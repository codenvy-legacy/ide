...
public interface GitConnection {
     ...
     *         if {@link CloneRequest#getRemoteUri()} return
     *         invalid value
     * @throws GitException
     ...
     *         if any error occurs
     * @throws IllegalArgumentException
     *         if {@link CommitRequest#getMessage()}
     ...
     * @throws IllegalArgumentException
     *         if {@link MergeRequest#getCommit()}
     ...
     *         move request
     * @throws IllegalArgumentException
     *         if {@link MoveRequest#getSource()} or
     ...
     *         if any error occurs
     * @throws IllegalArgumentException
     *         {@link RmRequest#getFiles()} returns
     ...
     *         if any error occurs
     * @throws IllegalArgumentException
     *         if there is tag with specified name (see

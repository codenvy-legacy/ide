...
import org.exoplatform.ide.git.client.clone.GetCommitersEvent;
 ...
 * 
 */
public class GetCommitersControl extends GitControl
{
   public GetCommitersControl()
   {
      super("Git/Commiters");
      setTitle("Commiters");
      setPrompt("Commiters");
      setImages(GitClientBundle.INSTANCE.cloneRepo(), GitClientBundle.INSTANCE.cloneRepoDisabled());
      setEvent(new GetCommitersEvent());
      setEnabled(true);
   }
}

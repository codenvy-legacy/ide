...
public interface IDocumentInformationMapping {
     ...
     *         if <code>imageOffset</code> is not a valid offset in the image document
     */
     ...
     * @throws BadLocationException
     *         if <code>imageRegion</code> is not a valid region of the image document
     */
     ...
     * @throws BadLocationException
     *         if <code>imageLine</code> is not a valid line number in the image document
     */
     ...
     * @throws BadLocationException
     *         if <code>originOffset</code> is not a valid offset in the original document
     */
     ...
     * @throws BadLocationException
     *         if <code>originRegion</code> is not a valid region of the original document
     */
     ...
     * @throws BadLocationException
     *         if <code>originLine</code> is not a valid line number in the original document
     */
     ...
     * @throws BadLocationException
     *         if <code>originLine</code>is not a valid line in the original document
     */

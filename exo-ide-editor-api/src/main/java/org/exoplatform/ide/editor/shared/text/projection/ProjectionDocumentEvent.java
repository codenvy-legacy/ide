...
import org.exoplatform.ide.editor.shared.text.SlaveDocumentEvent;
...
public class ProjectionDocumentEvent extends SlaveDocumentEvent {
     ...
     *
     * @param doc
     *         the changed projection document
     * @param offset
     *         the offset in the projection document
     * @param length
     *         the length in the projection document
     * @param text

 ...
 * {@link #apply(org.exoplatform.ide.editor.shared.text.IDocument, int) apply(IDocument, int)} method. In the above example the region of the
...
public abstract class TextEdit
{
    ...
    * @exception MalformedTreeException is thrown if the child edit can't be added to this edit. This is the case if the child
    ...
    * @exception MalformedTreeException is thrown if one of the given edits can't be added to this edit.
    * 
    ...
    * @param style flags controlling the execution of the edit tree. Valid flags are: <code>CREATE_UNDO</code> and
    *           </code>UPDATE_REGIONS</code>.
    * @return a undo edit, if <code>CREATE_UNDO</code> is specified. Otherwise <code>null</code> is returned.
    * 
    * @exception MalformedTreeException is thrown if the tree isn't in a valid state. This exception is thrown before any edit is
    ...
    * @param document the document to be manipulated
    * @param sourceEdits the list of source edits to be performed before the actual tree is applied to the document
    * 

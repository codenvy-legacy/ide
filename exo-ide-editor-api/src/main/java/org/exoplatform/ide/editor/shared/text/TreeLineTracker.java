...
import org.exoplatform.ide.editor.shared.text.AbstractLineTracker.DelimiterInfo;
...
abstract class TreeLineTracker implements ILineTracker
{
    ...
    * @param isLeftChild <code>true</code> if <code>child</code> shall become <code>parent</code>'s left child, <code>false</code>
   ...
   public final void replace(int offset, int length, String text) throws BadLocationException
   {
      ...
      while (true)
      {
         ...
         else
         {
            ...
            if (remaining < first.length || remaining == first.length && first.right == null)
            { // last line
    ...
    * @param firstLineDelta the number of characters from the replacement offset to the end of <code>node</code> &gt;
    *           <code>length</code>
    */
    ...
    * @param text the added text
    * @param length the replace length, &gt;= <code>firstLineDelta</code>
    * @param firstLineDelta the number of characters removed from the replacement offset to the end of <code>node</code>, &lt;=
    *           <code>length</code>
    */
    ...
    * @param wasLeftChild <code>true</code> if the deletion happened on <code>node</code>'s left subtree, <code>false</code> if it
    ...
    * @param offLen an array of length 2, with <code>offLen[0]</code> the expected offset of <code>node</code> and

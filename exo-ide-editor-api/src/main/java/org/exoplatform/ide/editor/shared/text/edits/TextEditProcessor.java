 ...
 * </p>
 *
 * org.eclipse.text.edits.TextEdit#apply(org.exoplatform.ide.editor.shared.text.IDocument)
 *
 * @since 3.0
 */
public class TextEditProcessor
{
    ...
    * @throws MalformedTreeException is thrown if the edit tree isn't in a valid state. This exception is thrown before any
    *                                edit is executed. So the document is still in its original state.
    * @throws BadLocationException   is thrown if one of the edits in the tree can't be executed. The state of the document is

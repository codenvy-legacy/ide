 ...
 * <p>
 * Adds the concept of multiple partitionings and the concept of zero-length partitions in conjunction with open and delimited
 * partitions. A delimited partition has a well defined start delimiter and a well defined end delimiter. Between two delimited
 * partitions there may be an open partition of length zero.
 * <p>
 * 
 * In order to fulfill the contract of this interface, the document must be configured with a document partitioner implementing

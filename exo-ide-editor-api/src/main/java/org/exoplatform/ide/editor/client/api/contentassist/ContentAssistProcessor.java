 ...
 * </p>
 */
public interface ContentAssistProcessor {
     ...
     */
    CompletionProposal[] computeCompletionProposals(Editor viewer, int offset);
     ...
     *
     * @param viewer
     *         the viewer whose document is used to compute the possible contexts
     * @param offset

...
public class ProjectionMapping
     ...
     *         the position category of the parent document used to manage the projected regions
     * @param slaveDocument
     *         the slave document
     ...
     * @param offset
     *         an origin offset
     * @param extensionDirection
     *         the direction in which to extend the search, or
     *         <code>NONE</code>
     * @return the index of the fragment containing <code>offset</code>, or
     *         <code>-1</code>
     * @throws BadLocationException
     *         if the index is not valid on the master
     *         document
     */
     ...
     * @param exact
     *         if <code>true</code>, the begin and end offsets of
     ...
     * @param takeClosestImage
     *         if <code>false</code>, <code>null</code> is
     ...
     * @throws BadLocationException
     *         if the region is not a valid origin region
     */
     ...
     *
     * @param originRegion
     *         the region to get the fragments for
     * @param exact
     *         if <code>true</code>, only the fragments that contain the
     ...
     * @param takeClosestImage
     *         if <code>true</code>, the method will return

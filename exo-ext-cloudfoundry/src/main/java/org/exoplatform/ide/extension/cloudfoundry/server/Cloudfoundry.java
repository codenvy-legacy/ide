...
import static org.exoplatform.ide.commons.FileUtils.GIT_FILTER;
...
import static org.exoplatform.ide.commons.JsonHelper.parseJson;
...
import org.exoplatform.ide.commons.exception.ParsingResponseException;
...
public class Cloudfoundry
{
      ...
      throws CloudfoundryException, ParsingResponseException, VirtualFileSystemException, IOException
   {
      ...
      Log.debug(getClass(), "createApplication START");
      ...
      finally
      {
         ...
         Log.debug(getClass(), "createApplication END, time: {} ms", time);
      }
      return appInfo;
   }
      ...
      throws IOException, ParsingResponseException, CloudfoundryException
   {
      ...
      if (!"STARTED".equals(appInfo.getState()))
      {
         ...
         for (int i = 0; i < attempts && !started; i++)
         {
            ...
            Log.debug(getClass(), "startApplication. Check is started, attempt: {}", (i + 1));
      ...
      Log.debug(getClass(), "startApplication. State: '{}'", appInfo.getState());
      ...
      throws VirtualFileSystemException, IOException
   {
      ...
      if (vfs != null && projectId != null)
      {
         ...
         app = item.getPropertyValue("cloudfoundry-application");
      }
   ...
   private void uploadApplication(Credential credential, String app, VirtualFileSystem vfs, String projectId, java.io.File path)
      throws ParsingResponseException, CloudfoundryException, VirtualFileSystemException, IOException
   {
      Log.debug(getClass(), "uploadApplication START");
      final long start = System.currentTimeMillis();
      ...
      try
      {
         ...
         if (totalSize > 65536)
         {
            ...
            Log.debug(getClass(), "Count SHA1 for {} files in {} ms", files.size(), timeSHA1);
         ...
         Log.debug(getClass(), "zip application in {} ms", timeZIP);
      ...
      finally
      {
         ...
         final long time = System.currentTimeMillis() - start;
         Log.debug(getClass(), "uploadApplication END, time: {} ms", time);
      }
   }

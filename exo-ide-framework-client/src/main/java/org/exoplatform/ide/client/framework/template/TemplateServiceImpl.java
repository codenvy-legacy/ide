...
public class TemplateServiceImpl extends TemplateService
{
   ...
   /**
    * @see org.exoplatform.ide.client.framework.template.TemplateService#addFileTemplate(org.exoplatform.ide.client.framework.template.AbstractTemplate,
   ...
   /**
    * @see org.exoplatform.ide.client.framework.template.TemplateService#getFileTemplateList(org.exoplatform.gwtframework.commons.rest.AsyncRequestCallback)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.framework.template.TemplateService#getProjectTemplateList(org.exoplatform.gwtframework.commons.rest.AsyncRequestCallback)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.framework.template.TemplateService#deleteTemplatesFromRegistry(org.exoplatform.gwtframework.commons.rest.AsyncRequestCallback)
    */
   @Override

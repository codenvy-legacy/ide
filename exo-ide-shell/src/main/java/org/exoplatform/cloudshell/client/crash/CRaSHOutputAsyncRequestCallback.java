 ...
 *
 */
public class CRaSHOutputAsyncRequestCallback extends AsyncRequestCallback<CRaSHOutput>
{
   /**
    ...
    */
   @Override
   protected void onSuccess(CRaSHOutput result)
   {
      CloudShell.console().print(result.getOutput());
   }

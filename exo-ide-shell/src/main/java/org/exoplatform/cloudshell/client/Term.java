...
//    scroll.getElement().getStyle().setOverflow(Overflow.AUTO);
//    scroll.setSize("100%", "600px");
    //
  ...
  protected void onAttach() {
    ...
    print(remote.getWelcome());
    
  }

  private void repaint() {
    text.repaint();
//    scroll.getElement().sscrollToBottom();
  }

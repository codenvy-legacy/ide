...
public abstract class Parser implements CommandLineParser
{
    ...
    * @param options the <code>Options</code>
    * @param arguments the <code>arguments</code>
    * @param stopAtNonOption specifies whether to stop interpreting the arguments when a non option has been encountered and to
    *           add them to the CommandLines args list.
    * @return the <code>CommandLine</code>
    * @throws ParseException if an error occurs when parsing the arguments.
    */
   ...
   /**
    * <p>
    * Process the argument values for the specified Option <code>opt</code> using the values retrieved from the specified iterator
    * <code>iter</code>.
    * 

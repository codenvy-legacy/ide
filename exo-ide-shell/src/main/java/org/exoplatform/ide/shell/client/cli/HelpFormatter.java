...
import org.exoplatform.ide.shell.client.PrintWriter;
...
public class HelpFormatter
{
    ...
    * <code>width</code>. The wrap point is the last postion before startPos+width having a whitespace character (space, \n, \r).
    * 
   ...
   protected String rtrim(String s)
   {
      ...
      while ((pos > 0) && Character.isSpace(s.charAt(pos - 1)))
      {
         --pos;
      }

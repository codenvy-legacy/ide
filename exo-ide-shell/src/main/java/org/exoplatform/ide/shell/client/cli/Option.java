...
import org.exoplatform.ide.shell.client.cli.OptionValidator;
...
/**
 * <p>
 * Describes a single command-line option. It maintains information regarding the short-name of the option, the long-name, if any
 * exists, a flag indicating if an argument is required for this option, and a self-documenting description of the option.
 * </p>
 * 
 * <p>
 ...
 * <p>
 * 
 * @see org.exoplatform.ide.shell.client.cli.Options
 * @see org.exoplatform.ide.shell.client.cli.CommandLine
 * 
...
public class Option implements Cloneable, Serializable
{
   ...
   /**
    * Processes the value. If this Option has a value separator the value will have to be parsed into individual tokens. When n-1
    * tokens have been processed and there are more value separators in the value, parsing is ceased and the remaining characters
    * are added as a single token.
    * 
   ...
   /**
    * Add the value to this Option. If the number of arguments is greater than zero and there is enough space in the list then add
    * the value. Otherwise, throw a runtime exception.
    * 
   ...
   /**
    * Clear the Option values. After a parse is complete, these are left with data in them and they need clearing if another parse
    * is done.
    * 
   ...
   /**
    * This method is not intended to be used. It was a piece of internal API that was made public in 1.0. It currently throws an

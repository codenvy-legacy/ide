...
{
   /**
    * Validates whether <code>opt</code> is a permissable Option shortOpt. The rules that specify if the <code>opt</code> is valid
    * are:
    * 
    * <ul>
   ...
   {
      return true;// Character.isJavaIdentifierPart(c);
   }
}

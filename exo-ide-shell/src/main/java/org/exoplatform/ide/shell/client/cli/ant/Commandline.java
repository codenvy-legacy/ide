...
public class Commandline implements Cloneable {
   ...
   private char separatorChar = '/';
    ...
    public void setExecutable(String executable) {
        ...
        this.executable = executable.replace('/', separatorChar)
     ...
     * @exception ParseCommandException if the argument contains both, single
     *                           and double quotes.
     */
    public static String quoteArgument(String argument) {
        if (argument.indexOf("\"") > -1) {
            if (argument.indexOf("\'") > -1) {
                throw new ParseCommandException("Can\'t handle single and double"

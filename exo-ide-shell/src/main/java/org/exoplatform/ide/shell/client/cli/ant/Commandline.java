...
package org.exoplatform.ide.shell.client.cli.ant;

//import java.util.StringTokenizer;
import org.exoplatform.ide.shell.client.cli.ant.Commandline;
import org.exoplatform.ide.shell.client.cli.ant.ParseCommandException;
import org.exoplatform.ide.shell.client.cli.ant.StringTokenizer;
import org.exoplatform.ide.shell.client.cli.ant.StringUtils;
 ...
 * &nbsp;&nbsp;&lt;/acommandline&gt;<br>
 * &lt;/someelement&gt;<br>
 * </code> The element <code>someelement</code> must provide a method <code>createAcommandline</code> which returns an instance of
 * this class.
 * 
 */
public class Commandline implements Cloneable
{
   ...
   protected static final String DISCLAIMER = StringUtils.LINE_SEP
      + "The \' characters around the executable and arguments are" + StringUtils.LINE_SEP + "not part of the command."
    ...
    * </p>
    * 
    * @param insertAtStart if true, the argument is inserted at the beginning of the list of args, otherwise it is appended.
   ...
   public void setExecutable(String executable)
   {
      ...
      this.executable = executable.replace('/', separatorChar).replace('\\', separatorChar);
   }
    ...
    * 
    * <p>
    * If the argument doesn't include spaces or quotes, return it as is. If it contains double quotes, use single quotes - else
    * surround the argument by double quotes.
    * </p>
    * 
    * @param argument the argument to quote if necessary.
    * @return the quoted argument.
    * @exception ParseCommandException if the argument contains both, single and double quotes.
    */
   public static String quoteArgument(String argument)
   {
      if (argument.indexOf("\"") > -1)
      {
         if (argument.indexOf("\'") > -1)
         {
            throw new ParseCommandException("Can\'t handle single and double" + " quotes in same argument");
         }
         else
         {
            return '\'' + argument + '\'';
   ...
   public static String[] translateCommandline(String toProcess)
   {
      ...
      {
         throw new ParseCommandException("unbalanced quotes in " + toProcess);
      }
    ...
    * 
    * <p>
    * This marker can be used to locate a position on the commandline--to insert something for example--when all parameters have
    * been set.
    * </p>
    * 
    * @return a marker

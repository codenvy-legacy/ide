...
public final class StringUtils
{
   ...
   /**
    * Checks that a string buffer ends up with a given string. It may sound trivial with the existing JDK API but the various
    * implementation among JDKs can make those methods extremely resource intensive and perform poorly due to massive memory
    ...
    *         represented by the StringBuffer object; <code>false</code> otherwise. Note that the result will be <code>true</code>
   ...
   public static long parseHumanSizes(String humanSize) throws Exception
   {
      ...
      {
         throw new ParseCommandException("Failed to parse \"" + humanSize + "\"", e);
      }
   }

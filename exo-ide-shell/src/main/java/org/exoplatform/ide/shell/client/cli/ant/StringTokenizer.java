 ...
 * 
 * If returnDelimiters is false, successive calls to nextToken() return maximal blocks of characters that do not contain a
 * delimiter.
 * 
 * If returnDelimiters is true, delimiters are considered to be tokens, and successive calls to nextToken() return either a one
 * character delimiter, or a maximal block of text between delimiters.
 */
public class StringTokenizer implements Enumeration<Object>
{
   ...
   /**
    * Constructs a new StringTokenizer for string using the specified delimiters and returning delimiters as tokens when
    * specified.
    * 
    * @param string the string to be tokenized
    * @param delimiters the delimiters to use

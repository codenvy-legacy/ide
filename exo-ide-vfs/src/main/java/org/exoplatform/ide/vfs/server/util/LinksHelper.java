...
public class LinksHelper {
    public static Map<String, Link> createFileLinks(URI baseUri,
        ...
        links.put(Link.REL_MOVE, //
                  new LinkImpl(locked
                               ? createURI(baseUriBuilder.clone(), vfsId, "move", itemId, "parentId", "[parentId]", "lockToken",
                                           "[lockToken]")
        ...
        links.put(Link.REL_RENAME, //
                  new LinkImpl(locked
                               ? createURI(baseUriBuilder.clone(), vfsId, "rename", itemId, "newname", "[newname]", "mediaType",
    ...
    private static void addBaseFolderLinks(Map<String, Link> links,
        ...
        if (!isRoot) {
            links.put(Link.REL_PARENT, //
                      new LinkImpl(createURI(baseUriBuilder.clone(), vfsId, "item", parentId), Link.REL_PARENT,
                                   MediaType.APPLICATION_JSON));

...
{
   private final ChangeEvent.ChangeType type;

   public TypeFilter(ChangeEvent.ChangeType type)
   {
      this.type = type;
   }
   ...
   {
      ChangeEvent.ChangeType eventType = event.getType();
      return eventType != null && this.type == eventType;
   }
}

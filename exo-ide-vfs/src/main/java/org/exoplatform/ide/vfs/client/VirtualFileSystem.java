...
public class VirtualFileSystem {
     ...
     *
     * @param parent
     *         parent folder of the new project
     * @param callback
     *         callback
     * @throws RequestException
     */
     ...
     *         item to rename
     * @param mediaType
     *         media type to change (may be <code>null</code> in case of just renaming operation)
     * @param newname
     *         new name of the item (may be <code>null</code> in case of just changing media type)
     * @param lockToken
     *         lock token
     * @param callback
     *         callback user has to implement to handle response
     * @throws RequestException
     */
     ...
     *
     * @param item
     *         item to update with properties
     * @param lockToken
     *         lock token
     * @param callback
     *         callback user has to implement to handle response

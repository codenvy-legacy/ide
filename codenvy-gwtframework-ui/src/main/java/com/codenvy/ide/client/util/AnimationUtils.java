...
public class AnimationUtils
{
   ...
   private static class TransitionEndHandler implements EventListener
   {
      ...
      private native void replaceOldListener(Element elem, String type, TransitionEndHandler transitionEndHandler) /*-{
    ...
    *       EventListener)}.
    */
   public static void animatePropertySet(final Element elem, String property, String value, double duration)
   {

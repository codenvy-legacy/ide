...
public final class QuirksConstants
{
    ...
    */
   public static final boolean PROVIDES_MUTATION_EVENTS = UserAgent.isFirefox() || UserAgent.isWebkit();
    ...
    */
   public static final boolean USUALLY_LEFT_NORMALISES = UserAgent.isWebkit() || UserAgent.isWebkit();
    ...
    */
   public static final boolean LIES_ABOUT_CARET_AT_LINK_END_BOUNDARY = UserAgent.isWebkit() && UserAgent.isAtLeastVersion(
      528, 0);
    ...
    */
   public static final boolean ALWAYS_GIVES_KEY_EVENT_BEFORE_CHANGING_DOM = UserAgent.isFirefox() || UserAgent.isIE7();
    ...
    * Untested exceptions: Any IME on Linux!
    */
   public static final boolean CAN_TELL_WHEN_FIRST_KEY_EVENT_IS_IME = UserAgent.isIE() || UserAgent.isWebkit() || UserAgent.isWin();
    ...
    */
   public static final boolean HAS_OLD_SCHOOL_CLIPBOARD_SHORTCUTS = UserAgent.isWin() || UserAgent.isLinux();
    ...
    */
   public static final boolean OK_SELECTION_ACROSS_TEXT_NODE_DATA_CHANGES = UserAgent.isFirefox() || UserAgent.isIE();
    ...
    */
   public static final boolean PRESERVES_SEMANTIC_SELECTION_ACROSS_INTRINSIC_TEXT_NODE_CHANGES = OK_SELECTION_ACROSS_TEXT_NODE_DATA_CHANGES && OK_SELECTION_ACROSS_TEXT_NODE_SPLITS;
    ...
    * Tested: Safari 3.2.1, FF 3.0, 3.5, Chrome 1, IE7, IE8
    */
   public static final boolean PRESERVES_SEMANTIC_SELECTION_ACROSS_MUTATIONS_OR_CLEARS_IT = OK_SELECTION_ACROSS_TEXT_NODE_DATA_CHANGES &&
    ...
    * events...)
    */
   public static final boolean CANCEL_BUBBLING_CANCELS_IME_COMPOSITION_AND_CONTEXTMENU = UserAgent.isFirefox();
    ...
    * quirk.
    */
   public static final boolean COMMAND_COMBO_DOESNT_GIVE_KEYPRESS = UserAgent.isMac() && UserAgent.isChrome();
    ...
    */
   public static final boolean SUPPORTS_GET_ELEMENTS_BY_CLASSNAME = GWT.isScript() && checkGetElementsByClassNameSupport();
    ...
    */
   public static final boolean SUPPORTS_COMPOSITION_EVENTS = UserAgent.isFirefox() || (UserAgent.isWebkit() && UserAgent.isAtLeastVersion(
      532, 5));
    ...
    */
   public static final boolean MODIFIES_DOM_AND_FIRES_TEXTINPUT_AFTER_COMPOSITION = UserAgent.isWebkit(); // Put an upper bound on the version here when it's fixed...
    ...
    */
   public static final boolean SANITIZES_PASTED_CONTENT = (UserAgent.isWebkit() && UserAgent.isAtLeastVersion(533,
      16)) || (UserAgent.isFirefox() && UserAgent.isAtLeastVersion(4, 0));

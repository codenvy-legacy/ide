...
public class ClientStringUtils {
     ...
     *
     * @param path
     *         String path to operate on
     * @param dirs
     *         maximum number of directory segments to leave
     * @param maxChars
     *         if > 3 specifies the maximum length of the returned string
     *         before it is truncated
     * @param sep
     *         Separator to use during split
     * @return
     */

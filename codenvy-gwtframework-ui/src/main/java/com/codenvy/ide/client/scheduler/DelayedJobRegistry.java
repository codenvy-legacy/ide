...
import com.codenvy.ide.client.util.NumberMap;
import com.codenvy.ide.client.util.NumberPriorityQueue;
import com.codenvy.ide.client.util.StringMap;
...
public class DelayedJobRegistry {
    ...
    public String toString() {
        return "DJR[jobTimes:" + jobTimes + ",delayedJobIds:" + delayedJobIds + ",delayedJobs:" + delayedJobs + "]";
    }
}

...
public interface Scheduler {
     ...
     *         Must be at least zero
     */
    void scheduleDelayed(Priority priority, IncrementalTask process, int minimumTime);
     ...
     *         Must be at least zero
     */
    void scheduleRepeating(Priority priority, IncrementalTask process, int minimumTime, int interval);
     ...
     *
     * @param listener
     *         no effect if it's not a known listener.
     */

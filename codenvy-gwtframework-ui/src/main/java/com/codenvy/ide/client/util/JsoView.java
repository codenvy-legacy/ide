...
import com.codenvy.ide.client.util.ReadableStringMap.ProcV;
...
public final class JsoView extends JavaScriptObject {
     ...
     *
     * @param <T>
     *         The value type. It is up to the caller to make sure only values
    ...
    public final native <T> void each(ProcV<T> proc) /*-{
        for (var k in this) {
            proc.
                @com.codenvy.ide.client.util.ReadableStringMap.ProcV::apply(Ljava/lang/String;Ljava/lang/Object;)
                (k, this[k]);
        }
    }-*/;

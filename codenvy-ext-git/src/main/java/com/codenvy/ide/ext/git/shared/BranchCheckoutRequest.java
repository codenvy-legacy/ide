...
public class BranchCheckoutRequest extends GitRequest {
    ...
    private String  name;
    /**
     * The name of a commit at which to start the new branch. If <code>null</code> the HEAD will be used. Has sense if {@link #createNew}
     * is
     * <code>true</code>.
     */
     ...
     * @param createNew
     *         if <code>true</code> then create a new branch named {@link #name} and start it at {@link #startPoint} or to the HEAD
    ...
    /**
     * @param createNew
     *         should create new branch named {@link #name} and checkout it or not. Exception will be thrown in there in no branch
     *         named {@link #name}
     */

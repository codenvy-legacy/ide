...
public class RemoteUpdateRequest extends GitRequest {
     ...
     *         updates for list of currently tracked branches
     * @param addBranches
     *         if <code>true</code> then <code>branches</code> instead of replacing the list of currently tracked branches, added
     *         to that list
     * @param addUrl
     *         remote URLs to be added
     * @param removeUrl
    ...
    /**
     * @param addBranches
     *         if <code>true</code> then {@link #branches} instead of replacing the list of currently tracked branches, added to
     *         that list
     * @see #addBranches
     */

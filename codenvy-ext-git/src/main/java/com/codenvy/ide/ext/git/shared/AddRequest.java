...
public class AddRequest extends GitRequest {
     ...
     * index if the corresponding files in the working tree have been removed. If <code>false</code> then new files and modified files
     * added
     * to the index.
     */
     ...
     *         files to add content from
     * @param update
     *         if <code>true</code> than never stage new files, but stage modified new contents of tracked files. It will remove files
    ...
    /**
     * @param filepattern
     *         files to add content from. If <code>null</code> the special {@link AddRequest#DEFAULT_PATTERN} pattern will be
     *         used instead
     */

...
package com.codenvy.ide.ext.git.dto.client;
...
public class DtoClientImpls {
  ...
  public static final String CLIENT_SERVER_PROTOCOL_HASH = "d1b536beafac72c5b354f4c957d7118c2fd01992";


  public static class AddRequestImpl extends GitRequestImpl implements com.codenvy.ide.ext.git.shared.AddRequest {
    protected AddRequestImpl() {}

    @Override
    public final native com.codenvy.ide.json.JsonArray<java.lang.String> getFilepattern() /*-{
      return this["filepattern"];
    }-*/;

    public final native AddRequestImpl setFilepattern(com.codenvy.ide.json.JsonArray<java.lang.String> filepattern) /*-{
      this["filepattern"] = filepattern;
      return this;
    }-*/;

    public final native boolean hasFilepattern() /*-{
      return this.hasOwnProperty("filepattern");
    }-*/;

    @Override
    public final native boolean update() /*-{
      return this["update"];
    }-*/;

    public final native AddRequestImpl setUpdate(boolean update) /*-{
      this["update"] = update;
      return this;
    }-*/;

    public final native boolean hasUpdate() /*-{
      return this.hasOwnProperty("update");
    }-*/;

    public static native AddRequestImpl make() /*-{
      return {
  ...
  public static class BranchListRequestImpl extends GitRequestImpl implements com.codenvy.ide.ext.git.shared.BranchListRequest {
    protected BranchListRequestImpl() {}

    @Override
    public final native java.lang.String getListMode() /*-{
      return this["listMode"];
    }-*/;

    public final native BranchListRequestImpl setListMode(java.lang.String listMode) /*-{
      this["listMode"] = listMode;
      return this;
    }-*/;

    public final native boolean hasListMode() /*-{
      return this.hasOwnProperty("listMode");
    }-*/;

    public static native BranchListRequestImpl make() /*-{
      return {
  ...
  public static class CloneRequestImpl extends GitRequestImpl implements com.codenvy.ide.ext.git.shared.CloneRequest {
    ...
    @Override
    public final native com.codenvy.ide.json.JsonArray<java.lang.String> getBranchesToFetch() /*-{
      return this["branchesToFetch"];
    }-*/;

    public final native CloneRequestImpl setBranchesToFetch(com.codenvy.ide.json.JsonArray<java.lang.String> branchesToFetch) /*-{
      this["branchesToFetch"] = branchesToFetch;
      return this;
    }-*/;

    public final native boolean hasBranchesToFetch() /*-{
      return this.hasOwnProperty("branchesToFetch");
    }-*/;
    ...
    public final native CloneRequestImpl setRemoteUri(java.lang.String remoteUri) /*-{
    ...
    public final native CloneRequestImpl setTimeout(int timeout) /*-{
    ...
    public static native CloneRequestImpl make() /*-{
      return {
  ...
  public static class DiffRequestImpl extends GitRequestImpl implements com.codenvy.ide.ext.git.shared.DiffRequest {
    ...
    public final native DiffRequestImpl setFileFilter(com.codenvy.ide.json.JsonArray<java.lang.String> fileFilter) /*-{
      this["fileFilter"] = fileFilter;
      return this;
    }-*/;

    public final native boolean hasFileFilter() /*-{
      return this.hasOwnProperty("fileFilter");
    }-*/;
    ...
    public final native DiffRequestImpl setCommitA(java.lang.String commitA) /*-{
    ...
    @Override
    public final native boolean noRenames() /*-{
      return this["noRenames"];
    }-*/;

    public final native DiffRequestImpl setNoRenames(boolean noRenames) /*-{
      this["noRenames"] = noRenames;
      return this;
    }-*/;

    public final native boolean hasNoRenames() /*-{
      return this.hasOwnProperty("noRenames");
    }-*/;

    @Override
    public final native com.codenvy.ide.ext.git.shared.DiffRequest.DiffType getType() /*-{
      return @com.codenvy.ide.ext.git.shared.DiffRequest.DiffType::valueOf(Ljava/lang/String;)(this["type"]);
    }-*/;

    public final native DiffRequestImpl setType(com.codenvy.ide.ext.git.shared.DiffRequest.DiffType type) /*-{
      type = type.@com.codenvy.ide.ext.git.shared.DiffRequest.DiffType::toString()();
      this["type"] = type;
      return this;
    }-*/;
    ...
    public final native DiffRequestImpl setCached(boolean cached) /*-{
      this["cached"] = cached;
      return this;
    }-*/;
  ...
  public static class FetchRequestImpl extends GitRequestImpl implements com.codenvy.ide.ext.git.shared.FetchRequest {
    ...
    @Override
    public final native boolean removeDeletedRefs() /*-{
      return this["removeDeletedRefs"];
    }-*/;

    public final native FetchRequestImpl setRemoveDeletedRefs(boolean removeDeletedRefs) /*-{
      this["removeDeletedRefs"] = removeDeletedRefs;
      return this;
    }-*/;

    public final native boolean hasRemoveDeletedRefs() /*-{
      return this.hasOwnProperty("removeDeletedRefs");
    }-*/;
    ...
    public final native FetchRequestImpl setRefSpec(com.codenvy.ide.json.JsonArray<java.lang.String> refSpec) /*-{
    ...
    public final native FetchRequestImpl setTimeout(int timeout) /*-{
      this["timeout"] = timeout;
      return this;
    }-*/;
    ...
    public static native FetchRequestImpl make() /*-{
      return {
  ...
  public static class GitHubRepositoryImpl extends com.codenvy.ide.json.js.Jso implements com.codenvy.ide.ext.git.shared.GitHubRepository {
    ...
    public final native GitHubRepositoryImpl setHomepage(java.lang.String homepage) /*-{
      this["homepage"] = homepage;
      return this;
    }-*/;

    public final native boolean hasHomepage() /*-{
      return this.hasOwnProperty("homepage");
    }-*/;
    ...
    public final native GitHubRepositoryImpl setForks(int forks) /*-{
      this["forks"] = forks;
      return this;
    }-*/;

    public final native boolean hasForks() /*-{
      return this.hasOwnProperty("forks");
    }-*/;
    ...
    public final native GitHubRepositoryImpl setWatchers(int watchers) /*-{
      this["watchers"] = watchers;
      return this;
    }-*/;

    public final native boolean hasWatchers() /*-{
      return this.hasOwnProperty("watchers");
    }-*/;

    @Override
    public final native java.lang.String getSshUrl() /*-{
      return this["sshUrl"];
    }-*/;

    public final native GitHubRepositoryImpl setSshUrl(java.lang.String sshUrl) /*-{
      this["sshUrl"] = sshUrl;
      return this;
    }-*/;

    public final native boolean hasSshUrl() /*-{
      return this.hasOwnProperty("sshUrl");
    }-*/;
    ...
    public final native GitHubRepositoryImpl setHtmlUrl(java.lang.String htmlUrl) /*-{
    ...
    @Override
    public final native java.lang.String getUpdatedAt() /*-{
      return this["updatedAt"];
    }-*/;

    public final native GitHubRepositoryImpl setUpdatedAt(java.lang.String updatedAt) /*-{
      this["updatedAt"] = updatedAt;
      return this;
    }-*/;

    public final native boolean hasUpdatedAt() /*-{
      return this.hasOwnProperty("updatedAt");
    }-*/;
    ...
    public final native GitHubRepositoryImpl setGitUrl(java.lang.String gitUrl) /*-{
      this["gitUrl"] = gitUrl;
      return this;
    }-*/;
    ...
    public final native GitHubRepositoryImpl setHasWiki(boolean hasWiki) /*-{
      this["hasWiki"] = hasWiki;
      return this;
    }-*/;

    public final native boolean hasHasWiki() /*-{
      return this.hasOwnProperty("hasWiki");
    }-*/;

    @Override
    public final native java.lang.String getCloneUrl() /*-{
      return this["cloneUrl"];
    }-*/;

    public final native GitHubRepositoryImpl setCloneUrl(java.lang.String cloneUrl) /*-{
      this["cloneUrl"] = cloneUrl;
      return this;
    }-*/;

    public final native boolean hasCloneUrl() /*-{
      return this.hasOwnProperty("cloneUrl");
    }-*/;

    @Override
    public final native int getOpenedIssues() /*-{
      return this["openedIssues"];
    }-*/;

    public final native GitHubRepositoryImpl setOpenedIssues(int openedIssues) /*-{
      this["openedIssues"] = openedIssues;
      return this;
    }-*/;

    public final native boolean hasOpenedIssues() /*-{
      return this.hasOwnProperty("openedIssues");
    }-*/;

    @Override
    public final native java.lang.String getCreatedAt() /*-{
      return this["createdAt"];
    }-*/;

    public final native GitHubRepositoryImpl setCreatedAt(java.lang.String createdAt) /*-{
      this["createdAt"] = createdAt;
      return this;
    }-*/;

    public final native boolean hasCreatedAt() /*-{
    ...
    public final native GitHubRepositoryImpl setName(java.lang.String name) /*-{
      this["name"] = name;
      return this;
    }-*/;
    ...
    @Override
    public final native java.lang.String getLanguage() /*-{
      return this["language"];
    }-*/;

    public final native GitHubRepositoryImpl setLanguage(java.lang.String language) /*-{
      this["language"] = language;
      return this;
    }-*/;

    public final native boolean hasLanguage() /*-{
      return this.hasOwnProperty("language");
    }-*/;
    ...
    public final native GitHubRepositoryImpl setSize(int size) /*-{
      this["size"] = size;
      return this;
    }-*/;
    ...
    public final native GitHubRepositoryImpl setIsPrivate(boolean isPrivate) /*-{
      this["isPrivate"] = isPrivate;
      return this;
    }-*/;

    public final native boolean hasIsPrivate() /*-{
      return this.hasOwnProperty("isPrivate");
    }-*/;
    ...
    public final native GitHubRepositoryImpl setDescription(java.lang.String description) /*-{
    ...
    public final native GitHubRepositoryImpl setUrl(java.lang.String url) /*-{
      this["url"] = url;
      return this;
    }-*/;
    ...
    public final native GitHubRepositoryImpl setIsFork(boolean isFork) /*-{
      this["isFork"] = isFork;
      return this;
    }-*/;

    public final native boolean hasIsFork() /*-{
      return this.hasOwnProperty("isFork");
    }-*/;

    @Override
    public final native java.lang.String getSvnUrl() /*-{
      return this["svnUrl"];
    }-*/;

    public final native GitHubRepositoryImpl setSvnUrl(java.lang.String svnUrl) /*-{
      this["svnUrl"] = svnUrl;
      return this;
    }-*/;

    public final native boolean hasSvnUrl() /*-{
      return this.hasOwnProperty("svnUrl");
    }-*/;

    public static native GitHubRepositoryImpl make() /*-{
      return {
  ...
  public static class GitUserImpl extends com.codenvy.ide.json.js.Jso implements com.codenvy.ide.ext.git.shared.GitUser {
    protected GitUserImpl() {}
    ...
    public final native GitUserImpl setName(java.lang.String name) /*-{
      this["name"] = name;
      return this;
    }-*/;
    ...
    public final native GitUserImpl setEmail(java.lang.String email) /*-{
      this["email"] = email;
      return this;
    }-*/;
    ...
    public static native GitUserImpl make() /*-{
      return {
  ...
  public static class IndexFileImpl extends com.codenvy.ide.json.js.Jso implements com.codenvy.ide.ext.git.shared.IndexFile {
    protected IndexFileImpl() {}
    ...
    public final native IndexFileImpl setPath(java.lang.String path) /*-{
      this["path"] = path;
      return this;
    }-*/;
    ...
    @Override
    public final native boolean indexed() /*-{
      return this["indexed"];
    }-*/;

    public final native IndexFileImpl setIndexed(boolean indexed) /*-{
      this["indexed"] = indexed;
      return this;
    }-*/;

    public final native boolean hasIndexed() /*-{
      return this.hasOwnProperty("indexed");
    }-*/;

    public static native IndexFileImpl make() /*-{
      return {
  ...
  public static class ReferenceImpl extends com.codenvy.ide.json.js.Jso implements com.codenvy.ide.ext.git.shared.Reference {
    protected ReferenceImpl() {}

    @Override
    public final native java.lang.String getFullName() /*-{
      return this["fullName"];
    }-*/;

    public final native ReferenceImpl setFullName(java.lang.String fullName) /*-{
      this["fullName"] = fullName;
      return this;
    }-*/;

    public final native boolean hasFullName() /*-{
      return this.hasOwnProperty("fullName");
    }-*/;

    @Override
    public final native com.codenvy.ide.ext.git.shared.Reference.RefType getRefType() /*-{
      return @com.codenvy.ide.ext.git.shared.Reference.RefType::valueOf(Ljava/lang/String;)(this["refType"]);
    }-*/;

    public final native ReferenceImpl setRefType(com.codenvy.ide.ext.git.shared.Reference.RefType refType) /*-{
      refType = refType.@com.codenvy.ide.ext.git.shared.Reference.RefType::toString()();
      this["refType"] = refType;
      return this;
    }-*/;

    public final native boolean hasRefType() /*-{
      return this.hasOwnProperty("refType");
    }-*/;
    ...
    public final native ReferenceImpl setDisplayName(java.lang.String displayName) /*-{
      this["displayName"] = displayName;
      return this;
    }-*/;
    ...
    @Override
    public final native com.codenvy.ide.json.JsonArray<com.codenvy.ide.ext.git.shared.Reference> getBranches() /*-{
      return this["branches"];
    }-*/;

    public final native ReferenceImpl setBranches(com.codenvy.ide.json.JsonArray<com.codenvy.ide.ext.git.shared.Reference> branches) /*-{
    ...
    public static native ReferenceImpl make() /*-{
      return {
  ...
  public static class RemoteAddRequestImpl extends GitRequestImpl implements com.codenvy.ide.ext.git.shared.RemoteAddRequest {
    protected RemoteAddRequestImpl() {}
    ...
    public final native RemoteAddRequestImpl setName(java.lang.String name) /*-{
      this["name"] = name;
      return this;
    }-*/;
    ...
    public final native RemoteAddRequestImpl setUrl(java.lang.String url) /*-{
      this["url"] = url;
      return this;
    }-*/;
    ...
    public final native RemoteAddRequestImpl setBranches(com.codenvy.ide.json.JsonArray<java.lang.String> branches) /*-{
      this["branches"] = branches;
      return this;
    }-*/;
    ...
    public static native RemoteAddRequestImpl make() /*-{
      return {
  ...
  public static class TagCreateRequestImpl extends GitRequestImpl implements com.codenvy.ide.ext.git.shared.TagCreateRequest {
    protected TagCreateRequestImpl() {}
    ...
    public final native TagCreateRequestImpl setCommit(java.lang.String commit) /*-{
      this["commit"] = commit;
      return this;
    }-*/;
    ...
    public final native TagCreateRequestImpl setName(java.lang.String name) /*-{
      this["name"] = name;
      return this;
    }-*/;
    ...
    public final native TagCreateRequestImpl setMessage(java.lang.String message) /*-{
      this["message"] = message;
      return this;
    }-*/;
    ...
    public final native TagCreateRequestImpl setForce(boolean force) /*-{
      this["force"] = force;
      return this;
    }-*/;
    ...
    public static native TagCreateRequestImpl make() /*-{
      return {

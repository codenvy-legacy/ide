...
@Singleton
public class ShowBranchesAction extends Action {
    private BranchPresenter  presenter;
    private ResourceProvider resourceProvider;

    @Inject
    public ShowBranchesAction(BranchPresenter presenter, ResourceProvider resourceProvider, GitClientResources resources,

...
public abstract class GitVendorService {
    ...
    protected GitVendorService(@NotNull String vendorName,
                               @NotNull String vendorBaseHost,
                               @NotNull String vendorUrlPattern,
                               @NotNull String[] vendorOAuthScopes,
                               boolean oauth2) {

        this(vendorName, vendorBaseHost, vendorUrlPattern, vendorOAuthScopes, oauth2, null);
    }
    ...
    protected GitVendorService(@NotNull String vendorName,
                               ...
                               @NotNull String[] vendorOAuthScopes,
                               boolean oauth2,
                               @Nullable SshKeyStore sshKeyStore) {

        this.vendorName = vendorName;
        this.vendorBaseHost = vendorBaseHost;
        this.vendorUrlPattern = Pattern.compile(vendorUrlPattern);
        this.vendorOAuthScopes = Arrays.asList(vendorOAuthScopes);
        this.oauth2 = oauth2;
     ...
     * {@link RequestBuilder} object.
     *
     * @param request
     *         parameters for this request.
     * @return {@link Response} object containing response body and headers which
     * should be retrieved.
     * @throws ProviderException
     */
     ...
     * @throws com.codenvy.commons.json.JsonParseException
     */

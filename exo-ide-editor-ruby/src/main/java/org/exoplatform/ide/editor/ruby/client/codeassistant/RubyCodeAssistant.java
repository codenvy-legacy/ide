...
public class RubyCodeAssistant extends CodeAssistant implements Comparator<Token> {
     ...
     *         List of tokens
     * @param tokens
     *         List of tokens where global and local variables will be stored
     */
     ...
     *
     * @param tokenList
     *         List of tokens, received from editor
     * @param tokens
     *         List of tokens where global and local variables will be stored
     */
     ...
     *
     * @param classToken
     *         Token that describes Ruby class
     * @param tokens
     *         List of tokens
     */
     ...
     *
     * @param methodToken
     *         token that represent Ruby method
     * @param tokens
     *         List of tokens
     */
     ...
     *
     * @param metaclass
     *         where do search classes
     * @param tokenMap
     *         Map that store tokens
     */
     ...
     *         array
     * @param tokens
     *         Map that store converted tokens
     */

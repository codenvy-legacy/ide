 ...
 * 
 */
public class DefaultCodeAssistant extends ClientCodeAssistant
{
    ...
    *      int, int, java.util.List, java.lang.String, org.exoplatform.ide.editor.api.codeassitant.Token)
    */
   @Override

...
public class CodeMirrorParserImpl extends Parser
{
    ...
    *         node
    */
   public TokenImplExtended parseLine(JavaScriptObject node, int lineNumber, TokenImplExtended currentToken,
   ...
   @Override
   public List<TokenImplExtended> getTokenList(String editorId, JavaScriptObject editor, HandlerManager eventBus)
   {
      if (editor == null)
         return null;
      ...
      TokenImplExtended rootToken = new TokenImplExtended();
      rootToken.setSubTokenList(new ArrayList<TokenImplExtended>());

      TokenImplExtended currentToken = rootToken;
      ...
      if (buildCommand.isBusy())
      {
         Window.alert("CodeMirrorParserImpl.getTokenList > fireEvent(new EditorTokenListPreparedEvent");
    ...
    * @return
    */
   public static String getLineMimeType(int targetLineNumber, List<TokenImplExtended> tokenList)
   {
   ...
   private static void searchLineMimeType(int targetLineNumber, TokenImplExtended currentToken)
   {
   ...
   class GetTokenListInBackgroundCommand implements RepeatingCommand
   {
      ...
      TokenImplExtended currentToken;

      TokenImplExtended rootToken;

      int lineNumber;

      JavaScriptObject cloneEditorContainer;

      List<TokenImplExtended> preparedTokenList;
      ...
      private void init()
      {
         ...
         preparedTokenList = new ArrayList<TokenImplExtended>();

         rootToken = new TokenImplExtended();
      ...
      private void finish()
      {
         ...
         interrupt();
         Window.alert("CodeMirrorParserImpl.GetTokenListInBackgroundCommand.finish()");

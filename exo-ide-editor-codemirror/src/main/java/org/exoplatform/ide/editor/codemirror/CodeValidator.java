...
public abstract class CodeValidator
{
    ...
    * @return
    */
   public static List<? extends Token> extractCode(List<TokenImplExtended> tokenList, List<TokenImplExtended> code,
      String mimeType)
   {
   ...
   private static void analizeToken(TokenImplExtended currentToken, List<TokenImplExtended> code, String mimeType)
   {
      ...
      else
      {
         ...
         if (currentToken.getSubTokenList() != null)
         {
            for (TokenImplExtended subtoken : currentToken.getSubTokenList())
            {

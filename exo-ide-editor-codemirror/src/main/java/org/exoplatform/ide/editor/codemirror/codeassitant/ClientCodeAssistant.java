...
import org.exoplatform.ide.editor.codemirror.codeassitant.ui.AssistImportDeclarationForm;
import org.exoplatform.ide.editor.codemirror.codeassitant.ui.AutocompletionForm;
import org.exoplatform.ide.editor.codemirror.codeassitant.ui.TokenWidget;
import org.exoplatform.ide.editor.codemirror.codeassitant.ui.TokenWidgetFactory;
 ...
 * 
 */
public abstract class ClientCodeAssistant implements TokenSelectedHandler, AssistImportDeclarationHandler
{
   ...
   {
      Window.alert("ClientCodeAssistant.onStringSelected()");
   ...
   public void onTokenSelected(TokenWidget value)
   {
      ...
      Window.alert("ClientCodeAssistant.onTokenSelected()");
...
//      }
   ...
   {
      Window.alert("ClientCodeAssistant.onImportTokenSelected()");

...
public class PreviewNetvibesEvent extends GwtEvent<PreviewNetvibesHandler>
{
    ...
    */
   @Override
   public com.google.gwt.event.shared.GwtEvent.Type<PreviewNetvibesHandler> getAssociatedType()
   {
      return TYPE;
   }
    ...
    */
   @Override
   protected void dispatch(PreviewNetvibesHandler handler)
   {
      handler.onPreviewNetvibes(this);
   }

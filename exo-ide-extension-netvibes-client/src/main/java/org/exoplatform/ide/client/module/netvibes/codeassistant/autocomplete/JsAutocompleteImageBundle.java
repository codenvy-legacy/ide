...
import org.exoplatform.ide.client.module.netvibes.NetvibesCss;
...
public interface JsAutocompleteImageBundle extends ClientBundle
{
   ...
   @Source("org/exoplatform/ide/client/module/netvibes.css")
   public NetvibesCss css();
   
   @Source("org/exoplatform/ide/client/module/netvibes/autocomplete/images/method-item.png")
   ImageResource methodItem();
   
   @Source("org/exoplatform/ide/client/module/netvibes/autocomplete/images/function-item.png")
   ImageResource functionItem();
   
   @Source("org/exoplatform/ide/client/module/netvibes/autocomplete/images/property-item.png")
   ImageResource propertyItem();
   
   @Source("org/exoplatform/ide/client/module/netvibes/autocomplete/images/var-item.png")
   ImageResource varItem();
   
   @Source("org/exoplatform/ide/client/module/netvibes/autocomplete/images/keyword.png")

...
class TypeBinding implements ITypeBinding
{
   ...
   public IAnnotationBinding[] getAnnotations()
   {
      ...
      if (refType != null)
      {
         org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding[] internalAnnotations =
         ...
         if (length != 0)
         {
            ...
            {
               org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding internalAnnotation =
      ...
      else if (this.binding.isTypeVariable())
      {
         ...
         switch (declaring.kind())
         {
            case org.eclipse.jdt.client.internal.compiler.lookup.Binding.METHOD :
               ...
               break;
            default :
               org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding typeBinding =
                  (org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding)declaring;
   ...
   public synchronized IMethodBinding[] getDeclaredMethods()
   {
      ...
      try
      {
         ...
         {
            ReferenceBinding referenceBinding = (ReferenceBinding)this.binding;
            org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding[] internalMethods =
   ...
   public ITypeBinding[] getTypeArguments()
   {
      ...
      {
         ParameterizedTypeBinding parameterizedTypeBinding = (ParameterizedTypeBinding)this.binding;
         final org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] arguments =
   ...
   public ITypeBinding[] getTypeBounds()
   {
      ...
      if (this.binding instanceof TypeVariableBinding)
      {
         ...
         org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding firstClassOrArrayBound =
   ...
   public boolean isFromSource()
   {
      ...
      else if (isTypeVariable())
      {
         ...
         {
            final org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding typeBinding =
               (org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding)declaringElement;
            ...
            else if (typeBinding instanceof ArrayBinding)
            {
               ...
               final org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding leafComponentType =

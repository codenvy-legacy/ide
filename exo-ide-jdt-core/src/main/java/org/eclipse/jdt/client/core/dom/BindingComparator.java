...
class BindingComparator
{
   ...
   {
      if (declaringElement instanceof org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding)
      {
         if (!(declaringElement2 instanceof org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding))
         {
            return false;
         }
         return isEqual((org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding)declaringElement,
            (org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding)declaringElement2, visitedTypes);
      }
      else if (declaringElement instanceof org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding)
      {
         if (!(declaringElement2 instanceof org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding))
         {
            return false;
         }
         return isEqual((org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding)declaringElement,
            (org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding)declaringElement2, visitedTypes);
      }
      ...
      else if (declaringElement instanceof org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding)
      {
         if (!(declaringElement2 instanceof org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding))
         {
            return false;
         }
         org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding packageBinding =
            (org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding)declaringElement;
         org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding packageBinding2 =
            (org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding)declaringElement2;
   ...
   static boolean isEqual(org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding methodBinding,
      org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding methodBinding2)
   {
      return isEqual(methodBinding, methodBinding2, new HashSet());
   }

   static boolean isEqual(org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding methodBinding,
      org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding methodBinding2, HashSet visitedTypes)
   {
    ...
    * @return true if both parameters are equals, false otherwise
    */
   static boolean isEqual(org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] bindings,
      org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] otherBindings)
   {
    ...
    */
   static boolean isEqual(org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] bindings,
      org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes)
   {
      if (bindings == null)
      {
         return otherBindings == null;
   ...
   static boolean isEqual(org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding typeBinding,
      org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes)
   {
    ...
    */
   static boolean isEqual(org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding typeBinding,
      org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding typeBinding2)
   {

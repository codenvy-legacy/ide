   ...
   ViewClosedHandler, UpdateOutlineHandler, EditorActiveFileChangedHandler
{
    ...
    */
   @Inject
   public GenerateNewConstructorUsingFieldsPresenter(HandlerManager eventBus, IDE ide, Provider<Display> displayProvider, Dialogs dialogs)
   {
      this.ide = ide;
   ...
   /**
    * @see org.eclipse.jdt.client.event.GenerateNewConstructorUsingFieldsHandler#onGenerateNewConstructorUsingFields(org.eclipse.jdt.client.event.GenerateNewConstructorUsingFieldsEvent)
    */
   @Override

...
public final class AddGetterSetterOperation
{
    ...
    */
   public AddGetterSetterOperation(final ITypeBinding type, final TypeDeclaration typeDeclaration, int insertPos, IDocument document,
   ...
   public final void run() throws CoreException
   {
      try
      {
         ...
         fEdit = astRewrite.rewriteAST(document, JdtExtension.get().getOptions());
         if (fApply)
         {

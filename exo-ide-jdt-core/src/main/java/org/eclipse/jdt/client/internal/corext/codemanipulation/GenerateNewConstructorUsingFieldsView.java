...
public class GenerateNewConstructorUsingFieldsView extends ViewImpl implements Display
{
   ...
   /**
    * @see org.eclipse.jdt.client.internal.corext.codemanipulation.GenerateNewConstructorUsingFieldsPresenter.Display#getConstructorIndex()
    */
   @Override
   ...
   /**
    * @see org.eclipse.jdt.client.internal.corext.codemanipulation.GenerateNewConstructorUsingFieldsPresenter.Display#getGenerateComment()
    */
   @Override
   ...
   /**
    * @see org.eclipse.jdt.client.internal.corext.codemanipulation.GenerateNewConstructorUsingFieldsPresenter.Display#getSelectAllButton()
    */
   @Override

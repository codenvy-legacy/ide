...
public class SuppressWarningsSubProcessor
{
    ...
    * @since 3.6
    */
   private static int addSuppressWarningsProposalIfPossible(IDocument document, ASTNode node, String warningToken,
    ...
    */
   public static void addUnknownSuppressWarningProposals(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
   ...
   public static void addRemoveUnusedSuppressWarningProposals(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {

...
import org.eclipse.jdt.client.internal.corext.fix.UnimplementedCodeFix.MakeTypeAbstractOperation;
...
public class ModifierCorrectionSubProcessor
{
   ...
   public static void addNonAccessibleReferenceProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals, int kind, int relevance) throws CoreException
   {
   ...
   public static void addChangeOverriddenModifierProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals, int kind)
   {
      ...
      if (kind == TO_VISIBLE && problem.getProblemId() != IProblem.OverridingNonVisibleMethod)
      {
         ...
         if (defining != null)
         {
            ...
            String label =
               CorrectionMessages.INSTANCE.INSTANCE
                  .ModifierCorrectionSubProcessor_changemethodvisibility_description(getVisibilityString(includedModifiers));
            Image image = new Image(JdtClientBundle.INSTANCE.correction_change());
   ...
   public static void addNonFinalLocalProposal(IInvocationContext context, IProblemLocation problem,
   ...
   public static void addRemoveInvalidModifiersProposal(IInvocationContext context, IProblemLocation problem,
      ...
      if (binding != null)
      {
         ...
         if (problemId == IProblem.IllegalModifierCombinationFinalVolatileForField)
         {
            proposals.add(new ModifierChangeCorrectionProposal(CorrectionMessages.INSTANCE
               .ModifierCorrectionSubProcessor_removefinal_description(), binding, selectedNode, 0, Modifier.FINAL,
         ...
         if (problemId == IProblem.UnexpectedStaticModifierForField && binding instanceof IVariableBinding)
         {
            ...
            {
               proposals.add(new ModifierChangeCorrectionProposal(CorrectionMessages.INSTANCE
                  .ModifierCorrectionSubProcessor_changemodifiertostaticfinal_description(), binding, selectedNode,
                  Modifier.FINAL, Modifier.VOLATILE, relevance + 1, context.getDocument(), image));
               ASTNode parentType = context.getASTRoot().findDeclaringNode(declClass);
               if (parentType != null)
               {
                  proposals.add(new ModifierChangeCorrectionProposal(CorrectionMessages.INSTANCE
                     .ModifierCorrectionSubProcessor_addstatictoparenttype_description(), declClass, parentType,
                     Modifier.STATIC, 0, relevance - 1, context.getDocument(), image));
               }
            }
         }
   ...
   private static void addMakeTypeAbstractProposal(IInvocationContext context, TypeDeclaration parentTypeDecl,
      Collection<ICommandAccess> proposals)
   {
   ...
   public static void addNativeMethodProposals(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      CompilationUnit astRoot = context.getASTRoot();
   ...
   public static void addNeedToEmulateProposal(IInvocationContext context, IProblemLocation problem,
   ...
   public static void addOverrideAnnotationProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
   ...
   public static void addDeprecatedAnnotationProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      //TODO
   ...
   public static void addOverridingDeprecatedMethodProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
   ...
   public static void removeOverrideAnnotationProposal(IInvocationContext context, IProblemLocation problem,
   ...
   public static void addSynchronizedMethodProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
   ...
   public static void addStaticMethodProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
   ...
   private static void addAddMethodModifierProposal(IInvocationContext context, IProblemLocation problem,

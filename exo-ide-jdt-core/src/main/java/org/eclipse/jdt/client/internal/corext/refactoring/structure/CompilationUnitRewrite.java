...
public class CompilationUnitRewrite
{
   ...
   //	 */
   //	public org.eclipse.jdt.client.internal.corext.refactoring.code.CompilationUnitChange createChange() throws CoreException {
   //		CompilationUnitChange change= createChange(true);
   //		if (change == null)
   //			return null;
   //		return new org.eclipse.jdt.client.internal.corext.refactoring.code.CompilationUnitChange(change);
   //	}

...
public abstract class CompilationUnitContextType extends TemplateContextType
{
   ...
   protected static class Type extends EnclosingJavaElement
   {
      ...
      {
         super(
            "enclosing_type", JavaTemplateMessages.INSTANCE.CompilationUnitContextType_variable_description_enclosing_type(), ASTNode.TYPE_LITERAL); //$NON-NLS-1$
      }
   }
   ...
   // super(org.eclipse.jdt.client.templates.api.GlobalTemplateVariables.LineSelection.NAME,
   ...
   public abstract CompilationUnitContext createContext(IDocument document, int completionPosition, int length,
      CompilationUnit compilationUnit);

   public abstract CompilationUnitContext createContext(IDocument document, Position completionPosition,
      CompilationUnit compilationUnit);

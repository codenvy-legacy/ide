...
public final class LazyGenericTypeProposal extends LazyJavaTypeCompletionProposal
{
   ...
   // * the proposed type, the wildcard type arguments of the proposed type that can be mapped through to type the arguments of
   // the
   // * expected type binding are bound accordingly.
   // * <p>
   // * For type arguments that cannot be mapped to arguments in the expected type, or if there is no expected type, the upper
   // bound
   // * of the type argument is proposed.
   // * </p>
   // * <p>
   // * The argument proposals have their <code>isAmbiguos</code> flag set to <code>false</code> if the argument can be mapped to
   // a

...
public class SourceElementNotifier
{
      ...
      TypeDeclaration declaringType, ImportReference currentPackage)
   {
      ...
      if (methodDeclaration.isConstructor())
      {
         ...
         if (isInRange)
         {
            ...
            boolean deprecated =
               (currentModifiers & ClassFileConstants.AccDeprecated) != 0
      ...
      boolean reportReference, HashtableOfObjectToInt sourceEndsMap, Map nodesToCategoriesMap)
   {
      ...
      try
      {
         ...
         length =
            (currentPackage == null ? 0 : 1) + (imports == null ? 0 : imports.length)
      ...
      switch (fieldDeclaration.getKind())
      {
         case AbstractVariableDeclaration.ENUM_CONSTANT :
            if (this.reportReferenceInfo)
            {
               ...
               if (fieldDeclaration.initialization instanceof AllocationExpression)
               {
                  ...
                  this.requestor.acceptConstructorReference(declaringType.name, alloc.arguments == null ? 0
                     : alloc.arguments.length, alloc.sourceStart);
               }
            }
            // $FALL-THROUGH$
         case AbstractVariableDeclaration.FIELD :
            ...
            if (isInRange)
            {
               ...
               fieldInfo.modifiers =
                  deprecated ? (currentModifiers & ExtraCompilerModifiers.AccJustFlag)
                     | ClassFileConstants.AccDeprecated : currentModifiers & ExtraCompilerModifiers.AccJustFlag;
               ...
               this.requestor
                  .exitField(
                     ...
                     (fieldDeclaration.initialization == null
                        ...
                        || fieldDeclaration.initialization instanceof ArrayReference || fieldDeclaration.initialization instanceof ThisReference)
                        ? -1 : fieldDeclaration.initialization.sourceStart, fieldEndPosition,

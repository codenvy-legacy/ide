...
public class EqualExpression extends BinaryExpression
{
   ...
   //         this.right.generateOptimizedBoolean(currentScope, codeStream, (inline ? trueLabel : falseLabel), (inline
   ...
   //         this.left.generateOptimizedBoolean(currentScope, codeStream, (inline ? trueLabel : falseLabel), (inline
   //            ? falseLabel : trueLabel), valueRequired);
   //         return;
   //      }
   //      // default case

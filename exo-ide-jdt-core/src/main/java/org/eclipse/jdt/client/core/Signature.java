...
public final class Signature
{
    ...
    */
   public static final char C_ARRAY = org.eclipse.jdt.client.internal.compiler.util.Util.C_ARRAY;

   /**
    * Character constant indicating the primitive type boolean in a signature. Value is <code>'Z'</code>.
    */
   public static final char C_BOOLEAN = org.eclipse.jdt.client.internal.compiler.util.Util.C_BOOLEAN;

   /**
    * Character constant indicating the primitive type byte in a signature. Value is <code>'B'</code>.
    */
   public static final char C_BYTE = org.eclipse.jdt.client.internal.compiler.util.Util.C_BYTE;
    ...
    * @since 3.1
    */
   public static final char C_CAPTURE = org.eclipse.jdt.client.internal.compiler.util.Util.C_CAPTURE;

   /**
    * Character constant indicating the primitive type char in a signature. Value is <code>'C'</code>.
    */
   public static final char C_CHAR = org.eclipse.jdt.client.internal.compiler.util.Util.C_CHAR;
    ...
    * @since 3.0
    */
   public static final char C_COLON = org.eclipse.jdt.client.internal.compiler.util.Util.C_COLON;

   /**
    * Character constant indicating the dollar in a signature. Value is <code>'$'</code>.
    */
   public static final char C_DOLLAR = org.eclipse.jdt.client.internal.compiler.util.Util.C_DOLLAR;

   /**
    * Character constant indicating the dot in a signature. Value is <code>'.'</code>.
    */
   public static final char C_DOT = org.eclipse.jdt.client.internal.compiler.util.Util.C_DOT;

   /**
    * Character constant indicating the primitive type double in a signature. Value is <code>'D'</code>.
    */
   public static final char C_DOUBLE = org.eclipse.jdt.client.internal.compiler.util.Util.C_DOUBLE;
    ...
    * @since 3.1
    */
   public static final char C_EXCEPTION_START = org.eclipse.jdt.client.internal.compiler.util.Util.C_EXCEPTION_START;
    ...
    * @since 3.1
    */
   public static final char C_EXTENDS = org.eclipse.jdt.client.internal.compiler.util.Util.C_EXTENDS;

   /**
    * Character constant indicating the primitive type float in a signature. Value is <code>'F'</code>.
    */
   public static final char C_FLOAT = org.eclipse.jdt.client.internal.compiler.util.Util.C_FLOAT;
    ...
    * @since 3.0
    */
   public static final char C_GENERIC_END = org.eclipse.jdt.client.internal.compiler.util.Util.C_GENERIC_END;
    ...
    * @since 3.0
    */
   public static final char C_GENERIC_START = org.eclipse.jdt.client.internal.compiler.util.Util.C_GENERIC_START;

   /**
    * Character constant indicating the primitive type int in a signature. Value is <code>'I'</code>.
    */
   public static final char C_INT = org.eclipse.jdt.client.internal.compiler.util.Util.C_INT;
    ...
    */
   public static final char C_LONG = org.eclipse.jdt.client.internal.compiler.util.Util.C_LONG;

   /**
    * Character constant indicating the end of a named type in a signature. Value is <code>';'</code>.
    */
   public static final char C_NAME_END = org.eclipse.jdt.client.internal.compiler.util.Util.C_NAME_END;

   /**
    * Character constant indicating the end of a parameter type list in a signature. Value is <code>')'</code>.
    */
   public static final char C_PARAM_END = org.eclipse.jdt.client.internal.compiler.util.Util.C_PARAM_END;

   /**
    * Character constant indicating the start of a parameter type list in a signature. Value is <code>'('</code>.
    */
   public static final char C_PARAM_START = org.eclipse.jdt.client.internal.compiler.util.Util.C_PARAM_START;

   /**
    * Character constant indicating the start of a resolved, named type in a signature. Value is <code>'L'</code>.
    */
   public static final char C_RESOLVED = org.eclipse.jdt.client.internal.compiler.util.Util.C_RESOLVED;

   /**
    * Character constant indicating the semicolon in a signature. Value is <code>';'</code>.
    */
   public static final char C_SEMICOLON = org.eclipse.jdt.client.internal.compiler.util.Util.C_SEMICOLON;

   /**
    * Character constant indicating the primitive type short in a signature. Value is <code>'S'</code>.
    */
   public static final char C_SHORT = org.eclipse.jdt.client.internal.compiler.util.Util.C_SHORT;
    ...
    * @since 3.0
    */
   public static final char C_STAR = org.eclipse.jdt.client.internal.compiler.util.Util.C_STAR;
    ...
    * @since 3.1
    */
   public static final char C_SUPER = org.eclipse.jdt.client.internal.compiler.util.Util.C_SUPER;
    ...
    * @since 3.0
    */
   public static final char C_TYPE_VARIABLE = org.eclipse.jdt.client.internal.compiler.util.Util.C_TYPE_VARIABLE;

   /**
    * Character constant indicating the start of an unresolved, named type in a signature. Value is <code>'Q'</code>.
    */
   public static final char C_UNRESOLVED = org.eclipse.jdt.client.internal.compiler.util.Util.C_UNRESOLVED;

   /**
    * Character constant indicating result type void in a signature. Value is <code>'V'</code>.
    */
   public static final char C_VOID = org.eclipse.jdt.client.internal.compiler.util.Util.C_VOID;
    ...
    * @param fullyQualifyTypeNames <code>true</code> if type names should be fully qualified, and <code>false</code> to use only
    *           simple names
    ...
    * @param fullyQualifyTypeNames <code>true</code> if type names should be fully qualified, and <code>false</code> to use only
    *           simple names
    * @param isVarArgs <code>true</code> if the array type must be displayed as a variable argument, <code>false</code> otherwise
    * @return the 0-based character index of the last character
    * @exception IllegalArgumentException if this is not an array type signature
    * @see Util#scanArrayTypeSignature(char[], int)
    */
    ...
    *           simple names
    * @param buffer the string buffer to append to
    * @param isVarArgs <code>true</code> if the type must be displayed as a variable argument, <code>false</code> otherwise. In
    *           this case, the type must be an array type
    * @return the 0-based character index of the last character
    * @exception IllegalArgumentException if this is not a type signature, or if isVarArgs is <code>true</code>, and the type is
...
/**
   ...
   public static String getQualifier(String name)
   {
      ...
      if (qualifier.length == 0)
         return org.eclipse.jdt.client.internal.compiler.util.Util.EMPTY_STRING;
...
/**
    ...
    * @param methodName the name of the method to insert in the result, or <code>null</code> if no method name is to be included
    * @param parameterNames the parameter names to insert in the result, or <code>null</code> if no parameter names are to be
    ...
    *           simple names
    * @param includeReturnType <code>true</code> if the return type is to be included
    * @param isVargArgs <code>true</code> if the last argument should be displayed as a variable argument, <code>false</code>
    *           otherwise.
    * @return the char array representation of the method signature
    * @throws IllegalArgumentException if the method signature is syntactically incorrect
    * 
    ...
    *           simple names
    * @param includeReturnType <code>true</code> if the return type is to be included
    * @param isVarArgs <code>true</code> if the last argument should be displayed as a variable argument, <code>false</code>
    *           otherwise
    * @see #toCharArray(char[], char[], char[][], boolean, boolean)
    * @return the string representation of the method signature
    * 
      ...
      boolean fullyQualifyTypeNames, boolean includeReturnType, boolean isVarArgs)
   {
      ...
      return new String(toCharArray(methodSignature.toCharArray(),
         methodName == null ? null : methodName.toCharArray(), params, fullyQualifyTypeNames, includeReturnType,
         isVarArgs));
   }

...
import org.eclipse.jdt.client.internal.corext.dom.HierarchicalASTVisitor;
...
import org.eclipse.jdt.client.internal.corext.refactoring.rename.TempOccurrenceAnalyzer;
import org.eclipse.jdt.client.internal.corext.refactoring.util.TextChangeCompatibility;
...
public class PromoteTempToFieldRefactoring extends Refactoring
{
    ...
    */
   public PromoteTempToFieldRefactoring(IDocument document, CompilationUnit cu, int selectionStart, int selectionLength)
   {
       ...
       */
      public PromoteTempToFieldRefactoring(VariableDeclaration declaration, IDocument document)
      {
   ...
   */
   ...
   public Change createChange(IProgressMonitor pm) throws CoreException
   {
      ...
      try
      {
         ...
         TextEdit resultingEdits = rewrite.rewriteAST(document, JdtExtension.get().getOptions());

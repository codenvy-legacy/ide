               ...
               CompilationUnit result =
                  CompilationUnitResolver.convert(compilationUnitDeclaration, sourceUnit.getContents(), this.apiLevel,
                     this.compilerOptions, needToResolveBindings, needToResolveBindings
                        ? new DefaultBindingResolver.BindingTables() : null, flags, monitor, false);
               return result;
            }
            finally
            {
   ...
   private ASTNode internalCreateASTForKind()
   {
      ...
      switch (this.astKind)
      {
         case K_STATEMENTS :
            ...
            org.eclipse.jdt.client.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
            if (statements != null)
            {
         ...
         case K_CLASS_BODY_DECLARATIONS :
            final org.eclipse.jdt.client.internal.compiler.ast.ASTNode[] nodes =

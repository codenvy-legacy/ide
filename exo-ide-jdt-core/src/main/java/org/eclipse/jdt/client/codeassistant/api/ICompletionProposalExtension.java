...
public interface ICompletionProposalExtension
{
   ...
   /**
    * Returns the position to which the computed context information refers to or <code>-1</code> if no context information can be
    * provided by this completion proposal.
    * 

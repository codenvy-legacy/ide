...
class BindingResolver
{
    ...
    */
   org.eclipse.jdt.client.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode)
   {
      return null;
   }
    ...
    */
   IMethodBinding getMethodBinding(org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding methodBinding)
   {
      return null;
   }
    ...
    */
   IPackageBinding getPackageBinding(org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding packageBinding)
   {
      return null;
   }
    ...
    */
   IVariableBinding getVariableBinding(org.eclipse.jdt.client.internal.compiler.lookup.VariableBinding binding)
   {
      return null;
   }
    ...
    */
   IAnnotationBinding getAnnotationInstance(org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding instance)
   {
      return null;
   }
    ...
    */
   void store(ASTNode newNode, org.eclipse.jdt.client.internal.compiler.ast.ASTNode oldASTNode)
   {
      // default implementation: do nothing
   }

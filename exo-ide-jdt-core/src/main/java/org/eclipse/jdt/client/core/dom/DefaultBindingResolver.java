...
import org.eclipse.jdt.client.internal.compiler.ast.Literal;
...
class DefaultBindingResolver extends BindingResolver {
	 ...
	 */
	DefaultBindingResolver(CompilationUnitScope scope, BindingTables bindingTables, boolean isRecoveringBindings, boolean fromJavaProject) {
	...
	DefaultBindingResolver(LookupEnvironment lookupEnvironment, BindingTables bindingTables, boolean isRecoveringBindings, boolean fromJavaProject) {
		this.newAstToOldAst = new HashMap();
		this.astNodesToBlockScope = new HashMap();
		this.bindingsToAstNodes = new HashMap();
		this.bindingTables = bindingTables;
	...
	IBinding getBinding(org.eclipse.jdt.client.internal.compiler.lookup.Binding binding) {
		switch (binding.kind()) {
			case Binding.PACKAGE:
				return getPackageBinding((org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding) binding);
			case Binding.TYPE:
			case Binding.BASE_TYPE:
			case Binding.GENERIC_TYPE:
			case Binding.PARAMETERIZED_TYPE:
			case Binding.RAW_TYPE:
				return getTypeBinding((org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding) binding);
			case Binding.ARRAY_TYPE:
			case Binding.TYPE_PARAMETER:
				return new TypeBinding(this, (org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding) binding);
			case Binding.METHOD:
				return getMethodBinding((org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding) binding);
			case Binding.FIELD:
			case Binding.LOCAL:
				return getVariableBinding((org.eclipse.jdt.client.internal.compiler.lookup.VariableBinding) binding);
		}
		return null;
	}
	...
	Util.BindingsToNodesMap getBindingsToNodesMap() {
		return new Util.BindingsToNodesMap() {
			public org.eclipse.jdt.client.internal.compiler.ast.ASTNode get(Binding binding) {
				return (org.eclipse.jdt.client.internal.compiler.ast.ASTNode)
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IMethodBinding getMethodBinding(org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding methodBinding) {
 		if (methodBinding != null && !methodBinding.isValidBinding()) {
			org.eclipse.jdt.client.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding =
				(org.eclipse.jdt.client.internal.compiler.lookup.ProblemMethodBinding) methodBinding;
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IPackageBinding getPackageBinding(org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding packageBinding) {
			...
			switch(referenceBinding.problemId()) {
				...
				case ProblemReasons.NonStaticReferenceInStaticContext :
					if (referenceBinding instanceof ProblemReferenceBinding) {
						...
						org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding binding2 = problemReferenceBinding.closestMatch();
	...
	synchronized IVariableBinding getVariableBinding(org.eclipse.jdt.client.internal.compiler.lookup.VariableBinding variableBinding, VariableDeclaration variableDeclaration) {
		if (this.isRecoveringBindings) {
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IVariableBinding getVariableBinding(org.eclipse.jdt.client.internal.compiler.lookup.VariableBinding variableBinding) {
		if (variableBinding != null) {
			if (variableBinding.isValidBinding()) {
				org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding variableType = variableBinding.type;
	...
	synchronized IAnnotationBinding getAnnotationInstance(org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding internalInstance) {
	...
	boolean isResolvedTypeInferredFromExpectedType(MethodInvocation methodInvocation) {
		...
		if (oldNode instanceof MessageSend) {
			...
			org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding methodBinding = messageSend.binding;
	...
	/**
	 * @see org.eclipse.jdt.client.core.dom.BindingResolver#recordScope(ASTNode, BlockScope)
	 */
	...
	boolean resolveBoxing(Expression expression) {
		org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
		if (node instanceof org.eclipse.jdt.client.internal.compiler.ast.Expression) {
			org.eclipse.jdt.client.internal.compiler.ast.Expression compilerExpression = (org.eclipse.jdt.client.internal.compiler.ast.Expression) node;
	...
	synchronized IMethodBinding resolveConstructor(ClassInstanceCreation expression) {
		org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
		if (node != null && (node.bits & org.eclipse.jdt.client.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
			org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration) node;
	...
	IMethodBinding resolveConstructor(EnumConstantDeclaration enumConstantDeclaration) {
		org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(enumConstantDeclaration);
		if (node instanceof org.eclipse.jdt.client.internal.compiler.ast.FieldDeclaration) {
		...
		try {
			switch(expression.getNodeType()) {
				case ASTNode.CLASS_INSTANCE_CREATION :
					org.eclipse.jdt.client.internal.compiler.ast.ASTNode astNode = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
					if (astNode instanceof org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration) {
						// anonymous type case
						org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration) astNode;
				...
				case ASTNode.SINGLE_MEMBER_ANNOTATION :
					org.eclipse.jdt.client.internal.compiler.ast.Expression compilerExpression = (org.eclipse.jdt.client.internal.compiler.ast.Expression) this.newAstToOldAst.get(expression);
	...
	synchronized IBinding resolveImport(ImportDeclaration importDeclaration) {
		...
		try {
			org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(importDeclaration);
			if (node instanceof ImportReference) {
				ImportReference importReference = (ImportReference) node;
				final boolean isStatic = importReference.isStatic();
				if ((importReference.bits & org.eclipse.jdt.client.internal.compiler.ast.ASTNode.OnDemand) != 0) {
					...
					if (binding != null) {
						if (isStatic) {
							if (binding instanceof org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding) {
								ITypeBinding typeBinding = this.getTypeBinding((org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding) binding);
								return typeBinding == null ? null : typeBinding;
							}
						} else {
							if ((binding.kind() & Binding.PACKAGE) != 0) {
								IPackageBinding packageBinding = getPackageBinding((org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding) binding);
								if (packageBinding == null) {
									return null;
								}
					...
					if (binding != null) {
						if (isStatic) {
							...
							} else if (binding instanceof org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding) {
								// it is a type
								return getMethodBinding((org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding)binding);
							}
						} else {
	...
	synchronized ITypeBinding resolveTypeBindingForName(Name name) {
		org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(name);
		...
		if (node instanceof QualifiedNameReference) {
			...
			if (index < indexOfFirstFieldBinding) {
				...
				if (binding instanceof org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding) {
					return null;
				} else if (binding instanceof org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding) {
					// it is a type
					return this.getTypeBinding((org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding)binding);
				}
				...
				if (qualifiedNameReference.isTypeReference()) {
					...
					org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding type = fieldBinding.declaringClass;
					if (type == null) { // array length scenario
						// use type from first binding (no capture needed for array type)
						switch (qualifiedNameReference.bits & org.eclipse.jdt.client.internal.compiler.ast.ASTNode.RestrictiveFlagMASK) {
							case Binding.FIELD:
			...
			if (index >= 0) {
				...
				if (importReferenceLength == index) {
					try {
						binding = this.scope.getImport(CharOperation.subarray(importReference.tokens, 0, index), (importReference.bits & org.eclipse.jdt.client.internal.compiler.ast.ASTNode.OnDemand) != 0, importReference.isStatic());
					} catch (AbortCompilation e) {
						// see https://bugs.eclipse.org/bugs/show_bug.cgi?id=53357
					}
				} else {
			...
			org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration) node;
			ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
			if (typeBinding != null) {
				return typeBinding;
			}
			...
			org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding binding = singleTypeReference.resolvedType;
			if (binding != null) {
		...
		} else if (node instanceof org.eclipse.jdt.client.internal.compiler.ast.TypeParameter) {
			org.eclipse.jdt.client.internal.compiler.ast.TypeParameter typeParameter = (org.eclipse.jdt.client.internal.compiler.ast.TypeParameter) node;
			return this.getTypeBinding(typeParameter.binding);
		} else if (node instanceof org.eclipse.jdt.client.internal.compiler.ast.MemberValuePair) {
			org.eclipse.jdt.client.internal.compiler.ast.MemberValuePair memberValuePair = (org.eclipse.jdt.client.internal.compiler.ast.MemberValuePair) node;
	...
	synchronized IBinding resolveName(Name name) {
		...
		if (node instanceof QualifiedNameReference) {
				...
				if (qualifiedNameReference.isTypeReference()) {
					...
					if (binding != null) {
						if (binding.isValidBinding()) {
							return this.getVariableBinding((org.eclipse.jdt.client.internal.compiler.lookup.VariableBinding) binding);
			...
			if (index >= 0) {
				...
				if (binding != null) {
					if (binding instanceof org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding) {
						...
						// it is a type
						return this.getTypeBinding((org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding)binding);
					} else if (binding instanceof org.eclipse.jdt.client.internal.compiler.lookup.FieldBinding) {
						// it is a type
						return this.getVariableBinding((org.eclipse.jdt.client.internal.compiler.lookup.FieldBinding)binding);
					} else if (binding instanceof org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding) {
						// it is a type
						return getMethodBinding((org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding)binding);
					} else {
			...
			org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration type = types[0];
			if (type != null) {
	...
	synchronized IPackageBinding resolvePackage(PackageDeclaration pkg) {
		if (this.scope == null) return null;
		try {
			org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(pkg);
			if (node instanceof ImportReference) {
				ImportReference importReference = (ImportReference) node;
	...
	synchronized IBinding resolveReference(MemberRef ref) {
		org.eclipse.jdt.client.internal.compiler.ast.Expression expression = (org.eclipse.jdt.client.internal.compiler.ast.Expression) this.newAstToOldAst.get(ref);
     ...
     * @since 3.2
	 */
	synchronized IMemberValuePairBinding resolveMemberValuePair(org.eclipse.jdt.client.core.dom.MemberValuePair memberValuePair) {
	...
	ITypeBinding resolveType(AnnotationTypeDeclaration type) {
		...
		if (node instanceof org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration) {
			org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration typeDeclaration = (org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration) node;
			ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
			if (typeBinding == null) {
				return null;
	...
	synchronized ITypeBinding resolveType(AnonymousClassDeclaration type) {
		org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(type);
		if (node != null && (node.bits & org.eclipse.jdt.client.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
			org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration) node;
	...
	synchronized ITypeBinding resolveType(Type type) {
		...
		org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = (org.eclipse.jdt.client.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(type);
		org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding binding = null;
		if (node != null) {
			if (node instanceof ParameterizedQualifiedTypeReference) {
				...
				org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding typeBinding = typeReference.resolvedType;
				if (type.isArrayType()) {
					if (this.scope == null) {
						return null;
					}
			...
			if (((PrimitiveType) type).getPrimitiveTypeCode() == PrimitiveType.VOID) {
				return this.getTypeBinding(org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.VOID);
			}
		}
		return null;
	}
	...
	synchronized ITypeBinding resolveTypeParameter(TypeParameter typeParameter) {
		...
		if (node instanceof org.eclipse.jdt.client.internal.compiler.ast.TypeParameter) {
			org.eclipse.jdt.client.internal.compiler.ast.TypeParameter typeParameter2 = (org.eclipse.jdt.client.internal.compiler.ast.TypeParameter) node;
	...
	synchronized IVariableBinding resolveVariable(VariableDeclaration variable) {
		...
		if (node instanceof AbstractVariableDeclaration) {
			...
			if (abstractVariableDeclaration instanceof org.eclipse.jdt.client.internal.compiler.ast.FieldDeclaration) {
				org.eclipse.jdt.client.internal.compiler.ast.FieldDeclaration fieldDeclaration = (org.eclipse.jdt.client.internal.compiler.ast.FieldDeclaration) abstractVariableDeclaration;
	...
	synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode) {
		...
		if (oldNode instanceof org.eclipse.jdt.client.internal.compiler.ast.Annotation) {
			org.eclipse.jdt.client.internal.compiler.ast.Annotation internalAstNode =
				(org.eclipse.jdt.client.internal.compiler.ast.Annotation) oldNode;
	...
	ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions) {
		...
		if (typeBinding.isArray()) {
 		...
 		org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding leafTypeBinding = null;
 		if (leafComponentType.isPrimitive()) {
 	 		String name = leafComponentType.getBinaryName();
			switch(name.charAt(0)) {
				case 'I' :
					leafTypeBinding = org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.INT;
					break;
				case 'B' :
					leafTypeBinding = org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.BYTE;
					break;
				case 'Z' :
					leafTypeBinding = org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.BOOLEAN;
					break;
				case 'C' :
					leafTypeBinding = org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.CHAR;
					break;
				case 'J' :
					leafTypeBinding = org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.LONG;
					break;
				case 'S' :
					leafTypeBinding = org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.SHORT;
					break;
				case 'D' :
					leafTypeBinding = org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.DOUBLE;
					break;
				case 'F' :
					leafTypeBinding = org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding.FLOAT;
					break;
				case 'V' :

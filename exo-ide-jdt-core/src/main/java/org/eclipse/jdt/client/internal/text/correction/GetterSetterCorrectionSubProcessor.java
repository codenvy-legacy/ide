...
public class GetterSetterCorrectionSubProcessor
{
   ...
   private static class ProposalParameter
   {
      ...
      public ProposalParameter(IDocument document, boolean useSuper, ASTRewrite rewrite, Expression accessNode,
    ...
    */
   public static boolean addGetterSetterProposal(IInvocationContext context, ASTNode coveringNode,
   ...
   public static void addGetterSetterProposal(IInvocationContext context, IProblemLocation location,
   ...
   private static boolean addGetterSetterProposal(IInvocationContext context, ASTNode coveringNode,
      Collection<ICommandAccess> proposals, int relevance)
   {
   ...
   private static ChangeCorrectionProposal getProposal(IDocument document, SimpleName sn,
   ...
   private static ChangeCorrectionProposal addGetterProposal(ProposalParameter context, int relevance)
   {
      ...
      if (method != null)
      {
         ...
         String label =
            ...
            CorrectionMessages.INSTANCE.GetterSetterCorrectionSubProcessor_replacewithgetter_description(ASTNodes
               .asString(context.accessNode));

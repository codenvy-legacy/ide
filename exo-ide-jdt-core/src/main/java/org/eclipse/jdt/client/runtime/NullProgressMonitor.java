...
public class NullProgressMonitor implements IProgressMonitor
{
   ...
   /**
    * This implementation returns the value of the internal state variable set by <code>setCanceled</code>. Subclasses which
    * override this method should override <code>setCanceled</code> as well.
    * 
   ...
   /**
    * This implementation sets the value of an internal state variable. Subclasses which override this method should override
   ...
   /**
    * This implementation does nothing. Subclasses may override this method to do interesting processing when some work has been
    * completed.
    * 

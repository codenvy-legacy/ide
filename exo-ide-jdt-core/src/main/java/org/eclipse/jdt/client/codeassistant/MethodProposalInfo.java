...
public final class MethodProposalInfo extends MemberProposalInfo
{
    ...
    */
   public MethodProposalInfo(CompletionProposal proposal)
   {
      super(proposal);
   }
   ...
   // * @throws JavaModelException if the method does not exist or if an exception occurs while accessing its corresponding
   // resource
   // */
   // private IMethod findMethod(String name, String[] paramTypes, boolean isConstructor, IMethod[] methods, Map<String, char[]>
   // typeVariables) throws JavaModelException {
   ...
   // resource
   // */
   // private boolean isSameMethodSignature(String name, String[] paramTypes, boolean isConstructor, IMethod method, Map<String,
   // char[]> typeVariables) throws JavaModelException {

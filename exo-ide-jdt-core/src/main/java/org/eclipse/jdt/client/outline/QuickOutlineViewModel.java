...
public class QuickOutlineViewModel implements TreeViewModel
{
   ...
   private class FilterNodeVisitor extends GenericVisitor
   {
      ...
      /**
       * @see org.eclipse.jdt.client.internal.corext.dom.GenericVisitor#visit(org.eclipse.jdt.client.core.dom.AnonymousClassDeclaration)
       */
      @Override
      public boolean visit(AnonymousClassDeclaration node)
      {
      ...
      /**
       * @see org.eclipse.jdt.client.internal.corext.dom.GenericVisitor#visit(org.eclipse.jdt.client.core.dom.AnnotationTypeDeclaration)
       */
      @Override
      public boolean visit(AnnotationTypeDeclaration node)
      {

   ...
   private static String getLineSeparator(char[] text, char[] buffer)
   {
      ...
      if (lineSeparator == null)
      {
         ...
         if (lineSeparator == null)
         {
            ...
            return org.eclipse.jdt.client.internal.compiler.util.Util.LINE_SEPARATOR;
         ...
         switch (current)
         {
            case ARGUMENTS_DELIMITER :
               ...
               else
               {
                  ...
                  {
                     currentArgumentContents = org.eclipse.jdt.client.internal.compiler.util.Util.EMPTY_STRING;
                  }
...
//   }
   ...
   public static int scanTypeSignature(char[] string, int start)
   {
      ...
      return org.eclipse.jdt.client.internal.compiler.util.Util.scanTypeSignature(string, start);
   }
   ...
   static void appendTypeSignature(char[] string, int start, StringBuffer buffer, boolean compact)
   {
      ...
      switch (c)
      {
         ...
         case Signature.C_TYPE_VARIABLE :
            int e = org.eclipse.jdt.client.internal.compiler.util.Util.scanTypeVariableSignature(string, start);
   ...
   public static String typeSignature(TypeReference type)
   {
      ...
      if ((type.bits & org.eclipse.jdt.client.internal.compiler.ast.ASTNode.IsUnionType) != 0)
      {

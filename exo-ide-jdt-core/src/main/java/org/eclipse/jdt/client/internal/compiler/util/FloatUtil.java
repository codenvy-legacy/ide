...
public class FloatUtil
{
   ...
   public static float valueOfHexFloatLiteral(char[] source)
   {
      ...
      return MathUtil.intBitsToFloat((int)bits);
   }
   ...
   private static long convertHexFloatingPointLiteralToBits(char[] source)
   {
      ...
      if (doublePrecision)
      {
         ...
         if (e - 1 > MAX_DOUBLE_EXPONENT)
         {
            ...
            result = MathUtil.doubleToLongBits(Double.POSITIVE_INFINITY);
         }
         ...
         else
         {
            ...
            result = MathUtil.doubleToLongBits(Double.NaN);
         }
         return result;
      }
      ...
      {
         // overflow to +infinity
         result = MathUtil.floatToIntBits(Float.POSITIVE_INFINITY);
      }
      ...
      else
      {
         ...
         result = MathUtil.floatToIntBits(Float.NaN);
      }
      return result;
   }
}

...
class PackageBinding implements IPackageBinding
{
   ...
   private org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding binding;
   ...
   PackageBinding(org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding binding, BindingResolver resolver)
   {
   ...
   public boolean isEqualTo(IBinding other)
   {
      ...
      org.eclipse.jdt.client.internal.compiler.lookup.PackageBinding packageBinding2 = ((PackageBinding)other).binding;

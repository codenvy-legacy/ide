...
public class FindReplaceDocumentAdapter implements CharSequence
{
   ...
   private MatchResult fFindReplaceMatcher;
   ...
   // // if (fFindReplaceMatcher != null && fFindReplaceMatcher.getInput().equals(findString)
   ...
   // // else
   // // {
   // RegExp pattern = RegExp.compile(findString, patternFlags);
   // fFindReplaceMatcher = pattern.exec(String.valueOf(this));
   // // }
   // }
   //
   // // Set state
   ...
   // int length = -1;
   // while (found
   // && fFindReplaceMatcher.start() + fFindReplaceMatcher.group().length() <= fFindReplaceMatchOffset + 1)
   // {
   ...
   // {
   //            String message = "Find pattern too complex"; //$NON-NLS-1$
   ...
   // {
   //                        String msg = "Illegal position for \\R"; //$NON-NLS-1$
   ...
   /**
    * Interprets current Retain Case mode (all upper-case,all lower-case,capitalized or mixed) and appends the character
   ...
   // else
   // {
   //               String msg = "Illegal control escape sequence \\c"; //$NON-NLS-1$ //$NON-NLS-2$
   ...
   // {
   //                  String msg = "Illegal hexadecimal escape sequence " + replaceText.substring(i - 1, i + 3); //$NON-NLS-1$
   // throw new PatternSyntaxException(msg, replaceText, i);
   // }
   ...
   // else
   // {
   //               String msg = "Illegal hexadecimal escape sequence " + replaceText.substring(i - 1, length); //$NON-NLS-1$
   // throw new PatternSyntaxException(msg, replaceText, i);
   // }
   // break;
   //
   ...
   // catch (NumberFormatException e)
   // {
   //                  String msg = "Illegal Unicode escape sequence " + replaceText.substring(i - 1, i + 5); //$NON-NLS-1$
   // throw new PatternSyntaxException(msg, replaceText, i);
   // }
   // interpretRetainCase(buf, (char)parsedInt);
   // i += 4;
   ...
   // else
   // {
   //               String msg = "Illegal Unicode escape sequence " + replaceText.substring(i - 1, length); //$NON-NLS-1$
   // throw new PatternSyntaxException(msg, replaceText, i);
   // }
   // break;
   //

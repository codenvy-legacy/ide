...
import org.eclipse.jdt.client.internal.corext.util.Messages;
...
//		ICompilationUnit unit= cuRewrite.getCu();
		...
		for (int i= 0; i < unimplementedMethods.length; i++) {
			...
			MethodDeclaration newMethodDecl= StubUtility2.createImplementationStub(rewrite, imports, context, curr, curr.getDeclaringClass().getName(), settings, false);

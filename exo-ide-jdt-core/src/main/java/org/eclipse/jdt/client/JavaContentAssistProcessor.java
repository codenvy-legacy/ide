...
//         {
    ...
    * @return
    */
   private CompletionProposalCollector createCollector(IDocument document, org.eclipse.jdt.client.core.dom.CompilationUnit unit, int completionPosition,
      FileModel currentFile)
   {
      ...
      collector
         .setAllowsRequiredProposals(
            org.eclipse.jdt.client.core.CompletionProposal.CONSTRUCTOR_INVOCATION, org.eclipse.jdt.client.core.CompletionProposal.TYPE_REF, true);
      ...
      collector.setAllowsRequiredProposals(org.eclipse.jdt.client.core.CompletionProposal.ANONYMOUS_CLASS_DECLARATION, org.eclipse.jdt.client.core.CompletionProposal.TYPE_REF,
         true);

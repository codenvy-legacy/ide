...
public class StringMatcher
{
   ...
   /**
    * StringMatcher constructor takes in a String object that is a simple pattern. The pattern may contain '*' for 0 and many
    ...
    *         of the first occurrence of the pattern in the specified range of the text; return null if not found or subtext is
    *         empty (start==end). A pair of zeros is returned if pattern is empty string Note that for pattern like "*abc*" with
    *         leading and trailing stars, position of "abc" is returned. For a pattern like"*??*" in text "abcdf", (1,3) is
    *         returned
    */

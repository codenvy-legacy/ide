...
class MemberValuePairBinding implements IMemberValuePairBinding {
	...
	static Object buildDOMValue(final Object internalObject, BindingResolver resolver) {
		...
		} else if (internalObject instanceof org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding) {
			return resolver.getTypeBinding((org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding) internalObject);
		} else if (internalObject instanceof org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding) {
			return resolver.getAnnotationInstance((org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding) internalObject);
		} else if (internalObject instanceof org.eclipse.jdt.client.internal.compiler.lookup.FieldBinding) {
			return resolver.getVariableBinding((org.eclipse.jdt.client.internal.compiler.lookup.FieldBinding) internalObject);

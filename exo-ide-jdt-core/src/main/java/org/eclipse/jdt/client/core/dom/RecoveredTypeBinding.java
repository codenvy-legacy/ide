...
class RecoveredTypeBinding implements ITypeBinding {
	...
	private org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding binding;
	...
	RecoveredTypeBinding(BindingResolver resolver, org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding typeBinding) {
		this.resolver = resolver;

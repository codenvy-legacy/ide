...
class CompilationUnitResolver extends Compiler
{
   ...
   public synchronized void accept(org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit sourceUnit,
    ...
    */
   protected void beginToCompile(org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit[] sourceUnits,
      String[] bindingKeys)
   {
      ...
      {
         org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit sourceUnit = sourceUnits[i];
   ...
   public static CompilationUnit convert(CompilationUnitDeclaration compilationUnitDeclaration, char[] source,
      int apiLevel, Map options, boolean needToResolveBindings, DefaultBindingResolver.BindingTables bindingTables,
      int flags, IProgressMonitor monitor, boolean fromJavaProject)
   {
   ...
   public static CompilationUnitDeclaration parse(org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit sourceUnit,
      NodeSearcher nodeSearcher, Map settings, int flags)
   {
      ...
      if (nodeSearcher != null)
      {
         ...
         org.eclipse.jdt.client.internal.compiler.ast.ASTNode node = nodeSearcher.found;
         if (node == null)
         {
            return compilationUnitDeclaration;
         }

         org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration enclosingTypeDeclaration = nodeSearcher.enclosingType;
         ...
         else if (enclosingTypeDeclaration != null)
         {
            ...
            {
               ((org.eclipse.jdt.client.internal.compiler.ast.Initializer)node).parseStatements(parser,
            ...
            {
               ((org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration)node).parseMethods(parser,
   ...
   //TODO
   public static CompilationUnitDeclaration resolve(org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit sourceUnit,
...
//         }
   ...
   {
      final org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration[] types = compilationUnitDeclaration.types;
      if (types != null)
      {
   ...
   private void removeUnresolvedBindings(org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration type)
   {
      final org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration[] memberTypes = type.memberTypes;
      if (memberTypes != null)
      {
      ...
      final org.eclipse.jdt.client.internal.compiler.ast.FieldDeclaration[] fields = type.fields;
      if (fields != null)
      {
...
//   }
      ...
      FileASTRequestor astRequestor, int apiLevel, Map compilerOptions, int flags)
   {
      ...
      try
      {
         ...
         org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit[] sourceUnits =
            new org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit[length];
         int count = 0;
         for (int i = 0; i < length; i++)
         {
            char[] contents = null;
         ...
         for (int i = 0; i < this.totalUnits; i++)
         {
            ...
            try
            {
               ...
               // requested AST
               char[] fileName = unit.compilationResult.getFileName();
               org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit source =
                  (org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit)this.requestedSources.get(fileName);
               if (source != null)
               {
                  // convert AST
                  CompilationResult compilationResult = unit.compilationResult;
                  org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit sourceUnit = compilationResult.compilationUnit;
                  char[] contents = sourceUnit.getContents();
                  AST ast = AST.newAST(apiLevel);
                  ast.setFlag(flags | AST.RESOLVED_BINDINGS);
                  ast.setDefaultNodeFlag(ASTNode.ORIGINAL);
   ...
   private CompilationUnitDeclaration resolve(CompilationUnitDeclaration unit,
      org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit sourceUnit, NodeSearcher nodeSearcher,
      boolean verifyMethods, boolean analyzeCode, boolean generateCode)
   {
      ...
      try
      {
         ...
         if (unit == null)
         {
            ...
            beginToCompile(new org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit[]{sourceUnit});
         ...
         else
         {
            ...
            if (searchPosition >= 0 && searchPosition <= length)
            {
               ...
               if (node != null)
               {
                  ...
                  org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration enclosingTypeDeclaration =
                  ...
                  else if (enclosingTypeDeclaration != null)
                  {
                     if (node instanceof org.eclipse.jdt.client.internal.compiler.ast.Initializer)
                     {
                        ((org.eclipse.jdt.client.internal.compiler.ast.Initializer)node).parseStatements(this.parser,
                           enclosingTypeDeclaration, unit);
                     }
                     else if (node instanceof org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration)
                     {
                        ((org.eclipse.jdt.client.internal.compiler.ast.TypeDeclaration)node).parseMethods(this.parser, unit);
                     }
                  }
    ...
    */
   public CompilationUnitDeclaration resolve(org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit sourceUnit,
      boolean verifyMethods, boolean analyzeCode, boolean generateCode)
   {
   ...
   public CompilationUnitDeclaration resolve(CompilationUnitDeclaration unit,
      org.eclipse.jdt.client.internal.compiler.env.ICompilationUnit sourceUnit, boolean verifyMethods, boolean analyzeCode,

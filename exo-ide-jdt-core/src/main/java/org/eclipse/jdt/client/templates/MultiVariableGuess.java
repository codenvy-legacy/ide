...
public class MultiVariableGuess {
	...
	private static class Proposal implements ICompletionProposal {
		 ...
		 */
		public Proposal(String replacementString, int replacementOffset, int replacementLength, int cursorPosition, Image image, String displayString, IContextInformation contextInformation, Widget additionalProposalInfo) {

...
public class DefaultCodeFormatterConstants
{
     ...
     * </pre>
     * 
     * Note: Import groups are defined once "Organize Import" operation has been executed. The code formatter itself doesn't define the
     * import groups.
     * 
     * @since 3.3
     */
    ...
    public final static String                    FORMATTER_COMMENT_FORMAT                                                            =
                                                                                                                                        "org.eclipse.jdt.core.formatter.comment.format_comments";                                    //$NON-NLS-1$
     ...
     * </pre>
     * 
     * Note that this option is ignored if either the {@link #FORMATTER_COMMENT_FORMAT_LINE_COMMENT} option has been set to {@link #FALSE}
     * or the formatter is created with the mode {@link ToolFactory#M_FORMAT_NEW}.
     * 
     * @see #TRUE
     * @see #FALSE
    ...
    public final static String                    FORMATTER_COMMENT_FORMAT_HEADER                                                     =
                                                                                                                                        "org.eclipse.jdt.core.formatter.comment.format_header";                                      //$NON-NLS-1$
    ...
    public final static String                    FORMATTER_COMMENT_FORMAT_HTML                                                       =
                                                                                                                                        "org.eclipse.jdt.core.formatter.comment.format_html";                                        //$NON-NLS-1$
    ...
    public final static String                    FORMATTER_COMMENT_LINE_LENGTH                                                       =
                                                                                                                                        "org.eclipse.jdt.core.formatter.comment.line_length";                                        //$NON-NLS-1$
    ...
    */
     ...
     * @see JavaCore#DO_NOT_INSERT
     * @since 3.1
     * @deprecated All new options must be enabled to activate old strategy {@link #FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION_ON_MEMBER}
     ...
     * @see JavaCore#DO_NOT_INSERT
     * @since 3.4
     * @deprecated All new options must be enabled to activate old strategy {@link #FORMATTER_INSERT_NEW_LINE_AFTER_ANNOTATION_ON_FIELD}
     ...
     * </pre>
     * <p>
     * This option changes the formatter behavior when nested method calls are encountered. Since 3.6, the formatter tries to wrap outermost
     * method calls first to have a better output.
     * </p>
     * <p>
     * For example, let's say we are using the Eclipse built-in profile with a max line width=40+space for tab policy. Then consider the
     * following snippet:
     * </p>
     * 
     * <pre>
     ...
     * </pre>
     * <p>
     * With this new strategy, the formatter will wrap the line earlier, between the arguments of the message call for this example, and
     * then it will allow to keep each nested call on a single line.
     * </p>
     * <p>
     ...
     * </p>
     * <ol>
     * <li>This new behavior is automatically activated (i.e. the default value for this preference is {@link #TRUE}). If the backward
     * compatibility regarding previous versions' formatter behavior (i.e. before 3.6 version) is necessary, then the preference needs to be
     * set to {@link #FALSE} to retrieve the previous formatter behavior.</li>
     * <li>The new strategy currently only applies to nested method calls, but might be extended to other nested expressions in future
     * versions</li>
     * </ol>
     * 
     * @see #TRUE
     ...
     * @see #createAlignmentValue(boolean, int, int)
     * @exception IllegalArgumentException if the given alignment value is null, if the given indentation style is not one of the possible
     ...
     * @see #createAlignmentValue(boolean, int, int)
     * @exception IllegalArgumentException if the given alignment value is null, if the given wrapping style is not one of the possible

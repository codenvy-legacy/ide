...
public abstract class CompilationUnitContext extends DocumentTemplateContext {
	 ...
	 */
	protected CompilationUnitContext(TemplateContextType type, IDocument document, int completionOffset, int completionLength, CompilationUnit compilationUnit) {
	 ...
	 * @since 3.2
	 */
	protected CompilationUnitContext(TemplateContextType type, IDocument document, Position completionPosition, CompilationUnit compilationUnit) {

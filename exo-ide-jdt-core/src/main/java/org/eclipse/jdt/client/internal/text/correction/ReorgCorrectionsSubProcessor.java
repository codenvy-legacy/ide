...
public class ReorgCorrectionsSubProcessor {
    ...
    public static void removeImportStatementProposals(IInvocationContext context, IProblemLocation problem,
        ...
        ChangeCorrectionProposal proposal =
                new ChangeCorrectionProposal(name, null, 5, new Image(JdtClientBundle.INSTANCE.correction_change())) {
                    @Override
    ...
    public static void getAccessRulesProposals(IInvocationContext context, IProblemLocation problem,
                                               Collection<ICommandAccess> proposals) {

...
public class NewDefiningMethodProposal extends AbstractMethodCorrectionProposal {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.jdt.internal.ui.text.correction.proposals.AbstractMethodCorrectionProposal#addNewTypeParameters(org.eclipse.jdt
     * .core.dom.rewrite.ASTRewrite, java.util.List, java.util.List)
     */
    @Override

...
public abstract class CompilationProgress
{
   ...
   /**
    * Notifies that the compilation is beginning. This is called exactly once per batch compilation. An estimated amount of
    * remaining work is given. This amount will change as the compilation progresses. The new estimated amount of remaining work
    * is reported using {@link #worked(int, int)}.
    * <p>
   ...
   /**
    * Notifies that the work is done; that is, either the compilation is completed or a cancellation was requested. This is called
    * exactly once per batch compilation.
    * <p>
    * Clients should not call this method.
    * </p>
    */
   ...
   /**
    * Notifies that a given amount of work of the compilation has been completed. Note that this amount represents an installment,
    * as opposed to a cumulative amount of work done to date. Also notifies an estimated amount of remaining work. Note that this
    * amount of remaining work may be greater than the previous estimated amount as new compilation units are injected in the
    * compile loop.
    * <p>
    * Clients should not call this method.
    * </p>

...
class MethodBinding implements IMethodBinding
{
   ...
   public IAnnotationBinding[] getParameterAnnotations(int index)
   {
      ...
      org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations =
      ...
      for (int i = 0; i < length; i++)
      {
         org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations =
   ...
   public ITypeBinding[] getTypeArguments()
   {
      ...
      if (this.binding instanceof ParameterizedGenericMethodBinding)
      {
         ...
         org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] typeArgumentsBindings =

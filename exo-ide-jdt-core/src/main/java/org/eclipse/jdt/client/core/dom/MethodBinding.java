...
class MethodBinding implements IMethodBinding {
	...
	private org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding binding;
	...
	MethodBinding(BindingResolver resolver, org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding binding) {
	...
	public IAnnotationBinding[] getAnnotations() {
		...
		org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding[] internalAnnotations = this.binding.getAnnotations();
	...
	public IAnnotationBinding[] getParameterAnnotations(int index) {
		...
		org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations = this.binding.getParameterAnnotations();
		...
		for (int i = 0; i < length; i++) {
			org.eclipse.jdt.client.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations = bindingAnnotations[i];
	...
	public ITypeBinding[] getParameterTypes() {
		...
		org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] parameters = this.binding.parameters;
	...
	public ITypeBinding[] getExceptionTypes() {
		...
		org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] exceptions = this.binding.thrownExceptions;
	...
	/**
	 * @see org.eclipse.jdt.client.core.dom.IMethodBinding#isVarargs()
	 * @since 3.1
	 */
	...
	public boolean isEqualTo(IBinding other) {
		...
		org.eclipse.jdt.client.internal.compiler.lookup.MethodBinding otherBinding = ((MethodBinding) other).binding;
	...
	/**
	 * @see org.eclipse.jdt.client.core.dom.IMethodBinding#isGenericMethod()
	 * @since 3.1
	 */
	...
	public ITypeBinding[] getTypeArguments() {
		...
		if (this.binding instanceof ParameterizedGenericMethodBinding) {
			...
			org.eclipse.jdt.client.internal.compiler.lookup.TypeBinding[] typeArgumentsBindings = genericMethodBinding.typeArguments;

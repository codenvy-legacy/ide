...
import org.eclipse.jdt.client.core.dom.EmptyStatement;
...
import org.eclipse.jdt.client.core.dom.InstanceofExpression;
...
import org.eclipse.jdt.client.internal.corext.dom.BodyDeclarationRewrite;
...
import org.eclipse.jdt.client.internal.corext.fix.CodeStyleCleanUp;
...
import org.eclipse.jdt.client.internal.corext.fix.UnimplementedCodeCleanUp;
import org.eclipse.jdt.client.internal.corext.fix.UnimplementedCodeFix;
import org.eclipse.jdt.client.internal.corext.fix.UnnecessaryCodeCleanUp;
...
import org.eclipse.jdt.client.internal.corext.refactoring.sorround.ExceptionAnalyzer;
import org.eclipse.jdt.client.internal.corext.refactoring.sorround.SurroundWithTryCatchRefactoring;
...
import org.eclipse.jdt.client.internal.text.correction.proposals.ChangeMethodSignatureProposal;
import org.eclipse.jdt.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.ChangeDescription;
import org.eclipse.jdt.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.InsertDescription;
import org.eclipse.jdt.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.RemoveDescription;
import org.eclipse.jdt.client.internal.text.correction.proposals.ConstructorFromSuperclassProposal;
...
import org.eclipse.jdt.client.internal.text.correction.proposals.MissingAnnotationAttributesProposal;
...
public class LocalCorrectionsSubProcessor
{
   ...
   public static void addUncaughtExceptionProposals(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals) throws CoreException
   {
      ...
      if (refactoring.checkActivationBasics(context.getDocument(), astRoot).isOK())
      {
         ...
         CUCorrectionProposal proposal =
            new CUCorrectionProposal(label, (CompilationUnitChange)refactoring.createChange(null), 6,
   ...
   public static void addUnreachableCatchProposals(IInvocationContext context, IProblemLocation problem,
   ...
   public static void addUninitializedLocalVariableProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      ASTNode selectedNode = problem.getCoveringNode(context.getASTRoot());
   ...
   public static void addConstructorFromSuperclassProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals) throws CoreException
   {
      ASTNode selectedNode = problem.getCoveringNode(context.getASTRoot());
      if (selectedNode == null)
   ...
   public static void addUnusedMemberProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
   ...
   public static void addRedundantSuperInterfaceProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      ASTNode selectedNode = problem.getCoveringNode(context.getASTRoot());
      if (!(selectedNode instanceof Name))
   ...
   private static void addProposal(IInvocationContext context, Collection<ICommandAccess> proposals,
   ...
   public static void addSuperfluousSemicolonProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
   ...
   public static void addUnnecessaryInstanceofProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      ASTNode selectedNode = problem.getCoveringNode(context.getASTRoot());
   ...
   public static void addUnnecessaryThrownExceptionProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      ASTNode selectedNode = problem.getCoveringNode(context.getASTRoot());
   ...
   public static void addUnqualifiedFieldAccessProposal(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      IProposableFix fix =
   ...
   public static void addInvalidVariableNameProposals(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
   ...
   public static void getInvalidOperatorProposals(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      CompilationUnit root = context.getASTRoot();
      AST ast = root.getAST();
   ...
   private static void addRemoveIncludingConditionProposal(IInvocationContext context, ASTNode toRemove,
   ...
   private static ASTRewriteCorrectionProposal createNoSideEffectProposal(IInvocationContext context,
      SimpleName nodeToQualify, IVariableBinding fieldBinding, String label, int relevance)
   {
   ...
   public static void addFallThroughProposals(IInvocationContext context, IProblemLocation problem,
      Collection<ICommandAccess> proposals)
   {
      ASTNode selectedNode = problem.getCoveringNode(context.getASTRoot());
         ...
         && selectedNode.getLocationInParent() == SwitchStatement.STATEMENTS_PROPERTY)
      {
         ...
         image = new Image(JdtClientBundle.INSTANCE.correction_change());
   ...
   public static ASTRewriteCorrectionProposal createMissingEnumConstantCaseProposals(IInvocationContext context,
      SwitchStatement switchStatement, String[] enumConstNames)
   {
      ...
      Collection<ICommandAccess> proposals)
   {
      ...
      if (hasInstanceFields)
      {
         ...
         ChangeCorrectionProposal proposal = new ChangeCorrectionProposal(label, null, 3, image)
         {
            ...
            {
               System.out
                  .println("LocalCorrectionsSubProcessor.addMissingHashCodeProposals(...).new ChangeCorrectionProposal() {...}.apply()");
               //TODO
               //               IEditorInput input = new FileEditorInput((IFile)cu.getResource());
               //               IWorkbenchPage p = JavaPlugin.getActivePage();
               //               if (p == null)

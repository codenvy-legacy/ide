...
public final class JavaCore
{
   ...
   // }
   //
   // private static void verbose_failed_to_instanciate_container_initializer(String containerID, IConfigurationElement
   ...
   // }
   //
   // // even if persisted value exists, initializer is given priority, only if no initializer is found the persisted value is
   // reused
   ...
   // if (variablePath == JavaModelManager.VARIABLE_INITIALIZATION_IN_PROGRESS) return null; // break cycle (initializer did not
   // init or reentering call)
   // if (JavaModelManager.CP_RESOLVE_VERBOSE_ADVANCED)
   ...
   // }
   //
   // private static void verbose_triggering_variable_initialization(String variableName, ClasspathVariableInitializer
   // initializer) {
   // Util.verbose(
   ...
   // return JavaModelManager.getJavaModelManager().getResolvedVariablePath(variablePath, false/*don't use previous session
   // value*/);
   // }
   ...
   // }
   // if (manager.forceBatchInitializations(true/*initAfterLoad*/)) { // if no other thread has started the batch container
   // initializations
   ...
   // manager.deltaState.rootsAreStale = true; // in case it was already initialized before we cleaned up the source attachment
   // proprties
   ...
   // * @since 3.1
   // */
   // public static ITypeHierarchy newTypeHierarchy(IRegion region, WorkingCopyOwner owner, IProgressMonitor monitor) throws
   // JavaModelException {
   // if (region == null) {
   // throw new IllegalArgumentException(Messages.hierarchy_nullRegion);
   // }
   // ICompilationUnit[] workingCopies = JavaModelManager.getJavaModelManager().getWorkingCopies(owner, true/*add primary working
   // copies*/);
   ...
   // * newLibraryEntry(path, sourceAttachmentPath, sourceAttachmentRootPath, new IAccessRule[0], new IClasspathAttribute[0],
   // false)}.
   // *
   ...
   // * <li><code> "../../lib/someLib.jar" </code> - reference to an external JAR that is a sibbling of the workspace on either
   // platform</li>
   // * </ul>
   ...
   // * @param path the absolute path of the prerequisite project
   // * @param accessRules the possibly empty list of access rules for this entry
   // * @param combineAccessRules whether the access rules of the project's exported entries should be combined with the given
   // access rules
   // * @param extraAttributes the possibly empty list of extra attributes to persist with this entry
   // * @param isExported indicates whether this entry is contributed to dependent
   // * projects in addition to the output location
   ...
   // * @param exclusionPatterns the possibly empty list of exclusion patterns
   // * represented as relative paths
   // * @param specificOutputLocation the specific output location for this source entry (<code>null</code> if using project
   ...
   // * @since 3.0
   // */
   // public static IClasspathEntry newSourceEntry(IPath path, IPath[] inclusionPatterns, IPath[] exclusionPatterns, IPath
   ...
   // */
   // public static IClasspathEntry newSourceEntry(IPath path, IPath[] inclusionPatterns, IPath[] exclusionPatterns, IPath
   // specificOutputLocation, IClasspathAttribute[] extraAttributes) {
   //
   ...
   // try {
   // SetVariablesOperation operation = new SetVariablesOperation(new String[]{ variableName}, new IPath[]{ null }, true/*update
   // preferences*/);
   ...
   // * @since 2.0
   // */
   // public static void setClasspathContainer(IPath containerPath, IJavaProject[] affectedProjects, IClasspathContainer[]

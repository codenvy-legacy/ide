 ...
 * @since 3.6
 */
class NameEnvironmentWithProgress extends FileSystem implements org.eclipse.jdt.core.INameEnvironmentWithProgress {
...
//			}
			throw new AbortCompilation(true/*silent*/, new RuntimeException());
		}
	}

 ...
 */
public interface ICompilationUnit extends ITypeRoot, ISourceManipulation {
/**
 ...
 */
ICompilationUnit getWorkingCopy(IProblemRequestor problemRequestor, IProgressMonitor monitor) throws JavaModelException;
/**
 ...
 * @since 3.0
 */
CompilationUnit reconcile(int astLevel, boolean forceProblemDetection, IProgressMonitor monitor) throws JavaModelException;
 ...
 * @since 3.2
 */
CompilationUnit reconcile(int astLevel, boolean forceProblemDetection, boolean enableStatementsRecovery, IProgressMonitor monitor) throws JavaModelException;
 ...
 * @since 3.3
 */
CompilationUnit reconcile(int astLevel, int reconcileFlags, IProgressMonitor monitor) throws JavaModelException;

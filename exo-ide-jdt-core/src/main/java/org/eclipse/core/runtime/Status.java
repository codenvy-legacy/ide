...
public class Status implements IStatus {
	 ...
	 * @since 3.0
	 */
	public static final IStatus OK_STATUS = new Status(OK, "run.time", OK, "ok", null); //$NON-NLS-1$
	/**
	 * A standard CANCEL status with no message.
	 * 
	 * @since 3.0
	 */
	public static final IStatus CANCEL_STATUS = new Status(CANCEL, "cancel", 1, "", null); //$NON-NLS-1$
	/**
	 * The severity. One of
	 * <ul>
...
//		isLegal(severity == OK || severity == ERROR || severity == WARNING || severity == INFO || severity == CANCEL);

...
public abstract class QuickFixTest extends GwtTestWithMockito {
    ...
    protected static CompilationUnit getASTRoot(IDocument cu, String name) {
    ...
    protected static final ArrayList collectCorrections(IDocument cu, CompilationUnit astRoot) throws CoreException {
        return collectCorrections(cu, astRoot, 1, null);
    }

    protected static final ArrayList collectCorrections(IDocument cu, CompilationUnit astRoot, int nProblems)
            throws CoreException {
        return collectCorrections(cu, astRoot, nProblems, null);
    }

    protected static final ArrayList collectCorrections(IDocument cu, CompilationUnit astRoot, int nProblems, int problem)
            throws CoreException {
    ...
    protected static ArrayList collectCorrections(IInvocationContext context, IProblemLocation problem)
            throws CoreException {
        ArrayList proposals = new ArrayList();
    ...
    protected static final ArrayList collectCorrections(IDocument cu, IProblem curr, IInvocationContext context)
            throws CoreException {

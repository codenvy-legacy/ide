...
public class ASTRewritingStatementsTest extends ASTRewritingTest
{
   ...
   public void testInsert1() throws Exception
   {
      ...
      buf.append("}\n");
      ICompilationUnit cu =
         new org.eclipse.jdt.client.compiler.batch.CompilationUnit(buf.toString().toCharArray(), "C.java", "");
   ...
   public void testInsert2() throws Exception
   {
      ...
      buf.append("}\n");
      ICompilationUnit cu =
         new org.eclipse.jdt.client.compiler.batch.CompilationUnit(buf.toString().toCharArray(), "D.java", "");
   ...
   public void testSwitchStatement13() throws Exception
   {
      ...
      Document document1 = new Document(String.valueOf(cu.getContents()));
   ...
   public void testTryStatement3() throws Exception
   {
      ...
      { // replace catch exception type with a union type
         ...
         rewrite.getListRewrite(unionType, UnionType.TYPES_PROPERTY).replace(exceptionType,
            ast.newSimpleType(ast.newSimpleName("FileNotFoundException")), null);
      }
   ...
   public void testTryStatementWithResources3() throws Exception
   {
      ...
      ICompilationUnit cu =
         new org.eclipse.jdt.client.compiler.batch.CompilationUnit(buf.toString().toCharArray(), "X.java", "");
   ...
   public void testVariableDeclarationStatement() throws Exception
   {
      ...
      buf.append("}\n");
      ICompilationUnit cu =
         new org.eclipse.jdt.client.compiler.batch.CompilationUnit(buf.toString().toCharArray(), "A.java", "");

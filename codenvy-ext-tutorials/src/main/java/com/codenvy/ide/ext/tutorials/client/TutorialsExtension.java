...
/**
 * Entry point for an extension that adds support to work with Codenvy tutorials.
 *
 * @author <a href="mailto:azatsarynnyy@codenvy.com">Artem Zatsarynnyy</a>
 * @version $Id: TutorialsExtension.java Sep 13, 2013 4:14:56 PM azatsarynnyy $
 */
@Singleton
@Extension(title = "Codenvy tutorials support.", version = "3.0.0")
public class TutorialsExtension {
    ...
    public TutorialsExtension(TemplateAgent templateAgent,
        ...
        projectTypeAgent.registerProjectType(TUTORIAL_PROJECT_TYPE, "Tutorial", resources.codenvyTutorialProject());

...
public class CreateNewResourceWizardTutorialPage extends AbstractTemplatePage {
     ...
     */
    @Inject
    public CreateNewResourceWizardTutorialPage(ManageProjectsClientService manageProjectsClientService,
    ...
    private void unzipTemplate(final String projectName, final CommitCallback callback) {
        try {
            unzipTemplateClientService.unzipNewResourceWizardTutorial(projectName, new AsyncRequestCallback<Void>() {
                @Override
                protected void onSuccess(Void result) {

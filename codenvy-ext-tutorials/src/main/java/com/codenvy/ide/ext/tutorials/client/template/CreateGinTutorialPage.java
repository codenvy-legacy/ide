...
public class CreateGinTutorialPage extends AbstractTemplatePage {
     ...
     */
    @Inject
    public CreateGinTutorialPage(TutorialsClientService service, ResourceProvider resourceProvider) {
    ...
    public void commit(@NotNull final CommitCallback callback) {
        ...
        try {
            service.createGinTutorialProject(projectName, properties, new AsyncRequestCallback<Void>() {
                @Override

...
public class CreateWizardTutorialPage extends AbstractTemplatePage {
     ...
     */
    @Inject
    public CreateWizardTutorialPage(ManageProjectsClientService manageProjectsClientService,
    ...
    private void unzipTemplate(final String projectName, final CommitCallback callback) {
        try {
            unzipTemplateClientService.unzipWizardTutorial(projectName, new AsyncRequestCallback<Void>() {
                @Override
                protected void onSuccess(Void result) {

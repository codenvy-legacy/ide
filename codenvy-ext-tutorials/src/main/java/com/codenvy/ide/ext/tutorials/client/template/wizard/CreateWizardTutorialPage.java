 ...
 * from Codenvy S.A..
 */
package com.codenvy.ide.ext.tutorials.client.template.wizard;
...
@Singleton
public class CreateWizardTutorialPage extends AbstractCreateProjectPage {
     ...
     */
    @Inject
    public CreateWizardTutorialPage(TutorialsClientService service, ResourceProvider resourceProvider) {
    ...
    public void commit(@NotNull final CommitCallback callback) {
        ...
        try {
            service.createWizardTutorialProject(projectName, properties, new AsyncRequestCallback<Void>() {
                @Override

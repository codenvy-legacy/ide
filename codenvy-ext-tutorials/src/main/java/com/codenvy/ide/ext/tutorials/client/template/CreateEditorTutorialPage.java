...
import static com.codenvy.ide.ext.tutorials.client.TutorialsExtension.EDITOR_TUTORIAL_ID;
...
/**
 * The wizard page for creating editor tutorial template.
 *
 * @author <a href="mailto:aplotnikov@codenvy.com">Andrey Plotnikov</a>
 */
public class CreateEditorTutorialPage extends AbstractTemplatePage {
     ...
     */
    @Inject
    public CreateEditorTutorialPage(TutorialsClientService service, ResourceProvider resourceProvider) {
        super(null, null, EDITOR_TUTORIAL_ID);
    ...
    public void commit(@NotNull final CommitCallback callback) {
        ...
        try {
            service.createEditorTutorialProject(projectName, properties, new AsyncRequestCallback<Void>() {
                @Override

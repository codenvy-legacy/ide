...
public class CreateEditorTutorialPage extends AbstractTemplatePage {
     ...
     */
    @Inject
    public CreateEditorTutorialPage(ManageProjectsClientService manageProjectsClientService,
    ...
    private void unzipTemplate(final String projectName, final CommitCallback callback) {
        try {
            unzipTemplateClientService.unzipEditorTutorial(projectName, new AsyncRequestCallback<Void>() {
                @Override
                protected void onSuccess(Void result) {

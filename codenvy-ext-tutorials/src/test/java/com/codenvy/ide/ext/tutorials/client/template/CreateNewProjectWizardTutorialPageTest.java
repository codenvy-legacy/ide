...
/**
 * Testing {@link com.codenvy.ide.ext.tutorials.client.template.CreateNewProjectWizardTutorialPage} functionality.
 *
 * @author <a href="mailto:aplotnikov@codenvy.com">Andrey Plotnikov</a>
 */
public class CreateNewProjectWizardTutorialPageTest extends BaseCreateTutorialTest {
    @Override
    public void setUp() {
        super.setUp();
        page = new CreateNewProjectWizardTutorialPage(service, resourceProvider);
    ...
    public void testCreateWhenGetProjectRequestIsSuccessful() throws Exception {
        ...
        }).when(service).createNewProjectWizardTutorialProject(anyString(), (JsonArray<Property>)anyObject(),
    ...
    public void testCreateWhenRequestExceptionHappened() throws Exception {
        doThrow(RequestException.class).when(service).createNewProjectWizardTutorialProject(anyString(),
    ...
    public void testInContext() {
        when(template.getId()).thenReturn(NEW_PROJECT_WIZARD_TUTORIAL_ID);

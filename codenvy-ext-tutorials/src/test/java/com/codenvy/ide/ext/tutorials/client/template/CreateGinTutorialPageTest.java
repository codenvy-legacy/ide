...
public class CreateGinTutorialPageTest extends BaseCreateTutorialTest {
    ...
    public void setUp() {
        super.setUp();
        page = new CreateGinTutorialPage(service, resourceProvider);
    ...
    public void testCreateWhenGetProjectRequestIsSuccessful() throws Exception {
        doAnswer(new Answer() {
            ...
            public Object answer(InvocationOnMock invocation) throws Throwable {
                ...
                .createGinTutorialProject(anyString(), (JsonArray<Property>)anyObject(), (AsyncRequestCallback<Void>)anyObject());

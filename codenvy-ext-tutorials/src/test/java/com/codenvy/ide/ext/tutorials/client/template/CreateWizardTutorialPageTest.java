...
public class CreateWizardTutorialPageTest extends BaseCreateTutorialTest {
    ...
    public void setUp() {
        super.setUp();
        page = new CreateWizardTutorialPage(manageProjectsClientService, projectTypeDescriptorRegistry, service, resourceProvider);
    ...
    public void testCreateWhenGetProjectRequestIsSuccessful() throws Exception {
        ...
        }).when(service).unzipWizardTutorial(anyString(), (AsyncRequestCallback<Void>)anyObject());
    ...
    public void testCreateWhenRequestExceptionHappened() throws Exception {
        doThrow(RequestException.class).when(service).unzipWizardTutorial(anyString(), (AsyncRequestCallback<Void>)anyObject());

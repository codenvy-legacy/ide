...
/**
 * Testing {@link CreateEditorTutorialPage} functionality.
 *
 * @author <a href="mailto:aplotnikov@codenvy.com">Andrey Plotnikov</a>
 */
public class CreateEditorTutorialPageTest extends BaseCreateTutorialTest {
    @Override
    public void setUp() {
        super.setUp();
        page = new CreateEditorTutorialPage(manageProjectsClientService, projectTypeDescriptorRegistry, service, resourceProvider);

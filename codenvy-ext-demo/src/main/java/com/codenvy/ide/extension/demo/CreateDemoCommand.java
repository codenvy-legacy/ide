                                              ...
                                              project.createFolder(project, "src", new AsyncCallback<Folder>() {
                                                  ...
                                                  public void onSuccess(Folder result) {
                                                      project.createFolder(result, "main", new AsyncCallback<Folder>() {
                                                          ...
                                                          @Override
                                                          public void onSuccess(Folder result) {
                                                              project.createFolder(result, "java/org/exoplatform/ide",
                                                                                   new AsyncCallback<Folder>() {
                                                                                       ...
                                                                                       public void onSuccess(Folder result) {
                                                                                           ...
                                                                                           project.createFolder(result, "void",
                                                                                                                new AsyncCallback<Folder>
                                                                                                                        () {
                                                              ...
                                                              project.createFolder(result, "resources/org/exoplatform/ide",
                                                                                   new AsyncCallback<Folder>() {
                                                                                       ...
                                                                                       @Override
                                                                                       public void onSuccess(Folder result) {
                                                                                           project.createFile(result, "styles.css",
                                                                                                              ".test{\n\n}", "text/css",
                                                                                                              new AsyncCallback<File>() {
                                                                                   ...
                                                                                   new AsyncCallback<Folder>() {
                                                                                       ...
                                                                                       public void onSuccess(Folder result) {
                                                                                           project.createFile(result, "TestFileOnFs.txt",
                                                                                                              "This is file content of the file from VFS",
                                                                                                              "text/text-pain",
                                                                                                              new AsyncCallback<File>() {
                                                                                                                  ...
                                                                                                                  public void onFailure(
                                                                                                                          Throwable caught) {
                                                                                                                      GWT.log("Error creating demo folder" +
                                                                                                                              caught);
                                                                                                                  }
                                                                                                              });

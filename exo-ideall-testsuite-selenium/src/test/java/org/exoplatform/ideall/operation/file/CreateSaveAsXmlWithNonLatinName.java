...
public class CreateSaveAsXmlWithNonLatinName extends BaseTest
{
   ...
   public void testCreateAndSaveAsXmlWithNonLatinName() throws Exception
   {
      ...
      saveAsFile("�������� ����.xml");
      Thread.sleep(1000);
      assertTrue(selenium.isElementPresent("scLocator=//TabSet[ID=\"ideEditorFormTabSet\"]/tab[title=�������� ����.xml||index=0]"));
      
      showAndCheckProperties("54", "text/xml", "�������� ����.xml");
      
      closeTab("0");
      
      Thread.sleep(500);
      selenium.open("/rest/private/jcr/repository/dev-monit/");
      selenium.waitForPageToLoad("10000");
      assertTrue(selenium.isElementPresent("link=�������� ����.xml"));
      selenium.click("link=�������� ����.xml");
      Thread.sleep(1000);
      ...
      selenium.waitForPageToLoad("10000");
      Thread.sleep(5000);
      assertTrue(selenium.isElementPresent("scLocator=//TreeGrid[ID=\"ideItemTreeGrid\"]/body/row[name=�������� ����.xml]/col[0]"));
      
      openFileWithCodeEditor("�������� ����.xml");
      ...
      saveAsFile("����� �������� ����.xml");
      Thread.sleep(1000);
      assertTrue(selenium.isElementPresent("scLocator=//TabSet[ID=\"ideEditorFormTabSet\"]/tab[title=����� �������� ����.xml]"));
      
      showAndCheckProperties("51", "text/xml", "����� �������� ����.xml");
...
//      Thread.sleep(10000);
      ...
      selenium.click("scLocator=//TreeGrid[ID=\"ideItemTreeGrid\"]/body/row[name=�������� ����.xml]/col[1]");
   ...
   private void openFileWithCodeEditor(String fileName) throws Exception
   {
      ...
      selenium.click("scLocator=//ListGrid[ID=\"ideOpenFileWithListGrid\"]/body/row[0]/col[fieldName=entryPoint||0]");

    ...
    :
        {
            ...
            "proxyUrl"
        :
            "http://%host%/gadgets/proxy?refresh=%refresh%&url=%url%",
                "jsonProxyUrl"
        :
            "http://%host%/gadgets/makeRequest"
        }
    ,
        "views"
    :

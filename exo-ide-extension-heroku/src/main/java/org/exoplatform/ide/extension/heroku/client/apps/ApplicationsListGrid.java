...
public class ApplicationsListGrid extends ListGrid<String> implements HasApplicationsActions
{
   ...
   /**
    * @see org.exoplatform.ide.extension.heroku.client.apps.HasApplicationsActions#addDeleteApplicationHandler(com.google.gwt.event.logical.shared.SelectionHandler)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.heroku.client.apps.HasApplicationsActions#addRenameApplicationHandler(com.google.gwt.event.logical.shared.SelectionHandler)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.heroku.client.apps.HasApplicationsActions#addChangeEnvironmentHandler(com.google.gwt.event.logical.shared.SelectionHandler)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.heroku.client.apps.HasApplicationsActions#addApplicationInfoHandler(com.google.gwt.event.logical.shared.SelectionHandler)
    */
   @Override

...
import org.exoplatform.ide.extension.nodejs.client.StringUnmarshaller;
 ...
 * @version $Id: LogsHandler.java Apr 18, 2013 4:22:53 PM vsvydenko $
 *
 */
public class LogsHandler implements ShowLogsHandler, ApplicationStartedHandler, ApplicationStoppedHandler {
    ...
    /** @see org.exoplatform.ide.extension.nodejs.client.logs.ShowLogsHandler#onShowLogs(org.exoplatform.ide.extension.nodejs.client.logs
     * .ShowLogsEvent) */
    @Override
    public void onShowLogs(ShowLogsEvent event) {
        if (runApplication != null) {
            ...
            Dialogs.getInstance().showInfo(NodeJsRuntimeExtension.NODEJS_LOCALIZATION.noRunningApplication());
        }
    }

    private void getLogs() {
        try {
            NodeJsRuntimeService.getInstance().getLogs(runApplication.getName(),

...
/**
 * Action for launching extension in Codenvy.
 * 
...
public class LaunchAction extends Action {
    ...
    @Inject
    public LaunchAction(LaunchExtensionController controller,
                        ExtRuntimeResources resources,
                        ResourceProvider resourceProvider,
                        ExtRuntimeLocalizationConstant localizationConstants) {
        super(localizationConstants.launchExtensionActionText(), localizationConstants.launchExtensionActionDescription(),
              resources.launchApp());

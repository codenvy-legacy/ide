 ...
 * @version $Id: StartApplicationStatusHandler.java Apr 17, 2013 4:20:58 PM azatsarynnyy $
 *
 */
public class StartApplicationStatusHandler implements RequestStatusHandler {
    ...
    public void requestInProgress(String id) {
        ...
        job.setStartMessage(PhpRuntimeExtension.PHP_LOCALIZATION.startingProjectMessage(projectName));
    ...
    public void requestFinished(String id) {
        ...
        job.setFinishMessage(PhpRuntimeExtension.PHP_LOCALIZATION.projectStartedMessage(projectName));
        IDE.fireEvent(new JobChangeEvent(job));
    }

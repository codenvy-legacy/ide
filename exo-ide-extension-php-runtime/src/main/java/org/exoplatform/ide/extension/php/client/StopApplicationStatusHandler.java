 ...
 * @version $Id: StopApplicationStatusHandler.java Apr 17, 2013 4:21:30 PM azatsarynnyy $
 *
 */
public class StopApplicationStatusHandler implements RequestStatusHandler {
    ...
    public void requestInProgress(String id) {
        ...
        job.setStartMessage(PhpRuntimeExtension.PHP_LOCALIZATION.stoppingProjectMessage(projectName));
    ...
    public void requestFinished(String id) {
        ...
        job.setFinishMessage(PhpRuntimeExtension.PHP_LOCALIZATION.projectStoppedMessage(projectName));
        IDE.fireEvent(new JobChangeEvent(job));
    }

 ...
 */
@Singleton
public class CreateSpringProjectPage extends AbstractTemplatePage {
    ...
    public CreateSpringProjectPage(CreateProjectClientService service, ResourceProvider resourceProvider) {
        super(null, null, com.codenvy.ide.extension.ant.client.AntExtension.ANT_SPRING_PROJECT_ID);

...
/**
 * The wizard page for creating a War project from a template.
 *
 * @author <a href="mailto:aplotnikov@codenvy.com">Andrey Plotnikov</a>
 */
@Singleton
public class CreateWarProjectPage extends AbstractTemplatePage {
     ...
     */
    @Inject
    public CreateWarProjectPage(CreateProjectClientService service, ResourceProvider resourceProvider) {
        super(null, null, WAR_PROJECT_ID);

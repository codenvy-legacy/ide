 ...
 */
public class MavenBuildRequestStatusHandler implements RequestStatusHandler {
    private String projectName;

    private EventBus eventBus;

    private MavenLocalizationConstant constant;

    /**
     * @param projectName
     *         project's name
     */
    public MavenBuildRequestStatusHandler(String projectName, EventBus eventBus,

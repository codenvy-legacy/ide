 ...
 * from Codenvy S.A..
 */
package com.codenvy.ide.extension.builder.client.template;
...
import static com.codenvy.ide.extension.maven.client.MavenExtension.WAR_PROJECT_ID;
import static org.mockito.Matchers.anyObject;
import static org.mockito.Matchers.anyString;
import static org.mockito.Mockito.*;

/**
 * Testing {@link com.codenvy.ide.extension.maven.client.template.CreateWarProjectPage} functionality.
 *
...
public class CreateWarProjectPageTest extends BaseCreateProjectTest {
    ...
    public void setUp() {
        super.setUp();
        page = new CreateWarProjectPage(service, resourceProvider);
    ...
    public void testInContext() {
        when(template.getId()).thenReturn(WAR_PROJECT_ID);

...
import com.codenvy.ide.json.server.JsonIntegerMapAdapter;
import com.codenvy.ide.json.server.JsonStringMapAdapter;
import com.codenvy.ide.json.server.JsonStringSetAdapter;
...
public final class JsonCollections {
     ...
     *
     * @param equivalence
     *         if null the {@link Object#equals(Object)} is used to
     ...
     *
     * @param equivalence
     *         if null {@link Objects#equal(Object, Object)} is used to
     *         verify equivalence.
     * @param <T>
     *         the data type of the arrays
     */

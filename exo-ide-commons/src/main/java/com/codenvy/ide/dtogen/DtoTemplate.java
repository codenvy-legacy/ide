 ...
 * server versions of all DTOs (irrespective of direction), but you aren't allowed to construct a new
 * {@link com.codenvy.ide.dtogen.shared.ServerToClientDto} on the client. And similarly, you aren't allowed to construct a
 * {@link com.codenvy.ide.dtogen.shared.ClientToServerDto} on the server.
 */
public class DtoTemplate {
    ...
    /**
     * @return whether or not the specified interface implements {@link com.codenvy.ide.dtogen.shared.RoutableDto}.
     */

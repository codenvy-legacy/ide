...
import org.exoplatform.ide.dtogen.DtoTemplate.MalformedDtoInterfaceException;
...
abstract class DtoImpl
{
            ...
            if (genericParamType instanceof Class<?>)
            {
               ...
               if (isWhitelisted(genericParamTypeClass))
               {
                  assert genericParamTypeClass.equals(
                     String.class) : "For JSON serialization there can be only strings or DTO types. " + "Please ping smok@ if you see this assert happening.";
               }
            }
    ...
    *
    * <p>For compact DTO (see {@link org.exoplatform.ide.dtogen.shared.CompactJsonDto}) methods are ordered
    * corresponding to {@link org.exoplatform.ide.dtogen.shared.SerializationIndex} annotation.
    *

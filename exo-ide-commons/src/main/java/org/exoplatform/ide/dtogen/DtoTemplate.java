 ...
 * a new {@link org.exoplatform.ide.dtogen.shared.ServerToClientDto} on the client. And similarly, you aren't
 * allowed to construct a {@link org.exoplatform.ide.dtogen.shared.ClientToServerDto} on the server.
 */
public class DtoTemplate
{
    ...
    *         {@link org.exoplatform.ide.dtogen.shared.ClientToServerDto}.
    */
   ...
   /**
    * @return whether or not the specified interface implements
    *         {@link org.exoplatform.ide.dtogen.shared.ServerToClientDto}.
    */
   ...
   /**
    * @return whether or not the specified interface implements
    *         {@link org.exoplatform.ide.dtogen.shared.RoutableDto}.
    */
   ...
   private DtoImpl createDtoImplTemplate(Class<?> i)
   {
      ...
      return isServerType ? new DtoImplServerTemplate(this, routingId, i) : new DtoImplClientTemplate(this, routingId,
         i);
   }
   ...
   private void emitPreamble(StringBuilder builder)
   {
      ...
      if (isServerType)
      {
         builder.append("  private static final Gson gson = " + "new GsonBuilder().serializeNulls().create();\n\n");
      }
   ...
   /**
    * Extracts the {@link org.exoplatform.ide.dtogen.shared.RoutingType} annotation to derive the stable
    * routing type.
    */

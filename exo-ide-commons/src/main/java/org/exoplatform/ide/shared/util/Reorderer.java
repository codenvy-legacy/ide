...
import org.exoplatform.ide.shared.util.Timer.Factory;
...
public class Reorderer<T> {
    ...
    /**
     * @param firstVersionToExpect
     *         the first version to expect
     * @param timeoutMs
     *         the amount of time to wait before triggering the {@code timeoutCallback} for
     *         dropped items
     */

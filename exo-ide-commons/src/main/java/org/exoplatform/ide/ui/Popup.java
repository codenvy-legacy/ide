...
import org.exoplatform.ide.ui.menu.AutoHideComponent;
import org.exoplatform.ide.ui.menu.AutoHideView;
import org.exoplatform.ide.ui.menu.PositionController;
...
public class Popup extends AutoHideComponent<Popup.View, AutoHideComponent.AutoHideModel>
{
   ...
   {
      @Source({"org/exoplatform/ide/common/constants.css", "Popup.css"})
      Css popupCss();
   }

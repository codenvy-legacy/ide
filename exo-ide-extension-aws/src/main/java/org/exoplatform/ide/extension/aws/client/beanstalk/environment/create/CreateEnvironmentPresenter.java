...
public class CreateEnvironmentPresenter implements CreateEnvironmentHandler, ViewClosedHandler
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.create.CreateEnvironmentHandler#onCreateEnvironment(org.exoplatform.ide.extension.aws.client.beanstalk.environment.create.CreateEnvironmentEvent)
    */
   @Override

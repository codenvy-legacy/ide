...
public class RestartAppServerPresenter implements RestartAppServerHandler, ViewClosedHandler
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.restart.RestartAppServerHandler#onRestartAppServer(org.exoplatform.ide.extension.aws.client.beanstalk.environment.restart.RestartAppServerEvent)
    */
   @Override

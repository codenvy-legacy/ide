...
public class RestartAppServerPresenter implements RestartAppServerHandler, ViewClosedHandler
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environments.restart.RestartAppServerHandler#onRestartAppServer(org.exoplatform.ide.extension.aws.client.beanstalk.environments.restart.RestartAppServerEvent)
    */
   @Override
      ...
      try
      {
         BeanstalkClientService.getInstance().restartApplicationServer(environment.getId(),
            ...
            })
            {
               ...
               {
                  String message = AWSExtension.LOCALIZATION_CONSTANT.restartAppServerFailed(environment.getId());

...
public class TerminateEnvironmentPresenter implements TerminateEnvironmentHandler, ViewClosedHandler
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environments.terminate.TerminateEnvironmentHandler#onTerminateEnvironment(org.exoplatform.ide.extension.aws.client.beanstalk.environments.terminate.TerminateEnvironmentEvent)
    */
   @Override

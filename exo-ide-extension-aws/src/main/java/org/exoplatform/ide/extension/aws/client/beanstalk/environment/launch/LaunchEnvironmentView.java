 ...
 */
package org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch;
...
public class LaunchEnvironmentView extends ViewImpl implements LaunchEnvironmentPresenter.Display
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch.LaunchEnvironmentPresenter.Display#getEnvNameField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch.LaunchEnvironmentPresenter.Display#getEnvDescriptionField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch.LaunchEnvironmentPresenter.Display#getSolutionStackField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch.LaunchEnvironmentPresenter.Display#setSolutionStackValues(java.lang.String[])
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch.LaunchEnvironmentPresenter.Display#getLaunchButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch.LaunchEnvironmentPresenter.Display#getCancelButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch.LaunchEnvironmentPresenter.Display#enableLaunchButton(boolean)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.launch.LaunchEnvironmentPresenter.Display#focusInEnvNameField()
    */
   @Override

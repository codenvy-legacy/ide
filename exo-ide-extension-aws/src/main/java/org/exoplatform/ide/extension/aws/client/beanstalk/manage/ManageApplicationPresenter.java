   ...
   ManageApplicationHandler, ViewClosedHandler, EnvironmentInfoChangedHandler
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.manage.ManageApplicationHandler#onManageApplication(org.exoplatform.ide.extension.aws.client.beanstalk.manage.ManageApplicationEvent)
    */
   @Override
      ...
      display.getVersionActions().addDeployHandler(new SelectionHandler<ApplicationVersionInfo>()
      {
         ...
         public void onSelection(SelectionEvent<ApplicationVersionInfo> event)
         {
            IDE.fireEvent(new DeployVersionEvent(event.getSelectedItem().getApplicationName(), event.getSelectedItem()
               .getVersionLabel(), deployVersionStartedHandler));
         }
      });

...
//      deleteS3BundleField.setName(DELETE_S3_BUNDLE_ID);
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.DeleteVersionPresenter.Display#getDeleteButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.DeleteVersionPresenter.Display#getCancelButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.DeleteVersionPresenter.Display#getDeleteQuestion()
    */
   @Override

 ...
 */
package org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy;
...
public class DeployVersionView extends ViewImpl implements DeployVersionPresenter.Display
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy.DeployVersionPresenter.Display#getNewEnvironmentMode()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy.DeployVersionPresenter.Display#getExistingEnvironmentMode()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy.DeployVersionPresenter.Display#getEnvironmentsField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy.DeployVersionPresenter.Display#setEnvironmentsValues(java.util.LinkedHashMap)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy.DeployVersionPresenter.Display#enableEnvironmentsField(boolean)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#getDeployButton()
    */
   @Override

...
public class UpdateApplicationView extends ViewImpl implements UpdateApplicationPresenter.Display
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.update.UpdateApplicationPresenter.Display#getUpdateButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.update.UpdateApplicationPresenter.Display#getCancelButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.update.UpdateApplicationPresenter.Display#getDescriptionField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.update.UpdateApplicationPresenter.Display#enableUpdateButton(boolean)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.update.UpdateApplicationPresenter.Display#focusInDescriptionField()
    */
   @Override

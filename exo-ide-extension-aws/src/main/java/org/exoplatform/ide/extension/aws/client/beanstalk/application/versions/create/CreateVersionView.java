...
public class CreateVersionView extends ViewImpl implements CreateVersionPresenter.Display
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#getVersionLabelField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#getDescriptionField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#getS3BucketField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#getS3KeyField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#getCreateButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#getCancelButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#enableCreateButton(boolean)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionPresenter.Display#focusInVersionLabelField()
    */
   @Override

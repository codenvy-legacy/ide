...
public class DeployVersionEvent extends GwtEvent<DeployVersionHandler>
{
   ...
   public DeployVersionEvent(String applicationName, String versionLabel, VersionDeployedHandler versionDeployedHandler)
   {
      this.applicationName = applicationName;
      this.versionLabel = versionLabel;
      this.versionDeployedHandler = versionDeployedHandler;
   }
   ...
   /**
    * @return the versionDeployedHandler
    */
   public VersionDeployedHandler getVersionDeployedHandler()
   {
      return versionDeployedHandler;
   }
}

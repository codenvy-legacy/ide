...
public class ManageApplicationView extends ViewImpl implements ManageApplicationPresenter.Display
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getApplicationNameField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getDescriptionField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getCreateDateField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getUpdatedDateField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getDeleteButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getUpdateDescriptionButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getCloseButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getVersionsGrid()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getVersionActions()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getCreateVersionButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#getLaunchEnvironmentButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationPresenter.Display#selectVersionsTab()
    */
   @Override

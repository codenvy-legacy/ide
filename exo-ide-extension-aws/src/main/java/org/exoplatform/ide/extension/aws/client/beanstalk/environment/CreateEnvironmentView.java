...
public class CreateEnvironmentView extends ViewImpl implements CreateEnvironmentPresenter.Display
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.CreateEnvironmentPresenter.Display#getEnvNameField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.CreateEnvironmentPresenter.Display#getEnvDescriptionField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.CreateEnvironmentPresenter.Display#getSolutionStackField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.CreateEnvironmentPresenter.Display#setSolutionStackValues(java.lang.String[])
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.CreateEnvironmentPresenter.Display#getCreateButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.CreateEnvironmentPresenter.Display#getCancelButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.CreateEnvironmentPresenter.Display#enableCreateButton(boolean)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.CreateEnvironmentPresenter.Display#focusInEnvNameField()
    */
   @Override

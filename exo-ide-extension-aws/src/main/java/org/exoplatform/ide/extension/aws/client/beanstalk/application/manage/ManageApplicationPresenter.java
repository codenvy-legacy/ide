...
import org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.CreateVersionEvent;
import org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.create.VersionCreatedHandler;
import org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.delete.DeleteVersionEvent;
import org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.delete.VersionDeletedHandler;
import org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy.DeployVersionEvent;
   ...
   ManageApplicationHandler, VfsChangedHandler, ViewClosedHandler
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationHandler#onManageApplication(org.exoplatform.ide.extension.aws.client.beanstalk.application.manage.ManageApplicationEvent)
    */
   @Override
   ...
   private Timer checkEnvironmentStatusTimer = new Timer()
   {
      ...
      public void run()
      {
         ...
         listEventsRequest.setVersionLabel(newEnvironmentInfo.getVersionLabel());
         listEventsRequest.setEnvironmentId(newEnvironmentInfo.getId());
         ...
         try
         {
            BeanstalkClientService.getInstance().getApplicationEvents(currentVfs.getId(), openedProject.getId(),
   ...
   private void updateEnvironmentStatus(EnvironmentInfo environment)
   {
      ...
      else if (environment.getStatus() == EnvironmentStatus.Terminated)
      {
         ...
         message.append(AWSExtension.LOCALIZATION_CONSTANT.createApplicationTerminated());

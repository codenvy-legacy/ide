   ...
   DeployVersionHandler, ViewClosedHandler
{
   ...
   private VersionDeployedHandler versionDeployedHandler;
   ...
   public void bindDisplay()
   {
      ...
      display.getDeployButton().addClickHandler(new ClickHandler()
      {
         ...
         public void onClick(ClickEvent event)
         {
            ...
            {
               IDE.getInstance().closeView(display.asView().getId());
               IDE.fireEvent(new CreateEnvironmentEvent(vfsInfo.getId(), openedProject.getId(), applicationName,
                  versionLabel, null));
            }
         }
      });
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy.DeployVersionHandler#onDeployVersion(org.exoplatform.ide.extension.aws.client.beanstalk.application.versions.deploy.DeployVersionEvent)
    */
   @Override
   public void onDeployVersion(DeployVersionEvent event)
   {
      ...
      this.versionDeployedHandler = event.getVersionDeployedHandler();
   ...
   private void deployVersion()
   {
      ...
      try
      {
         BeanstalkClientService.getInstance().updateEnvironment(
            display.getEnvironmentsField().getValue(),
               ...
               })
            {
               ...
               protected void onSuccess(EnvironmentInfo result)
               {
                  ...
                  if (versionDeployedHandler != null)
                  {
                     versionDeployedHandler.onVersionDeployed(null);
                  }
               }

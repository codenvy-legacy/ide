...
public class RestartAppServerView extends ViewImpl implements RestartAppServerPresenter.Display
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.restart.RestartAppServerPresenter.Display#getRestartButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.beanstalk.environment.restart.RestartAppServerPresenter.Display#getRestartQuestion()
    */
   @Override

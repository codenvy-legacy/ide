...
public class EC2ClientServiceImpl extends EC2ClientService
{
   ...
   /**
    * @see org.exoplatform.ide.extension.aws.client.ec2.EC2ClientService#images(java.lang.String, java.lang.String,
    *       java.lang.String, int, int, org.exoplatform.gwtframework.commons.rest.AsyncRequestCallback)
    */
   @Override
   public void images(String owner, String isPublic, String architecture, int skipCount, int maxItems,

...
import org.exoplatform.ide.extension.aws.server.Cloudfoundry;
import org.exoplatform.ide.extension.aws.server.CloudfoundryCredentials;
import org.exoplatform.ide.extension.aws.server.CloudfoundryException;
import org.exoplatform.ide.extension.aws.server.DebugMode;
import org.exoplatform.ide.extension.aws.shared.CloudFoundryApplication;
import org.exoplatform.ide.extension.aws.shared.CloudfoundryApplicationStatistics;
import org.exoplatform.ide.extension.aws.shared.CloudfoundryServices;
import org.exoplatform.ide.extension.aws.shared.Instance;
import org.exoplatform.ide.extension.aws.shared.SystemInfo;
import org.exoplatform.ide.extension.aws.shared.SystemResources;
import org.exoplatform.ide.extension.aws.shared.SystemService;
...
public class CloudfoundryTest
{
   ...
   {
      assertEquals(1, cloudfoundry.getTargets().size());
      assertTrue(cloudfoundry.getTargets().contains(LoginInfo.target));
   }
   ...
   public void testCreateApplication() throws Exception
   {
      ...
      try
      {
         CloudFoundryApplication app = cloudfoundry.createApplication(
            ...
            null,             // debug
            null,             // vfs. Do not provide VFS instance since we provide all required info and not need to read something from VFS
            null,             // project
      ...
      {
         cloudfoundry.deleteApplication(LoginInfo.target, name, null, null, false);
      }
   }
   ...
   public void testStartApplication() throws Exception
   {
      ...
      try
      {
         ...
         CloudFoundryApplication app = cloudfoundry.createApplication(LoginInfo.target, name, null, null, 1, 128,
            true /* disable start */, null, null, null, null, null, javaWebApp.toURI().toURL());
         assertEquals(1, app.getInstances());
   ...
   public void testStartApplicationNotEnoughMemory() throws Exception
   {
      ...
      {
         cloudfoundry.deleteApplication(LoginInfo.target, name1, null, null, false);
         cloudfoundry.deleteApplication(LoginInfo.target, name2, null, null, false);
      }
   }
   ...
   public void testUpdateApplication() throws Exception
   {
      ...
      try
      {
         ...
         CloudFoundryApplication app = cloudfoundry.createApplication(LoginInfo.target, name, null, null, 1, 128, false,
            null, null, null, null, null, javaWebApp.toURI().toURL());
   ...
   public void testDeleteApplication() throws Exception
   {
      ...
      cloudfoundry.deleteApplication(LoginInfo.target, name, null, null, false);
      assertTrue(cloudfoundry.listApplications(LoginInfo.target).length == 0);
   ...
   public void testListApplications() throws Exception
   {
      ...
      try
      {
         ...
         CloudFoundryApplication[] apps = cloudfoundry.listApplications(LoginInfo.target);
   ...
   public void testServices() throws Exception
   {
      ...
      CloudfoundryServices services = cloudfoundry.services(LoginInfo.target);

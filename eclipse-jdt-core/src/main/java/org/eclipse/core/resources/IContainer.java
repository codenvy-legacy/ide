...
public interface IContainer extends IResource, IAdaptable
{
    ...
    * @throws CoreException              if this filter could not be added. Reasons include:
    *                                    <ul>
    *                                    <li> Resource changes are disallowed during certain types of resource change
    ...
    * @throws CoreException if this resource's filters could not be retrieved. Reasons include:
    *                       <ul>

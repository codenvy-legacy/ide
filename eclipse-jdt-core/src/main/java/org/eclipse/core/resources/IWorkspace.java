...
public interface IWorkspace extends IAdaptable
{
    ...
    * @return the last saved state in which the plug-in participated, or
    *         <code>null</code> if the plug-in has not participated before
    * @throws CoreException if the method fails to add the participant.
    *                       Reasons include:
    *                       <ul>
    *                       <li>The previous state could not be recovered.</li>
    *                       </ul>
    ...
    * @throws CoreException              if the method fails to copy some resources. The
    ...
    *         low-severity warnings or informational messages
    * @throws CoreException              if the method fails to delete some resource. The
    ...
    *         otherwise a description (possibly a multi-status) consisting of
    *         low-severity warnings or informational messages.
    * @throws CoreException              if the method fails to move some resources. The
    *                                    status contained in the exception may be a multi-status indicating where
    *                                    the individual failures occurred.
    * @throws OperationCanceledException if the operation is canceled.
    *                                    Cancelation can occur even if no progress monitor is provided.
    ...
    * @throws OperationCanceledException if the operation is canceled. If a
    ...
    * @throws CoreException              if this method fails to save the state of this
    ...
    * @throws CoreException if the method fails. Reasons include:
    *                       <ul>

...
public final class ResourcesPlugin {
	 ...
	 * 
	 * @see IJobManager#join(Object, org.eclipse.core.runtime.IProgressMonitor)
	 * @since 3.0
	 */
...
//	private ServiceRegistration<IWorkspace> workspaceRegistration;
	 ...
	 *
	 * @exception org.eclipse.core.runtime.CoreException if the workspace structure could not be constructed.
	 * Reasons include:
	 * <ul>

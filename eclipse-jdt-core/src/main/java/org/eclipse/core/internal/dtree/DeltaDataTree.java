...
public class DeltaDataTree extends AbstractDataTree
{
   ...
   /**
    * @see AbstractDataTree#createChild(org.eclipse.core.runtime.IPath, String)
    */
   ...
   /**
    * @see AbstractDataTree#createChild(org.eclipse.core.runtime.IPath, String, Object)
    */
   ...
   /**
    * @see AbstractDataTree#createSubtree(org.eclipse.core.runtime.IPath, AbstractDataTreeNode)
    */
   ...
   /**
    * @see AbstractDataTree#deleteChild(org.eclipse.core.runtime.IPath, String)
    */
   ...
   /**
    * @see AbstractDataTree#getChildCount(org.eclipse.core.runtime.IPath)
    */
   ...
   /**
    * @see AbstractDataTree#getChildren(org.eclipse.core.runtime.IPath)
    */
   ...
   /**
    * @see AbstractDataTree#getNameOfChild(org.eclipse.core.runtime.IPath, int)
    */
    ...
    *
    * @see AbstractDataTree#getNamesOfChildren(org.eclipse.core.runtime.IPath)
    */
   ...
   /**
    * @see AbstractDataTree#setData(org.eclipse.core.runtime.IPath, Object)
    */

...
//		DEBUG_SHUTDOWN = JobOSGiUtils.getDefault().getBooleanDebugOption(OPTION_SHUTDOWN, false);
	...
	/**
	 * Implementation of {@link org.eclipse.core.runtime.jobs.Job#yieldRule(IProgressMonitor)}
	 */
	...
	/**
	 * Invokes {@link org.eclipse.core.runtime.jobs.Job#shouldRun()} while guarding against unexpected failures.
	 */

...
public class Marker extends PlatformObject implements IMarker
{
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#equals(Object)
    */
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#getAttribute(String)
    */
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#getAttribute(String, int)
    */
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#getAttributes(String[])
    */
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#isSubtypeOf(String)
    */
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#setAttribute(String, int)
    */
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#setAttribute(String, Object)
    */
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#setAttribute(String, boolean)
    */
   ...
   /**
    * @see org.eclipse.core.resources.IMarker#setAttributes(String[], Object[])
    */

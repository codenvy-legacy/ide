...
public class EFS
{
   ...
   /**
    * The simple identifier constant (value "<code>filesystem</code>") of
    ...
    *
    * @see IFileStore#putInfo(org.eclipse.core.filesystem.IFileInfo, int, IProgressMonitor)
    */
    ...
    * </p>
    * <p>
    * If this attribute is <code>true</code> for a given {@link org.eclipse.core.filesystem.IFileInfo}
    * instance, a String value may be associated with the attribute
    * holding the symbolic link target. This link target can be
    * retrieved with {@link org.eclipse.core.filesystem.IFileInfo#getStringAttribute(int)} with attribute
    ...
    * of a {@link org.eclipse.core.filesystem.IFileInfo} apply to the link target instead of the link.
    ...
    * but {@link org.eclipse.core.filesystem.IFileInfo#exists()} returns <code>false</code> for these.

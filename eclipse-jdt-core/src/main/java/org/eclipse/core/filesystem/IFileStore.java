...
public interface IFileStore extends IAdaptable {
	...
	/**
	 * Returns an {@link org.eclipse.core.filesystem.IFileInfo} instance for each file and directory contained
	 * within this store.
	 * 
	 ...
	 * when passed to {@link EFS#getStore(java.net.URI)}, will return a store equal
	 * to this instance.
	 *
	 * @return A URI corresponding to this store.
	 * @see EFS#getStore(java.net.URI)
	 */
	public URI toURI();
}
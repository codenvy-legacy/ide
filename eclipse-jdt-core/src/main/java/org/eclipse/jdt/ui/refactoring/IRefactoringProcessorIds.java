...
public interface IRefactoringProcessorIds
{
    ...
    * {@link org.eclipse.jdt.core.refactoring.IJavaElementMapper} and {@link org.eclipse.ltk.core.refactoring.IResourceMapper}, which can be
    ...
    * through the interfaces {@link org.eclipse.jdt.core.refactoring.IJavaElementMapper} and {@link org.eclipse.ltk.core.refactoring.IResourceMapper}, which can be retrieved from the
    ...
    * </ul>
    * <p>
    * Use the method {@link ResourceMapping#accept(ResourceMappingContext context, org.eclipse.core.resources.IResourceVisitor visitor, org.eclipse.core.runtime.IProgressMonitor monitor)}

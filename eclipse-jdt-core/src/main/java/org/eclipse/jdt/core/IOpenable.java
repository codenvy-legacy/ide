...
public interface IOpenable
{
    ...
    *
    * @throws JavaModelException if an error occurs closing this element
    */
    ...
    * @throws JavaModelException if the element is unable to access the contents
    ...
    *
    * @param progress the given progress monitor
    * @throws JavaModelException if an error occurs accessing the contents
    *                            of its underlying resource. Reasons include:
    *                            <ul>
    *                            <li>This Java element does not exist (ELEMENT_DOES_NOT_EXIST)</li>
    *                            </ul>

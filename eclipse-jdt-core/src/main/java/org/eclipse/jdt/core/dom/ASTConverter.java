...
class ASTConverter
{
   ...
   protected void checkAndAddMultipleFieldDeclaration(org.eclipse.jdt.internal.compiler.ast.FieldDeclaration[] fields,
   ...
   private BlockScope lookupScope(ASTNode node)
   {
      ...
      if (currentNode instanceof Initializer)
      {
         ...
         {
            org.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDecl = (org.eclipse.jdt.internal.compiler.ast.TypeDeclaration)this.ast.getBindingResolver().getCorrespondingNode(
               currentNode);
      ...
      while (fragments.hasNext())
      {
         ...
         else if (node.getNodeType() == ASTNode.METHOD_REF)
         {
            ...
            while (parameters.hasNext())
            {
               ...
               org.eclipse.jdt.internal.compiler.ast.Expression expression = (org.eclipse.jdt.internal.compiler.ast.Expression)javadoc.getNodeStartingAt(
         ...
         {
            org.eclipse.jdt.internal.compiler.ast.ASTNode compilerNode = javadoc.getNodeStartingAt(

...
public class PrefixExpression extends Expression
{
    ...
    * @since 3.0
    */
   public static final SimplePropertyDescriptor OPERATOR_PROPERTY = new SimplePropertyDescriptor(PrefixExpression.class,
      "operator", PrefixExpression.Operator.class, MANDATORY); //$NON-NLS-1$

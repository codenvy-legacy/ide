 ...
 * <p>
 * This is a wrapper for {@link org.eclipse.jdt.core.JavaConventions} with more convenient
 * <code>validate*(..)</code> methods. If multiple validations are planned on
 * the same element, please use {@link org.eclipse.jdt.core.JavaConventions} directly (with the
 * arguments from {@link #getSourceComplianceLevels(org.eclipse.jdt.core.IJavaElement)}).
 * </p>
 */
public class JavaConventionsUtil
{
    ...
    *         {@link org.eclipse.jdt.core.JavaCore#COMPILER_SOURCE} and whose <code>[1]</code> is
    *         the {@link org.eclipse.jdt.core.JavaCore#COMPILER_COMPLIANCE} level at the given
    *         <code>context</code>.
    */
    ...
    * @see org.eclipse.jdt.core.JavaConventions#validateCompilationUnitName(String, String, String)
    */
    ...
    * @param context an {@link org.eclipse.jdt.core.IJavaElement} or <code>null</code>
    * @return validation status in <code>context</code>'s project or in the workspace
    * @see org.eclipse.jdt.core.JavaConventions#validateClassFileName(String, String, String)
    */
    ...
    * @param context an {@link org.eclipse.jdt.core.IJavaElement} or <code>null</code>
    * @return validation status in <code>context</code>'s project or in the workspace
    * @see org.eclipse.jdt.core.JavaConventions#validateFieldName(String, String, String)
    */
    ...
    * @param context an {@link org.eclipse.jdt.core.IJavaElement} or <code>null</code>
    * @return validation status in <code>context</code>'s project or in the workspace
    * @see org.eclipse.jdt.core.JavaConventions#validateIdentifier(String, String, String)
    */
    ...
    * @param context an {@link org.eclipse.jdt.core.IJavaElement} or <code>null</code>
    * @return validation status in <code>context</code>'s project or in the workspace
    * @see org.eclipse.jdt.core.JavaConventions#validateImportDeclaration(String, String, String)
    */
    ...
    * @param context an {@link org.eclipse.jdt.core.IJavaElement} or <code>null</code>
    * @return validation status in <code>context</code>'s project or in the workspace
    * @see org.eclipse.jdt.core.JavaConventions#validateJavaTypeName(String, String, String)
    */
    ...
    * @param context an {@link org.eclipse.jdt.core.IJavaElement} or <code>null</code>
    * @return validation status in <code>context</code>'s project or in the workspace
    * @see org.eclipse.jdt.core.JavaConventions#validateMethodName(String, String, String)
    */
    ...
    * @param context an {@link org.eclipse.jdt.core.IJavaElement} or <code>null</code>
    * @return validation status in <code>context</code>'s project or in the workspace
    * @see org.eclipse.jdt.core.JavaConventions#validatePackageName(String, String, String)
    */
    ...
    * @param context an {@link org.eclipse.jdt.core.IJavaElement} or <code>null</code>
    * @return validation status in <code>context</code>'s project or in the workspace
    * @see org.eclipse.jdt.core.JavaConventions#validateTypeVariableName(String, String, String)
    */

...
public class Util
{
      ...
      BindingsToNodesMap bindingsToNodes)
   {
      ...
      org.eclipse.jdt.internal.compiler.ast.ASTNode node = bindingsToNodes == null ? null : bindingsToNodes.get(
         methodBinding);
   ...
   {
      char[] typeName = org.eclipse.jdt.core.Signature.toCharArray(

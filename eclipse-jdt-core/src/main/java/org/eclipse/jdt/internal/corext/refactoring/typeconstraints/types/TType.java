...
/**
 * TTypes are lightweight fully-resolved type objects that stand for {@link org.eclipse.jdt.core.dom.ITypeBinding}s.
 * TTypes can answer basic questions about the relationship between types.
 *
 * They do not hold references to their corresponding {@link org.eclipse.jdt.core.dom.ITypeBinding}s, and they
...
public abstract class TType
{
    ...
    * The type environment <em>must</em> call {@link #initialize(org.eclipse.jdt.core.dom.ITypeBinding)} after using this constructor.
    *
   ...
   /**
    * Creates a new type with the given environment as an owner.
    * The type environment must <em>not</em> call {@link #initialize(org.eclipse.jdt.core.dom.ITypeBinding)} after using this constructor.
    *
    * @param environment owner
   ...
   /**
    * Returns the name of this type as defined by {@link org.eclipse.jdt.core.dom.ITypeBinding#getName()}.
    *

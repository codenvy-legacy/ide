...
public class IndexManager extends JobManager implements IIndexConstants
{
   ...
   private char[][] readIndexState(String dirOSString)
   {
      try
      {
         char[] savedIndexNames = org.eclipse.jdt.internal.compiler.util.Util.getFileCharContent(
   ...
   private void readParticipantsIndexNamesFile()
   {
      ...
      try
      {
         char[] participantIndexNames = org.eclipse.jdt.internal.compiler.util.Util.getFileCharContent(

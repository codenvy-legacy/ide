...
public class CuCollectingSearchRequestor extends CollectingSearchRequestor
{
    ...
    * Use {@link #collectMatch(org.eclipse.jdt.core.search.SearchMatch)} instead.
    *
    * @param match
    ...
    * Subclasses can override and call {@link #collectMatch(org.eclipse.jdt.core.search.SearchMatch)} to collect matches.
    *

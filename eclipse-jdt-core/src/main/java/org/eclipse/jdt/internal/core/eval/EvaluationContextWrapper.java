...
public class EvaluationContextWrapper implements IEvaluationContext
{
      ...
      WorkingCopyOwner owner) throws JavaModelException
   {
      ...
      codeComplete(codeSnippet, position, new org.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor),
         owner);
   }
   ...
   public void evaluateCodeSnippet(String codeSnippet, String[] localVariableTypeNames, String[] localVariableNames,
      ...
      ICodeSnippetRequestor requestor, IProgressMonitor progressMonitor) throws org.eclipse.jdt.core.JavaModelException
   {
   ...
   public void codeComplete(String codeSnippet, int position,
      final org.eclipse.jdt.core.ICodeCompletionRequestor requestor) throws JavaModelException
   {

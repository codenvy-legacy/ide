...
public class InferTypeArgumentsConstraintCreator extends HierarchicalASTVisitor
{
   ...
   private boolean canAssignToVararg(TType rhs,
      org.eclipse.jdt.internal.corext.refactoring.typeconstraints.types.ArrayType lhs)
   {
    ...
    * @return the {@link org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ConstraintVariable2} associated with the node, or <code>null</code>
    */
   ...
   /**
    * @param node               the ASTNode
    * @param constraintVariable the {@link org.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ConstraintVariable2} to be associated with node
    */

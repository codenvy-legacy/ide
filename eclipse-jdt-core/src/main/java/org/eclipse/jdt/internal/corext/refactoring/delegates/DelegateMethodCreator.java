...
public class DelegateMethodCreator extends DelegateCreator
{
   ...
   /**
    * @return the delegate incovation, either a {@link org.eclipse.jdt.core.dom.ConstructorInvocation}
    *         or a {@link org.eclipse.jdt.core.dom.MethodInvocation}. May be null if the delegate

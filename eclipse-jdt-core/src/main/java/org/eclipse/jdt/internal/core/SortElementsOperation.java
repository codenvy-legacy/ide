...
public class SortElementsOperation extends JavaModelOperation
{
    ...
    */
   public TextEdit calculateEdit(org.eclipse.jdt.core.dom.CompilationUnit unit,
      ...
      ast.accept(new ASTVisitor()
      {
         ...
         public boolean visit(org.eclipse.jdt.core.dom.CompilationUnit compilationUnit)
         {
            ...
            sortElements(compilationUnit.types(),
               rewriter.getListRewrite(compilationUnit, org.eclipse.jdt.core.dom.CompilationUnit.TYPES_PROPERTY));
            return true;
         }

...
/**
 * A type environment comprises a set of {@link TType}s that stand for Java {@link org.eclipse.jdt.core.dom.ITypeBinding}s.
 * In contrast to type bindings, TTypes of the same type environment also work across project boundaries and
 * across compiler environments, i.e. a type environment can handle bindings from multiple {@link org.eclipse.jdt.core.dom.ASTParser} sessions.
 *
 * @see TType
 */

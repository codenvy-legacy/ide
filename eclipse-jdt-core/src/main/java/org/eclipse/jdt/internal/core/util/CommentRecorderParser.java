   ...
   public int flushCommentsDefinedPriorTo(int position)
   {
      ...
      if (validCount > 0)
      {
         ...
         { // only tolerating non-javadoc comments (non-javadoc comment end positions are negative)
            ...
            if (org.eclipse.jdt.internal.compiler.util.Util.getLineNumber(position, this.scanner.lineEnds, 0,
               this.scanner.linePtr) != org.eclipse.jdt.internal.compiler.util.Util.getLineNumber(immediateCommentEnd,

...
public final class JavaModelUtil
{
   ...
   /**
    * The latest available {@link org.eclipse.jdt.core.JavaCore}{@code #VERSION_*} level.
    *
    * @since 3.7
    */
    ...
    * a name from an existing compilation unit with {@link #getRenamedCUName(org.eclipse.jdt.core.ICompilationUnit, String)}
    * <p>
    * Note: Unlike {@link org.eclipse.jdt.core.JavaCore#getJavaLikeExtensions()}, this suffix includes a leading ".".
    * </p>
    *
    * @see org.eclipse.jdt.core.JavaCore#getJavaLikeExtensions()
    * @see org.eclipse.jdt.core.JavaCore#isJavaLikeFileName(String)
    * @see org.eclipse.jdt.core.JavaCore#removeJavaLikeExtension(String)
    * @see #getRenamedCUName(org.eclipse.jdt.core.ICompilationUnit, String)
    */
    ...
    * @see #getTypeContainerName(org.eclipse.jdt.core.IType)
    */

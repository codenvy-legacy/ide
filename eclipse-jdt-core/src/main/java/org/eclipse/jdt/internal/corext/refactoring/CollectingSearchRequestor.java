...
public class CollectingSearchRequestor extends SearchRequestor
{
   ...
   /**
    * The default implementation calls {@link #collectMatch(org.eclipse.jdt.core.search.SearchMatch)} for
    * all matches that make it through {@link #filterMatch(org.eclipse.jdt.core.search.SearchMatch)}.
    *
   ...
   /**
    * @return a List of {@link org.eclipse.jdt.core.search.SearchMatch}es (not sorted)
    */

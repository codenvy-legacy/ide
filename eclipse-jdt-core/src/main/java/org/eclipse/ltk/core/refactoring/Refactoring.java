 ...
 * <li>{@link #checkInitialConditions(org.eclipse.core.runtime.IProgressMonitor)} is called. The method
 ...
 * <li>{@link #checkFinalConditions(org.eclipse.core.runtime.IProgressMonitor)} is called. The method
 * can be called more than once. The method must not be called if
 * {@link #checkInitialConditions(org.eclipse.core.runtime.IProgressMonitor)} returns a refactoring
 * status of severity {@link RefactoringStatus#FATAL}.</li>
 * <li>{@link #createChange(org.eclipse.core.runtime.IProgressMonitor)} is called. The method must only be
 * called once after each call to {@link #checkFinalConditions(org.eclipse.core.runtime.IProgressMonitor)}
...
public abstract class Refactoring extends PlatformObject
{
    ...
    * {@link org.eclipse.core.resources.IWorkspace#validateEdit(org.eclipse.core.resources.IFile[], Object)}.
    *
    ...
    * @see #checkInitialConditions(org.eclipse.core.runtime.IProgressMonitor)
    * @see #checkFinalConditions(org.eclipse.core.runtime.IProgressMonitor)
    */

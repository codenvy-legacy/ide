 ...
 * <p>
 * If the severity of the condition checking result is {@link org.eclipse.ltk.core.refactoring.RefactoringStatus#FATAL}
 ...
 * file (see {@link #createChange(org.eclipse.core.runtime.IProgressMonitor)} and {@link #getTextChange(Object)}).
 ...
 * </p>
 * <p>
 * Since 3.4, a refactoring participant can also override {@link #createPreChange(org.eclipse.core.runtime.IProgressMonitor)}
...
public abstract class RefactoringParticipant extends PlatformObject
{
   ...
   /**
    * Creates a {@link org.eclipse.ltk.core.refactoring.Change} object that contains the workspace modifications
    ...
    * </p>
    * <p>
    * Note that most refactorings will implement {@link #createChange(org.eclipse.core.runtime.IProgressMonitor)}
    ...
    * @see #createChange(org.eclipse.core.runtime.IProgressMonitor)
    * @since 3.4
    */
    ...
    * @throws org.eclipse.core.runtime.OperationCanceledException
    *          if the change creation got canceled
    * @see #createPreChange(org.eclipse.core.runtime.IProgressMonitor)
    */

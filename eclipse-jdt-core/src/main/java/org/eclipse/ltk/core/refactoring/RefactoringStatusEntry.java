...
public class RefactoringStatusEntry
{
   ...
   /**
    * Returns this refactoring status entry as an {@link org.eclipse.core.runtime.IStatus}.
    * <p>
    * If this refactoring status entry has a severity of
    * {@link RefactoringStatus#FATAL}, the returned status will have a
    * severity of {@link org.eclipse.core.runtime.IStatus#ERROR}, otherwise a status with severity

 ...
 * @see org.eclipse.ltk.internal.core.refactoring.history.RefactoringHistoryService
 * @since 3.2
 */
public class PerformRefactoringHistoryOperation implements IWorkspaceRunnable
{
    ...
    * @deprecated since 3.4. Override {@link #createRefactoring(RefactoringDescriptor, RefactoringStatus, org.eclipse.core.runtime.IProgressMonitor)} instead
    */
    ...
    *          if an error occurs while creating the refactoring instance
    * @since 3.4
    * @deprecated since 3.6. Override {@link #createRefactoringContext(RefactoringDescriptor, RefactoringStatus, org.eclipse.core.runtime.IProgressMonitor)} instead
    */

...
public abstract class RefactoringProcessor extends PlatformObject
{
    ...
    * @see org.eclipse.ltk.core.refactoring.RefactoringStatus#FATAL
    */
   ...
   /**
    * Creates a {@link org.eclipse.ltk.core.refactoring.Change} object describing the workspace modifications
    ...
    * {@link #checkFinalConditions(org.eclipse.core.runtime.IProgressMonitor, CheckConditionsContext)}has

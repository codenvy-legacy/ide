...
public class ResourceChangeChecker implements IConditionChecker
{
    ...
    *          a {@link org.eclipse.core.runtime.CoreException} if an error occurs
    * @see ResourceChangeValidator#validateChange(IResourceDelta, org.eclipse.core.runtime.IProgressMonitor)
    */

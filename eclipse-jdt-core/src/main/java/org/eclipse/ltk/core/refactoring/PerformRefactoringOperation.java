...
public class PerformRefactoringOperation implements IWorkspaceRunnable
{
    ...
    * of {@link #run(org.eclipse.core.runtime.IProgressMonitor)} will call {@link RefactoringContext#dispose()}.
    * </p>
    *
    ...
    * object is initialize via the call {@link Change#initializeValidationData(org.eclipse.core.runtime.IProgressMonitor)}
    *

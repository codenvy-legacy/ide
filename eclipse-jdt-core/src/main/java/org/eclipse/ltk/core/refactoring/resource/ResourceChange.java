...
public abstract class ResourceChange extends Change
{
   ...
   /**
    * Sets the validation methods used when the current resource is validated in {@link #isValid(org.eclipse.core.runtime.IProgressMonitor)}.
    * <p>
    ...
    * </p>
    *
    * @param validationMethod the validation method used in {@link #isValid(org.eclipse.core.runtime.IProgressMonitor)}.
   ...
   /**
    * This implementation of {@link org.eclipse.ltk.core.refactoring.Change#isValid(org.eclipse.core.runtime.IProgressMonitor)} tests the modified resource using the validation method

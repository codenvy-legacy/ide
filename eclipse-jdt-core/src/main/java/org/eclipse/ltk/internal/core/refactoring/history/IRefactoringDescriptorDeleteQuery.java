...
public interface IRefactoringDescriptorDeleteQuery
{
    ...
    * method returns a status of severity {@link org.eclipse.ltk.core.refactoring.RefactoringStatus#OK}.<br>
    * If a status of severity {@link org.eclipse.ltk.core.refactoring.RefactoringStatus#FATAL} is returned, the

...
public interface IProject extends IContainer, IAdaptable {
     ...
     *
     * @param configName
     *         the configuration to get the references for
     ...
     *
     * @param options
     *         kind of snapshot information to load
     ...
     *
     * @param description
     *         the description for the destination project
     * @param force
     *         a flag controlling whether resources that are not
     *         in sync with the local file system will be tolerated
     * @param monitor
     ...
     *
     * @param options
     *         kind of snapshot information to save
     * @param snapshotLocation
     *         URI for saving the snapshot to
     * @param monitor
     *         a progress monitor, or <code>null</code> if progress
     *         reporting is not desired
     * @throws CoreException

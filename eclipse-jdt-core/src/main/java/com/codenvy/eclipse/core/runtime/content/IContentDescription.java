 ...
 *******************************************************************************/
package com.codenvy.eclipse.core.runtime.content;

import com.codenvy.eclipse.core.internal.content.IContentConstants;
...
public interface IContentDescription {
    ...
    public final static QualifiedName   CHARSET         = new QualifiedName(IContentConstants.RUNTIME_NAME,
                                                                            "charset"); //$NON-NLS-1$
    /**
     * Key for the "byte order mark" property. This property is only meaningful
     * when describing byte streams.
     */
    public final static QualifiedName   BYTE_ORDER_MARK = new QualifiedName(IContentConstants.RUNTIME_NAME,
                                                                            "bom"); //$NON-NLS-1$
     ...
     *
     * @param key
     *         a key for the property to be verified

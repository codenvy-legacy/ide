...
import com.codenvy.eclipse.core.filebuffers.IAnnotationModelFactory;
...
public class ResourceExtensionRegistry extends ExtensionsRegistry {
     ...
     *
     * @param file
     *         the file for which to look up the factory
     ...
     *
     * @param file
     *         the file for which to look up the content types
     * @return the set of content types for the location
     */
     ...
     *
     * @param file
     *         the file for which to look up the setup participants

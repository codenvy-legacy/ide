 ...
 *******************************************************************************/
package com.codenvy.eclipse.core.runtime.jobs;
...
public interface IJobManager {
     ...
     *
     * @param rule
     *         the rule to begin applying in this thread, or <code>null</code>
     * @param monitor
     ...
     *
     * @param family
     *         the job family to cancel, or <code>null</code> to cancel all jobs
     ...
     *
     * @param provider
     *         the new provider, or <code>null</code> if no progress
     *         is needed
     */
     ...
     *
     * @param family
     *         the job family to sleep, or <code>null</code> to sleep all jobs.
     * @see Job#belongsTo(Object)
     */
     ...
     *
     * @param family
     *         the job family to wake up, or <code>null</code> to wake up all jobs
     * @see Job#belongsTo(Object)
     */

...
public class LocalizationUtils {
     ...
     *
     * @param key
     *         case-sensitive name of the filed in the translation file representing
     *         the string to be translated
     * @return The localized message or the non-translated key
     */
    static public String safeLocalize(String key) {
        try {
            Class messageClass = Class.forName("com.codenvy.eclipse.core.internal.runtime.CommonMessages"); //$NON-NLS-1$

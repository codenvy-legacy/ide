...
public abstract class AbstractDataTreeNode {
     ...
     * @param parentTree
     *         parent tree on which to base backward delta
     * @param key
     *         key of node in its tree
     */
    ...
    /**
     */
    protected static AbstractDataTreeNode[] compareWith(AbstractDataTreeNode[] oldNodes, AbstractDataTreeNode[] newNodes,
    ...
    public String toString() {
        return "an AbstractDataTreeNode(" + this.getName() + ") with " + getChildren().length + " children."; //$NON-NLS-1$ //$NON-NLS-2$
        //$NON-NLS-3$
    }

...
public interface IProjectDescription {
     ...
     *
     * @param configName
     *         the configuration in the described project to get the references for
     ...
     *
     * @param configName
     *         the configuration to set as the active or default
     * @since 3.7
     */
     ...
     *
     * @param configNames
     *         the configurations to set for the described project
     ...
     *
     * @param configName
     *         the configuration in the described project to set the references for
     * @param references
     ...
     *
     * @param buildSpec
     *         the array of build commands to run
     * @see IProject#setDescription(IProjectDescription, int, IProgressMonitor)
     * @see #getBuildSpec()
     * @see #newCommand()
     */

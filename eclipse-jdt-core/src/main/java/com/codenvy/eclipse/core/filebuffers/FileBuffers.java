...
import com.codenvy.eclipse.core.internal.filebuffers.ResourceTextFileBufferManager;
...
public final class FileBuffers {
     ...
     *         the location
     * @param isNormalized
     *         <code>true</code> if the given location is already normalized
     * @return the workspace file at the location or <code>null</code> if no such file exists or if
     *         the location is not a valid location
     * @since 3.3
     */
     ...
     * which there
     * {@link com.codenvy.eclipse.core.resources.IContainer#exists(com.codenvy.eclipse.core.runtime.IPath) exists}

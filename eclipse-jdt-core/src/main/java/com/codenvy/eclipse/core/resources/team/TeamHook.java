...
import com.codenvy.eclipse.core.internal.resources.InternalTeamHook;
...
public abstract class TeamHook extends InternalTeamHook {
     ...
     *
     * @see #getRuleFactory(com.codenvy.eclipse.core.resources.IProject)
     * @see #setRuleFactory(com.codenvy.eclipse.core.resources.IProject, com.codenvy.eclipse.core.resources.IResourceRuleFactory)
     * @since 3.0
     */
     ...
     *
     * @param project
     *         the project to change the resource rule factory for
     * @param factory
     *         the new resource rule factory
     * @see #getRuleFactory(com.codenvy.eclipse.core.resources.IProject)
     ...
     * @see com.codenvy.eclipse.core.resources.IResource#ALLOW_MISSING_LOCAL
     */
     ...
     * Validates whether a particular attempt at link creation is allowed.  This gives
     * team providers an opportunity to hook into the beginning of the implementation
     * of {@link com.codenvy.eclipse.core.resources.IFile#createLink(java.net.URI, int, com.codenvy.eclipse.core.runtime.IProgressMonitor) }
     * <p>
     * The implementation of this method runs "below" the resources API and is
     * therefore very restricted in what resource API method it can call. The
     * list of useable methods includes most resource operations that read but
...
//			return validateCreateLink(file, updateFlags, URIUtil.toPath(location));
     ...
     * Validates whether a particular attempt at link creation is allowed.  This gives
     * team providers an opportunity to hook into the beginning of the implementation
     * of {@link com.codenvy.eclipse.core.resources.IFolder#createLink(java.net.URI, int,

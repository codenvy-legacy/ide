 ...
 * are obtained from a {@link com.codenvy.eclipse.core.filebuffers.IFileBufferManager}.
 * </p>
 *
 * @since 3.0
 */
public interface IFileBuffer {
     ...
     * <p>
     * {IDocumentExtension4#UNKNOWN_MODIFICATION_STAMP} is returned if the
     ...
     *
     * @param isDirty
     *         <code>true</code> if the buffer should be marked dirty, <code>false</code> otherwise
     * @since 3.1
     */

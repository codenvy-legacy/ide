...
public interface IFileBufferManager {
     ...
     * @param monitor
     *         the progress monitor, or <code>null</code> if progress reporting is not desired
     * @throws CoreException
     *         if the file could not successfully be connected
     ...
     *         the progress monitor, or <code>null</code> if progress reporting is not desired
     * @throws CoreException
     *         if the file could not successfully be disconnected
     ...
     *
     * @param context
     *         the synchronization context managed by this file buffer manager
     */
     ...
     * @param location
     *         the location
     * @deprecated As of 3.1, replaced by {@link com.codenvy.eclipse.core.filebuffers.IFileBuffer#requestSynchronizationContext()}
     */
     ...
     * @param monitor
     *         the progress monitor, or <code>null</code> if progress reporting is not
     *         desired
     ...
     * @since 3.1
     */
    void validateState(IFileBuffer[] fileBuffers, IProgressMonitor monitor,
                       Object computationContext) throws CoreException;
}

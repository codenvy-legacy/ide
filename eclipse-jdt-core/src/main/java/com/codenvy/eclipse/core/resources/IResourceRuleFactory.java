 ...
 *
 * @see WorkspaceJob
 * @see IWorkspace#run(IWorkspaceRunnable, ISchedulingRule, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
 * @see com.codenvy.eclipse.core.runtime.jobs.MultiRule#combine(ISchedulingRule, ISchedulingRule)
 * @since 3.0
 */
public interface IResourceRuleFactory {
     ...
     *
     * @param resource
     *         the resource for which the charset will be changed
     * @return a scheduling rule, or <code>null</code>
     * @since 3.1
     */
     ...
     *
     * @param resource
     *         the resource for which the derived flag will be changed
     * @return a scheduling rule, or <code>null</code>
     * @since 3.6
     */

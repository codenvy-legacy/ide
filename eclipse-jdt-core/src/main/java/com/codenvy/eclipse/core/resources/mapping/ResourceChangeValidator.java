...
import com.codenvy.eclipse.core.internal.resources.mapping.ChangeDescription;
import com.codenvy.eclipse.core.internal.resources.mapping.ResourceChangeDescriptionFactory;
 ...
 * The change is then validated by calling the {@link #validateChange(com.codenvy.eclipse.core.resources.IResourceDelta, com.codenvy.eclipse.core.runtime.IProgressMonitor)}
 ...
 * </code>
 * If the result status does not have severity {@link com.codenvy.eclipse.core.runtime.IStatus#OK}, then
...
public final class ResourceChangeValidator
{
   ...
   private IStatus combineResults(IStatus[] result)
   {
      ...
      return new MultiStatus(ResourcesPlugin.PI_RESOURCES, 0, notOK.toArray(new IStatus[notOK.size()]),
         Messages.mapping_multiProblems, null);
   }
    ...
    * <p>
    * This method returns either a {@link ModelStatus}, or a {@link com.codenvy.eclipse.core.runtime.MultiStatus}

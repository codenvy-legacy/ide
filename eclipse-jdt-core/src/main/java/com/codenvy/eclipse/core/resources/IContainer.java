...
public interface IContainer extends IResource, IAdaptable {
    ...
    * Constants defining which members are wanted:
     ...
     *         <code>true</code> if phantom resources are
     ...
     *
     * @param charset
     *         a charset string, or <code>null</code>
     * @throws CoreException
     ...
     *
     * @param type
     *         ({@link IResourceFilterDescription#INCLUDE_ONLY} or
     ...
     *         which {@link org.eclipse.core.filesystem.IFileInfo} instances will be excluded from the resource tree
     * @param updateFlags
     ...
     * @throws CoreException
     *         if this filter could not be added. Reasons include:
     *         <ul>
     *         <li> Resource changes are disallowed during certain types of resource change
     ...
     * @throws CoreException
     *         if this resource's filters could not be retrieved. Reasons include:
     *         <ul>

...
import com.codenvy.eclipse.core.internal.filebuffers.NLSUtility;
...
public class ContainerCreator {
     ...
     *
     * @param workspace
     *         the workspace in which to create the container
     * @param fullPath
     *         the full path of the container, must not denote a file
     */
    ...
    public IContainer createContainer(IProgressMonitor progressMonitor) throws CoreException {
        IWorkspaceRunnable runnable = new IWorkspaceRunnable() {
            public void run(IProgressMonitor monitor) throws CoreException {
                monitor.beginTask(FileBuffersMessages.ContainerCreator_task_creatingContainer,
                                  fContainerFullPath.segmentCount());
                if (fContainer != null) {
                    return;
                }
                ...
                if (found instanceof IContainer) {
                    ...
                    throw new CoreException(new Status(IStatus.ERROR, FileBuffersPlugin.PLUGIN_ID, IStatus.OK,
                                                       NLSUtility.format(FileBuffersMessages.ContainerCreator_destinationMustBeAContainer,
                                                                         fContainerFullPath), null));
                }
                ...
                for (int i = 0; i < fContainerFullPath.segmentCount(); i++) {
                    ...
                    if (resource != null) {
                        if (resource instanceof IContainer) {
                            ...
                            throw new CoreException(new Status(IStatus.ERROR, FileBuffersPlugin.PLUGIN_ID, IStatus.OK,
                                                               NLSUtility
                                                                       .format(FileBuffersMessages
                                                                                       .ContainerCreator_destinationMustBeAContainer,

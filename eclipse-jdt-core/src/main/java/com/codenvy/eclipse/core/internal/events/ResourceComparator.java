...
import com.codenvy.eclipse.core.internal.watson.IElementComparator;
...
public class ResourceComparator implements IElementComparator, ICoreConstants {
     ...
     *
     * @param notification
     *         if true, check for marker deltas.
     * @param save
     *         if true, check for all resource changes that snapshot needs
     */

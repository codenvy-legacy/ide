...
public abstract class AbstractDataTree
{
    ...
    * @throws ObjectNotFoundException parentKey does not exist in the receiver
    ...
    * @throws ObjectNotFoundException a child of parentKey with name localName does not exist in the receiver
    * @throws RuntimeException        receiver is immutable
    */
    ...
    * @throws ObjectNotFoundException        parentKey does not exist in the receiver
    * @throws ArrayIndexOutOfBoundsException if no child with the given index (runtime exception)
    */
    ...
    * @throws ObjectNotFoundException key does not exist in the receiver
    */
    ...
    * @throws ObjectNotFoundException        parentKey does not exist in the receiver
    * @throws ArrayIndexOutOfBoundsException if no child with the given index
    */
    ...
    * @throws ObjectNotFoundException  the nodeKey does not exist in the receiver
    * @throws IllegalArgumentException receiver is immutable
    */

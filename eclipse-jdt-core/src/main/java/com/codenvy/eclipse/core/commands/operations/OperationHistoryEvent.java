...
public final class OperationHistoryEvent
{
    ...
    *
    * @param code      the event code to be used.
    * @param history   the history triggering the event.
    * @param operation the operation involved in the event.
    */
    ...
    * @param history   the history triggering the event.
    * @param operation the operation involved in the event.
    * @param status    the status associated with the event, or null if no status is
    *                  available.
    * @since 3.2
    */

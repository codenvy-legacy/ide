...
public interface IResource extends IAdaptable, ISchedulingRule {
    ...
    * Constants defining the depth of resource tree traversal:
     ...
     *
     * @param type
     *         the type of marker to consider (normally {@link IMarker#PROBLEM}
     ...
     *
     * @param depth
     *         valid values are <code>DEPTH_ZERO</code>,
     ...
     *
     * @param depth
     *         the depth (one of <code>IResource.DEPTH_ZERO</code>,
     *         <code>DEPTH_ONE</code>, or <code>DEPTH_INFINITE</code>)
     ...
     *
     * @param isDerived
     *         <code>true</code> if this resource is to be marked

...
public class DeltaDataTree extends AbstractDataTree
{
   ...
   /**
    * @see AbstractDataTree#createChild(com.codenvy.eclipse.core.runtime.IPath, String)
    */
   ...
   /**
    * @see AbstractDataTree#createChild(com.codenvy.eclipse.core.runtime.IPath, String, Object)
    */
   ...
   /**
    * @see AbstractDataTree#createSubtree(com.codenvy.eclipse.core.runtime.IPath, AbstractDataTreeNode)
    */
   ...
   /**
    * @see AbstractDataTree#deleteChild(com.codenvy.eclipse.core.runtime.IPath, String)
    */
   ...
   /**
    * @see AbstractDataTree#getChildCount(com.codenvy.eclipse.core.runtime.IPath)
    */
   ...
   /**
    * @see AbstractDataTree#getChildren(com.codenvy.eclipse.core.runtime.IPath)
    */
   ...
   /**
    * @see AbstractDataTree#getNameOfChild(com.codenvy.eclipse.core.runtime.IPath, int)
    */
    ...
    *
    * @see AbstractDataTree#getNamesOfChildren(com.codenvy.eclipse.core.runtime.IPath)
    */
    ...
    *
    * @throws RuntimeException receiver is not immutable
    */
    ...
    * @throws RuntimeException sourceTree is not immutable
    */
   ...
   /**
    * @see AbstractDataTree#setData(com.codenvy.eclipse.core.runtime.IPath, Object)
    */

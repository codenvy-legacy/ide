...
import com.codenvy.eclipse.core.internal.jobs.InternalJob;
import com.codenvy.eclipse.core.internal.jobs.JobManager;
...
public abstract class Job extends InternalJob implements IAdaptable {
     ...
     *
     * @param monitor
     *         a progress monitor, or <tt>null</tt> if progress

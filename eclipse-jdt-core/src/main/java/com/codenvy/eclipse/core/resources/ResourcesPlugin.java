...
public final class ResourcesPlugin {
    ...
    * Constants defining the ids of the standard workspace extension points:
     ...
     *
     * @see IJobManager#join(Object, com.codenvy.eclipse.core.runtime.IProgressMonitor)
     * @since 3.0
     */
    ...
    private static ConcurrentHashMap<String, IWorkspace> workspaceMap = new ConcurrentHashMap<String, IWorkspace>();
    //
     ...
     *         if the workspace structure could not be constructed.
     *         Reasons include:
     *         <ul>

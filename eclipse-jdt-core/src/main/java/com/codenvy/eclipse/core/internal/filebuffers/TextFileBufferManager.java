 ...
 *     Andrew Ferguson (Symbian) - [api] enable document setup participants to customize behavior based on resource being opened -
...
import com.codenvy.eclipse.core.filebuffers.IFileBufferListener;
import com.codenvy.eclipse.core.filebuffers.IFileBufferStatusCodes;
import com.codenvy.eclipse.core.filebuffers.ISynchronizationContext;
...
import com.codenvy.eclipse.core.runtime.content.IContentType;
...
public class TextFileBufferManager implements ITextFileBufferManager {
    ...
    protected static final IContentType TEXT_CONTENT_TYPE = null;
    ...
    /*
     * @see org.eclipse.core.filebuffers.IFileBufferManager#connect(org.eclipse.core.runtime.IPath,
     * org.eclipse.core.filebuffers.IFileBufferManager.LocationKind, org.eclipse.core.runtime.IProgressMonitor)
     * @since 3.3
     */
    public void connect(IPath location, LocationKind locationKind, IProgressMonitor monitor) throws CoreException {
        ...
        if (fileBuffer == null) {
            throw new CoreException(
                    new Status(IStatus.ERROR, FileBuffersPlugin.PLUGIN_ID, IFileBufferStatusCodes.CREATION_FAILED,
    ...
    //	/*
    //	 * @see org.eclipse.core.filebuffers.IFileBufferManager#connectFileStore(org.eclipse.core.filesystem.IFileStore,
    ...
    //		if (fileBuffer == null)
    //			throw new CoreException(new Status(IStatus.ERROR, FileBuffersPlugin.PLUGIN_ID, IFileBufferStatusCodes.CREATION_FAILED,
    // FileBuffersMessages.FileBufferManager_error_canNotCreateFilebuffer, null));
    //
    ...
    /*
     * @see org.eclipse.core.filebuffers.IFileBufferManager#disconnect(org.eclipse.core.runtime.IPath,
     * org.eclipse.core.filebuffers.IFileBufferManager.LocationKind, org.eclipse.core.runtime.IProgressMonitor)
     * @since 3.3
     */
    ...
    //	/*
    //	 * @see org.eclipse.core.filebuffers.IFileBufferManager#disconnectFileStore(org.eclipse.core.filesystem.IFileStore,
    // org.eclipse.core.runtime.IProgressMonitor)
    //	 * @since 3.3
    //	 */
     ...
     * org.eclipse.core.filebuffers.IFileBufferManager.LocationKind)
     * @since 3.3
     */
    ...
    public IDocument createEmptyDocument(final IPath location, final LocationKind locationKind) {
        ...
        //							String message= NLSUtility.format(FileBuffersMessages
        // .TextFileBufferManager_warning_documentSetupInstallsDefaultPartitioner, participant.getClass());
     ...
     *             {@link com.codenvy.eclipse.core.filebuffers.IFileBuffer#requestSynchronizationContext()}
     */
     ...
     *
     * @param location
     *         the location of the file to be connected
     * @param locationKind
    ...
    protected AbstractFileBuffer createTextFileBuffer(IPath location, LocationKind locationKind) {
        ...
        return new ResourceTextFileBuffer((ResourceTextFileBufferManager)this);
    }

...
import com.codenvy.eclipse.core.resources.IPathVariableChangeEvent;
...
public class PathVariableChangeEvent extends EventObject implements IPathVariableChangeEvent {
    ...
    /** @see com.codenvy.eclipse.core.resources.IPathVariableChangeEvent#getValue() */
    public IPath getValue() {
        return value;
    }

    /** @see com.codenvy.eclipse.core.resources.IPathVariableChangeEvent#getVariableName() */
    public String getVariableName() {
        return variableName;
    }

    /** @see com.codenvy.eclipse.core.resources.IPathVariableChangeEvent#getType() */
    public int getType() {
        return type;
    }

 ...
 *
 * Contributors:
 *     Andrew Ferguson (Symbian) - Initial implementation - [api] enable document setup participants to customize behaviour based on
 *     resource being opened - https://bugs.eclipse.org/bugs/show_bug.cgi?id=208881
 *******************************************************************************/
 ...
 * {@link com.codenvy.eclipse.core.filebuffers.IDocumentSetupParticipant}.
 * <p/>
 * <p>
 ...
 * </p>
 *
 * @see com.codenvy.eclipse.core.filebuffers.IDocumentSetupParticipant
 * @since 3.4
 */
public interface IDocumentSetupParticipantExtension {
     ...
     * @param location
     *         a path of the resource backing the new document
     * @param locationKind

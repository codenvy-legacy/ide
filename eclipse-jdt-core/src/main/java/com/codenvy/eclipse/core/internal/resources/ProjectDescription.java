...
public class ProjectDescription implements IProjectDescription {
     ...
     * {@link com.codenvy.eclipse.core.resources.IBuildConfiguration#DEFAULT_CONFIG_NAME}
    ...
    protected Map<String, IBuildConfiguration[]> cachedConfigRefs = Collections.synchronizedMap(
            new HashMap<String, IBuildConfiguration[]>(1));
    ...
    //	/**
    //	 * Helper to turn an array of projects into an array of {@link org.eclipse.core.resources.IBuildConfiguration} to the
    ...
    public IBuildConfiguration[] getAllBuildConfigReferences(String configName, boolean makeCopy) {
        ...
        //			IBuildConfiguration[] dynamicBuildConfigs = dynamicConfigRefs.containsKey(configName) ? dynamicConfigRefs.get(configName) :
    ...
    public IBuildConfiguration[] getBuildConfigRefs(String configName, boolean makeCopy) {
        ...
        return makeCopy ? (IBuildConfiguration[])dynamicConfigRefs.get(configName).clone() : dynamicConfigRefs.get(
                configName);
    }
    ...
    /**
     * @see com.codenvy.eclipse.core.resources.IProjectDescription#getLocation()
     * @deprecated
     */
    public IPath getLocation() {
        ...
        return null; /*FileUtil.toPath(location)*/
    }
     ...
     * @see #setSnapshotLocationURI(java.net.URI)
     * @since 3.6
     */
    ...
    public void setBuildConfigs(String[] names) {
        ...
        if (names == null || names.length == 0) {
            ...
            if (buildConfigNames.size() == 1 && ((buildConfigNames.iterator().next())).equals(
     ...
     *
     * @param description
     *         Project description to copy dynamic state from

...
import com.codenvy.eclipse.core.runtime.IProgressMonitorWithBlocking;
...
import com.codenvy.eclipse.core.runtime.jobs.IJobChangeEvent;
import com.codenvy.eclipse.core.runtime.jobs.IJobChangeListener;
import com.codenvy.eclipse.core.runtime.jobs.IJobManager;
import com.codenvy.eclipse.core.runtime.jobs.ILock;
import com.codenvy.eclipse.core.runtime.jobs.ISchedulingRule;
import com.codenvy.eclipse.core.runtime.jobs.Job;
import com.codenvy.eclipse.core.runtime.jobs.JobChangeAdapter;
import com.codenvy.eclipse.core.runtime.jobs.LockListener;
import com.codenvy.eclipse.core.runtime.jobs.MultiRule;
import com.codenvy.eclipse.core.runtime.jobs.ProgressProvider;
...
public class JobManager implements IJobManager {
    ...
    private JobManager() {
        ...
        pool.setDaemon(/*JobOSGiUtils.getDefault().useDaemonThreads()*/ false);
        internalWorker = new InternalWorker(this);
        internalWorker.setDaemon(/*JobOSGiUtils.getDefault().useDaemonThreads()*/ false);
    ...
    /* (non-Javadoc)
     * @see org.eclipse.core.runtime.jobs.IJobManager#beginRule(org.eclipse.core.runtime.jobs.ISchedulingRule,
    ...
    private void doShutdown() {
        ...
        if (toCancel != null) {
            for (int i = 0; i < toCancel.length; i++) {
                ...
                String msg =
                        "Job found still running after platform shutdown.  Jobs should be canceled by the plugin that scheduled them " +
                        "during shutdown: " +
                        jobName; //$NON-NLS-1$
...
//		DEBUG_SHUTDOWN = JobOSGiUtils.getDefault().getBooleanDebugOption(OPTION_SHUTDOWN, false);
     ...
     * (non-Javadoc)
     *
     * @see com.codenvy.eclipse.core.runtime.jobs.IJobManager#resume(com.codenvy.eclipse.core.runtime.jobs.ISchedulingRule)
    ...
    /** Implementation of {@link com.codenvy.eclipse.core.runtime.jobs.Job#yieldRule(IProgressMonitor)} */
    ...
    /** Invokes {@link com.codenvy.eclipse.core.runtime.jobs.Job#shouldRun()} while guarding against unexpected failures. */
    private boolean shouldRun(Job job) {
        ...
        Util.log(new Status(IStatus.ERROR, JobManager.PI_JOBS, JobManager.PLUGIN_ERROR, "Error invoking shouldRun() method on: " + job,
                            t)); //$NON-NLS-1$
     ...
     * (non-Javadoc)
     *
     * @see com.codenvy.eclipse.core.runtime.jobs.IJobManager#suspend(com.codenvy.eclipse.core.runtime.jobs.ISchedulingRule,

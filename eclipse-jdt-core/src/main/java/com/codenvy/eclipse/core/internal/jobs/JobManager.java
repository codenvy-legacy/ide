...
//		DEBUG_SHUTDOWN = JobOSGiUtils.getDefault().getBooleanDebugOption(OPTION_SHUTDOWN, false);
	...
	private boolean shouldRun(Job job) {
		...
		Util.log(new Status(IStatus.ERROR, JobManager.PI_JOBS, JobManager.PLUGIN_ERROR, "Error invoking shouldRun() method on: " + job, t)); //$NON-NLS-1$
	...
	/** (non-Javadoc)
	 * @deprecated this method should not be used
	 * @see com.codenvy.eclipse.core.runtime.jobs.IJobManager#suspend(com.codenvy.eclipse.core.runtime.jobs.ISchedulingRule, com.codenvy.eclipse.core.runtime.IProgressMonitor)
	 */

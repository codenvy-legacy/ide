...
import com.codenvy.eclipse.core.internal.resources.IMarkerSetElement;
...
import com.codenvy.eclipse.resources.ResourceInfo;
...
public class ResourceDelta extends PlatformObject implements IResourceDelta
{
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#findMember(com.codenvy.eclipse.core.runtime.IPath)
    */
         ...
         switch (kind)
         {
            ...
            case ADDED:
               ...
               if (oldPath != null && !oldPath.equals(path))
               {
                  ...
                  status = (status & KIND_MASK) | (deltaInfo.getComparator().compare(actualOldInfo,
                     newInfo) & ~KIND_MASK);
                  status |= MOVED_FROM;
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getAffectedChildren()
    */
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getAffectedChildren(int)
    */
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getFlags()
    */
   public int getFlags()
   {
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getFullPath()
    */
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getKind()
    */
   public int getKind()
   {
      return status & KIND_MASK;
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getMarkerDeltas()
    */
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getMovedFromPath()
    */
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getMovedToPath()
    */
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getProjectRelativePath()
    */
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IResourceDelta#getResource()
    */

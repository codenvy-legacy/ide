 ...
 *******************************************************************************/
package com.codenvy.eclipse.core.commands.operations;

import com.codenvy.eclipse.core.commands.ExecutionException;
...
public interface IOperationHistory
{
    ...
    */
   public static final IStatus NOTHING_TO_REDO_STATUS = new OperationStatus(IStatus.INFO,
      OperationStatus.DEFAULT_PLUGIN_ID, OperationStatus.NOTHING_TO_REDO, "No operation to redo", null); //$NON-NLS-1$

   /**
    * An operation info status describing the condition that there is no
    * available operation for undo.
    */
   public static final IStatus NOTHING_TO_UNDO_STATUS = new OperationStatus(IStatus.INFO,
      OperationStatus.DEFAULT_PLUGIN_ID, OperationStatus.NOTHING_TO_UNDO, "No operation to undo", null); //$NON-NLS-1$
    ...
    */
   public static final IStatus OPERATION_INVALID_STATUS = new OperationStatus(IStatus.ERROR,
      OperationStatus.DEFAULT_PLUGIN_ID, OperationStatus.OPERATION_INVALID, "Operation is not valid",
      null); //$NON-NLS-1$
    ...
    * </p>
    *
    * @param approver the IOperationApprover to be added as an approver.the instance
    ...
    * @see com.codenvy.eclipse.core.commands.operations.IOperationApprover
    */
    ...
    * </p>
    *
    * @param listener the IOperationHistoryListener to be added as a listener. Must
    *                 not be <code>null</code>. If an attempt is made to register
    *                 an instance which is already registered with this instance,
    *                 this method has no effect.
    * @see com.codenvy.eclipse.core.commands.operations.IOperationHistoryListener
    * @see com.codenvy.eclipse.core.commands.operations.OperationHistoryEvent
    */
    ...
    * </p>
    *
    * @param operationOK  <code>true</code> if the operation successfully completed.
    ...
    * @param addToHistory <code>true</code> if the operation should be added to the
    ...
    * @param mode         the mode the operation was opened in. Can be one of
    ...
    * </p>
    *
    * @param context      the context to be disposed
    * @param flushUndo    <code>true</code> if the context should be flushed from the
    *                     undo history, <code>false</code> if it should not
    * @param flushRedo    <code>true</code> if the context should be flushed from the
    *                     redo history, <code>false</code> if it should not.
    * @param flushContext <code>true</code> if the context is no longer in use and
    ...
    * </p>
    *
    * @param context the context whose limit is requested
    ...
    * </p>
    *
    * @param context the context for the redo
    ...
    * </p>
    *
    * @param context the context for the undo
    * @return the array of operations in the history
    */
    ...
    * </p>
    *
    * @param operation the composite operation to be considered as the parent for all
    *                  subsequent operations.
    * @param mode      the mode the operation is executing in. Can be one of
    *                  <code>EXECUTE</code>, <code>UNDO</code>, or
    *                  <code>REDO</code>. This determines what notifications are
    *                  sent.
    */
    ...
    * </p>
    *
    * @param context the context to be redone
    ...
    * @param monitor   the progress monitor to be used for the redo, or code>null</code>
    ...
    * </p>
    *
    * @param approver the IOperationApprover to be removed. Must not be
    ...
    * </p>
    *
    * @param listener The IOperationHistoryListener to be removed. Must not be
    *                 <code>null</code>. If an attempt is made to remove an
    *                 instance which is not already registered with this instance,
    *                 this method has no effect.
    */
    ...
    * </p>
    *
    * @param operation    The IUndoableOperation to be replaced
    * @param replacements the array of IUndoableOperation to replace the first operation
    */
    ...
    * </p>
    *
    * @param context the context whose limit is being set.
    * @param limit   the maximum number of operations that should be kept in the
    ...
    * </p>
    *
    * @param context the context to be undone
    * @param monitor the progress monitor to be used for the undo, or
    *                <code>null</code> if no progress monitor is provided.
    * @param info    the IAdaptable (or <code>null</code>) provided by the
    *                caller in order to supply UI information for prompting the
    *                user if necessary. When this parameter is not

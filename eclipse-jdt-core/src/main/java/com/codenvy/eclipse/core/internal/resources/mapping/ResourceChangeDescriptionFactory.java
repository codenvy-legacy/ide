...
public class ResourceChangeDescriptionFactory implements IResourceChangeDescriptionFactory {
     ...
     *
     * @param parentDelta
     *         The parent of the deletion delta to create
     * @param resource
     *         The deleted resource to create a delta for
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.core.resources.mapping.IProposedResourceDeltaFactory#copy(org.eclipse.core.resources.IResource,
    ...
    private void fail(CoreException e) {
        Policy.log(e.getStatus().getSeverity(), "An internal error occurred while accumulating a change description.",
                   e); //$NON-NLS-1$
    }
    ...
    /* (non-Javadoc)
     * @see org.eclipse.core.resources.mapping.IProposedResourceDeltaFactory#move(org.eclipse.core.resources.IResource,
     * org.eclipse.core.runtime.IPath)
     */
     ...
     *         The root of the destination sub-tree
     * @param move
     *         <code>true</code> for a move, <code>false</code> for a copy

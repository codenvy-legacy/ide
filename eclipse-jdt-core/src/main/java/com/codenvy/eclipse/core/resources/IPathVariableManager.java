...
public interface IPathVariableManager {
     ...
     * @param value
     *         the value for the variable (may be <code>null</code>)
     * @throws CoreException
     *         if this method fails. Reasons include:
     ...
     *
     * @param value
     *         the value encoded using OS string (as returned from Path.toOSString())
     * @param locationFormat
     *         indicates whether the value contains a string that is stored in the linked resource location rather than in the path variable
     *         value

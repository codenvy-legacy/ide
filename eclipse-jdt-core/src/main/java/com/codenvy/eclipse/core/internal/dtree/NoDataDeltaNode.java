...
public class NoDataDeltaNode extends AbstractDataTreeNode {
    ...
    /** @see AbstractDataTreeNode#compareWithParent(com.codenvy.eclipse.core.runtime.IPath, DeltaDataTree, IComparator) */
    ...
    public String toString() {
        return "a NoDataDeltaNode(" + this.getName() + ") with " + getChildren().length +

 ...
 *******************************************************************************/
package com.codenvy.eclipse.core.resources.mapping;

import com.codenvy.eclipse.core.internal.resources.mapping.ModelProviderManager;
 ...
 * </p>
 *
 * @see com.codenvy.eclipse.core.resources.mapping.ResourceMapping
 * @since 3.2
 */
public abstract class ModelProvider extends PlatformObject
{
    ...
    * {@link #getMappings(com.codenvy.eclipse.core.resources.IResource[], ResourceMappingContext, com.codenvy.eclipse.core.runtime.IProgressMonitor)}
    * or {@link #getMappings(ResourceTraversal[], ResourceMappingContext, com.codenvy.eclipse.core.runtime.IProgressMonitor)}
    ...
    * This method is used to map operations on resources to
    * operations on resource mappings. By default, this method
    * calls {@link #getMappings(com.codenvy.eclipse.core.resources.IResource[], ResourceMappingContext, com.codenvy.eclipse.core.runtime.IProgressMonitor)}
    ...
    * <p>
    * This method must return either a {@link ModelStatus}, or a {@link com.codenvy.eclipse.core.runtime.MultiStatus}
   ...
   {
      return new ModelStatus(IStatus.OK, ResourcesPlugin.PI_RESOURCES, descriptor.getId(),

...
public abstract class ModelProvider extends PlatformObject {
     ...
     * {@link #getMappings(com.codenvy.eclipse.core.resources.IResource[], ResourceMappingContext,
     ...
     * This method is used to map operations on resources to
     * operations on resource mappings. By default, this method
     * calls {@link #getMappings(com.codenvy.eclipse.core.resources.IResource[], ResourceMappingContext,
     * com.codenvy.eclipse.core.runtime.IProgressMonitor)}
     ...
     *
     * @param mappings
     *         the mappings being mapped to resources
     * @param context

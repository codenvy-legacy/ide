...
public interface IResourceStatus extends IStatus
{
	 ...
	 * Severity: error. Category: workspace.
	 * @see IContainer#setDefaultCharset(String, com.codenvy.eclipse.core.runtime.IProgressMonitor)
	 * @see IFile#setCharset(String, com.codenvy.eclipse.core.runtime.IProgressMonitor)
	 * @since 3.0 
	 */

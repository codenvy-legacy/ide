 ...
 * </p>
 *
 * @see com.codenvy.eclipse.core.resources.IResource
...
public abstract class ResourceMapping extends PlatformObject
{
    ...
    * The visitor's {@link com.codenvy.eclipse.core.resources.IResourceVisitor#visit} method is called for each
    ...
    *          </ul>
    */
   public void accept(ResourceMappingContext context, IResourceVisitor visitor,
    ...
    */
   public abstract ResourceTraversal[] getTraversals(ResourceMappingContext context,
      IProgressMonitor monitor) throws CoreException;

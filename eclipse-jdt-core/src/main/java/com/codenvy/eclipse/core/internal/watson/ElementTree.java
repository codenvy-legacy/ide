...
import com.codenvy.eclipse.core.internal.dtree.AbstractDataTreeNode;
import com.codenvy.eclipse.core.internal.dtree.DataTreeLookup;
import com.codenvy.eclipse.core.internal.dtree.DataTreeNode;
import com.codenvy.eclipse.core.internal.dtree.DeltaDataTree;
import com.codenvy.eclipse.core.internal.dtree.ObjectNotFoundException;
 ...
 * tree.
 *
 * @see com.codenvy.eclipse.core.runtime.IPath
 *      <p/>
...
public class ElementTree {
     ...
     *         element key
     * @param data
     *         element data, or <code>null</code>
     */
     ...
     *
     * @param key
     *         The path of the new subtree in this tree.
     * @see #getSubtree(com.codenvy.eclipse.core.runtime.IPath)
     */
    ...
    public static int findOldest(ElementTree[] trees) {
        ...
        HashMap<ElementTree, ElementTree> candidates = new HashMap<ElementTree, ElementTree>(
                (int)(trees.length * 1.5 + 1));
     ...
     *
     * @see #createSubtree(com.codenvy.eclipse.core.runtime.IPath, ElementTree)
     */
     ...
     *
     * @param path
     *         The path of the subtree chain to merge
     * @param trees
    ...
    public ElementTree mergeDeltaChain(IPath path, ElementTree[] trees) {
        if (path == null || trees == null) {
            throw new IllegalArgumentException(
                    NLS.bind(Messages.watson_nullArg, "ElementTree.mergeDeltaChain")); //$NON-NLS-1$
        }
     ...
     *         element identifier
     * @param data
     *         element info, or <code>null</code>
     */

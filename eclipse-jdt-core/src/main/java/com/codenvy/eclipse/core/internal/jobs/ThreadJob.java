...
class ThreadJob extends Job {
     ...
     *
     * @param monitor
     *         - The <code>IProgressMonitor</code> used to report blocking status and
     *         cancellation.
     ...
     * @see com.codenvy.eclipse.core.runtime.jobs.LockListener#aboutToWait(Thread)
     * @see com.codenvy.eclipse.core.runtime.jobs.LockListener#canBlock()
     * @see JobManager#transferRule(com.codenvy.eclipse.core.runtime.jobs.ISchedulingRule, Thread)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.codenvy.eclipse.core.runtime.jobs.Job#run(com.codenvy.eclipse.core.runtime.IProgressMonitor)
     */

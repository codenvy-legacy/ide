...
public class ExtensionsRegistry {
    ...
    //			if (contentType == null) {
    //				log(new Status(IStatus.ERROR, FileBuffersPlugin.PLUGIN_ID, IStatus.OK, NLSUtility.format(FileBuffersMessages
    // .ExtensionsRegistry_error_contentTypeDoesNotExist, value), null));
    //				return;
    //			}
    ...
    //			log(new Status(IStatus.ERROR, FileBuffersPlugin.PLUGIN_ID, 0, NLSUtility.format(FileBuffersMessages
    // .ExtensionsRegistry_error_extensionPointNotFound, extensionPointName), null));
    //			return;
    //		}
    //
    ...
    //			return (org.eclipse.core.filebuffers.IDocumentFactory)getExtension(entry, fFactories,

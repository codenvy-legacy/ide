...
public interface IWorkspace extends IAdaptable {
     ...
     * <p/>
     * <pre>
     * addResourceChangeListener(listener, IResourceChangeEvent.PRE_CLOSE | IResourceChangeEvent.PRE_DELETE |
     ...
     *
     * @param buildConfigs
     *         array of configurations to build
     * @param kind
     *         the kind of build being requested. Valid values are
     *         <ul>
     *         <li>{@link IncrementalProjectBuilder#FULL_BUILD}- indicates a full build.</li>
     ...
     *         not actually build anything, but rather discards all problems and build states.</li>
     *         </ul>
     * @param buildReferences
     *         boolean indicating if references should be transitively built.
     * @param monitor
     *         a progress monitor, or <code>null</code> if progress
     *         reporting is not desired
     * @throws CoreException
     ...
     *
     * @param pluginId
     *         the unique identifier of the plug-in, or <code>null</code>
     ...
     *
     * @param filterMatcherId
     *         the filter matcher extension identifier (e.g.
     ...
     *
     * @param projectName
     *         the name of the project on which the configuration will exist
     * @param configName
     *         the name of the new build configuration
     ...
     *
     * @param full
     *         <code>true</code> if this is a full save, and
...
//   public void setWorkspaceLock(WorkspaceLock lock);
     ...
     * @param context
     *         either {@link IWorkspace#VALIDATE_PROMPT},
     ...
     *
     * @param resource
     *         the resource to validate the location for
     ...
     *
     * @param project
     *         the project to validate the location for, can be <code>null</code>
     *         if non default project location is validated
     * @param location
     *         the location of the project contents on disk, or <code>null</code>

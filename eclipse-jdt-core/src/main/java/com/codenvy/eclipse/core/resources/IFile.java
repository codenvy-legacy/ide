...
import com.codenvy.eclipse.core.runtime.content.IContentTypeManager;
...
public interface IFile extends IResource, IEncodedStorage, IAdaptable {
     ...
     *
     * @param source
     *         an input stream containing the new contents of the file
     * @param force
     ...
     *
     * @param source
     *         a previous state of this resource
     * @param force
     *         a flag controlling how to deal with resources that
     *         are not in sync with the local file system
     * @param keepHistory

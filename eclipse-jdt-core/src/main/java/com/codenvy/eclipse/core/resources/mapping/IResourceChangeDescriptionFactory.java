 ...
 * that can then be passed to the {ResourceChangeValidator#validateChange(org.eclipse.core.resources.IResourceDelta,
...
public interface IResourceChangeDescriptionFactory {
     ...
     *
     * @param file
     *         the file whose contents will be changed
     */
     ...
     *
     * @param project
     *         the project that will be closed
     */
     ...
     *
     * @param resource
     *         the resource that will be copied
     * @param destination
     ...
     *
     * @param resource
     *         the resource that will be deleted
     */

 ...
 * </p>
 *
 * @see com.codenvy.eclipse.core.runtime.content.IContentTypeMatcher
 * @since 3.0
 */
...
//		 */
    ...
    public interface ISelectionPolicy {
         ...
         *
         * @param candidates
         *         an array containing content types matching some query
         * @param fileName
         *         whether it is a file name-based content type matching
         * @param content

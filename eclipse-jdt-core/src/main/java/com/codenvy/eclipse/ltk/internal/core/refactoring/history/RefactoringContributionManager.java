...
public final class RefactoringContributionManager
{
   ...
   public RefactoringDescriptor createDescriptor(final String id, final String project, final String description,
      final String comment, final Map arguments, final int flags) throws IllegalArgumentException
   {
      Assert.isNotNull(id);
   ...
   private void populateCache()
   {
      ...
      //					} else
      //						RefactoringCorePlugin.logErrorMessage(
      //                     Messages.format(RefactoringCoreMessages.RefactoringCorePlugin_missing_class_attribute,
      //                        new String[]{point, attributeId, ATTRIBUTE_CLASS}));
      //				} else
      //					RefactoringCorePlugin.logErrorMessage(
      //                  Messages.format(RefactoringCoreMessages.RefactoringCorePlugin_missing_attribute,

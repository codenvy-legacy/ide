...
import com.codenvy.eclipse.ltk.internal.core.refactoring.resource.RenameResourceProcessor;
...
public final class RenameResourceDescriptor extends RefactoringDescriptor {
     ...
     *         <code>true</code> if this rename will update references
     */
    ...
    public Refactoring createRefactoring(RefactoringStatus status) throws CoreException {
        ...
        if (resource == null || !resource.exists()) {
            status.addFatalError(
                    Messages.format(RefactoringCoreMessages.RenameResourceDescriptor_error_resource_not_existing,

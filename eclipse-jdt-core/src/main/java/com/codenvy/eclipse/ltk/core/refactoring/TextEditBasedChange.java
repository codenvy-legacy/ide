...
public abstract class TextEditBasedChange extends Change {
    ...
    String getContent(IDocument document, IRegion region, boolean expandRegionToFullLine,
        ...
        try {
            if (expandRegionToFullLine) {
                ...
                if (region.getLength() == 0) {
                    ...
                    endLine = Math.min(document.getLineOfOffset(region.getOffset()) + surroundingLines - 1,
     ...
     */
    public abstract String getCurrentContent(IRegion region, boolean expandRegionToFullLine, int surroundingLines,
     ...
     */
    public abstract String getPreviewContent(TextEditBasedChangeGroup[] changeGroups, IRegion region,
                                             boolean expandRegionToFullLine, int surroundingLines, IProgressMonitor pm)

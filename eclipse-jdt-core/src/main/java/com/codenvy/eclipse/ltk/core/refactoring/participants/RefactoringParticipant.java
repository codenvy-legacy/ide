 ...
 * <p>
 * If the severity of the condition checking result is {@link com.codenvy.eclipse.ltk.core.refactoring.RefactoringStatus#FATAL}
 ...
 * file (see {@link #createChange(com.codenvy.eclipse.core.runtime.IProgressMonitor)} and {@link #getTextChange(Object)}).
 ...
 * </p>
 * <p>
 * Since 3.4, a refactoring participant can also override {@link #createPreChange(com.codenvy.eclipse.core.runtime.IProgressMonitor)}
...
public abstract class RefactoringParticipant extends PlatformObject {
     ...
     *
     * @param processor
     *         the processor this participant is associated with
     * @param element
     ...
     * @see com.codenvy.eclipse.ltk.core.refactoring.Refactoring#checkInitialConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)
     * @see com.codenvy.eclipse.ltk.core.refactoring.RefactoringStatus
     */
    public abstract RefactoringStatus checkConditions(IProgressMonitor pm,
                                                      CheckConditionsContext context) throws OperationCanceledException;

    /**
     * Creates a {@link com.codenvy.eclipse.ltk.core.refactoring.Change} object that contains the workspace modifications
     ...
     * </p>
     * <p>
     * Note that most refactorings will implement {@link #createChange(com.codenvy.eclipse.core.runtime.IProgressMonitor)}
     ...
     * @throws com.codenvy.eclipse.core.runtime.OperationCanceledException
     *         if the change creation got canceled
     * @see #createChange(com.codenvy.eclipse.core.runtime.IProgressMonitor)
     * @since 3.4
     */
     ...
     * @throws com.codenvy.eclipse.core.runtime.OperationCanceledException
     *         if the change creation got canceled
     * @see #createPreChange(com.codenvy.eclipse.core.runtime.IProgressMonitor)
     */

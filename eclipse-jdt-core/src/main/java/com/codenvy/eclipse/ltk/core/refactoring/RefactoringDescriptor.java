...
public abstract class RefactoringDescriptor implements Comparable {
     ...
     * reasons, they are reported for {@link com.codenvy.eclipse.ltk.core.refactoring.history.IRefactoringExecutionListener} or
     * {@link com.codenvy.eclipse.ltk.core.refactoring.history.IRefactoringHistoryListener} in order to keep clients of these
     ...
     */
    protected RefactoringDescriptor(final String id, final String project, final String description,
                                    final String comment, final int flags) {
        Assert.isNotNull(id);
        Assert.isLegal(!"".equals(id), "Refactoring id must not be empty"); //$NON-NLS-1$ //$NON-NLS-2$
        Assert.isLegal(project == null || !"".equals(project),

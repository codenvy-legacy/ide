...
import com.codenvy.eclipse.core.commands.operations.IOperationHistory;
import com.codenvy.eclipse.core.commands.operations.IOperationHistoryListener;
...
import com.codenvy.eclipse.core.commands.operations.OperationHistoryFactory;
import com.codenvy.eclipse.core.commands.operations.TriggeredOperations;
...
import com.codenvy.eclipse.ltk.core.refactoring.IUndoManager;
import com.codenvy.eclipse.ltk.core.refactoring.IUndoManagerListener;
...
public class UndoManager2 implements IUndoManager
{
   ...
   public void performUndo(IValidationCheckResultQuery query, IProgressMonitor pm) throws CoreException
   {
      ...
      if (changeOperation == null)
      {
         throw new CoreException(new Status(IStatus.ERROR, RefactoringCorePlugin.getPluginId(), IStatus.ERROR,
   ...
   private void handleException(ExecutionException e) throws CoreException
   {
      ...
      {
         throw new CoreException(new Status(IStatus.ERROR, RefactoringCorePlugin.getPluginId(), IStatus.ERROR,
            RefactoringCoreMessages.RefactoringCorePlugin_internal_error, e));
      }
   }

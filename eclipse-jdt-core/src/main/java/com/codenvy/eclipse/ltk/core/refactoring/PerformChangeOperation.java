 ...
 * calls {@link Change#initializeValidationData(com.codenvy.eclipse.core.runtime.IProgressMonitor)} to initialize the
...
public class PerformChangeOperation implements IWorkspaceRunnable {
     ...
     *
     * @param change
     *         the change to be applied to the workbench
     */
     ...
     *
     * @param manager
     *         the undo manager to use or <code>null</code> if no
     ...
     *
     * @param rule
     *         the rule to use, or <code>null</code> to use no scheduling rule
     * @since 3.3
     */

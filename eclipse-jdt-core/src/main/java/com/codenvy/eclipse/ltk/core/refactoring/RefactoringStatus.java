 ...
 * @see Refactoring#checkAllConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)
 * @since 3.0
 */
public class RefactoringStatus
{
    ...
    * @since 3.1
    */
   public RefactoringStatusEntry[] getEntries(IRefactoringStatusEntryComparator comparator,

 ...
 * </li>
 * <li>a method to create a {@link com.codenvy.eclipse.ltk.core.refactoring.Change} object
 ...
 * <li>{@link #checkInitialConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)} is called. The method
 ...
 * <li>{@link #checkFinalConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)} is called. The method
 * can be called more than once. The method must not be called if
 * {@link #checkInitialConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)} returns a refactoring
 * status of severity {@link RefactoringStatus#FATAL}.</li>
 * <li>{@link #createChange(com.codenvy.eclipse.core.runtime.IProgressMonitor)} is called. The method must only be
 * called once after each call to {@link #checkFinalConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)}
...
public abstract class Refactoring extends PlatformObject
{
    ...
    * {@link com.codenvy.eclipse.core.resources.IWorkspace#validateEdit(com.codenvy.eclipse.core.resources.IFile[], Object)}.
    *
    ...
    * @see #checkInitialConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)
    * @see #checkFinalConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   public RefactoringStatus checkAllConditions(IProgressMonitor pm) throws CoreException, OperationCanceledException
   {
      ...
      result.merge(
         checkInitialConditions(new SubProgressMonitor(pm, refactoringTickProvider.getCheckInitialConditionsTicks())));
      if (!result.hasFatalError())
      {
         ...
         result.merge(
            checkFinalConditions(new SubProgressMonitor(pm, refactoringTickProvider.getCheckFinalConditionsTicks())));
      }
      pm.done();
      return result;
   }

 ...
 *******************************************************************************/
package com.codenvy.eclipse.ltk.core.refactoring.history;
...
public interface IRefactoringHistoryService
{
    ...
    * @param monitor the progress monitor to use, or <code>null</code> if no
    ...
    * @return the project refactoring history
    */
   public RefactoringHistory getProjectHistory(IProject project, long start, long end, int flags,
    ...
    * @return the combined refactoring history
    */
   public RefactoringHistory getRefactoringHistory(IProject[] projects, long start, long end, int flags,
      IProgressMonitor monitor);
    ...
    * </p>
    *
    * @param stream a <code>UTF-8</code> input stream where to read the
    *               refactoring history from
    * @param flags  the refactoring descriptor flags to filter the refactoring
    *               descriptors
    ...
    * @see com.codenvy.eclipse.ltk.core.refactoring.IRefactoringCoreStatusCodes#UNSUPPORTED_REFACTORING_HISTORY_VERSION
    * @see com.codenvy.eclipse.ltk.core.refactoring.IRefactoringCoreStatusCodes#MISSING_REFACTORING_HISTORY_VERSION
    */
    ...
    * @param stream  a <code>UTF-8</code> output stream where to write the
    *                refactoring descriptors to
    * @param flags   the flags which must be present in order to be written to the
    *                output stream, or <code>RefactoringDescriptor#NONE</code>
    * @param time    <code>true</code> to write time information associated with
    ...
    * @see com.codenvy.eclipse.ltk.core.refactoring.IRefactoringCoreStatusCodes#REFACTORING_HISTORY_IO_ERROR
    */
   public void writeRefactoringDescriptors(RefactoringDescriptorProxy[] proxies, OutputStream stream, int flags,
      boolean time, IProgressMonitor monitor) throws CoreException;
    ...
    * @see com.codenvy.eclipse.ltk.core.refactoring.IRefactoringCoreStatusCodes#REFACTORING_HISTORY_IO_ERROR
    */
   public void writeRefactoringSession(RefactoringSessionDescriptor descriptor, OutputStream stream,
      boolean time) throws CoreException;
}

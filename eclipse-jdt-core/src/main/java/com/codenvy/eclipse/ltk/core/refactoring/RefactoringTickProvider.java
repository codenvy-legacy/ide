...
public class RefactoringTickProvider {
     ...
     */
    public RefactoringTickProvider(int checkInitialConditionsTicks, int checkFinalConditionsTicks, int createChangeTicks,
     ...
     * passed to <code>{@link Change#initializeValidationData(com.codenvy.eclipse.core.runtime.IProgressMonitor)}</code>

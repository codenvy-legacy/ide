 ...
 * {@link com.codenvy.eclipse.ltk.core.refactoring.Refactoring}. Implementors of
...
public abstract class RefactoringProcessor extends PlatformObject {
   ...
   /* package */ void setRefactoring(ProcessorBasedRefactoring refactoring) {
     ...
     * @see com.codenvy.eclipse.ltk.core.refactoring.RefactoringStatus#FATAL
     */
     ...
     * @throws com.codenvy.eclipse.core.runtime.OperationCanceledException
     *         if the condition checking got canceled
     * @see com.codenvy.eclipse.ltk.core.refactoring.Refactoring#checkFinalConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor)
     * @see com.codenvy.eclipse.ltk.core.refactoring.RefactoringStatus#FATAL
     */
    ...
    /**
     * Creates a {@link com.codenvy.eclipse.ltk.core.refactoring.Change} object describing the workspace modifications
     ...
     * @throws com.codenvy.eclipse.core.runtime.OperationCanceledException
     *         if the condition checking got canceled
     * @see com.codenvy.eclipse.ltk.core.refactoring.Refactoring#createChange(com.codenvy.eclipse.core.runtime.IProgressMonitor)
     */
     ...
     * @throws com.codenvy.eclipse.core.runtime.CoreException
     *         if an error occurred while creating the post change
     * @throws com.codenvy.eclipse.core.runtime.OperationCanceledException
     *         if the condition checking got canceled
     ...
     * {@link #checkFinalConditions(com.codenvy.eclipse.core.runtime.IProgressMonitor, CheckConditionsContext)}has
     ...
     * @throws com.codenvy.eclipse.core.runtime.CoreException
     *         if creating or loading of the participants failed

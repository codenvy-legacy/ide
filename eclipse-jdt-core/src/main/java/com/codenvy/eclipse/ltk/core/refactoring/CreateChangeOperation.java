...
import com.codenvy.eclipse.ltk.internal.core.refactoring.NotCancelableProgressMonitor;
import com.codenvy.eclipse.ltk.internal.core.refactoring.RefactoringCoreMessages;
import com.codenvy.eclipse.ltk.internal.core.refactoring.history.UnknownRefactoringDescriptor;
 ...
 * </p>
 * <p>
 * If a change has been created the operation calls {@link Change#initializeValidationData(com.codenvy.eclipse.core.runtime
 * .IProgressMonitor)}
...
public class CreateChangeOperation implements IWorkspaceRunnable {
     ...
     *
     * @param operation
     *         the condition checking operation
     * @param checkFailedSeverity
            ...
            if (fCheckConditionOperation != null) {
                ...
                if (status != null && status.getSeverity() < fConditionCheckingFailedSeverity) {
                    ...
                    fChange.initializeValidationData(
                            new NotCancelableProgressMonitor(new SubProgressMonitor(pm, rtp.getInitializeChangeTicks())));
                } else {
     ...
     * by calling {@link Refactoring#createChange(com.codenvy.eclipse.core.runtime.IProgressMonitor)} then {@link

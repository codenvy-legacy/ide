 ...
 * {@link #acquireDocument(com.codenvy.eclipse.core.runtime.IProgressMonitor) aquireDocument},
 * {@link #commit(IDocument document, com.codenvy.eclipse.core.runtime.IProgressMonitor pm) commitDocument}, and
 * {@link #releaseDocument(IDocument, com.codenvy.eclipse.core.runtime.IProgressMonitor) releaseDocument}.
 * <p>
...
public abstract class TextChange extends TextEditBasedChange
{
    ...
    * via a call to {@link #releaseDocument(IDocument, com.codenvy.eclipse.core.runtime.IProgressMonitor)}.
    * <p>
   ...
   /**
    * Commits the document acquired via a call to {@link #acquireDocument(com.codenvy.eclipse.core.runtime.IProgressMonitor)
   ...
   /**
    * Releases the document acquired via a call to {@link #acquireDocument(com.codenvy.eclipse.core.runtime.IProgressMonitor)
    * aquireDocument}.
    *
    ...
    * @throws MalformedTreeException is thrown if the edit tree isn't
    *                                in a valid state. This exception is thrown before any edit is executed.
    *                                So the document is still in its original state.
    * @throws BadLocationException   is thrown if one of the edits in the
    ...
    * @see #getCurrentContent(IRegion, boolean, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   public String getPreviewContent(TextEditChangeGroup[] changeGroups, IRegion region, boolean expandRegionToFullLine,
      ...
      boolean expandRegionToFullLine, int surroundingLines, IProgressMonitor pm) throws CoreException
   {
      ...
      Assert.isTrue(
         region.getOffset() <= currentRegion.getOffset() && currentRegion.getOffset() + currentRegion.getLength() <= region.getOffset() + region.getLength());
      ...
      return getContent(result.document, new Region(region.getOffset(), region.getLength() + delta),
      ...
      IProgressMonitor pm) throws CoreException
   {
      ...
      TextEditProcessor processor = changes == ALL_EDITS ? createTextEditProcessor(document, TextEdit.NONE,
         true) : createTextEditProcessor(document, TextEdit.NONE, changes);
      try
      {

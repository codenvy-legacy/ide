...
/**
 * {@link com.codenvy.eclipse.ltk.core.refactoring.Change} that moves a resource.
 *
 * @since 3.4
 */
public class MoveResourceChange extends ResourceChange {
     ...
     *         the stamp to restore on the moved resource
     * @param restoreSourceChange
     *         the change to restore a resource at the source or <code>null</code> if no resource
    ...
    public String getName() {
        return Messages.format(RefactoringCoreMessages.MoveResourceChange_name,
                               new String[]{BasicElementLabels.getPathLabel(fSource.getFullPath(), false),

...
public class PerformRefactoringOperation implements IWorkspaceRunnable {
     ...
     * of {@link #run(com.codenvy.eclipse.core.runtime.IProgressMonitor)} will call {@link RefactoringContext#dispose()}.
     * </p>
     *
     * @param refactoringContext
     ...
     * object is initialize via the call {@link Change#initializeValidationData(com.codenvy.eclipse.core.runtime.IProgressMonitor)}
     *

 ...
 * </p>
 *
 * @see com.codenvy.eclipse.core.resources.IWorkspace
 * @see PerformRefactoringOperation
 * @see RefactoringHistory
 * @see com.codenvy.eclipse.ltk.internal.core.refactoring.history.RefactoringHistoryService
 * @since 3.2
 */
public class PerformRefactoringHistoryOperation implements IWorkspaceRunnable
{
    ...
    */
   protected RefactoringStatus aboutToPerformRefactoring(final Refactoring refactoring,
      final RefactoringDescriptor descriptor, final IProgressMonitor monitor)
   {
    ...
    *
    * @param descriptor the refactoring descriptor
    * @param status     a refactoring status to describe the outcome of the
    *                   initialization
    ...
    * @deprecated since 3.4. Override {@link #createRefactoring(RefactoringDescriptor, RefactoringStatus, com.codenvy.eclipse.core.runtime.IProgressMonitor)} instead
    */
   protected Refactoring createRefactoring(final RefactoringDescriptor descriptor,
    ...
    *          if an error occurs while creating the refactoring instance
    * @since 3.4
    * @deprecated since 3.6. Override {@link #createRefactoringContext(RefactoringDescriptor, RefactoringStatus, com.codenvy.eclipse.core.runtime.IProgressMonitor)} instead
    */
   protected Refactoring createRefactoring(final RefactoringDescriptor descriptor, final RefactoringStatus status,
   ...
   public void run(final IProgressMonitor monitor) throws CoreException
   {
      ...
      monitor.beginTask(RefactoringCoreMessages.PerformRefactoringHistoryOperation_perform_refactorings,
         170 * proxies.length);
         ...
         for (int index = 0; index < proxies.length; index++)
         {
            ...
            if (descriptor != null)
            {
               ...
               try
               {
                  try
                  {
                     context = createRefactoringContext(descriptor, status,
                        new SubProgressMonitor(monitor, 30, SubProgressMonitor.SUPPRESS_SUBTASK_LABEL));
                  }

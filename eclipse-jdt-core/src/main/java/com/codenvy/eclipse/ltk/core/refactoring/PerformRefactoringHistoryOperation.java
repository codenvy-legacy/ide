...
public class PerformRefactoringHistoryOperation implements IWorkspaceRunnable {
     ...
     * @deprecated since 3.4. Override {@link #createRefactoring(RefactoringDescriptor, RefactoringStatus,
     *             com.codenvy.eclipse.core.runtime.IProgressMonitor)} instead
     */
     ...
     *         if an error occurs while creating the refactoring instance
     * @since 3.4
     * @deprecated since 3.6. Override {@link #createRefactoringContext(RefactoringDescriptor, RefactoringStatus,
     *             com.codenvy.eclipse.core.runtime.IProgressMonitor)} instead
     */

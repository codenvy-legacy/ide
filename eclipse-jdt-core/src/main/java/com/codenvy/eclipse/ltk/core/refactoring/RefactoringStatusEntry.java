...
public class RefactoringStatusEntry
{
   ...
   {
      Assert.isTrue(
         severity == RefactoringStatus.INFO || severity == RefactoringStatus.WARNING || severity == RefactoringStatus.ERROR || severity == RefactoringStatus.FATAL);
   ...
   /**
    * Returns this refactoring status entry as an {@link com.codenvy.eclipse.core.runtime.IStatus}.
    * <p>
    * If this refactoring status entry has a severity of
    * {@link RefactoringStatus#FATAL}, the returned status will have a
    * severity of {@link com.codenvy.eclipse.core.runtime.IStatus#ERROR}, otherwise a status with severity

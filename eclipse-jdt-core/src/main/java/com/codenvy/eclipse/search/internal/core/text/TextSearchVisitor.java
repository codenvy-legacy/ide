...
import com.codenvy.eclipse.search.internal.core.text.FileCharSequenceProvider.FileCharSequenceException;
import com.codenvy.eclipse.search.internal.core.ui.SearchMessages;
...
public class TextSearchVisitor
{
   ...
   public TextSearchVisitor(TextSearchRequestor collector, Pattern searchPattern)
   {
      ...
      fStatus = new MultiStatus("IDE", IStatus.OK, "SearchMessages.TextSearchEngine_statusMessage", null);
   ...
   public boolean processFile(IFile file, Map documentsInEditors)
   {
      ...
      catch (UnsupportedCharsetException e)
      {
         ...
         fStatus.add(new Status(IStatus.ERROR, "IDE", IStatus.ERROR, message, e));
      }

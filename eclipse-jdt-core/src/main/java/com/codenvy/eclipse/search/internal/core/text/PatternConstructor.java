...
public class PatternConstructor {
     ...
     *         <code>true</code> if the passed string is in the StringMatcher format.
     * @param isCaseSensitive
     *         Set to <code>true</code> to create a case insensitive pattern
     * @param isWholeWord
     *         <code>true</code> to create a pattern that requires a word boundary at the
    ...
    /**
     * Copied from {org.eclipse.jface.text.FindReplaceDocumentAdapter}' to support '\R'
     *
     * @param findString
    ...
    /**
     * Copied from {FindReplaceDocumentAdapter}
     * <p/>
     ...
     * Cagatay Calli <ccalli@gmail.com> - [find/replace] define & fix behavior of retain caps with other escapes and text before \C -

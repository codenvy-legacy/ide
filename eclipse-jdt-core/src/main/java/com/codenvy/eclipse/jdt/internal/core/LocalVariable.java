...
public class LocalVariable extends SourceRefElement implements ILocalVariable
{
   ...
   public LocalVariable(JavaElement parent, String name, int declarationSourceStart, int declarationSourceEnd,
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation[] astAnnotations, int flags, boolean isParameter)
   {
   ...
   public boolean equals(Object o)
   {
      ...
      return this.declarationSourceStart == other.declarationSourceStart && this.declarationSourceEnd == other.declarationSourceEnd && this.nameStart == other.nameStart && this.nameEnd == other.nameEnd && super.equals(
         o);
   }
   ...
   private IAnnotation[] getAnnotations(com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation[] astAnnotations)
   {
      int length;
   ...
   private IAnnotation getAnnotation(final com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation annotation,
      JavaElement parentElement)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.MemberValuePair[] astMemberValuePairs = annotation.memberValuePairs();
      int length;
      IMemberValuePair[] memberValuePairs;
      ...
      else
      {
         ...
         for (int i = 0; i < length; i++)
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.MemberValuePair astMemberValuePair = astMemberValuePairs[i];
      ...
      JavaElement parentElement)
   {
      ...
      else if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation)
      {
         ...
         return getAnnotation((com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation)expression, parentElement);
      }

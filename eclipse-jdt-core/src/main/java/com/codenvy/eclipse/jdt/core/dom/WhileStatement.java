...
public class WhileStatement extends Statement
{
    ...
    * @since 3.0
    */
   public static final ChildPropertyDescriptor BODY_PROPERTY = new ChildPropertyDescriptor(WhileStatement.class, "body",
      Statement.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$

...
class RecoveredTypeBinding implements ITypeBinding {
    ...
    private com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding binding;
    ...
    RecoveredTypeBinding(BindingResolver resolver, com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding) {
        this.resolver = resolver;
        ...
        if (packageBinding != null) {
            ...
            if (javaElement != null && javaElement.getElementType() == IJavaElement.PACKAGE_FRAGMENT) {
                ...
                return ((PackageFragment)javaElement).getCompilationUnit(
                        getInternalName() + SuffixConstants.SUFFIX_STRING_java).getType(this.getName());
            }
        }
        return null;
    }
    ...
    public String getKey() {
        ...
        if (this.innerTypeBinding != null) {
            ...
            buffer.append("variableDeclaration") //$NON-NLS-1$
                    .append(this.variableDeclaration.getClass()).append(
                    this.variableDeclaration.getName().getIdentifier()).append(this.variableDeclaration.getExtraDimensions());
        }

...
public class ExtractClassDescriptor extends JavaRefactoringDescriptor {
    ...
    public static class Field {
         ...
         *
         * @param newFieldName
         *         the new field name. Must not be <code>null</code>
         */
        ...
        public String toString() {
            return "Field:" + fFieldName + " new name:" + fNewFieldName + " create field:" +
         ...
         *
         * @param createField
         *         if <code>true</code> the field will be moved
         */
     ...
     */
    public ExtractClassDescriptor(String project, String description, String comment, Map arguments,
        ...
        if (JavaRefactoringDescriptorUtil.getString(arguments, OLD_FIELD_COUNT, true) != null) {
            String[] oldFieldNames = JavaRefactoringDescriptorUtil.getStringArray(arguments, OLD_FIELD_COUNT,
                                                                                  OLD_FIELD_NAME, 0);
            boolean[] createField = JavaRefactoringDescriptorUtil.getBooleanArray(arguments, CREATE_FIELD_COUNT,
                                                                                  CREATE_FIELD, 0);
            ...
            for (int i = 0; i < oldFieldNames.length; i++) {
                ...
                if (createField[i]) {
                    fFields[i].setNewFieldName(JavaRefactoringDescriptorUtil.getString(arguments,
     ...
     *
     * @param fields
     *         the fields to move to the extracted class. Can be <code>null</code> to indicate that all instance fields should
     *         be moved
     * @throws IllegalArgumentException
     *         if one of the fields is <code>null</code>
     */
     ...
     *
     * @param packageName
     *         the package in which the top level class will be created. Can be <code>null</code> to indicate that the
     *         package will be the same as the type
     */
     ...
     *
     * @param className
     *         the class name for the extracted class or <code>null</code> if the refactoring should choose a name
     */
     ...
     *
     * @param fieldName
     *         the field name for the generated field or <code>null</code> if the refactoring should choose a name
     */
     ...
     *
     * @param createTopLevel
     *         <code>true</code> to generated as top level class. The default is <code>true</code>
     */
     ...
     *
     * @param createGetterSetter
     *         <code>true</code> to create getters and setters. Default is <code>false</code>.
     */

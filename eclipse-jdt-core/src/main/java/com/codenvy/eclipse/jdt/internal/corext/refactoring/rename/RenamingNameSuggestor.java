...
import com.codenvy.eclipse.jdt.internal.ui.text.JavaWordIterator;
...
public class RenamingNameSuggestor {
    ...
    * ADDITIONAL OPTIONS
    ...
    public String suggestNewFieldName(IJavaProject project, String oldFieldName, boolean isStatic, String oldTypeName,
                                      String newTypeName) {
    ...
    public String suggestNewLocalName(IJavaProject project, String oldLocalName, boolean isArgument, String oldTypeName,
                                      String newTypeName) {
    ...
    private String suffixMatch(final String oldType, final String newType, final String strippedVariableName) {
        ...
        if (lastSuffixMatched == 0) {
            ...
            if (newPrefixes > 0) {
                ...
                if (Character.isLowerCase(suffixesVar[hunkInVarName].charAt(0)) && Character.isUpperCase(
                        suffixesOldEqual[lastSuffixMatched].charAt(0))) {

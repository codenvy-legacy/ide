...
import com.codenvy.eclipse.jdt.internal.core.DeltaProcessor;
    ...
    public IPath[] enclosingProjectsAndJars() {
        ...
        try {
            ...
            if (BasicSearchEngine.VERBOSE) {
                ...
                Util.verbose("JavaWorkspaceScope.enclosingProjectsAndJars: " + length + " paths computed in " + time +
    ...
    public IPackageFragmentRoot packageFragmentRoot(String resourcePathString, int jarSeparatorIndex, String jarPath) {
        ...
        if (jarPath != null) {
            ...
            if (ExternalFoldersManager.isInternalPathForExternalFolder(path)) {
                IResource resource =
                        JavaModel.getWorkspaceTarget(path.uptoSegment(2/*linked folders for external folders are always of size 2*/));
                if (resource != null)

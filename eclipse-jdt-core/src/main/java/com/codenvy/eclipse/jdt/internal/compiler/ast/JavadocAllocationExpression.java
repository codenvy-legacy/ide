...
public class JavadocAllocationExpression extends AllocationExpression
{
   ...
   TypeBinding internalResolveType(Scope scope)
   {
      ...
      if (!this.binding.isValidBinding())
      {
         ...
         MethodBinding methodBinding = scope.getMethod(this.resolvedType, this.resolvedType.sourceName(), argumentTypes,
            this);
      ...
      else if (this.binding.isVarargs())
      {
         ...
         {
            MethodBinding problem = new ProblemMethodBinding(this.binding, this.binding.selector, argumentTypes,
      ...
      else if (this.resolvedType.isMemberType())
      {
         ...
         if (length > 1)
         { // accept qualified member class constructor reference => see bug https://bugs.eclipse.org/bugs/show_bug.cgi?id=103304
            ReferenceBinding enclosingTypeBinding = allocationType;
            ...
            {
               int idx = length;
               while (idx > 0 && CharOperation.equals(this.qualification[--idx],
                  enclosingTypeBinding.sourceName) && (enclosingTypeBinding = enclosingTypeBinding.enclosingType()) != null)
               {

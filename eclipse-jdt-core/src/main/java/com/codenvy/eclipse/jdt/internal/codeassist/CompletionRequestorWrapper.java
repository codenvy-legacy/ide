...
public class CompletionRequestorWrapper extends CompletionRequestor {
    ...
    private com.codenvy.eclipse.jdt.core.ICompletionRequestor requestor;

    public CompletionRequestorWrapper(com.codenvy.eclipse.jdt.core.ICompletionRequestor requestor) {
        ...
        switch (internalCompletionProposal.getKind()) {
            ...
            case CompletionProposal.TYPE_REF:
                if ((internalCompletionProposal.getFlags() & Flags.AccEnum) != 0) {
                    ...
                    if (DECODE_SIGNATURE) {
                        ...
                        this.requestor.acceptInterface(
                                internalCompletionProposal.getPackageName() == null ? CharOperation.NO_CHAR
                                                                                    : internalCompletionProposal.getPackageName(),
            ...
            case CompletionProposal.FIELD_REF:
                if (DECODE_SIGNATURE) {
                    ...
                    this.requestor.acceptField(
                            internalCompletionProposal.getDeclarationPackageName() == null ? CharOperation.NO_CHAR
                                                                                           : internalCompletionProposal
                                    .getDeclarationPackageName(),
                            internalCompletionProposal.getDeclarationTypeName() == null ? CharOperation.NO_CHAR : internalCompletionProposal
                                    .getDeclarationTypeName(),
                            internalCompletionProposal.getName(),
                            internalCompletionProposal.getPackageName() == null ? CharOperation.NO_CHAR
                                                                                : internalCompletionProposal.getPackageName(),
                            internalCompletionProposal.getTypeName() == null ? CharOperation.NO_CHAR
                                                                             : internalCompletionProposal.getTypeName(),
                            internalCompletionProposal.getCompletion(),
                            internalCompletionProposal.getFlags(),
                            internalCompletionProposal.getReplaceStart(),
            ...
            case CompletionProposal.METHOD_REF:
                if (DECODE_SIGNATURE) {
                    this.requestor.acceptMethod(
                            ...
                            internalCompletionProposal.findParameterNames(null) == null ? CharOperation.NO_CHAR_CHAR
                                                                                        : internalCompletionProposal
                    ...
                    this.requestor.acceptMethod(
                            ...
                            internalCompletionProposal.getDeclarationTypeName() == null ? CharOperation.NO_CHAR : internalCompletionProposal
                                    .getDeclarationTypeName(),
                            internalCompletionProposal.getName(),
                            internalCompletionProposal.getParameterPackageNames() == null ? CharOperation.NO_CHAR_CHAR
                                                                                          : internalCompletionProposal
                                    .getParameterPackageNames(),
                            internalCompletionProposal.getParameterTypeNames() == null ? CharOperation.NO_CHAR_CHAR
                                                                                       : internalCompletionProposal.getParameterTypeNames(),
                            internalCompletionProposal.findParameterNames(null) == null ? CharOperation.NO_CHAR_CHAR
                                                                                        : internalCompletionProposal
                                    .findParameterNames(null),
                            internalCompletionProposal.getPackageName() == null ? CharOperation.NO_CHAR

...
public class UnresolvedReferenceBinding extends ReferenceBinding {
    ...
    void addWrapper(TypeBinding wrapper, LookupEnvironment environment) {
        if (this.resolvedType != null) {
            ...
            // when the ParameterizedType for Unresolved B is created with args B<T>.M, the Unresolved B is resolved before the wrapper
            // is added
    ...
    public String toString() {
        return "Unresolved type " + ((this.compoundName != null) ? CharOperation.toString(

...
public class ConditionalExpression extends OperatorExpression
{
   ...
   public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo)
   {
      ...
      if (isConditionOptimizedFalse)
      {
         ...
         if (!isKnowDeadCodePattern(
            this.condition) || currentScope.compilerOptions().reportDeadCodeInTrivialIfStatement)
         {
   ...
   public TypeBinding resolveType(BlockScope scope)
   {
      ...
      if (use15specifics && valueIfTrueType != valueIfFalseType)
      {
         if (valueIfTrueType.isBaseType())
         {
            ...
            else
            {
               ...
               TypeBinding unboxedIfFalseType = valueIfFalseType.isBaseType() ? valueIfFalseType : env.computeBoxingType(
                  valueIfFalseType);
         ...
         else if (valueIfFalseType.isBaseType())
         {
            ...
            TypeBinding unboxedIfTrueType = valueIfTrueType.isBaseType() ? valueIfTrueType : env.computeBoxingType(
               valueIfTrueType);
      ...
      if (valueIfTrueType.isNumericType() && valueIfFalseType.isNumericType())
      {
         ...
         if ((valueIfTrueType == TypeBinding.BYTE || valueIfTrueType == TypeBinding.SHORT || valueIfTrueType == TypeBinding.CHAR) && (valueIfFalseType == TypeBinding.INT && this.valueIfFalse.isConstantValueOfTypeAssignableToType(
         ...
         if ((valueIfFalseType == TypeBinding.BYTE || valueIfFalseType == TypeBinding.SHORT || valueIfFalseType == TypeBinding.CHAR) && (valueIfTrueType == TypeBinding.INT && this.valueIfTrue.isConstantValueOfTypeAssignableToType(
         ...
         // int
         if (BaseTypeBinding.isNarrowing(valueIfTrueType.id, T_int) && BaseTypeBinding.isNarrowing(valueIfFalseType.id,
            T_int))
         {
         ...
         // long
         if (BaseTypeBinding.isNarrowing(valueIfTrueType.id, T_long) && BaseTypeBinding.isNarrowing(valueIfFalseType.id,
            T_long))
         {
         ...
         // float
         if (BaseTypeBinding.isNarrowing(valueIfTrueType.id, T_float) && BaseTypeBinding.isNarrowing(
            valueIfFalseType.id, T_float))
         {

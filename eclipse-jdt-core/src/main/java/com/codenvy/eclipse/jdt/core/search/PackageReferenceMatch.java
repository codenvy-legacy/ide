...
public class PackageReferenceMatch extends ReferenceMatch {
     ...
     *         the inner-most enclosing member that references this package
     * @param accuracy
     ...
     */
    public PackageReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length, boolean insideDocComment,

...
public class JdtFlags {
    ...
    private static boolean isInterfaceOrAnnotationMember(BodyDeclaration bodyDeclaration) {
        boolean isInterface =
                (bodyDeclaration.getParent() instanceof TypeDeclaration) && ((TypeDeclaration)bodyDeclaration.getParent()).isInterface();
     ...
     * @see com.codenvy.eclipse.jdt.core.dom.Modifier#PUBLIC
     * @see com.codenvy.eclipse.jdt.core.dom.Modifier#PROTECTED
     * @see com.codenvy.eclipse.jdt.core.dom.Modifier#NONE
     * @see com.codenvy.eclipse.jdt.core.dom.Modifier#PRIVATE
     */

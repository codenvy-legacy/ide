...
public class CodeSnippetParsingUtil
{
      ...
      boolean recordParsingInformation, boolean enabledStatementRecovery)
   {
      ...
      final ProblemReporter problemReporter = new ProblemReporter(DefaultErrorHandlingPolicies.proceedWithAllProblems(),
      ...
      final CompilationUnitDeclaration compilationUnitDeclaration = new CompilationUnitDeclaration(problemReporter,
         compilationResult, source.length);

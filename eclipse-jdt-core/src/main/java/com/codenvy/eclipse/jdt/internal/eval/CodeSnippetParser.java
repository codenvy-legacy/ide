...
public class CodeSnippetParser extends Parser implements EvaluationConstants
{
   ...
   protected void consumeStatementReturn()
   {
      ...
      // support have to be defined at toplevel only
      if ((this.hasRecoveredOnExpression || (this.scanner.startPosition >= this.codeSnippetStart && this.scanner.startPosition <= this.codeSnippetEnd + 1 + this.lineSeparatorLength /* 14838*/)) && this.expressionLengthStack[this.expressionLengthPtr] != 0 && isTopLevelType())
      {

 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.internal.core.refactoring.descriptors;

import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ChangeMethodSignatureDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ConvertAnonymousDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ConvertLocalVariableDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ConvertMemberTypeDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.CopyDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.DeleteDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.EncapsulateFieldDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ExtractClassDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ExtractConstantDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ExtractInterfaceDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ExtractLocalDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ExtractMethodDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.ExtractSuperclassDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.GeneralizeTypeDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.InferTypeArgumentsDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.InlineConstantDescriptor;
...
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.IntroduceFactoryDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.IntroduceIndirectionDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.IntroduceParameterDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.IntroduceParameterObjectDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.MoveDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.MoveMethodDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.MoveStaticMembersDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.PullUpDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.PushDownDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.RenameJavaElementDescriptor;
import com.codenvy.eclipse.jdt.core.refactoring.descriptors.UseSupertypeDescriptor;
...
public class RefactoringSignatureDescriptorFactory
{
   ...
   public static ChangeMethodSignatureDescriptor createChangeMethodSignatureDescriptor(String project,
   ...
   public static ConvertAnonymousDescriptor createConvertAnonymousDescriptor(String project, String description,
   ...
   public static GeneralizeTypeDescriptor createGeneralizeTypeDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static CopyDescriptor createCopyDescriptor(String project, String description, String comment, Map arguments,
      int flags)
   {
   ...
   public static DeleteDescriptor createDeleteDescriptor(String project, String description, String comment,
      Map arguments, int flags)
   {
      return new DeleteDescriptor(project, description, comment, arguments, flags);
   }

   public static ExtractClassDescriptor createExtractClassDescriptor(String project, String description, String comment,
   ...
   public static ExtractConstantDescriptor createExtractConstantDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static ExtractInterfaceDescriptor createExtractInterfaceDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static ExtractMethodDescriptor createExtractMethodDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static ExtractSuperclassDescriptor createExtractSuperclassDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static ExtractLocalDescriptor createExtractLocalDescriptor(String project, String description, String comment,
      Map arguments, int flags)
   {
   ...
   public static InferTypeArgumentsDescriptor createInferTypeArgumentsDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static InlineConstantDescriptor createInlineConstantDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static InlineMethodDescriptor createInlineMethodDescriptor(String project, String description, String comment,
      Map arguments, int flags)
   {
   ...
   public static InlineLocalVariableDescriptor createInlineLocalVariableDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static IntroduceFactoryDescriptor createIntroduceFactoryDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static IntroduceIndirectionDescriptor createIntroduceIndirectionDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static IntroduceParameterObjectDescriptor createIntroduceParameterObjectDescriptor(String project,
   ...
   public static IntroduceParameterDescriptor createIntroduceParameterDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static ConvertMemberTypeDescriptor createConvertMemberTypeDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static MoveMethodDescriptor createMoveMethodDescriptor(String project, String description, String comment,
      Map arguments, int flags)
   {
   ...
   public static MoveDescriptor createMoveDescriptor(String project, String description, String comment, Map arguments,
      int flags)
   {
   ...
   public static MoveStaticMembersDescriptor createMoveStaticMembersDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static ConvertLocalVariableDescriptor createConvertLocalVariableDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static PullUpDescriptor createPullUpDescriptor(String project, String description, String comment,
      Map arguments, int flags)
   {
   ...
   public static PushDownDescriptor createPushDownDescriptor(String project, String description, String comment,
      Map arguments, int flags)
   {
   ...
   public static RenameJavaElementDescriptor createRenameJavaElementDescriptor(String id, String project,
      String description, String comment, Map arguments, int flags)
   {
   ...
   public static EncapsulateFieldDescriptor createEncapsulateFieldDescriptor(String project, String description,
      String comment, Map arguments, int flags)
   {
   ...
   public static UseSupertypeDescriptor createUseSupertypeDescriptor(String project, String description, String comment,
      Map arguments, int flags)
   {

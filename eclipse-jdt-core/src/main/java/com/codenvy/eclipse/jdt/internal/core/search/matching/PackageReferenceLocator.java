            ...
            try {
                switch (packageFragment.getKind()) {
                    case IPackageFragmentRoot.K_SOURCE:
                        if (!com.codenvy.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(fileName) ||
...
//public int match(MessageSend node, MatchingNodeSet nodeSet) - SKIP IT
    ...
    protected void matchReportReference(ASTNode reference, IJavaElement element, IJavaElement localElement, IJavaElement[] otherElements,
        ...
        PackageReferenceMatch packageReferenceMatch =
                locator.newPackageReferenceMatch(element, accuracy, sourceStart, sourceEnd - sourceStart + 1, reference);

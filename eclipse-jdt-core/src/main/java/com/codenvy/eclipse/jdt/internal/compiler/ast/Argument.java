...
public class Argument extends LocalDeclaration
{
   ...
   public TypeBinding resolveForCatch(BlockScope scope)
   {
      ...
      else
      {
         ...
         if (exceptionType.findSuperTypeOriginatingFrom(TypeIds.T_JavaLangThrowable,
            true) == null && exceptionType.isValidBinding())
         {
      ...
      {
         this.binding = new CatchParameterBinding(this, exceptionType, this.modifiers | ClassFileConstants.AccFinal,

...
public class ASTRewriteFlattener extends ASTVisitor {
    ...
    public boolean visit(MethodDeclaration node) {
        ...
        visitList(node, MethodDeclaration.THROWN_EXCEPTIONS_PROPERTY, String.valueOf(','), " throws ",
    ...
    public boolean visit(TryStatement node) {
        ...
        if (node.getAST().apiLevel() >= AST.JLS4) {
            visitList(node, TryStatement.RESOURCES_PROPERTY, String.valueOf(';'), String.valueOf('('),
                      String.valueOf(')'));
        }
    ...
    public boolean visit(TypeDeclaration node) {
        ...
        ChildListPropertyDescriptor superInterfaceProperty =
                (apiLevel == JLS2_INTERNAL) ? TypeDeclaration.SUPER_INTERFACES_PROPERTY : TypeDeclaration.SUPER_INTERFACE_TYPES_PROPERTY;
    ...
    public boolean visit(EnumDeclaration node) {
        ...
        this.result.append(' ');
        visitList(node, EnumDeclaration.SUPER_INTERFACE_TYPES_PROPERTY, String.valueOf(','), "implements ",
                  Util.EMPTY_STRING); //$NON-NLS-1$
    ...
    public boolean visit(TypeParameter node) {
        ...
        visitList(node, TypeParameter.TYPE_BOUNDS_PROPERTY, " & ", " extends ",
                  Util.EMPTY_STRING); //$NON-NLS-1$ //$NON-NLS-2$
        return false;
    }

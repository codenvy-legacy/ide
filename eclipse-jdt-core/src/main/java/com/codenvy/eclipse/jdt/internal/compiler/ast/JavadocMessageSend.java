...
public class JavadocMessageSend extends MessageSend {
    ...
    private TypeBinding internalResolveType(Scope scope) {
        ...
        this.actualReceiverType =
                scope.environment().convertToRawType(this.receiver.resolvedType, true /*force the conversion of enclosing types*/);
        ...
        if (!this.binding.isValidBinding()) {
            ...
            MethodBinding problem = new ProblemMethodBinding(this.binding, this.selector, argumentTypes,

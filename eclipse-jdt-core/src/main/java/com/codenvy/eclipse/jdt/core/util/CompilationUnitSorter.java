...
package com.codenvy.eclipse.jdt.core.util;
...
import com.codenvy.eclipse.jdt.internal.core.SortElementsOperation;
...
public final class CompilationUnitSorter
{
    ...
    * @see com.codenvy.eclipse.jdt.core.dom.BodyDeclaration
    */
    ...
    *                        none
    * @throws JavaModelException       if the compilation unit could not be
    ...
    *                                  resource
    *                                  </ul>
    * @throws IllegalArgumentException if the given compilation unit is null
    ...
    * ({@link com.codenvy.eclipse.jdt.core.dom.ASTParser#newParser(int)}. Clients
    ...
    * @throws JavaModelException       if the compilation unit could not be sorted. Reasons
    *                                  include:
    *                                  <ul>
    *                                  <li> The given unit was not created from a ICompilationUnit (INVALID_ELEMENT_TYPES)</li>
    *                                  </ul>
    * @throws IllegalArgumentException if the given compilation unit is null or if the given
      ...
      IProgressMonitor monitor) throws JavaModelException
   {
      ...
      SortElementsOperation operation = new SortElementsOperation(AST.JLS4, new IJavaElement[]{unit.getJavaElement()},
         null, comparator);

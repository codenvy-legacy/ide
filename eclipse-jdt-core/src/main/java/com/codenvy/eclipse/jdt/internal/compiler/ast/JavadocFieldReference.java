...
public class JavadocFieldReference extends FieldReference
{
   ...
   protected TypeBinding internalResolveType(Scope scope)
   {
      ...
      Binding fieldBinding = (this.receiver != null && this.receiver.isThis()) ? scope.classScope().getBinding(
         this.token, this.bits & RestrictiveFlagMASK, this, true /*resolve*/) : scope.getField(this.actualReceiverType,
         this.token, this);
      ...
      if (!fieldBinding.isValidBinding() || !(fieldBinding instanceof FieldBinding))
      {
         ...
         if (this.actualReceiverType instanceof ReferenceBinding)
         {
            ...
            {
               possibleMethod = this.receiver.isThis() ? scope.getImplicitMethod(selector, Binding.NO_TYPES,
                  this) : scope.getMethod(refBinding, selector, Binding.NO_TYPES, this);
            }

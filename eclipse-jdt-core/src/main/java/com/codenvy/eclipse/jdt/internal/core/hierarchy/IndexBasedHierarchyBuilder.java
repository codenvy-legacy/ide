...
import com.codenvy.eclipse.jdt.internal.core.IPathRequestor;
...
import com.codenvy.eclipse.jdt.internal.core.search.JavaSearchParticipant;
import com.codenvy.eclipse.jdt.internal.core.search.SubTypeSearchJob;
...
import com.codenvy.eclipse.jdt.internal.core.search.matching.SuperTypeReferencePattern;
...
public class IndexBasedHierarchyBuilder extends HierarchyBuilder implements SuffixConstants {
    ...
    public void build(boolean computeSubtypes) {
        ...
        try {
            ...
            if (computeSubtypes) {
                ...
                IProgressMonitor possibleSubtypesMonitor = this.hierarchy.progressMonitor == null ? null : new SubProgressMonitor(
                        this.hierarchy.progressMonitor, amountOfWorkForSubtypes);
                HashSet localTypes = new HashSet(
                        10); // contains the paths that have potential subtypes that are local/anonymous types
                ...
                if (allPossibleSubtypes != null) {
                    IProgressMonitor buildMonitor = this.hierarchy.progressMonitor == null ? null : new SubProgressMonitor(
    ...
    private void buildForProject(JavaProject project, ArrayList potentialSubtypes,
                                 com.codenvy.eclipse.jdt.core.ICompilationUnit[] workingCopies, HashSet localTypes,
        ...
        if (openablesLength > 0) {
            ...
            com.codenvy.eclipse.jdt.core.ICompilationUnit[] unitsToLookInside = null;
            if (inProjectOfFocusType) {
                com.codenvy.eclipse.jdt.core.ICompilationUnit unitToLookInside = focusType.getCompilationUnit();
                if (unitToLookInside != null) {
                    int wcLength = workingCopies == null ? 0 : workingCopies.length;
                    if (wcLength == 0) {
                        unitsToLookInside = new com.codenvy.eclipse.jdt.core.ICompilationUnit[]{unitToLookInside};
                    } else {
                        unitsToLookInside = new com.codenvy.eclipse.jdt.core.ICompilationUnit[wcLength + 1];
            ...
            this.hierarchyResolver = new HierarchyResolver(searchableEnvironment, options, this,
    ...
    private void buildFromPotentialSubtypes(String[] allPotentialSubTypes, HashSet localTypes, IProgressMonitor monitor) {
        ...
        int wcLength;
        com.codenvy.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.hierarchy.workingCopies;
        if (workingCopies != null && (wcLength = workingCopies.length) > 0) {
            String[] newPaths = new String[wcLength];
            for (int i = 0; i < wcLength; i++) {
                com.codenvy.eclipse.jdt.core.ICompilationUnit workingCopy = workingCopies[i];
    ...
    * Sort in alphabetical order so that potential subtypes are grouped per project
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                try {
                    ...
                    Openable handle;
                    com.codenvy.eclipse.jdt.core.ICompilationUnit workingCopy = (com.codenvy.eclipse.jdt.core.ICompilationUnit)wcPaths.get(
                            resourcePath);
                    if (workingCopy != null) {
    ...
    protected IBinaryType createInfoFromClassFileInJar(Openable classFile) {
        String filePath = (((ClassFile)classFile).getType().getFullyQualifiedName('$')).replace('.',
    ...
    private String[] determinePossibleSubTypes(final HashSet localTypes, IProgressMonitor monitor) {
        ...
        try {
            ...
            searchAllPossibleSubTypes(getType(), this.scope, this.binariesFromIndexMatches, collector,
    ...
    public static void searchAllPossibleSubTypes(IType type, IJavaSearchScope scope, final Map binariesFromIndexMatches,
                                                 final IPathRequestor pathRequestor, int waitingPolicy,
	...
	/* use a special collector to collect paths and queue new subtype names */
                ...
                if (documentPath.toLowerCase().endsWith(SUFFIX_STRING_class)) {
                    ...
                    if (binaryType == null) {
                        ...
                        binaryType = new HierarchyBinaryType(record.modifiers, record.pkgName, typeName, enclosingTypeName,
                                                             record.typeParameterSignatures, record.classOrInterface);
        ...
        SubTypeSearchJob job = new SubTypeSearchJob(pattern, new JavaSearchParticipant(), // java search only
        ...
        try {
            while (queue.start <= queue.end) {
                ...
                indexManager.performConcurrentJob(job, waitingPolicy,
                                                  progressMonitor == null ? null : new NullProgressMonitor() {
                                                      // don't report progress since this is too costly for deep hierarchies (see
                                                      // https://bugs.eclipse.org/bugs/show_bug.cgi?id=34078 )
                                                      // just handle isCanceled() (see https://bugs.eclipse.org/bugs/show_bug
                                                      // .cgi?id=179511 )

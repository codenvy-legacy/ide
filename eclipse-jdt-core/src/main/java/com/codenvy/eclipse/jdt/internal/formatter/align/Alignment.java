 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.internal.formatter.align;

import com.codenvy.eclipse.core.runtime.Assert;
import com.codenvy.eclipse.jdt.internal.formatter.Location;
import com.codenvy.eclipse.jdt.internal.formatter.Scribe;
...
public class Alignment {
    ...
    public static final int SPLIT_MASK =
            M_ONE_PER_LINE_SPLIT | M_NEXT_SHIFTED_SPLIT | M_COMPACT_SPLIT | M_COMPACT_FIRST_BREAK_SPLIT | M_NEXT_PER_LINE_SPLIT;

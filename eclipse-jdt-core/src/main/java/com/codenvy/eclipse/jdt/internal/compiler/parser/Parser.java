 ...
 */
   ...
   protected void checkForDiamond(TypeReference allocType)
   {
      ...
      else if (allocType instanceof ParameterizedQualifiedTypeReference)
      {
         ...
         { // Don't care for X<>.Y<> and X<>.Y<String>
            if (this.options.sourceLevel < ClassFileConstants.JDK1_7)
            {
	...
	*/
      ...
      if (!(this.diet && this.dietInt == 0) && statements == null && (constructorCall == null || constructorCall.isImplicitSuper()) && !containsComment(
   ...
   protected void consumeConstructorHeaderName()
   {
	...
	/* recovering - might be an empty message send */
      if (this.currentElement != null)
      {
         if (this.lastIgnoredToken == TokenNamenew)
   ...
   protected void consumeEnterVariable()
   {
      ...
      if (this.currentElement != null)
      {
         if (!(this.currentElement instanceof RecoveredType) && (this.currentToken == TokenNameDOT
            ...
            this.scanner.linePtr) != Util.getLineNumber((int)(namePosition >>> 32), this.scanner.lineEnds, 0,
 ...
 */
   ...
   protected void consumeStatementIfWithElse()
   {
      ...
      this.astStack[--this.astPtr] = new IfStatement(this.expressionStack[this.expressionPtr--],
         (Statement)this.astStack[this.astPtr], (Statement)this.astStack[this.astPtr + 1], this.intStack[this.intPtr--],
         this.endStatementPosition);
   }
 ...
 */
   ...
   protected void markEnclosingMemberWithLocalType()
   {
      ...
      {
         ASTNode node = this.astStack[i];
         if (node instanceof AbstractMethodDeclaration || node instanceof FieldDeclaration || (node instanceof TypeDeclaration // mark type for now: all initializers will be marked when added to this type

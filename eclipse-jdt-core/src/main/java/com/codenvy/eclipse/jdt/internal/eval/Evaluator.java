...
public abstract class Evaluator {
    ...
    Evaluator(EvaluationContext context, INameEnvironment environment, Map options, IRequestor requestor,
              IProblemFactory problemFactory) {
     ...
     */
    protected abstract void addEvaluationResultForCompilationProblem(Map resultsByIDs, CategorizedProblem problem,
                                                                     char[] cuSource);
                ...
                if (result.hasProblems()) {
                    ...
                    for (int i = 0; i < evalResults.length; i++) {
                        ...
                        for (int j = 0; j < problems.length; j++) {
                            Evaluator.this.requestor.acceptProblem(problems[j], evalResult.getEvaluationID(),
 ...
 */
    ...
    Compiler getCompiler(ICompilerRequestor compilerRequestor) {
        ...
        return new Compiler(this.environment, DefaultErrorHandlingPolicies.exitAfterAllProblems(), compilerOptions,
                            compilerRequestor, this.problemFactory);
    }

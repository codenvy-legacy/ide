...
public class MethodReferenceMatch extends ReferenceMatch {
     ...
     * @since 3.1
     */
    public MethodReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length, boolean constructor, boolean synthetic,
     ...
     *         the length of the match, or -1 if unknown
     * @param constructor
     *         <code>true</code> if this search matches a constructor
     *         <code>false</code> otherwise
     * @param synthetic
     *         <code>true</code> if this search matches a synthetic element
     *         <code>false</code> otherwise
     ...
     */
    public MethodReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length, boolean constructor, boolean synthetic,
                                boolean superInvocation, boolean insideDocComment, SearchParticipant participant, IResource resource) {

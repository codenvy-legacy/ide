...
public abstract class Expression extends Statement
{
      ...
      Expression expression)
   {
      ...
      if (castType.isBaseType())
      {
         ...
         expressionType).isCompatibleWith(castType))
                     ...
                     if (castType.isInterface())
                     {
                        ...
                        else
                        {
                           ...
                           for (int i = 0, castMethodsLength = castTypeMethods.length; i < castMethodsLength; i++)
                           {
                              ...
                              {
                                 if ((castTypeMethods[i].returnType != expressionTypeMethods[j].returnType) && (CharOperation.equals(
         ...
         else if (receiverBinding instanceof FieldBinding)
         {
            ...
            if (field.type.isRawType())
            {
               if (referenceContext instanceof AbstractMethodDeclaration)
               {
                  ...
                  if (field.declaringClass != methodDecl.binding.declaringClass)
               ...
               else if (referenceContext instanceof TypeDeclaration)
               {
                  ...
                  if (field.declaringClass != type.binding)
                  { // inherited raw field, see https://bugs.eclipse.org/bugs/show_bug.cgi?id=337962
                     return true;
                  }
               }

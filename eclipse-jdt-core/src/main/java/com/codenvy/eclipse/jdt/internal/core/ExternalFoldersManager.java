...
public class ExternalFoldersManager {
    ...
    private IFolder createLinkFolder(IPath externalFolderPath, boolean refreshIfExistAlready,
        ...
        try {
            ...
            if (System.getProperty("jdt.bug.367669") != null) { //$NON-NLS-1$
                ...
                System.out.println(
                        externalFile.exists() ? "External folder exists"
                                              : "ERROR: External folder DOES NOT exist"); //$NON-NLS-1$ //$NON-NLS-2$
                System.out.println(
    ...
    private void openExternalFoldersProject(IProject project, IProgressMonitor monitor) throws CoreException {
        ...
        //         {
        //            // workspace was moved
        //            // (see https://bugs.eclipse.org/bugs/show_bug.cgi?id=241400 and https://bugs.eclipse.org/bugs/show_bug
        // .cgi?id=252571 )

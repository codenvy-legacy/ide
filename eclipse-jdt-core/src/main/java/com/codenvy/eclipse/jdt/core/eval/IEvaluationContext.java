 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.core.eval;
...
public interface IEvaluationContext {
     ...
     *
     * @param codeSnippet
     *         the code snippet to complete in
     * @param position
     *         the character position in the code snippet to complete at,
     ...
     *         if code completion could not be performed. Reasons include:
     *         <ul>
     ...
     *
     * @param codeSnippet
     *         the code snippet to resolve in
     * @param offset
     *         the position in the code snippet of the first character
     *         of the code to resolve
     * @param length
     *         the length of the selected code to resolve
     ...
     *         the dot-separated fully qualified names of the types of the local variables.
     ...
     *         the modifiers of the local variables (default modifier or final modifier).
     * @param declaringType
     *         the type in which the code snippet is evaluated.
     * @param isStatic
     *         whether the code snippet is evaluated in a static member of the declaring type.
     * @param isConstructorCall
     *         whether the code snippet is evaluated in a constructor of the declaring type.
     * @param requestor
     *         the code snippet requestor
     * @param progressMonitor
     *         a progress monitor
     * @throws JavaModelException
     *         if a runtime problem occurred or if this
    ...
    public void evaluateCodeSnippet(String codeSnippet, String[] localVariableTypeNames, String[] localVariableNames,
                                    ...
                                    ICodeSnippetRequestor requestor, IProgressMonitor progressMonitor) throws JavaModelException;
     ...
     * @param initializer
     *         the initializer expression, or <code>null</code> if the
     ...
     *
     * @param packageName
     *         the dot-separated package name, or the empty string
     ...
     *         the code snippet requestor
     * @throws JavaModelException
     *         if this context's project has no build state
     */
    ...
    public void codeComplete(String codeSnippet, int position,
                             com.codenvy.eclipse.jdt.core.ICodeCompletionRequestor requestor) throws JavaModelException;

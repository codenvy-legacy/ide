...
public class MethodDeclaration extends BodyDeclaration {
     ...
     * @since 3.0
     */
    public static final ChildPropertyDescriptor JAVADOC_PROPERTY = internalJavadocPropertyFactory(
     ...
     *
     * @param isConstructor
     *         <code>true</code> for a constructor declaration,
     ...
     *
     * @param body
     *         the block node, or <code>null</code> if
     *         there is none
     * @throws IllegalArgumentException
     *         if:
     *         <ul>
    ...
    int treeSize() {
        return memSize() + (this.optionalDocComment == null ? 0 : getJavadoc().treeSize()) +
               ...
               (this.typeParameters == null ? 0 : this.typeParameters.listSize()) + (this.methodName == null ? 0 : getName().treeSize()) +
               (this.returnType == null ? 0 : this.returnType.treeSize()) + this.parameters.listSize() + this.thrownExceptions.listSize() +

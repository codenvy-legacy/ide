...
public class CollectingSearchRequestor extends SearchRequestor {
    ...
    /**
     * The default implementation calls {@link #collectMatch(com.codenvy.eclipse.jdt.core.search.SearchMatch)} for
     * all matches that make it through {@link #filterMatch(com.codenvy.eclipse.jdt.core.search.SearchMatch)}.
     *
     * @param match
     *         the found match
    ...
    /** @return a List of {@link com.codenvy.eclipse.jdt.core.search.SearchMatch}es (not sorted) */

...
public class SourceTypeBinding extends ReferenceBinding
{
   ...
   public FieldBinding addSyntheticFieldForClassLiteral(TypeBinding targetType, BlockScope blockScope)
   {
      ...
      if (synthField == null)
      {
         synthField = new SyntheticFieldBinding(CharOperation.concat(TypeConstants.SYNTHETIC_CLASS,
            ...
            ClassFileConstants.AccDefault | ClassFileConstants.AccStatic | ClassFileConstants.AccSynthetic, this,
   ...
   public SyntheticFieldBinding addSyntheticFieldForSwitchEnum(char[] fieldName, String key)
   {
      ...
      if (synthField == null)
      {
         synthField = new SyntheticFieldBinding(fieldName, this.scope.createArrayType(TypeBinding.INT, 1),
            ClassFileConstants.AccPrivate | ClassFileConstants.AccStatic | ClassFileConstants.AccSynthetic, this,
            Constant.NotAConstant, this.synthetics[SourceTypeBinding.FIELD_EMUL].size());
   ...
   */
      ...
      MethodBinding targetMethod)
   {
      ...
      if (inheritedMethodToBridge.returnType.erasure() == targetMethod.returnType.erasure() && inheritedMethodToBridge.areParameterErasuresEqual(
         targetMethod))
      {
         ...
         while (synthMethods.hasNext())
         {
            ...
            if (synthetic instanceof MethodBinding)
            {
               ...
               if (CharOperation.equals(inheritedMethodToBridge.selector,
                  method.selector) && inheritedMethodToBridge.returnType.erasure() == method.returnType.erasure() && inheritedMethodToBridge.areParameterErasuresEqual(
                  method))
               {
                  return null;
               }
   ...
   */
         ...
         for (int i = 0, length = this.methods.length; i < length; i++)
         {
            ...
            for (int j = i + 1; j < length; j++)
            {
               ...
               boolean isEnumSpecialMethod = isEnum() && (CharOperation.equals(selector,
                  TypeConstants.VALUEOF) || CharOperation.equals(selector, TypeConstants.VALUES));
               // report duplicate
   ...
   public FieldBinding resolveTypeFor(FieldBinding field)
   {
      ...
      for (int f = 0; f < length; f++)
      {
         ...
         try
         {
            ...
            TypeBinding fieldType = fieldDecl.getKind() == AbstractVariableDeclaration.ENUM_CONSTANT ? initializationScope.environment().convertToRawType(
               this,
   ...
   public MethodBinding resolveTypesFor(MethodBinding method)
   {
      ...
      if (this.scope.compilerOptions().sourceLevel >= ClassFileConstants.JDK1_7)
      {
         ...
         else if (method.parameters != null && method.parameters.length > 0 && method.isVarargs())
   ...
   private void evaluateNullAnnotations(long annotationTagBits)
   {
      ...
      if (!isPackageInfo)
      {
         boolean isInNullnessAnnotationPackage = pkg == this.scope.environment().nonnullAnnotationPackage || pkg == this.scope.environment().nullableAnnotationPackage || pkg == this.scope.environment().nonnullByDefaultAnnotationPackage;

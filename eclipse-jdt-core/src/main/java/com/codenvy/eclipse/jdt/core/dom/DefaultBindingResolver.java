...
import com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocAllocationExpression;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocSingleNameReference;
...
import com.codenvy.eclipse.jdt.internal.compiler.impl.Constant;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.ElementValuePair;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.ProblemFieldBinding;
...
class DefaultBindingResolver extends BindingResolver
{
   ...
   IBinding getBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding binding)
   {
      switch (binding.kind())
      {
         case Binding.PACKAGE:
            return getPackageBinding((com.codenvy.eclipse.jdt.internal.compiler.lookup.PackageBinding)binding);
         case Binding.TYPE:
         case Binding.BASE_TYPE:
         case Binding.GENERIC_TYPE:
         case Binding.PARAMETERIZED_TYPE:
         case Binding.RAW_TYPE:
            return getTypeBinding((com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)binding);
         case Binding.ARRAY_TYPE:
         case Binding.TYPE_PARAMETER:
            return new TypeBinding(this, (com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)binding);
         case Binding.METHOD:
            return getMethodBinding((com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding)binding);
         case Binding.FIELD:
         case Binding.LOCAL:
            return getVariableBinding((com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding)binding);
      }
      return null;
   }
   ...
   Util.BindingsToNodesMap getBindingsToNodesMap()
   {
      ...
      {
         public com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode get(Binding binding)
         {
            return (com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode)DefaultBindingResolver.this.newAstToOldAst.get(
               DefaultBindingResolver.this.bindingsToAstNodes.get(binding));
         }
      };
   }

   synchronized com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode)
   {
      return (com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(currentNode);
   }

   /*
    * Method declared on BindingResolver.
    */
   synchronized IMethodBinding getMethodBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding)
   {
      if (methodBinding != null && !methodBinding.isValidBinding())
      {
         com.codenvy.eclipse.jdt.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding = (com.codenvy.eclipse.jdt.internal.compiler.lookup.ProblemMethodBinding)methodBinding;
   ...
   synchronized IMemberValuePairBinding getMemberValuePairBinding(ElementValuePair valuePair)
   {
      ...
      IMemberValuePairBinding binding = (IMemberValuePairBinding)this.bindingTables.compilerBindingsToASTBindings.get(
         valuePair);
      if (binding != null)
      {
         return binding;
   ...
   synchronized IPackageBinding getPackageBinding(
      com.codenvy.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding)
   {
    ...
    * Method declared on BindingResolver.
    */
   synchronized ITypeBinding getTypeBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding referenceBinding)
   {
         ...
         switch (referenceBinding.problemId())
         {
            ...
            case ProblemReasons.NonStaticReferenceInStaticContext:
               if (referenceBinding instanceof ProblemReferenceBinding)
               {
                  ...
                  com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding binding2 = problemReferenceBinding.closestMatch();
            ...
            case ProblemReasons.NotFound:
               ...
               ITypeBinding binding = (ITypeBinding)this.bindingTables.compilerBindingsToASTBindings.get(
                  referenceBinding);
               if (binding != null)
               {
                  return binding;
   ...
   synchronized IVariableBinding getVariableBinding(
      com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding variableBinding, VariableDeclaration variableDeclaration)
   {
      if (this.isRecoveringBindings)
      {
         if (variableBinding != null)
         {
            ...
            {
               IVariableBinding binding = (IVariableBinding)this.bindingTables.compilerBindingsToASTBindings.get(
                  variableBinding);
               if (binding != null)
               {
                  return binding;
               ...
               if (variableBinding instanceof ProblemFieldBinding)
               {
                  ...
                  switch (problemFieldBinding.problemId())
                  {
                     ...
                     case ProblemReasons.NonStaticReferenceInConstructorInvocation:
                        ...
                        {
                           IVariableBinding variableBinding2 = (IVariableBinding)this.bindingTables.compilerBindingsToASTBindings.get(
                              exactBinding);
    ...
    */
   synchronized IVariableBinding getVariableBinding(
      com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding variableBinding)
   {
      if (variableBinding != null)
      {
         if (variableBinding.isValidBinding())
         {
            com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding variableType = variableBinding.type;
   ...
   synchronized IAnnotationBinding getAnnotationInstance(
      com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding internalInstance)
   {
      ...
      IAnnotationBinding domInstance = (IAnnotationBinding)this.bindingTables.compilerBindingsToASTBindings.get(
         internalInstance);
      if (domInstance != null)
      {
         return domInstance;
   ...
   boolean isResolvedTypeInferredFromExpectedType(MethodInvocation methodInvocation)
   {
      ...
      if (oldNode instanceof MessageSend)
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding = messageSend.binding;
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.dom.BindingResolver#recordScope(ASTNode, BlockScope)
    */
   ...
   {
      com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(
         expression);
      if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.Expression compilerExpression = (com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)node;
   ...
   synchronized IMethodBinding resolveConstructor(ClassInstanceCreation expression)
   {
      com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(
         expression);
      if (node != null && (node.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)node;
   ...
   IMethodBinding resolveConstructor(EnumConstantDeclaration enumConstantDeclaration)
   {
      ...
      if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration)
      {
      ...
      try
      {
         switch (expression.getNodeType())
         {
            case ASTNode.CLASS_INSTANCE_CREATION:
               com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode astNode = (com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(
                  expression);
               if (astNode instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)
               {
                  // anonymous type case
                  com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)astNode;
            ...
            case ASTNode.SINGLE_MEMBER_ANNOTATION:
               com.codenvy.eclipse.jdt.internal.compiler.ast.Expression compilerExpression = (com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)this.newAstToOldAst.get(
                  expression);
   ...
   synchronized IBinding resolveImport(ImportDeclaration importDeclaration)
   {
      ...
      try
      {
         ...
         if (node instanceof ImportReference)
         {
            ...
            if ((importReference.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0)
            {
               Binding binding = this.scope.getImport(
                  CharOperation.subarray(importReference.tokens, 0, importReference.tokens.length), true, isStatic);
               if (binding != null)
               {
                  if (isStatic)
                  {
                     if (binding instanceof com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)
                     {
                        ITypeBinding typeBinding = this.getTypeBinding(
                           (com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)binding);
                  ...
                  else
                  {
                     if ((binding.kind() & Binding.PACKAGE) != 0)
                     {
                        IPackageBinding packageBinding = getPackageBinding(
                           (com.codenvy.eclipse.jdt.internal.compiler.lookup.PackageBinding)binding);
                        if (packageBinding == null)
                        {
                           return null;
                        }
            ...
            else
            {
               ...
               if (binding != null)
               {
                  if (isStatic)
                  {
                     ...
                     else if (binding instanceof com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding)
                     {
                        // it is a type
                        return getMethodBinding((com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding)binding);
                     }
   ...
   synchronized ITypeBinding resolveTypeBindingForName(Name name)
   {
      ...
      if (node instanceof QualifiedNameReference)
      {
         ...
         if (index < indexOfFirstFieldBinding)
         {
            ...
            if (binding instanceof com.codenvy.eclipse.jdt.internal.compiler.lookup.PackageBinding)
            {
               return null;
            }
            else if (binding instanceof com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)
            {
               // it is a type
               return this.getTypeBinding((com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)binding);
            }
         }
         else if (index == indexOfFirstFieldBinding)
         {
            ...
            else
            {
               ...
               com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding type = fieldBinding.declaringClass;
               if (type == null)
               { // array length scenario
                  // use type from first binding (no capture needed for array type)
                  switch (qualifiedNameReference.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.RestrictiveFlagMASK)
                  {
                     case Binding.FIELD:
            ...
            if (importReferenceLength == index)
            {
               try
               {
                  binding = this.scope.getImport(CharOperation.subarray(importReference.tokens, 0, index),
                     (importReference.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0,
      ...
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)node;
         ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
         if (typeBinding != null)
         {
            return typeBinding;
      ...
      else if (node instanceof SingleTypeReference)
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding binding = singleTypeReference.resolvedType;
         if (binding != null)
         {
      ...
      else if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter typeParameter = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter)node;
         return this.getTypeBinding(typeParameter.binding);
      }
      else if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.MemberValuePair)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.MemberValuePair memberValuePair = (com.codenvy.eclipse.jdt.internal.compiler.ast.MemberValuePair)node;
   ...
   synchronized IBinding resolveName(Name name)
   {
         ...
         else if (index == indexOfFirstFieldBinding)
         {
            ...
            else
            {
               ...
               if (binding != null)
               {
                  ...
                  {
                     return this.getVariableBinding((com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding)binding);
                  }
                        ...
                        case ProblemReasons.NonStaticReferenceInStaticContext:
                           ...
                           if (declaringClass != null)
                           {
                              ...
                              if (exactBinding != null)
                              {
                                 ...
                                 {
                                    IVariableBinding variableBinding = (IVariableBinding)this.bindingTables.compilerBindingsToASTBindings.get(
                                       exactBinding);
                                    if (variableBinding != null)
                                    {
         ...
         else
         {
            ...
            else
            {
               return this.getVariableBinding(
                  qualifiedNameReference.otherBindings[index - indexOfFirstFieldBinding - 1]);
            }
         }
      }
      else if (node instanceof QualifiedTypeReference)
      ...
      else if (node instanceof ImportReference)
      {
         ...
         if (index >= 0)
         {
            ...
            if (binding != null)
            {
               ...
               else if (binding instanceof com.codenvy.eclipse.jdt.internal.compiler.lookup.FieldBinding)
               {
                  // it is a type
                  return this.getVariableBinding((com.codenvy.eclipse.jdt.internal.compiler.lookup.FieldBinding)binding);
               }
               else if (binding instanceof com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding)
               {
                  // it is a type
      ...
      else if (node instanceof CompilationUnitDeclaration)
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration[] types = compilationUnitDeclaration.types;
         if (types == null || types.length == 0)
         {
            return null;
         }
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration type = types[0];
         if (type != null)
         {
   ...
   synchronized IPackageBinding resolvePackage(PackageDeclaration pkg)
   {
      ...
      try
      {
         ...
         {
            ImportReference importReference = (ImportReference)node;
            Binding binding = this.scope.getOnlyPackage(
               CharOperation.subarray(importReference.tokens, 0, importReference.tokens.length));
   ...
   {
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression = (com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)this.newAstToOldAst.get(
         ref);
    ...
    * @see BindingResolver#resolveMemberValuePair(MemberValuePair)
     * @since 3.2
    */
   synchronized IMemberValuePairBinding resolveMemberValuePair(com.codenvy.eclipse.jdt.core.dom.MemberValuePair memberValuePair)
   {
   ...
   ITypeBinding resolveType(AnnotationTypeDeclaration type)
   {
      ...
      if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)node;
         ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
         if (typeBinding == null)
   ...
   synchronized ITypeBinding resolveType(Type type)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(
         type);
      com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding binding = null;
      if (node != null)
      {
         if (node instanceof ParameterizedQualifiedTypeReference)
         {
            ...
            com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = typeReference.resolvedType;
            if (type.isArrayType())
            {
               if (this.scope == null)
               {
               ...
               return getTypeBinding(
                  this.scope.createArrayType(arrayBinding.leafComponentType, arrayType.getDimensions()));
            }
      ...
      else if (type.isPrimitiveType())
      {
         ...
         {
            return this.getTypeBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.VOID);
         }
      }
      return null;
   }
   ...
   synchronized ITypeBinding resolveTypeParameter(TypeParameter typeParameter)
   {
      ...
      if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter typeParameter2 = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter)node;
   ...
   synchronized IVariableBinding resolveVariable(VariableDeclaration variable)
   {
      ...
      if (node instanceof AbstractVariableDeclaration)
      {
         ...
         if (abstractVariableDeclaration instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration)
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration)abstractVariableDeclaration;
            variableBinding = this.getVariableBinding(fieldDeclaration.binding, variable);
         }
         else
         {
            variableBinding = this.getVariableBinding(((LocalDeclaration)abstractVariableDeclaration).binding,
               variable);
         }
         if (variableBinding == null)
         {
   ...
   synchronized ITypeBinding resolveWellKnownType(String name)
   {
      ...
      try
      {
         ...
         else if ("java.lang.Cloneable".equals(name))
         {//$NON-NLS-1$
            typeBinding = this.getTypeBinding(this.scope.getJavaLangCloneable());
         }
         else if ("java.io.Serializable".equals(name))
         {//$NON-NLS-1$
         ...
         else if ("java.lang.AssertionError".equals(name))
         { //$NON-NLS-1$
   ...
   synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode)
   {
      ...
      if (oldNode instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation internalAstNode = (com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation)oldNode;
    ...
    * Method declared on BindingResolver.
    */
   synchronized void store(ASTNode node, com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode oldASTNode)
   {
   ...
   ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding leafTypeBinding = null;
      if (leafComponentType.isPrimitive())
      {
         ...
         {
            case 'I':
               leafTypeBinding = com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.INT;
               break;
            case 'B':
               leafTypeBinding = com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.BYTE;
               break;
            case 'Z':
               leafTypeBinding = com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.BOOLEAN;
               break;
            case 'C':
               leafTypeBinding = com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.CHAR;
               break;
            case 'J':
               leafTypeBinding = com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.LONG;
               break;
            case 'S':
               leafTypeBinding = com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.SHORT;
               break;
            case 'D':
               leafTypeBinding = com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.DOUBLE;
               break;
            case 'F':
               leafTypeBinding = com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.FLOAT;
               break;
            case 'V':

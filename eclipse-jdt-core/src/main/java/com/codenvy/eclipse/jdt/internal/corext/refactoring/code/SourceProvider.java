...
import com.codenvy.eclipse.jdt.internal.corext.refactoring.code.SourceAnalyzer.NameData;
...
public class SourceProvider {
     ...
     *         the type root
     * @param source
     *         document containing the content of the type root
     * @param declaration
    ...
    private void replaceParameterWithExpression(ASTRewrite rewriter, CallContext context,
    ...
    private void updateImplicitReceivers(ASTRewrite rewriter, CallContext context) {
        ...
        for (Iterator<Expression> iter = implicitReceivers.iterator(); iter.hasNext(); ) {
            ...
            if (node instanceof MethodInvocation) {
                ...
                rewriter.set(inv, MethodInvocation.EXPRESSION_PROPERTY,
                             createReceiver(rewriter, context, (IMethodBinding)inv.getName().resolveBinding(), importRewriteContext),
                             null);
                ...
                rewriter.set(inst, ClassInstanceCreation.EXPRESSION_PROPERTY,
                             createReceiver(rewriter, context, inst.resolveConstructorBinding(), importRewriteContext), null);

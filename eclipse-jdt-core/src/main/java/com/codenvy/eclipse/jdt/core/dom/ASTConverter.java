...
import com.codenvy.eclipse.jdt.core.dom.Modifier.ModifierKeyword;
import com.codenvy.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration;
import com.codenvy.eclipse.jdt.internal.compiler.ast.AbstractVariableDeclaration;
import com.codenvy.eclipse.jdt.internal.compiler.ast.Argument;
import com.codenvy.eclipse.jdt.internal.compiler.ast.ForeachStatement;
import com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocArgumentExpression;
import com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocFieldReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocMessageSend;
import com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration;
import com.codenvy.eclipse.jdt.internal.compiler.ast.MessageSend;
import com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedAllocationExpression;
import com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.SingleNameReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.SingleTypeReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.StringLiteralConcatenation;
import com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.Wildcard;
import com.codenvy.eclipse.jdt.internal.compiler.classfmt.ClassFileConstants;
import com.codenvy.eclipse.jdt.internal.compiler.impl.CompilerOptions;
import com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope;
import com.codenvy.eclipse.jdt.internal.compiler.lookup.ExtraCompilerModifiers;
import com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeConstants;
import com.codenvy.eclipse.jdt.internal.compiler.parser.RecoveryScanner;
import com.codenvy.eclipse.jdt.internal.compiler.parser.Scanner;
import com.codenvy.eclipse.jdt.internal.compiler.parser.TerminalTokens;
...
class ASTConverter
{
   ...
   public ASTConverter(Map options, boolean resolveBindings, IProgressMonitor monitor)
   {
      ...
      this.scanner = new Scanner(true /*comment*/, false /*whitespace*/, false /*nls*/, sourceLevel /*sourceLevel*/,
   ...
   protected void adjustSourcePositionsForParent(com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression)
   {
   ...
   protected void buildBodyDeclarations(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration,
      AbstractTypeDeclaration typeDecl, boolean isInterface)
   {
      // add body declaration in the lexical order
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration[] members = typeDeclaration.memberTypes;
      com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration[] fields = typeDeclaration.fields;
      com.codenvy.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = typeDeclaration.methods;
      ...
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration nextFieldDeclaration = null;
         com.codenvy.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration nextMethodDeclaration = null;
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = null;
   ...
   protected void buildBodyDeclarations(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration enumDeclaration2,
      EnumDeclaration enumDeclaration)
   {
      // add body declaration in the lexical order
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration[] members = enumDeclaration2.memberTypes;
      com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration[] fields = enumDeclaration2.fields;
      com.codenvy.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = enumDeclaration2.methods;
   ...
   protected void buildBodyDeclarations(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration expression,
      AnonymousClassDeclaration anonymousClassDeclaration)
   {
      // add body declaration in the lexical order
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration[] members = expression.memberTypes;
      com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration[] fields = expression.fields;
      com.codenvy.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = expression.methods;
   ...
   protected void checkAndAddMultipleFieldDeclaration(com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration[] fields,
      int index, List bodyDeclarations)
   {
      if (fields[index] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer oldInitializer = (com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer)fields[index];
   ...
   protected void checkAndAddMultipleLocalDeclaration(com.codenvy.eclipse.jdt.internal.compiler.ast.Statement[] stmts,
      int index, List blockStatements)
   {
      if (index > 0 && stmts[index - 1] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration local1 = (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)stmts[index - 1];
         com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration local2 = (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)stmts[index];
         if (local1.declarationSourceStart == local2.declarationSourceStart)
         {
            ...
            VariableDeclarationStatement variableDeclarationStatement = (VariableDeclarationStatement)blockStatements.get(
               blockStatements.size() - 1);
            variableDeclarationStatement.fragments().add(convertToVariableDeclarationFragment(
               (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)stmts[index]));
         }
         else
         {
            // we can create a new FieldDeclaration
   ...
   protected void completeRecord(ArrayType arrayType, com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode astNode)
   {
   ...
   public ASTNode convert(boolean isInterface,
      com.codenvy.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration methodDeclaration)
   {
      checkCanceled();
      if (methodDeclaration instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.AnnotationMethodDeclaration)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.AnnotationMethodDeclaration)methodDeclaration);
      }
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference[] thrownExceptions = methodDeclaration.thrownExceptions;
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Argument[] parameters = methodDeclaration.arguments;
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall explicitConstructorCall = null;
      if (isConstructor)
      {
         if (isInterface)
         {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.ast.ConstructorDeclaration constructorDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.ConstructorDeclaration)methodDeclaration;
      ...
      else if (methodDeclaration instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.MethodDeclaration)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.MethodDeclaration method = (com.codenvy.eclipse.jdt.internal.compiler.ast.MethodDeclaration)methodDeclaration;
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeReference = method.returnType;
      ...
      if (closingPosition != -1)
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.ast.Statement[] statements = methodDeclaration.statements;
         ...
         {
            if (explicitConstructorCall != null && explicitConstructorCall.accessMode != com.codenvy.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall.ImplicitSuper)
            {
            ...
            {
               if (statements[i] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)
               {
         ...
         if (block != null && (Modifier.isAbstract(methodDecl.getModifiers()) || Modifier.isNative(
            methodDecl.getModifiers()) || isInterface))
         {
            methodDecl.setFlags(methodDecl.getFlags() | ASTNode.MALFORMED);
         }
      }
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter[] typeParameters = methodDeclaration.typeParameters();
   ...
   public ClassInstanceCreation convert(com.codenvy.eclipse.jdt.internal.compiler.ast.AllocationExpression expression)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] arguments = expression.arguments;
      if (arguments != null)
      {
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.AND_AND_Expression expression)
   {
      ...
      final int expressionOperatorID = (expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
      if (expression.left instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression && ((expression.left.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.ast.Expression leftOperand = expression.left;
         com.codenvy.eclipse.jdt.internal.compiler.ast.Expression rightOperand = null;
         do
         {
            rightOperand = ((com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression)leftOperand).right;
            if ((((leftOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID && ((leftOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)) || ((rightOperand instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression && ((rightOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID) && ((rightOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)))
            {
            ...
            leftOperand = ((com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression)leftOperand).left;
         }
         while (leftOperand instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression && ((leftOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0));
   ...
   private AnnotationTypeDeclaration convertToAnnotationDeclaration(
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration)
   {
      checkCanceled();
   ...
   public ASTNode convert(
      com.codenvy.eclipse.jdt.internal.compiler.ast.AnnotationMethodDeclaration annotationTypeMemberDeclaration)
   {
      checkCanceled();
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeReference = annotationTypeMemberDeclaration.returnType;
      if (typeReference != null)
      {
         Type returnType = convertType(typeReference);
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression memberValue = annotationTypeMemberDeclaration.defaultValue;
      if (memberValue != null)
      {
   ...
   public SingleVariableDeclaration convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Argument argument)
   {
   ...
   public Annotation convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation annotation)
   {
      if (annotation instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.SingleMemberAnnotation)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.SingleMemberAnnotation)annotation);
      }
      else if (annotation instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.MarkerAnnotation)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.MarkerAnnotation)annotation);
      }
      else
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.NormalAnnotation)annotation);
      }
   }

   public ArrayCreation convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayAllocationExpression expression)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] dimensions = expression.dimensions;
   ...
   public ArrayInitializer convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayInitializer expression)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] expressions = expression.expressions;
      if (expressions != null)
      {
   ...
   public ArrayAccess convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayReference reference)
   {
   ...
   public AssertStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.AssertStatement statement)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression exceptionArgument = statement.exceptionArgument;
   ...
   public Assignment convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Assignment expression)
   {
   ...
   /*
	 ...
	 */
   public TypeDeclaration convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode[] nodes)
   {
      ...
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode node = nodes[i];
         if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer)
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer oldInitializer = (com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer)node;
            Initializer initializer = new Initializer(this.ast);
            initializer.setBody(convert(oldInitializer.block));
            setModifiers(initializer, oldInitializer);
            initializer.setSourceRange(oldInitializer.declarationSourceStart,
         ...
         else if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration)
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration)node;
            if (i > 0 && (nodes[i - 1] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration) && ((com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration)nodes[i - 1]).declarationSourceStart == fieldDeclaration.declarationSourceStart)
            {
               // we have a multiple field declaration
               // We retrieve the existing fieldDeclaration to add the new VariableDeclarationFragment
         ...
         else if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration)
         {
         ...
         else if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)node;
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression expression)
   {
      InfixExpression infixExpression = new InfixExpression(this.ast);
      if (this.resolveBindings)
      {
      ...
      int expressionOperatorID = (expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
      ...
      else if (expression.left instanceof StringLiteralConcatenation && ((expression.left.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0) && (OperatorIds.PLUS == expressionOperatorID))
      {
         StringLiteralConcatenation literal = (StringLiteralConcatenation)expression.left;
         final com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] stringLiterals = literal.literals;
   ...
   public Block convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Block statement)
   {
      Block block = new Block(this.ast);
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Statement[] statements = statement.statements;
      if (statements != null)
      {
   ...
   public BreakStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.BreakStatement statement)
   {
   ...
   public SwitchCase convert(com.codenvy.eclipse.jdt.internal.compiler.ast.CaseStatement statement)
   {
      SwitchCase switchCase = new SwitchCase(this.ast);
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression constantExpression = statement.constantExpression;
   ...
   public CastExpression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.CastExpression expression)
   {
   ...
   public CharacterLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.CharLiteral expression)
   {
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ClassLiteralAccess expression)
   {
   ...
   public CompilationUnit convert(com.codenvy.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration unit, char[] source)
   {
      try
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.ast.ImportReference[] imports = unit.imports;
         if (imports != null)
         {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration[] types = unit.types;
         if (types != null)
         {
            int typesLength = types.length;
            for (int i = 0; i < typesLength; i++)
            {
               com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration declaration = types[i];
      ...
      catch (IllegalArgumentException e)
      {
         StringBuffer message = new StringBuffer(
            "Exception occurred during compilation unit conversion:");  //$NON-NLS-1$
         ...
         message.append(lineDelimiter);
         message.append(
            "----------------------------------- SOURCE END -------------------------------------"); //$NON-NLS-1$
         Util.log(e, message.toString());
         throw e;
      }
   }

   public Assignment convert(com.codenvy.eclipse.jdt.internal.compiler.ast.CompoundAssignment expression)
   {
      Assignment assignment = new Assignment(this.ast);
      Expression lhs = convert(expression.lhs);
      assignment.setLeftHandSide(lhs);
      ...
      {
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.PLUS:
            assignment.setOperator(Assignment.Operator.PLUS_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.MINUS:
            assignment.setOperator(Assignment.Operator.MINUS_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.MULTIPLY:
            assignment.setOperator(Assignment.Operator.TIMES_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.DIVIDE:
            assignment.setOperator(Assignment.Operator.DIVIDE_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.AND:
            assignment.setOperator(Assignment.Operator.BIT_AND_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.OR:
            assignment.setOperator(Assignment.Operator.BIT_OR_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.XOR:
            assignment.setOperator(Assignment.Operator.BIT_XOR_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.REMAINDER:
            assignment.setOperator(Assignment.Operator.REMAINDER_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.LEFT_SHIFT:
            assignment.setOperator(Assignment.Operator.LEFT_SHIFT_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.RIGHT_SHIFT:
            assignment.setOperator(Assignment.Operator.RIGHT_SHIFT_SIGNED_ASSIGN);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.UNSIGNED_RIGHT_SHIFT:
   ...
   public ConditionalExpression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ConditionalExpression expression)
   {
   ...
   public ContinueStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ContinueStatement statement)
   {
   ...
   public DoStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.DoStatement statement)
   {
   ...
   public NumberLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.DoubleLiteral expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
   ...
   public EmptyStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.EmptyStatement statement)
   {
   ...
   public EnumConstantDeclaration convert(com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration enumConstant)
   {
      checkCanceled();
      ...
      final com.codenvy.eclipse.jdt.internal.compiler.ast.Expression initialization = enumConstant.initialization;
      if (initialization != null)
      {
         if (initialization instanceof QualifiedAllocationExpression)
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration anonymousType = ((QualifiedAllocationExpression)initialization).anonymousType;
         ...
         final com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] arguments = ((com.codenvy.eclipse.jdt.internal.compiler.ast.AllocationExpression)initialization).arguments;
         if (arguments != null)
         {
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.EqualExpression expression)
   {
      InfixExpression infixExpression = new InfixExpression(this.ast);
      if (this.resolveBindings)
      {
      ...
      int startPosition = leftExpression.getStartPosition();
      infixExpression.setSourceRange(startPosition, expression.sourceEnd - startPosition + 1);
      switch ((expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT)
      {
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.EQUAL_EQUAL:
            infixExpression.setOperator(InfixExpression.Operator.EQUALS);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.NOT_EQUAL:
   ...
   public Statement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall statement)
   {
      ...
      if (statement.isSuperAccess() || statement.isSuper())
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] arguments = statement.arguments;
         if (arguments != null)
         {
            int length = arguments.length;
            for (int i = 0; i < length; i++)
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression)
   {
      if ((expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0)
      {
         return convertToParenthesizedExpression(expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.CastExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.CastExpression)expression);
      }
      // switch between all types of expression
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayAllocationExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayAllocationExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedAllocationExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedAllocationExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.AllocationExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.AllocationExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayInitializer)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayInitializer)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.PrefixExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.PrefixExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.PostfixExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.PostfixExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.CompoundAssignment)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.CompoundAssignment)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Assignment)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.Assignment)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ClassLiteralAccess)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ClassLiteralAccess)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.FalseLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.FalseLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TrueLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.TrueLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.NullLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.NullLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.CharLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.CharLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.DoubleLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.DoubleLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.FloatLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.FloatLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.IntLiteralMinValue)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.IntLiteralMinValue)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.IntLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.IntLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LongLiteralMinValue)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.LongLiteralMinValue)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LongLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.LongLiteral)expression);
      }
      if (expression instanceof StringLiteralConcatenation)
      {
         return convert((StringLiteralConcatenation)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ExtendedStringLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ExtendedStringLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.StringLiteral)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.StringLiteral)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.AND_AND_Expression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.AND_AND_Expression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.OR_OR_Expression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.OR_OR_Expression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.EqualExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.EqualExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.InstanceOfExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.InstanceOfExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.UnaryExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.UnaryExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ConditionalExpression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ConditionalExpression)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.MessageSend)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.MessageSend)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Reference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.Reference)expression);
      }
      if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)expression);
      }
      return null;
   }

   public StringLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ExtendedStringLiteral expression)
   {
   ...
   public BooleanLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.FalseLiteral expression)
   {
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.FieldReference reference)
   {
      if (reference.receiver.isSuper())
      {
         ...
         if (reference.receiver instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference)
         {
            Name qualifier = convert((com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference)reference.receiver);
   ...
   public NumberLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.FloatLiteral expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
      NumberLiteral literal = new NumberLiteral(this.ast);
   ...
   public Statement convert(ForeachStatement statement)
   {
      switch (this.ast.apiLevel)
      {
         ...
         default:
            ...
            com.codenvy.eclipse.jdt.internal.compiler.ast.Expression collection = statement.collection;
            if (collection == null)
            {
               return null;
            }
   ...
   public ForStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ForStatement statement)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Statement[] initializations = statement.initializations;
      if (initializations != null)
      {
         // we know that we have at least one initialization
         if (initializations[0] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration initialization = (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)initializations[0];
            ...
            {
               initialization = (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)initializations[i];
            ...
            if (initializationsLength != 1)
            {
               ...
               int end = ((com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)initializations[initializationsLength - 1]).declarationSourceEnd;
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Statement[] increments = statement.increments;
      if (increments != null)
      {
   ...
   public IfStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.IfStatement statement)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Statement statement2 = statement.elseStatement;
      if (statement2 != null)
      {
   ...
   public InstanceofExpression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.InstanceOfExpression expression)
   {
   ...
   public NumberLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.IntLiteral expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
   ...
   public NumberLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.IntLiteralMinValue expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
      NumberLiteral literal = new NumberLiteral(this.ast);
   ...
   public void convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Javadoc javadoc, BodyDeclaration bodyDeclaration)
   {
   ...
   public void convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Javadoc javadoc, PackageDeclaration packageDeclaration)
   {
      switch (this.ast.apiLevel)
      {
         case AST.JLS2_INTERNAL:
   ...
   public LabeledStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.LabeledStatement statement)
   {
   ...
   public NumberLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.LongLiteral expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
      final NumberLiteral literal = new NumberLiteral(this.ast);
   ...
   public NumberLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.LongLiteralMinValue expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
      final NumberLiteral literal = new NumberLiteral(this.ast);
   ...
   public Expression convert(MessageSend expression)
   {
      ...
      if (expression.isSuperAccess())
      {
         ...
         if (expression.receiver instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference)
         {
            Name qualifier = convert(
               (com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference)expression.receiver);
      ...
      else
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.ast.Expression receiver = expression.receiver;
         if (receiver instanceof MessageSend)
         {
            if ((receiver.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0)
            {
   ...
   public MarkerAnnotation convert(com.codenvy.eclipse.jdt.internal.compiler.ast.MarkerAnnotation annotation)
   {
   ...
   public MemberValuePair convert(com.codenvy.eclipse.jdt.internal.compiler.ast.MemberValuePair memberValuePair)
   {
   ...
   public Name convert(com.codenvy.eclipse.jdt.internal.compiler.ast.NameReference reference)
   {
      if (reference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedNameReference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedNameReference)reference);
      }
      else
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.SingleNameReference)reference);
      }
   }
   ...
   public InfixExpression convert(StringLiteralConcatenation expression)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] stringLiterals = expression.literals;
      infixExpression.setLeftOperand(convert(stringLiterals[0]));
      infixExpression.setRightOperand(convert(stringLiterals[1]));
   ...
   public NormalAnnotation convert(com.codenvy.eclipse.jdt.internal.compiler.ast.NormalAnnotation annotation)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.MemberValuePair[] memberValuePairs = annotation.memberValuePairs;
   ...
   public NullLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.NullLiteral expression)
   {
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.OR_OR_Expression expression)
   {
      InfixExpression infixExpression = new InfixExpression(this.ast);
   ...
   public PostfixExpression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.PostfixExpression expression)
   {
   ...
   public PrefixExpression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.PrefixExpression expression)
   {
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedAllocationExpression allocation)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] arguments = allocation.arguments;
      if (arguments != null)
      {
         int length = arguments.length;
         for (int i = 0; i < length; i++)
   ...
   public Name convert(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedNameReference nameReference)
   {
      return setQualifiedNameNameAndSourceRanges(nameReference.tokens, nameReference.sourcePositions, nameReference);
   }

   public Name convert(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference reference)
   {
      return convert(reference.qualification);
   }

   public ThisExpression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedThisReference reference)
   {
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Reference reference)
   {
      if (reference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.NameReference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.NameReference)reference);
      }
      if (reference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ThisReference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ThisReference)reference);
      }
      if (reference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayReference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayReference)reference);
      }
      if (reference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.FieldReference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.FieldReference)reference);
      }
      return null; // cannot be reached
   }

   public ReturnStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ReturnStatement statement)
   {
   ...
   public SingleMemberAnnotation convert(com.codenvy.eclipse.jdt.internal.compiler.ast.SingleMemberAnnotation annotation)
   {
   ...
   public SimpleName convert(com.codenvy.eclipse.jdt.internal.compiler.ast.SingleNameReference nameReference)
   {
      final SimpleName name = new SimpleName(this.ast);
   ...
   public Statement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Statement statement)
   {
      if (statement instanceof ForeachStatement)
      {
         return convert((ForeachStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration localDeclaration = (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)statement;
         return convertToVariableDeclarationStatement(localDeclaration);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.AssertStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.AssertStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Block)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.Block)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.BreakStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.BreakStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ContinueStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ContinueStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.CaseStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.CaseStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.DoStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.DoStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.EmptyStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.EmptyStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ForStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ForStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.IfStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.IfStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LabeledStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.LabeledStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ReturnStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ReturnStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.SwitchStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.SwitchStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.SynchronizedStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.SynchronizedStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.ThrowStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.ThrowStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TryStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.TryStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)
      {
         ASTNode result = convert((com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)statement);
         if (result == null)
         {
            return createFakeEmptyStatement(statement);
         }
      ...
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.WhileStatement)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.WhileStatement)statement);
      }
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)
      {
         com.codenvy.eclipse.jdt.internal.compiler.ast.Expression statement2 = (com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)statement;
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.StringLiteral expression)
   {
      if (expression instanceof StringLiteralConcatenation)
      {
         return convert((StringLiteralConcatenation)expression);
   ...
   public SwitchStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.SwitchStatement statement)
   {
   ...
   public SynchronizedStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.SynchronizedStatement statement)
   {
   ...
   public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ThisReference reference)
   {
      ...
      else if (reference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference)reference);
      }
      else if (reference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedThisReference)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedThisReference)reference);
      }
      else
      {
   ...
   public ThrowStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ThrowStatement statement)
   {
   ...
   public BooleanLiteral convert(com.codenvy.eclipse.jdt.internal.compiler.ast.TrueLiteral expression)
   {
      final BooleanLiteral literal = new BooleanLiteral(this.ast);
   ...
   public TryStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.TryStatement statement)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Argument[] catchArguments = statement.catchArguments;
      if (catchArguments != null)
      {
         int catchArgumentsLength = catchArguments.length;
         com.codenvy.eclipse.jdt.internal.compiler.ast.Block[] catchBlocks = statement.catchBlocks;
   ...
   public ASTNode convert(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration)
   {
      int kind = com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration.kind(typeDeclaration.modifiers);
      switch (kind)
      {
         case com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration.ENUM_DECL:
            if (this.ast.apiLevel == AST.JLS2_INTERNAL)
            {
               return null;
            }
         ...
         case com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration.ANNOTATION_TYPE_DECL:
            if (this.ast.apiLevel == AST.JLS2_INTERNAL)
            {
               return null;
            }
      ...
      boolean isInterface = kind == com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration.INTERFACE_DECL;
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference[] superInterfaces = typeDeclaration.superInterfaces;
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter[] typeParameters = typeDeclaration.typeParameters;
      if (typeParameters != null)
      {
         switch (this.ast.apiLevel)
         {
   ...
   public TypeParameter convert(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeParameter typeParameter)
   {
   ...
   public Name convert(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeReference)
   {
      ...
      {
         // QualifiedName
         com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference qualifiedTypeReference = (com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference;
   ...
   public PrefixExpression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.UnaryExpression expression)
   {
      final PrefixExpression prefixExpression = new PrefixExpression(this.ast);
      if (this.resolveBindings)
      {
      ...
      switch ((expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >> com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT)
      {
         ...
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.MINUS:
            ...
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.NOT:
            prefixExpression.setOperator(PrefixExpression.Operator.NOT);
            break;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.TWIDDLE:
            prefixExpression.setOperator(PrefixExpression.Operator.COMPLEMENT);
      }
      return prefixExpression;
   }

   public WhileStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.WhileStatement statement)
   {
   ...
   public ImportDeclaration convertImport(com.codenvy.eclipse.jdt.internal.compiler.ast.ImportReference importReference)
   {
      final ImportDeclaration importDeclaration = new ImportDeclaration(this.ast);
      final boolean onDemand = (importReference.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0;
   ...
   public PackageDeclaration convertPackage(
      com.codenvy.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration compilationUnitDeclaration)
   {
      com.codenvy.eclipse.jdt.internal.compiler.ast.ImportReference importReference = compilationUnitDeclaration.currentPackage;
      ...
      packageDeclaration.setSourceRange(importReference.declarationSourceStart,
         importReference.declarationEnd - importReference.declarationSourceStart + 1);
      com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation[] annotations = importReference.annotations;
      if (annotations != null)
      {
         switch (this.ast.apiLevel)
         {
   ...
   public Expression convertToExpression(com.codenvy.eclipse.jdt.internal.compiler.ast.Statement statement)
   {
      if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)
      {
         return convert((com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)statement);
      }
      else
      {
         return null;
   ...
   protected FieldDeclaration convertToFieldDeclaration(
      com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration fieldDecl)
   {
   ...
   public ParenthesizedExpression convertToParenthesizedExpression(
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression)
   {
      ...
      int numberOfParenthesis = (expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) >> com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
      expression.bits &= ~com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK;
      expression.bits |= (numberOfParenthesis - 1) << com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
   ...
   protected VariableDeclarationExpression convertToVariableDeclarationExpression(
      com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration localDeclaration)
   {
   ...
   protected VariableDeclarationFragment convertToVariableDeclarationFragment(
      com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration localDeclaration)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.ast.Expression initialization = localDeclaration.initialization;
   ...
   public Type convertType(TypeReference typeReference)
   {
      ...
      if (typeReference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.SingleTypeReference)
      {
         // this is either an ArrayTypeReference or a SingleTypeReference
         char[] name = ((com.codenvy.eclipse.jdt.internal.compiler.ast.SingleTypeReference)typeReference).getTypeName()[0];
      ...
      else
      {
         if (typeReference instanceof ParameterizedQualifiedTypeReference)
         {
            ...
            switch (this.ast.apiLevel)
            {
               case AST.JLS2_INTERNAL:
               {
                  char[][] name = ((com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference).getTypeName();
         ...
         else if (typeReference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference)
         {
            char[][] name = ((com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference).getTypeName();
            int nameLength = name.length;
            long[] positions = ((com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference).sourcePositions;
            sourceStart = (int)(positions[0] >>> 32);
            length = (int)(positions[nameLength - 1] & 0xFFFFFFFF) - sourceStart + 1;
         ...
         {
            TypeReference[] typeReferences = ((com.codenvy.eclipse.jdt.internal.compiler.ast.UnionTypeReference)typeReference).typeReferences;
            switch (this.ast.apiLevel)
            {
               case AST.JLS2_INTERNAL:
               case AST.JLS3_INTERNAL:
   ...
   protected Statement createFakeEmptyStatement(com.codenvy.eclipse.jdt.internal.compiler.ast.Statement statement)
   {
      if (statement == null)
      {
         return null;
   ...
   protected InfixExpression.Operator getOperatorFor(int operatorID)
   {
      switch (operatorID)
      {
         ...
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.LESS_EQUAL:
            return InfixExpression.Operator.LESS_EQUALS;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.GREATER_EQUAL:
         ...
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.OR_OR:
            return InfixExpression.Operator.CONDITIONAL_OR;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.AND_AND:
         ...
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.GREATER:
            return InfixExpression.Operator.GREATER;
         case com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorIds.LESS:
   ...
   private BlockScope lookupScope(ASTNode node)
   {
      ...
      if (currentNode instanceof Initializer)
      {
         ...
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDecl = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)this.ast.getBindingResolver().getCorrespondingNode(
               currentNode);
      ...
      AbstractMethodDeclaration abstractMethodDeclaration = (AbstractMethodDeclaration)this.ast.getBindingResolver().getCorrespondingNode(
         currentNode);
      return abstractMethodDeclaration.scope;
   }

   protected void recordName(Name name, com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode compilerNode)
   {
      if (compilerNode != null)
      {
         recordNodes(name, compilerNode);
         if (compilerNode instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeRef = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)compilerNode;
   ...
   protected void recordNodes(ASTNode node, com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode oldASTNode)
   {
      this.ast.getBindingResolver().store(node, oldASTNode);
   }

   protected void recordNodes(com.codenvy.eclipse.jdt.internal.compiler.ast.Javadoc javadoc, TagElement tagElement)
   {
      ...
      while (fragments.hasNext())
      {
         ...
         if (node.getNodeType() == ASTNode.MEMBER_REF)
         {
            ...
            com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode compilerNode = javadoc.getNodeStartingAt(start);
            if (compilerNode != null)
            {
               recordNodes(name, compilerNode);
            ...
            {
               com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeRef = null;
               if (compilerNode instanceof JavadocFieldReference)
               {
                  com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression = ((JavadocFieldReference)compilerNode).receiver;
                  if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)
                  {
                     typeRef = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)expression;
                  }
               }
               else if (compilerNode instanceof JavadocMessageSend)
               {
                  com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression = ((JavadocMessageSend)compilerNode).receiver;
                  if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)
                  {
                     typeRef = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)expression;
                  }
         ...
         else if (node.getNodeType() == ASTNode.METHOD_REF)
         {
            ...
            {
               nextToken:
               while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF && token != TerminalTokens.TokenNameLPAREN)
               {
            ...
            if (compilerNode != null)
            {
               ...
               // get type ref
               com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeRef = null;
               if (compilerNode instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocAllocationExpression)
               {
                  typeRef = ((com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocAllocationExpression)compilerNode).type;
                  if (typeRef != null)
                  {
                     recordNodes(name, compilerNode);
                  }
               }
               else if (compilerNode instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocMessageSend)
               {
                  com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression = ((com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocMessageSend)compilerNode).receiver;
                  if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)
                  {
                     typeRef = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)expression;
                  }
            ...
            while (parameters.hasNext())
            {
               ...
               com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression = (com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)javadoc.getNodeStartingAt(
               ...
               if (expression != null)
               {
                  ...
                  if (expression instanceof JavadocArgumentExpression)
                  {
                     ...
                     com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeRef = argExpr.argument.type;
         ...
         {
            com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode compilerNode = javadoc.getNodeStartingAt(
    ...
    */
   private void trimWhiteSpacesAndComments(com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression)
   {
      int start = expression.sourceStart;
      int end = expression.sourceEnd;
      int token;
   ...
   protected void setModifiers(BodyDeclaration bodyDeclaration,
      com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation[] annotations, int modifiersEnd)
   {
         ...
         while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF)
         {
            ...
            switch (token)
            {
               ...
               case TerminalTokens.TokenNameAT:
                  ...
                  {
                     com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation annotation = annotations[indexInAnnotations++];
   ...
   protected void setModifiers(EnumDeclaration enumDeclaration,
      com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration enumDeclaration2)
   {
   ...
   protected void setModifiers(Initializer initializer,
      com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer oldInitializer)
   {
      switch (this.ast.apiLevel)
      {
         case AST.JLS2_INTERNAL:
   ...
   protected void setModifiers(SingleVariableDeclaration variableDecl, Argument argument)
   {
      switch (this.ast.apiLevel)
      {
         ...
         default:
            ...
            com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation[] annotations = argument.annotations;
            int indexInAnnotations = 0;
            try
            {
               int token;
   ...
   protected void setModifiers(SingleVariableDeclaration variableDecl, LocalDeclaration localDeclaration)
   {
      switch (this.ast.apiLevel)
      {
         ...
         default:
            ...
            com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation[] annotations = localDeclaration.annotations;
            int indexInAnnotations = 0;
            try
            {
               int token;
   ...
   protected QualifiedName setQualifiedNameNameAndSourceRanges(char[][] typeName, long[] positions,
      com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode node)
   {
      int length = typeName.length;
   ...
   protected void setTypeNameForAnnotation(com.codenvy.eclipse.jdt.internal.compiler.ast.Annotation compilerAnnotation,

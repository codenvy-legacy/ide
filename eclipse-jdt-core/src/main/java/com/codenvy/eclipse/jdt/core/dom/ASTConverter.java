...
class ASTConverter {
    ...
    protected void checkAndAddMultipleFieldDeclaration(com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration[] fields,
        ...
        if (fields[index] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer) {
            com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer oldInitializer =
                    (com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer)fields[index];
    ...
    protected void checkAndAddMultipleLocalDeclaration(com.codenvy.eclipse.jdt.internal.compiler.ast.Statement[] stmts,
        ...
        if (index > 0 && stmts[index - 1] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration) {
            com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration local1 =
                    (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)stmts[index - 1];
            com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration local2 =
    ...
    public ASTNode convert(boolean isInterface,
        ...
        if (isConstructor) {
            ...
            com.codenvy.eclipse.jdt.internal.compiler.ast.ConstructorDeclaration constructorDeclaration =
                    (com.codenvy.eclipse.jdt.internal.compiler.ast.ConstructorDeclaration)methodDeclaration;
            ...
            com.codenvy.eclipse.jdt.internal.compiler.ast.MethodDeclaration method =
                    (com.codenvy.eclipse.jdt.internal.compiler.ast.MethodDeclaration)methodDeclaration;
        ...
        if (closingPosition != -1) {
            ...
            if (block != null && (statements != null || explicitConstructorCall != null)) {
                if (explicitConstructorCall != null && explicitConstructorCall.accessMode !=
                                                       com.codenvy.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall
                                                               .ImplicitSuper) {
    ...
    public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.AND_AND_Expression expression) {
        ...
        final int expressionOperatorID = (expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                                         com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
        if (expression.left instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression &&
            ((expression.left.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)) {
            ...
            do {
                ...
                if ((((leftOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                      com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID &&
                     ((leftOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)) ||
                    ((rightOperand instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression &&
                      ((rightOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                       com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID) &&
                     ((rightOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))) {
            ...
            while (leftOperand instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression &&
                   ((leftOperand.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0));
    ...
    public TypeDeclaration convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode[] nodes) {
        ...
        for (int i = 0; i < nodesLength; i++) {
            ...
            if (node instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer) {
                com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer oldInitializer =
                        (com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer)node;
                Initializer initializer = new Initializer(this.ast);
                initializer.setBody(convert(oldInitializer.block));
                setModifiers(initializer, oldInitializer);
                initializer.setSourceRange(oldInitializer.declarationSourceStart,
                ...
                com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration =
                        (com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration)node;
                if (i > 0 && (nodes[i - 1] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration) &&
                    ((com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration)nodes[i - 1]).declarationSourceStart ==
                ...
                com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration =
                        (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)node;
    ...
    public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression expression) {
        ...
        int expressionOperatorID = (expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                                   com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
    ...
    public EnumConstantDeclaration convert(com.codenvy.eclipse.jdt.internal.compiler.ast.FieldDeclaration enumConstant) {
        ...
        if (initialization != null) {
            if (initialization instanceof QualifiedAllocationExpression) {
                com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration anonymousType =
            ...
            final com.codenvy.eclipse.jdt.internal.compiler.ast.Expression[] arguments =
                    ((com.codenvy.eclipse.jdt.internal.compiler.ast.AllocationExpression)initialization).arguments;
            if (arguments != null) {
    ...
    public Expression convert(com.codenvy.eclipse.jdt.internal.compiler.ast.EqualExpression expression) {
        ...
        int startPosition = leftExpression.getStartPosition();
        infixExpression.setSourceRange(startPosition, expression.sourceEnd - startPosition + 1);
        switch ((expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) {
    ...
    public ForStatement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.ForStatement statement) {
        ...
        if (initializations != null) {
            ...
            if (initializations[0] instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration) {
                com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration initialization =
                        (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)initializations[0];
                ...
                if (initializationsLength != 1) {
                    ...
                    int end = ((com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)initializations[initializationsLength -
    ...
    public Statement convert(com.codenvy.eclipse.jdt.internal.compiler.ast.Statement statement) {
        ...
        if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration) {
            com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration localDeclaration =
                    (com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration)statement;
        ...
        if (statement instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.Expression) {
            com.codenvy.eclipse.jdt.internal.compiler.ast.Expression statement2 =
                    (com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)statement;
    ...
    public Name convert(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeReference) {
        ...
        if (length > 1) {
            // QualifiedName
            com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference qualifiedTypeReference =
                    (com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference;
    ...
    public ParenthesizedExpression convertToParenthesizedExpression(
        ...
        int numberOfParenthesis = (expression.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) >>
                                  com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
        ...
        if (typeReference instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.SingleTypeReference) {
            ...
            if (typeReference instanceof ParameterizedQualifiedTypeReference) {
                ...
                TypeReference[] typeReferences =
                        ((com.codenvy.eclipse.jdt.internal.compiler.ast.UnionTypeReference)typeReference).typeReferences;
                switch (this.ast.apiLevel) {
                    case AST.JLS2_INTERNAL:
                    case AST.JLS3_INTERNAL:
                        // recovery
    ...
    private BlockScope lookupScope(ASTNode node) {
        ...
        while (currentNode != null && !(currentNode instanceof MethodDeclaration) && !(currentNode instanceof Initializer) &&
               !(currentNode instanceof FieldDeclaration) && !(currentNode instanceof AbstractTypeDeclaration)) {
        ...
        if (currentNode instanceof Initializer) {
            ...
            if (currentNode instanceof TypeDeclaration || currentNode instanceof EnumDeclaration ||
                ...
                com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDecl =
                        (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration)this.ast.getBindingResolver().getCorrespondingNode(
                                currentNode);
    ...
    protected void recordName(Name name, com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode compilerNode) {
        if (compilerNode != null) {
            ...
            if (compilerNode instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference) {
                com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference typeRef =
                        (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)compilerNode;
            ...
            if (node.getNodeType() == ASTNode.MEMBER_REF) {
                ...
                if (compilerNode != null) {
                    ...
                    if (compilerNode instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocAllocationExpression) {
                        ...
                        com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression =
                                ((com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocMessageSend)compilerNode).receiver;
                        if (expression instanceof com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference) {
                            typeRef = (com.codenvy.eclipse.jdt.internal.compiler.ast.TypeReference)expression;
                        }
                        recordNodes(name, compilerNode);
                ...
                while (parameters.hasNext()) {
                    ...
                    com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression =
                            (com.codenvy.eclipse.jdt.internal.compiler.ast.Expression)javadoc.getNodeStartingAt(

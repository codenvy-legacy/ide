...
public class ReorgUtils {
     ...
     *
     * @param elements
     *         the list with elements to check
    ...
    public static IJavaElement[] union(IJavaElement[] set1, IJavaElement[] set2) {
        List<IJavaElement> union = new ArrayList<IJavaElement>(
    ...
    public static void splitIntoJavaElementsAndResources(Object[] elements, List<? super IJavaElement> javaElementResult,

...
import com.codenvy.eclipse.jdt.internal.core.search.matching.ConstructorDeclarationPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.DeclarationOfAccessedFieldsPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.DeclarationOfReferencedMethodsPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.DeclarationOfReferencedTypesPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.JavaSearchPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.MatchLocator;
import com.codenvy.eclipse.jdt.internal.core.search.matching.MultiTypeDeclarationPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.QualifiedTypeDeclarationPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.SecondaryTypeDeclarationPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.TypeDeclarationPattern;
...
/**
 * Search basic engine. Public search engine (see {@link com.codenvy.eclipse.jdt.core.search.SearchEngine}
...
public class BasicSearchEngine {
    ...
    boolean match(char patternTypeSuffix, char[] patternPkg, int matchRulePkg, char[] patternTypeName, int matchRuleType, int typeKind,
        ...
        if (patternTypeName != null) {
            boolean isCamelCase =
                    (matchRuleType & (SearchPattern.R_CAMELCASE_MATCH | SearchPattern.R_CAMELCASE_SAME_PART_COUNT_MATCH)) != 0;
    ...
    public void search(SearchPattern pattern, SearchParticipant[] participants, IJavaSearchScope scope, SearchRequestor requestor,
        ...
        if (VERBOSE) {
            Util.verbose(
                    "BasicSearchEngine.search(SearchPattern, SearchParticipant[], IJavaSearchScope, SearchRequestor, " +
    ...
    public void searchAllConstructorDeclarations(
        ...
        final char NoSuffix =
                IIndexConstants.TYPE_SUFFIX; // Used as TYPE_SUFFIX has no effect in method #match(char, char[] , int, char[], int , int,
                // char[], char[])

        // Debug
        if (VERBOSE) {
            Util.verbose(
                    "BasicSearchEngine.searchAllConstructorDeclarations(char[], char[], int, IJavaSearchScope, " +
                    "IRestrictedAccessConstructorRequestor, int, IProgressMonitor)"); //$NON-NLS-1$
        ...
        IndexQueryRequestor searchRequestor = new IndexQueryRequestor() {
            public boolean acceptIndexMatch(String documentPath, SearchPattern indexRecord, SearchParticipant participant,
                ...
                if (access != null) {
                    ...
                    int pkgLength = (record.declaringPackageName == null || record.declaringPackageName.length == 0) ? 0 :
                    ...
                    if (workingCopy.isConsistent()) {
                        ...
                        for (int j = 0, allTypesLength = allTypes.length; j < allTypesLength; j++) {
                            ...
                            if (match(NoSuffix, packageName, pkgMatchRule, typeName, validatedTypeMatchRule, 0/*no kind*/,
                                      packageDeclaration, simpleName) && !type.isMember()) {
                                ...
                                for (int k = 0; k < methods.length; k++) {
                                    ...
                                    if (method.isConstructor()) {
                                        ...
                                        for (int l = 0; l < length; l++) {
                                            ...
                                            parameterTypes[l] =
                                                    Signature.toCharArray(Signature.getTypeErasure(stringParameterTypes[l]).toCharArray());
                                        }
                        ...
                        com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit unit =
                                (com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit)workingCopy;
                ...
                for (int i = 0; i < copiesLength; i++) {
                    ...
                    if (workingCopy.isConsistent()) {
                        ...
                        for (int j = 0, allTypesLength = allTypes.length; j < allTypesLength; j++) {
                            ...
                            if (match(typeSuffix, packageName, packageMatchRule, typeName, validatedTypeMatchRule, kind, packageDeclaration,
                                      simpleName)) {
                        ...
                        if (parsedUnit != null) {
                            ...
                            class AllTypeDeclarationsVisitor extends ASTVisitor {
                                ...
                                public boolean visit(TypeDeclaration memberTypeDeclaration, ClassScope classScope) {
                                    ...
                                    if (pattern.matchesDecodedKey(decodedPattern)) {
                                        nameRequestor
                                                .acceptType(memberTypeDeclaration.modifiers, packageDeclaration, memberTypeDeclaration.name,
     ...
     *      for detailed comment
     */
    public void searchDeclarationsOfSentMessages(IJavaElement enclosingElement, SearchRequestor requestor, IProgressMonitor monitor)
            throws JavaModelException {
        if (VERBOSE) {
            Util.verbose(

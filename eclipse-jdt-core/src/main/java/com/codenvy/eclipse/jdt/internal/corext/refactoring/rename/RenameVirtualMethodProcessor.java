...
public class RenameVirtualMethodProcessor extends RenameMethodProcessor {
        ...
        try {
            ...
            for (Iterator<IType> iter = types.iterator(); iter.hasNext(); ) {
                ...
                result.addAll(Arrays.asList(hierarchyDeclaresMethodName(new SubProgressMonitor(pm, 1),
                                                                        declaring.newTypeHierarchy(new SubProgressMonitor(pm, 1)), found,
                                                                        newName)));
            }
    ...
    private boolean isSpecialCase() throws CoreException {
        ...
        String[][] specialParamTypes =
                new String[][]{noParams, noParams, noParams, noParams, {"QObject;"}, {"Qjava.lang.Object;"}, noParams, noParams,
                               //$NON-NLS-2$ //$NON-NLS-1$

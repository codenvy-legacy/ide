...
import com.codenvy.eclipse.jdt.core.CompletionContext;
import com.codenvy.eclipse.jdt.core.CompletionFlags;
import com.codenvy.eclipse.jdt.core.CompletionProposal;
import com.codenvy.eclipse.jdt.core.CompletionRequestor;
...
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionNodeDetector;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionNodeFound;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnAnnotationOfType;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnArgumentName;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnBranchStatementLabel;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnClassLiteralAccess;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnExplicitConstructorCall;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnFieldName;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnFieldType;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnImportReference;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadoc;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadocAllocationExpression;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadocFieldReference;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadocMessageSend;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadocParamNameReference;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadocQualifiedTypeReference;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadocSingleTypeReference;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadocTag;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnJavadocTypeParamReference;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnKeyword;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnLocalName;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnMarkerAnnotationName;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnMemberAccess;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnMemberValueName;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnMessageSend;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnMessageSendName;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnMethodName;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnMethodReturnType;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnPackageReference;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnParameterizedQualifiedTypeReference;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnQualifiedAllocationExpression;
...
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnStringLiteral;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionParser;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionScanner;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.InvalidCursorLocation;
import com.codenvy.eclipse.jdt.internal.codeassist.impl.AssistParser;
import com.codenvy.eclipse.jdt.internal.codeassist.impl.Engine;
import com.codenvy.eclipse.jdt.internal.codeassist.impl.Keywords;
import com.codenvy.eclipse.jdt.internal.compiler.CompilationResult;
import com.codenvy.eclipse.jdt.internal.compiler.DefaultErrorHandlingPolicies;
import com.codenvy.eclipse.jdt.internal.compiler.ExtraFlags;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.Javadoc;
import com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocImplicitTypeReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocQualifiedTypeReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.JavadocSingleTypeReference;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.OperatorExpression;
...
import com.codenvy.eclipse.jdt.internal.compiler.env.INameEnvironment;
import com.codenvy.eclipse.jdt.internal.compiler.env.ISourceType;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.BaseTypeBinding;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.ImportBinding;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.LookupEnvironment;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.ParameterizedMethodBinding;
import com.codenvy.eclipse.jdt.internal.compiler.lookup.ParameterizedTypeBinding;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding;
...
import com.codenvy.eclipse.jdt.internal.compiler.parser.ScannerHelper;
import com.codenvy.eclipse.jdt.internal.compiler.parser.SourceTypeConverter;
...
import com.codenvy.eclipse.jdt.internal.compiler.problem.DefaultProblemFactory;
import com.codenvy.eclipse.jdt.internal.compiler.problem.ProblemReporter;
import com.codenvy.eclipse.jdt.internal.compiler.problem.ProblemSeverities;
import com.codenvy.eclipse.jdt.internal.compiler.util.HashtableOfObject;
import com.codenvy.eclipse.jdt.internal.compiler.util.ObjectVector;
import com.codenvy.eclipse.jdt.internal.compiler.util.SuffixConstants;
import com.codenvy.eclipse.jdt.internal.core.BasicCompilationUnit;
import com.codenvy.eclipse.jdt.internal.core.BinaryTypeConverter;
import com.codenvy.eclipse.jdt.internal.core.INamingRequestor;
import com.codenvy.eclipse.jdt.internal.core.InternalNamingConventions;
import com.codenvy.eclipse.jdt.internal.core.JavaModelManager;
import com.codenvy.eclipse.jdt.internal.core.SearchableEnvironment;
import com.codenvy.eclipse.jdt.internal.core.SourceMethod;
import com.codenvy.eclipse.jdt.internal.core.SourceMethodElementInfo;
import com.codenvy.eclipse.jdt.internal.core.SourceType;
import com.codenvy.eclipse.jdt.internal.core.SourceTypeElementInfo;
import com.codenvy.eclipse.jdt.internal.core.search.matching.JavaSearchNameEnvironment;
import com.codenvy.eclipse.jdt.internal.core.util.Messages;
...
public final class CompletionEngine
    ...
    public static char[] createMethodSignature(char[][] parameterPackageNames, char[][] parameterTypeNames, char[] returnPackagename,
                                               char[] returnTypeName) {
	...
	*/
    ...
    public void acceptUnresolvedName(char[] name) {
        ...
        if (!CompletionEngine.this.requestor.isIgnored(CompletionProposal.LOCAL_VARIABLE_REF)) {
            InternalCompletionProposal proposal = CompletionEngine.this
                    .createProposal(CompletionProposal.LOCAL_VARIABLE_REF, CompletionEngine.this.actualCompletionPosition);
                    ...
                    for (int i = 0, length = imports.length; i < length; i++) {
                        ...
                        if (importReference instanceof CompletionOnImportReference) {
                            ...
                            if (!this.requestor.isIgnored(CompletionProposal.KEYWORD)) {
                                ...
                                findKeywords(keyword.getToken(), keyword.getPossibleKeywords(), true, false,
    ...
    public void complete(IType type, char[] snippet, int position, char[][] localVariableTypeNames, char[][] localVariableNames,
        ...
        try {
            ...
            if (type instanceof SourceType) {
                ...
                typeDeclaration =
                        new BinaryTypeConverter(this.parser.problemReporter(), compilationResult, null/*no need to remember type names*/)
                                .buildTypeDeclaration(type, compilationUnit);
            }

            if (typeDeclaration != null) {
                // build AST from snippet
                Initializer fakeInitializer =
                        parseSnippeInitializer(snippet, position, localVariableTypeNames, localVariableNames, localVariableModifiers,
                                               isStatic);
        ...
        } catch (AbortCompilation e) { // ignore this exception for now since it typically means we cannot find java.lang.Object (added
        // with fix of 99629)
            if (DEBUG) {
                System.out.println("Exception caught by CompletionEngine:"); //$NON-NLS-1$
                e.printStackTrace(System.out);
    ...
    private void completionOnMarkerAnnotationName(ASTNode astNode, Binding qualifiedBinding, Scope scope) {
        ...
        if (fakeType.annotations[0] == annot) {
            // When the completion is inside a method body the annotation cannot be accuratly attached to the correct node by completion
            // recovery.
    ...
    private void completionOnParameterizedQualifiedTypeReference(ASTNode astNode, ASTNode astNodeParent, Binding qualifiedBinding,
                                                                 Scope scope) {
        if (!this.requestor.isIgnored(CompletionProposal.TYPE_REF)) {
        ...
        if (parent instanceof AbstractVariableDeclaration && !(parent instanceof TypeParameter)) {
            ...
            if (this.parser.enclosingNode instanceof AbstractVariableDeclaration ||
                ...
                if (this.parser.enclosingNode instanceof AbstractVariableDeclaration) {
                    ...
                    expected =
                            abstractVariableDeclaration.initialization != null ? abstractVariableDeclaration.initialization.expectedType()
                                                                               : null;
                } else {
...
//		}
    ...
    private void createMethod(MethodBinding method, char[][] parameterPackageNames, char[][] parameterTypeNames, char[][] parameterNames,
                              Scope scope, StringBuffer completion) {
        //// Modifiers
	 ...
	 */
    private void createTypeProposal(char[] packageName, char[] typeName, int modifiers, int accessibility, char[] completionName,
                                    int relevance) {
            ...
            if (!exactMatch) {
                if (!isIgnored(CompletionProposal.ANONYMOUS_CLASS_CONSTRUCTOR_INVOCATION, CompletionProposal.TYPE_REF)) {
                    ...
                    InternalCompletionProposal proposal =
                            createProposal(CompletionProposal.ANONYMOUS_CLASS_CONSTRUCTOR_INVOCATION, this.actualCompletionPosition);
    ...
    private char[] getResolvedSignature(char[][] parameterTypes, char[] fullyQualifiedTypeName, int parameterCount, Scope scope) {
        ...
        try {
            ...
            if (guessedType != null && guessedType.isValidBinding()) {
                // the erasure must be used because guessedType can be a RawTypeBinding (https://bugs.eclipse.org/bugs/show_bug
                // .cgi?id=276890)
...
//				boolean inlineTagStarted = javadocTag.completeInlineTagStarted();
            ...
            for (int i = 0; i < choices.length; i++)
                if (length <= choices[i].length
                    ...
                    if (!this.requestor.isIgnored(CompletionProposal.KEYWORD)) {
                        ...
                        proposal.setReplaceRange((canCompleteEmptyToken && (this.startPosition < 0)) ? 0 : this.startPosition - this.offset,
                                                 this.endPosition - this.offset);
                        proposal.setTokenRange((canCompleteEmptyToken && (this.tokenStart < 0)) ? 0 : this.tokenStart - this.offset,
     ...
     *
     * @param methods
     *         a resultant array of MethodBinding, whose names should match methodName. The calling client must ensure that this check is
     *         handled.
    ...
    private void findMemberTypes(
        ...
        for (int m = memberTypes.length; --m >= 0; ) {
            ...
            if (staticFieldsAndMethodOnly && this.insideQualifiedReference) relevance +=
                    R_NON_INHERITED; // This criterion doesn't concern types and is added to be balanced with field and method relevance.
                    ...
                    for (int i = 0, length = blockScope.subscopeCount; i < length; i++) {
                        ...
                        if (blockScope.subscopes[i] instanceof ClassScope) {
                            ...
                            if (!localType.isAnonymousType()) {
                                ...
                                relevance += computeRelevanceForQualification(false);
                                relevance +=
                                        computeRelevanceForRestrictions(IAccessRule.K_ACCESSIBLE); // no access restriction for nested type
    ...
    private void findTypesAndPackages(char[] token, Scope scope, boolean proposeBaseTypes, boolean proposeVoidType,
        ...
        if ((proposeType || proposeConstructor) && this.unitScope != null) {
            ...
            for (int i = 0, length = types.length; i < length; i++) {
                ...
                relevance += computeRelevanceForQualification(false);
                relevance +=
                        computeRelevanceForRestrictions(IAccessRule.K_ACCESSIBLE); // no access restriction for type in the current unit
            ...
            UnresolvedReferenceNameFinder.UnresolvedReferenceNameRequestor nameRequestor =
                    new UnresolvedReferenceNameFinder.UnresolvedReferenceNameRequestor() {
                        public void acceptName(char[] name) {
                            ...
                            relevance +=
                                    computeRelevanceForRestrictions(IAccessRule.K_ACCESSIBLE); // no access restriction for variable name

                            // accept result
                            CompletionEngine.this.noProposal = false;
                            if (!CompletionEngine.this.requestor.isIgnored(CompletionProposal.VARIABLE_DECLARATION)) {
                                InternalCompletionProposal proposal = CompletionEngine.this
                                        .createProposal(CompletionProposal.VARIABLE_DECLARATION,
        ...
        INamingRequestor namingRequestor = new INamingRequestor() {
            void accept(char[] name, int prefixAndSuffixRelevance, int reusedCharacters) {
                ...
                if (CharOperation.prefixEquals(t, name, false)) {
                    ...
                    if (!CompletionEngine.this.requestor.isIgnored(CompletionProposal.VARIABLE_DECLARATION)) {
                        InternalCompletionProposal proposal = CompletionEngine.this
                                .createProposal(CompletionProposal.VARIABLE_DECLARATION, CompletionEngine.this.actualCompletionPosition);
                        proposal.setSignature(getSignature(typeBinding));
                ...
                switch (currentScope.kind) {
                    ...
                    case Scope.BLOCK_SCOPE:
                        ...
                        for (int i = 0, length = blockScope.locals.length; i < length; i++) {
                            ...
                            relevance += computeRelevanceForQualification(false);
                            relevance +=
                                    computeRelevanceForRestrictions(IAccessRule.K_ACCESSIBLE); // no access restriction for local variable
    ...
    private Initializer parseSnippeInitializer(char[] snippet, int position, char[][] localVariableTypeNames, char[][] localVariableNames,
                                               int[] localVariableModifiers, boolean isStatic) {
    ...
    private void printDebug(CompletionProposal proposal, int tab, StringBuffer buffer) {
        ...
        buffer.append("{\n");//$NON-NLS-1$
        printDebugTab(tab, buffer);
        buffer.append("\tCompletion[").append(proposal.getCompletion() == null ? "null".toCharArray() : proposal.getCompletion())
              .append("]\n"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        printDebugTab(tab, buffer);
        buffer.append("\tDeclarationSignature[")
              .append(proposal.getDeclarationSignature() == null ? "null".toCharArray() : proposal.getDeclarationSignature())
              .append("]\n"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        printDebugTab(tab, buffer);
        buffer.append("\tDeclarationKey[")
              .append(proposal.getDeclarationKey() == null ? "null".toCharArray() : proposal.getDeclarationKey())
              .append("]\n"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        printDebugTab(tab, buffer);
        buffer.append("\tSignature[").append(proposal.getSignature() == null ? "null".toCharArray() : proposal.getSignature())
              .append("]\n"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        printDebugTab(tab, buffer);
        buffer.append("\tKey[").append(proposal.getKey() == null ? "null".toCharArray() : proposal.getKey())
              .append("]\n"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        printDebugTab(tab, buffer);
        buffer.append("\tName[").append(proposal.getName() == null ? "null".toCharArray() : proposal.getName())
              .append("]\n"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    private char[] substituteMethodTypeParameterName(char firstName, char startChar, char endChar, char[][] excludedNames,
                ...
                if (CharOperation.equals(typeParameterName, methodParameterName, false)) {
                    ...
                    if (methodParameterName.length == 1) {
                        if (ScannerHelper.isUpperCase(methodParameterName[0])) {
                            substitution = substituteMethodTypeParameterName(methodParameterName[0], 'A', 'Z', excludedNames,
                                                                             substituedParameterNames);
                        } else {
                            substitution = substituteMethodTypeParameterName(methodParameterName[0], 'a', 'z', excludedNames,
                                                                             substituedParameterNames);

...
class TypeBinding implements ITypeBinding
{
      ...
      else if (this.binding.isTypeVariable())
      {
         ...
         switch (declaring.kind())
         {
            case com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding.METHOD:
               ...
               break;
            default:
               com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = (com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)declaring;
   ...
   public synchronized IMethodBinding[] getDeclaredMethods()
   {
      ...
      try
      {
         ...
         {
            ReferenceBinding referenceBinding = (ReferenceBinding)this.binding;
            com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding[] internalMethods = referenceBinding.availableMethods(); // be resilient
   ...
   public boolean isFromSource()
   {
      ...
      else if (isTypeVariable())
      {
         ...
         {
            final com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = (com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)declaringElement;

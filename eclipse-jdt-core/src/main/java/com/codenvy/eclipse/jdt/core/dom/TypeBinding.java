...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.RawTypeBinding;
...
class TypeBinding implements ITypeBinding {
    private static final StringLiteral EXPRESSION = new com.codenvy.eclipse.jdt.internal.compiler.ast.StringLiteral(0, 0);
    ...
    public TypeBinding(BindingResolver resolver, com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding binding) {
    ...
    public IAnnotationBinding[] getAnnotations() {
        ...
        com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding refType = null;
        if (this.binding instanceof ParameterizedTypeBinding) {
            ...
            refType = (com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding)this.binding;
        }
        if (refType != null) {
            com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations = refType.getAnnotations();
            int length = internalAnnotations == null ? 0 : internalAnnotations.length;
            if (length != 0) {
                IAnnotationBinding[] tempAnnotations = new IAnnotationBinding[length];
                int convertedAnnotationCount = 0;
                for (int i = 0; i < length; i++) {
                    com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding internalAnnotation = internalAnnotations[i];
    ...
    public String getBinaryName() {
        if (this.binding.isCapture()) {
            ...
            com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding declaring = typeVariableBinding.declaringElement;
            StringBuffer binaryName = new StringBuffer();
            switch (declaring.kind()) {
                case com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding.METHOD:
                    ...
                    binaryName.append(CharOperation.replaceOnCopy(constantPoolName, '/', '.')).append('$').append(
                            methodBinding.signature()).append('$').append(typeVariableBinding.sourceName);
                    break;
                default:
                    com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding =
                            (com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)declaring;
    ...
    public synchronized IVariableBinding[] getDeclaredFields() {
        ...
        } catch (RuntimeException e) {         /* in case a method cannot be resolvable due to missing jars on the classpath
          * see https://bugs.eclipse.org/bugs/show_bug.cgi?id=57871
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=63550
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
            com.codenvy.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared fields"); //$NON-NLS-1$
        }
        return this.fields = NO_VARIABLE_BINDINGS;
    }
    ...
    public synchronized IMethodBinding[] getDeclaredMethods() {
        ...
        try {
            if (isClass() || isInterface() || isEnum()) {
                ReferenceBinding referenceBinding = (ReferenceBinding)this.binding;
                com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding[] internalMethods =
                ...
                if (length != 0) {
                    ...
                    for (int i = 0; i < length; i++) {
                        com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding = internalMethods[i];
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
            com.codenvy.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared methods"); //$NON-NLS-1$
        }
        return this.methods = NO_METHOD_BINDINGS;
    }
        ...
        if (this.binding instanceof LocalTypeBinding) {
            ...
            if (methodBinding != null) {
                try {
					 ...
					 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
					 */
                    com.codenvy.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring method"); //$NON-NLS-1$
                }
            }
        } else if (this.binding.isTypeVariable()) {
            TypeVariableBinding typeVariableBinding = (TypeVariableBinding)this.binding;
        ...
        if (isClass() || isInterface() || isEnum()) {
            ...
            if (referenceBinding.isNestedType()) {
                try {
					 ...
					 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
					 */
                    com.codenvy.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring class"); //$NON-NLS-1$
                }
            }
        } else if (this.binding.isTypeVariable()) {
            TypeVariableBinding typeVariableBinding = (TypeVariableBinding)this.binding;
            Binding declaringElement = typeVariableBinding.isCapture() ? ((CaptureBinding)typeVariableBinding).sourceType
    ...
    public synchronized ITypeBinding[] getInterfaces() {
        ...
        try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
            com.codenvy.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve interfaces"); //$NON-NLS-1$
        }
        ...
        if (isRecovered()) {
            ...
            if (packageBinding != null) {
                ...
                if (javaElement != null && javaElement.getElementType() == IJavaElement.PACKAGE_FRAGMENT) {
                    ...
                    return ((PackageFragment)javaElement).getCompilationUnit(
                            new String(this.binding.sourceName()) + SuffixConstants.SUFFIX_STRING_java).getType(this.getName());
                }
            }
            return null;
        }
    ...
    private JavaElement getUnresolvedJavaElement(com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding) {
        ...
        if (this.resolver instanceof DefaultBindingResolver) {
            ...
            return com.codenvy.eclipse.jdt.internal.core.util.Util.getUnresolvedJavaElement(typeBinding,
    ...
    /** @see com.codenvy.eclipse.jdt.core.dom.ITypeBinding#getQualifiedName() */
    ...
    public synchronized ITypeBinding getSuperclass() {
        ...
        try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
            com.codenvy.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve superclass"); //$NON-NLS-1$
    ...
    public ITypeBinding[] getTypeArguments() {
        ...
        if (this.binding.isParameterizedTypeWithActualArguments()) {
            ParameterizedTypeBinding parameterizedTypeBinding = (ParameterizedTypeBinding)this.binding;
            final com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding[] arguments = parameterizedTypeBinding.arguments;
    ...
    public ITypeBinding[] getTypeBounds() {
        ...
        if (this.binding instanceof TypeVariableBinding) {
            ...
            com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding firstClassOrArrayBound = typeVariableBinding.firstBound;
            int boundsLength = 0;
    ...
    public boolean isAssignmentCompatible(ITypeBinding type) {
        try {
            ...
            return this.binding.isCompatibleWith(other.binding) || scope.isBoxingCompatibleWith(this.binding,
                                                                                                other.binding);
    ...
    public boolean isCastCompatible(ITypeBinding type) {
        try {
            ...
            com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding expressionType = ((TypeBinding)type).binding;
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding otherBinding = ((TypeBinding)other).binding;
        // check return type
    ...
    public boolean isFromSource() {
        if (isClass() || isInterface() || isEnum()) {
            ...
            if (referenceBinding.isRawType()) {
                ...
                com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding erasure = parameterizedTypeBinding.erasure();
            ...
            if (declaringElement instanceof MethodBinding) {
                ...
                final com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding =
                        (com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)declaringElement;
                if (typeBinding instanceof ReferenceBinding) {
                    ...
                    final com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding leafComponentType = arrayBinding.leafComponentType;
    ...
    public boolean isNullType() {
        return this.binding == com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding.NULL;
    }

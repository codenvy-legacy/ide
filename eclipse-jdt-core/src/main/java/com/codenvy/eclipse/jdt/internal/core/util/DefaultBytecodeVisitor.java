...
import com.codenvy.eclipse.jdt.core.util.IBytecodeVisitor;
...
import com.codenvy.eclipse.jdt.core.util.IOpcodeMnemonics;
import com.codenvy.eclipse.jdt.core.util.OpcodeStringValues;
...
public class DefaultBytecodeVisitor implements IBytecodeVisitor {
    ...
    public void _aload_0(int pc) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD_0],
    ...
    public void _aload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD_1],
    ...
    public void _aload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD_2],
    ...
    public void _aload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD_3],
    ...
    public void _aload(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ALOAD],
    ...
    public void _anewarray(int pc, int index, IConstantPoolEntry constantClass) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_anewarray,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ANEWARRAY], Integer.toString(
                                                 index), returnConstantClassName(constantClass)}));
        writeNewLine();
    }
    ...
    public void _astore_0(int pc) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ASTORE_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _astore_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ASTORE_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    private String getLocalVariableName(int pc, int index, boolean showIndex) {
        ...
        if (this.parameterNames != null) {
            ...
            if (index != 0) {
                ...
                int i = 0;
                loop:
                for (int max = this.argumentSizes.length; i < max; i++) {
    ...
    public void _astore_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ASTORE_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _astore_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ASTORE_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _astore(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ASTORE],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _bipush(int pc, byte _byte) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.BIPUSH]).append(
                Messages.disassembler_space).append(_byte);
        writeNewLine();
    }
    ...
    public void _checkcast(int pc, int index, IConstantPoolEntry constantClass) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_checkcast,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.CHECKCAST], Integer.toString(
                                                 index), returnConstantClassName(constantClass)}));
        writeNewLine();
    }
    ...
    public void _dload_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _dload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    public void _dload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _dload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _dload(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DLOAD],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _dstore_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DSTORE_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _dstore_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DSTORE_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    public void _dstore_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DSTORE_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _dstore_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DSTORE_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _dstore(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.DSTORE],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _fload_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _fload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    public void _fload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _fload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _fload(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FLOAD],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _fstore_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FSTORE_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _fstore_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FSTORE_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    public void _fstore_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FSTORE_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _fstore_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FSTORE_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _fstore(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.FSTORE],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _getfield(int pc, int index, IConstantPoolEntry constantFieldref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_getfield,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.GETFIELD], Integer.toString(
                                                 index), returnDeclaringClassName(constantFieldref), new String(
                                                 constantFieldref.getFieldName()), returnClassName(
                                                 Signature.toCharArray(constantFieldref.getFieldDescriptor()))}));
        writeNewLine();
    }
    ...
    public void _getstatic(int pc, int index, IConstantPoolEntry constantFieldref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_getstatic,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.GETSTATIC], Integer.toString(
                                                 index), returnDeclaringClassName(constantFieldref), new String(
                                                 constantFieldref.getFieldName()), returnClassName(
                                                 Signature.toCharArray(constantFieldref.getFieldDescriptor()))}));
        writeNewLine();
    ...
    public void _goto_w(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.GOTO_W]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _goto(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.GOTO]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _if_acmpeq(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IF_ACMPEQ]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _if_acmpne(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IF_ACMPNE]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _if_icmpeq(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IF_ICMPEQ]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _if_icmpge(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IF_ICMPGE]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _if_icmpgt(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IF_ICMPGT]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _if_icmple(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IF_ICMPLE]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _if_icmplt(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IF_ICMPLT]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _if_icmpne(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IF_ICMPNE]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _ifeq(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IFEQ]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _ifge(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IFGE]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _ifgt(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IFGT]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _ifle(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IFLE]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _iflt(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IFLT]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _ifne(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IFNE]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _ifnonnull(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IFNONNULL]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _ifnull(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IFNULL]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _iinc(int pc, int index, int _const) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_iinc,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.IINC], Integer.toString(
                                                 index), Integer.toString(_const), getLocalVariableName(pc, index, false)}));
        writeNewLine();
    }
    ...
    public void _iload_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _iload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    public void _iload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _iload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _iload(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ILOAD],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _instanceof(int pc, int index, IConstantPoolEntry constantClass) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_instanceof,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.INSTANCEOF], Integer.toString(
                                                 index), returnConstantClassName(constantClass)}));
        writeNewLine();
    }
    ...
    public void _invokedynamic(int pc, int index, IConstantPoolEntry nameEntry, IConstantPoolEntry descriptorEntry) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokedynamic,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.INVOKEDYNAMIC], Integer.toString(
                                                 index), Util.toString(null, nameEntry.getUtf8Value(), descriptorEntry.getUtf8Value(), true,
                                                                       isCompact())}));
        writeNewLine();
    }
    ...
    public void _invokedynamic(int pc, int index, IConstantPoolEntry invokeDynamicEntry) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokedynamic,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.INVOKEDYNAMIC], Integer.toString(
                                                 index), Integer.toString(entry.getBootstrapMethodAttributeIndex()), Util.toString(null,
                                                                                                                                   entry
    ...
    public void _invokeinterface(int pc, int index, byte nargs, IConstantPoolEntry constantInterfaceMethodref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokeinterface,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.INVOKEINTERFACE], Integer.toString(
                                                 index), Integer.toString(nargs), Util.toString(constantInterfaceMethodref.getClassName(),
    ...
    public void _invokespecial(int pc, int index, IConstantPoolEntry constantMethodref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokespecial,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.INVOKESPECIAL], Integer.toString(
                                                 index), signature}));
        writeNewLine();
    }
    ...
    public void _invokestatic(int pc, int index, IConstantPoolEntry constantMethodref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokestatic,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.INVOKESTATIC], Integer.toString(
                                                 index), signature}));
        writeNewLine();
    }
    ...
    public void _invokevirtual(int pc, int index, IConstantPoolEntry constantMethodref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_invokevirtual,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.INVOKEVIRTUAL], Integer.toString(
                                                 index), signature}));
        writeNewLine();
    }
    ...
    public void _istore_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ISTORE_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _istore_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ISTORE_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    public void _istore_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ISTORE_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _istore_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ISTORE_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _istore(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.ISTORE],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _jsr_w(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.JSR_W]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
    ...
    public void _jsr(int pc, int branchOffset) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.JSR]).append(
                Messages.disassembler_space).append(branchOffset + pc);
        writeNewLine();
    }
        ...
        switch (constantPoolEntry.getKind()) {
            case IConstantPoolConstant.CONSTANT_Float:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_float,
                                                 new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC_W], Integer.toString(
                                                         index), Float.toString(constantPoolEntry.getFloatValue())}));
                break;
            case IConstantPoolConstant.CONSTANT_Integer:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_integer,
                                                 new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC_W], Integer.toString(
                                                         index), Integer.toString(constantPoolEntry.getIntegerValue())}));
                break;
            case IConstantPoolConstant.CONSTANT_String:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_string,
                                                 new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC_W], Integer.toString(
                                                         index), Disassembler.escapeString(constantPoolEntry.getStringValue())}));
                break;
            case IConstantPoolConstant.CONSTANT_Class:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_class,
                                                 new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC_W], Integer.toString(
                                                         index), returnConstantClassName(constantPoolEntry)}));
        }
        writeNewLine();
    }
    ...
    public void _ldc(int pc, int index, IConstantPoolEntry constantPoolEntry) {
        ...
        switch (constantPoolEntry.getKind()) {
            case IConstantPoolConstant.CONSTANT_Float:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_float,
                                                 new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC], Integer.toString(
                                                         index), Float.toString(constantPoolEntry.getFloatValue())}));
                break;
            case IConstantPoolConstant.CONSTANT_Integer:
                this.buffer.append(Messages.bind(Messages.classformat_ldc_w_integer,
        ...
        switch (constantPoolEntry.getKind()) {
            case IConstantPoolConstant.CONSTANT_Long:
                this.buffer.append(Messages.bind(Messages.classformat_ldc2_w_long,
                                                 new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC2_W], Integer.toString(
                                                         index), Long.toString(constantPoolEntry.getLongValue())}));
                break;
            case IConstantPoolConstant.CONSTANT_Double:
                this.buffer.append(Messages.bind(Messages.classformat_ldc2_w_double,
                                                 new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LDC2_W], Integer.toString(
                                                         index), Double.toString(constantPoolEntry.getDoubleValue())}));
        }
        writeNewLine();
    }
    ...
    public void _lload_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _lload_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    public void _lload_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _lload_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _lload(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_load,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LLOAD],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _lookupswitch(int pc, int defaultoffset, int npairs, int[][] offset_pairs) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LOOKUPSWITCH]).append(
                " default: ") //$NON-NLS-1$
    ...
    public void _lstore_0(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LSTORE_0],
                                                      getLocalVariableName(pc, 0)}));
        writeNewLine();
    }
    ...
    public void _lstore_1(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LSTORE_1],
                                                      getLocalVariableName(pc, 1)}));
        writeNewLine();
    }
    ...
    public void _lstore_2(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LSTORE_2],
                                                      getLocalVariableName(pc, 2)}));
        writeNewLine();
    }
    ...
    public void _lstore_3(int pc) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LSTORE_3],
                                                      getLocalVariableName(pc, 3)}));
        writeNewLine();
    }
    ...
    public void _lstore(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(Messages.bind(Messages.classformat_store,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.LSTORE],
                                                      getLocalVariableName(pc, index,
                                                                           true)}));
        writeNewLine();
    }
    ...
    public void _multianewarray(int pc, int index, int dimensions, IConstantPoolEntry constantClass) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_multianewarray,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.MULTIANEWARRAY], Integer.toString(
                                                 index), returnConstantClassName(constantClass)}));
        writeNewLine();
    }
    ...
    public void _new(int pc, int index, IConstantPoolEntry constantClass) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_new,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEW], Integer.toString(
                                                 index), returnConstantClassName(constantClass)}));
        writeNewLine();
    }
        ...
        switch (atype) {
            case T_BOOLEAN:
                this.buffer.append(Messages.bind(Messages.classformat_newarray_boolean,
                                                 new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.NEWARRAY],
    ...
    public void _putfield(int pc, int index, IConstantPoolEntry constantFieldref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_putfield,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.PUTFIELD], Integer.toString(
                                                 index), returnDeclaringClassName(constantFieldref), new String(
                                                 constantFieldref.getFieldName()), returnClassName(
                                                 Signature.toCharArray(constantFieldref.getFieldDescriptor()))}));
        writeNewLine();
    ...
    public void _putstatic(int pc, int index, IConstantPoolEntry constantFieldref) {
        ...
        this.buffer.append(Messages.bind(Messages.classformat_putstatic,
                                         new String[]{OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.PUTSTATIC], Integer.toString(
                                                 index), returnDeclaringClassName(constantFieldref), new String(
                                                 constantFieldref.getFieldName()), returnClassName(
                                                 Signature.toCharArray(constantFieldref.getFieldDescriptor()))}));
        writeNewLine();
    ...
    public void _ret(int pc, int index) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.RET]).append(
                Messages.disassembler_space).append(index);
        writeNewLine();
    }
    ...
    public void _sipush(int pc, short value) {
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.SIPUSH]).append(
                Messages.disassembler_space).append(value);
        writeNewLine();
    }
    ...
    public void _tableswitch(int pc, int defaultoffset, int low, int high, int[] jump_offsets) {
        ...
        dumpPcNumber(pc);
        this.buffer.append(OpcodeStringValues.BYTECODE_NAMES[IOpcodeMnemonics.TABLESWITCH]).append(
                " default: ") //$NON-NLS-1$
                .append(defaultoffset + pc);
        writeNewLine();
    ...
    private String returnMethodSignature(IConstantPoolEntry constantMethodref) {
        ...
        final char[] signature = Util.toString(constantMethodref.getClassName(), constantMethodref.getMethodName(),
                                               methodDescriptor, true, isCompact()).toCharArray();

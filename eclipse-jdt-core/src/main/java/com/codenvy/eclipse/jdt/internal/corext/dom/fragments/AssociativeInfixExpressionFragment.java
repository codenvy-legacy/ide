...
class AssociativeInfixExpressionFragment extends ASTFragment implements IExpressionFragment {
    ...
    private static ISourceRange getRangeOfOperands(List<Expression> operands) {
        ...
        return new SourceRange(first.getStartPosition(),
    ...
    private static boolean isOperatorAssociative(InfixExpression.Operator operator) {
        return operator == InfixExpression.Operator.PLUS || operator == InfixExpression.Operator.TIMES ||
               operator == InfixExpression.Operator.XOR || operator == InfixExpression.Operator.OR ||
               operator == InfixExpression.Operator.AND || operator == InfixExpression.Operator.CONDITIONAL_OR ||
    ...
    public Expression createCopyTarget(ASTRewrite rewrite,
                                       boolean removeSurroundingParenthesis) throws JavaModelException {

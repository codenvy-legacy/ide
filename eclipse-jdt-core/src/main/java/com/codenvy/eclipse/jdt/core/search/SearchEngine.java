...
import com.codenvy.eclipse.jdt.internal.core.search.TypeNameRequestorWrapper;
...
public class SearchEngine {
    ...
    static class ResultCollectorAdapter extends SearchRequestor {
        ...
        /** @see com.codenvy.eclipse.jdt.core.search.SearchRequestor#acceptSearchMatch(com.codenvy.eclipse.jdt.core.search.SearchMatch) */
        ...
        /** @see com.codenvy.eclipse.jdt.core.search.SearchRequestor#beginReporting() */
        public void beginReporting() {
            this.resultCollector.aboutToStart();
        }

        /** @see com.codenvy.eclipse.jdt.core.search.SearchRequestor#endReporting() */
     ...
     *         the owner of the working copies that take precedence over their original compilation units
     * @since 3.0
     */
     ...
     *         </ul>
     * @since 3.0
     * @deprecated Use {@link #searchAllTypeNames(char[], char[], int, int, IJavaSearchScope, TypeNameRequestor, int, IProgressMonitor)}
     *             instead
     */
    public void searchAllTypeNames(
            final char[] packageName,
     ...
     *         <li>the classpath is incorrectly set</li>
     *         </ul>
     * @deprecated Use {@link #searchAllTypeNames(char[], char[], int, int, IJavaSearchScope, ITypeNameRequestor, int, IProgressMonitor)}
     *             instead
     */
    public void searchAllTypeNames(

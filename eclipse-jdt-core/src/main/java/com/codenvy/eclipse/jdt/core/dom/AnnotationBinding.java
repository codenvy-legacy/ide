...
class AnnotationBinding implements IAnnotationBinding
{
   ...
   private com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding binding;

   private BindingResolver bindingResolver;

   private String key;

   AnnotationBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding annotation, BindingResolver resolver)
   {
      if (annotation == null)
      {
   ...
   public IMemberValuePairBinding[] getAllMemberValuePairs()
   {
      ...
      for (int i = 0; i < methodLength; i++)
      {
         ...
         allPairs[i] = pair == null ? new DefaultValuePairBinding(methods[i],
            this.bindingResolver) : (IMemberValuePairBinding)pair;
      }
      return allPairs;
   }
   ...
   public IJavaElement getJavaElement()
   {
      ...
      switch (parent.getNodeType())
      {
         ...
         case ASTNode.FIELD_DECLARATION:
            VariableDeclarationFragment fragment = (VariableDeclarationFragment)((FieldDeclaration)parent).fragments().get(
               0);
   ...
   private String getRecipientKey()
   {
      ...
      switch (recipient.getNodeType())
      {
         ...
         case ASTNode.FIELD_DECLARATION:
            VariableDeclarationFragment fragment = (VariableDeclarationFragment)((FieldDeclaration)recipient).fragments().get(
               0);

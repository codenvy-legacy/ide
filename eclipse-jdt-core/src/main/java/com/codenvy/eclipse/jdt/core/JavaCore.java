...
public final class JavaCore
{
   ...
   /**
    * @since 2.0
    * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_ANONYMOUS_TYPE_DECLARATION},
    *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_BLOCK} ,
    *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_CONSTRUCTOR_DECLARATION},
    *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_METHOD_DECLARATION},
    *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_SWITCH},
    *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_TYPE_DECLARATION} instead.
    */
   public static final String FORMATTER_NEWLINE_OPENING_BRACE = PLUGIN_ID + ".formatter.newline.openingBrace"; //$NON-NLS-1$

   /**
    * @since 2.0
    * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_INSERT_NEW_LINE_BEFORE_CATCH_IN_TRY_STATEMENT},
    *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_INSERT_NEW_LINE_BEFORE_ELSE_IN_IF_STATEMENT},
    *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_INSERT_NEW_LINE_BEFORE_FINALLY_IN_TRY_STATEMENT},
    *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_INSERT_NEW_LINE_BEFORE_WHILE_IN_DO_STATEMENT} instead.
    */
   ...
   /**
    * @since 2.0
    * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_INSERT_NEW_LINE_IN_EMPTY_BLOCK} instead.
    */
   public static final String FORMATTER_NEWLINE_EMPTY_BLOCK = PLUGIN_ID + ".formatter.newline.emptyBlock"; //$NON-NLS-1$

   /**
    * @since 2.0
    * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_NUMBER_OF_EMPTY_LINES_TO_PRESERVE} instead.
    */
   ...
   /**
    * @since 2.0
    * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_INSERT_SPACE_BEFORE_ASSIGNMENT_OPERATOR} instead.
    */
   ...
   /**
    * @since 2.1
    * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_INSERT_SPACE_AFTER_CLOSING_PAREN_IN_CAST} instead.
    */
...
//      }
    ...
    * @param element the Java element for which the marker needs to be configured
    * @throws CoreException if the <code>IMarker.setAttribute</code> on the marker fails
    */
    ...
    * @throws JavaModelException if an exception occurred while resolving the container, or if the resolved container
    ...
    * @throws IllegalArgumentException if the given region is <code>null</code>
    * @since 3.3
    */
   ...
   public static void initializeAfterLoad(IProgressMonitor monitor) throws CoreException
   {
      try
      {
         ...
         try
         {
            ...
            if (manager.forceBatchInitializations(true/*initAfterLoad*/))
    ...
    * @throws CoreException if the <code>IMarker.getAttribute</code> on the marker fails
    */
    ...
    * @throws CoreException if the  <code>IMarkerDelta.getAttribute</code> on the marker delta fails
    */
    ...
    * @throws JavaModelException       if an element in the region does not exist or if an
    *                                  exception occurs while accessing its corresponding resource
    * @throws IllegalArgumentException if region is <code>null</code>
    * @since 3.1
    */

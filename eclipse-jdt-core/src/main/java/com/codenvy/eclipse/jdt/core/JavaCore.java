...
import com.codenvy.eclipse.core.resources.IMarkerDelta;
...
import com.codenvy.eclipse.jdt.core.search.TypeNameRequestor;
...
import com.codenvy.eclipse.jdt.internal.core.BatchOperation;
import com.codenvy.eclipse.jdt.internal.core.BufferFactoryWrapper;
import com.codenvy.eclipse.jdt.internal.core.BufferManager;
import com.codenvy.eclipse.jdt.internal.core.ClasspathAccessRule;
import com.codenvy.eclipse.jdt.internal.core.ClasspathAttribute;
import com.codenvy.eclipse.jdt.internal.core.ClasspathEntry;
import com.codenvy.eclipse.jdt.internal.core.ClasspathValidation;
import com.codenvy.eclipse.jdt.internal.core.CreateTypeHierarchyOperation;
import com.codenvy.eclipse.jdt.internal.core.DefaultWorkingCopyOwner;
import com.codenvy.eclipse.jdt.internal.core.ExternalFoldersManager;
import com.codenvy.eclipse.jdt.internal.core.JavaCorePreferenceInitializer;
import com.codenvy.eclipse.jdt.internal.core.JavaModel;
import com.codenvy.eclipse.jdt.internal.core.JavaModelManager;
import com.codenvy.eclipse.jdt.internal.core.JavaProject;
import com.codenvy.eclipse.jdt.internal.core.Region;
import com.codenvy.eclipse.jdt.internal.core.SetContainerOperation;
import com.codenvy.eclipse.jdt.internal.core.SetVariablesOperation;
import com.codenvy.eclipse.jdt.internal.core.builder.JavaBuilder;
import com.codenvy.eclipse.jdt.internal.core.builder.State;
import com.codenvy.eclipse.jdt.internal.core.util.MementoTokenizer;
...
public final class JavaCore {
     ...
     * to toggle compliance mode to <code>"1.5"</code>, <code>"1.6"</code> target requires to toggle compliance mode to <code>"1.6"</code>
     * and
     * <code>"1.7"</code> target requires to toggle compliance mode to <code>"1.7"</code>.
     * <code>"cldc1.1"</code> requires the source version to be <code>"1.3"</code> and the compliance version to be <code>"1.4"</code> or
     * lower.
     * <dl>
    ...
    public static final String COMPILER_PB_OVERRIDING_PACKAGE_DEFAULT_METHOD =
            PLUGIN_ID + ".compiler.problem.overridingPackageDefaultMethod"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_UNUSED_PARAMETER_WHEN_IMPLEMENTING_ABSTRACT =
            PLUGIN_ID + ".compiler.problem.unusedParameterWhenImplementingAbstract"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_UNUSED_PARAMETER_WHEN_OVERRIDING_CONCRETE =
            PLUGIN_ID + ".compiler.problem.unusedParameterWhenOverridingConcrete"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_UNUSED_PARAMETER_INCLUDE_DOC_COMMENT_REFERENCE =
            PLUGIN_ID + ".compiler.problem.unusedParameterIncludeDocCommentReference"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_UNUSED_TYPE_ARGUMENTS_FOR_METHOD_INVOCATION =
            PLUGIN_ID + ".compiler.problem.unusedTypeArgumentsForMethodInvocation"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_INCOMPATIBLE_NON_INHERITED_INTERFACE_METHOD =
            PLUGIN_ID + ".compiler.problem.incompatibleNonInheritedInterfaceMethod"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_POSSIBLE_ACCIDENTAL_BOOLEAN_ASSIGNMENT =
            PLUGIN_ID + ".compiler.problem.possibleAccidentalBooleanAssignment"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_UNUSED_DECLARED_THROWN_EXCEPTION_WHEN_OVERRIDING =
            PLUGIN_ID + ".compiler.problem.unusedDeclaredThrownExceptionWhenOverriding"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_UNUSED_DECLARED_THROWN_EXCEPTION_INCLUDE_DOC_COMMENT_REFERENCE =
            PLUGIN_ID + ".compiler.problem.unusedDeclaredThrownExceptionIncludeDocCommentReference"; //$NON-NLS-1$
     ...
     * <dl>
     * <dt>Option id:</dt><dd><code>"org.eclipse.jdt.core.compiler.problem
     * .unusedDeclaredThrownExceptionExemptExceptionAndThrowable"</code></dd>
     * <dt>Possible values:</dt><dd><code>{ "enabled", "disabled" }</code></dd>
     * <dt>Default:</dt><dd><code>"enabled"</code></dd>
     * </dl>
     *
    ...
    public static final String COMPILER_PB_UNUSED_DECLARED_THROWN_EXCEPTION_EXEMPT_EXCEPTION_AND_THROWABLE =
            PLUGIN_ID + ".compiler.problem.unusedDeclaredThrownExceptionExemptExceptionAndThrowable"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_UNAVOIDABLE_GENERIC_TYPE_PROBLEMS =
            PLUGIN_ID + ".compiler.problem.unavoidableGenericTypeProblems"; //$NON-NLS-1$
     ...
     * <dl>
     * <dt>Option id:</dt><dd><code>"org.eclipse.jdt.core.compiler.problem
     * .missingOverrideAnnotationForInterfaceMethodImplementation"</code></dd>
     * <dt>Possible values:</dt><dd><code>{ "enabled", "disabled" }</code></dd>
     * <dt>Default:</dt><dd><code>"enabled"</code></dd>
     * </dl>
     *
    ...
    public static final String COMPILER_PB_MISSING_OVERRIDE_ANNOTATION_FOR_INTERFACE_METHOD_IMPLEMENTATION =
            PLUGIN_ID + ".compiler.problem.missingOverrideAnnotationForInterfaceMethodImplementation"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_MISSING_ENUM_CASE_DESPITE_DEFAULT =
            PLUGIN_ID + ".compiler.problem.missingEnumCaseDespiteDefault"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_INVALID_JAVADOC_TAGS__DEPRECATED_REF =
            PLUGIN_ID + ".compiler.problem.invalidJavadocTagsDeprecatedRef"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_INVALID_JAVADOC_TAGS__NOT_VISIBLE_REF =
            PLUGIN_ID + ".compiler.problem.invalidJavadocTagsNotVisibleRef"; //$NON-NLS-1$
     ...
     * a subset of the standard <a href="http://download.oracle.com/javase/6/docs/technotes/tools/windows/javadoc.html#javadoctags">Javadoc
     * tags</a>
     * that have a description, text or label are checked. While this set may grow in the future, note that user-defined tags are not and
     * will not be checked.
     * <dl>
    ...
    public static final String COMPILER_PB_MISSING_JAVADOC_TAGS_METHOD_TYPE_PARAMETERS =
            PLUGIN_ID + ".compiler.problem.missingJavadocTagsMethodTypeParameters"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_MISSING_JAVADOC_COMMENTS_VISIBILITY =
            PLUGIN_ID + ".compiler.problem.missingJavadocCommentsVisibility"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_MISSING_JAVADOC_COMMENTS_OVERRIDING =
            PLUGIN_ID + ".compiler.problem.missingJavadocCommentsOverriding"; //$NON-NLS-1$
     ...
     * <dt>Possible values:</dt><dd><code>"&lt;n&gt;"</code> where <code>&lt;n&gt;</code> is zero or a positive integer (if zero then all
     * problems are reported).</dd>
    ...
    public static final String COMPILER_PB_POTENTIALLY_MISSING_STATIC_ON_METHOD =
            PLUGIN_ID + ".compiler.problem.reportMethodCanBePotentiallyStatic"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_MISSING_NONNULL_BY_DEFAULT_ANNOTATION =
            PLUGIN_ID + ".compiler.annotation.missingNonNullByDefaultAnnotation"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_NULL_ANNOTATION_INFERENCE_CONFLICT =
            PLUGIN_ID + ".compiler.problem.nullAnnotationInferenceConflict"; //$NON-NLS-1$
     ...
     * <dt>Possible values:</dt><dd><code>{ "&lt;priority&gt;[,&lt;priority&gt;]*" }</code> where <code>&lt;priority&gt;</code> is one of
     * <code>"HIGH"</code>, <code>"NORMAL"</code> or <code>"LOW"</code></dd>
     ...
     * another letter or digit to be recognized (<code>"fooToDo"</code> will not be recognized as a task for tag <code>"ToDo"</code>, but
     * <code>"foo#ToDo"</code>
     * will be detected for either tag <code>"ToDo"</code> or <code>"#ToDo"</code>). Respectively,
     * a tag ending with a letter or digit cannot
     * be followed
     * by a letter or digit to be recognized (<code>"ToDofoo"</code> will not be recognized as a task for tag <code>"ToDo"</code>, but
     * <code>"ToDo:foo"</code> will
     ...
     * <dt>Possible values:</dt><dd><code>{ "&lt;tag&gt;[,&lt;tag&gt;]*" }</code> where <code>&lt;tag&gt;</code> is a String without any
     * wild-card or leading/trailing spaces</dd>
    ...
    public static final String COMPILER_PB_OVERRIDING_METHOD_WITHOUT_SUPER_INVOCATION =
            PLUGIN_ID + ".compiler.problem.overridingMethodWithoutSuperInvocation"; //$NON-NLS-1$
    ...
    public static final String COMPILER_PB_MISSING_SYNCHRONIZED_ON_INHERITED_METHOD =
            PLUGIN_ID + ".compiler.problem.missingSynchronizedOnInheritedMethod"; //$NON-NLS-1$
     ...
     * <dt>Possible values:</dt><dd><code>{ "&lt;name&gt;[,&lt;name&gt;]* }</code> where <code>&lt;name&gt;</code> is a file name pattern (*
     * and ? wild-cards allowed)
     ...
     * <dt>Possible values:</dt><dd><code>"&lt;n&gt;"</code>, where <code>n</code> is an integer greater than or equal to
     * <code>0</code></dd>
    ...
    /**
     * @since 2.0
     * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter
     * .DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_ANONYMOUS_TYPE_DECLARATION},
     *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_BLOCK} ,
     *             {@link com.codenvy.eclipse.jdt.core.formatter
     ...
     *             {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_BRACE_POSITION_FOR_SWITCH},
     *             {@link com.codenvy.eclipse.jdt.core.formatter
    ...
    /**
     * @since 2.0
     * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_COMPACT_ELSE_IF} instead.
     */
    public static final String FORMATTER_NEWLINE_ELSE_IF = PLUGIN_ID + ".formatter.newline.elseIf"; //$NON-NLS-1$

    /**
     * @since 2.0
     * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_INSERT_NEW_LINE_IN_EMPTY_BLOCK}
     *             instead.
     */
    ...
    /**
     * @since 2.0
     * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_LINE_SPLIT} instead
     */
    ...
    /**
     * @since 2.0
     * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_TAB_CHAR} instead.
     */
    public static final String FORMATTER_TAB_CHAR = PLUGIN_ID + ".formatter.tabulation.char"; //$NON-NLS-1$

    /**
     * @since 2.0
     * @deprecated Use {@link com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants#FORMATTER_TAB_SIZE} instead.
     */
     ...
     * <dt>Possible values:</dt><dd><code>{ "&lt;prefix&gt;[,&lt;prefix&gt;]*" }</code> where <code>&lt;prefix&gt;</code> is a String
     * without
     * any wild-card</dd>
     * <dt>Default:</dt><dd><code>""</code></dd>
     * </dl>
     ...
     * <dt>Possible values:</dt><dd><code>{ "&lt;suffix&gt;[,&lt;suffix&gt;]*" }</code> where <code>&lt;suffix&gt;</code> is a String
     * without
     * any wild-card</dd>
     * <dt>Default:</dt><dd><code>""</code></dd>
     * </dl>
     ...
     *
     * @see com.codenvy.eclipse.core.runtime.content.IContentTypeManager#getContentType(String)
...
//      }
     ...
     *
     * @param attributes
     *         the mutable marker attribute map (key type: <code>String</code>,
    ...
    private static void addNonJavaResources(Object[] nonJavaResources, IContainer container, int rootPathSegmentCounts,
                                            ArrayList collector) {
    ...
    public static ClasspathContainerInitializer getClasspathContainerInitializer(String containerID) {
        ...
        ClasspathContainerInitializer initializer = (ClasspathContainerInitializer)containerInitializersCache.get(
                containerID);
        if (initializer == null) {
    ...
    public static IPath getClasspathVariable(final String variableName) {
        ...
        if (initializer != null) {
            ...
            manager.variablePut(variableName,
                                JavaModelManager.VARIABLE_INITIALIZATION_IN_PROGRESS); // avoid initialization cycles
            boolean ok = false;
            try {
     ...
     * @param region
     *         the given region
     * @param includesNonJavaResources
     *         a flag that indicates if non-java resources should be included
     ...
     *         if the given region is <code>null</code>
     * @since 3.3
     */
     ...
     *
     * @param owner
     *         the given working copy owner or <code>null</code> for primary working copy owner
    ...
    public static void initializeAfterLoad(IProgressMonitor monitor) throws CoreException {
        try {
            ...
            try {
                if (monitor != null) {
                    subMonitor = new SubProgressMonitor(monitor,
                                                        50); // 50% of the time is spent in initializing containers and variables
                ...
                if (manager.forceBatchInitializations(
                        true/*initAfterLoad*/)) { // if no other thread has started the batch container initializations
                ...
                if (classpath != null) {
                    for (int j = 0, length2 = classpath.length; j < length2; j++) {
                        ...
                        if (entry.getEntryKind() == IClasspathEntry.CPE_LIBRARY) {
                            IPath entryPath = entry.getPath();
                            if (ExternalFoldersManager.isExternalFolderPath(entryPath) && externalFoldersManager.getFolder(
                                    entryPath) == null) {
            ...
            manager.deltaState.rootsAreStale =
                    true; // in case it was already initialized before we cleaned up the source attachment proprties
            ...
            try {
                engine.searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, "!@$#!@".toCharArray(), //$NON-NLS-1$
                                          ...
                                          monitor == null ? null : new SubProgressMonitor(monitor, 49)
                        ...
                        for (int i = 0, length = projects.length; i < length; i++) {
                            ...
                            try {
                                ...
                                new ClasspathValidation(
                                        (JavaProject)project).validate(); // https://bugs.eclipse.org/bugs/show_bug.cgi?id=287164
            ...
            try {
                ...
                model.refreshExternalArchives(null/*refresh all projects*/,
                                              monitor == null ? null : new SubProgressMonitor(monitor, 1)
     ...
     * @throws CoreException
     *         if the <code>IMarker.getAttribute</code> on the marker fails
     */
     ...
     * @throws CoreException
     *         if the  <code>IMarkerDelta.getAttribute</code> on the marker delta fails
     */
     ...
     * @param kind
     *         one of {@link IAccessRule#K_ACCESSIBLE}, {@link IAccessRule#K_DISCOURAGED},
    ...
    public static IClasspathEntry newContainerEntry(IPath containerPath) {
        return newContainerEntry(containerPath, ClasspathEntry.NO_ACCESS_RULES, ClasspathEntry.NO_EXTRA_ATTRIBUTES, false/*not exported*/);
    }
    ...
    public static IClasspathEntry newContainerEntry(IPath containerPath, IAccessRule[] accessRules,
        ...
        if (containerPath == null) {
            ...
            throw new ClasspathEntry.AssertionFailedException(
                    "Illegal classpath container path: \'" + containerPath.makeRelative().toString() + "\', " +
     ...
     * @since 3.1
     */
    public static ITypeHierarchy newTypeHierarchy(IRegion region, WorkingCopyOwner owner,
                                                  IProgressMonitor monitor) throws JavaModelException {
        if (region == null) {
            throw new IllegalArgumentException(Messages.hierarchy_nullRegion);
        }
        ICompilationUnit[] workingCopies =
                JavaModelManager.getJavaModelManager().getWorkingCopies(owner, true/*add primary working copies*/);
        CreateTypeHierarchyOperation op = new CreateTypeHierarchyOperation(region, workingCopies, null, true/*compute subtypes*/);
     ...
     */
    public static IClasspathEntry newLibraryEntry(IPath path, IPath sourceAttachmentPath, IPath sourceAttachmentRootPath,
                                                  IAccessRule[] accessRules, IClasspathAttribute[] extraAttributes, boolean isExported) {
        ...
        if (!hasDotDot && !path.isAbsolute()) {
            throw new ClasspathEntry.AssertionFailedException(
                    "Path for IClasspathEntry must be absolute: " + path); //$NON-NLS-1$
        }
     ...
     *         whether the access rules of the project's exported entries should be combined with the given access rules
     * @param extraAttributes
     *         the possibly empty list of extra attributes to persist with this entry
     * @param isExported
     *         indicates whether this entry is contributed to dependent
     ...
     * newVariableEntry(variablePath, variableSourceAttachmentPath, sourceAttachmentRootPath, new IAccessRule[0],
     ...
     * is bound to "c:/eclipse/plugins". The resolved classpath entry is denoting the library "c:\eclipse\plugins\com.example\example
     * .jar"</li>
     * </ul>
     * <p>
     * The access rules determine the set of accessible class files
    ...
    public static IClasspathEntry newVariableEntry(IPath variablePath, IPath variableSourceAttachmentPath,
        ...
        if (variablePath.segmentCount() < 1) {
            throw new ClasspathEntry.AssertionFailedException(
                    "Illegal classpath variable path: \'" + variablePath.makeRelative().toString() + "\', " +
     ...
     * @param project
     *         project where the persisted referenced entries to be retrieved from. If <code>null</code>
    ...
    public static void removeClasspathVariable(String variableName, IProgressMonitor monitor) {
        try {
            SetVariablesOperation operation = new SetVariablesOperation(new String[]{variableName}, new IPath[]{null},
     ...
     * @since 2.0
     */
    public static void setClasspathVariables(String[] variableNames, IPath[] paths,
                                             IProgressMonitor monitor) throws JavaModelException {

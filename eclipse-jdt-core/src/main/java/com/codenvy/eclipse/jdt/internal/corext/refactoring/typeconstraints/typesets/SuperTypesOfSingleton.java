...
public class SuperTypesOfSingleton extends TypeSet {
    ...
    protected TypeSet specialCasesIntersectedWith(TypeSet other) {
        ...
        if (other instanceof SuperTypesOfSingleton) {
            ...
            if ((otherUpper != fLowerBound && TTypes.canAssignTo(otherUpper, fLowerBound)) || !TTypes.canAssignTo(
                    fLowerBound, otherUpper)) {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.jdt.internal.corext.refactoring.typeconstraints.typesets.TypeSet#containsAll(org.eclipse.jdt.internal.corext
     * .refactoring.typeconstraints.typesets.TypeSet)
     */
    @Override
    ...
    public EnumeratedTypeSet enumerate() {
        if (fEnumCache == null) {
            if (fLowerBound instanceof ArrayType) {
                ...
                fEnumCache = EnumeratedTypeSet.makeArrayTypesForElements(

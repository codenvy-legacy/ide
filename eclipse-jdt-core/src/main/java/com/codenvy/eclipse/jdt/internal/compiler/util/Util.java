 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.internal.compiler.util;
...
public class Util implements SuffixConstants
{
   ...
   public static char[] getInputStreamAsCharArray(InputStream stream, int length, String encoding) throws IOException
   {
      ...
      try
      {
         reader = encoding == null ? new BufferedReader(new InputStreamReader(stream)) : new BufferedReader(
      ...
      if (inclusionPatterns != null)
      {
         for (int i = 0, length = inclusionPatterns.length; i < length; i++)
         {
            ...
            if (isFolderPath)
            {
               ...
               { // trailing slash -> adds '**' for free (see http://ant.apache.org/manual/dirtasks.html)
            ...
            if (systemLibrariesJars != null)
            {
               for (int i = 0, max = systemLibrariesJars.length; i < max; i++)
               {
                  ...
                  if (current != null)
                  {
                     ...
                     {
                        FileSystem.Classpath classpath = FileSystem.getClasspath(current[j].getAbsolutePath(), null,
                           false, null, null);
                        if (classpath != null)
                        {
    ...
    * @param start  the 0-based character index of the first character
    * @return the 0-based character index of the last character
    * @throws IllegalArgumentException if this is not a list of type arguments
    *                                  signatures
    */

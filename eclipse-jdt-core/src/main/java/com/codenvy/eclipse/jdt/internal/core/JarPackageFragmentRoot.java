 ...
 *
 * @see com.codenvy.eclipse.jdt.core.IPackageFragmentRoot
 * @see com.codenvy.eclipse.jdt.internal.core.JarPackageFragmentRootInfo
 */
public class JarPackageFragmentRoot extends PackageFragmentRoot
{
    ...
    *
    * @throws CoreException if an error occurs accessing the jar
    */
   ...
   public Object[] getNonJavaResources() throws JavaModelException
   {
      ...
      Object[] defaultPkgResources = ((JarPackageFragment)getPackageFragment(
         CharOperation.NO_STRINGS)).storedNonJavaResources();
   ...
   protected boolean resourceExists(IResource underlyingResource)
   {
      ...
      {
         return JavaModel.getExternalTarget(getPath()/*don't make the path relative as this is an external archive*/,

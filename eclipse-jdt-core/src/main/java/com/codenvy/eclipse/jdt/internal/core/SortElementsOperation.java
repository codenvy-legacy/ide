...
import com.codenvy.eclipse.jdt.core.util.CompilationUnitSorter;
...
public class SortElementsOperation extends JavaModelOperation {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.core.JavaModelOperation#executeOperation() */
     ...
     */
    public TextEdit calculateEdit(com.codenvy.eclipse.jdt.core.dom.CompilationUnit unit,
    ...
    private String processElement(ICompilationUnit unit, char[] source) {
        ...
        com.codenvy.eclipse.jdt.core.dom.CompilationUnit ast = (com.codenvy.eclipse.jdt.core.dom.CompilationUnit)parser.createAST(null);
    ...
    private ASTRewrite sortCompilationUnit(com.codenvy.eclipse.jdt.core.dom.CompilationUnit ast, final TextEditGroup group) {
        ast.accept(new ASTVisitor() {
            public boolean visit(com.codenvy.eclipse.jdt.core.dom.CompilationUnit compilationUnit) {
        ...
        ast.accept(new ASTVisitor() {
            ...
            public boolean visit(com.codenvy.eclipse.jdt.core.dom.CompilationUnit compilationUnit) {
                ...
                sortElements(compilationUnit.types(),
                             rewriter.getListRewrite(compilationUnit, com.codenvy.eclipse.jdt.core.dom.CompilationUnit.TYPES_PROPERTY));
                return true;
            }
            ...
            public boolean visit(AnnotationTypeDeclaration annotationTypeDeclaration) {
                ...
                sortElements(annotationTypeDeclaration.bodyDeclarations(),
            ...
            public boolean visit(AnonymousClassDeclaration anonymousClassDeclaration) {
                ...
                sortElements(anonymousClassDeclaration.bodyDeclarations(),
                             rewriter.getListRewrite(anonymousClassDeclaration,

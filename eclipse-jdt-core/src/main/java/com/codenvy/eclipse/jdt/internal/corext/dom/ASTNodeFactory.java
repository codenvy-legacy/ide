...
public class ASTNodeFactory
{
   ...
   public static Annotation newAnnotation(AST ast, IAnnotationBinding annotation, ImportRewrite importRewrite,
      ImportRewriteContext context)
   {
      ...
      else if (mvps.length == 1 && "value".equals(mvps[0].getName()))
      { //$NON-NLS-1$
   ...
   public static Expression newAnnotationValue(AST ast, Object value, ImportRewrite importRewrite,
      ImportRewriteContext context)
   {

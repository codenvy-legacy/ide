...
public class FieldReferenceMatch extends ReferenceMatch {
     ...
     *         the inner-most enclosing member that references
     *         this field
     * @param accuracy
     ...
     * @param isReadAccess
     *         whether the match represents a read access
     * @param isWriteAccess
     *         whether the match represents a write access
     * @param insideDocComment
     *         <code>true</code> if this search match is inside a
     ...
     */
    public FieldReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length, boolean isReadAccess,
                               boolean isWriteAccess, boolean insideDocComment, SearchParticipant participant, IResource resource) {

...
public final class IndentManipulation
{
    ...
    * <p>Use {@link com.codenvy.eclipse.jdt.core.IJavaProject#getOptions(boolean)} to get the most current project options.</p>
    *
    * @param options the map to get the formatter settings from.
    * @return the tab width
    * @throws IllegalArgumentException if the given <code>options</code> is null
    */
   ...
   public static int getIndentWidth(Map options)
   {
      ...
      boolean isMixedMode = DefaultCodeFormatterConstants.MIXED.equals(

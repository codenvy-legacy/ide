 ...
 *     Carsten Pfeiffer <carsten.pfeiffer@gebit.de> - [ccp] ReorgPolicies' canEnable() methods return true too often - https://bugs
 *     .eclipse.org/bugs/show_bug.cgi?id=303698
 *******************************************************************************/
...
public final class ReorgPolicyFactory {
    ...
    private static abstract class FilesFoldersAndCusReorgPolicy extends ReorgPolicy {
        ...
        public final ChangeDescriptor getDescriptor() {
            ...
            final String header = length == 1 ? Messages.format(getHeaderPatternSingular(),
                                              ...
                                              : Messages.format(getHeaderPatternPlural(),
    ...
    private static abstract class PackageFragmentRootsReorgPolicy extends ReorgPolicy {
        ...
        public final ChangeDescriptor getDescriptor() {
            ...
            final String project = resource != null ? resource.getName() : null;
            final String header = length == 1 ? Messages.format(getHeaderPatternSingular(),
                                                                new String[]{fPackageFragmentRoots[0].getElementName(),
                                                                             getDestinationLabel()}) : Messages.format(
    ...
    private static abstract class PackagesReorgPolicy extends ReorgPolicy {
        ...
        public final ChangeDescriptor getDescriptor() {
            ...
            final String project = resource != null ? resource.getName() : null;
            final String header = length == 1 ? Messages.format(getHeaderPatternSingular(),
                                                                new String[]{(fPackageFragments[0]).getElementName(),
                                                                             getDestinationLabel()}) : Messages.format(
                    getHeaderPatternPlural(), new String[]{String.valueOf(length), getDestinationLabel()});
    ...
    private static abstract class SubCuElementReorgPolicy extends ReorgPolicy {
       ...
       * The CU which does contain element
        ...
        public final ChangeDescriptor getDescriptor() {
            ...
            final String header = length == 1 ? Messages.format(getHeaderPatternSingular(),
                                                                new String[]{
                                                                        JavaElementLabels.getTextLabel(fJavaElements[0].getElementName(),
                                                                                                       JavaElementLabels
                                                                                                               .ALL_FULLY_QUALIFIED),
                                                                        getDestinationLabel()}) : Messages.format(
                    getHeaderPatternPlural(), new String[]{String.valueOf(length), getDestinationLabel()});
    ...
    private static IReorgPolicy createReorgPolicy(boolean copy, IResource[] selectedResources,
        ...
        if (ReorgUtils.isArchiveOrExternalMember(javaElements) && ReorgUtils.getElementsOfType(javaElements,
                                                                                               IJavaElement.PACKAGE_FRAGMENT_ROOT).size() !=
                                                                  javaElements.length) {
            return NO;
        }

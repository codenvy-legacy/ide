...
import com.codenvy.eclipse.jdt.core.IJavaModel;
...
import com.codenvy.eclipse.jdt.core.IOpenable;
...
import com.codenvy.eclipse.jdt.core.dom.rewrite.ImportRewrite.ImportRewriteContext;
...
import com.codenvy.eclipse.jdt.internal.corext.codemanipulation.ContextSensitiveImportRewriteContext;
import com.codenvy.eclipse.jdt.internal.corext.codemanipulation.StubUtility;
...
import com.codenvy.eclipse.jdt.internal.corext.refactoring.changes.CopyCompilationUnitChange;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.changes.CopyPackageChange;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.changes.CopyPackageFragmentRootChange;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.changes.CopyResourceChange;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.changes.DynamicValidationStateChange;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.changes.MoveCompilationUnitChange;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.changes.MovePackageChange;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.changes.MovePackageFragmentRootChange;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.reorg.IReorgPolicy.ICopyPolicy;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.reorg.IReorgPolicy.IMovePolicy;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.reorg.ReorgDestinationFactory.JavaElementDestination;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.reorg.ReorgDestinationFactory.ResourceDestination;
...
import com.codenvy.eclipse.jdt.internal.corext.refactoring.structure.ImportRewriteUtil;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.util.Changes;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.util.JavaElementUtil;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.util.QualifiedNameFinder;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.util.QualifiedNameSearchResult;
...
import com.codenvy.eclipse.jdt.internal.corext.util.JavaConventionsUtil;
...
import com.codenvy.eclipse.ltk.core.refactoring.participants.CopyArguments;
import com.codenvy.eclipse.ltk.core.refactoring.participants.MoveArguments;
...
import com.codenvy.eclipse.ltk.core.refactoring.resource.MoveResourceChange;
...
public final class ReorgPolicyFactory
{
      ...
      public IJavaElement[] getActualJavaElementsToReorg() throws JavaModelException
      {
         ...
         for (int i = 0; i < fJavaElements.length; i++)
         {
            ...
            if (element instanceof IType)
            {
               ...
               if (cu != null && type.getDeclaringType() == null && cu.exists() && cu.getTypes().length == 1 && !result.contains(
                  cu))
               {
                  result.add(cu);
               }
   ...
   private static final class CopyFilesFoldersAndCusPolicy extends FilesFoldersAndCusReorgPolicy implements ICopyPolicy
   {
      ...
      protected JavaRefactoringDescriptor createRefactoringDescriptor(JDTRefactoringDescriptorComment comment,
         Map<String, String> arguments, String description, String project, int flags)
      {
         ReorgExecutionLog log = getReorgExecutionLog();
         storeReorgExecutionLog(project, arguments, log);
         return RefactoringSignatureDescriptorFactory.createCopyDescriptor(project, description, comment.asString(),
            arguments, flags);
      }
      ...
      implements ICopyPolicy
   {
      ...
      protected RefactoringModifications getModifications() throws CoreException
      {
         ...
         if (destination == null)
         {
            ...
            for (int i = 0; i < roots.length; i++)
            {
               fModifications.copy(roots[i].getResource(),
   ...
   private static final class CopyPackagesPolicy extends PackagesReorgPolicy implements ICopyPolicy
   {
         ...
         INewNameQueries copyQueries)
      {
         ...
         if (newName == null || JavaConventionsUtil.validatePackageName(newName,
            destination).getSeverity() < IStatus.ERROR)
         {
            INewNameQuery nameQuery;
            if (newName == null)
            {
      ...
      public Change createChange(IProgressMonitor pm, INewNameQueries newNameQueries) throws JavaModelException
      {
         ...
         for (int i = 0; i < fragments.length; i++)
         {
            ...
            {
               composite.add(
                  createChange(fragments[i], (IContainer)getResourceDestination(), nameProposer, newNameQueries));
            }
            else
            {
      ...
      protected RefactoringModifications getModifications() throws CoreException
      {
         ...
         if (destination == null)
         {
            ...
            {
               fModifications.copy(packages[i].getResource(),
                  new CopyArguments(getResourceDestination(), fReorgExecutionLog));
            }
         }
         else
   ...
   private static final class CopySubCuElementsPolicy extends SubCuElementReorgPolicy implements ICopyPolicy
   {
      ...
      public IFile[] getAllModifiedFiles()
      {
         return ReorgUtils.getFiles(
            new IResource[]{ReorgUtils.getResource(getEnclosingCompilationUnit(getJavaElementDestination()))});
      }
   ...
   private static abstract class FilesFoldersAndCusReorgPolicy extends ReorgPolicy
   {
      ...
      {
         return ReorgUtils.containsLinkedResources(fFiles) || ReorgUtils.containsLinkedResources(
            fFolders) || ReorgUtils.containsLinkedResources(fCus);
      }

      protected abstract JavaRefactoringDescriptor createRefactoringDescriptor(
         final JDTRefactoringDescriptorComment comment, final Map<String, String> arguments, final String description,
         final String project, int flags);
      ...
      public final ChangeDescriptor getDescriptor()
      {
         ...
         final String header = length == 1 ? Messages.format(getHeaderPatternSingular(),
            new String[]{getSingleElementName(), getDestinationLabel()}) : Messages.format(getHeaderPatternPlural(),
         ...
         {
            arguments.put(
               JavaRefactoringDescriptorUtil.ATTRIBUTE_ELEMENT + (offset + fFolders.length + fFiles.length + 1),
               JavaRefactoringDescriptorUtil.elementToHandle(project, fCus[offset]));
         }
         arguments.putAll(getRefactoringArguments(project));
         final JavaRefactoringDescriptor descriptor = createRefactoringDescriptor(comment, arguments, description,
            project, flags);
      ...
      public RefactoringStatus initialize(JavaRefactoringArguments arguments)
      {
         ...
         for (int index = 0; index < fileCount; index++)
         {
            ...
            { //$NON-NLS-1$
               final IResource resource = JavaRefactoringDescriptorUtil.handleToResource(arguments.getProject(),
                  handle);
               if (resource == null || !resource.exists())
               {
                  status.merge(JavaRefactoringDescriptorUtil.createInputWarningStatus(resource, getProcessorId(),
                     getRefactoringId()));
               }
               else
               {
         ...
         for (int index = 0; index < unitCount; index++)
         {
            ...
            { //$NON-NLS-1$
               ...
               {
                  status.merge(JavaRefactoringDescriptorUtil.createInputWarningStatus(element, getProcessorId(),
                     getRefactoringId()));
               }
               else
               {
   ...
   private static final class MoveFilesFoldersAndCusPolicy extends FilesFoldersAndCusReorgPolicy implements IMovePolicy
   {
         ...
         Map<String, String> arguments, String description, String project, int flags)
      {
         ...
         return RefactoringSignatureDescriptorFactory.createMoveDescriptor(project, description, comment.asString(),
            arguments, flags);
      }
      ...
      protected Map<String, String> getRefactoringArguments(String project)
      {
         ...
         arguments.put(JavaRefactoringDescriptorUtil.ATTRIBUTE_REFERENCES,
      ...
      protected RefactoringStatus verifyDestination(IJavaElement destination) throws JavaModelException
      {
         ...
         IContainer destinationAsContainer = getDestinationAsContainer();
         if (destinationAsContainer != null && (destinationAsContainer.equals(
            commonParent) || commonParent instanceof IPackageFragmentRoot && destinationAsContainer.equals(
   ...
   private static final class MovePackagesPolicy extends PackagesReorgPolicy implements IMovePolicy
   {
      ...
      protected RefactoringModifications getModifications() throws CoreException
      {
         ...
         for (int i = 0; i < packages.length; i++)
         {
            ...
            {
               fModifications.move(packages[i].getResource(),
   ...
   private static abstract class MoveSubCuElementsPolicy extends SubCuElementReorgPolicy implements IMovePolicy
   {
      ...
      public Change createChange(IProgressMonitor pm) throws JavaModelException
      {
         ...
         try
         {
            ...
            CompilationUnit sourceCuNode = RefactoringASTParser.parseWithASTProvider(sourceCu, true,
            ...
            {
               CompilationUnit destinationCuNode = RefactoringASTParser.parseWithASTProvider(destinationCu, true,
                  new SubProgressMonitor(pm, 1));
            ...
            else
            {
               CompositeChange result = new DynamicValidationStateChange(
                  RefactoringCoreMessages.ReorgPolicy_move_members);
               result.markAsSynthetic();
               result.add(targetCuChange);
               if (Arrays.asList(getJavaElements()).containsAll(Arrays.asList(sourceCu.getTypes())))
               {
                  result.add(
                     DeleteChangeCreator.createDeleteChange(null, new IResource[0], new ICompilationUnit[]{sourceCu},
                        RefactoringCoreMessages.ReorgPolicy_move, Collections.<IResource>emptyList()));
               }
               else
               {
      ...
      public IFile[] getAllModifiedFiles()
      {
         return ReorgUtils.getFiles(new IResource[]{ReorgUtils.getResource(getSourceCu()), ReorgUtils.getResource(
            getEnclosingCompilationUnit(getJavaElementDestination()))});
      }
         ...
         while (true)
         {
            ...
            if (i == 1)
            {
               newName = Messages.format(RefactoringCoreMessages.CopyRefactoring_package_copyOf1,
                  pack.getElementName()); // Don't use BasicElementLabels! No RTL!
            }
            else
            {
   ...
   private static abstract class PackageFragmentRootsReorgPolicy extends ReorgPolicy
   {
      ...
      public final ChangeDescriptor getDescriptor()
      {
         ...
         final String project = resource != null ? resource.getName() : null;
         final String header = length == 1 ? Messages.format(getHeaderPatternSingular(),
            new String[]{fPackageFragmentRoots[0].getElementName(), getDestinationLabel()}) : Messages.format(
   ...
   private static abstract class PackagesReorgPolicy extends ReorgPolicy
   {
      ...
      public final ChangeDescriptor getDescriptor()
      {
         ...
         final String project = resource != null ? resource.getName() : null;
         final String header = length == 1 ? Messages.format(getHeaderPatternSingular(),
            new String[]{(fPackageFragments[0]).getElementName(), getDestinationLabel()}) : Messages.format(
            getHeaderPatternPlural(), new String[]{String.valueOf(length), getDestinationLabel()});
      ...
      private IPackageFragmentRoot getDestinationAsPackageFragmentRoot(
   ...
   private static abstract class ReorgPolicy implements IReorgPolicy
   {
       ...
       *
       * This is less strict then {@link #verifyDestination(com.codenvy.eclipse.core.resources.IResource)} where
       ...
       *
       * This is less strict then {@link #verifyDestination(com.codenvy.eclipse.jdt.core.IJavaElement)} where
       ...
       *          if creating the modifications failed
       */
      protected RefactoringModifications getModifications() throws CoreException
      {
         return null;
      ...
      public RefactoringStatus initialize(JavaRefactoringArguments arguments)
      {
         ...
         if (handle != null)
         {
            ...
            if (element != null)
            {
               ...
               {
                  return JavaRefactoringDescriptorUtil.createInputFatalStatus(element, getProcessorId(),
                     getRefactoringId());
               }
               else
               {
            ...
            else
            {
               ...
               {
                  return JavaRefactoringDescriptorUtil.createInputFatalStatus(resource, getProcessorId(),
                     getRefactoringId());
               }
               else
               {
   ...
   private static abstract class SubCuElementReorgPolicy extends ReorgPolicy
   {
      ...
      private void copyImportsToDestination(IImportContainer container, ASTRewrite rewrite,
         CompilationUnit sourceCuNode, CompilationUnit destinationCuNode) throws JavaModelException
      {
      ...
      private void copyImportToDestination(IImportDeclaration declaration, ASTRewrite targetRewrite,
         CompilationUnit sourceCuNode, CompilationUnit destinationCuNode) throws JavaModelException
      {
         ImportDeclaration sourceNode = ASTNodeSearchUtil.getImportDeclarationNode(declaration, sourceCuNode);
         ...
         {
            ImportDeclaration destinationNode = ASTNodeSearchUtil.getImportDeclarationNode(
      ...
      {
         BodyDeclaration newInitializer = (BodyDeclaration)targetRewriter.getASTRewrite().createStringPlaceholder(
            getUnindentedSource(initializer), ASTNode.INITIALIZER);
         copyMemberToDestination(initializer, targetRewriter, sourceCuNode, targetCuNode, newInitializer);
      }

      private void copyMemberToDestination(IMember member, CompilationUnitRewrite targetRewriter,
         CompilationUnit sourceCuNode, CompilationUnit targetCuNode,
         BodyDeclaration newMember) throws JavaModelException
      {
         ...
         if (destinationContainer instanceof AbstractTypeDeclaration)
         {
            ...
            {
               listRewrite = targetRewriter.getASTRewrite().getListRewrite(destinationContainer,
                  ((AbstractTypeDeclaration)destinationContainer).getBodyDeclarationsProperty());
            }
         }
         ...
         {
            listRewrite.insertAt(newMember, ASTNodes.getInsertionIndex(newMember, listRewrite.getRewrittenList()),
               null);
         }
         else
         {
         ...
         if (!(member instanceof IInitializer))
         {
            ...
            if (decl != null)
            {
               ImportRewriteContext context = new ContextSensitiveImportRewriteContext(destinationContainer,
                  targetRewriter.getImportRewrite());
               ImportRewriteUtil.addImports(targetRewriter, context, decl, new HashMap<Name, String>(),
      ...
      private ASTNode getDestinationNode(IJavaElement destination, CompilationUnit target) throws JavaModelException
      {
         switch (destination.getElementType())
         {
            ...
            case IJavaElement.TYPE:
               ...
               {
                  return ASTNodeSearchUtil.getClassInstanceCreationNode(typeDestination,
                     target).getAnonymousClassDeclaration();
               }
               else
               {
      ...
      private void copyMethodToDestination(IMethod method, CompilationUnitRewrite targetRewriter,
         CompilationUnit sourceCuNode, CompilationUnit targetCuNode) throws JavaModelException
      {
         MethodDeclaration newMethod = (MethodDeclaration)targetRewriter.getASTRewrite().createStringPlaceholder(
            getUnindentedSource(method), ASTNode.METHOD_DECLARATION);
      ...
      protected void copyToDestination(IJavaElement element, CompilationUnitRewrite targetRewriter,
         CompilationUnit sourceCuNode, CompilationUnit targetCuNode) throws CoreException
      {
      ...
      private void copyTypeToDestination(IType type, CompilationUnitRewrite targetRewriter,
         CompilationUnit sourceCuNode, CompilationUnit targetCuNode) throws JavaModelException
      {
         AbstractTypeDeclaration newType = (AbstractTypeDeclaration)targetRewriter.getASTRewrite().createStringPlaceholder(
            getUnindentedSource(type), ASTNode.TYPE_DECLARATION);
         ...
         {
            targetRewriter.getASTRewrite().getListRewrite(targetCuNode, CompilationUnit.TYPES_PROPERTY).insertLast(
               newType, null);
         }
      }

      private BodyDeclaration createNewFieldDeclarationNode(IField field, ASTRewrite rewrite,
         CompilationUnit sourceCuNode) throws CoreException
      {
         ...
         if (bodyDeclaration instanceof FieldDeclaration)
         {
            ...
            {
               return (FieldDeclaration)rewrite.createStringPlaceholder(getUnindentedSource(field),
                  ASTNode.FIELD_DECLARATION);
            }
            VariableDeclarationFragment originalFragment = ASTNodeSearchUtil.getFieldDeclarationFragmentNode(field,
               sourceCuNode);
            VariableDeclarationFragment copiedFragment = (VariableDeclarationFragment)ASTNode.copySubtree(targetAst,
               originalFragment);
            newDeclaration = targetAst.newFieldDeclaration(copiedFragment);
            ((FieldDeclaration)newDeclaration).setType(
               (Type)ASTNode.copySubtree(targetAst, fieldDeclaration.getType()));
         }
            ...
            if (anonymousDeclaration != null)
            {
               ...
               if (content != null)
               {
                  newConstDeclaration.setAnonymousClassDeclaration(
                     (AnonymousClassDeclaration)rewrite.createStringPlaceholder(content,
      ...
      public final ChangeDescriptor getDescriptor()
      {
         ...
         final String project = resource != null ? resource.getName() : null;
         final String header = length == 1 ? Messages.format(getHeaderPatternSingular(),
            new String[]{JavaElementLabels.getTextLabel(fJavaElements[0].getElementName(),
               JavaElementLabels.ALL_FULLY_QUALIFIED), getDestinationLabel()}) : Messages.format(
            getHeaderPatternPlural(), new String[]{String.valueOf(length), getDestinationLabel()});
         int flags = JavaRefactoringDescriptor.JAR_REFACTORING | JavaRefactoringDescriptor.JAR_MIGRATION | RefactoringDescriptor.STRUCTURAL_CHANGE | RefactoringDescriptor.MULTI_CHANGE;
         final JDTRefactoringDescriptorComment comment = new JDTRefactoringDescriptorComment(project, this, header);
         arguments.put(ATTRIBUTE_POLICY, getPolicyId());
      ...
      protected RefactoringStatus verifyDestination(IJavaElement destination, int location) throws JavaModelException
      {
         ...
         switch (destination.getElementType())
         {
            case IJavaElement.COMPILATION_UNIT:
               ...
               {
                  if (JavaElementUtil.getMainType(destinationCu) == null || !ReorgUtils.hasOnlyElementsOfType(
                     getJavaElements(),
                     new int[]{IJavaElement.FIELD, IJavaElement.INITIALIZER, IJavaElement.METHOD, IJavaElement.TYPE}))
                  {
                     return RefactoringStatus.createFatalErrorStatus(RefactoringCoreMessages.ReorgPolicyFactory_cannot);
                  }
               }
   ...
   private static IReorgPolicy createReorgPolicy(boolean copy, IResource[] selectedResources,
      IJavaElement[] selectedJavaElements) throws JavaModelException
   {
      ...
      if (ReorgUtils.isArchiveOrExternalMember(javaElements) && ReorgUtils.getElementsOfType(javaElements,
         IJavaElement.PACKAGE_FRAGMENT_ROOT).size() != javaElements.length)
      {
         return NO;
      }
      ...
      if (ReorgUtils.hasElementsOfType(resources, IResource.FILE | IResource.FOLDER) || ReorgUtils.hasElementsOfType(
         javaElements, IJavaElement.COMPILATION_UNIT))
      {
      ...
      if (hasOnlyImportDeclarations(javaElements))
      {
         ...
         {
            List<IImportDeclaration> declarations = (List<IImportDeclaration>)ReorgUtils.getElementsOfType(javaElements,
   ...
   private static void processCreateTargetExecutionRecord(CreateTargetExecutionLog log,
      JavaRefactoringArguments arguments, String token)
   {
   ...
   private static void processReorgExecutionRecord(ReorgExecutionLog log, JavaRefactoringArguments arguments,
      String token)
   {
      final StringTokenizer tokenizer = new StringTokenizer(token, DELIMITER_ELEMENT, false);
      String value = null;
   ...
   public static void storeCreateTargetExecutionLog(String project, Map<String, String> arguments,
      CreateTargetExecutionLog log)
   {
      if (log != null)
      {

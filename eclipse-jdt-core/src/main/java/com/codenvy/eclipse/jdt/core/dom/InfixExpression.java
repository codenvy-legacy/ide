...
public class InfixExpression extends Expression {
    ...
    public static class Operator {
        ...
        static {
            ...
            Operator[] ops =
                    {TIMES, DIVIDE, REMAINDER, PLUS, MINUS, LEFT_SHIFT, RIGHT_SHIFT_SIGNED, RIGHT_SHIFT_UNSIGNED, LESS, GREATER,
                     LESS_EQUALS,
                     GREATER_EQUALS, EQUALS, NOT_EQUALS, XOR, OR, AND, CONDITIONAL_OR, CONDITIONAL_AND,};

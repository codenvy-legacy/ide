...
public class CaseStatement extends Statement
{
    ...
    *
    * @see com.codenvy.eclipse.jdt.internal.compiler.ast.Statement#resolveCase(com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope, com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding, com.codenvy.eclipse.jdt.internal.compiler.ast.SwitchStatement)
    */
   public Constant resolveCase(BlockScope scope, TypeBinding switchExpressionType, SwitchStatement switchStatement)
   {
      ...
      if (this.constantExpression.isConstantValueOfTypeAssignableToType(caseType,
         switchExpressionType) || caseType.isCompatibleWith(switchExpressionType))
      {
         if (caseType.isEnum())
         {
            ...
            if (this.constantExpression instanceof NameReference && (this.constantExpression.bits & ASTNode.RestrictiveFlagMASK) == Binding.FIELD)
            {
               ...
               return IntConstant.fromValue(
                  field.original().id + 1); // (ordinal value + 1) zero should not be returned see bug 141810
            }
         }
         else
         {

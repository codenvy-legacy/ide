...
public abstract class AbstractCommentParser implements JavadocTagConstants {
    ...
    protected boolean commentParse() {
        ...
        try {
            ...
            this.lineEnd = (this.linePtr == this.lastLinePtr) ? this.javadocEnd : this.scanner.getLineEnd(
                    this.linePtr) - 1;
     ...
     *         otherwise
     * @throws com.codenvy.eclipse.jdt.core.compiler.InvalidInputException
        ...
        try {
            ...
            if (currentChar == 'a' || currentChar == 'A') {
                ...
                if (readToken() == TerminalTokens.TokenNameIdentifier) {
                    consumeToken();
                    try {
                        if (CharOperation.equals(this.scanner.getCurrentIdentifierSource(), HREF_TAG,
                                                 false) && readToken() == TerminalTokens.TokenNameEQUAL) {
                            consumeToken();
        ...
        if (readToken() == TerminalTokens.TokenNameIdentifier) {
            ...
            if (readToken() == TerminalTokens.TokenNameLPAREN) {
                ...
                try {
                    ...
                    int end = this.scanner.getCurrentTokenEndPosition() < this.lineEnd ? this.scanner.getCurrentTokenEndPosition()
    ...
    protected char peekChar() {
        ...
        if (c == '\\' && this.source[idx] == 'u') {
            ...
            if (!(((c1 = ScannerHelper.getHexadecimalValue(
                    this.source[idx++])) > 15 || c1 < 0) || ((c2 = ScannerHelper.getHexadecimalValue(
                    this.source[idx++])) > 15 || c2 < 0) || ((c3 = ScannerHelper.getHexadecimalValue(
                    this.source[idx++])) > 15 || c3 < 0) || ((c4 = ScannerHelper.getHexadecimalValue(
                    this.source[idx++])) > 15 || c4 < 0))) {
    ...
    protected void pushIdentifier(boolean newLength, boolean isToken) {
        ...
        if (++this.identifierPtr >= stackLength) {
            ...
            System.arraycopy(this.identifierPositionStack, 0, this.identifierPositionStack = new long[stackLength + 10], 0,
                             stackLength);
        }

...
public class SimpleType extends Type
{
    ...
    * @since 3.0
    */
   public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(SimpleType.class, "name",
      Name.class, MANDATORY, NO_CYCLE_RISK); //$NON-NLS-1$

 ...
 */
    ...
    private FlowInfo addInfoFrom(FlowInfo inits, boolean handleInits) {
        ...
        if (otherHasNulls) {
            if (!thisHadNulls) {
                ...
                this.nullBit1 = (b1 = otherInits.nullBit1) | (a1 = this.nullBit1) & ((a3 = this.nullBit3) & (a4 = this.nullBit4) &
                ...
                this.nullBit3 = b3 & (nb1 & (b2 | a2 | na1) | b1 & (b4 | nb2 | a1 & a3) | na1 & na2 & na4) | a3 & nb2 & nb4 |
                                nb1 & ((na2 & a4 | na1) & a3 | a1 & na2 & na4 & b2);
                this.nullBit4 = nb1 & (a4 & (na3 & nb3 | (a3 | na2) & nb2) | a1 & (a3 & nb2 & b4 | a2 & b2 & (b4 | a3 & na4 & nb3))) | b1 &
                                                                                                                                       (a3 &
                                                                                                                                        a4 &
                                                                                                                                        b4 |
        ...
        if (this.extra != null || otherInits.extra != null) {
            ...
            for (i = 0; i < mergeLimit; i++) {
                this.extra[1 + 1][i] = (b1 = otherInits.extra[1 + 1][i]) | (a1 = this.extra[1 + 1][i]) &
                ...
                this.extra[3 + 1][i] = b3 & (nb1 & (b2 | a2 | na1) | b1 & (b4 | nb2 | a1 & a3) | na1 & na2 & na4) | a3 & nb2 & nb4 |
                                       nb1 & ((na2 & a4 | na1) & a3 | a1 & na2 & na4 & b2);
                this.extra[4 + 1][i] =
                        nb1 & (a4 & (na3 & nb3 | (a3 | na2) & nb2) | a1 & (a3 & nb2 & b4 | a2 & b2 & (b4 | a3 & na4 & nb3))) | b1 &
                                                                                                                               (a3 & a4 &
                                                                                                                                b4 |
                                                                                                                                na2 & na4 &
                                                                                                                                nb3 & b4 |
    ...
    public UnconditionalFlowInfo addPotentialNullInfoFrom(UnconditionalFlowInfo otherInits) {
        ...
        if (thisHadNulls) {
            ...
            this.nullBit3 = b3 & (nb1 & b2 | a2 & (nb2 | a3) | na1 & nb2 | a1 & na2 & na4 & b1) | a3 & (nb2 & nb4 | na2 & a4 | na1) |
                            a1 & na2 & na4 & b2;
            this.nullBit4 = na3 & (nb1 & nb3 & b4 | a4 & (nb3 | b1 & b2)) | nb2 & (na3 & b1 & nb3 | na2 & (nb1 & b4 | b1 & nb3 | a4)) |
        ...
        if (otherInits.extra != null) {
            ...
            int i;
            for (i = 0; i < mergeLimit; i++) {
                this.extra[1 + 1][i] = (a1 = this.extra[1 + 1][i]) & ((a3 = this.extra[3 + 1][i]) & (a4 = this.extra[4 + 1][i]) &
                                                                      ((nb2 = ~(b2 = otherInits.extra[2 + 1][i])) &
                                                                       (nb4 = ~(b4 = otherInits.extra[4 + 1][i])) |
                                                                       (b1 = otherInits.extra[1 + 1][i]) &
                                                                       (b3 = otherInits.extra[3 + 1][i])) |
    ...
    final public boolean cannotBeDefinitelyNullOrNonNull(LocalVariableBinding local) {
        ...
        if ((position = local.id + this.maxFieldCount) < BitCacheSize) {
            // use bits
            return ((~this.nullBit1 & (this.nullBit2 & this.nullBit3 | this.nullBit4) | ~this.nullBit2 & ~this.nullBit3 & this.nullBit4) &
                    (1L << position)) != 0;
        }
        // use extra vector
        if (this.extra == null) {
        ...
        return ((~this.extra[2][vectorIndex] &
                 ...
                 ~a2 & ~a3 & a4) & (1L << (position % BitCacheSize))) != 0;
    }
    ...
    final public boolean isPotentiallyUnknown(LocalVariableBinding local) {
        ...
        return (this.extra[5][vectorIndex] & (~this.extra[2][vectorIndex] | ~this.extra[3][vectorIndex] & ~this.extra[4][vectorIndex]) &
                (1L << (position % BitCacheSize))) != 0;
    }
    ...
    public void markAsComparedEqualToNonNull(LocalVariableBinding local) {
        ...
        if (this != DEAD_END) {
            ...
            if ((position = local.id + this.maxFieldCount) < BitCacheSize) {
                // use bits
                if (((mask = 1L << position) & (a1 = this.nullBit1) & (na2 = ~(a2 = this.nullBit2)) & ~(a3 = this.nullBit3) &
                     (a4 = this.nullBit4)) != 0) {
                    this.nullBit4 &= ~mask;
    ...
    public UnconditionalFlowInfo mergedWith(UnconditionalFlowInfo otherInits) {
        ...
        if ((otherInits.tagBits & FlowInfo.UNREACHABLE_BY_NULLANALYSIS) != 0) {
            ...
            if (otherHasNulls) {
                this.nullBit1 = (a2 = this.nullBit2) & (a3 = this.nullBit3) & (a4 = this.nullBit4) & (b1 = otherInits.nullBit1) &
                                (nb2 = ~(b2 = otherInits.nullBit2)) | (a1 = this.nullBit1) & (b1 & (a3 & a4 & (b3 = otherInits.nullBit3) &
                ...
                this.nullBit3 = b3 & (nb2 & b4 | nb1 | a3 & (na4 & nb4 | a4 & b4)) | a3 & (na2 & a4 | na1) | (a2 | na1) & b1 & nb2 & nb4 |
                                a1 & na2 & na4 & (b2 | nb1);
                this.nullBit4 = na3 & (nb1 & nb3 & b4 | b1 & (nb2 & nb3 | a4 & b2 & nb4) | na1 & a4 & (nb3 | b1 & b2)) |
                                a3 & a4 & (b3 & b4 | b1 & nb2) | na2 & (nb1 & b4 | b1 & nb3 | na1 & a4) & nb2 | a1 & (na3 & (nb3 & b4 |
                                                                                                                             b1 & b2 & b3 &
                                                                                                                             nb4 | na2 &
                                                                                                                                   (nb3 |
                                                                                                                                    nb2)) |
        ...
        if (this.extra != null || otherInits.extra != null) {
            ...
            // compose nulls
            for (i = 0; i < mergeLimit; i++) {
                this.extra[1 + 1][i] = (a2 = this.extra[2 + 1][i]) & (a3 = this.extra[3 + 1][i]) & (a4 = this.extra[4 + 1][i]) &
                                       (b1 = otherInits.extra[1 + 1][i]) & (nb2 = ~(b2 = otherInits.extra[2 + 1][i])) |
                                       (a1 = this.extra[1 + 1][i]) & (b1 & (a3 & a4 & (b3 = otherInits.extra[3 + 1][i]) &
                                                                            (b4 = otherInits.extra[4 + 1][i]) | (na2 = ~a2) & nb2 &
                                                                                                                ((nb4 = ~b4) | (na4 = ~a4) |
                                                                                                                 (na3 = ~a3) &
                                                                                                                 (nb3 = ~b3)) |
                                                                            a2 & b2 & ((na4 | na3) & (nb4 | nb3))) | na2 & b2 & b3 & b4);
                this.extra[2 + 1][i] =
                        b2 & (nb3 | (nb1 = ~b1) | a3 & (a4 | (na1 = ~a1)) & nb4) | a2 & (b2 | na4 & b3 & (b4 | nb1) | na3 | na1);
                this.extra[3 + 1][i] =
                        b3 & (nb2 & b4 | nb1 | a3 & (na4 & nb4 | a4 & b4)) | a3 & (na2 & a4 | na1) | (a2 | na1) & b1 & nb2 & nb4 |
                        a1 & na2 & na4 & (b2 | nb1);
                this.extra[4 + 1][i] = na3 & (nb1 & nb3 & b4 | b1 & (nb2 & nb3 | a4 & b2 & nb4) | na1 & a4 & (nb3 | b1 & b2)) |
                                       a3 & a4 & (b3 & b4 | b1 & nb2) | na2 & (nb1 & b4 | b1 & nb3 | na1 & a4) & nb2 | a1 & (na3 &
                                                                                                                             (nb3 & b4 |
                                                                                                                              b1 & b2 & b3 &
                                                                                                                              nb4 | na2 &
                                                                                                                                    (nb3 |

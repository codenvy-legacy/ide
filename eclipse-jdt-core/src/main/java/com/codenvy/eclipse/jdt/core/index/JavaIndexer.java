 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.core.index;

import com.codenvy.eclipse.jdt.core.search.SearchEngine;
import com.codenvy.eclipse.jdt.internal.core.search.indexing.DefaultJavaIndexer;
...
public final class JavaIndexer {
     ...
     *
     * @param pathToJar
     *         The full path to the jar that needs to be indexed
     * @param pathToIndexFile
     *         The full path to the index file that needs to be generated
     * @throws IOException
     *         if the jar is not found or could not write into the index file
     * @since 3.8
     */

...
public class LocalVariableReferenceMatch extends SearchMatch {
     ...
     *         the inner-most enclosing member that references this local variable
     * @param accuracy
     ...
     * @param isWriteAccess
     *         whethre the match represents a write access
     ...
     */
    public LocalVariableReferenceMatch(IJavaElement enclosingElement, int accuracy, int offset, int length, boolean isReadAccess,

 ...
 * @see IEvaluationContext#evaluateCodeSnippet(String, String[], String[], int[], com.codenvy.eclipse.jdt.core.IType, boolean, boolean, ICodeSnippetRequestor, org.eclipse.core.runtime.IProgressMonitor)
 */

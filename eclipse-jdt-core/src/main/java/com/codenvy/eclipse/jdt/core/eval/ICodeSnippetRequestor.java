...
import com.codenvy.eclipse.jdt.internal.eval.EvaluationConstants;
 ...
 * @see IEvaluationContext#evaluateCodeSnippet(String, String[], String[], int[], com.codenvy.eclipse.jdt.core.IType, boolean, boolean,
 *      ICodeSnippetRequestor, org.eclipse.core.runtime.IProgressMonitor)
 */
public interface ICodeSnippetRequestor {
    ...
    * REPORTING A PROBLEM OF COMPILATION IN THE CODE SNIPPET
     ...
     *         the list of class file bytes
     * @param classFileCompoundNames
     ...
     *
     * @param problemMarker
     *         the problem marker (cannot be null)

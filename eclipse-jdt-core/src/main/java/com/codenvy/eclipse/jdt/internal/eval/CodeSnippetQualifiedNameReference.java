...
public class CodeSnippetQualifiedNameReference extends QualifiedNameReference
    ...
    public TypeBinding checkFieldAccess(BlockScope scope) {
        ...
        if ((this.indexOfFirstFieldBinding == 1 || declaringClass.isEnum()) && methodScope.enclosingSourceType() == declaringClass &&
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
        ...
        FieldBinding lastFieldBinding =
                this.otherBindings == null ? (FieldBinding)this.binding : this.otherBindings[this.otherBindings.length - 1];
    ...
    public void generateCompoundAssignment(BlockScope currentScope, CodeStream codeStream, Expression expression,
        ...
        FieldBinding lastFieldBinding =
                this.otherBindings == null ? (FieldBinding)this.binding : this.otherBindings[this.otherBindings.length - 1];
        if (lastFieldBinding.canBeSeenBy(getFinalReceiverType(), this, currentScope)) {
            super.generateCompoundAssignment(currentScope, codeStream, expression, operator, assignmentImplicitConversion,
                                             valueRequired);
            return;
        }
        lastFieldBinding = generateReadSequence(currentScope, codeStream);
    ...
    public void generateReceiver(CodeStream codeStream) {
        ...
        if (this.delegateThis != null) {
            codeStream.fieldAccess(Opcodes.OPC_getfield, this.delegateThis,
                                   null /* default declaringClass */); // delegated field access
        }
    }

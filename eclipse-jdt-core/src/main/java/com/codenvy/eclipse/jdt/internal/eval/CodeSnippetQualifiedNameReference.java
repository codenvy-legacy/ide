   ...
   implements EvaluationConstants, ProblemReasons
{
   ...
   public TypeBinding checkFieldAccess(BlockScope scope)
   {
      ...
      if ((this.indexOfFirstFieldBinding == 1 || declaringClass.isEnum()) && methodScope.enclosingSourceType() == declaringClass && methodScope.lastVisibleFieldID >= 0 && fieldBinding.id >= methodScope.lastVisibleFieldID && (!fieldBinding.isStatic() || methodScope.isStatic))
      {

...
public class ProblemReferenceBinding extends ReferenceBinding {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#closestMatch() */
    ...
    */
    ...
    public String toString() {
        ...
        buffer.append(this.compoundName == null ? "<null>" : new String(
                CharOperation.concatWith(this.compoundName, '.'))); //$NON-NLS-1$

...
public class ArrayAccess extends Expression
{
    ...
    * @since 3.0
    */
   public static final ChildPropertyDescriptor ARRAY_PROPERTY = new ChildPropertyDescriptor(ArrayAccess.class, "array",
      Expression.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
    ...
    * @since 3.0
    */
   public static final ChildPropertyDescriptor INDEX_PROPERTY = new ChildPropertyDescriptor(ArrayAccess.class, "index",
      Expression.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$

...
public abstract class ChangeClasspathOperation extends JavaModelOperation {
    ...
    protected void classpathChanged(ClasspathChange change, boolean refreshExternalFolder) throws JavaModelException {
        // reset the project's caches early since some clients rely on the project's caches being up-to-date when run inside an
        // IWorkspaceRunnable
        ...
        if (this.canChangeResources) {
            ...
            new ExternalFolderChange(project, change.oldResolvedClasspath).updateExternalFoldersIfNecessary(
                    refreshExternalFolder, null);

 ...
 * Note that Java model class {@link com.codenvy.eclipse.jdt.core.Flags} also
...
public final class Modifier extends ASTNode implements IExtendedModifier
{
   ...
   public static class ModifierKeyword
   {
       ...
       */
      public static final ModifierKeyword SYNCHRONIZED_KEYWORD = new ModifierKeyword("synchronized",
      ...
      static
      {
         ...
         ModifierKeyword[] ops = {PUBLIC_KEYWORD, PROTECTED_KEYWORD, PRIVATE_KEYWORD, STATIC_KEYWORD, ABSTRACT_KEYWORD, FINAL_KEYWORD, NATIVE_KEYWORD, SYNCHRONIZED_KEYWORD, TRANSIENT_KEYWORD, VOLATILE_KEYWORD, STRICTFP_KEYWORD};

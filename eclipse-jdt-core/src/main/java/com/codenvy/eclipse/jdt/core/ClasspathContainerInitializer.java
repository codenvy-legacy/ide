...
public abstract class ClasspathContainerInitializer {
     ...
     * <ul>
     * <li>{@link JavaCore#setClasspathContainer(IPath, IJavaProject[], IClasspathContainer[],
     * com.codenvy.eclipse.core.runtime.IProgressMonitor)}</li>
     ...
     * @see JavaCore#setClasspathContainer(IPath, IJavaProject[], IClasspathContainer[], com.codenvy.eclipse.core.runtime.IProgressMonitor)
     * @see IClasspathContainer
     */
     ...
     *
     * @param containerPath
     *         the path of the container which requires to be updated
     * @param project
     ...
     * @throws CoreException
     *         when <code>JavaCore#setClasspathContainer</code> would throw any.
     * @see JavaCore#setClasspathContainer(IPath, IJavaProject[], IClasspathContainer[], com.codenvy.eclipse.core.runtime.IProgressMonitor)
     ...
     *
     * @param containerPath
     *         the path of the container which requires a readable description
     * @param project
     ...
     *
     * @param containerPath
     *         the path of the container which failed to initialize
     * @param project
     *         the project from which the container is referenced
     ...
     *
     * @param containerPath
     *         the path of the container which is being checked
     * @param project

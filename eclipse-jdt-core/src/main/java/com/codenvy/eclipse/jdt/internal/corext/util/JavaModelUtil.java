...
import com.codenvy.eclipse.core.resources.IStorage;
...
import com.codenvy.eclipse.jdt.core.IJarEntryResource;
...
import com.codenvy.eclipse.jdt.internal.corext.CorextMessages;
import com.codenvy.eclipse.jdt.internal.corext.ValidateEditException;
...
public final class JavaModelUtil {
    ...
    /**
     * The latest available {@link com.codenvy.eclipse.jdt.core.JavaCore}{@code #VERSION_*} level.
     *
     * @since 3.7
     */
     ...
     * a name from an existing compilation unit with {@link #getRenamedCUName(com.codenvy.eclipse.jdt.core.ICompilationUnit, String)}
     * <p>
     * Note: Unlike {@link com.codenvy.eclipse.jdt.core.JavaCore#getJavaLikeExtensions()}, this suffix includes a leading ".".
     * </p>
     *
     * @see com.codenvy.eclipse.jdt.core.JavaCore#getJavaLikeExtensions()
     * @see com.codenvy.eclipse.jdt.core.JavaCore#isJavaLikeFileName(String)
     * @see com.codenvy.eclipse.jdt.core.JavaCore#removeJavaLikeExtension(String)
     * @see #getRenamedCUName(com.codenvy.eclipse.jdt.core.ICompilationUnit, String)
     */
     ...
     * @see #getTypeContainerName(com.codenvy.eclipse.jdt.core.IType)
     */
     ...
     * @throws com.codenvy.eclipse.jdt.core.JavaModelException
     *         thrown when the cu can not be accessed
     */
     ...
     * @throws com.codenvy.eclipse.jdt.core.JavaModelException
     *         thrown when the member can not be accessed
     */
    ...
    public static boolean isVisibleInHierarchy(IMember member, IPackageFragment pack) throws JavaModelException {
        ...
        if (Flags.isPublic(otherflags) || Flags.isProtected(
                otherflags) || (declaringType != null && isInterfaceOrAnnotation(declaringType))) {
            return true;
        } else if (Flags.isPrivate(otherflags)) {
            return false;
        }
     ...
     */
    public static IMethod findMethod(String name, String[] paramTypes, boolean isConstructor,
     ...
     *
     * @param hierarchy
     *         The hierarchy containing the type
     * @param type
     *         The type to start the search from
     * @param name
     *         The name of the method to find
     * @param paramTypes
     *         The type signatures of the parameters e.g. <code>{"QString;","I"}</code>
     ...
     *         thrown when the type can not be accessed
     */
    public static IMethod findMethodInHierarchy(ITypeHierarchy hierarchy, IType type, String name, String[] paramTypes,
     ...
     *
     * @param typeSignature
     *         the type signature string to check
    ...
    public static boolean isSuperType(ITypeHierarchy hierarchy, IType possibleSuperType, IType type) {
        ...
        IType superClass = hierarchy.getSuperclass(type);
        if (superClass != null && (possibleSuperType.equals(superClass) || isSuperType(hierarchy, possibleSuperType,
                                                                                       superClass))) {
            return true;
        }
     ...
     * @see com.codenvy.eclipse.jdt.core.IClasspathEntry#getExclusionPatterns
     */
     ...
     *         the compilation unit
     * @throws com.codenvy.eclipse.jdt.core.JavaModelException
     *         thrown when the compilation unit can not be accessed
     */
    public static void reconcile(ICompilationUnit unit) throws JavaModelException {
        unit.reconcile(ICompilationUnit.NO_AST, false /* don't force problem detection */, null /* use primary owner */,
     ...
     * @throws com.codenvy.eclipse.jdt.core.JavaModelException
     *         thrown if accessing the container failed
     */
    public static IClasspathEntry getClasspathEntryToEdit(IJavaProject jproject, IPath containerPath,
                                                          IPath libPath) throws JavaModelException {
     ...
     *
     * @param root
     *         a package fragment root
     * @return the corresponding classpath entry
     * @throws com.codenvy.eclipse.jdt.core.JavaModelException
     *         if accessing the entry failed
     * @since 3.6
     */
    ...
    private static void addAllCus(HashSet<ICompilationUnit> collector,
    ...
    public static boolean is50OrHigher(IJavaProject project) {
        String source = project != null ? project.getOption(JavaCore.COMPILER_SOURCE, true) : JavaCore.getOption(
     ...
     *         a compilation unit
     * @param newMainName
     *         the new name of the cu's main type (without extension)
     ...
     */
    public static void applyEdit(ICompilationUnit cu, TextEdit edit, boolean save,

...
public abstract class CreateElementInCUOperation extends JavaModelOperation {
        ...
        if (propertyDescriptor instanceof ChildListPropertyDescriptor) {
            ...
            switch (this.insertionPolicy) {
                case INSERT_BEFORE:
                    ...
                    // case of an empty import list: the anchor element is the top level type and cannot be used in insertBefore as it is
                    // not the same type
                    {
                ...
                case INSERT_AFTER:
                    ...
                    // case of an empty import list: the anchor element is the top level type and cannot be used in insertAfter as it is
                    // not the same type
                    {
                        rewrite.insertLast(child, null);
                    }
     ...
     * @see com.codenvy.eclipse.jdt.core.JavaConventions
     */

...
import com.codenvy.eclipse.jdt.internal.compiler.parser.AbstractCommentParser;
...
class DocCommentParser extends AbstractCommentParser
{
         ...
         case TerminalTokens.TokenNameIdentifier:
            switch (tagName[0])
            {
               ...
               case 'l':
                  ...
                  break;
               case 'v':
                  if (this.sourceLevel >= ClassFileConstants.JDK1_5 && length == TAG_VALUE_LENGTH && CharOperation.equals(
                     TAG_VALUE, tagName))
                  {
   ...
   protected boolean pushParamName(boolean isTypeParam)
   {
      ...
      if (isTypeParam)
      { // specific storage for @param <E> (see bug 79809)

...
public class IfStatement extends Statement {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        boolean reportDeadCodeForKnownPattern = !isKnowDeadCodePattern(
        ...
        FlowInfo mergedInfo = FlowInfo.mergedOptimizedBranchesIfElse(thenFlowInfo, isConditionOptimizedTrue, elseFlowInfo,
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream) {
        ...
        boolean hasElsePart = !((cst != Constant.NotAConstant && cst.booleanValue() == true) || this.elseStatement == null ||
        ...
        if (hasThenPart) {
            ...
            if (cst != Constant.NotAConstant && cst.booleanValue() == false) {
                ...
                this.condition.generateOptimizedBoolean(currentScope, codeStream, endifLabel, null, true/*cst == Constant.NotAConstant*/);
            }
            // generate else statement
            // May loose some local variable initializations : affecting the local variable attributes
            if (this.elseInitStateIndex != -1) {

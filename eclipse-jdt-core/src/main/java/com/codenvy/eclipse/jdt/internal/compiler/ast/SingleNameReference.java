      ...
      switch (this.bits & ASTNode.RestrictiveFlagMASK)
      {
         ...
         case Binding.LOCAL: // assigning to a local variable
            ...
            else
            {
               ...
               {
                  assignment.expression.generateCode(currentScope, codeStream, true);               /* Even though the value may not be required, we force it to be produced, and discard it later

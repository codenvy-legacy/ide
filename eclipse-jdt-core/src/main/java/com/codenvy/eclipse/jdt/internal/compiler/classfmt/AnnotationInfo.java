...
import com.codenvy.eclipse.jdt.internal.compiler.impl.ByteConstant;
import com.codenvy.eclipse.jdt.internal.compiler.impl.CharConstant;
import com.codenvy.eclipse.jdt.internal.compiler.impl.DoubleConstant;
import com.codenvy.eclipse.jdt.internal.compiler.impl.FloatConstant;
import com.codenvy.eclipse.jdt.internal.compiler.impl.IntConstant;
import com.codenvy.eclipse.jdt.internal.compiler.impl.LongConstant;
import com.codenvy.eclipse.jdt.internal.compiler.impl.ShortConstant;
   ...
   Object decodeDefaultValue()
   {
      ...
      switch (tag)
      {
         ...
         case 'c':
            ...
            break;
         case '@':
            value = new AnnotationInfo(this.reference, this.constantPoolOffsets, this.readOffset + this.structOffset,
               false, true);
   ...
   private int readRetentionPolicy(int offset)
   {
      ...
      switch (tag)
      {
         case 'e':
            ...
            currentOffset += 2;
            if (typeName.length == 38 && CharOperation.equals(typeName,
               ConstantPool.JAVA_LANG_ANNOTATION_RETENTIONPOLICY))
            {

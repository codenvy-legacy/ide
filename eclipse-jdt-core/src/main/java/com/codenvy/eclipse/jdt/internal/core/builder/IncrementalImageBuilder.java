...
public class IncrementalImageBuilder extends AbstractImageBuilder {
                ...
                if (com.codenvy.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(resourceName)) {
                    ...
                    switch (sourceDelta.getKind()) {
                        case IResourceDelta.ADDED:
                            ...
                            if (!this.newState
                                    .isDuplicateLocator(typeName, typeLocator)) { // adding dependents results in 2 duplicate errors
                                if (JavaBuilder.DEBUG) {
    ...
    /**
     * @see com.codenvy.eclipse.jdt.internal.core.builder.AbstractImageBuilder#writeClassFileContents(com.codenvy.eclipse.jdt.internal
     * .compiler.ClassFile,
     *      com.codenvy.eclipse.core.resources.IFile, java.lang.String, boolean, com.codenvy.eclipse.jdt.internal.core.builder.SourceFile)
     */

...
public class ParameterizedMethodBinding extends MethodBinding
{
      ...
      MethodBinding originalMethod)
   {
      ...
      this.originalMethod = originalMethod;      /* missing type bit cannot be copied as is it might come from the return type or a parameter type that
      ...
      Scope scope)
   {
      ...
      method.returnType = environment.createParameterizedType(genericClassType,
         new TypeBinding[]{environment.createWildcard(genericClassType, 0, rawType, null /*no extra bound*/,

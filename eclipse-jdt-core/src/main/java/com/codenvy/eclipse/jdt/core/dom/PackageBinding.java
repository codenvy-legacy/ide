            ...
            switch (fragType)
            {
               ...
               case IPackageFragmentRoot.K_BINARY:
                  ...
                  if (answer != null && answer.isBinaryType())
                  {
                     ...
                     com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] binaryInstances = BinaryTypeBinding.createAnnotations(
                        binaryAnnotations, this.binding.environment, missingTypeNames);
                     com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] allInstances = com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding.addStandardAnnotations(

...
public abstract class ClassFileBytesDisassembler
{
    ...
    * @throws ClassFormatException if the classfile bytes are ill-formed
    */
    ...
    * @throws ClassFormatException if the classfile bytes are ill-formed
    */
   public abstract String disassemble(byte[] classFileBytes, String lineSeparator,
      int mode) throws ClassFormatException;

...
public interface ICompletionRequestor {
     ...
     *         Name of the package that contains the super type of this
    ...
    void acceptAnonymousType(char[] superTypePackageName, char[] superTypeName, char[][] parameterPackageNames,
                             char[][] parameterTypeNames, char[][] parameterNames, char[] completionName, int modifiers,
                             int completionStart,
     ...
     *         Name of the class.
     * @param completionName
     *         The completion for the class.	Can include ';' for imported classes.
     * @param modifiers
     ...
     * @param completionName
     *         The completion for the interface.	Can include ';' for imported interfaces.
     * @param modifiers
     ...
     * @param completionName
     *         The completion for the method. Can include zero, one or two brackets. If the closing bracket is included, then the cursor

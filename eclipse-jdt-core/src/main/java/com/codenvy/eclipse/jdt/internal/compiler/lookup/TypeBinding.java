...
abstract public class TypeBinding extends Binding {
    ...
    public final static BaseTypeBinding NULL = new BaseTypeBinding(TypeIds.T_null, TypeConstants.NULL,
                                                                   new char[]{'N'}); //N stands for null even if it is never internally used
    ...
    public TypeBinding findSuperTypeOriginatingFrom(TypeBinding otherType) {
        ...
        switch (kind()) {
            case Binding.ARRAY_TYPE:
                ...
                TypeBinding leafSuperType = arrayType.leafComponentType.findSuperTypeOriginatingFrom(
                        otherType.leafComponentType());
    ...
    public TypeBinding getErasureCompatibleType(TypeBinding declaringClass) {
        switch (kind()) {
            ...
            case Binding.INTERSECTION_TYPE:
                ...
                if (intersection.superclass != null && intersection.superclass.findSuperTypeOriginatingFrom(
                        declaringClass) != null) {
    ...
    private boolean isProvableDistinctSubType(TypeBinding otherType) {
        if (otherType.isInterface()) {
            ...
            if (isInterface()) {
                if (otherType.isArrayType() || ((otherType instanceof ReferenceBinding) && ((ReferenceBinding)otherType).isFinal()) ||
    ...
    private boolean isProvablyDistinctTypeArgument(TypeBinding otherArgument, final ParameterizedTypeBinding paramType,
        ...
        if (lowerBound1 != null) {
            ...
            if (lowerBound2 != null) {
                ...
                return upperBound1.isProvableDistinctSubType(upperBound2) && upperBound2.isProvableDistinctSubType(
                        upperBound1);
            } else {
        ...
        switch (otherType.kind()) {
            ...
            case Binding.TYPE_PARAMETER: {
                ...
                if (upperBound.id == TypeIds.T_JavaLangObject && otherBounds == null) {
                    return false; // but given class A<T>, A<?> stays an unbounded wildcard, see https://bugs.eclipse.org/bugs/show_bug
                    // .cgi?id=348956
                }
    ...
    public char[] qualifiedPackageName() {
        ...
        return packageBinding == null || packageBinding.compoundName == CharOperation.NO_CHAR_CHAR ? CharOperation.NO_CHAR

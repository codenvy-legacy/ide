...
public class RefactoringExecutionHelper
{
    ...
    * @param stopSeverity a refactoring status constant from {@link com.codenvy.eclipse.ltk.core.refactoring.RefactoringStatus}
    * @param saveMode     a save mode from {RefactoringSaveHelper}
    */

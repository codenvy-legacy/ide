 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.core.formatter;

import com.codenvy.eclipse.jdt.core.JavaCore;
import com.codenvy.eclipse.jdt.core.ToolFactory;
import com.codenvy.eclipse.jdt.internal.formatter.DefaultCodeFormatterOptions;
...
public class DefaultCodeFormatterConstants {
     ...
     * @see #FALSE
     * @since 3.1
     * @deprecated Use {@link #FORMATTER_COMMENT_CLEAR_BLANK_LINES_IN_BLOCK_COMMENT} and {@link
     * #FORMATTER_COMMENT_CLEAR_BLANK_LINES_IN_JAVADOC_COMMENT}
     */
    public final static String FORMATTER_COMMENT_CLEAR_BLANK_LINES = "org.eclipse.jdt.core.formatter.comment.clear_blank_lines";
    //$NON-NLS-1$
    ...
    /**
     * <pre>
     * FORMATTER / Option to control whether the white space between code and line comments should be preserved or replaced with a single
     * space
     ...
     * @since 3.3
     */
    public final static String FORMATTER_COMMENT_FORMAT_BLOCK_COMMENT = "org.eclipse.jdt.core.formatter.comment.format_block_comments";
    //$NON-NLS-1$
     ...
     * @since 3.3
     */
    public final static String FORMATTER_COMMENT_FORMAT_JAVADOC_COMMENT = "org.eclipse.jdt.core.formatter.comment.format_javadoc_comments";
    //$NON-NLS-1$
    ...
    /**
     * <pre>
     * FORMATTER / Option to use the disabling and enabling tags defined respectively by the {@link #FORMATTER_DISABLING_TAG} and the {@link
     * #FORMATTER_ENABLING_TAG} options.
    ...
    public static final String FORMATTER_USE_ON_OFF_TAGS                                                   =
            JavaCore.PLUGIN_ID + ".formatter.use_on_off_tags";//$NON-NLS-1$
    /**
     * <pre>
    ...
    public static final String FORMATTER_DISABLING_TAG                                                     =
            JavaCore.PLUGIN_ID + ".formatter.disabling_tag";//$NON-NLS-1$
    /**
     * <pre>
     * FORMATTER / Option to define the tag to put in a comment to re-enable the formatting after it has been disabled (see {@link
    ...
    public static final String FORMATTER_ENABLING_TAG                                                      =
            JavaCore.PLUGIN_ID + ".formatter.enabling_tag";//$NON-NLS-1$
    /**
     * <pre>
    ...
    public static final String FORMATTER_INDENT_EMPTY_LINES                                                =
            JavaCore.PLUGIN_ID + ".formatter.indent_empty_lines"; //$NON-NLS-1$
    /**
     * <pre>
    ...
    public static final String FORMATTER_INSERT_SPACE_BEFORE_CLOSING_ANGLE_BRACKET_IN_PARAMETERIZED_TYPE_REFERENCE =
            JavaCore.PLUGIN_ID + ".formatter.insert_space_before_closing_angle_bracket_in_parameterized_type_reference";
    //$NON-NLS-1$
    /**
     * <pre>

...
public final class MoveStaticMembersDescriptor extends JavaRefactoringDescriptor
{
   ...
   public MoveStaticMembersDescriptor(String project, String description, String comment, Map arguments, int flags)
   {
      ...
      fMembers = (IMember[])JavaRefactoringDescriptorUtil.getJavaElementArray(fArguments, null, ATTRIBUTE_ELEMENT, 1,
         project, IMember.class);
   }
    ...
    * to the moved ones.
    *
    * @param delegate <code>true</code> to keep the originals, <code>false</code>
    *                 otherwise
    */
   ...
   public RefactoringStatus validateDescriptor()
   {
      ...
      {
         status.merge(
            RefactoringStatus.createFatalErrorStatus(DescriptorMessages.MoveStaticMembersDescriptor_no_members));
      }
      else
      {

                    ...
                    if (existing instanceof PackageFragmentRoot) {
                        ...
                        if (rootPosition != exisitingPosition) { // if not equal
                            this.packageFragments.put(pkgName,
                                                      exisitingPosition < rootPosition ? new IPackageFragmentRoot[]{
                                                              (PackageFragmentRoot)existing, root} : new IPackageFragmentRoot[]{root,
 ...
 */
            ...
            for (int i = 0, length = keys.length; i < length; i++) {
                ...
                if (pkgName != null) {
                    boolean match = isStarPattern || (hasPatternChars ? CharOperation.match(lowercaseName,
                                                                                            Util.concatCompoundNameToCharArray(pkgName),
                                                                                            false)
    ...
    public Answer findType(String typeName, String packageName, boolean partialMatch, int acceptFlags,
        ...
        return findType(typeName, packageName, partialMatch, acceptFlags, true/* consider secondary types */, false/* do NOT wait for
      indexes */,

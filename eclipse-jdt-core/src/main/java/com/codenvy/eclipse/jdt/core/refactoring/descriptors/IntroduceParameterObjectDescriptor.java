...
import com.codenvy.eclipse.jdt.internal.core.refactoring.descriptors.JavaRefactoringDescriptorUtil;
...
public class IntroduceParameterObjectDescriptor extends JavaRefactoringDescriptor {
    ...
    public static class Parameter {
        ...
        /**
         * The index of the parameter in the original method signature. The parameter object has the special index {@link
         * IntroduceParameterObjectDescriptor#PARAMETER_OBJECT_IDX}.
         * The position in the new method signature depends on the position in the array passed to {@link
         ...
         * default is <code>false</code>. Changing the creatField property of the parameter object will throw a {@link
         * IllegalArgumentException}
         *
         * @param createField
         *         <code>true</code> if the parameter should be created as field, <code>false</code>
     ...
     *
     * @param method
     *         derive parameter from this method
     ...
     */
    public IntroduceParameterObjectDescriptor(final String project, final String description, final String comment,
    ...
    /**
     * Returns the name of the parameter. Can return <code>null</code> in which case the refactoring chooses a name. Default is
     * <code>null</code>
     *
     * @return the name of the parameter. Can return <code>null</code> in which case the refactoring chooses a name. Default is
     *         <code>null</code>
     */
    ...
    protected void populateArgumentMap() {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            JavaRefactoringDescriptorUtil.setInt(fArguments,
                                                 JavaRefactoringDescriptorUtil.getAttributeName(PARAMETER_IDX, i), param.getIndex());
            JavaRefactoringDescriptorUtil.setBoolean(fArguments,
                                                     JavaRefactoringDescriptorUtil.getAttributeName(PARAMETER_CREATE_FIELD, i),
                                                     param.isCreateField());
            if (param.isCreateField()) {
                JavaRefactoringDescriptorUtil.setString(fArguments,
    ...
    private void initializeParameter(Map map) throws IllegalArgumentException {
        ...
        boolean[] createField = JavaRefactoringDescriptorUtil.getBooleanArray(map, PARAMETER_COUNT,
                                                                              PARAMETER_CREATE_FIELD, 0);
        ...
        for (int i = 0; i < idx.length; i++) {
            ...
            if (index == PARAMETER_OBJECT_IDX) {
                ...
                if (createField[i]) {
                    parameter.setFieldName(JavaRefactoringDescriptorUtil.getString(map,
                                                                                   JavaRefactoringDescriptorUtil
                                                                                           .getAttributeName(PARAMETER_FIELD_NAME, i)));
                }
            }
        }
     ...
     *
     * @param className
     *         the name of the generated class or <code>null</code>. Default is <code>null</code>
     */
     ...
     *
     * @param delegate
     *         <code>true</code> to keep delegates. Default is <code>false</code>
     */
     ...
     *
     * @param deprecateDelegate
     *         <code>true</code> to deprecate kept delegates. Default is <code>false</code>
     */
     ...
     *
     * @param getters
     *         <code>true</code> to create getters. Default is <code>false</code>.
     */
     ...
     *
     * @param method
     *         the method. May not be <code>null</code>
     */
     ...
     *
     * @param packageName
     *         the package for the top level class or <code>null</code>. Default is <code>null</code>.
     */
     ...
     *
     * @param parameterName
     *         the name of the parameter or <code>null</code>. Default is <code>null</code>.
     */
     ...
     *
     * @param parameters
     *         the parameters or <code>null</code>. Default is <code>null</code>
     */
     ...
     *
     * @param setters
     *         <code>true</code> to create setters. Default is <code>false</code>
     */
     ...
     *
     * @param topLevel
     *         <code>true</code> to create the parameter object as top level. Default is <code>true</code>
     */
    ...
    public RefactoringStatus validateDescriptor() {
        ...
        if (fParameters != null) {
            ...
            for (int i = 0; i < fParameters.length; i++) {
                ...
                if (parameter.isCreateField()) {
                    ...
                    if (fieldName == null) {
                        result.addError(
                                "The parameter " + parameter.getIndex() +
                                " is marked for field creation but does not have a field name"); //$NON-NLS-1$ //$NON-NLS-2$
                    } else {
        ...
        if (fClassName != null) {
            result.merge(
                    RefactoringStatus.create(JavaConventions.validateIdentifier(fClassName, sourceLevel, complianceLevel)));
        }
        if (fParameterName != null) {
            result.merge(
                    RefactoringStatus.create(JavaConventions.validateIdentifier(fParameterName, sourceLevel, complianceLevel)));
        }
        if (fPackageName != null && !"".equals(fPackageName)) { //$NON-NLS-1$
            result.merge(
                    RefactoringStatus.create(JavaConventions.validatePackageName(fPackageName, sourceLevel, complianceLevel)));
        }
        return result;
    }
}

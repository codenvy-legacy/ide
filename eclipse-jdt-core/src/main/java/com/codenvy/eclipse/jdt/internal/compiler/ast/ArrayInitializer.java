   ...
   public TypeBinding resolveTypeExpecting(BlockScope scope, TypeBinding expectedType)
   {
      ...
      if (expectedType instanceof ArrayBinding)
      {
         ...
         for (int i = 0, length = this.expressions.length; i < length; i++)
         {
            ...
            TypeBinding expressionType = expression instanceof ArrayInitializer ? expression.resolveTypeExpecting(scope,
               elementType) : expression.resolveType(scope);
            ...
            if (expression.isConstantValueOfTypeAssignableToType(expressionType,
               elementType) || expressionType.isCompatibleWith(elementType))
            {

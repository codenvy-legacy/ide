...
public class RecoveredField extends RecoveredElement {
    ...
    public RecoveredElement add(TypeDeclaration typeDeclaration, int bracketBalanceValue) {
        ...
        if (this.alreadyCompletedFieldInitialization || ((typeDeclaration.bits & ASTNode.IsAnonymousType) == 0) ||
            ...
            if (this.anonymousTypes == null) {
                ...
                if (this.anonymousTypeCount == this.anonymousTypes.length) {
                    System.arraycopy(this.anonymousTypes, 0,
                                     (this.anonymousTypes = new RecoveredType[2 * this.anonymousTypeCount]), 0, this.anonymousTypeCount);
                }
            }
    ...
    public FieldDeclaration updatedFieldDeclaration(int depth, Set knownTypes) {   /* update annotations */
        if (this.modifiers != 0) {

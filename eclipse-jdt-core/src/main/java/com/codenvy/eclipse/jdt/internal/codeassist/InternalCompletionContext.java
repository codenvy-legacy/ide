...
public class InternalCompletionContext extends CompletionContext {
    ...
    /**
     * Returns the innermost enclosing Java element which contains the completion location or <code>null</code> if this element cannot be
     * computed.
     * The returned Java element and all Java elements in the same compilation unit which can be navigated to from the returned Java element
     ...
     * </ul>
     *
     * @return the innermost enclosing Java element which contains the completion location or <code>null</code> if this element cannot be
     *         computed.
     * @throws UnsupportedOperationException
     *         if the context is not an extended context
     * @since 3.4
     */
     ...
     * @see com.codenvy.eclipse.jdt.core.dom.ASTParser#createASTs(ICompilationUnit[], String[],
     * com.codenvy.eclipse.jdt.core.dom.ASTRequestor,

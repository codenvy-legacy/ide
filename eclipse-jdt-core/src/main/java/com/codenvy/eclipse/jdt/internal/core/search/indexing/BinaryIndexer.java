...
public class BinaryIndexer extends AbstractIndexer implements SuffixConstants {
            ...
            switch (tag) {
                ...
                case ClassFileConstants.InterfaceMethodRefTag:
                    ...
                    if (CharOperation.equals(INIT, name)) {
                        ...
                        // add a constructor reference, use class name to extract arg count if it's a local type to remove synthetic
                        // parameter
                ...
                case ClassFileConstants.ClassTag:
                    ...
                    // also add a simple reference on each segment of the qualification (see http://bugs.eclipse.org/bugs/show_bug
                    // .cgi?id=24741)
    ...
    private char[] removeFirstSyntheticParameter(char[] descriptor) {
        ...
        if (descriptor[1] != ')') {
            ...
            int start = com.codenvy.eclipse.jdt.internal.compiler.util.Util.scanTypeSignature(descriptor, 1) + 1;

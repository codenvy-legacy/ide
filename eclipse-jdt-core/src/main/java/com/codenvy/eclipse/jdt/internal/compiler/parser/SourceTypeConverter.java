...
import com.codenvy.eclipse.jdt.internal.compiler.env.ISourceImport;
...
import com.codenvy.eclipse.jdt.internal.core.InitializerElementInfo;
import com.codenvy.eclipse.jdt.internal.core.JavaElement;
import com.codenvy.eclipse.jdt.internal.core.PackageFragment;
import com.codenvy.eclipse.jdt.internal.core.SourceAnnotationMethodInfo;
import com.codenvy.eclipse.jdt.internal.core.SourceField;
import com.codenvy.eclipse.jdt.internal.core.SourceFieldElementInfo;
...
*/		}
	...
	private CompilationUnitDeclaration convert(ISourceType[] sourceTypes, CompilationResult compilationResult) throws JavaModelException
   {
		...
		com.codenvy.eclipse.jdt.core.ICompilationUnit cuHandle = topLevelTypeInfo.getHandle().getCompilationUnit();

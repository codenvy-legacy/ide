...
public final class Signature
{
    ...
    * Value is <code>'['</code>.
    */
   public static final char C_ARRAY = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_ARRAY;

   /**
    * Character constant indicating the primitive type boolean in a signature.
    * Value is <code>'Z'</code>.
    */
   public static final char C_BOOLEAN = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_BOOLEAN;

   /**
    * Character constant indicating the primitive type byte in a signature.
    * Value is <code>'B'</code>.
    */
   public static final char C_BYTE = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_BYTE;
    ...
    * @since 3.1
    */
   public static final char C_CAPTURE = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_CAPTURE;

   /**
    * Character constant indicating the primitive type char in a signature.
    * Value is <code>'C'</code>.
    */
   public static final char C_CHAR = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_CHAR;
    ...
    * @since 3.0
    */
   public static final char C_COLON = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_COLON;

   /**
    * Character constant indicating the dollar in a signature.
    * Value is <code>'$'</code>.
    */
   public static final char C_DOLLAR = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_DOLLAR;

   /**
    * Character constant indicating the dot in a signature.
    * Value is <code>'.'</code>.
    */
   public static final char C_DOT = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_DOT;

   /**
    * Character constant indicating the primitive type double in a signature.
    * Value is <code>'D'</code>.
    */
   public static final char C_DOUBLE = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_DOUBLE;
    ...
    * @since 3.1
    */
   public static final char C_EXCEPTION_START = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_EXCEPTION_START;
    ...
    * @since 3.1
    */
   public static final char C_EXTENDS = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_EXTENDS;

   /**
    * Character constant indicating the primitive type float in a signature.
    * Value is <code>'F'</code>.
    */
   public static final char C_FLOAT = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_FLOAT;
    ...
    * @since 3.0
    */
   public static final char C_GENERIC_END = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_GENERIC_END;
    ...
    * @since 3.0
    */
   public static final char C_GENERIC_START = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_GENERIC_START;

   /**
    * Character constant indicating the primitive type int in a signature.
    * Value is <code>'I'</code>.
    */
   public static final char C_INT = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_INT;
    ...
    */
   public static final char C_LONG = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_LONG;

   /**
    * Character constant indicating the end of a named type in a signature.
    * Value is <code>';'</code>.
    */
   public static final char C_NAME_END = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_NAME_END;

   /**
    * Character constant indicating the end of a parameter type list in a
    * signature. Value is <code>')'</code>.
    */
   public static final char C_PARAM_END = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_PARAM_END;

   /**
    * Character constant indicating the start of a parameter type list in a
    * signature. Value is <code>'('</code>.
    */
   public static final char C_PARAM_START = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_PARAM_START;

   /**
    * Character constant indicating the start of a resolved, named type in a
    * signature. Value is <code>'L'</code>.
    */
   public static final char C_RESOLVED = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_RESOLVED;

   /**
    * Character constant indicating the semicolon in a signature.
    * Value is <code>';'</code>.
    */
   public static final char C_SEMICOLON = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_SEMICOLON;

   /**
    * Character constant indicating the primitive type short in a signature.
    * Value is <code>'S'</code>.
    */
   public static final char C_SHORT = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_SHORT;
    ...
    * @since 3.0
    */
   public static final char C_STAR = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_STAR;
    ...
    * @since 3.1
    */
   public static final char C_SUPER = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_SUPER;
    ...
    * @since 3.0
    */
   public static final char C_TYPE_VARIABLE = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_TYPE_VARIABLE;

   /**
    * Character constant indicating the start of an unresolved, named type in a
    * signature. Value is <code>'Q'</code>.
    */
   public static final char C_UNRESOLVED = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_UNRESOLVED;

   /**
    * Character constant indicating result type void in a signature.
    * Value is <code>'V'</code>.
    */
   public static final char C_VOID = com.codenvy.eclipse.jdt.internal.compiler.util.Util.C_VOID;
    ...
    * @param buffer                the string buffer to append to
    * @return the 0-based character index of the last character
    * @throws IllegalArgumentException if this is not a list of type argument
    *                                  signatures
    ...
    * @return the 0-based character index of the last character
    * @throws IllegalArgumentException if this is not a type signature, or if isVarArgs is <code>true</code>,
    ...
    * @throws IllegalArgumentException if the signature is not syntactically
    *                                  correct
    * @since 2.0
    */
    ...
    * @throws IllegalArgumentException if the signature is syntactically
    *                                  incorrect
    * @since 2.0
    */
   ...
   public static char[] getSimpleName(char[] name)
   {
      ...
      appendArgumentSimpleNames(name, lastGenericStart, lastGenericEnd, buffer);
      buffer.append(name, lastGenericEnd + 1,
   ...
   public static String getSimpleName(String name)
   {
      ...
      buffer.append(nameChars, lastGenericEnd + 1,
         length - lastGenericEnd - 1); // copy trailing portion, may contain dimensions

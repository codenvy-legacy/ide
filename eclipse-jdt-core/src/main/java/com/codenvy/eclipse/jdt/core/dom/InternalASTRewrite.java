...
import com.codenvy.eclipse.jdt.internal.core.dom.rewrite.ListRewriteEvent;
...
class InternalASTRewrite extends NodeEventHandler {
     ...
     *
     * @param document
     *         Document which describes the code of the AST that is passed in in the
    ...
    public TextEdit rewriteAST(IDocument document, Map options) {
        ...
        if (rootNode != null) {
            ...
            ASTRewriteAnalyzer visitor = new ASTRewriteAnalyzer(content, lineInfo, lineDelim, result, this.eventStore,
                                                                this.nodeStore, comments, currentOptions, xsrComputer,

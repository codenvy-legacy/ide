...
public class EnumeratedTypeSet extends TypeSet {
    ...
    public static EnumeratedTypeSet makeArrayTypesForElements(Iterator<TType> elemTypes,
    ...
    public TypeSet lowerBound() {
        ...
        for (Iterator<TType> iter = fMembers.iterator(); iter.hasNext(); ) {
            ...
            if (t instanceof ArrayType) {
                ArrayType at = (ArrayType)t;
                int numDims = at.getDimensions();
                for (Iterator<TType> superIter = TTypes.getAllSuperTypesIterator(

...
protected CompilationUnitDeclaration buildBindings(ICompilationUnit compilationUnit, boolean isTopLevelOrMember) throws JavaModelException {
	// source unit
	com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = (com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit) compilationUnit;

...
import com.codenvy.eclipse.jdt.internal.core.search.PathCollector;
...
public class SuperTypeNamesCollector {
    ...
    protected CompilationUnitDeclaration buildBindings(ICompilationUnit compilationUnit, boolean isTopLevelOrMember)
        ...
        com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit =
                (com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit)compilationUnit;
            ...
            try {
                ...
                if (openable instanceof ICompilationUnit) {
                    ...
                    CompilationUnitDeclaration parsedUnit =
                            buildBindings(unit, true /*only top level and member types are visible to the focus type*/);
                    if (parsedUnit != null)

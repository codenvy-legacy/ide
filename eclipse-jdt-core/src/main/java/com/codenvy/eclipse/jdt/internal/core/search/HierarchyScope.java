...
public class HierarchyScope extends AbstractSearchScope implements SuffixConstants {
     ...
     *
     * @param project
     *         constrain the search result to this project,
     *         or <code>null</code> if search should consider all types in the workspace
     * @param type
     *         the focus type of the hierarchy
     * @param owner
     ...
     * @param noMembersOrEnclosingTypes
     ...
     *         if true the focus type <code>type</code> is included in the resulting scope, otherwise it is excluded
     */
    public HierarchyScope(IJavaProject project, IType type, WorkingCopyOwner owner, boolean onlySubtypes, boolean noMembersOrEnclosingTypes,
                          boolean includeFocusType) throws JavaModelException {
        this(type, owner);

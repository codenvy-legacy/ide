...
import com.codenvy.eclipse.jdt.internal.codeassist.impl.AssistCompilationUnit;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.SignatureWrapper;
...
public class InternalExtendedCompletionContext {
    ...
    private void computeEnclosingJavaElements() {
        ...
        if (this.typeRoot.getElementType() == IJavaElement.COMPILATION_UNIT) {
            ICompilationUnit original = (com.codenvy.eclipse.jdt.core.ICompilationUnit)this.typeRoot;
            ...
            com.codenvy.eclipse.jdt.core.ICompilationUnit handle =
                    new AssistCompilationUnit(original, this.owner, handleToBinding, handleToInfo);
                    ...
                    for (int i = 0; i < fields.length; i++) {
                        if (fields[i] instanceof Initializer) {
                            ...
                            if (initializer.block.sourceStart <= astNode.sourceStart &&
                                ...
                                searchVisibleVariablesAndMethods(scope, this.visibleLocalVariables, this.visibleFields, this.visibleMethods,
                                                                 notInJavadoc);
                                break done;
                            }
                        } else {
                            ...
                            if (fieldDeclaration.initialization != null) {
                                ...
                                if (isInsideInitializer) {
                                    searchVisibleVariablesAndMethods(scope, this.visibleLocalVariables, this.visibleFields,
                                                                     this.visibleMethods, notInJavadoc);
    ...
    private TypeBinding getTypeFromSignature(String typeSignature, Scope scope) {
        ...
        try {
            ...
            assignableTypeBinding = this.lookupEnvironment
                    .getTypeFromTypeSignature(wrapper, typeVariables, this.assistScope.enclosingClassScope().referenceContext.binding,
                                              null);

 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.internal.formatter;
...
import com.codenvy.eclipse.jdt.core.formatter.CodeFormatter;
import com.codenvy.eclipse.jdt.core.formatter.DefaultCodeFormatterConstants;
import com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor;
import com.codenvy.eclipse.jdt.internal.compiler.ast.AND_AND_Expression;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayInitializer;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.AssertStatement;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.BreakStatement;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.CharLiteral;
import com.codenvy.eclipse.jdt.internal.compiler.ast.ClassLiteralAccess;
import com.codenvy.eclipse.jdt.internal.compiler.ast.Clinit;
import com.codenvy.eclipse.jdt.internal.compiler.ast.CombinedBinaryExpression;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.ContinueStatement;
import com.codenvy.eclipse.jdt.internal.compiler.ast.DoStatement;
import com.codenvy.eclipse.jdt.internal.compiler.ast.DoubleLiteral;
import com.codenvy.eclipse.jdt.internal.compiler.ast.EmptyStatement;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.FalseLiteral;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.FloatLiteral;
import com.codenvy.eclipse.jdt.internal.compiler.ast.ForStatement;
import com.codenvy.eclipse.jdt.internal.compiler.ast.ForeachStatement;
import com.codenvy.eclipse.jdt.internal.compiler.ast.IfStatement;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.IntLiteral;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.LongLiteral;
import com.codenvy.eclipse.jdt.internal.compiler.ast.MarkerAnnotation;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.NormalAnnotation;
import com.codenvy.eclipse.jdt.internal.compiler.ast.NullLiteral;
import com.codenvy.eclipse.jdt.internal.compiler.ast.OR_OR_Expression;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.PostfixExpression;
import com.codenvy.eclipse.jdt.internal.compiler.ast.PrefixExpression;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedThisReference;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.SingleMemberAnnotation;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.StringLiteral;
import com.codenvy.eclipse.jdt.internal.compiler.ast.StringLiteralConcatenation;
import com.codenvy.eclipse.jdt.internal.compiler.ast.SuperReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.SwitchStatement;
import com.codenvy.eclipse.jdt.internal.compiler.ast.SynchronizedStatement;
import com.codenvy.eclipse.jdt.internal.compiler.ast.ThisReference;
import com.codenvy.eclipse.jdt.internal.compiler.ast.ThrowStatement;
import com.codenvy.eclipse.jdt.internal.compiler.ast.TrueLiteral;
import com.codenvy.eclipse.jdt.internal.compiler.ast.TryStatement;
...
import com.codenvy.eclipse.jdt.internal.compiler.ast.WhileStatement;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope;
...
import com.codenvy.eclipse.jdt.internal.core.util.CodeSnippetParsingUtil;
import com.codenvy.eclipse.jdt.internal.formatter.align.Alignment;
import com.codenvy.eclipse.jdt.internal.formatter.align.AlignmentException;
...
public class CodeFormatterVisitor extends ASTVisitor
{
   ...
   public CodeFormatterVisitor(DefaultCodeFormatterOptions preferences, Map settings, IRegion[] regions,
      CodeSnippetParsingUtil codeSnippetParsingUtil, boolean includeComments)
   {
      long sourceLevel = settings == null ? ClassFileConstants.JDK1_3 : CompilerOptions.versionToJdkLevel(
         settings.get(JavaCore.COMPILER_SOURCE));
      this.localScanner = new Scanner(true, false, false/*nls*/, sourceLevel/*sourceLevel*/, null/*taskTags*/, null/*taskPriorities*/,
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#acceptProblem(com.codenvy.eclipse.jdt.core.compiler.IProblem)
    */
         ...
         if (currentNode instanceof FieldDeclaration)
         {
            ...
            else
            {
               ...
               if (previousMergedNode instanceof MultiFieldDeclaration)
               {
                  ...
                  System.arraycopy(multiFieldDeclaration.declarations, 0,
                     multiFieldDeclaration.declarations = new FieldDeclaration[length + 1], 0, length);
               ...
               else if (previousMergedNode instanceof FieldDeclaration)
               {
                  ...
                  if (currentField.declarationSourceStart == previousFieldDeclaration.declarationSourceStart)
                  {
                     ...
                     final MultiFieldDeclaration multiFieldDeclaration = new MultiFieldDeclaration(
                        new FieldDeclaration[]{previousFieldDeclaration, currentField});
            ...
            if (fieldStart < methodStart && fieldStart < typeStart)
            {
               ...
               if (fieldStart == previousFieldStart)
               {
                  ...
                  if (previousMember instanceof MultiFieldDeclaration)
                  {
                     ...
                     System.arraycopy(multiField.declarations, 0,
                        multiField.declarations = new FieldDeclaration[length + 1], 0, length);
                  ...
                  else
                  {
                     ...
                     final MultiFieldDeclaration multiFieldDeclaration = new MultiFieldDeclaration(
                        new FieldDeclaration[]{fieldDeclaration, field});
   ...
   private boolean dumpBinaryExpression(BinaryExpression binaryExpression, int operator, BlockScope scope)
   {
      ...
      try
      {
         ...
         if ((builder.realFragmentsSize() > 1 || fragmentsSize > 4) && numberOfParens == 0)
         {
            ...
            Alignment binaryExpressionAlignment = this.scribe.createAlignment(Alignment.BINARY_EXPRESSION,
      ...
      boolean isFirstClassBodyDeclaration)
   {
      ...
      if (initialization != null)
      {
         ...
         Alignment assignmentAlignment = this.scribe.createAlignment(Alignment.FIELD_DECLARATION_ASSIGNMENT,
            this.preferences.alignment_for_assignment, Alignment.R_INNERMOST, 1, this.scribe.scanner.currentPosition);
      ...
      boolean isChunkStart, boolean isFirstClassBodyDeclaration)
   {
      ...
      Alignment multiFieldDeclarationsAlignment = this.scribe.createAlignment(Alignment.MULTIPLE_FIELD,
         this.preferences.alignment_for_multiple_fields, multipleFieldDeclarationsLength - 1,
         this.scribe.scanner.currentPosition);
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.formatter.CodeFormatter#format(int, String, int, int, int, String)
    */
   ...
   private void format(TypeDeclaration typeDeclaration)
   {
      ...
      if (superclass != null)
      {
         Alignment superclassAlignment = this.scribe.createAlignment(Alignment.SUPER_CLASS,
            this.preferences.alignment_for_superclass_in_type_declaration, 2, this.scribe.scanner.currentPosition);
      ...
      if (superInterfaces != null)
      {
         ...
         Alignment interfaceAlignment = this.scribe.createAlignment(Alignment.SUPER_INTERFACES,
      ...
      if (kind == TypeDeclaration.ENUM_DECL)
      {
         ...
         if (fieldDeclarations != null)
         {
            ...
            {
               Alignment enumConstantsAlignment = this.scribe.createAlignment(Alignment.ENUM_CONSTANTS,
                  this.preferences.alignment_for_enum_constants, enumConstantsLength,
                  this.scribe.scanner.currentPosition, 0,
         ...
         if (isNextToken(TerminalTokens.TokenNameSEMICOLON))
         {
            this.scribe.printNextToken(TerminalTokens.TokenNameSEMICOLON,
               this.preferences.insert_space_before_semicolon);
            this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
            if (hasConstants || ((enumConstantsLength - length) != 0) || typeDeclaration.methods != null || typeDeclaration.memberTypes != null)
            {
   ...
   private void formatCascadingMessageSends(CascadingMethodInvocationFragmentBuilder builder, BlockScope scope)
   {
      ...
      else
      {
         ...
         if (arguments != null)
         {
            ...
            Alignment argumentsAlignment = this.scribe.createAlignment(Alignment.MESSAGE_ARGUMENTS,
               this.preferences.alignment_for_arguments_in_method_invocation, Alignment.R_OUTERMOST, argumentLength,
               this.scribe.scanner.currentPosition);
      ...
      Alignment cascadingMessageSendAlignment = this.scribe.createAlignment(Alignment.CASCADING_MESSAGE_SEND,
         ...
         try
         {
            ...
            for (int i = startingPositionInCascade; i < size; i++)
            {
               ...
               if (arguments != null)
               {
                  ...
                  Alignment argumentsAlignment = this.scribe.createAlignment(Alignment.MESSAGE_ARGUMENTS, alignmentMode,
                     Alignment.R_OUTERMOST, argumentLength, this.scribe.scanner.currentPosition);
                  this.scribe.enterAlignment(argumentsAlignment);
                  boolean okForArguments = false;
                  do
                  {
   ...
   private void formatClassBodyDeclarations(ASTNode[] nodes)
   {
      ...
      Alignment memberAlignment = this.scribe.createMemberAlignment(Alignment.TYPE_MEMBERS,
         this.preferences.align_type_members_on_columns ? Alignment.M_MULTICOLUMN : Alignment.M_NO_ALIGNMENT, 4,
         this.scribe.scanner.currentPosition);
   ...
   private void formatLeftCurlyBrace(final int line, final String bracePosition)
   {
      ...
      if (DefaultCodeFormatterConstants.NEXT_LINE_ON_WRAP.equals(
         bracePosition) && (this.scribe.line > line || this.scribe.column >= this.preferences.page_width))
      {
         this.scribe.printNewLine();
      }
   }
      ...
      boolean insertSpaceBeforeComma, boolean insertSpaceAfterComma)
   {
      ...
      if (initialization != null)
      {
         ...
         Alignment assignmentAlignment = this.scribe.createAlignment(Alignment.LOCAL_DECLARATION_ASSIGNMENT,
            this.preferences.alignment_for_assignment, Alignment.R_OUTERMOST, 1, this.scribe.scanner.currentPosition);
         this.scribe.enterAlignment(assignmentAlignment);
         boolean ok = false;
         do
         {
   ...
   private void formatMessageSend(MessageSend messageSend, BlockScope scope, Alignment messageAlignment)
   {
      ...
      if (arguments != null)
      {
         ...
         if (argumentsLength > 1)
         {
            int alignmentMode = this.preferences.alignment_for_arguments_in_method_invocation;
            Alignment argumentsAlignment = this.scribe.createAlignment(Alignment.MESSAGE_ARGUMENTS, alignmentMode,
               argumentsLength, this.scribe.scanner.currentPosition);
            this.scribe.enterAlignment(argumentsAlignment);
            boolean ok = false;
            do
            {
   ...
   private void formatMethodArguments(AbstractMethodDeclaration methodDeclaration, boolean spaceBeforeOpenParen,
      boolean spaceBetweenEmptyParameters, boolean spaceBeforeClosingParen, boolean spaceBeforeFirstParameter,
      boolean spaceBeforeComma, boolean spaceAfterComma, int methodDeclarationParametersAlignment)
   {
      ...
      if (arguments != null)
      {
         ...
         int argumentLength = arguments.length;
         Alignment argumentsAlignment = this.scribe.createAlignment(Alignment.METHOD_ARGUMENTS,
            methodDeclarationParametersAlignment, argumentLength, this.scribe.scanner.currentPosition);
         this.scribe.enterAlignment(argumentsAlignment);
         boolean ok = false;
         do
         {
      ...
      boolean spaceBeforeComma, boolean spaceAfterComma, int methodDeclarationParametersAlignment)
   {
      ...
      {
         int argumentLength = arguments.length;
         Alignment argumentsAlignment = this.scribe.createAlignment(Alignment.ENUM_CONSTANTS_ARGUMENTS,
            methodDeclarationParametersAlignment, argumentLength, this.scribe.scanner.currentPosition);
         this.scribe.enterAlignment(argumentsAlignment);
         boolean ok = false;
         do
   ...
   private void formatStatements(BlockScope scope, final Statement[] statements,
      ...
      boolean spaceAfterComma, int alignmentForThrowsClause)
   {
      ...
      if (thrownExceptions != null)
      {
         ...
         Alignment throwsAlignment = this.scribe.createAlignment(Alignment.THROWS, alignmentForThrowsClause,
   ...
   {
      Alignment memberAlignment = this.scribe.createMemberAlignment(Alignment.TYPE_MEMBERS,
         this.preferences.align_type_members_on_columns ? Alignment.M_MULTICOLUMN : Alignment.M_NO_ALIGNMENT, 3,
         this.scribe.scanner.currentPosition);
      this.scribe.enterMemberAlignment(memberAlignment);
         ...
         do
         {
            try
            {
               for (int i = startIndex, max = members.length; i < max; i++)
               {
                  ...
                  {
                     isChunkStart = memberAlignment.checkChunkStart(Alignment.CHUNK_TYPE, i,
                        this.scribe.scanner.currentPosition);
   ...
   {
      return !commentStartsBlock(block.sourceStart,
         block.sourceEnd) && block.statements != null && block.statements.length == 1 && (block.statements[0] instanceof ReturnStatement || block.statements[0] instanceof ThrowStatement);
   }
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.AllocationExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(AllocationExpression allocationExpression, BlockScope scope)
   {
      ...
      if (arguments != null)
      {
         ...
         int argumentLength = arguments.length;
         Alignment argumentsAlignment = this.scribe.createAlignment(Alignment.ALLOCATION,
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.AND_AND_Expression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.Argument, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayAllocationExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayInitializer, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
      ...
      try
      {
         ...
         if (expressions != null)
         {
            ...
            if (expressionsLength > 1)
            {
               ...
               arrayInitializerAlignment = this.scribe.createAlignment(Alignment.ARRAY_INITIALIZER,
                  this.preferences.alignment_for_expressions_in_array_initializer, Alignment.R_OUTERMOST,
            ...
            else
            {
               ...
               {
                  arrayInitializerAlignment = this.scribe.createAlignment(Alignment.ARRAY_INITIALIZER,
                     this.preferences.alignment_for_expressions_in_array_initializer, Alignment.R_OUTERMOST, 0,
                     this.scribe.scanner.currentPosition,
                     this.preferences.continuation_indentation_for_array_initializer, true);
                  this.scribe.enterAlignment(arrayInitializerAlignment);
               }
            ...
            this.scribe.printNextToken(TerminalTokens.TokenNameRBRACE, false,
               Scribe.PRESERVE_EMPTY_LINES_IN_CLOSING_ARRAY_INITIALIZER + (arrayInitializerIndentationLevel << 16));
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayQualifiedTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayQualifiedTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ArrayTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.AssertStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(AssertStatement assertStatement, BlockScope scope)
   {
      ...
      if (assertStatement.exceptionArgument != null)
      {
         this.scribe.printNextToken(TerminalTokens.TokenNameCOLON,
            this.preferences.insert_space_before_colon_in_assert);
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.Assignment, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(Assignment assignment, BlockScope scope)
   {
      ...
      Alignment assignmentAlignment = this.scribe.createAlignment(Alignment.ASSIGNMENT,
         this.preferences.alignment_for_assignment, Alignment.R_OUTERMOST, 1, this.scribe.scanner.currentPosition);
      this.scribe.enterAlignment(assignmentAlignment);
      boolean ok = false;
      do
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.Block, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.BreakStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.CaseStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.CastExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.CharLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ClassLiteralAccess, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.Clinit, com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration, com.codenvy.eclipse.jdt.internal.compiler.lookup.CompilationUnitScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.CompoundAssignment, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(CompoundAssignment compoundAssignment, BlockScope scope)
   {
      ...
      Alignment assignmentAlignment = this.scribe.createAlignment(Alignment.COMPOUND_ASSIGNMENT,
         this.preferences.alignment_for_assignment, Alignment.R_OUTERMOST, 1, this.scribe.scanner.currentPosition);
      this.scribe.enterAlignment(assignmentAlignment);
      boolean ok = false;
      do
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ConditionalExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(ConditionalExpression conditionalExpression, BlockScope scope)
   {
      ...
      Alignment conditionalExpressionAlignment = this.scribe.createAlignment(Alignment.CONDITIONAL_EXPRESSION,
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ConstructorDeclaration, com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ContinueStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.DoStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.DoubleLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.EmptyStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.EqualExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(ExplicitConstructorCall explicitConstructor, BlockScope scope)
   {
      ...
      if (arguments != null)
      {
         ...
         int argumentLength = arguments.length;
         Alignment argumentsAlignment = this.scribe.createAlignment(Alignment.EXPLICIT_CONSTRUCTOR_CALL,
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.FalseLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.FieldReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.FloatLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ForStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.IfStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(IfStatement ifStatement, BlockScope scope)
   {
      ...
      if (thenStatement != null)
      {
         if (thenStatement instanceof Block)
         {
            ...
            if (isGuardClause(
               (Block)thenStatement) && elseStatement == null && this.preferences.keep_guardian_clause_on_one_line)
            {
					/*
         ...
         {
            Alignment compactIfAlignment = this.scribe.createAlignment(Alignment.COMPACT_IF,
               this.preferences.alignment_for_compact_if, Alignment.R_OUTERMOST, 1, this.scribe.scanner.currentPosition,
               1, false);
      ...
      if (elseStatement != null)
      {
         if (thenStatementIsBlock)
         {
            this.scribe.printNextToken(TerminalTokens.TokenNameelse,
               this.preferences.insert_space_after_closing_brace_in_block, Scribe.PRESERVE_EMPTY_LINES_BEFORE_ELSE);
         }
         else
         {
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.Initializer, com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.InstanceOfExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.IntLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.LabeledStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.LocalDeclaration, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.LongLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.MessageSend, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(MessageSend messageSend, BlockScope scope)
   {
      ...
      else
      {
         ...
         if (!messageSend.receiver.isImplicitThis())
         {
            ...
            messageAlignment = this.scribe.createAlignment(Alignment.MESSAGE_SEND, alignmentMode, 1,
               this.scribe.scanner.currentPosition);
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.MethodDeclaration, com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope)
    */
   public boolean visit(MethodDeclaration methodDeclaration, ClassScope scope)
   {
      ...
      // Create alignment
      Alignment methodDeclAlignment = this.scribe.createAlignment(Alignment.METHOD_DECLARATION,
         this.preferences.alignment_for_method_declaration, Alignment.R_INNERMOST, 3,
         this.scribe.scanner.currentPosition);
   ...
   public boolean visit(NormalAnnotation annotation, BlockScope scope)
   {
      ...
      if (memberValuePairs != null)
      {
         ...
         Alignment annotationAlignment = this.scribe.createAlignment(Alignment.ANNOTATION_MEMBERS_VALUE_PAIRS,
            this.preferences.alignment_for_arguments_in_annotation, length, this.scribe.scanner.currentPosition);
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.NullLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.OR_OR_Expression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.PostfixExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.PrefixExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedAllocationExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedNameReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedThisReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ReturnStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(ReturnStatement returnStatement, BlockScope scope)
   {
      ...
      if (expression != null)
      {
         ...
         if ((numberOfParens != 0 && this.preferences.insert_space_before_parenthesized_expression_in_return) || numberOfParens == 0)
         {
            this.scribe.space();
         }
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.SingleNameReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.SingleTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.SingleTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.StringLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   public boolean visit(StringLiteralConcatenation stringLiteral, BlockScope scope)
   {
      ...
      Alignment binaryExpressionAlignment = this.scribe.createAlignment(Alignment.STRING_CONCATENATION,
         this.preferences.alignment_for_binary_expression, Alignment.R_OUTERMOST, fragmentsSize,
         this.scribe.scanner.currentPosition);
      this.scribe.enterAlignment(binaryExpressionAlignment);
      boolean ok = false;
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.SuperReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.SwitchStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.SynchronizedStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ThisReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.ThrowStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   public boolean visit(ThrowStatement throwStatement, BlockScope scope)
   {
      ...
      final int numberOfParens = (expression.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
      if ((numberOfParens > 0 && this.preferences.insert_space_before_parenthesized_expression_in_throw) || numberOfParens == 0)
      {
         this.scribe.space();
      }
      expression.traverse(this, scope);
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.TrueLiteral, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.TryStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
      ...
      int multiCatchAlignment, BlockScope scope)
   {
      ...
      if (length > 0)
      {
         Alignment argumentsAlignment = this.scribe.createAlignment(Alignment.MULTI_CATCH, multiCatchAlignment, length,
            this.scribe.scanner.currentPosition);
         this.scribe.enterAlignment(argumentsAlignment);
         boolean ok = false;
         do
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration, com.codenvy.eclipse.jdt.internal.compiler.lookup.ClassScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.TypeDeclaration, com.codenvy.eclipse.jdt.internal.compiler.lookup.CompilationUnitScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.UnaryExpression, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.UnionTypeReference, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ASTVisitor#visit(com.codenvy.eclipse.jdt.internal.compiler.ast.WhileStatement, com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */

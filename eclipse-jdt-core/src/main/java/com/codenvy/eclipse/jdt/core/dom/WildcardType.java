...
public class WildcardType extends Type {
    ...
    public static final ChildPropertyDescriptor BOUND_PROPERTY = new ChildPropertyDescriptor(WildcardType.class, "bound",
                                                                                             Type.class, OPTIONAL, CYCLE_RISK);
    //$NON-NLS-1$
     ...
     *
     * @param type
     *         the new bound of this wildcard type, or <code>null</code>
     *         if none
     * @param isUpperBound
     *         <code>true</code> for an upper bound ("? extends B"),
     ...
     *
     * @param isUpperBound
     *         <code>true</code> if an upper bound,
     *         and <code>false</code> if a lower bound
     * @see #isUpperBound()
     */

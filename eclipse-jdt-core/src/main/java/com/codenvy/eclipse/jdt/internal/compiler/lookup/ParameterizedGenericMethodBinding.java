...
public class ParameterizedGenericMethodBinding extends ParameterizedMethodBinding implements Substitution
{
      ...
      Scope scope, InvocationSite invocationSite)
   {
      ...
      computeSubstitutes:
      {
         ...
         if (inferenceContext.hasUnresolvedTypeArgument())
         {
            ...
            { // only remember unchecked status post 15.12.2.7
      ...
      LookupEnvironment environment)
   {
      ...
      this.thrownExceptions = Scope.substitute(this,
         ignoreRawTypeSubstitution ? originalMethod.thrownExceptions // no substitution if original was static

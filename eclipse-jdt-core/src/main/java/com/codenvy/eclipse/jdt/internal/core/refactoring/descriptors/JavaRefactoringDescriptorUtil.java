...
public class JavaRefactoringDescriptorUtil {
     ...
     *         element exists
     */
    public static IJavaElement handleToElement(final WorkingCopyOwner owner, final String project, final String handle,
                                               final boolean check) {
        ...
        if (element == null && project != null) {
            final IJavaProject javaProject = JavaCore.create(ResourcesPlugin.getWorkspace().getRoot()).getJavaProject(
                    project);
     ...
     *         the key in the map
     * @param allowNull
     *         if <code>true</code> a <code>null</code> will be returned if the attribute does not exist
     * @return the value of the attribute
     * @throws IllegalArgumentException
     *         if the value of the attribute is not a {@link String} or allowNull is <code>false</code> and the attribute does not exist
     */
     ...
     * @return the value of the attribute
     * @throws IllegalArgumentException
     *         if the value of the attribute is not a {@link String} or the attribute does not exist
     */
     ...
     *         the attribute name where the values are stored. The index starting from offset is appended to this
     * @param offset
     ...
     */
    public static String[] getStringArray(Map map, String countAttribute, String arrayAttribute,
    ...
    public static int getInt(Map map, String attribute) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "The attribute '" + attribute + "' does not contain a valid int '" + value +
     ...
     *         the attribute that contains the number of elements
     * @param arrayAttribute
     *         the attribute name where the values are stored. The index starting from '0' is appended to this
     * @param map
     *         the map with <code>&lt;String, String&gt;</code> mapping
     ...
     *         if any of the attribute does not exist or is not a number
     */
    public static int[] getIntArray(Map map, String countAttribute,
     ...
     *         the key in the map
     * @param project
     *         the project for resolving the java element. Can be <code>null</code> for workspace
     ...
     *         the project for resolving the java element. Can be <code>null</code> for workspace
     * @param arrayClass
     *         the component type for the resulting array. The resulting array can then be safely casted to arrayClass[]
     * @return the <code>IJavaElement[]</code>
     * @throws IllegalArgumentException
     *         if any of the attribute does not exist or is not a number
     */
    public static IJavaElement[] getJavaElementArray(Map map, String countAttribute, String arrayAttribute, int offset,
                                                     String project, Class arrayClass) throws IllegalArgumentException {
     ...
     *         the key in the map
     * @param project
     *         the project for resolving the resource. Can be <code>null</code> for workspace
     ...
     *         if any of the attribute does not exist or is not a number
     */
    public static IPath[] getResourcePathArray(Map map, String countAttribute, String arrayAttribute, int offset,
                                               String project) throws IllegalArgumentException {
        int count = getInt(map, countAttribute);
    ...
    public static boolean getBoolean(Map map, String attribute) throws IllegalArgumentException {
        ...
        throw new IllegalArgumentException(
                "The attribute '" + attribute + "' does not contain a valid boolean: '" + value +
                "'"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
     ...
     * @throws IllegalArgumentException
     *         if the attribute name is invalid, or the element is <code>null</code>
     */
    public static void setJavaElement(Map arguments, String attribute, String project,
                                      IJavaElement element) throws IllegalArgumentException {
        if (element == null) {
            throw new IllegalArgumentException(
     ...
     * @throws IllegalArgumentException
     *         if the attribute name is invalid, or the resource is <code>null</code>
     */
    public static void setResourcePath(Map arguments, String attribute, String project,
     ...
     * @param countAttribute
     *         the attribute where the number of resources will be stored. Can be <code>null</code> if no count attribute should be created
     * @param arrayAttribute
     ...
     */
    public static void setBooleanArray(Map arguments, String countAttribute, String arrayAttribute, boolean[] value,
                                       int offset) {
        if (value == null) {
            throw new IllegalArgumentException(
     ...
     *         the key's name for the map
     * @param value
     *         the <code>{@link String}</code> to store. If <code>null</code> no insertion is performed
     * @throws IllegalArgumentException
     *         if the attribute name is invalid
     */
     ...
     */
    public static void setStringArray(Map arguments, String countAttribute, String arrayAttribute, String[] value,
                                      int offset) {
        if (value == null) {
            throw new IllegalArgumentException(
                    "The values for arrayAttribute '" + arrayAttribute + "' may not be null"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     *         if the attribute name is invalid
     */
    public static void setSelection(Map arguments, String attribute, int offset,
     ...
     */
    public static void setResourcePathArray(Map arguments, String countAttribute, String arrayAttribute, String project,
                                            IPath[] resourcePaths, int offset) throws IllegalArgumentException {
     ...
     *         arguments the map with <code>&lt;String, String&gt;</code> mapping
     * @param countAttribute
     *         the attribute where the number of elements will be stored. Can be <code>null</code> if no count attribute should be created
     * @param arrayAttributePrefix
     *         the name prefix of the attributes where the elements will be stored
     * @param project
     ...
     */
    public static void setJavaElementArray(Map arguments, String countAttribute, String arrayAttributePrefix,
                                           String project, IJavaElement[] elements, int offset) throws IllegalArgumentException {
        if (elements == null) {
            throw new IllegalArgumentException(

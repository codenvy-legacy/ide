...
public class PackageFragment extends Openable implements IPackageFragment, SuffixConstants
{
   ...
   /**
    * @throws IllegalArgumentException if the name does not end with ".class"
    * @see IPackageFragment#getClassFile(String)
    */
   public IClassFile getClassFile(String classFileName)
   {
      if (!com.codenvy.eclipse.jdt.internal.compiler.util.Util.isClassFileName(classFileName))
      {
   ...
   /**
    * @throws IllegalArgumentException if the name does not end with ".java"
    * @see IPackageFragment#getCompilationUnit(String)
    */
   public ICompilationUnit getCompilationUnit(String cuName)
   {
      if (!com.codenvy.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(cuName))
      {

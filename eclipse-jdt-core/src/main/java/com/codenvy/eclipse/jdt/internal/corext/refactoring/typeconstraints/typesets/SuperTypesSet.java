...
public class SuperTypesSet extends TypeSet {
     ...
     * .refactoring.typeconstraints.typesets.EnumeratedTypeSet)
     */
    @Override
        ...
        if (fEnumCache == null) {
            ...
            for (Iterator<TType> iter = fLowerBounds.iterator(); iter.hasNext(); ) {
                ...
                if (lb instanceof ArrayType) {
                    ...
                    for (Iterator<TType> elemSuperIter = TTypes.getAllSuperTypesIterator(
                            at.getElementType()); elemSuperIter.hasNext(); ) {

...
import com.codenvy.eclipse.ltk.core.refactoring.TextEditBasedChange;
import com.codenvy.eclipse.ltk.core.refactoring.participants.CheckConditionsContext;
import com.codenvy.eclipse.ltk.core.refactoring.participants.MoveProcessor;
...
public final class JavaMoveProcessor extends MoveProcessor implements IQualifiedNameUpdating, IReorgDestinationValidator
{
   ...
   public RefactoringStatus checkInitialConditions(IProgressMonitor pm) throws CoreException
   {
      ...
      try
      {
         ...
         result.merge(
            RefactoringStatus.create(Resources.checkInSync(ReorgUtils.getNotNulls(fMovePolicy.getResources()))));
   ...
   public Change createChange(IProgressMonitor pm) throws CoreException
   {
      ...
      try
      {
         final DynamicValidationStateChange result = new DynamicValidationStateChange(
            RefactoringCoreMessages.JavaMoveProcessor_change_name)
         {

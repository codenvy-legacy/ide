...
import com.codenvy.eclipse.jdt.internal.codeassist.InternalCompletionProposal;
...
public class CompletionProposal {
     ...
     * </p>
     * <p>
     * This kind of proposal could require a long computation, so they are computed only if completion operation is called with a {@link
     * IProgressMonitor}
     * (e.g. {@link ICodeAssist#codeComplete(int, CompletionRequestor, IProgressMonitor)}).<br>
     * This kind of proposal is always is only proposals with a {@link #TYPE_REF} required proposal, so this kind of required proposal must
     * be allowed:
     ...
     * @see com.codenvy.eclipse.jdt.core.dom.ASTParser#createASTs(ICompilationUnit[], String[], com.codenvy.eclipse.jdt.core.dom
     * .ASTRequestor,
     *      IProgressMonitor)
     * @since 3.1
     */

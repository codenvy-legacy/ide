            ...
            checkHiding:
            {
                ...
                checkHidingSuperField:
                {
                    ...
                    FieldBinding existingVariable =
                            classScope.findField(declaringType.superclass, this.name, this, false /*do not resolve hidden field*/,
                                                 true /* no visibility checks please */);
        ...
        try {
            ...
            if (this.initialization == null) {
                ...
                if (this.initialization instanceof ArrayInitializer) {
                    ...
                    if ((initializationType = this.initialization.resolveTypeExpecting(initializationScope,
                                                                                       fieldType)) != null) {
                    ...
                    if (this.initialization.isConstantValueOfTypeAssignableToType(initializationType,
                        ...
                        if (initializationType.needsUncheckedConversion(fieldType)) {
                            initializationScope.problemReporter().unsafeTypeConversion(this.initialization, initializationType,
                                                                                       fieldType);
                        }
                    ...
                    if (this.binding.isFinal()) { // cast from constant actual type to variable type
                        this.binding.setConstant(this.initialization.constant.castTo(

...
public class Clinit extends AbstractMethodDeclaration {
    ...
    public void analyseCode(ClassScope classScope, InitializationFlowContext staticInitializerFlowContext,
        ...
        try {
            ExceptionHandlingFlowContext clinitContext = new ExceptionHandlingFlowContext(
                    staticInitializerFlowContext.parent, this, Binding.NO_EXCEPTIONS, staticInitializerFlowContext, this.scope,
                    FlowInfo.DEAD_END);
    ...
    private void generateCode(ClassScope classScope, ClassFile classFile, int clinitOffset) {
        ...
        if (this.assertionSyntheticFieldBinding != null) {
            ...
            codeStream.generateClassLiteralAccessForType(classScope.outerMostClassScope().enclosingSourceType(),
                        ...
                        if (fieldDecl.isStatic()) {
                            if (fieldDecl.getKind() == AbstractVariableDeclaration.ENUM_CONSTANT) {
                                ...
                                if (count > ENUM_CONSTANTS_THRESHOLD) {
                                    SyntheticMethodBinding syntheticMethod = declaringType.binding.addSyntheticMethodForEnumInitialization(
                                            begin, i);

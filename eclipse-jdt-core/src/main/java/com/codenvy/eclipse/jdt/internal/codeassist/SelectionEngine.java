...
import com.codenvy.eclipse.jdt.internal.codeassist.select.SelectionJavadocParser;
import com.codenvy.eclipse.jdt.internal.codeassist.select.SelectionNodeFound;
import com.codenvy.eclipse.jdt.internal.codeassist.select.SelectionOnImportReference;
import com.codenvy.eclipse.jdt.internal.codeassist.select.SelectionOnPackageReference;
import com.codenvy.eclipse.jdt.internal.codeassist.select.SelectionOnQualifiedTypeReference;
import com.codenvy.eclipse.jdt.internal.codeassist.select.SelectionOnSingleTypeReference;
import com.codenvy.eclipse.jdt.internal.codeassist.select.SelectionParser;
...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.MemberTypeBinding;
...
import com.codenvy.eclipse.jdt.internal.core.search.TypeNameMatchRequestorWrapper;
import com.codenvy.eclipse.jdt.internal.core.util.ASTNodeFinder;
import com.codenvy.eclipse.jdt.internal.core.util.HashSetOfCharArrayArray;
...
public final class SelectionEngine extends Engine implements ISearchRequestor {
    ...
    private void findAllTypes(char[] prefix) {
        try {
            ...
            com.codenvy.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.owner == null ? null
                    ...
                    for (int i = 0, length = imports.length; i < length; i++) {
                        ...
                        if (importReference instanceof SelectionOnImportReference) {
                            ...
                            this.nameEnvironment
                                    .findTypes(CharOperation.concatWith(tokens, '.'), false, false, IJavaSearchConstants.TYPE, this);
                    ...
                    if (constructorDeclaration.binding != null) {
                        ...
                        if (constructorDeclaration.scope != null) {
                            throw new SelectionNodeFound(
                                    new MethodBinding(constructorDeclaration.modifiers, constructorDeclaration.selector, null, null, null,
                ...
                if (methodDeclaration.selector == assistIdentifier) {
                    if (methodDeclaration.binding != null) {
                        ...
                        if (methodDeclaration.scope != null) {
                            throw new SelectionNodeFound(
                                    new MethodBinding(methodDeclaration.modifiers, methodDeclaration.selector, null, null, null,
    ...
    public void selectType(char[] typeName, IType context) throws JavaModelException {
        try {
            ...
            com.codenvy.eclipse.jdt.core.ICompilationUnit cu = context.getCompilationUnit();
            if (cu != null) {
                ...
                CompilationResult result =
                        new CompilationResult(outerTypeInfo.getFileName(), 1, 1, this.compilerOptions.maxProblemsPerUnit);

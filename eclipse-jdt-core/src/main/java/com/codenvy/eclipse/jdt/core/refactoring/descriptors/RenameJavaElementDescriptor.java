...
public final class RenameJavaElementDescriptor extends JavaRefactoringDescriptor
{
   ...
   /**
    * @deprecated Replaced by {@link com.codenvy.eclipse.ltk.core.refactoring.resource.RenameResourceDescriptor#ID}
    */
    ...
    * {@link JavaRefactoringDescriptorUtil#handleToElement(com.codenvy.eclipse.jdt.core.WorkingCopyOwner, String, String, boolean)}.
    */
    ...
    * @since 1.2
    */
   public RenameJavaElementDescriptor(String id, String project, String description, String comment, Map arguments,
      int flags)
   {
    ...
    * </p>
    *
    * @param deprecate <code>true</code> to deprecate the delegate,
    ...
    * </p>
    *
    * @param delegate <code>true</code> to keep the original, <code>false</code>
    *                 otherwise
    */
   ...
   {
      Assert.isLegal(strategy == STRATEGY_EXACT || strategy == STRATEGY_EMBEDDED || strategy == STRATEGY_SUFFIX,
    ...
    * </p>
    *
    * @param rename <code>true</code> to rename getter methods,
    *               <code>false</code> otherwise
    */
    ...
    * </p>
    *
    * @param rename <code>true</code> to rename setter methods,
    *               <code>false</code> otherwise
    */
    ...
    * </p>
    *
    * @param update <code>true</code> to update hierarchically,
    *               <code>false</code> otherwise
    */
    ...
    * </p>
    *
    * @param update <code>true</code> to update similar declarations,
    *               <code>false</code> otherwise
    */
    ...
    * </p>
    *
    * @param update <code>true</code> to update occurrences, <code>false</code>
    *               otherwise
    */
   ...
   public RefactoringStatus validateDescriptor()
   {
      ...
      {
         status.merge(
            RefactoringStatus.createFatalErrorStatus(DescriptorMessages.RenameJavaElementDescriptor_no_java_element));
      }
      else
      {
         final int type = fJavaElement.getElementType();

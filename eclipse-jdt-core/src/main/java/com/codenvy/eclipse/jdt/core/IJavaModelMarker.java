...
public interface IJavaModelMarker
{
    ...
    * transient problems.
    *
    * @see com.codenvy.eclipse.jdt.core.compiler.IProblem
    * @see com.codenvy.eclipse.jdt.core.eval.ICodeSnippetRequestor#acceptProblem(com.codenvy.eclipse.core.resources.IMarker, String,
    *      int)
    */

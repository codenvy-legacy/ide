...
public abstract class JavaRefactoringDescriptor extends RefactoringDescriptor
{
    ...
    *         element exists
    */
   protected static IJavaElement handleToElement(final WorkingCopyOwner owner, final String project,
   ...
   {
      this(id, null, "JavaRefactoringDescriptor_not_available", null, new HashMap(),
    ...
    * @since 1.2
    */
   public JavaRefactoringDescriptor(final String id, final String project, final String description,
   ...
   public Refactoring createRefactoring(final RefactoringStatus status) throws CoreException
   {
      ...
      if (contribution != null)
      {
         ...
         {
            Util.log(new Status(IStatus.ERROR, "ide", 0,
               MessageFormat.format("JavaRefactoringDescriptor no resulting descriptor", new Object[]{id}), null));
         }
      }
      return refactoring;
   }
   ...
   protected void populateArgumentMap()
   {
      ...
      {
         throw new RuntimeException("Validation returns a fatal error status",
    ...
    * </p>
    *
    * @param comment the details comment to set, or <code>null</code> to set no
    *                details comment
    * @see #getComment()
    */
    ...
    * </p>
    *
    * @param flags the flags to set, or <code>RefactoringDescriptor.NONE</code>
    *              to clear the flags
    * @see #getFlags()
   ...
   public RefactoringStatus validateDescriptor()
   {
      ...
      {
         status.merge(RefactoringStatus.createFatalErrorStatus("JavaRefactoringDescriptor no description"));
      }
      return status;
   }
}
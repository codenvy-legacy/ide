...
public class QualifiedName extends Name
{
   ...
   public static final ChildPropertyDescriptor QUALIFIER_PROPERTY = new ChildPropertyDescriptor(QualifiedName.class,
      "qualifier", Name.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
    ...
    * @since 3.0
    */
   public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(QualifiedName.class, "name",

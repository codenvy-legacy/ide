...
public interface IPackageFragmentRoot extends IParent, IJavaElement, IOpenable
{
    ...
    * @throws JavaModelException if this operation fails. Reasons include:
    *                            <ul>
    ...
    * @throws JavaModelException if this root could not be copied. Reasons
    *                            include:
    *                            <ul>
    ...
    *                            </ul>
    * @see com.codenvy.eclipse.core.resources.IResource#copy(IPath, boolean, IProgressMonitor)
    * @since 2.1
    */
    ...
    *                            </ul>
    * @see com.codenvy.eclipse.core.resources.IFolder#create(boolean, boolean, IProgressMonitor)
    */
   IPackageFragment createPackageFragment(String name, boolean force,
      IProgressMonitor monitor) throws JavaModelException;
    ...
    *                            <code>NO_RESOURCE_MODIFICATION</code>)
    * @param monitor             a progress monitor
    * @throws JavaModelException if this root could not be deleted. Reasons
    *                            include:
    *                            <ul>
    *                            <li> This root does not exist (ELEMENT_DOES_NOT_EXIST)</li>
    ...
    *                            </li>
    *                            </ul>
    * @see com.codenvy.eclipse.core.resources.IResource#delete(boolean, IProgressMonitor)
    * @since 2.1
    */
    ...
    * @throws JavaModelException if this operation fails
    */
    ...
    *                            be inserted at the end
    * @param monitor             a progress monitor
    * @throws JavaModelException if this root could not be moved. Reasons
    *                            include:
    *                            <ul>
    *                            <li> This root does not exist (ELEMENT_DOES_NOT_EXIST)</li>
    *                            <li> A <code>CoreException</code> occurred while copying the
    ...
    *                            has not been specified as <code>REPLACE</code></li>
    *                            </ul>
    * @see com.codenvy.eclipse.core.resources.IResource#move(IPath, boolean, IProgressMonitor)
    * @since 2.1
    */

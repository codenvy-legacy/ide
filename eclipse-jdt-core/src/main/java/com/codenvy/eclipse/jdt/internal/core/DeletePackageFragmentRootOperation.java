...
public class DeletePackageFragmentRootOperation extends JavaModelOperation {
                ...
                public boolean visit(IResourceProxy proxy) throws CoreException {
                    if (proxy.getType() == IResource.FOLDER) {
                        ...
                        if (prefixesOneOf(path, nestedFolders)) {
                            ...
                            proxy.requestResource().delete(DeletePackageFragmentRootOperation.this.updateResourceFlags,
                                                           DeletePackageFragmentRootOperation.this.progressMonitor);
                            return false;
                        }
                    } else {
                        proxy.requestResource().delete(DeletePackageFragmentRootOperation.this.updateResourceFlags,
    ...
    protected void updateReferringProjectClasspaths(IPath rootPath, IJavaProject projectOfRoot,
                                                    Map oldRoots) throws JavaModelException {

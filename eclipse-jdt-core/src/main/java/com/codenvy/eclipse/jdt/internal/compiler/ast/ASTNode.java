...
public abstract class ASTNode implements TypeConstants, TypeIds {
    ...
    public static boolean checkInvocationArguments(BlockScope scope, Expression receiver, TypeBinding receiverType,
        ...
        boolean isRawMemberInvocation = !method.isStatic() && !receiverType.isUnboundWildcard() && method.declaringClass.isRawType() &&
            ...
            if (method.isVarargs()) {
                ...
                if (lastIndex <= argLength) { // https://bugs.eclipse.org/bugs/show_bug.cgi?id=337093
                    ...
                    if (paramLength != argLength || parameterType.dimensions() != argumentTypes[lastIndex].dimensions()) {
                        ...
                        originalRawParam = rawOriginalGenericMethod == null ? null
            ...
            if (scope.compilerOptions().reportUnavoidableGenericTypeProblems || receiver == null || !receiver.forcedToBeRaw(
                ...
                scope.problemReporter().unsafeRawInvocation((ASTNode)invocationSite, method);
                                                                               ...
                                                                               method instanceof ParameterizedGenericMethodBinding
                                                                                          /*&& method.returnType != scope.environment()
                                                                                          .convertToRawType(method.returnType.erasure(),
                                                                                          true)*/)) {

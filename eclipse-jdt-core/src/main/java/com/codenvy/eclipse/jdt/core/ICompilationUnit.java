...
public interface ICompilationUnit extends ITypeRoot, IWorkingCopy, ISourceManipulation {
     ...
     *         the edit to apply
     * @param monitor
     *         the progress monitor to use or <code>null</code> if no progress should be reported
     ...
     *         <li>The provided edit can not be applied as there is a problem with the text edit locations ({@link
     *         IJavaModelStatusConstants#BAD_TEXT_EDIT_LOCATION}).</li>
     *         </ul>
     * @since 3.4
     */
     ...
     *         <ul>
     *         <li> A {@link com.codenvy.eclipse.core.runtime.CoreException} occurred while updating an underlying resource
     ...
     *
     * @param name
     *         the name of the import declaration to add as defined by JLS2 7.5. (For example: <code>"java.io.File"</code> or
     *         <code>"java.awt.*"</code>)
     * @param sibling
     ...
     *         <code> null </code>, then this import will be inserted as the last import declaration.
     * @param flags
     *         {@link Flags#AccStatic} for static imports, or
     ...
     * @since 3.0
     */
    IImportDeclaration createImport(String name, IJavaElement sibling, int flags,
                                    IProgressMonitor monitor) throws JavaModelException;
     ...
     *
     * @param name
     *         the name of the package declaration to add as defined by JLS2 7.4. (For example, <code>"java.lang"</code>)
     * @param monitor
     *         the progress monitor to notify
     ...
     *
     * @param owner
     *         the given {@link WorkingCopyOwner}
     ...
     *
     * @param name
     *         the name of the import to find as defined by JLS2 7.5. (For example: <code>"java.io.File"</code>
     ...
     *
     * @param astLevel
     *         either {@link #NO_AST} if no AST is wanted,
     ...
     * @since 3.0
     */
    CompilationUnit reconcile(int astLevel, boolean forceProblemDetection, WorkingCopyOwner owner,
                              IProgressMonitor monitor) throws JavaModelException;
     ...
     *         boolean indicating whether problem should be
     *         recomputed even if the source hasn't changed
     * @param enableStatementsRecovery
     *         if <code>true</code> statements recovery is enabled.
     * @param owner
     *         the owner of working copies that take precedence over the
     *         original compilation units, or <code>null</code> if the primary working
     *         copy owner should be used
     ...
     * @since 3.3
     */
    CompilationUnit reconcile(int astLevel, int reconcileFlags, WorkingCopyOwner owner,
                              IProgressMonitor monitor) throws JavaModelException;

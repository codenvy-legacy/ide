...
import com.codenvy.eclipse.jdt.internal.core.util.KeyKind;
import com.codenvy.eclipse.jdt.internal.core.util.KeyToSignature;
...
public final class BindingKey {
     ...
     * @see com.codenvy.eclipse.jdt.core.BindingKey#createWildcardTypeBindingKey(String, char, String, int)

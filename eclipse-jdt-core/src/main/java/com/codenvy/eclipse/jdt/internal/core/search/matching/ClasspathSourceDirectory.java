			...
			for (int i = 0, l = members.length; i < l; i++) {
				...
				if (m.getType() == IResource.FILE) {
					...
					if (index >= 0) {
						...
						if (!com.codenvy.eclipse.jdt.internal.compiler.util.Util.isExcluded(fullPath.toCharArray(), this.fulInclusionPatternChars, this.fullExclusionPatternChars, false/*not a folder path*/)) {

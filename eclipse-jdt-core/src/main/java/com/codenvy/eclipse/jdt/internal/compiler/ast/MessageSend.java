...
public class MessageSend extends Expression implements InvocationSite {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        if (this.arguments != null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (this.receiver.resolvedType != null && this.receiver.resolvedType.id == TypeIds.T_OrgEclipseCoreRuntimeAssert &&
                    argument.resolvedType != null && argument.resolvedType.id == TypeIds.T_boolean) {
    ...
    /**
     * @see com.codenvy.eclipse.jdt.internal.compiler.ast.Expression#computeConversion(com.codenvy.eclipse.jdt.internal.compiler.lookup
     * .Scope,
     *      com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding, com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)
     */
        ...
        if (!this.binding.isStatic()) {
            ...
            if (receiverIsType) {
                ...
                if (this.actualReceiverType != oldReceiverType && this.receiver.postConversionType(
                        scope) != this.actualReceiverType) { // record need for explicit cast at codegen since receiver could not handle it
        ...
        if (this.receiver.isSuper() && compilerOptions.getSeverity(
            ...
            if (referenceContext instanceof AbstractMethodDeclaration) {
                ...
                if (enclosingMethodBinding.isOverriding() && CharOperation.equals(this.binding.selector,
                                                                                  enclosingMethodBinding.selector) &&
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.ast.Expression#setExpectedType(com.codenvy.eclipse.jdt.internal.compiler.lookup
     * .TypeBinding) */

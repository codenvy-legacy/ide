...
import com.codenvy.eclipse.jdt.internal.compiler.lookup.MissingTypeBinding;
import com.codenvy.eclipse.jdt.internal.compiler.lookup.PolymorphicMethodBinding;
...
public class MessageSend extends Expression implements InvocationSite
{
   ...
   public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo)
   {
      ...
      if (analyseResources && CharOperation.equals(TypeConstants.CLOSE, this.selector))
      {
         ...
         { // null happens if receiver is not a local variable or not an AutoCloseable
      ...
      if (this.arguments != null)
      {
         ...
         for (int i = 0; i < length; i++)
         {
            ...
            if (this.receiver.resolvedType != null && this.receiver.resolvedType.id == TypeIds.T_OrgEclipseCoreRuntimeAssert && argument.resolvedType != null && argument.resolvedType.id == TypeIds.T_boolean)
            {
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ast.Expression#computeConversion(com.codenvy.eclipse.jdt.internal.compiler.lookup.Scope, com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding, com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)
    */
   ...
   public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired)
   {
      ...
      { // outer access ?
         ...
         ReferenceBinding targetType = currentScope.enclosingSourceType().enclosingTypeAt(
      ...
      {
         TypeBinding constantPoolDeclaringClass = CodeStream.getConstantPoolDeclaringClass(currentScope, codegenBinding,
   ...
   public void manageSyntheticAccessIfNecessary(BlockScope currentScope, FlowInfo flowInfo)
   {
      ...
      if (this.binding.isPrivate())
      {
         ...
         {
            this.syntheticAccessor = ((SourceTypeBinding)codegenBinding.declaringClass).addSyntheticMethod(
               codegenBinding, false /* not super access there */);
      ...
      else if (this.binding.isProtected())
      {
         ...
         if (((this.bits & ASTNode.DepthMASK) != 0) && codegenBinding.declaringClass.getPackage() != (enclosingSourceType = currentScope.enclosingSourceType()).getPackage())
         {
            ...
            SourceTypeBinding currentCompatibleType = (SourceTypeBinding)enclosingSourceType.enclosingTypeAt(
               (this.bits & ASTNode.DepthMASK) >> ASTNode.DepthSHIFT);
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ast.Expression#postConversionType(Scope)
    */
   ...
   public TypeBinding resolveType(BlockScope scope)
   {
      ...
      if (this.arguments != null)
      {
         ...
         if (argHasError)
         {
            if (this.actualReceiverType instanceof ReferenceBinding)
            {
               ...
               this.binding = this.receiver.isImplicitThis() ? scope.getImplicitMethod(this.selector, pseudoArgs,
                  this) : scope.findMethod((ReferenceBinding)this.actualReceiverType, this.selector, pseudoArgs, this);
               if (this.binding != null && !this.binding.isValidBinding())
               {
                  ...
                  if (closestMatch != null)
                  {
                     ...
                     { // generic method
                        ...
                        closestMatch = scope.environment().createParameterizedGenericMethod(closestMatch.original(),
                           (RawTypeBinding)null);
                     }
                     this.binding = closestMatch;
                     MethodBinding closestMatchOriginal = closestMatch.original();
                     if (closestMatchOriginal.isOrEnclosedByPrivateType() && !scope.isDefinedInMethod(
                        closestMatchOriginal))
                     {
      ...
      this.binding = this.receiver.isImplicitThis() ? scope.getImplicitMethod(this.selector, argumentTypes,
         this) : scope.getMethod(this.actualReceiverType, this.selector, argumentTypes, this);
      if (!this.binding.isValidBinding())
      {
      ...
      if (((this.bits & ASTNode.InsideExpressionStatement) != 0) && this.binding.isPolymorphic())
      {
         ...
         this.binding = scope.environment().updatePolymorphicMethodReturnType((PolymorphicMethodBinding)this.binding,
            TypeBinding.VOID);
      }
      ...
      if (!this.binding.isStatic())
      {
         ...
         if (receiverIsType)
         {
            ...
            if (this.actualReceiverType.isRawType() && (this.receiver.bits & ASTNode.IgnoreRawTypeCheck) == 0 && compilerOptions.getSeverity(
         ...
         else
         {
            ...
            if (this.actualReceiverType != oldReceiverType && this.receiver.postConversionType(
               scope) != this.actualReceiverType)
      ...
      if (this.receiver.isSuper() && compilerOptions.getSeverity(
         CompilerOptions.OverridingMethodWithoutSuperInvocation) != ProblemSeverities.Ignore)
      {
         ...
         if (referenceContext instanceof AbstractMethodDeclaration)
         {
            ...
            if (enclosingMethodBinding.isOverriding() && CharOperation.equals(this.binding.selector,
               enclosingMethodBinding.selector) && this.binding.areParametersEqual(enclosingMethodBinding))
            {
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ast.Expression#setExpectedType(com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding)
    */

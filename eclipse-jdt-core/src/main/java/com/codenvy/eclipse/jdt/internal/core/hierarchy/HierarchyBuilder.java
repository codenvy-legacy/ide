...
import com.codenvy.eclipse.jdt.internal.core.util.ResourceCompilationUnit;
...
public abstract class HierarchyBuilder {
    ...
    public HierarchyBuilder(TypeHierarchy hierarchy) throws JavaModelException {
        ...
        com.codenvy.eclipse.jdt.core.ICompilationUnit unitToLookInside = focusType == null ? null : focusType.getCompilationUnit();
        com.codenvy.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.hierarchy.workingCopies;
        com.codenvy.eclipse.jdt.core.ICompilationUnit[] unitsToLookInside;
        ...
        if (project != null) {
            ...
            this.hierarchyResolver = new HierarchyResolver(searchableEnvironment, project.getOptions(true), this,
    ...
    protected IType getHandle(IGenericType genericType, ReferenceBinding binding) {
        ...
        if (genericType instanceof HierarchyType) {
            ...
            if (classFile == null) {
                ...
                // case of an anonymous type (see 1G2O5WK: ITPJCORE:WINNT - NullPointerException when selecting "Show in Type Hierarchy"
                // for a inner class)
    ...
    protected IBinaryType createInfoFromClassFile(Openable handle, IResource file) {
        ...
        } catch (com.codenvy.eclipse.jdt.internal.compiler.classfmt.ClassFormatException e) {
            if (TypeHierarchy.DEBUG) {
                e.printStackTrace();
            }
            return null;
    ...
    protected IBinaryType createInfoFromClassFileInJar(Openable classFile) {
        ...
        try {
            ...
            info = com.codenvy.eclipse.jdt.internal.compiler.classfmt.ClassFileReader.read(zipFile, classFilePath);
        } catch (com.codenvy.eclipse.jdt.internal.compiler.classfmt.ClassFormatException e) {
            if (TypeHierarchy.DEBUG) {
                e.printStackTrace();
            }

 ...
 * <dl>
 * <li>the AST has a {@link com.codenvy.eclipse.jdt.core.ITypeRoot} as source: {@link com.codenvy.eclipse.jdt.core.dom
 * .CompilationUnit#getTypeRoot()}
 * is not null.</li>
 * <li>the {@link com.codenvy.eclipse.jdt.core.dom.AST#apiLevel() AST API level} is {@link com.codenvy.eclipse.jdt.core.dom.AST#JLS4 API
 * level 4} or higher</li>
 * <li>the AST has bindings resolved ({@link com.codenvy.eclipse.jdt.core.dom.AST#hasResolvedBindings()})</li>
 * <li>{@link com.codenvy.eclipse.jdt.core.dom.AST#hasStatementsRecovery() statement} and {@link
 * com.codenvy.eclipse.jdt.core.dom.AST#hasBindingsRecovery() bindings}
 ...
 * </p>
 * <p>
 * The returned AST is shared. It is marked as {@link com.codenvy.eclipse.jdt.core.dom.ASTNode#PROTECT} and must not be modified. Clients
 * are advised to use
...
public final class SharedASTProvider {
     ...
     *
     * @param element
     *         the {@link com.codenvy.eclipse.jdt.core.ITypeRoot}, must not be <code>null</code>
     * @param waitFlag

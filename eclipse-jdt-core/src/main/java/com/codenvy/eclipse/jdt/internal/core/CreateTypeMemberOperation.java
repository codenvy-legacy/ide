...
public abstract class CreateTypeMemberOperation extends CreateElementInCUOperation
{
   ...
   private String removeIndentAndNewLines(String code, ICompilationUnit cu) throws JavaModelException
   {
      ...
      return IndentManipulation.changeIndent(code.substring(firstNonWhiteSpace, lastNonWhiteSpace + 1), indent,
         tabWidth, indentWidth, "", lineDelimiter); //$NON-NLS-1$
   }
   ...
   protected String generateSyntaxIncorrectAST()
   {
      ...
      IType type = getType();
      String lineSeparator = com.codenvy.eclipse.jdt.internal.core.util.Util.getLineSeparator(this.source,
         type == null ? null : type.getJavaProject());

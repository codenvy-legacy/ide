...
public class RawTypeBinding extends ParameterizedTypeBinding {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ParameterizedTypeBinding#createParameterizedMethod(com.codenvy.eclipse.jdt
     * .internal.compiler.lookup.MethodBinding) */
    ...
    protected void initializeArguments() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            typeArguments[i] =
                    this.environment.convertToRawType(typeVariables[i].erasure(), false /*do not force conversion of enclosing types*/);
        }

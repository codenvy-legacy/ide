...
public class ASTMatcher {
     ...
     *
     * @param node1
     *         the first AST node, or <code>null</code>; must be an
     *         instance of <code>ASTNode</code>
     * @param node2
     *         the second AST node, or <code>null</code>; must be an
     *         instance of <code>ASTNode</code>
    ...
    public boolean match(AnnotationTypeDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.modifiers(),
                                                                                            o.modifiers()) &&
                safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(
    ...
    public boolean match(AnnotationTypeMemberDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.modifiers(),
                                                                                            o.modifiers()) &&
                safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeMatch(node.getName(),
                                                                                  o.getName()) &&
    ...
    public boolean match(EnumConstantDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.modifiers(),
                                                                                            o.modifiers()) &&
                safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.arguments(),
                                                                                      o.arguments()) &&
                safeSubtreeMatch(node.getAnonymousClassDeclaration(), o.getAnonymousClassDeclaration()));
    }
    ...
    public boolean match(ForStatement node, Object other) {
        ...
        return (safeSubtreeListMatch(node.initializers(), o.initializers()) && safeSubtreeMatch(node.getExpression(),
                                                                                                o.getExpression()) &&
                safeSubtreeListMatch(node.updaters(), o.updaters()) && safeSubtreeMatch(node.getBody(),
                                                                                        o.getBody()));
    }
    ...
    public boolean match(SingleVariableDeclaration node, Object other) {
        ...
        return safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeMatch(node.getName(),
                                                                                 o.getName()) &&
               node.getExtraDimensions() == o.getExtraDimensions() && safeSubtreeMatch(node.getInitializer(),
                                                                                       o.getInitializer());
    }
    ...
    public boolean match(TryStatement node, Object other) {
        ...
        return (safeSubtreeListMatch(node.resources(), o.resources()) && safeSubtreeMatch(node.getBody(),
                                                                                          o.getBody()) &&
                safeSubtreeListMatch(node.catchClauses(), o.catchClauses()) && safeSubtreeMatch(
    ...
    public boolean match(VariableDeclarationFragment node, Object other) {
        ...
        return safeSubtreeMatch(node.getName(),
                                o.getName()) && node.getExtraDimensions() == o.getExtraDimensions() &&
               safeSubtreeMatch(node.getInitializer(),
                                o.getInitializer());
    }

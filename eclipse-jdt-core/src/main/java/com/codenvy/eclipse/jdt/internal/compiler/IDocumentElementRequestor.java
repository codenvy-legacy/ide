...
public interface IDocumentElementRequestor {
     ...
     * @param typeStart
     *         - a source position corresponding to the start of the fields type
     * @param typeEnd
     ...
     *         (for example, 'int v[]')
     * @param extendedTypeDimensionEnd
    ...
    void enterInterface(int declarationStart, int[] javaDocPositions, int modifiers, int modifiersStart,
                        int interfaceStart, char[] name, int nameStart, int nameEnd, char[][] superinterfaces, int[] superinterfaceStarts,
    ...
    /**
     * @param bodyEnd
     *         - a source position corresponding to the closing bracket of the method
     * @param declarationEnd

...
class VariableBinding implements IVariableBinding
{
   ...
   private com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding binding;
   ...
   VariableBinding(BindingResolver resolver, com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding binding)
   {
   ...
   private JavaElement getUnresolvedJavaElement()
   {
      ...
      if (isField())
      {
         if (this.resolver instanceof DefaultBindingResolver)
         {
            ...
            return Util.getUnresolvedJavaElement((FieldBinding)this.binding, defaultBindingResolver.workingCopyOwner,
      ...
      if (declaringMethod == null)
      {
         ...
         if (referenceContext instanceof TypeDeclaration)
         {
            ...
            typeHandle = Util.getUnresolvedJavaElement(typeDeclaration.binding, defaultBindingResolver.workingCopyOwner,
               defaultBindingResolver.getBindingsToNodesMap());
   ...
   public boolean isEqualTo(IBinding other)
   {
      ...
      com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding otherBinding = ((VariableBinding)other).binding;

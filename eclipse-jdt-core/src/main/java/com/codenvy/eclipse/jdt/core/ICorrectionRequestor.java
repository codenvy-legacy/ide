...
public interface ICorrectionRequestor {
     ...
     * @param correctionStart
     *         The start position of insertion of the correction of this field.
     * @param correctionEnd
     ...
     * @param correctionName
     *         The correction for the interface.
     ...
     * @param typePackageName
     *         Name of the package in which the type of this local variable is declared.
     * @param typeName
     *         Name of the type of this local variable.
     * @param modifiers
     *         The modifiers of this local variable.
     * @param correctionStart
     *         The start position of insertion of the correction of this local variable.
     * @param correctionEnd
     *         The end position of insertion of the correction of this local variable.
     *         <p/>
     *         NOTE - All package and type names are presented in their readable form:
     *         Package names are in the form "a.b.c".
     *         Base types are in the form "int" or "boolean".
     ...
     *
     * @param declaringTypePackageName
     *         Name of the package in which the type that contains this method is declared.
     * @param declaringTypeName
     *         Name of the type declaring this method.
     * @param selector
     *         Name of the method.
     ...
     *         Name of the return type of this method, should be <code>null</code> for a constructor.
     * @param correctionName
     ...
     * @param correctionStart
     *         The start position of insertion of the correction of this method.
     * @param correctionEnd
     ...
     * @param correctionStart
     *         The start position of insertion of the correction of this package.
     * @param correctionEnd

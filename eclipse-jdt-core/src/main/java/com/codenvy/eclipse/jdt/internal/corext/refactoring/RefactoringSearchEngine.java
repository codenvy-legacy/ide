...
/**
 * Convenience wrapper for {@link com.codenvy.eclipse.jdt.core.search.SearchEngine} - performs searching and sorts the results by {@link
 * com.codenvy.eclipse.core.resources.IResource}.
...
public class RefactoringSearchEngine {
     ...
     * @param status
     *         an error is added here if inaccurate or non-cu matches have been found

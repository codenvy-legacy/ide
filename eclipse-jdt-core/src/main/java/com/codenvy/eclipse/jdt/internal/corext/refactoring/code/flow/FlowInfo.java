 ...
 *     Benjamin Muskalla <bmuskalla@eclipsesource.com> - [extract method] missing return type when code can throw exception -
 *     https://bugs.eclipse.org/bugs/show_bug.cgi?id=97413
 *******************************************************************************/
...
public abstract class FlowInfo {
   ...
   /*	  					  UNUSED		   READ			    READ_POTENTIAL   WRTIE			  WRITE_POTENTIAL  UNKNOWN */
     ...
     * @param mode
     *         the access type. Valid values are <code>READ</code>, <code>WRITE</code>,

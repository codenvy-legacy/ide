...
class MethodBinding implements IMethodBinding {
    ...
    private com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding binding;
    ...
    MethodBinding(BindingResolver resolver, com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding binding) {
    ...
    public IAnnotationBinding[] getAnnotations() {
        ...
        com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations = this.binding.getAnnotations();
    ...
    public IAnnotationBinding[] getParameterAnnotations(int index) {
        ...
        com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations = this.binding.getParameterAnnotations();
        ...
        for (int i = 0; i < length; i++) {
            com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations = bindingAnnotations[i];
    ...
    public ITypeBinding[] getParameterTypes() {
        ...
        com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding[] parameters = this.binding.parameters;
    ...
    public ITypeBinding[] getExceptionTypes() {
        ...
        com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding[] exceptions = this.binding.thrownExceptions;
    ...
    /**
     * @see com.codenvy.eclipse.jdt.core.dom.IMethodBinding#isVarargs()
     * @since 3.1
     */
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding otherBinding = ((MethodBinding)other).binding;
        return BindingComparator.isEqual(this.binding, otherBinding);
    }

    /** @see com.codenvy.eclipse.jdt.core.dom.IMethodBinding#getTypeParameters() */
    ...
    /**
     * @see com.codenvy.eclipse.jdt.core.dom.IMethodBinding#isGenericMethod()
     * @since 3.1
     */
    ...
    /** @see com.codenvy.eclipse.jdt.core.dom.IMethodBinding#getTypeArguments() */
    public ITypeBinding[] getTypeArguments() {
        ...
        if (this.binding instanceof ParameterizedGenericMethodBinding) {
            ...
            com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding[] typeArgumentsBindings = genericMethodBinding.typeArguments;
    ...
    /** @see com.codenvy.eclipse.jdt.core.dom.IMethodBinding#isParameterizedMethod() */
    ...
    /** @see com.codenvy.eclipse.jdt.core.dom.IMethodBinding#isRawMethod() */
    ...
    public boolean isSubsignature(IMethodBinding otherMethod) {
        try {
            ...
            return lookupEnvironment != null && lookupEnvironment.methodVerifier().isMethodSubsignature(this.binding,
    ...
    /** @see com.codenvy.eclipse.jdt.core.dom.IMethodBinding#getMethodDeclaration() */
    ...
    public boolean overrides(IMethodBinding otherMethod) {
        LookupEnvironment lookupEnvironment = this.resolver.lookupEnvironment();
        return lookupEnvironment != null && lookupEnvironment.methodVerifier().doesMethodOverride(this.binding,

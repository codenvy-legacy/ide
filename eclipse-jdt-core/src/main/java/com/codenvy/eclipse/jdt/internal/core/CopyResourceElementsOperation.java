...
public class CopyResourceElementsOperation extends MultiOperation implements SuffixConstants {
     ...
     */
    private boolean createNeededPackageFragments(IContainer sourceFolder, PackageFragmentRoot root, String[] newFragName,
                                                 boolean moveFolder) throws JavaModelException {
    ...
    private void processCompilationUnitResource(ICompilationUnit source, PackageFragment dest) throws JavaModelException {
        ...
        com.codenvy.eclipse.jdt.internal.core.CompilationUnit destCU = new com.codenvy.eclipse.jdt.internal.core.CompilationUnit(dest,
                                                                                                                                 destName,
     ...
     *         complete
     */
    private void processPackageFragmentResource(PackageFragment source, PackageFragmentRoot root,
                        ...
                        for (int i = 0, max = resources.length; i < max; i++) {
                            ...
                            if (destinationResource != null) {
                                if (this.force) {
                                    ...
                                    throw new JavaModelException(new JavaModelStatus(IJavaModelStatusConstants.NAME_COLLISION,
                                                                                     Messages.bind(Messages.status_nameCollision,
                                                                                                   destinationResource.getFullPath()
                                                                                                                      .toString())));
                                }
                            }
                        }
    ...
    private void updatePackageStatement(CompilationUnit astCU, String[] pkgName, ASTRewrite rewriter,
        ...
        if (defaultPackage) {
            ...
            com.codenvy.eclipse.jdt.core.dom.PackageDeclaration pkg = astCU.getPackage();
            if (pkg != null) {
    ...
    protected void verify(IJavaElement element) throws JavaModelException {
        ...
        if (elementType == IJavaElement.COMPILATION_UNIT) {
            com.codenvy.eclipse.jdt.internal.core.CompilationUnit compilationUnit =
                    (com.codenvy.eclipse.jdt.internal.core.CompilationUnit)element;

...
public class CopyResourceElementsOperation extends MultiOperation implements SuffixConstants
{
    ...
    *
    * @throws JavaModelException if the operation is unable to
    *                            complete
    */
   ...
   protected void verify(IJavaElement element) throws JavaModelException
   {
      ...
      {
         com.codenvy.eclipse.jdt.internal.core.CompilationUnit compilationUnit = (com.codenvy.eclipse.jdt.internal.core.CompilationUnit)element;

...
public class PackageFragmentRoot extends Openable implements IPackageFragmentRoot
{
   ...
   public void attachSource(IPath sourcePath, IPath rootPath, IProgressMonitor monitor) throws JavaModelException
   {
      try
      {
         ...
         if (sourcePath == null)
         {
            ...
            setSourceMapper(null);      /* Disable deltas (see 1GDTUSD)
		...
		*/
		 ...
		 */
            ...
            {
               if (!(storedSourcePath.equals(sourcePath) && (rootPath != null && rootPath.equals(
                  storedRootPath)) || storedRootPath == null))
               {
                  rootNeedsToBeClosed = true;
               }
            }
         ...
         else
         {
            ...
            Util.setSourceAttachmentProperty(getPath(),
               sourcePath.toString() + (rootPath == null ? "" : (ATTACHMENT_PROPERTY_DELIMITER + rootPath.toString()))); //$NON-NLS-1$
         }
   ...
   public void delete(int updateResourceFlags, int updateModelFlags, IProgressMonitor monitor) throws JavaModelException
   {
      ...
      DeletePackageFragmentRootOperation op = new DeletePackageFragmentRootOperation(this, updateResourceFlags,
         updateModelFlags);
    ...
    *
    * @throws JavaModelException The resource associated with this package fragment root does not exist
    */
    ...
    *
    * @throws JavaModelException The resource associated with this package fragment does not exist
    */
      ...
      char[][] inclusionPatterns, char[][] exclusionPatterns) throws JavaModelException
   {
            ...
            for (int i = 0; i < length; i++)
            {
               ...
               switch (member.getType())
               {
                  ...
                  case IResource.FILE:
                     ...
                     if (!hasIncluded && Util.isValidCompilationUnitName(memberName, sourceLevel,
                        complianceLevel) && !Util.isExcluded(member, inclusionPatterns, exclusionPatterns))
                     {
                        hasIncluded = true;
                        IPackageFragment pkg = getPackageFragment(pkgName);
                        vChildren.add(pkg);
      ...
      catch (IllegalArgumentException e)
      {
         throw new JavaModelException(e,
            IJavaModelStatusConstants.ELEMENT_DOES_NOT_EXIST); // could be thrown by ElementTree when path is not found
      }
      ...
      IProgressMonitor monitor) throws JavaModelException
   {
      ...
      CopyPackageFragmentRootOperation op = new CopyPackageFragmentRootOperation(this, destination, updateResourceFlags,
    ...
    * @see IPackageFragmentRoot
    */
   public IPackageFragment createPackageFragment(String pkgName, boolean force,
      IProgressMonitor monitor) throws JavaModelException
   {
    ...
    *
    * @throws JavaModelException if the project and root do
    *                            not exist.
    */
      ...
      IProgressMonitor monitor) throws JavaModelException
   {
      ...
      MovePackageFragmentRootOperation op = new MovePackageFragmentRootOperation(this, destination, updateResourceFlags,
         updateModelFlags, sibling);
      op.runOperation(monitor);
   }

...
public abstract class NamedMember extends Member
{
   ...
   protected String getFullyQualifiedParameterizedName(String fullyQualifiedName,
      String uniqueKey) throws JavaModelException
   {
   ...
   public String[][] resolveType(String typeName, WorkingCopyOwner owner) throws JavaModelException
   {
      ...
      class TypeResolveRequestor implements ISelectionRequestor
      {
         ...
         public void acceptMethodTypeParameter(char[] declaringTypePackageName, char[] declaringTypeName,
            char[] selector, int selectorStart, int selcetorEnd, char[] typeParameterName, boolean isDeclaration,
            int start, int end)
         {
            // ignore
         }

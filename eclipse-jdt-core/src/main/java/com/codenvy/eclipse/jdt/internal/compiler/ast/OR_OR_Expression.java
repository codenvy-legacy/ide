...
public class OR_OR_Expression extends BinaryExpression
{
   ...
   public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo)
   {
      ...
      FlowInfo mergedInfo = FlowInfo.conditional(
         ...
         leftInfoWhenTrueForMerging.unconditionalInits().mergedWith(
            rightInfo.safeInitsWhenTrue().setReachMode(previousMode).unconditionalInits()), rightInfo.initsWhenFalse());
      this.mergedInitStateIndex = currentScope.methodScope().recordInitializationStates(mergedInfo);
      return mergedInfo;
   }
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.ast.BinaryExpression#resolveType(com.codenvy.eclipse.jdt.internal.compiler.lookup.BlockScope)
    */

 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.internal.core.eval;

import com.codenvy.eclipse.core.runtime.IProgressMonitor;
import com.codenvy.eclipse.jdt.core.CompletionRequestor;
import com.codenvy.eclipse.jdt.core.ICodeCompletionRequestor;
import com.codenvy.eclipse.jdt.core.ICompilationUnit;
import com.codenvy.eclipse.jdt.core.ICompletionRequestor;
...
import com.codenvy.eclipse.jdt.core.eval.ICodeSnippetRequestor;
...
import com.codenvy.eclipse.jdt.internal.core.JavaModelStatus;
...
import com.codenvy.eclipse.jdt.internal.core.SelectionRequestor;
import com.codenvy.eclipse.jdt.internal.core.SourceMapper;
import com.codenvy.eclipse.jdt.internal.core.builder.NameEnvironment;
import com.codenvy.eclipse.jdt.internal.core.builder.ProblemFactory;
...
import com.codenvy.eclipse.jdt.internal.eval.IRequestor;
import com.codenvy.eclipse.jdt.internal.eval.InstallException;
...
public class EvaluationContextWrapper implements IEvaluationContext
{
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#allVariables()
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor)
    * @deprecated
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor, WorkingCopyOwner)
    * @deprecated
    */
   public void codeComplete(String codeSnippet, int position, ICompletionRequestor requestor,
      WorkingCopyOwner owner) throws JavaModelException
   {
      ...
      codeComplete(codeSnippet, position, new com.codenvy.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor),
         owner);
   }

   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, IProgressMonitor)
    */
   public void codeComplete(String codeSnippet, int position, CompletionRequestor requestor,
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner)
    */
   public void codeComplete(String codeSnippet, int position, CompletionRequestor requestor,
      WorkingCopyOwner owner) throws JavaModelException
   {
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner, IProgressMonitor)
    */
   public void codeComplete(String codeSnippet, int position, CompletionRequestor requestor, WorkingCopyOwner owner,
      IProgressMonitor monitor) throws JavaModelException
   {
      SearchableEnvironment environment = this.project.newSearchableNameEnvironment(owner);
      this.context.complete(codeSnippet.toCharArray(), position, environment, requestor, this.project.getOptions(true),
         this.project, owner, monitor);
   }

   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#codeSelect(String, int, int)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#codeSelect(String, int, int, WorkingCopyOwner)
    */
   public IJavaElement[] codeSelect(String codeSnippet, int offset, int length,
      WorkingCopyOwner owner) throws JavaModelException
   {
      SearchableEnvironment environment = this.project.newSearchableNameEnvironment(owner);
      SelectionRequestor requestor = new SelectionRequestor(environment.nameLookup,
         null); // null because there is no need to look inside the code snippet itself
      this.context.select(codeSnippet.toCharArray(), offset, offset + length - 1, environment, requestor,
         this.project.getOptions(true), owner);
      return requestor.getElements();
   }

   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#deleteVariable(IGlobalVariable)
    */
    ...
    */
   public void evaluateCodeSnippet(String codeSnippet, String[] localVariableTypeNames, String[] localVariableNames,
      int[] localVariableModifiers, IType declaringType, boolean isStatic, boolean isConstructorCall,
      ICodeSnippetRequestor requestor, IProgressMonitor progressMonitor) throws com.codenvy.eclipse.jdt.core.JavaModelException
   {
      ...
      try
      {
         this.context.evaluate(codeSnippet.toCharArray(), varTypeNames, varNames, localVariableModifiers,
            declaringType == null ? null : declaringType.getFullyQualifiedName().toCharArray(), isStatic,
            isConstructorCall, environment = getBuildNameEnvironment(), options,
    ...
    */
   public void evaluateCodeSnippet(String codeSnippet, ICodeSnippetRequestor requestor,
      IProgressMonitor progressMonitor) throws JavaModelException
   {
      ...
      try
      {
         this.context.evaluate(codeSnippet.toCharArray(), environment = getBuildNameEnvironment(),
    ...
    */
   public void evaluateVariable(IGlobalVariable variable, ICodeSnippetRequestor requestor,
      IProgressMonitor progressMonitor) throws JavaModelException
   {
      ...
      try
      {
         this.context.evaluateVariable(((GlobalVariableWrapper)variable).variable,
            environment = getBuildNameEnvironment(), this.project.getOptions(true),
            getInfrastructureEvaluationRequestor(requestor), getProblemFactory());
      }
      catch (InstallException e)
      {
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#getImports()
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#getPackageName()
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#getProject()
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#newVariable(String, String, String)
    */
   public IGlobalVariable newVariable(String typeName, String name, String initializer)
   {
      GlobalVariable newVar = this.context.newVariable(typeName.toCharArray(), name.toCharArray(),
         (initializer == null) ? null : initializer.toCharArray());
      return new GlobalVariableWrapper(newVar);
   }

   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#setImports(String[])
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.eval.IEvaluationContext#setPackageName(String)
    */
   ...
   public void validateImports(ICodeSnippetRequestor requestor)
   {
      ...
      try
      {
         this.context.evaluateImports(environment = getBuildNameEnvironment(),
            getInfrastructureEvaluationRequestor(requestor), getProblemFactory());
      }
      finally
      {
   ...
   public void codeComplete(String codeSnippet, int position,
      final com.codenvy.eclipse.jdt.core.ICodeCompletionRequestor requestor) throws JavaModelException
   {
      ...
      codeComplete(codeSnippet, position, new ICompletionRequestor()
      {
         public void acceptAnonymousType(char[] superTypePackageName, char[] superTypeName,
            char[][] parameterPackageNames, char[][] parameterTypeNames, char[][] parameterNames, char[] completionName,
         ...
         {
            requestor.acceptField(declaringTypePackageName, declaringTypeName, name, typePackageName, typeName,
            ...
            int completionStart, int completionEnd, int relevance)
         {
            ...
            requestor.acceptMethod(declaringTypePackageName, declaringTypeName, selector, parameterPackageNames,
               parameterTypeNames, returnTypePackageName, returnTypeName, completionName, modifiers, completionStart,
               completionEnd);
         }

...
public class ChangeMethodSignatureArguments extends RefactoringArguments {
    ...
    public final static class Parameter {
         ...
         *
         * @param oldIndex
         *         the index of the parameter in the original method or <code>-1</code> if the parameter is a new parameter.
         * @param newName
         *         the new name of the parameter.
         * @param newSignature
         *         the new type of the parameter in signature notation (See {@link Signature}).
         * @param defaultValue
        ...
        public String toString() {
            return "name: " + fNewName + ", type: " + fNewSignature + ", oldIndex: " + fOldIndex + ", defaultValue: " +
     ...
     *
     * @param newName
     *         the new name of the element to be changed
     * @param newReturnType
     *         the new method return type in signature notation (see {@link Signature}).
     * @param newVisibility
     *         the new visibility; one of {@link Flags#AccPublic}, {@link Flags#AccProtected},
     *         {@link Flags#AccPrivate} or <code>0</code> for the default visibility.
     * @param newParameters
     *         the new parameters of this method
     * @param thrownExceptions
     *         the new exceptions thrown by this method
     * @param keepOriginal
     *         <code>true</code> if the original method is kept as a delegate to the new one,
     *         <code>false</code> otherwise
     */
    public ChangeMethodSignatureArguments(String newName, String newReturnType, int newVisibility,
                                          Parameter[] newParameters, ThrownException[] thrownExceptions, boolean keepOriginal) {

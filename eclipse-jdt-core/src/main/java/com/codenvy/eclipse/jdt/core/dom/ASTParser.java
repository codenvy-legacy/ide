...
import com.codenvy.eclipse.jdt.internal.compiler.batch.Main;
...
public class ASTParser {
    ...
    private List getClasspath() throws IllegalStateException {
        Main main = new Main(new PrintWriter(System.out), new PrintWriter(System.err), false/*systemExit*/, null/*options*/,
                             null/*progress*/);
        ArrayList allClasspaths = new ArrayList();
        try {
            if ((this.bits & CompilationUnitResolver.INCLUDE_RUNNING_VM_BOOTCLASSPATH) != 0) {
                com.codenvy.eclipse.jdt.internal.compiler.util.Util.collectRunningVMBootclasspath(allClasspaths);
            }
     ...
     * @param encodings
     *         the encodings of the corresponding sourcepath entries or <code>null</code> if the platform encoding
     *         can be used.
     ...
     *
     * @param enabled
     *         <code>true</code> if bindings are wanted,
     ...
     *
     * @param source
     *         the Java model compilation unit whose source code
     ...
     *
     * @param source
     *         the Java model class file whose corresponding source code
     *         is to be parsed, or <code>null</code> if none
     */
     ...
     *
     * @param source
     *         the Java model compilation unit or class file whose corresponding source code
     *         is to be parsed, or <code>null</code> if none
     * @since 3.3
     */
     ...
     *
     * @param enabled
     *         <code>true</code> if statements containing syntax errors are wanted,
        ...
        switch (this.astKind) {
                    ...
                    if (this.typeRoot != null) {
                        ...
                        if (this.typeRoot instanceof ICompilationUnit) {
                            com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit =
                                    (com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit)this.typeRoot;
            ...
            case K_COMPILATION_UNIT:
                ...
                try {
                    ...
                    com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = null;
                    ...
                    if (this.typeRoot instanceof ICompilationUnit) {                     /*
							 ...
							 */
                        sourceUnit = (com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit)this.typeRoot;
							/*
                        ...
                        needToResolveBindings = ((this.bits & CompilationUnitResolver.RESOLVE_BINDING) != 0) && this.unitName != null &&
                    ...
                    if (needToResolveBindings) {
                        ...
                        try {
                            ...
                            compilationUnitDeclaration = CompilationUnitResolver.resolve(sourceUnit, this.project,
                                                                                         getClasspath(), searcher, this.compilerOptions,
                                                                                         this.workingCopyOwner, flags, monitor);
                        } catch (JavaModelException e) {
                            flags &= ~ICompilationUnit.ENABLE_BINDINGS_RECOVERY;
                    ...
                    CompilationUnit result = CompilationUnitResolver.convert(compilationUnitDeclaration,
                                                                             sourceUnit.getContents(), this.apiLevel, this.compilerOptions,
                                                                             needToResolveBindings, wcOwner,
                                                                             needToResolveBindings
                                                                             ? new DefaultBindingResolver.BindingTables() : null, flags,
                                                                             monitor,
                                                                             this.project != null);
    ...
    private ASTNode internalCreateASTForKind() {
        ...
        switch (this.astKind) {
            case K_STATEMENTS:
                ...
                com.codenvy.eclipse.jdt.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
                if (statements != null) {
                ...
                return block;
            case K_EXPRESSION:
                com.codenvy.eclipse.jdt.internal.compiler.ast.Expression expression = codeSnippetParsingUtil.parseExpression(
            ...
            case K_CLASS_BODY_DECLARATIONS:
                final com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode[] nodes = codeSnippetParsingUtil.parseClassBodyDeclarations(
                        this.rawSource, this.sourceOffset, this.sourceLength, this.compilerOptions, true,

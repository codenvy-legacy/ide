 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.internal.core.hierarchy;
...
import com.codenvy.eclipse.jdt.internal.compiler.env.IGenericType;
...
public class HierarchyResolver implements ITypeRequestor {
    ...
    public void accept(ISourceType[] sourceTypes, PackageBinding packageBinding, AccessRestriction accessRestriction) {
        ...
        if (unit != null) {
            try {
                ...
                com.codenvy.eclipse.jdt.core.ICompilationUnit cu = ((SourceTypeElementInfo)sourceType).getHandle().getCompilationUnit();
        ...
        if (superBinding != null) {
            ...
            if (typeBinding.isHierarchyInconsistent()) {
                if (superBinding.problemId() == ProblemReasons.NotFound) {
                    ...
                    if (superclassName !=
                        null) { // check whether subclass of Object due to broken hierarchy (as opposed to explicitly extending it)
                        int lastSeparator = CharOperation.lastIndexOf(separator, superclassName);
                        char[] simpleName = lastSeparator == -1 ? superclassName : CharOperation.subarray(superclassName,
                                                                                                          lastSeparator + 1,
        ...
        for (int current = this.typeIndex; current >= 0; current--) {
            ...
            if (typeBinding instanceof SourceTypeBinding) {
                ...
                if (scope != null) {
                    ...
                    int length;
                    ReferenceBinding[] interfaceBindings = typeBinding.superInterfaces();
                    if (superInterfaces != null && (length = superInterfaces.length) > (interfaceBindings == null ? 0
                                                                                                                  : interfaceBindings
                                                                                                .length)) { // check for
                                                                                                // interfaceBindings being null (see
    ...
    private void remember(IType type, ReferenceBinding typeBinding) {
        if (((CompilationUnit)type.getCompilationUnit()).isOpen()) {
            ...
            HierarchyType hierarchyType = new HierarchyType(type, typeDeclaration.name, typeDeclaration.binding.modifiers,
     ...
     */
    private void rememberAllTypes(CompilationUnitDeclaration parsedUnit, com.codenvy.eclipse.jdt.core.ICompilationUnit cu,
        ...
        try {
            if (suppliedType.isBinaryType()) {
                BinaryTypeBinding binaryTypeBinding = this.lookupEnvironment.cacheBinaryType((IBinaryType)suppliedType,
                                                                                             false/*don't need field and method (bug
                                                                                             125067)*/,
                ...
                com.codenvy.eclipse.jdt.core.ICompilationUnit cu = ((SourceTypeElementInfo)suppliedType).getHandle().getCompilationUnit();
    ...
    public void resolve(Openable[] openables, HashSet localTypes, IProgressMonitor monitor) {
        try {
            ...
            com.codenvy.eclipse.jdt.core.ICompilationUnit[] cus = new com.codenvy.eclipse.jdt.core.ICompilationUnit[openablesLength];
            int unitsIndex = 0;
            ...
            for (int i = 0; i < openablesLength; i++) {
                ...
                if (openable instanceof com.codenvy.eclipse.jdt.core.ICompilationUnit) {
                    com.codenvy.eclipse.jdt.core.ICompilationUnit cu = (com.codenvy.eclipse.jdt.core.ICompilationUnit)openable;
                    ...
                    IBinaryType binaryType = (IBinaryType)JavaModelManager.getJavaModelManager().getInfo(
                            classFile.getType());
                    if (binaryType == null) {
                    ...
                    if (binaryType != null) {
                        try {
                            BinaryTypeBinding binaryTypeBinding =
                                    this.lookupEnvironment.cacheBinaryType(binaryType, false/*don't need field and method (bug 125067)*/,
                                                                           null /*no access restriction*/);
        ...
        } catch (ClassCastException e) { // work-around for 1GF5W1S - can happen in case duplicates are fed to the hierarchy with
        // binaries hiding sources
        } catch (AbortCompilation e) { // ignore this exception for now since it typically means we cannot find java.lang.Object

...
public class CodeFormatterUtil
{
    ...
    *                         It can be any of the kind constants defined in {@link com.codenvy.eclipse.jdt.core.formatter.CodeFormatter}
    ...
    *                         If set to <code>null</code>, then use the current settings from {@link com.codenvy.eclipse.jdt.core.JavaCore#getOptions()}.
    ...
    *                         Recognized options are documented on {@link com.codenvy.eclipse.jdt.core.JavaCore#getDefaultOptions()}.
    *                         If set to <code>null</code>, then use the current settings from {@link com.codenvy.eclipse.jdt.core.JavaCore#getOptions()}.
    * @return the formatted source string
    */
   public static String format(int kind, String source, int indentationLevel, String lineSeparator,
      Map<String, String> options)
   {
      ...
      else
      {
         ...
         {
            Util.log(e); // bug in the formatter
      ...
      Map<String, String> options)
   {
      ...
      TextEdit edit = format2(code, concatStr, prefix.length(), source.length(), indentationLevel, lineSeparator,
         options);

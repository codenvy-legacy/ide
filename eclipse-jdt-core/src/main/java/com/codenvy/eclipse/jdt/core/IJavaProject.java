...
public interface IJavaProject extends IParent, IJavaElement, IOpenable
{
    ...
    * @throws JavaModelException if the given path is <code>null</code>
    *                            or absolute
    */
    ...
    * @throws JavaModelException in one of the corresponding situation:
    *                            <ul>
    ...
    * @throws JavaModelException       if this element does not exist or if an
    *                                  exception occurs while accessing its corresponding resource
    * @throws IllegalArgumentException if type or region is <code>null</code>
    */
    ...
    * @throws JavaModelException if the classpath could not be set. Reasons include:
    *                            <ul>
    ...
    * @param monitor        the progress monitor
    * @param outputLocation the default output location
    * @throws JavaModelException if the classpath could not be set. Reasons
    *                            include:
    *                            <ul>
    *                            <li> This Java element does not exist (ELEMENT_DOES_NOT_EXIST)</li>

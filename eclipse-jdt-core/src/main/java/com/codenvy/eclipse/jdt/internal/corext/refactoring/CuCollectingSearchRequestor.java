...
public class CuCollectingSearchRequestor extends CollectingSearchRequestor {
     ...
     * Use {@link #collectMatch(com.codenvy.eclipse.jdt.core.search.SearchMatch)} instead.
     *
     * @param match
     ...
     * Subclasses can override and call {@link #collectMatch(com.codenvy.eclipse.jdt.core.search.SearchMatch)} to collect matches.
     *
     * @param unit

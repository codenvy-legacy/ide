...
public class AnnotationComponentValue extends ClassFileStruct implements IAnnotationComponentValue {
    ...
    public AnnotationComponentValue(byte[] classFileBytes, IConstantPool constantPool,
            ...
            case '[':
                ...
                if (numberOfValues != 0) {
                    ...
                    for (int i = 0; i < numberOfValues; i++) {
                        AnnotationComponentValue value = new AnnotationComponentValue(classFileBytes, constantPool,

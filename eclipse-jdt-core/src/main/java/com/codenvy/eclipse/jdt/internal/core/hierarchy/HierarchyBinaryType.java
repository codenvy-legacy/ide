...
public class HierarchyBinaryType implements IBinaryType {
    ...
    public HierarchyBinaryType(int modifiers, char[] qualification, char[] sourceName, char[] enclosingTypeName,
                               char[][] typeParameterSignatures, char typeSuffix) {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.env.IBinaryType */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.env.IBinaryType#getMissingTypeNames() */

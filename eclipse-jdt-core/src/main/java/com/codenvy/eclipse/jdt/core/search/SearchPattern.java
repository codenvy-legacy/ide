...
import com.codenvy.eclipse.jdt.internal.core.index.EntryResult;
...
import com.codenvy.eclipse.jdt.internal.core.search.StringOperation;
import com.codenvy.eclipse.jdt.internal.core.search.indexing.IIndexConstants;
import com.codenvy.eclipse.jdt.internal.core.search.matching.AndPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.ConstructorPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.FieldPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.LocalVariablePattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.MatchLocator;
import com.codenvy.eclipse.jdt.internal.core.search.matching.MethodPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.OrPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.PackageDeclarationPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.PackageReferencePattern;
...
import com.codenvy.eclipse.jdt.internal.core.search.matching.TypeParameterPattern;
import com.codenvy.eclipse.jdt.internal.core.search.matching.TypeReferencePattern;
 ...
 * </p>
 *
 * @see #createPattern(com.codenvy.eclipse.jdt.core.IJavaElement, int)
...
public abstract class SearchPattern {
     ...
     */
    public void acceptMatch(String relativePath, String containerPath, char separator, SearchPattern pattern, IndexQueryRequestor requestor,
                            SearchParticipant participant, IJavaSearchScope scope) {
     ...
     */
    public void acceptMatch(String relativePath, String containerPath, char separator, SearchPattern pattern, IndexQueryRequestor requestor,
                            SearchParticipant participant, IJavaSearchScope scope, IProgressMonitor monitor) {
    ...
    public static final boolean camelCaseMatch(String pattern, int patternStart, int patternEnd, String name, int nameStart, int nameEnd,
        ...
        return StringOperation.getCamelCaseMatchingRegions(pattern, patternStart, patternEnd, name, nameStart, nameEnd, samePartCount) !=
               null;
    }
     ...
     *
     * @param pattern
     *         the given pattern. If <code>null</code>,
    ...
    private static SearchPattern createFieldPattern(String patternString, int limitTo, int matchRule) {
        ...
        Scanner scanner = new Scanner(false /*comment*/, true /*whitespace*/, false /*nls*/, ClassFileConstants.JDK1_7/*sourceLevel*/,
                                      null /*taskTags*/,
                            ...
                            case TerminalTokens.TokenNameCOMMA:
                                ...
                                if (parameterTypes != null) {
                                    if (parameterTypes.length == parameterCount)
                                        System.arraycopy(parameterTypes, 0, parameterTypes = new String[parameterCount * 2], 0,
                                                         parameterCount);
                ...
                if (!ignoreDeclaringType) {
                    ...
                    if (enclosingNames.length > 0) {
                        declaringQualification =
                                CharOperation.concat(declaringQualification, CharOperation.concatWith(enclosingNames, '.'), '.');
                    }
                }
    ...
    private static SearchPattern createTypePattern(char[] simpleName, char[] packageName, char[][] enclosingTypeNames, String typeSignature,
                                                   IType type, int limitTo, int matchRule) {
        switch (limitTo) {
            case IJavaSearchConstants.DECLARATIONS:
    ...
    private static SearchPattern createTypePattern(String patternString, int limitTo, int matchRule, char indexSuffix) {
        // use 1.7 as the source level as there are more valid tokens in 1.7 mode
        // https://bugs.eclipse.org/bugs/show_bug.cgi?id=376673
        Scanner scanner = new Scanner(false /*comment*/, true /*whitespace*/, false /*nls*/, ClassFileConstants.JDK1_7/*sourceLevel*/, null /*taskTags*/,
                                      null/*taskPriorities*/, true/*taskCaseSensitive*/);
        scanner.setSource(patternString.toCharArray());
        String type = null;
        int token;
        ...
        switch (limitTo) {
            ...
            case IJavaSearchConstants.IMPLEMENTORS:
                return new SuperTypeReferencePattern(qualificationChars, typeChars, SuperTypeReferencePattern.ONLY_SUPER_INTERFACES,
                                                     indexSuffix, matchRule);
            case IJavaSearchConstants.ALL_OCCURRENCES:
                return new OrPattern(
                        new QualifiedTypeDeclarationPattern(qualificationChars, typeChars, indexSuffix, matchRule),

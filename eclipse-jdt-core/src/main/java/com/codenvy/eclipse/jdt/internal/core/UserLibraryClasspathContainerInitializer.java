...
public class UserLibraryClasspathContainerInitializer extends ClasspathContainerInitializer
{
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.ClasspathContainerInitializer#getDescription(com.codenvy.eclipse.core.runtime.IPath, com.codenvy.eclipse.jdt.core.IJavaProject)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.ClasspathContainerInitializer#requestClasspathContainerUpdate(com.codenvy.eclipse.core.runtime.IPath, com.codenvy.eclipse.jdt.core.IJavaProject, com.codenvy.eclipse.jdt.core.IClasspathContainer)
    */
      ...
      IClasspathContainer containerSuggestion) throws CoreException
   {
      if (isUserLibraryContainer(containerPath))
      {
         ...
         {
            JavaModelManager.getUserLibraryManager().setUserLibrary(name, containerSuggestion.getClasspathEntries(),
               containerSuggestion.getKind() == IClasspathContainer.K_SYSTEM);
         }
         else
         {

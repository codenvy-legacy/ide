...
public class RenameSupport
{
   ...
   public void perform() throws InterruptedException, InvocationTargetException, CoreException
   {
         ...
         RefactoringExecutionHelper helper = new RefactoringExecutionHelper(fRefactoring,
            RefactoringCore.getConditionCheckingFailedSeverity(), getJavaRenameProcessor().getSaveMode());
    ...
    *
    * @param descriptor the {@link com.codenvy.eclipse.jdt.core.refactoring.descriptors.RenameJavaElementDescriptor} to create a
    ...
    *
    * @param root    the {@link com.codenvy.eclipse.jdt.core.IPackageFragmentRoot} to be renamed.
    ...
    *
    * @param fragment the {@link com.codenvy.eclipse.jdt.core.IPackageFragment} to be renamed.
    ...
    *
    * @param unit    the {@link com.codenvy.eclipse.jdt.core.ICompilationUnit} to be renamed.
    ...
    *
    * @param type    the {@link com.codenvy.eclipse.jdt.core.IType} to be renamed.
    ...
    *
    * @param method  the {@link com.codenvy.eclipse.jdt.core.IMethod} to be renamed.
    ...
    *
    * @param field   the {@link com.codenvy.eclipse.jdt.core.IField} to be renamed.
    ...
    *
    * @param parameter the {@link com.codenvy.eclipse.jdt.core.ITypeParameter} to be renamed.
    ...
    *
    * @param variable the {@link com.codenvy.eclipse.jdt.core.ILocalVariable} to be renamed.

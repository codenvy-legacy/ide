 ...
 *******************************************************************************/
package com.codenvy.eclipse.jdt.ui.refactoring;
...
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenameCompilationUnitProcessor;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenameEnumConstProcessor;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenameFieldProcessor;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenameLocalVariableProcessor;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenameNonVirtualMethodProcessor;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenamePackageProcessor;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenameSourceFolderProcessor;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenameTypeParameterProcessor;
import com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenameTypeProcessor;
...
import com.codenvy.eclipse.jdt.internal.ui.RefactoringExecutionHelper;
...
public class RenameSupport {
    ...
    //	 * @throws org.eclipse.core.runtime.CoreException if an unexpected exception occurs while opening the
    //	 * dialog.
    //	 *
    ...
    //	 *
    //	 * @throws org.eclipse.core.runtime.CoreException if an error occurred while executing the
    //	 * operation.
    //	 *
     ...
     * {@link com.codenvy.eclipse.jdt.core.refactoring.descriptors.RenameJavaElementDescriptor}.
     *
     * @param descriptor
     *         the {@link com.codenvy.eclipse.jdt.core.refactoring.descriptors.RenameJavaElementDescriptor} to create a
    ...
    //	/**
    //	 * Creates a new rename support for the given {@link org.eclipse.jdt.core.IJavaProject}.
    //	 *
    //	 * @param project the {@link org.eclipse.jdt.core.IJavaProject} to be renamed.
    ...
    //	 * @return the {@link RenameSupport}.
    //	 * @throws org.eclipse.core.runtime.CoreException if an unexpected error occurred while creating
    ...
    /**
     * Creates a new rename support for the given {@link com.codenvy.eclipse.jdt.core.IPackageFragmentRoot}.
     *
     * @param root
     *         the {@link com.codenvy.eclipse.jdt.core.IPackageFragmentRoot} to be renamed.
     * @param newName
     *         the package fragment root's new name. <code>null</code> is
    ...
    /**
     * Creates a new rename support for the given {@link com.codenvy.eclipse.jdt.core.IPackageFragment}.
     *
     * @param fragment
     *         the {@link com.codenvy.eclipse.jdt.core.IPackageFragment} to be renamed.
     * @param newName
     *         the package fragment's new name. <code>null</code> is a
    ...
    /**
     * Creates a new rename support for the given {@link com.codenvy.eclipse.jdt.core.ICompilationUnit}.
     *
     * @param unit
     *         the {@link com.codenvy.eclipse.jdt.core.ICompilationUnit} to be renamed.
     * @param newName
     *         the compilation unit's new name. <code>null</code> is a
     *         valid value indicating that no new name is provided.
     * @param flags
     *         flags controlling additional parameters. Valid flags are
     *         <code>UPDATE_REFERENCES</code>, and <code>UPDATE_TEXTUAL_MATCHES</code>,
    ...
    /**
     * Creates a new rename support for the given {@link com.codenvy.eclipse.jdt.core.IType}.
     *
     * @param type
     *         the {@link com.codenvy.eclipse.jdt.core.IType} to be renamed.
     * @param newName
     *         the type's new name. <code>null</code> is a valid value
    ...
    /**
     * Creates a new rename support for the given {@link com.codenvy.eclipse.jdt.core.IMethod}.
     *
     * @param method
     *         the {@link com.codenvy.eclipse.jdt.core.IMethod} to be renamed.
     * @param newName
     *         the method's new name. <code>null</code> is a valid value
     *         indicating that no new name is provided.
     * @param flags
     *         flags controlling additional parameters. Valid flags are
     *         <code>UPDATE_REFERENCES</code> or <code>NONE</code>.
    ...
    /**
     * Creates a new rename support for the given {@link com.codenvy.eclipse.jdt.core.IField}.
     *
     * @param field
     *         the {@link com.codenvy.eclipse.jdt.core.IField} to be renamed.
     * @param newName
    ...
    /**
     * Creates a new rename support for the given {@link com.codenvy.eclipse.jdt.core.ITypeParameter}.
     *
     * @param parameter
     *         the {@link com.codenvy.eclipse.jdt.core.ITypeParameter} to be renamed.
     * @param newName
     *         the parameter's new name. <code>null</code> is a valid value
     *         indicating that no new name is provided.
     * @param flags
     *         flags controlling additional parameters. Valid flags are
     *         <code>UPDATE_REFERENCES</code>, or <code>NONE</code>.
    ...
    /**
     * Creates a new rename support for the given {@link com.codenvy.eclipse.jdt.core.ILocalVariable}.
     *
     * @param variable
     *         the {@link com.codenvy.eclipse.jdt.core.ILocalVariable} to be renamed.
     * @param newName
    ...
    private void ensureChecked() throws CoreException {
        if (fPreCheckStatus == null) {
            if (!fRefactoring.isApplicable()) {
                fPreCheckStatus = RefactoringStatus.createFatalErrorStatus("RenameSupport not available");
            } else {

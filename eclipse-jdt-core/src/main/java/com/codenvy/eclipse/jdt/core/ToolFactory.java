...
public class ToolFactory
{
      ...
      int decodingFlag)
   {
      ...
      try
      {
         ...
         {
            System.out.println(
               "(" + Thread.currentThread() + ") [ToolFactory.createDefaultClassFileReader()] Creating ZipFile on " + zipFileName); //$NON-NLS-1$	//$NON-NLS-2$
         }
      ...
      boolean recordLineSeparator)
   {
      ...
      PublicScanner scanner = new PublicScanner(tokenizeComments, tokenizeWhiteSpace, false/*nls*/,
         assertMode ? ClassFileConstants.JDK1_4 : ClassFileConstants.JDK1_3/*sourceLevel*/, complianceLevelValue, null/*taskTags*/,

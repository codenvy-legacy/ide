...
import com.codenvy.eclipse.jdt.internal.core.util.ClassFileReader;
import com.codenvy.eclipse.jdt.internal.core.util.Disassembler;
import com.codenvy.eclipse.jdt.internal.core.util.PublicScanner;
import com.codenvy.eclipse.jdt.internal.formatter.DefaultCodeFormatter;
...
public class ToolFactory {
     ...
     *
     * @return a classfile bytecode disassembler
     * @see com.codenvy.eclipse.jdt.core.util.IClassFileDisassembler
     * @deprecated Use {@link #createDefaultClassFileBytesDisassembler()} instead
     */
    public static com.codenvy.eclipse.jdt.core.util.IClassFileDisassembler createDefaultClassFileDisassembler() {
        class DeprecatedDisassembler extends Disassembler implements com.codenvy.eclipse.jdt.core.util.IClassFileDisassembler {
        ...
        if (root != null) {
            try {
                if (root instanceof JarPackageFragmentRoot) {
                    ...
                    String entryName = com.codenvy.eclipse.jdt.internal.core.util.Util.concatWith(packageFragment.names,
                                                                                                  classFileName, '/');
    ...
    public static IClassFileReader createDefaultClassFileReader(String zipFileName, String zipEntryName,
        ...
        try {
            if (JavaModelManager.ZIP_ACCESS_VERBOSE) {
                System.out.println(
                        "(" + Thread.currentThread() + ") [ToolFactory.createDefaultClassFileReader()] Creating ZipFile on " +
    ...
    public static ICodeFormatter createDefaultCodeFormatter(Map options) {
        ...
        return new com.codenvy.eclipse.jdt.internal.formatter.old.CodeFormatter(options);
    }
     ...
     * @return a scanner
     * @see com.codenvy.eclipse.jdt.core.compiler.IScanner
    ...
    public static IScanner createScanner(boolean tokenizeComments, boolean tokenizeWhiteSpace, boolean assertMode,
        ...
        PublicScanner scanner = new PublicScanner(tokenizeComments, tokenizeWhiteSpace, false/*nls*/,
                                                  ...
                                                  complianceLevelValue, null/*taskTags*/,
     ...
     *         considered as valid line separators.
     * @param sourceLevel
     *         if set to <code>&quot;1.3&quot;</code> or <code>null</code>, occurrences of 'assert' will be reported as identifiers
    ...
    public static IScanner createScanner(boolean tokenizeComments, boolean tokenizeWhiteSpace,
        ...
        PublicScanner scanner = new PublicScanner(tokenizeComments, tokenizeWhiteSpace, false/*nls*/, sourceLevelValue /*sourceLevel*/,
                                                  complianceLevelValue, null/*taskTags*/, null/*taskPriorities*/,
    ...
    public static IScanner createScanner(boolean tokenizeComments, boolean tokenizeWhiteSpace,
        ...
        scanner = new PublicScanner(tokenizeComments, tokenizeWhiteSpace, false/*nls*/, sourceLevelValue /*sourceLevel*/,

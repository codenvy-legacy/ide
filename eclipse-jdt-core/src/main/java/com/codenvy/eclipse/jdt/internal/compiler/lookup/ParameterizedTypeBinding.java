...
public class ParameterizedTypeBinding extends ReferenceBinding implements Substitution {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#canBeInstantiated() */
    public boolean canBeInstantiated() {
        return ((this.tagBits & TagBits.HasDirectWildcard) == 0) &&
               super.canBeInstantiated(); // cannot instantiate param type with wildcard arguments
    }

    /**
     * Perform capture conversion for a parameterized type with wildcard arguments
     *
     * @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#capture(Scope, int)
     */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#collectMissingTypes(java.util.List) */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#computeId() */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#constantPoolName() */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#debugName() */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#enclosingType() */
    public ReferenceBinding enclosingType() {
        return this.enclosingType;
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.Substitution#environment() */
    public LookupEnvironment environment() {
        return this.environment;
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#erasure() */
    public TypeBinding erasure() {
        return this.type.erasure(); // erasure
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#fieldCount() */
    public int fieldCount() {
        return this.type.fieldCount(); // same as erasure (lazy)
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#fields() */
    public FieldBinding[] fields() {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getAnnotationTagBits() */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getExactConstructor(TypeBinding[]) */
    public MethodBinding getExactConstructor(TypeBinding[] argumentTypes) {
        ...
        if ((this.tagBits & TagBits.AreMethodsComplete) != 0) { // have resolved all arg types & return type of the methods
            ...
            MethodBinding[] matchingMethods = getMethods(
                    TypeConstants.INIT); // takes care of duplicates & default abstract methods
            nextMethod:
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getExactMethod(char[], TypeBinding[],
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getField(char[], boolean) */
    public FieldBinding getField(char[] fieldName, boolean needResolve) {
        fields(); // ensure fields have been initialized... must create all at once unlike methods
        return ReferenceBinding.binarySearch(fieldName, this.fields);
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getMemberType(char[]) */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getMethods(char[]) */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#implementsMethod(MethodBinding) */
            ...
            for (int i = 0, length = someArguments.length; i < length; i++) {
                ...
                switch (someArgument.kind()) {
                    ...
                    case Binding.INTERSECTION_TYPE:
                        this.tagBits |= TagBits.HasDirectWildcard |
                                        TagBits.IsBoundParameterizedType; // Surely NOT X<?,?>,
                                        // see https://bugs.eclipse.org/bugs/show_bug.cgi?id=366131
                        break;
                    default:
                        this.tagBits |= TagBits.IsBoundParameterizedType;
                        break;
                ...
                this.tagBits |=
                        someArgument.tagBits & (TagBits.HasTypeVariable | TagBits.HasMissingType | TagBits.ContainsNestedTypeReferences);
            }
        }
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.Substitution#isRawSubstitution() */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#memberTypes() */
    public ReferenceBinding[] memberTypes() {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#methods() */
    public MethodBinding[] methods() {
        if ((this.tagBits & TagBits.AreMethodsComplete) != 0) {
            return this.methods;
        }
     ...
     *
     * @see com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding#problemId()
     */
    public int problemId() {
        return this.type.problemId();
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#qualifiedPackageName() */
    public char[] qualifiedPackageName() {
        return this.type.qualifiedPackageName();
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#qualifiedSourceName() */
    public char[] qualifiedSourceName() {
        return this.type.qualifiedSourceName();
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding#readableName() */
    ...
    ReferenceBinding resolve() {
        ...
        ReferenceBinding resolvedType = (ReferenceBinding)BinaryTypeBinding
                .resolveType(this.type, this.environment, false /* no raw conversion */); // still part of parameterized type ref
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding#shortReadableName() */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#signature() */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#sourceName() */
    public char[] sourceName() {
        return this.type.sourceName();
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.Substitution#substitute(com.codenvy.eclipse.jdt.internal.compiler.lookup
     * .TypeVariableBinding) */
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#superclass() */
    public ReferenceBinding superclass() {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#superInterfaces() */
    public ReferenceBinding[] superInterfaces() {
    ...
    public void swapUnresolved(UnresolvedReferenceBinding unresolvedType, ReferenceBinding resolvedType,
        ...
        if (this.type == unresolvedType) {
            ...
            if (enclosing != null) {
                this.enclosingType = (ReferenceBinding)env.convertUnresolvedBinaryToRawType(
                        enclosing); // needed when binding unresolved member type
            }
        }
        if (this.arguments != null) {
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#syntheticEnclosingInstanceTypes() */
    public ReferenceBinding[] syntheticEnclosingInstanceTypes() {
        return genericType().syntheticEnclosingInstanceTypes();
    }

    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#syntheticOuterLocalVariables() */

...
public class ParameterizedTypeBinding extends ReferenceBinding implements Substitution
{
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getExactMethod(char[], TypeBinding[], CompilationUnitScope)
    */
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.lookup.Substitution#substitute(com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding)
    */

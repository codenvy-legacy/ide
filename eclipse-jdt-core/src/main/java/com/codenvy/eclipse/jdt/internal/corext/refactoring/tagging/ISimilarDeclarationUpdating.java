...
public interface ISimilarDeclarationUpdating
{
    ...
    *
    * @param selectedStrategy one of the STRATEGY_* constants in {@link com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenamingNameSuggestor}
    */
    ...
    *
    * @return one of the STRATEGY_* constants in {@link com.codenvy.eclipse.jdt.internal.corext.refactoring.rename.RenamingNameSuggestor}
    */

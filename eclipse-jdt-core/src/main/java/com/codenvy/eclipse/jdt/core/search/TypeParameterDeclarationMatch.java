 ...
 * The element is an {@link com.codenvy.eclipse.jdt.core.ITypeParameter}.
 * <p>
...
public class TypeParameterDeclarationMatch extends SearchMatch {
     ...
     */
    public TypeParameterDeclarationMatch(IJavaElement element, int accuracy, int offset, int length, SearchParticipant participant,
                                         IResource resource) {

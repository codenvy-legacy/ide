 ...
 * </p>
 *
 * @see IPackageFragmentRoot#attachSource(com.codenvy.eclipse.core.runtime.IPath, com.codenvy.eclipse.core.runtime.IPath, IProgressMonitor)
 */
...
public interface IClassFile extends ITypeRoot {
     ...
     * @param owner
     *         the given {@link WorkingCopyOwner}, or <code>null</code> for the primary owner
     * @param monitor

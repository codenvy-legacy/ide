...
import com.codenvy.eclipse.jdt.internal.ui.viewsupport.JavaElementLabelComposer;
...
public class JavaElementLabels
{
   ...
   /**
    * Specifies to use the resolved information of a IType, IMethod or IField. See {@link com.codenvy.eclipse.jdt.core.IType#isResolved()}.
   ...
   public final static long ALL_FULLY_QUALIFIED = new Long(
      F_FULLY_QUALIFIED | M_FULLY_QUALIFIED | I_FULLY_QUALIFIED | T_FULLY_QUALIFIED | D_QUALIFIED | CF_QUALIFIED | CU_QUALIFIED | P_QUALIFIED | ROOT_QUALIFIED).longValue();

   /**
    * Post qualify all elements
    */
   public final static long ALL_POST_QUALIFIED = new Long(
      F_POST_QUALIFIED | M_POST_QUALIFIED | I_POST_QUALIFIED | T_POST_QUALIFIED | TP_POST_QUALIFIED | D_POST_QUALIFIED | CF_POST_QUALIFIED | CU_POST_QUALIFIED | P_POST_QUALIFIED | ROOT_POST_QUALIFIED).longValue();
   ...
   public final static long ALL_DEFAULT = new Long(
      M_PARAMETER_TYPES | M_APP_TYPE_PARAMETERS | T_TYPE_PARAMETERS).longValue();

   /**
    * Default qualify options (All except Root and Package)
    */
   public final static long DEFAULT_QUALIFIED = new Long(
      F_FULLY_QUALIFIED | M_FULLY_QUALIFIED | I_FULLY_QUALIFIED | T_FULLY_QUALIFIED | D_QUALIFIED | CF_QUALIFIED | CU_QUALIFIED).longValue();

   /**
    * Default post qualify options (All except Root and Package)
    */
   public final static long DEFAULT_POST_QUALIFIED = new Long(
      F_POST_QUALIFIED | M_POST_QUALIFIED | I_POST_QUALIFIED | T_POST_QUALIFIED | TP_POST_QUALIFIED | D_POST_QUALIFIED | CF_POST_QUALIFIED | CU_POST_QUALIFIED).longValue();
   ...
   /**
    * Returns the label of the given object. The object must be of type {@link com.codenvy.eclipse.jdt.core.IJavaElement} or adapt to { IWorkbenchAdapter}.
   ...
   //	/**
   //	 * Returns the styled label of the given object. The object must be of type {@link org.eclipse.jdt.core.IJavaElement} or adapt to {@link IWorkbenchAdapter}.
   //	 * If the element type is not known, the empty string is returned.

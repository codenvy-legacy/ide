...
import com.codenvy.eclipse.jdt.internal.core.ExternalJavaProject;
 ...
 * </p>
 *
 * @see ICompilationUnit#becomeWorkingCopy(com.codenvy.eclipse.core.runtime.IProgressMonitor)
 * @see ICompilationUnit#discardWorkingCopy()
 * @see ICompilationUnit#getWorkingCopy(com.codenvy.eclipse.core.runtime.IProgressMonitor)
 * @since 3.0
 */
public abstract class WorkingCopyOwner {
     ...
     *
     * @param workingCopy
     *         The problem requestor used for the given working copy.
     ...
     *
     * @param typeName
     *         the simple name of the type to lookup
     * @param packageName
     *         the dot-separated name of the package of type
     ...
     *
     * @param pkg
     *         the segments of a package to lookup
     ...
     * @param classpath
     *         the classpath used to resolve names in this working copy
    ...
    public final ICompilationUnit newWorkingCopy(String name, IClasspathEntry[] classpath,
        ...
        IPackageFragment parent = ((PackageFragmentRoot)project.getPackageFragmentRoot(
                project.getProject())).getPackageFragment(CharOperation.NO_STRINGS);

...
public class CommentRecorderParser extends Parser {
        ...
        if (validCount > 0) {
            ...
            while (index < lastCommentIndex && (immediateCommentEnd = -this.scanner.commentStops[index + 1]) >
                ...
                if (com.codenvy.eclipse.jdt.internal.compiler.util.Util.getLineNumber(position, this.scanner.lineEnds, 0,
                    ...
                    com.codenvy.eclipse.jdt.internal.compiler.util.Util.getLineNumber(immediateCommentEnd,
    ...
    private void pushOnCommentsStack(int start, int end) {
        ...
        for (int i = start; i <= end; i++) {
            ...
            int commentStart = this.commentPtr == -1 ? -1 : (this.commentStarts[this.commentPtr] < 0 ? -this.commentStarts[this.commentPtr]

...
public class CommentRecorderParser extends Parser
{
   ...
   public int flushCommentsDefinedPriorTo(int position)
   {
      ...
      if (validCount > 0)
      {
         ...
         { // only tolerating non-javadoc comments (non-javadoc comment end positions are negative)
            ...
            if (com.codenvy.eclipse.jdt.internal.compiler.util.Util.getLineNumber(position, this.scanner.lineEnds, 0,
               this.scanner.linePtr) != com.codenvy.eclipse.jdt.internal.compiler.util.Util.getLineNumber(immediateCommentEnd,
   ...
   public void initializeScanner()
   {
      this.scanner = new Scanner(false /*comment*/, false /*whitespace*/,
         ...
         this.options.sourceLevel /*sourceLevel*/, this.options.taskTags/*taskTags*/, this.options.taskPriorities/*taskPriorities*/,

...
public abstract class JavaElementResourceMapping extends ResourceMapping {
    ...
    private static final class JavaProjectResourceMapping extends JavaElementResourceMapping {
        ...
        public ResourceTraversal[] getTraversals(ResourceMappingContext context,
                                                 IProgressMonitor monitor) throws CoreException {
            return new ResourceTraversal[]{new ResourceTraversal(new IResource[]{fProject.getProject()},
    ...
    private static final class PackageFragementRootResourceMapping extends JavaElementResourceMapping {
        ...
        public ResourceTraversal[] getTraversals(ResourceMappingContext context,
                                                 IProgressMonitor monitor) throws CoreException {
            return new ResourceTraversal[]{new ResourceTraversal(new IResource[]{fRoot.getResource()},
                                                                 IResource.DEPTH_INFINITE, 0)};
        }
    }
    ...
    //   private static ResourceTraversal[] getRemotePackageFragmentTraversals(IPackageFragment pack,
    //      RemoteResourceMappingContext context, IProgressMonitor monitor) throws CoreException
    //   {
    //      ArrayList<ResourceTraversal> res = new ArrayList<ResourceTraversal>();
    //      IContainer container = (IContainer)pack.getResource();
    //
    ...
    //               if (member instanceof IFolder && JavaConventionsUtil.validatePackageName(member.getName(),
    //                  pack).getSeverity() == IStatus.ERROR)
    //               {
    ...
    private static final class CompilationUnitResourceMapping extends JavaElementResourceMapping {
        ...
        public ResourceTraversal[] getTraversals(ResourceMappingContext context,
                                                 IProgressMonitor monitor) throws CoreException {
            return new ResourceTraversal[]{new ResourceTraversal(new IResource[]{fUnit.getResource()}, IResource.DEPTH_ONE,
                                                                 0)};
        }
    }
    ...
    private static final class ClassFileResourceMapping extends JavaElementResourceMapping {
        ...
        public ResourceTraversal[] getTraversals(ResourceMappingContext context,
                                                 IProgressMonitor monitor) throws CoreException {
            return new ResourceTraversal[]{new ResourceTraversal(new IResource[]{fClassFile.getResource()},

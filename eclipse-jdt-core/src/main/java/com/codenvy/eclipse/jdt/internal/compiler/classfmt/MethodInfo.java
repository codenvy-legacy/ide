...
public class MethodInfo extends ClassFileStruct implements IBinaryMethod, Comparable {
                ...
                switch (attributeName[0]) {
                    case 'S':
                        if (CharOperation.equals(AttributeNamesConstants.SignatureName, attributeName)) {
                            methodInfo.signatureUtf8Offset = methodInfo.constantPoolOffsets[methodInfo.u2At(
    ...
    public boolean equals(Object o) {
        ...
        MethodInfo otherMethod = (MethodInfo)o;
        return CharOperation.equals(getSelector(), otherMethod.getSelector()) && CharOperation.equals(
                getMethodDescriptor(), otherMethod.getMethodDescriptor());
    }
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.env.IGenericMethod#getArgumentNames() */

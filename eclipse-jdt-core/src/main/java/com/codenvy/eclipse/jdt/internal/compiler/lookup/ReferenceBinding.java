...
abstract public class ReferenceBinding extends TypeBinding {
    ...
    public boolean canBeInstantiated() {
        return (this.modifiers & (ClassFileConstants.AccAbstract | ClassFileConstants.AccInterface | ClassFileConstants.AccEnum |
                ...
                if (!(receiverType == this || receiverType == enclosingType())) {
                    ...
                    if (receiverType.isTypeVariable()) {
                        ...
                        if (typeVariable.environment.globalOptions.complianceLevel <= ClassFileConstants.JDK1_6 &&
                            (typeVariable.isErasureBoundTo(
                                    erasure()) || typeVariable.isErasureBoundTo(enclosingType().erasure()))) {
                            break receiverCheck;
                        }
                    }
                    return false;
                                ...
                                switch (typeName[0]) {
                                    case 'C':
                                        if (CharOperation.equals(typeName, TypeConstants.JAVA_IO_CLOSEABLE[2])) {
                                            this.typeBits |=
                                                    TypeIds.BitCloseable; // don't assign id, only typeBit (for analysis of resource leaks)
                                        }
                                        return;
                                    case 'E':
                                    ...
                                    if (CharOperation.equals(packageName, TypeConstants.INVOKE)) {
                                        ...
                                        switch (typeName[0]) {
                                            case 'M':
                                                ...
                                                if (CharOperation.equals(typeName,
                                                                         TypeConstants
                                                                                 .JAVA_LANG_INVOKE_METHODHANDLE_POLYMORPHICSIGNATURE[3]) &&
                                        ...
                                        switch (typeName[0]) {
                                            case 'r':
                                                ...
                                                if (CharOperation.equals(typeName,
                                                    ...
                                                    CharOperation.equals(
                                                            memberTypeName, TypeConstants.ORG_ECLIPSE_CORE_RUNTIME_ASSERT[4])) {
    ...
    public int hashCode() {
        ...
        return (this.compoundName == null || this.compoundName.length == 0) ? super.hashCode() : CharOperation.hashCode(
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#isThrowable() */
     ...
     *
     * @see com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding#isUncheckedException(boolean)
     */

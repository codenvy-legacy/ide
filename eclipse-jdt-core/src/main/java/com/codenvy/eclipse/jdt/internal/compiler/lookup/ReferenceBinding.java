         ...
         receiverCheck:
         {
            if (!(receiverType == this || receiverType == enclosingType()))
            {
               ...
               if (receiverType.isTypeVariable())
               {
                  ...
                  if (typeVariable.environment.globalOptions.complianceLevel <= ClassFileConstants.JDK1_6 && (typeVariable.isErasureBoundTo(
                           ...
                           if (CharOperation.equals(packageName, TypeConstants.INVOKE))
                           {
                              ...
                              switch (typeName[0])
                              {
                                 case 'M':
                                    ...
                                    if (CharOperation.equals(typeName,
                                       TypeConstants.JAVA_LANG_INVOKE_METHODHANDLE_POLYMORPHICSIGNATURE[3]) && CharOperation.equals(
                                       memberTypeName,
                           ...
                           if (CharOperation.equals(packageName, TypeConstants.CORE))
                           {
                              ...
                              switch (typeName[0])
                              {
                                 case 'r':
                                    ...
                                    if (CharOperation.equals(typeName,
                                       TypeConstants.ORG_ECLIPSE_CORE_RUNTIME_ASSERT[3]) && CharOperation.equals(

...
public class BufferManager {
    ...
    /** @deprecated  */
    protected com.codenvy.eclipse.jdt.core.IBufferFactory defaultBufferFactory = new com.codenvy.eclipse.jdt.core.IBufferFactory() {
        /**
         * @deprecated
         */
    ...
    protected void addBuffer(IBuffer buffer) {
        ...
        if (VERBOSE) {
            System.out.println("-> Buffer cache filling ratio = " + NumberFormat.getInstance().format(
                    this.openBuffers.fillingRatio()) + "%"); //$NON-NLS-1$//$NON-NLS-2$
        }
    }
     ...
     * @deprecated
     */
    public com.codenvy.eclipse.jdt.core.IBufferFactory getDefaultBufferFactory() {

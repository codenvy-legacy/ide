...
public class ConstructorDeclaration extends AbstractMethodDeclaration {
    ...
    public void analyseCode(ClassScope classScope, InitializationFlowContext initializerFlowContext, FlowInfo flowInfo,
        ...
        try {
            ...
            if (this.statements != null) {
                int complaintLevel = (nonStaticFieldInfoReachMode & FlowInfo.UNREACHABLE) == 0 ? Statement.NOT_COMPLAINED
    ...
    private void internalGenerateCode(ClassScope classScope, ClassFile classFile) {
        ...
        if ((!this.binding.isNative()) && (!this.binding.isAbstract())) {
            ...
            initializerScope.computeLocalVariablePositions(argSlotSize,
                                                           codeStream); // offset by the argument size (since not linked to method scope)
    ...
    public boolean isRecursive(ArrayList visited) {
        ...
        ConstructorDeclaration targetConstructor = ((ConstructorDeclaration)this.scope.referenceType().declarationOf(
                this.constructorCall.binding.original()));

...
import com.codenvy.eclipse.jdt.internal.compiler.util.CompoundNameVector;
import com.codenvy.eclipse.jdt.internal.compiler.util.HashtableOfObject;
import com.codenvy.eclipse.jdt.internal.compiler.util.HashtableOfType;
import com.codenvy.eclipse.jdt.internal.compiler.util.ObjectVector;
import com.codenvy.eclipse.jdt.internal.compiler.util.SimpleNameVector;
...
public class CompilationUnitScope extends Scope {
        ...
        if (this.currentPackageName == CharOperation.NO_CHAR_CHAR) {
            ...
            if ((this.fPackage = this.environment.createPackage(this.currentPackageName)) == null) {
                if (this.referenceContext.currentPackage != null) {
                    problemReporter().packageCollidesWithType(
    ...
    void checkAndSetImports() {
        ...
        for (int i = 0; i < numberOfStatements; i++) {
            ...
            if (((importReference.bits & ASTNode.OnDemand) != 0) && CharOperation.equals(TypeConstants.JAVA_LANG,
    ...
    private Binding findImport(char[][] compoundName, int length) {
        ...
        while (i < length) {
            type = (ReferenceBinding)this.environment.convertToRawType(type,
                                                                       false /*do not force conversion of enclosing types*/); // type
                                                                       // imports are necessarily raw for all except last
    ...
    ImportBinding[] getDefaultImports() {
        ...
        return this.environment.defaultImports = new ImportBinding[]{new ImportBinding(TypeConstants.JAVA_LANG, true,
                                                                                       importBinding, null)};
    }
    ...
    private int checkAndRecordImportBinding(Binding importBinding, HashtableOfType typesBySimpleNames,
        ...
        if (importBinding instanceof ReferenceBinding || conflictingType != null) {
            ...
            ReferenceBinding typeToCheck =
                    referenceBinding.problemId() == ProblemReasons.Ambiguous ? ((ProblemReferenceBinding)referenceBinding).closestMatch
                                                                             : referenceBinding;

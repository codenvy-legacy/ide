...
public class StubUtility
{
    ...
    *
    * @param variableKind    specifies what type the variable is: {@link com.codenvy.eclipse.jdt.core.NamingConventions#VK_LOCAL},
    *                        {@link com.codenvy.eclipse.jdt.core.NamingConventions#VK_PARAMETER}, {@link com.codenvy.eclipse.jdt.core.NamingConventions#VK_STATIC_FIELD},
   ...
   {
      return true; //Boolean.valueOf(PreferenceConstants.getPreference(PreferenceConstants.CODEGEN_IS_FOR_GETTERS, project)).booleanValue();
   }
   //
   ...
   /**
    * Returns a {@link com.codenvy.eclipse.jdt.core.dom.rewrite.ImportRewrite} using {@link com.codenvy.eclipse.jdt.core.dom.rewrite.ImportRewrite#create(com.codenvy.eclipse.jdt.core.dom.CompilationUnit, boolean)} and
    * configures the rewriter with the settings as specified in the JDT UI preferences.
    * <p>
    * This method sets {@link com.codenvy.eclipse.jdt.core.dom.rewrite.ImportRewrite#setUseContextToFilterImplicitImports(boolean)} to <code>true</code>

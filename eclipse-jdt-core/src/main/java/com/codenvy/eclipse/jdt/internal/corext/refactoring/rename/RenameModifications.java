...
import com.codenvy.eclipse.jdt.internal.corext.refactoring.reorg.RefactoringModifications;
...
import com.codenvy.eclipse.ltk.core.refactoring.participants.RefactoringArguments;
...
public class RenameModifications extends RefactoringModifications {
    ...
    public void rename(IPackageFragment rootPackage, RenameArguments args,
        ...
        if (renameSubPackages) {
            ...
            for (int i = 0; i < allSubPackages.length; i++) {
                ...
                RenameArguments subArgs = new RenameArguments(
                        getNewPackageName(rootPackage, args.getNewName(), pack.getElementName()), args.getUpdateReferences());
    ...
    private void addAllResourceModifications(IPackageFragment rootPackage, RenameArguments args,
                                             boolean renameSubPackages, IPackageFragment[] allSubPackages) throws CoreException {
    ...
    private IFolder addResourceModifications(IPackageFragment rootPackage, RenameArguments args, IPackageFragment pack,
                                             boolean renameSubPackages) throws CoreException {

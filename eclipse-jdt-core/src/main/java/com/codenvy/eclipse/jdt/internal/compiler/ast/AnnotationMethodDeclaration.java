...
public class AnnotationMethodDeclaration extends MethodDeclaration {
    ...
    public void resolveStatements() {
        ...
        if (returnTypeBinding != null) {
            ...
            if (this.defaultValue != null) {
                MemberValuePair pair = new MemberValuePair(this.selector, this.sourceStart, this.sourceEnd,
                                                           this.defaultValue);
                pair.binding = this.binding;
                pair.resolveTypeExpecting(this.scope, returnTypeBinding);
                this.binding.setDefaultValue(
                        com.codenvy.eclipse.jdt.internal.compiler.lookup.ElementValuePair.getValue(this.defaultValue));

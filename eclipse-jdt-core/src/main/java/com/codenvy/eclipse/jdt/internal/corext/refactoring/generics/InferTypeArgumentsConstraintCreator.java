...
public class InferTypeArgumentsConstraintCreator extends HierarchicalASTVisitor {
    ...
    public void endVisit(CastExpression node) {
        ...
        if (!(expressionCv instanceof TypeVariable2 || expressionCv instanceof IndependentTypeVariable2 ||
              expressionCv instanceof CollectionElementVariable2) && fTCModel.getElementVariables(
    ...
    private boolean isSpecialCloneInvocation(IMethodBinding methodBinding, Expression receiver) {
        return fAssumeCloneReturnsSameType && "clone".equals(methodBinding.getName()) //$NON-NLS-1$
               && methodBinding.getParameterTypes().length == 0 && receiver != null &&
        ...
        for (int i = 0; i < arguments.size(); i++) {
            ...
            if (!methodBinding.isVarargs() || i < lastParamIdx) {
                ...
                if (i == lastParamIdx && canAssignToVararg(fTCModel.createTType(arg.resolveTypeBinding()),
                                                           (com.codenvy.eclipse.jdt.internal.corext.refactoring.typeconstraints.types
                                                                   .ArrayType)declaredParameterType)) {
     ...
     * @param node
     *         the ASTNode
     * @return the {@link com.codenvy.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ConstraintVariable2} associated with the node,
     *         or <code>null</code>
     */
     ...
     *         the {@link com.codenvy.eclipse.jdt.internal.corext.refactoring.typeconstraints2.ConstraintVariable2} to be associated with
     *         node
     */

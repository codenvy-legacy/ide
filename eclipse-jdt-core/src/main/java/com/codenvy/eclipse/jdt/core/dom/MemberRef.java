...
public class MemberRef extends ASTNode implements IDocElement
{
   ...
   public static final ChildPropertyDescriptor QUALIFIER_PROPERTY = new ChildPropertyDescriptor(MemberRef.class,
      "qualifier", Name.class, OPTIONAL, NO_CYCLE_RISK); //$NON-NLS-1$
    ...
    * @since 3.0
    */
   public static final ChildPropertyDescriptor NAME_PROPERTY = new ChildPropertyDescriptor(MemberRef.class, "name",

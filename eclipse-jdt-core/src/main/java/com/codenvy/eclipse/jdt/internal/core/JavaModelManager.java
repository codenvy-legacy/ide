...
import com.codenvy.eclipse.core.resources.ISaveContext;
...
import com.codenvy.eclipse.core.runtime.content.IContentTypeManager.ContentTypeChangeEvent;
import com.codenvy.eclipse.core.runtime.content.IContentTypeManager.IContentTypeChangeListener;
import com.codenvy.eclipse.jdt.core.ClasspathContainerInitializer;
...
import com.codenvy.eclipse.jdt.core.IParent;
import com.codenvy.eclipse.jdt.core.IProblemRequestor;
...
import com.codenvy.eclipse.jdt.core.compiler.CompilationParticipant;
...
import com.codenvy.eclipse.jdt.internal.compiler.AbstractAnnotationProcessorManager;
...
import com.codenvy.eclipse.jdt.internal.core.search.AbstractSearchScope;
import com.codenvy.eclipse.jdt.internal.core.search.BasicSearchEngine;
import com.codenvy.eclipse.jdt.internal.core.search.IRestrictedAccessTypeRequestor;
import com.codenvy.eclipse.jdt.internal.core.search.JavaWorkspaceScope;
import com.codenvy.eclipse.jdt.internal.core.search.indexing.IndexManager;
import com.codenvy.eclipse.jdt.internal.core.util.HashtableOfArrayToObject;
import com.codenvy.eclipse.jdt.internal.core.util.LRUCache;
import com.codenvy.eclipse.jdt.internal.core.util.LRUCache.Stats;
import com.codenvy.eclipse.jdt.internal.core.util.Messages;
import com.codenvy.eclipse.jdt.internal.core.util.Util;
import com.codenvy.eclipse.jdt.internal.core.util.WeakHashSet;
import com.codenvy.eclipse.jdt.internal.core.util.WeakHashSetOfCharArray;
...
public class JavaModelManager implements ISaveParticipant, IContentTypeChangeListener
{
      ...
      public void flush()
      {
         ...
         while (iterator.hasNext())
         {
            try
            {
               ...
               {
                  System.out.println(
                     "(" + currentThread + ") [JavaModelManager.flushZipFiles()] Closing ZipFile on " + zipFile.getName()); //$NON-NLS-1$//$NON-NLS-2$
               }
               zipFile.close();
            }
            catch (IOException e)
      ...
      final IClasspathEntry[] newEntries, final IClasspathEntry[] oldEntries)
   {
      Util.verbose("CPContainer SET  - missbehaving container\n" + //$NON-NLS-1$
         ...
         "	projects: {" +//$NON-NLS-1$
         com.codenvy.eclipse.jdt.internal.compiler.util.Util.toString(projects,
            new com.codenvy.eclipse.jdt.internal.compiler.util.Util.Displayable()
            {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.util.Util.toString(respectiveContainers,
            new com.codenvy.eclipse.jdt.internal.compiler.util.Util.Displayable()
            {
               public String displayString(Object o)
               {
   ...
   void verbose_missbehaving_container(IJavaProject project, IPath containerPath, IClasspathEntry[] classpathEntries)
   {
      Util.verbose("CPContainer GET - missbehaving container (returning null classpath entry)\n" + //$NON-NLS-1$
         ...
         "	container path: " + containerPath + '\n' + //$NON-NLS-1$
         "	classpath entries: {\n" + //$NON-NLS-1$
         com.codenvy.eclipse.jdt.internal.compiler.util.Util.toString(classpathEntries,
            new com.codenvy.eclipse.jdt.internal.compiler.util.Util.Displayable()
            {
               public String displayString(Object o)
               {
   ...
   public static IJavaElement create(IFile file, IJavaProject project)
   {
      ...
      if (file.getFileExtension() != null)
      {
         ...
         if (com.codenvy.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(name))
         {
            return createCompilationUnitFrom(file, project);
         }
         if (com.codenvy.eclipse.jdt.internal.compiler.util.Util.isClassFileName(name))
         {
   ...
   public static ICompilationUnit createCompilationUnitFrom(IFile file, IJavaProject project)
   {
      ...
      if (pkg == null)
      {
         ...
         {
            System.out.println(
               "WARNING : creating unit element outside classpath (" + Thread.currentThread() + "): " + file.getFullPath()); //$NON-NLS-1$//$NON-NLS-2$
         }
      }
   ...
   public static IJavaElement determineIfOnClasspath(IResource resource, IJavaProject project)
   {
      ...
      try
      {
         ...
         boolean isJavaLike = com.codenvy.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(resourcePath.lastSegment());
            ...
            for (int i = 0; i < length; i++)
            {
               ...
               else if (rootPath.isPrefixOf(resourcePath))
               {
                     ...
                     ((ClasspathEntry)entry).fullExclusionPatternChars()))
                  {
                     ...
                     PackageFragmentRoot root = isExternal ? new ExternalPackageFragmentRoot(rootPath,
                        (JavaProject)project) : (PackageFragmentRoot)((JavaProject)project).getFolderPackageFragmentRoot(
                        rootPath);
                     if (root == null)
                     {
                        return null;
   ...
   public static class PerProjectInfo
   {
      ...
      private ClasspathChange setClasspath(IClasspathEntry[] newRawClasspath, IClasspathEntry[] referencedEntries,
         ...
         Map newRootPathToRawEntries, Map newRootPathToResolvedEntries, IJavaModelStatus newUnresolvedEntryStatus,
         ...
         IClasspathEntry[] referencedEntries, IPath newOutputLocation, IJavaModelStatus newRawClasspathStatus)
      {
         ...
         return setClasspath(newRawClasspath, referencedEntries, newOutputLocation, newRawClasspathStatus, null/*resolved classpath*/,
            null/*root to raw map*/, null/*root to resolved map*/, null/*unresolved status*/, true/*add classpath change*/);
      }

      public ClasspathChange setResolvedClasspath(IClasspathEntry[] newResolvedClasspath, Map newRootPathToRawEntries,
         Map newRootPathToResolvedEntries, IJavaModelStatus newUnresolvedEntryStatus, int timeStamp,
         boolean addClasspathChange)
      {
      ...
      public synchronized ClasspathChange setResolvedClasspath(IClasspathEntry[] newResolvedClasspath,
         IClasspathEntry[] referencedEntries, Map newRootPathToRawEntries, Map newRootPathToResolvedEntries,
         IJavaModelStatus newUnresolvedEntryStatus, int timeStamp, boolean addClasspathChange)
      {
   ...
   public void closeZipFile(ZipFile zipFile)
   {
      ...
      try
      {
         ...
         {
            System.out.println(
               "(" + Thread.currentThread() + ") [JavaModelManager.closeZipFile(ZipFile)] Closing ZipFile on " + zipFile.getName()); //$NON-NLS-1$	//$NON-NLS-2$
         }
         zipFile.close();
      }
      catch (IOException e)
   ...
   public AbstractAnnotationProcessorManager createAnnotationProcessorManager()
   {
      ...
      //               {
      //                  Util.log(null,
      //                     "An annotation processor manager is already registered: ignoring " + extensions[i].getUniqueIdentifier()); //$NON-NLS-1$
      //                  break;
      //               }
      //               IConfigurationElement[] configElements = extensions[i].getConfigurationElements();
      //               for (int j = 0; j < configElements.length; j++)
      //               {
      //                  final IConfigurationElement configElement = configElements[j];
      //                  if ("annotationProcessorManager".equals(configElement.getName()))
      //                  { //$NON-NLS-1$
   ...
   public IClasspathContainer getClasspathContainer(final IPath containerPath,
      final IJavaProject project) throws JavaModelException
   {
      ...
      if (container == null)
      {
         ...
         else
         {
            ...
            SetContainerOperation operation = new SetContainerOperation(containerPath, new IJavaProject[]{project},
   ...
   public IClasspathEntry[] getReferencedClasspathEntries(IClasspathEntry libraryEntry, IJavaProject project)
   {
      ...
      for (int index = 0; index < referencedEntries.length; index++)
      {
         ...
         if ((persistedEntry = (IClasspathEntry)perProjectInfo.rootPathToResolvedEntries.get(
            referencedEntries[index].getPath())) != null)
         {
      ...
      IProblemRequestor problemRequestor)
   {
      ...
      { // use the perWorkingCopyInfo collection as its own lock
         ...
         PerWorkingCopyInfo info = workingCopyToInfos == null ? null : (PerWorkingCopyInfo)workingCopyToInfos.get(
            workingCopy);
         if (info == null && create)
         {
   ...
   public IClasspathEntry resolveVariableEntry(IClasspathEntry entry, boolean usePreviousSession)
   {
      ...
      if (target instanceof File)
      {
         ...
         if (externalFile != null)
         {
            ...
            return JavaCore.newLibraryEntry(resolvedPath,
               getResolvedVariablePath(entry.getSourceAttachmentPath(), usePreviousSession),
               getResolvedVariablePath(entry.getSourceAttachmentRootPath(), usePreviousSession), entry.getAccessRules(),
               entry.getExtraAttributes(), entry.isExported());
         }
         else
         {
   ...
   public IPath getResolvedVariablePath(IPath variablePath, boolean usePreviousSession)
   {
      ...
      IPath resolvedPath = usePreviousSession ? getPreviousSessionVariable(
         variableName) : JavaCore.getClasspathVariable(variableName);
      if (resolvedPath == null)
      {
         return null;
      }
   ...
   public ICompilationUnit[] getWorkingCopies(WorkingCopyOwner owner, boolean addPrimary)
   {
      synchronized (this.perWorkingCopyInfos)
      {
         ICompilationUnit[] primaryWCs = addPrimary && owner != DefaultWorkingCopyOwner.PRIMARY ? getWorkingCopies(
   ...
   public void verifyArchiveContent(IPath path) throws CoreException
   {
      if (isInvalidArchive(path))
      {
         throw new CoreException(
            new Status(IStatus.ERROR, JavaCore.PLUGIN_ID, -1, Messages.status_IOException, new ZipException()));
      }
   ...
   public ZipFile getZipFile(IPath path) throws CoreException
   {
      ...
      if (file != null)
      {
         ...
         {
            throw new CoreException(
               new Status(IStatus.ERROR, JavaCore.PLUGIN_ID, -1, Messages.bind(Messages.file_notFound, path.toString()),
                  null));
         }
      ...
      try
      {
         ...
         {
            System.out.println(
               "(" + Thread.currentThread() + ") [JavaModelManager.getZipFile(IPath)] Creating ZipFile on " + localFile); //$NON-NLS-1$ //$NON-NLS-2$
         }
   ...
   /*
	 ...
	 */
   private IClasspathContainer initializeAllContainers(IJavaProject javaProjectToInit,
      IPath containerToInit) throws JavaModelException
   {
      if (CP_RESOLVE_VERBOSE_ADVANCED)
      {
   ...
   IClasspathContainer initializeContainer(IJavaProject project, IPath containerPath) throws JavaModelException
   {
      ...
      if (initializer != null)
      {
         ...
         try
         {
            ...
            {
               monitor.subTask(
                  Messages.bind(Messages.javamodel_configuring, initializer.getDescription(containerPath, project)));
            }
   ...
   {
      return JavaCore.COMPILER_PB_INVALID_IMPORT.equals(optionName) || JavaCore.COMPILER_PB_UNREACHABLE_CODE.equals(
         optionName);
   }
   ...
   private Set getNonChainingJarsCache() throws CoreException
   {
      ...
      for (int i = 0, length = projects.length; i < length; i++)
      {
         ...
         for (int j = 0, length2 = classpath.length; j < length2; j++)
         {
            ...
            IPath path;
            if (entry.getEntryKind() == IClasspathEntry.CPE_LIBRARY && !result.contains(
               path = entry.getPath()) && ClasspathEntry.resolvedChainedLibraries(path).length == 0)
            {
               result.add(path);
            }
         }
   ...
   private final class VariablesAndContainersLoadHelper
   {
      ...
      private IClasspathEntry loadClasspathEntry() throws IOException
      {
         ...
         IClasspathEntry entry = new ClasspathEntry(contentKind, entryKind, path, inclusionPatterns, exclusionPatterns,
            sourceAttachmentPath, sourceAttachmentRootPath, specificOutputLocation, isExported, accessRules,
   ...
   protected Object readState(IProject project) throws CoreException
   {
      ...
      if (file != null && file.exists())
      {
         ...
         {
            e.printStackTrace();
            throw new CoreException(new Status(IStatus.ERROR, JavaCore.PLUGIN_ID, 42,
      ...
      if (info != null)
      {
         ...
         try
         {
            if (JavaModelCache.VERBOSE)
            {
               ...
               System.out.println(
                  Thread.currentThread() + " CLOSING " + elementType + " " + element.toStringWithAncestors());  //$NON-NLS-1$//$NON-NLS-2$
               wasVerbose = true;
...
//      MANAGER = new JavaModelManager();
   ...
   private void saveBuiltState(PerProjectInfo info) throws CoreException
   {
      ...
      catch (RuntimeException e)
      {
         ...
         throw new CoreException(new Status(IStatus.ERROR, JavaCore.PLUGIN_ID, 2,
   ...
   public void secondaryTypeAdding(String path, char[] typeName, char[] packageName)
   {
      ...
      if (resource != null)
      {
         if (com.codenvy.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(path) && resource.getType() == IResource.FILE)
         {
    ...
    */
   public Map secondaryTypes(IJavaProject project, boolean waitForIndexes,
      IProgressMonitor monitor) throws JavaModelException
   {
      ...
      Map indexingSecondaryCache = projectInfo.secondaryTypes == null ? null : (Map)projectInfo.secondaryTypes.get(
      ...
      final PerProjectInfo projectInfo) throws JavaModelException
   {
      ...
      while (packages.hasNext())
      {
         ...
         while (names.hasNext())
         {
            ...
            if (com.codenvy.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(path))
            {
   ...
   private void secondaryTypesRemoving(Hashtable secondaryTypesMap, IFile file)
   {
      ...
      while (packages.hasNext())
      {
         ...
         String packName = (String)entry.getKey();
         if (packName != INDEXED_SECONDARY_TYPES)

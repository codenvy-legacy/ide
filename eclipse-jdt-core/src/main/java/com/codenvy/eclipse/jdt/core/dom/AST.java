...
public final class AST {
     ...
     * @deprecated Use org.eclipse.jdt.core.dom.AST.convertCompilationUnit(int, CompilationUnitDeclaration, Map, boolean, CompilationUnit,
     *             int, IProgressMonitor) instead
     */
    public static CompilationUnit convertCompilationUnit(int level,
                                                         com.codenvy.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration
                                                                 compilationUnitDeclaration,
                                                         char[] source,
                                                         Map options, boolean isResolved,
                                                         com.codenvy.eclipse.jdt.internal.core.CompilationUnit workingCopy,
                                                         int reconcileFlags,
        ...
        switch (level) {
            ...
            case JLS3_INTERNAL:
                ...
                this.scanner = new Scanner(true /*comment*/, true /*whitespace*/, false /*nls*/, ClassFileConstants.JDK1_3 /*sourceLevel*/,
                                           ClassFileConstants.JDK1_5 /*complianceLevel*/, null/*taskTag*/, null/*taskPriorities*/,
            ...
            case JLS4:
                ...
                this.scanner = new Scanner(true /*comment*/, true /*whitespace*/, false /*nls*/, ClassFileConstants.JDK1_7 /*sourceLevel*/,
                                           ClassFileConstants.JDK1_7 /*complianceLevel*/, null/*taskTag*/, null/*taskPriorities*/,
                                           true/*taskCaseSensitive*/);
                break;
            default:
     ...
     *
     * @param elementType
     *         the element type (can be an array type)
     * @param dimensions
     ...
     *         if <code>recordModifications</code>

 ...
 * (see {@link com.codenvy.eclipse.jdt.core.dom.ASTNode ASTNode} and its subclasses)
 ...
 * </pre>
 * See also {@link com.codenvy.eclipse.jdt.core.dom.rewrite.ASTRewrite} for
...
public final class AST
{
   ...
   public static CompilationUnit convertCompilationUnit(int level,
      com.codenvy.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration compilationUnitDeclaration, char[] source,
      Map options, boolean isResolved, com.codenvy.eclipse.jdt.internal.core.CompilationUnit workingCopy, int reconcileFlags,
    ...
    */
   public static CompilationUnit convertCompilationUnit(int level,
      com.codenvy.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration compilationUnitDeclaration, Map options,
      boolean isResolved, com.codenvy.eclipse.jdt.internal.core.CompilationUnit workingCopy, int reconcileFlags,
      IProgressMonitor monitor)
   {
    ...
    * @return the compilation unit node
    * @throws IllegalArgumentException if the given Java element does not
   ...
   private AST(int level)
   {
      switch (level)
      {
         ...
         case JLS3_INTERNAL:
            ...
            this.scanner = new Scanner(true /*comment*/, true /*whitespace*/, false /*nls*/, ClassFileConstants.JDK1_3 /*sourceLevel*/,
               ClassFileConstants.JDK1_5 /*complianceLevel*/, null/*taskTag*/, null/*taskPriorities*/, true/*taskCaseSensitive*/);
            break;
         case JLS4:
            this.apiLevel = level;
            // initialize a scanner
            this.scanner = new Scanner(true /*comment*/, true /*whitespace*/, false /*nls*/, ClassFileConstants.JDK1_7 /*sourceLevel*/,
               ClassFileConstants.JDK1_7 /*complianceLevel*/, null/*taskTag*/, null/*taskPriorities*/, true/*taskCaseSensitive*/);
            break;
         default:
   ...
   public AST(Map options)
   {
      ...
      this.scanner = new Scanner(true /*comment*/, true /*whitespace*/, false /*nls*/, sourceLevel /*sourceLevel*/,
    ...
    * @throws IllegalArgumentException if <code>nodeClass</code> is
    ...
    * @return a new unparented node owned by this AST
    * @throws IllegalArgumentException if <code>nodeType</code> is
    ...
    * @throws IllegalArgumentException      if the primitive type code is invalid
    * @throws UnsupportedOperationException if this operation is used in
    *                                       a JLS2 AST
    * @since 3.1
    */
    ...
    * source code string.
    *
    * @throws IllegalArgumentException if this compilation unit is
    ...
    * @throws IllegalArgumentException if the document passed is
    *                                  <code>null</code> or does not correspond to this AST
    * @throws IllegalStateException    if <code>recordModifications</code>

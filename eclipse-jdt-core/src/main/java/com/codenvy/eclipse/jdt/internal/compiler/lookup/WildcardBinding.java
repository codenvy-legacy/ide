...
public class WildcardBinding extends ReferenceBinding {
                            ...
                            case Binding.WILDCARD_TYPE:
                                ...
                                switch (actualWildcard.boundKind) {
                                    ...
                                    case Wildcard.SUPER: // A={? super V} << F={? super U} ---> 0
                                        ...
                                        for (int i = 0, length = actualWildcard.otherBounds == null ? 0 : actualWildcard.otherBounds.length;
                                             i < length; i++) {
                        ...
                        switch (actualType.kind()) {
                            ...
                            case Binding.INTERSECTION_TYPE: // A={? extends V1&...&Vn} == F={? extends U} ---> V1 == U, ..., Vn == U
                                ...
                                this.bound.collectSubstitutes(scope, actuaIntersection.bound, inferenceContext,
                                                              TypeConstants.CONSTRAINT_EQUAL);
                                for (int i = 0, length = actuaIntersection.otherBounds == null ? 0 : actuaIntersection.otherBounds.length;
                                     i < length; i++) {
                    ...
                    case Wildcard.EXTENDS: // F={? extends U}
                        switch (actualType.kind()) {
                            ...
                            case Binding.INTERSECTION_TYPE: // A={? extends V1&...&Vn} >> F={? extends U} ---> V1 >> U, ..., Vn >> U
                                ...
                                this.bound.collectSubstitutes(scope, actualIntersection.bound, inferenceContext,
                                                              TypeConstants.CONSTRAINT_SUPER);
                                for (int i = 0, length = actualIntersection.otherBounds == null ? 0 : actualIntersection.otherBounds.length;
                                     i < length; i++) {
                                    this.bound.collectSubstitutes(scope, actualIntersection.otherBounds[i], inferenceContext,
                                                                  TypeConstants.CONSTRAINT_SUPER);
                                }
        ...
        if (this.genericSignature == null) {
            switch (this.boundKind) {
                case Wildcard.UNBOUND:
                    ...
                    break;
                case Wildcard.EXTENDS:
                    this.genericSignature = CharOperation.concat(TypeConstants.WILDCARD_PLUS,
                                                                 this.bound.genericTypeSignature());
                    break;
                default: // SUPER
                    this.genericSignature = CharOperation.concat(TypeConstants.WILDCARD_MINUS,
                                                                 this.bound.genericTypeSignature());
            }
        }
    ...
    /** @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#isSuperclassOf(com.codenvy.eclipse.jdt.internal.compiler
     * .lookup.ReferenceBinding) */
    ...
    public ReferenceBinding superclass() {
        if (this.superclass == null) {
            ...
            this.superclass = superType instanceof ReferenceBinding && !superType.isInterface() ? (ReferenceBinding)superType
                                                                                                : this.environment.getResolvedType(

...
public class WildcardBinding extends ReferenceBinding
{
   ...
   /**
    * @see com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#isSuperclassOf(com.codenvy.eclipse.jdt.internal.compiler.lookup.ReferenceBinding)
    */
   ...
   public ReferenceBinding superclass()
   {
      if (this.superclass == null)
      {
         ...
         this.superclass = superType instanceof ReferenceBinding && !superType.isInterface() ? (ReferenceBinding)superType : this.environment.getResolvedType(

...
import com.codenvy.eclipse.jdt.internal.core.search.matching.MatchLocator.WrappedCoreException;
        ...
        if (this.nodesCount == 1) {
            ...
            if (this.localElements[idx] == null) {
                ...
                if (oPtr == 0) {
                    ...
                    if (oPtr == length) {
                        System.arraycopy(this.allOtherElements[idx], 0, this.allOtherElements[idx] = new IJavaElement[length + 10], 0,
                                         length);
                    }
                }
                if (this.annotation == null) {
    ...
    public boolean visit(TypeDeclaration typeDeclaration, BlockScope unused) {
        try {
            ...
            if ((typeDeclaration.bits & ASTNode.IsAnonymousType) != 0) {
                ...
                this.locator.reportMatching(typeDeclaration, this.enclosingElement, level != null ? level.intValue() : -1, this.nodeSet,
                                            occurrenceCount);
            }

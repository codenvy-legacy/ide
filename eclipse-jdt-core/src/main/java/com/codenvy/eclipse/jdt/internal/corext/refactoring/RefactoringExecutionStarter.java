...
public final class RefactoringExecutionStarter {
    ...
    private static RenameSupport createRenameSupport(IJavaElement element, String newName,
    ...
    //	public static void startChangeSignatureRefactoring(final IMethod method, final SelectionDispatchAction action,
    // final Shell shell) throws JavaModelException
    //   {
    ...
    //				if (entry.getCode() == RefactoringStatusCodes.OVERRIDES_ANOTHER_METHOD || entry.getCode() == RefactoringStatusCodes
    ...
    //							} else {
    //								MessageDialog.openInformation(shell, ActionMessages.ModifyParameterAction_problem_title,
    // ActionMessages.ModifyParameterAction_problem_message);
    //							}
    ...
    //		new RefactoringStarter().activate(new ChangeTypeWizard(refactoring), shell, RefactoringMessages.ChangeTypeAction_dialog_title,
    // RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    //	public static void startCleanupRefactoring(ICompilationUnit[] cus, ICleanUp[] cleanUps, boolean useOptionsFromProfile, Shell shell,
    // boolean showWizard, String actionName) throws InvocationTargetException {
    ...
    //	}
    //
    //	public static void startConvertAnonymousRefactoring(final ICompilationUnit unit, final int offset, final int length,
    // final Shell shell) {
    //		final ConvertAnonymousToNestedRefactoring refactoring= new ConvertAnonymousToNestedRefactoring(unit, offset, length);
    //		new RefactoringStarter().activate(new ConvertAnonymousToNestedWizard(refactoring), shell,
    // RefactoringMessages.ConvertAnonymousToNestedAction_dialog_title,
    //				RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    ...
    //	}
    //
    //	public static void startCutRefactoring(final Object[] elements, final Shell shell) throws InterruptedException,
    ...
    //		ExtractInterfaceProcessor processor= new ExtractInterfaceProcessor(type, JavaPreferencesSettings.getCodeGenerationSettings(type
    // .getJavaProject()));
    //		Refactoring refactoring= new ProcessorBasedRefactoring(processor);
    //		new RefactoringStarter().activate(new ExtractInterfaceWizard(processor, refactoring), shell,
    ...
    //		ExtractSupertypeProcessor processor= new ExtractSupertypeProcessor(members, JavaPreferencesSettings.getCodeGenerationSettings
    // (project));
    //		Refactoring refactoring= new ProcessorBasedRefactoring(processor);
    ...
    //					.activate(new InferTypeArgumentsWizard(refactoring), shell, RefactoringMessages.InferTypeArgumentsAction_dialog_title,
    // RefactoringSaveHelper.SAVE_REFACTORING);
    //		} catch (CoreException e) {
    //			ExceptionHandler.handle(e, RefactoringMessages.InferTypeArgumentsAction_dialog_title,
    // RefactoringMessages.OpenRefactoringWizardAction_exception);
    //		}
    //	}
    //
    //	public static boolean startInlineConstantRefactoring(final ICompilationUnit unit, final CompilationUnit node, final int offset,
    // final int length, final Shell shell) {
    ...
    //			new RefactoringStarter().activate(new InlineConstantWizard(refactoring), shell,
    // RefactoringMessages.InlineConstantAction_dialog_title, RefactoringSaveHelper.SAVE_REFACTORING);
    //			return true;
    //		}
    //		return false;
    //	}
    //
    //	public static boolean startInlineMethodRefactoring(final ITypeRoot typeRoot, final CompilationUnit node, final int offset,
    // final int length, final Shell shell) {
    //		final InlineMethodRefactoring refactoring= InlineMethodRefactoring.create(typeRoot, node, offset, length);
    //		if (refactoring != null) {
    //			new RefactoringStarter().activate(new InlineMethodWizard(refactoring), shell,
    // RefactoringMessages.InlineMethodAction_dialog_title, RefactoringSaveHelper.SAVE_REFACTORING);
    //			return true;
    //		}
    //		return false;
    //	}
    //
    //	public static boolean startInlineTempRefactoring(final ICompilationUnit unit, CompilationUnit node, final ITextSelection selection,
    // final Shell shell) {
    ...
    //			new RefactoringStarter().activate(new InlineTempWizard(refactoring), shell, RefactoringMessages.InlineTempAction_inline_temp,
    ...
    //	}
    //
    //	public static void startIntroduceFactoryRefactoring(final ICompilationUnit unit, final ITextSelection selection,
    // final Shell shell) {
    ...
    //		new RefactoringStarter().activate(new IntroduceFactoryWizard(refactoring, RefactoringMessages.IntroduceFactoryAction_use_factory),
    // shell,
    //				RefactoringMessages.IntroduceFactoryAction_dialog_title, RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    //	public static void startIntroduceIndirectionRefactoring(final IClassFile file, final int offset, final int length,
    // final Shell shell) {
    //		final IntroduceIndirectionRefactoring refactoring= new IntroduceIndirectionRefactoring(file, offset, length);
    //		new RefactoringStarter().activate(new IntroduceIndirectionWizard(refactoring,
    // RefactoringMessages.IntroduceIndirectionAction_dialog_title), shell,
    //				RefactoringMessages.IntroduceIndirectionAction_dialog_title, RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    //	public static void startIntroduceIndirectionRefactoring(final ICompilationUnit unit, final int offset, final int length,
    // final Shell shell) {
    ...
    //		new RefactoringStarter().activate(new IntroduceParameterWizard(refactoring), shell,
    // RefactoringMessages.IntroduceParameterAction_dialog_title, RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    ...
    //			return;
    //		final MoveInnerToTopRefactoring refactoring= new MoveInnerToTopRefactoring(type, JavaPreferencesSettings.getCodeGenerationSettings
    // (type.getJavaProject()));
    //		new RefactoringStarter().activate(new MoveInnerToTopWizard(refactoring), shell,
    // RefactoringMessages.OpenRefactoringWizardAction_refactoring, RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    //	public static void startMoveMethodRefactoring(final IMethod method, final Shell shell) {
    //		MoveInstanceMethodProcessor processor= new MoveInstanceMethodProcessor(method, JavaPreferencesSettings.getCodeGenerationSettings
    // (method.getJavaProject()));
    //		Refactoring refactoring= new MoveRefactoring(processor);
    //		MoveInstanceMethodWizard wizard= new MoveInstanceMethodWizard(processor, refactoring);
    //		new RefactoringStarter().activate(wizard, shell, RefactoringMessages.MoveInstanceMethodAction_dialog_title,
    // RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    //	public static void startMoveRefactoring(final IResource[] resources, final IJavaElement[] elements,
    // final Shell shell) throws JavaModelException
    //   {
    ...
    //		MoveStaticMembersProcessor processor= new MoveStaticMembersProcessor(elements, JavaPreferencesSettings.getCodeGenerationSettings
    // (project));
    //		Refactoring refactoring= new MoveRefactoring(processor);
    ...
    //		if (members != null && members.length > 0)
    //			project= members[0].getJavaProject();
    //		PullUpRefactoringProcessor processor= new PullUpRefactoringProcessor(members, JavaPreferencesSettings.getCodeGenerationSettings
    // (project));
    //		Refactoring refactoring= new ProcessorBasedRefactoring(processor);
    //		new RefactoringStarter().activate(new PullUpWizard(processor, refactoring), shell,
    // RefactoringMessages.OpenRefactoringWizardAction_refactoring, RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    ...
    //	}
    //
    //	public static void startReplaceInvocationsRefactoring(final ITypeRoot typeRoot, final int offset, final int length,
    // final Shell shell) {
    //		final ReplaceInvocationsRefactoring refactoring= new ReplaceInvocationsRefactoring(typeRoot, offset, length);
    //		new RefactoringStarter().activate(new ReplaceInvocationsWizard(refactoring), shell,
    // RefactoringMessages.ReplaceInvocationsAction_dialog_title, RefactoringSaveHelper.SAVE_REFACTORING);
    //	}
    //
    ...
    //			new RefactoringStarter().activate(new SelfEncapsulateFieldWizard(refactoring), shell, "",
    // RefactoringSaveHelper.SAVE_REFACTORING); //$NON-NLS-1$
    //		} catch (JavaModelException e) {
    //			ExceptionHandler.handle(e, ActionMessages.SelfEncapsulateFieldAction_dialog_title,
    // ActionMessages.SelfEncapsulateFieldAction_dialog_cannot_perform);
    //		}
    //	}
    //

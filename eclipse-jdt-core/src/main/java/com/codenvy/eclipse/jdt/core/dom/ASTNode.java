...
import com.codenvy.eclipse.jdt.internal.core.dom.NaiveASTFlattener;
...
public abstract class ASTNode {   /*
    ...
    class NodeList extends AbstractList {
        ...
        class Cursor implements Iterator {
             ...
             *
             * @param index
             *         the position at which the element was added
             *         or removed
             * @param delta
     ...
     *         <code>false</code> for a set operation
     * @param child
     *         the new child value, or <code>null</code> if none;
     ...
     * @throws RuntimeException
     *         if the given node does not have the
     *         given property
     * @since 3.0
     */
     ...
     * @param propertyList
     *         list beginning with the AST node class
     ...
     * @param cycleCheck
     *         <code>true</code> if cycles are possible and need
     ...
     * @param newChild
     *         the new child of this node, or <code>null</code> if
     *         there is no replacement child
     * @param property
     *         the property descriptor of this node describing
     ...
     *         the visitor object
     * @param child
     *         the child AST node to dispatch too, or <code>null</code>
     *         if none
     */

...
{   /*
    ...
    * @throws RuntimeException if this node does not have the given property
    * @since 3.0
    */
    ...
    * @throws RuntimeException if this node does not have the
    ...
    * @throws RuntimeException if the given node does not have the
    *                          given property
    * @since 3.0
    */
    ...
    *
    * @throws RuntimeException is not modifiable
    */

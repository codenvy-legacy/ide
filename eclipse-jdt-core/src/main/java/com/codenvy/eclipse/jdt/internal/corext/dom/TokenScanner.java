...
public class TokenScanner
{
    ...
    * @throws CoreException Thrown when the end of the file has been reached (code END_OF_FILE)
    ...
    * @throws CoreException Thrown when a lexical error was detected while scanning (code LEXICAL_ERROR)
    */
   ...
   {
      return new Status(IStatus.ERROR, "ide", code, message, e);
   }

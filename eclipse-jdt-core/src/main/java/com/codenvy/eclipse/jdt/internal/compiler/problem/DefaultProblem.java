...
public class DefaultProblem extends CategorizedProblem
{
   ...
   /**
    * @see com.codenvy.eclipse.jdt.core.compiler.CategorizedProblem#getCategoryID()
    */
    ...
    *
    * @return int
    * @see com.codenvy.eclipse.jdt.core.compiler.IProblem#getID()
    */
   public int getID()
   {
      return this.id;
    ...
    *
    * @see com.codenvy.eclipse.jdt.core.compiler.CategorizedProblem#getMarkerType()
    */

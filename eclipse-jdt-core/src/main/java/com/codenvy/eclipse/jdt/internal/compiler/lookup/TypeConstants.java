...
public interface TypeConstants
{
   ...
   char[][] JAVAX_RMI_CORBA_STUB = new char[][]{JAVAX, "rmi".toCharArray(), //$NON-NLS-1$
   ...
   char[][] JAVA_LANG_INVOKE_METHODHANDLE_$_POLYMORPHICSIGNATURE = { // Signature while parsing source file
      JAVA, LANG, INVOKE, "MethodHandle$PolymorphicSignature".toCharArray() //$NON-NLS-1$
   };
   ...
   char[][] JAVA_IO_WRAPPER_CLOSEABLES = new char[][]{"BufferedInputStream".toCharArray(), //$NON-NLS-1$
   ...
   char[][] JAVA_UTIL_ZIP_WRAPPER_CLOSEABLES = new char[][]{"GZIPInputStream".toCharArray(), //$NON-NLS-1$
   ...
   char[][][] OTHER_WRAPPER_CLOSEABLES = new char[][][]{{JAVA, "security".toCharArray(), "DigestInputStream".toCharArray()}, //$NON-NLS-1$ //$NON-NLS-2$
   ...
   char[][] JAVA_IO_RESOURCE_FREE_CLOSEABLES = new char[][]{"StringReader".toCharArray(), //$NON-NLS-1$

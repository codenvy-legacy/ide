...
import com.codenvy.eclipse.jdt.internal.core.builder.ClasspathJar;
import com.codenvy.eclipse.jdt.internal.core.builder.ClasspathLocation;
...
public class JavaSearchNameEnvironment implements INameEnvironment, SuffixConstants {
    ...
    public JavaSearchNameEnvironment(IJavaProject javaProject, com.codenvy.eclipse.jdt.core.ICompilationUnit[] copies) {
            ...
            try {
                if (root.isArchive()) {
                    ...
                    if (target == null) {
                        ...
                        cpLocations[index++] = new ClasspathSourceDirectory((IContainer)target, root.fullExclusionPatternChars(),

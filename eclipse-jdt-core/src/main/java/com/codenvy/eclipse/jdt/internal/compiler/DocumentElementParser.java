...
public class DocumentElementParser extends Parser {
    ...
    /* int[] stack for storing javadoc positions */ int[][] intArrayStack;
	...
	*/
    ...
    protected void consumeClassBodyDeclaration() {
        ...
        this.requestor.acceptInitializer(initializer.declarationSourceStart, initializer.declarationSourceEnd,
                                         this.intArrayStack[this.intArrayPtr--], 0, this.modifiersSourceStart,
    ...
    protected void consumeConstructorHeader() {
        ...
        this.requestor.enterConstructor(cd.declarationSourceStart, this.intArrayStack[this.intArrayPtr--], cd.modifiers,
                                        cd.modifiersSourceStart, cd.selector, cd.sourceStart,
                                        (int)(this.selectorSourcePositions & 0xFFFFFFFFL),
                                        // retrieve the source end of the name
                                        argumentTypes, argumentTypeStarts, argumentTypeEnds, argumentNames, argumentNameStarts,
                                        argumentNameEnds,
                                        this.rParenPos,
                                        // right parenthesis
	...
	*/
    ...
    protected void consumeInterfaceHeader() {
        ...
        this.requestor.enterInterface(typeDecl.declarationSourceStart, this.intArrayStack[this.intArrayPtr--],
                                      ...
                                      typeDecl.sourceEnd, interfaceNames, interfaceNameStarts, interfacenameEnds,
                                      this.scanner.currentPosition - 1);
    }
    ...
    protected void consumeMethodHeader() {
        ...
        this.requestor.enterMethod(md.declarationSourceStart, this.intArrayStack[this.intArrayPtr--], md.modifiers,
                                   ...
                                   argumentTypeStarts, argumentTypeEnds, argumentNames, argumentNameStarts, argumentNameEnds,
                                   this.rParenPos,
 ...
 */
	 ...
	 */
        ...
        if ((length = this.identifierLengthStack[localIdentifierLengthPtr]) == 1) {
            ...
            if (dim == 0) {
                ref = new SingleTypeReference(this.identifierStack[localIdentifierPtr],
                                              this.identifierPositionStack[localIdentifierPtr--]);
            } else {
                ref = new ArrayTypeReference(this.identifierStack[localIdentifierPtr], dim,
                                             this.identifierPositionStack[localIdentifierPtr--]);

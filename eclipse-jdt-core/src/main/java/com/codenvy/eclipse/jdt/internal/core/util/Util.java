...
public class Util
{
      ...
      BindingsToNodesMap bindingsToNodes)
   {
      ...
      else if (referenceBinding.isTypeVariable())
      {
         ...
         com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding declaringElement = ((com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding)referenceBinding).declaringElement;

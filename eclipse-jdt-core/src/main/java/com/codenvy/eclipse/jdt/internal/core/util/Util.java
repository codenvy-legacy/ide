...
import com.codenvy.eclipse.jdt.internal.compiler.env.ClassSignature;
import com.codenvy.eclipse.jdt.internal.compiler.env.EnumConstantSignature;
import com.codenvy.eclipse.jdt.internal.compiler.env.IBinaryAnnotation;
import com.codenvy.eclipse.jdt.internal.compiler.env.IDependent;
...
import com.codenvy.eclipse.jdt.internal.core.Member;
import com.codenvy.eclipse.jdt.internal.core.MemberValuePair;
...
public class Util {
    ...
    * Returns the default java extension (".java").
    ...
    public final static boolean endsWithIgnoreCase(String str, String end) {
        ...
        for (int i = 1; i <= endLength; i++) {
            if (ScannerHelper.toLowerCase(end.charAt(endLength - i)) != ScannerHelper.toLowerCase(
                    str.charAt(strLength - i))) {
                return false;
            }
        }
    ...
    * Returns whether the given file name equals to the given string ignoring the java like extension
    ...
    private static IFile findFirstClassFile(IFolder folder) {
        try {
            ...
            for (int i = 0, max = members.length; i < max; i++) {
                ...
                } else if (com.codenvy.eclipse.jdt.internal.compiler.util.Util.isClassFileName(member.getName())) {
                    return (IFile)member;
                }
            }
    ...
    private static IClassFile getClassFile(char[] fileName) {
        ...
        if (jarSeparator != -1 &&
            pkgEnd < jarSeparator) // if in a jar and no slash, it is a default package -> pkgEnd should be equal to jarSeparator
        {
            pkgEnd = jarSeparator;
        }
        if (pkgEnd == -1) {
                ...
                try {
                    ...
                    if (path != null) {
                        ...
                        for (Enumeration e = jar.entries(); e.hasMoreElements(); ) {
                            ...
                            if (com.codenvy.eclipse.jdt.internal.compiler.util.Util.isClassFileName(entryName)) {
    ...
    public static String getLineSeparator(String text, IJavaProject project) {
        ...
        return com.codenvy.eclipse.jdt.internal.compiler.util.Util.LINE_SEPARATOR;
    }
    ...
    public static IPackageFragment getPackageFragment(char[] fileName, int pkgEnd, int jarSeparator) {
        if (jarSeparator != -1) {
            ...
            IContainer folder = path.segmentCount() == 1 ? workspaceRoot.getProject(
                    path.lastSegment()) : (IContainer)workspaceRoot.getFolder(path);
                ...
                case ARGUMENTS_DELIMITER:
                    ...
                    if (next == ARGUMENTS_DELIMITER) {
                        ...
                        if (EMPTY_ARGUMENT.equals(currentArgumentContents)) {
                            currentArgumentContents = com.codenvy.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING;
                        }
    ...
    public static byte[] getResourceContentsAsByteArray(IFile file) throws JavaModelException {
        ...
        try {
            return com.codenvy.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsByteArray(stream, -1);
        } catch (IOException e) {
    ...
    public static char[] getResourceContentsAsCharArray(IFile file, String encoding) throws JavaModelException {
        ...
        try {
            return com.codenvy.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsCharArray(stream, (int)length, encoding);
        } catch (IOException e) {
            throw new JavaModelException(e, IJavaModelStatusConstants.IO_EXCEPTION);
        } finally {
            try {
        ...
        if (property == null) {
            try {
                property = ResourcesPlugin.getWorkspace().getRoot().getPersistentProperty(
                        getSourceAttachmentPropertyName(path));
                if (property == null) {
    ...
    public static JavaElement getUnresolvedJavaElement(MethodBinding methodBinding, WorkingCopyOwner workingCopyOwner,
        ...
        com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode node = bindingsToNodes == null ? null : bindingsToNodes.get(
                methodBinding);
        if (node != null && !declaringType.isBinary()) {
            ...
            com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding original = methodBinding.original();
    ...
    public static JavaElement getUnresolvedJavaElement(TypeBinding typeBinding, WorkingCopyOwner workingCopyOwner,
        ...
        switch (typeBinding.kind()) {
            case Binding.ARRAY_TYPE:
                typeBinding = ((com.codenvy.eclipse.jdt.internal.compiler.lookup.ArrayBinding)typeBinding).leafComponentType();
        ...
        if (referenceBinding.isLocalType() || referenceBinding.isAnonymousType()) {
            ...
            if (com.codenvy.eclipse.jdt.internal.compiler.util.Util.isClassFileName(fileName)) {
                int jarSeparator = CharOperation.indexOf(IDependent.JAR_FILE_ENTRY_SEPARATOR, fileName);
                int pkgEnd = CharOperation.lastIndexOf('/', fileName); // pkgEnd is exclusive
                if (pkgEnd == -1) {
                    pkgEnd = CharOperation.lastIndexOf(File.separatorChar, fileName);
                ...
                ClassFile classFile = (ClassFile)pkg.getClassFile(
                        new String(classFileName) + SuffixConstants.SUFFIX_STRING_class);
            ...
            try {
                int sourceStart = ((com.codenvy.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding)referenceBinding).sourceStart;
            ...
            com.codenvy.eclipse.jdt.internal.compiler.lookup.Binding declaringElement =
                    ((com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding)referenceBinding).declaringElement;
    ...
    public static final boolean isExcluded(IJavaElement element) {
        ...
        switch (elementType) {
            ...
            case IJavaElement.PACKAGE_FRAGMENT:
                ...
                return resource != null && isExcluded(resource, root.fullInclusionPatternChars(),
    ...
    public final static boolean isExcluded(IPath resourcePath, char[][] inclusionPatterns, char[][] exclusionPatterns,
        ...
        return com.codenvy.eclipse.jdt.internal.compiler.util.Util.isExcluded(resourcePath.toString().toCharArray(),
    ...
    public static boolean isValidFolderNameForPackage(String folderName, String sourceLevel, String complianceLevel) {
        return JavaConventions.validateIdentifier(folderName, sourceLevel,
                                                  complianceLevel).getSeverity() != IStatus.ERROR;
    }
    ...
    public static ClassFileReader newClassFileReader(
            IResource resource) throws CoreException, ClassFormatException, IOException {
        InputStream in = null;
        try {
    ...
    public static int scanTypeSignature(char[] string, int start) {
        ...
        return com.codenvy.eclipse.jdt.internal.compiler.util.Util.scanTypeSignature(string, start);
    }
    ...
    public static boolean startsWithIgnoreCase(String[] compoundName, String[] prefix, boolean partialMatch) {
        ...
        return (partialMatch || prefixLength == nameLength) && compoundName[prefixLength - 1].toLowerCase().startsWith(
    ...
    static void appendTypeSignature(char[] string, int start, StringBuffer buffer, boolean compact) {
        ...
        switch (c) {
            ...
            case Signature.C_TYPE_VARIABLE:
                int e = com.codenvy.eclipse.jdt.internal.compiler.util.Util.scanTypeVariableSignature(string, start);
    ...
    public static String typeSignature(TypeReference type) {
        ...
        if ((type.bits & com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode.IsUnionType) != 0) {
    ...
    public static IAnnotation getAnnotation(JavaElement parent, IBinaryAnnotation binaryAnnotation,
        ...
        char[] typeName = com.codenvy.eclipse.jdt.core.Signature.toCharArray(
     ...
     * @param selector
     *         the method name
     * @param paramTypeSignatures
     *         the type signatures of the method arguments
     * @param isConstructor
     *         whether we're looking for a constructor

...
public class DefaultStackMapFrame extends ClassFileStruct implements IStackMapFrame {
     ...
     */
    public DefaultStackMapFrame(byte[] classFileBytes, IConstantPool constantPool,
        ...
        if (tempLocals != 0) {
            ...
            for (int i = 0; i < tempLocals; i++) {
                VerificationInfo verificationInfo = new VerificationInfo(classFileBytes, constantPool,

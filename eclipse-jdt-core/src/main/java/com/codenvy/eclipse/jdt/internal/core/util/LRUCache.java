...
public class LRUCache implements Cloneable
{
   ...
   protected String toStringContents()
   {
      ...
      for (int i = 0; i < length; i++)
      {
         ...
         unsortedKeys[i] = key;
         unsortedToStrings[i] = (key instanceof com.codenvy.eclipse.jdt.internal.core.JavaElement) ? ((com.codenvy.eclipse.jdt.internal.core.JavaElement)key).getElementName() : key.toString();
      }

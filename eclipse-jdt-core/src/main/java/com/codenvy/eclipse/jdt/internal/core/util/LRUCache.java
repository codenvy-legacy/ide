 ...
 *
 * @see com.codenvy.eclipse.jdt.internal.core.util.ILRUCacheable
 */
public class LRUCache implements Cloneable {
    ...
    protected void privateAddEntry(LRUCacheEntry entry, boolean shuffle) {
        ...
        if (this.entryQueue == null) {         /* this is the first and last entry */
    ...
    protected String toStringContents() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            unsortedKeys[i] = key;
            unsortedToStrings[i] = (key instanceof com.codenvy.eclipse.jdt.internal.core.JavaElement)
                                   ? ((com.codenvy.eclipse.jdt.internal.core.JavaElement)key).getElementName() : key.toString();
        }

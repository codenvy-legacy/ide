...
public class DefaultCodeFormatter extends CodeFormatter {
    ...
    private static final int K_MASK =
            K_UNKNOWN | K_EXPRESSION | K_STATEMENTS | K_CLASS_BODY_DECLARATIONS | K_COMPILATION_UNIT | K_SINGLE_LINE_COMMENT |
    ...
    private TextEdit probeFormatting(String source, int indentationLevel, String lineSeparator, IRegion[] regions,
        ...
        if (PROBING_SCANNER == null) {
            ...
            PROBING_SCANNER = new Scanner(true, false/*do not tokenize whitespaces*/, false/*nls*/,
                                          ClassFileConstants.JDK1_6, ClassFileConstants.JDK1_6, null/*taskTags*/, null/*taskPriorities*/,

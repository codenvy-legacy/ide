...
public class WhileStatement extends Statement
{
   ...
   public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo)
   {
      ...
      condInfo = this.condition.analyseCode(currentScope,
         (condLoopContext = new LoopingFlowContext(flowContext, flowInfo, this, null, null, currentScope)), condInfo);
      ...
      else
      {
         ...
         else
         {
            ...
            exitBranch.
               addPotentialInitializationsFrom(actionInfo.unconditionalInits()).

...
public class ClassInstanceCreation extends Expression {
    ...
    public static final ChildPropertyDescriptor ANONYMOUS_CLASS_DECLARATION_PROPERTY = new ChildPropertyDescriptor(
            ClassInstanceCreation.class, "anonymousClassDeclaration", AnonymousClassDeclaration.class, OPTIONAL,
     ...
     *
     * @param expression
     *         the expression node, or <code>null</code> if
     *         there is none
     ...
     *
     * @param decl
     *         the anonymous class declaration, or <code>null</code>
     *         if none
     */
    ...
    int treeSize() {
        ...
        return memSize() + (this.typeName == null ? 0 : getName().treeSize()) + (this.type == null ? 0 : getType().treeSize()) +
               (this.optionalExpression == null ? 0 : getExpression().treeSize()) +
               (this.typeArguments == null ? 0 : this.typeArguments.listSize()) + (this.arguments == null ? 0 : this.arguments.listSize()) +

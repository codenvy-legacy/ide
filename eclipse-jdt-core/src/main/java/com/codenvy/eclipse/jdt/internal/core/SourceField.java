...
public class SourceField extends NamedMember implements IField {
    ...
    public ASTNode findNode(com.codenvy.eclipse.jdt.core.dom.CompilationUnit ast) {
    ...
    public JavaElement resolved(Binding binding) {
        SourceRefElement resolvedHandle = new ResolvedSourceField(this.parent, this.name,

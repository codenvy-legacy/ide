...
public class CodeSnippetMessageSend extends MessageSend {
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        if (this.actualReceiverType.isArrayType() && this.binding.parameters == Binding.NO_PARAMETERS &&
            scope.compilerOptions().complianceLevel >= ClassFileConstants.JDK1_5 && CharOperation.equals(

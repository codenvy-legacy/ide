...
import com.codenvy.eclipse.jdt.core.BufferChangedEvent;
import com.codenvy.eclipse.jdt.core.CompletionRequestor;
import com.codenvy.eclipse.jdt.core.IBuffer;
import com.codenvy.eclipse.jdt.core.IBufferChangedListener;
...
public abstract class Openable extends JavaElement implements IOpenable, IBufferChangedListener
{
   ...
   protected void codeComplete(com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit cu,
      com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit unitToSkip, int position, CompletionRequestor requestor,
...
//      }
   ...
   protected IJavaElement[] codeSelect(com.codenvy.eclipse.jdt.internal.compiler.env.ICompilationUnit cu, int offset,
...
//      }
   ...
   public void save(IProgressMonitor pm, boolean force) throws JavaModelException
   {
      ...
      IBuffer buf = getBuffer();
      if (buf != null)
      { // some Openables (like a JavaProject) don't have a buffer
         buf.save(pm, force);

...
public class NullInfoRegistry extends UnconditionalFlowInfo
{
   ...
   public NullInfoRegistry(UnconditionalFlowInfo upstream)
   {
      ...
      if ((upstream.tagBits & NULL_FLAG_MASK) != 0)
      {
         ...
         this.nullBit2 = (u1 = upstream.nullBit1) & (u2 = upstream.nullBit2) & (nu3 = ~(u3 = upstream.nullBit3)) & (nu4 = ~(u4 = upstream.nullBit4));
         ...
         if (upstream.extra != null)
         {
            ...
            {
               this.extra[2 + 1][i] = (u1 = upstream.extra[1 + 1][i]) & (u2 = upstream.extra[2 + 1][i]) & (nu3 = ~(u3 = upstream.extra[3 + 1][i])) & (nu4 = ~(u4 = upstream.extra[4 + 1][i]));

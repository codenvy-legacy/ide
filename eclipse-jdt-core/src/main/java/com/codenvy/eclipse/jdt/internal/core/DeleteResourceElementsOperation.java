    ...
    private void deletePackageFragment(IPackageFragment frag) throws JavaModelException {
        ...
        if (res != null) {
            ...
            for (int i = 0, length = remainingFiles.length; i < length; i++) {
                ...
                if (file instanceof IFile && com.codenvy.eclipse.jdt.internal.compiler.util.Util.isClassFileName(file.getName())) {
            ...
            if (isEmpty &&
                !frag.isDefaultPackage()/*don't delete default package's folder: see https://bugs.eclipse.org/bugs/show_bug
                .cgi?id=38450*/) {

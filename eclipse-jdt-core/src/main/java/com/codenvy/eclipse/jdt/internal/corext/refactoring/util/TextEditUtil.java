...
public class TextEditUtil {
     ...
     * @param edit
     *         the edit to insert into parent
     * @throws org.exoplatform.ide.editor.shared.text.edits.MalformedTreeException
     *         is edit can't be inserted int parent
     */
     ...
     *
     * @param edit1
     *         the edit to compare against edit2
     * @param edit2
     *         the edit to compare against edit1
     ...
     * <p>If <code>edit1</code> overlaps <code>edit2</code> this method fails with a {@link org.exoplatform.ide.editor.shared.text.edits
     * .MalformedTreeException}</p>
     ...
     * @throws org.exoplatform.ide.editor.shared.text.edits.MalformedTreeException
     *         if {@link #overlaps(TextEdit, TextEdit)} returns <b>true</b>

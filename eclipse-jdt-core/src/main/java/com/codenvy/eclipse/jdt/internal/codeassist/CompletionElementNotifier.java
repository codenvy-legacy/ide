...
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnKeyword2;
...
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnMethodTypeParameter;
import com.codenvy.eclipse.jdt.internal.codeassist.complete.CompletionOnPackageReference;
import com.codenvy.eclipse.jdt.internal.compiler.SourceElementNotifier;
...
public class CompletionElementNotifier extends SourceElementNotifier {
    ...
    protected void notifySourceElementRequestor(AbstractMethodDeclaration methodDeclaration, TypeDeclaration declaringType,
    ...
    public void notifySourceElementRequestor(CompilationUnitDeclaration parsedUnit, int sourceStart, int sourceEnd, boolean reportReference,
                                             HashtableOfObjectToInt sourceEndsMap, Map nodesToCategoriesMap) {

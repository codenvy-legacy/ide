...
public abstract class AbstractMethodDeclaration extends ASTNode implements ProblemSeverities, ReferenceContext
{
      ...
      if (this.arguments != null && this.binding != null)
      {
         for (int i = 0, length = this.arguments.length; i < length; i++)
         {
            ...
            if ((argument.binding.tagBits & (TagBits.AnnotationNonNull | TagBits.AnnotationNullable)) != 0)
            {
               ...
               this.binding.parameterNonNullness[i] = Boolean.valueOf(
                  (argument.binding.tagBits & TagBits.AnnotationNonNull) != 0);
            }
         }
      }
   }
   ...
   public void resolve(ClassScope upperScope)
   {
      ...
      try
      {
         ...
         if (this.binding != null && (this.binding.getAnnotationTagBits() & TagBits.AnnotationDeprecated) == 0 && (this.binding.modifiers & ClassFileConstants.AccDeprecated) != 0 && this.scope.compilerOptions().sourceLevel >= ClassFileConstants.JDK1_5)
         {
   ...
   public void resolveStatements()
   {
      ...
      {
         if (!this.isConstructor() || this.arguments != null)
      ...
      if (this.binding != null && this.binding.parameterNonNullness != null)
      {
         ...
         for (int i = 0; i < length; i++)
         {
            if (this.binding.parameterNonNullness[i] != null)
            {
               ...
               this.scope.validateNullAnnotation(nullAnnotationTagBit, this.arguments[i].type,

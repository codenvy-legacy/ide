...
public class RefactoringHandleTransplanter {
     ...
     * @param newType
     *         renamed type
     * @param refactoredSimilarElements
     *         map from similar element (IJavaElement) to new name (String), or <code>null</code>
     */
    public RefactoringHandleTransplanter(IType oldType, IType newType,
                                         Map<IJavaElement, String> refactoredSimilarElements) {
        fOldType = oldType;
        fNewType = newType;

...
class BindingResolver
{
    ...
    */
   com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode)
   {
      return null;
   }
    ...
    */
   IMethodBinding getMethodBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding)
   {
      return null;
   }
    ...
    */
   IPackageBinding getPackageBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding)
   {
      return null;
   }
    ...
    */
   ITypeBinding getTypeBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.TypeBinding referenceBinding)
   {
      return null;
   }
    ...
    */
   IVariableBinding getVariableBinding(com.codenvy.eclipse.jdt.internal.compiler.lookup.VariableBinding binding)
   {
      return null;
   }
    ...
    */
   IAnnotationBinding getAnnotationInstance(com.codenvy.eclipse.jdt.internal.compiler.lookup.AnnotationBinding instance)
   {
      return null;
   }
    ...
    */
   void store(ASTNode newNode, com.codenvy.eclipse.jdt.internal.compiler.ast.ASTNode oldASTNode)
   {
      // default implementation: do nothing
   }

...
public class Buffer implements IBuffer {
    ...
    public void close() {
        ...
        synchronized (this) { // ensure that no other thread is adding/removing a listener at the same time (https://bugs.eclipse
        // .org/bugs/show_bug.cgi?id=126673)
    ...
    public void save(IProgressMonitor progress, boolean force) throws JavaModelException {
        ...
        try {
            ...
            if (encoding != null && encoding.equals(com.codenvy.eclipse.jdt.internal.compiler.util.Util.UTF_8)) {

 ...
 * </p>
 *
 * @see JavaCore#create(com.codenvy.eclipse.core.resources.IWorkspaceRoot)
 */
public interface IJavaModel extends IJavaElement, IOpenable, IParent
{
    ...
    * @throws JavaModelException if an element could not be copied. Reasons include:
    *                            <ul>
    ...
    *                            </ul>
    * @see com.codenvy.eclipse.jdt.core.IJavaModelStatusConstants#INVALID_DESTINATION
    */
   void copy(IJavaElement[] elements, IJavaElement[] containers, IJavaElement[] siblings, String[] renamings,
    ...
    * @param monitor  a progress monitor
    * @throws JavaModelException if an element could not be deleted. Reasons include:
    *                            <ul>
    *                            <li> There is no element to process (NO_ELEMENTS_TO_PROCESS). The given elements is null or empty</li>
    ...
    *         are none
    * @throws JavaModelException if this request fails.
    */
    ...
    *                   exception in the event of a name collision
    * @param monitor    a progress monitor
    * @throws JavaModelException       if an element could not be moved. Reasons include:
    *                                  <ul>
    *                                  <li> There is no element to process (NO_ELEMENTS_TO_PROCESS). The given elements is null or empty</li>
    *                                  <li> A specified element, container, or sibling does not exist (ELEMENT_DOES_NOT_EXIST)</li>
    *                                  <li> A <code>CoreException</code> occurred while updating an underlying resource</li>
    ...
    * @see com.codenvy.eclipse.jdt.core.IJavaModelStatusConstants#INVALID_DESTINATION
    */
   void move(IJavaElement[] elements, IJavaElement[] containers, IJavaElement[] siblings, String[] renamings,
      boolean replace, IProgressMonitor monitor) throws JavaModelException;
    ...
    *                     exception in the event of a name collision
    * @param monitor      a progress monitor
    * @throws JavaModelException if an element could not be renamed. Reasons include:
    *                            <ul>
    *                            <li> There is no element to process (NO_ELEMENTS_TO_PROCESS). The given elements is null or empty</li>
    *                            <li> A specified element does not exist (ELEMENT_DOES_NOT_EXIST)</li>

...
public class SuperTypeHierarchyCache {
    ...
    private static Map<IType, MethodOverrideTester> fgMethodOverrideTesterCache = new LRUMap<IType, MethodOverrideTester>(
            CACHE_SIZE);
     ...
     * requested type. Therefore, queries such as {@link com.codenvy.eclipse.jdt.core.ITypeHierarchy#getAllClasses()}
     * or {@link com.codenvy.eclipse.jdt.core.ITypeHierarchy#getRootInterfaces()} may return more types than the same

...
public class SetClasspathOperation extends ChangeClasspathOperation {
    ...
    public SetClasspathOperation(JavaProject project, IClasspathEntry[] newRawClasspath, IPath newOutputLocation,
    ...
    protected void executeOperation() throws JavaModelException {
        ...
        try {
            ...
            ClasspathChange classpathChange = perProjectInfo.setRawClasspath(this.newRawClasspath, this.referencedEntries,
                                                                             this.newOutputLocation,
                                                                             JavaModelStatus.VERIFIED_OK/*format is ok*/);
    ...
    protected ISchedulingRule getSchedulingRule() {
        if (this.canChangeResources) {
            ...
            return new MultiRule(new ISchedulingRule[]{
                    // use project modification rule as this is needed to create the .classpath file if it doesn't exist yet,
                    // or to update project references

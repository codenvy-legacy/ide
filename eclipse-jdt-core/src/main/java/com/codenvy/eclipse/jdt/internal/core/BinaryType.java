...
public class BinaryType extends BinaryMember implements IType, SuffixConstants
{
   ...
   public static final JavadocContents EMPTY_JAVADOC = new JavadocContents(null,
      ...
      WorkingCopyOwner owner) throws JavaModelException
   {
      ...
      codeComplete(snippet, insertion, position, localVariableTypeNames, localVariableNames, localVariableModifiers,
         isStatic, new com.codenvy.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
   }
   ...
   {
      codeComplete(snippet, insertion, position, localVariableTypeNames, localVariableNames, localVariableModifiers,
         isStatic, requestor, DefaultWorkingCopyOwner.PRIMARY, monitor);
   }
      ...
      WorkingCopyOwner owner, IProgressMonitor monitor) throws JavaModelException
   {
      ...
      if (source != null && insertion > -1 && insertion < source.length())
      {
         ...
         BasicCompilationUnit cu = new BasicCompilationUnit(fakeSource, null, getElementName(),
      ...
      {
         engine.complete(this, snippet, position, localVariableTypeNames, localVariableNames, localVariableModifiers,
            isStatic);
      }
    ...
    */
   public IField createField(String contents, IJavaElement sibling, boolean force,
      IProgressMonitor monitor) throws JavaModelException
   {
    ...
    */
   public IMethod createMethod(String contents, IJavaElement sibling, boolean force,
      IProgressMonitor monitor) throws JavaModelException
   {
      throw new JavaModelException(new JavaModelStatus(IJavaModelStatusConstants.READ_ONLY, this));
   }
    ...
    */
   public IType createType(String contents, IJavaElement sibling, boolean force,
      IProgressMonitor monitor) throws JavaModelException
   {
      throw new JavaModelException(new JavaModelStatus(IJavaModelStatusConstants.READ_ONLY, this));
   }
   ...
   public IType getDeclaringType()
   {
      ...
      if (classFile.isOpen())
      {
         try
         {
            ...
            if (classFile.getElementName().length() > enclosingTypeName.length + 1 && Character.isDigit(
               classFile.getElementName().charAt(enclosingTypeName.length + 1)))
            {
               return null;
            }
   ...
   public String getSuperclassTypeSignature() throws JavaModelException
   {
      ...
      if (genericSignature != null)
      {
         ...
         int start = index;
         index = com.codenvy.eclipse.jdt.internal.compiler.util.Util.scanClassTypeSignature(genericSignature, start) + 1;
   ...
   public String[] getSuperInterfaceTypeSignatures() throws JavaModelException
   {
      ...
      if (genericSignature != null)
      {
         ...
         // skip superclass
         index = com.codenvy.eclipse.jdt.internal.compiler.util.Util.scanClassTypeSignature(genericSignature, index) + 1;
   ...
   {
      IClassFile classFile = getPackageFragment().getClassFile(
         getTypeQualifiedName() + "$" + typeName + SUFFIX_STRING_class); //$NON-NLS-1$
    ...
    * @see IType
    */
   public ITypeHierarchy loadTypeHierachy(InputStream input, WorkingCopyOwner owner,
      IProgressMonitor monitor) throws JavaModelException
   {
      ...
      IProgressMonitor monitor) throws JavaModelException
   {
      ...
      CreateTypeHierarchyOperation op = new CreateTypeHierarchyOperation(this, workingCopies,
         SearchEngine.createWorkspaceScope(), false);
    ...
    */
   public ITypeHierarchy newTypeHierarchy(IJavaProject project, WorkingCopyOwner owner,
      IProgressMonitor monitor) throws JavaModelException
   {
      if (project == null)
      {
   ...
   {
      SourceRefElement resolvedHandle = new ResolvedBinaryType(this.parent, this.name,
   ...
   {
      PerProjectInfo projectInfo = JavaModelManager.getJavaModelManager().getPerProjectInfoCheckExistence(
      ...
      pathBuffer.append(pack.getElementName().replace('.', '/')).append('/').append(typeQualifiedName).append(
         JavadocConstants.HTML_EXTENSION);

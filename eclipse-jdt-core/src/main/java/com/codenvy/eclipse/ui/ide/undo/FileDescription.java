...
package com.codenvy.eclipse.ui.ide.undo;
...
import com.codenvy.eclipse.ltk.internal.core.refactoring.resource.undostates.IFileContentDescription;
...
public class FileDescription extends AbstractResourceDescription
{
    ...
    * @param linkLocation           the location of the file's link, or <code>null</code> if the
    *                               file is not linked
    * @param fileContentDescription the file content description that can be used to get

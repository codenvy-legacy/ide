...
public class ProjectResource extends ContainerResource implements IProject
{
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IProject#build(int, java.lang.String, java.util.Map, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IProject#build(com.codenvy.eclipse.core.resources.IBuildConfiguration, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IProject#create(com.codenvy.eclipse.core.resources.IProjectDescription, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IProject#create(com.codenvy.eclipse.core.resources.IProjectDescription, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IProject#loadSnapshot(int, java.net.URI, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IProject#saveSnapshot(int, java.net.URI, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IProject#setDescription(com.codenvy.eclipse.core.resources.IProjectDescription, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IProject#setDescription(com.codenvy.eclipse.core.resources.IProjectDescription, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override

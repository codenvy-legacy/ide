...
public abstract class ContainerResource extends ItemResource implements IContainer
{
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IContainer#findDeletedMembersWithHistory(int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IContainer#setDefaultCharset(java.lang.String, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IContainer#createFilter(int, com.codenvy.eclipse.core.resources.FileInfoMatcherDescription, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override

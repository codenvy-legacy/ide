...
public class FileResource extends ItemResource implements IFile
{
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IFile#appendContents(java.io.InputStream, boolean, boolean, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IFile#appendContents(java.io.InputStream, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IFile#create(java.io.InputStream, boolean, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IFile#createLink(com.codenvy.eclipse.core.runtime.IPath, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IFile#setContents(java.io.InputStream, boolean, boolean, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IFile#setContents(com.codenvy.eclipse.core.resources.IFileState, boolean, boolean, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override
   ...
   /**
    * @see com.codenvy.eclipse.core.resources.IFile#setContents(com.codenvy.eclipse.core.resources.IFileState, int, com.codenvy.eclipse.core.runtime.IProgressMonitor)
    */
   @Override

...
public class SelectWorkspaceCommand extends AbstractCommand
{

   public SelectWorkspaceCommand()
   {
      super("Window/Workspace...", "Select Workspace...", Images.BrowserPanel.ICON, true, true, new SelectWorkspaceEvent());
   }

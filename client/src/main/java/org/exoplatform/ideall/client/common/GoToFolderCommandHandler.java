...
import org.exoplatform.ideall.client.event.file.GoToFolderEvent;
import org.exoplatform.ideall.client.event.file.GoToFolderHandler;
...
public class GoToFolderCommandHandler implements GoToFolderHandler
{
   ...
   public GoToFolderCommandHandler(HandlerManager eventBus)
   {
      ...
      handlers.addHandler(GoToFolderEvent.TYPE, this);
   }

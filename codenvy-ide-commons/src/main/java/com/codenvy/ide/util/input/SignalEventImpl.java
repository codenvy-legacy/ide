...
import com.codenvy.ide.util.input.SignalKeyLogic.UserAgentType;
...
public class SignalEventImpl implements SignalEvent
{
   ...
   private static final UserAgentType currentUserAgent = (UserAgent.isWebkit() ? UserAgentType.WEBKIT : (UserAgent
      .isFirefox() ? UserAgentType.GECKO : UserAgentType.IE));

   private static final OperatingSystem currentOs = (UserAgent.isWin() ? OperatingSystem.WINDOWS : (UserAgent.isMac()

...
/**
 * Command for "PaaS/CloudBees/Switch Account" action.
 *
...
public class ShowLoginCommand implements ExtendedCommand {
     ...
     */
    @Inject
    public ShowLoginCommand(LoginPresenter presenter, CloudBeesResources resources) {

...
/**
 * Command for "PaaS/CloudBees/Create Account" action.
 *
 * @author <a href="mailto:aplotnikov@codenvy.com">Andrey Plotnikov</a>
 */
@Singleton
public class ShowCreateAccountCommand implements ExtendedCommand {
     ...
     */
    @Inject
    public ShowCreateAccountCommand(CreateAccountPresenter presenter, CloudBeesResources resources) {
    ...
    public String getToolTip() {
        return "Create new account on cloudbees.com";
    }

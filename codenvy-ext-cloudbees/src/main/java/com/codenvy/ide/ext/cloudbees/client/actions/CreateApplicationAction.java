...
public class CreateApplicationAction extends Action {
    ...
    @Inject
    public CreateApplicationAction(CreateApplicationPresenter presenter, CloudBeesResources resources, ResourceProvider resourceProvider) {
        super("Create Application...", "Create new application on CloudBees", resources.initializeApp());

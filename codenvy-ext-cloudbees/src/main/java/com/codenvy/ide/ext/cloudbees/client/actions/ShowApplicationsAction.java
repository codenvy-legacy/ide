...
public class ShowApplicationsAction extends Action {
    ...
    @Inject
    public ShowApplicationsAction(ApplicationsPresenter presenter, CloudBeesResources resources) {
        super("Applications...", "Shows registered applications on cloudbees.com", resources.appList());

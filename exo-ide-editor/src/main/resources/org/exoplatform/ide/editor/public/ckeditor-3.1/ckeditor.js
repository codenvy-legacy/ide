...
(function () {
    if (!window.CKEDITOR)window.CKEDITOR = (function () {
        var a = {timestamp: 'A06B', version: '3.1', revision: '4891', _: {}, status: 'unloaded', basePath: (function () {
    ...
    (function () {
        ...
        function q(r, s, t) {
            ...
            u.getBody().append(x);
            if (!c && s != 'html')x.setStyles({position: 'absolute', left: '-1000px', top: v.getStartElement().getDocumentPosition().y + 'px', width: '1px', height: '1px', overflow: 'hidden'});
        ...
        j.add('clipboard', {requires: ['htmldataprocessor'], init: function (r) {
    ...
    (function () {
        j.add('div', {requires: ['editingblock', 'domiterator'], init: function (l) {
            var m = l.lang.div;
    ...
    (function () {
        ...
        j.enterkey = {enterBlock: function (s, t, u, v) {
            ...
            if (!B && !C) {
                ...
                var F = y.elementPath;
                if (F)for (var G = 0, H = F.elements.length;
                           G < H; G++) {
                    var I = F.elements[G];
        ...
        j.list = {listToArray: function (A, B, C, D, E) {
            ...
            for (; ;) {
                ...
                if (L.indent == I) {
                    ...
                    J;
                    if (l[L.grandparent.getName()])J = E.createElement('li'); else if (D != 2 && L.grandparent.getName() != 'td')J = E.createElement(K);
        ...
        j.add('wysiwygarea', {requires: ['editingblock'], init: function (w) {
            ...
            w.on('editingBlockReady', function () {
                var z, A, B, C, D, E, F, G = b.isCustomDomain(), H = function (K) {
                    ...
                    if (b.gecko) {
                        z.setAttributes({role: 'region', title: L});
                        B.setAttributes({role: 'region', title: ' '});
                    } else if (b.webkit) {
                    ...
                    P.on('focus', function () {
                        if (b.gecko) {
                            ...
                            if (!U.nextSibling && 'BR' == U.tagName && U.hasAttribute('_moz_editor_bogus_node')) {
                                ...
                                if (w.config.enterMode == 2)L.createElement('br', {attributes: {_moz_dirty: ''}}).replace(W); else W.remove();
                            }
                        }
                ...
                w.addMode('wysiwyg', {load: function (K, L, M) {
                    z = K;
    ...
    (function () {
        a.menu = e.createClass({$: function (m, n) {
            ...
            if (!s) {
                s = this._.panel = new k.floatPanel(this.editor, a.document.getBody(), {css: r.skin.editor.css, level: this._.level - 1, className: r.skinClass + ' cke_contextmenu'}, this._.level);
    ...
    (function () {
        ...
        (function () {
            k.dialog = {uiElement: function (K, L, M, N, O, P, Q) {
                ...
                k.dialog.uiElement.call(this, K, O || {type: 'hbox'}, N, 'table', S, O && O.align && {align: O.align} || null, U);
                ...
                k.dialog.uiElement.call(this, K, O || {type: 'vbox'}, N, 'div', null, null, S);
            }};
        })();

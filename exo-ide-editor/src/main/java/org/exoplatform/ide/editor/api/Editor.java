...
public abstract class Editor extends AbsolutePanel
{
   ...
   /**
    * Set cursor at the position (row, column). If there are now such row or column in the specified row in the text, then cursor
   ...
   /**
    * If editor support autocompletion and outline feature, this method return {@link List} of {@link Token} parsed from current
    * file in background without freezing of browser
    * 
    * @return {@link List} of {@link Token}
    */
   ...
   /**
    * Verify if there any such fqn among the default packages of import statements and insert import statement like
    * "import <fqn>;" in the appropriate place of file
    * 
    * @param fqn
    */

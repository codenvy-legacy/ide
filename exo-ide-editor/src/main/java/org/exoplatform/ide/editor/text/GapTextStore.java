...
public class GapTextStore implements ITextStore
{
    ...
    * 
    * @param lowWatermark unused - at the lower bound, the array is only resized when the content does not fit
    * @param highWatermark if the gap is ever larger than this, it will automatically be shrunken (&gt;=&nbsp;0)
    ...
    * @param maxSize the maximum gap size to allocate (&gt;=&nbsp;minSize; use {@link Integer#MAX_VALUE} for no maximum)

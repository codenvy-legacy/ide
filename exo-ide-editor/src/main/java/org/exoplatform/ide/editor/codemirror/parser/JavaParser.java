...
//      else if (!inMethodBraces)
      else
      {
                    ...
                    )
            {
               ...
               if (methodParameter == null)
               {
                  methodParameter = new TokenBeenImpl(nodeContent, TokenType.PARAMETER, lineNumber,
                     MimeType.APPLICATION_JAVA, currentJavaType);
               }
               else
               {
         ...
         else
         {
            ...
            else if (isJavaVariable(nodeType)) 
            {
               ...
               {
                  TokenBeenImpl newToken = new TokenBeenImpl(nodeContent, TokenType.valueOf(lastNodeContent.toUpperCase()), lineNumber, MimeType.APPLICATION_JAVA, null, modifiers);
   ...
   {
      if (isJavaModifier(nodeType, nodeContent) 
               && (nodeContent != null) )
      {
   ...
   private void parsePackageOrImportStatement(int lineNumber, TokenBeenImpl currentToken, String nodeContent, String nodeType)
   {
      ...
      else if (inPackageStatement || inImportStatement)
      {
         ...
         else if (! isJavaVariable(lastNodeType) && isPoint(nodeType, nodeContent)) // filter package or import statement like this "java." 
         {
            inPackageStatement = false;
            inImportStatement = false;
         }
   ...
   private boolean isJavaModifier(String nodeType, String nodeContent)
   {
      return (nodeType != null) && nodeType.equals("java-keyword") 
               && (
                  "abstract".equals(nodeContent)
                  || "final".equals(nodeContent)
                  || "private".equals(nodeContent)
                  || "protected".equals(nodeContent)
                  || "public".equals(nodeContent)
                  || "static".equals(nodeContent)
                  || "strictfp".equals(nodeContent)
                  || "synchronized".equals(nodeContent)
                  || "threadsafe".equals(nodeContent)
                  || "transient".equals(nodeContent)
                  || "volatile".equals(nodeContent)
               );
   }
   ...
   private boolean isJavaType(String nodeType, String nodeContent)
   {
      return (nodeType != null) && nodeType.equals("java-keyword") 
               && (
                  "boolean".equals(nodeContent) 
                  || "byte".equals(nodeContent)
                  || "char".equals(nodeContent)
                  || "enum".equals(nodeContent)
                  || "double".equals(nodeContent)
                  || "float".equals(nodeContent)
                  || "int".equals(nodeContent)
                  || "long".equals(nodeContent)
                  || "short".equals(nodeContent)
                  || "void".equals(nodeContent)                  
               );
   }
   ...
   {
      return (nodeType != null) && (nodeContent != null) && nodeType.equals("java-operator")
         && nodeContent.equals("=");
   }
   ...
   private boolean isOpenBracket(String nodeType, String nodeContent)
   {
      return (nodeType != null) && (nodeContent != null) 
         && nodeType.equals("java-punctuation")
         && nodeContent.equals("(");
   }
   ...
   {
      return (nodeType != null) && (nodeContent != null) && nodeType.equals("java-keyword") && nodeContent.equals("class");
   }
   
   private boolean isJavaInterfaceNode(String nodeType, String nodeContent)
   {
      return (nodeType != null) && (nodeContent != null) && nodeType.equals("java-keyword") && nodeContent.equals("interface");
   }

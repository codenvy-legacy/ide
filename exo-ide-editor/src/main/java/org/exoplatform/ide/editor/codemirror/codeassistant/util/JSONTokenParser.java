 ...
 */
package org.exoplatform.ide.editor.codemirror.codeassistant.util;
...
public class JSONTokenParser
{
   ...
   public List<Token> getTokens(JSONArray json)
   {
      ...
      for (int i = 0; i < json.size(); i++)
      {
         ...
         Token t =
            new TokenImpl(jObject.get(TokenFields.NAME).isString().stringValue(), TokenType.valueOf(jObject
         ...
         {
            t.setProperty(TokenProperties.CHILD_TOKEN_LIST,

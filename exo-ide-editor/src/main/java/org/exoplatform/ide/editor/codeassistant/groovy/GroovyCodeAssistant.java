 ...
 */
package org.exoplatform.ide.editor.codeassistant.groovy;
...
public class GroovyCodeAssistant extends JavaCodeAssistant
{
   ...
   /**
    * @see org.exoplatform.ide.editor.codeassistant.java.JavaCodeAssistant#parseKeyWords(com.google.gwt.resources.client.TextResource)
    */
   @Override

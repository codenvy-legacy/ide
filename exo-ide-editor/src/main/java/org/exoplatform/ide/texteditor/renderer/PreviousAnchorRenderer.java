...
public class PreviousAnchorRenderer implements LineRenderer
{
   ...
   public PreviousAnchorRenderer(Document document, AnchorType anchorType, AnchorStyleGetter styleGetter)
   {
   ...
   private void calculateNextChunk()
   {
      ...
      if (prevAnchor == null)
      {
         Anchor startSearchAnchor =
            document.getAnchorManager().createAnchor(START_SEARCH_ANCHOR_TYPE, line, AnchorManager.IGNORE_LINE_NUMBER,
               1);

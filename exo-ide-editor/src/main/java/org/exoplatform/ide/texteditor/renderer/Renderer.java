...
import org.exoplatform.ide.texteditor.renderer.ChangeTracker.ChangeType;
...
public class Renderer
{
   ...
   public static Renderer create(Document document, ViewportModel viewport, Buffer buffer, Gutter leftGutter,
   ...
   private Renderer(Document document, ViewportModel viewport, Buffer buffer, Gutter leftGutter,
      SelectionModel selection, FocusManager focusManager, Editor editor, Resources res,
      RenderTimeExecutor renderTimeExecutor)
   {

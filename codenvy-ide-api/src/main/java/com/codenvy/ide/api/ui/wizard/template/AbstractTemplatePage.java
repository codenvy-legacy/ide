 ...
 */
public class AbstractTemplatePage extends AbstractWizardPage {
     ...
     * @param image
     */
    public AbstractTemplatePage(@Nullable String caption, @Nullable ImageResource image, String templateID) {
        super(caption, image);

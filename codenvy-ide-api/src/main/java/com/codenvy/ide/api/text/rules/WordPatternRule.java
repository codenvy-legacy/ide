...
public class WordPatternRule extends SingleLineRule {
     ...
     *
     * @param detector
     *         the word detector to be used
     * @param startSequence
     *         the start sequence of the word pattern
     * @param endSequence
     *         the end sequence of the word pattern
     * @param token
     *         the token to be returned on success
     */
    public WordPatternRule(WordDetector detector, String startSequence, String endSequence, Token token) {
     ...
     */
    public WordPatternRule(WordDetector detector, String startSequence, String endSequence, Token token, char escapeCharacter) {

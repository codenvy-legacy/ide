...
public class EndOfLineRule extends SingleLineRule {
     ...
     */
    public EndOfLineRule(String startSequence, Token token) {
     ...
     */
    public EndOfLineRule(String startSequence, Token token, char escapeCharacter) {
     ...
     * @since 3.0
     */
    public EndOfLineRule(String startSequence, Token token, char escapeCharacter, boolean escapeContinuesLine) {

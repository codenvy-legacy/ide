 ...
 * type are of type <code>"com.codenvy.ide.api.text.annotation.unknown"</code>.
 * </p>
 */
public class Annotation {
     ...
     * Value: <code>"com.codenvy.ide.api.text.annotation.unknown"</code>
     */
    public final static String TYPE_UNKNOWN = "com.codenvy.ide.api.text.annotation.unknown"; //$NON-NLS-1$

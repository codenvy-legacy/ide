...
public class RuleBasedScanner implements CharacterScanner, TokenScanner {
     ...
     * @since 2.0
     */
    public void setDefaultReturnToken(Token defaultReturnToken) {
     ...
     */
    public void setRange(final Document document, int offset, int length) {
        ...
        if (fDefaultReturnToken == null)
            fDefaultReturnToken = new TokenImpl(null);
    }
    ...
    public Token nextToken() {
        ...
        if (fRules != null) {
            for (int i = 0; i < fRules.length; i++) {
                Token token = (fRules[i].evaluate(this));

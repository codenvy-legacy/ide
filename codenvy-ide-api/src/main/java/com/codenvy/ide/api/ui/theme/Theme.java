...
/**
 * Theme is a collection of colors, fonts and supporting data that may
...
public interface Theme {
    ...
    /**
     * Background color of the {@link com.google.gwt.user.client.ui.Button}
     * Button has gradient in background, so this color is main color
     *
     * @return the color
     */

...
public class MultiLineRule extends PatternRule {
     ...
     */
    public MultiLineRule(String startSequence, String endSequence, Token token) {
     ...
     */
    public MultiLineRule(String startSequence, String endSequence, Token token, char escapeCharacter) {
     ...
     * @since 2.1
     */
    public MultiLineRule(String startSequence, String endSequence, Token token, char escapeCharacter, boolean breaksOnEOF) {

...
public class SingleLineRule extends PatternRule {
     ...
     */
    public SingleLineRule(String startSequence, String endSequence, Token token) {
     ...
     */
    public SingleLineRule(String startSequence, String endSequence, Token token, char escapeCharacter) {
     ...
     *         the escape character
     * @param breaksOnEOF
     *         indicates whether the end of the file successfully terminates this rule
     * @since 2.1
     */
    public SingleLineRule(String startSequence, String endSequence, Token token, char escapeCharacter, boolean breaksOnEOF) {

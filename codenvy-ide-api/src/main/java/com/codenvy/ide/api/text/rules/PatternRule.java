 ...
 */
public class PatternRule implements PredicateRule {
     ...
     */
    public PatternRule(String startSequence, String endSequence, Token token, char escapeCharacter, boolean breaksOnEOL) {
     ...
     *         indicates whether the end of the line also terminates the pattern
     * @param breaksOnEOF
     *         indicates whether the end of the file also terminates the pattern
     * @since 2.1
     */
    public PatternRule(String startSequence, String endSequence, Token token, char escapeCharacter, boolean breaksOnEOL,
                       boolean breaksOnEOF) {
     ...
     */
    protected Token doEvaluate(CharacterScanner scanner) {
     ...
     * @since 2.0
     */
    protected Token doEvaluate(CharacterScanner scanner, boolean resume) {
     ...
     */
    protected boolean endSequenceDetected(CharacterScanner scanner) {
     ...
     */
    protected boolean sequenceDetected(CharacterScanner scanner, char[] sequence, boolean eofAllowed) {
     ...
     * @since 2.0
     */
    public Token evaluate(CharacterScanner scanner, boolean resume) {
        ...
        scanner.unread();
        if (c == fStartSequence[0])
            return (fColumn == scanner.getColumn() ? doEvaluate(scanner, resume) : TokenImpl.UNDEFINED);
        return TokenImpl.UNDEFINED;
    }

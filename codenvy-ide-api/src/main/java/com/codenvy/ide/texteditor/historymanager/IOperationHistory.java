 ...
 *******************************************************************************/
package com.codenvy.ide.texteditor.historymanager;
...
public interface IOperationHistory
{
   ...
   public static final IStatus OPERATION_INVALID_STATUS = new OperationStatus(IStatus.ERROR,
      OperationStatus.DEFAULT_PLUGIN_ID, OperationStatus.OPERATION_INVALID, "Operation is not valid", null); //$NON-NLS-1$
    ...
    * 
    * @see com.codenvy.ide.texteditor.historymanager.core.commands.operations.IOperationHistoryListener
    * @see com.codenvy.ide.texteditor.historymanager.core.commands.operations.OperationHistoryEvent
    */
    ...
    * 
    */
   IStatus execute(IUndoableOperation operation) throws ExecutionException;
    ...
    * 
    */
   IStatus redo(IUndoContext context) throws ExecutionException;
    ...
    *             if an exception occurred during redo.
    */
   IStatus redoOperation(IUndoableOperation operation) throws ExecutionException;
   ...
   IStatus undo(IUndoContext context) throws ExecutionException;
    ...
    *             if an exception occurred during undo.
    */
   IStatus undoOperation(IUndoableOperation operation) throws ExecutionException;

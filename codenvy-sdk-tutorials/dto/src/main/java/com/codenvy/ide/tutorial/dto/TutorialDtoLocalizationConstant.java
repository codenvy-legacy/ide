...
/**
 * Interface to represent the constants contained in resource bundle: 'TutorialDtoLocalizationConstant.properties'.
 */
public interface TutorialDtoLocalizationConstant extends Messages {
    /* Buttons */
    @Key("button.cancel")
    String buttonCancel();

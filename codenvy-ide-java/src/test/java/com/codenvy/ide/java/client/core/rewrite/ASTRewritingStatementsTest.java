...
public class ASTRewritingStatementsTest extends ASTRewritingTest
{
   ...
   public void testInsert1() throws Exception
   {
      ...
      buf.append("}\n");
      ICompilationUnit cu =
         new com.codenvy.ide.java.client.compiler.batch.CompilationUnit(buf.toString().toCharArray(), "C.java", "");
   ...
   public void testInsert2() throws Exception
   {
      ...
      buf.append("}\n");
      ICompilationUnit cu =
         new com.codenvy.ide.java.client.compiler.batch.CompilationUnit(buf.toString().toCharArray(), "D.java", "");
   ...
   public void testTryStatementWithResources3() throws Exception
   {
      ...
      ICompilationUnit cu =
         new com.codenvy.ide.java.client.compiler.batch.CompilationUnit(buf.toString().toCharArray(), "X.java", "");
   ...
   public void testVariableDeclarationStatement() throws Exception
   {
      ...
      buf.append("}\n");
      ICompilationUnit cu =
         new com.codenvy.ide.java.client.compiler.batch.CompilationUnit(buf.toString().toCharArray(), "A.java", "");

 ...
 *******************************************************************************/
package com.codenvy.ide.java.client.internal.codeassist.impl;
...
import com.codenvy.ide.java.client.internal.compiler.ast.ASTNode;
...
import com.codenvy.ide.java.client.internal.compiler.ast.Block;
import com.codenvy.ide.java.client.internal.compiler.ast.CompilationUnitDeclaration;
import com.codenvy.ide.java.client.internal.compiler.ast.ConstructorDeclaration;
import com.codenvy.ide.java.client.internal.compiler.ast.ExplicitConstructorCall;
import com.codenvy.ide.java.client.internal.compiler.ast.Expression;
import com.codenvy.ide.java.client.internal.compiler.ast.FieldDeclaration;
...
import com.codenvy.ide.java.client.internal.compiler.ast.Initializer;
...
import com.codenvy.ide.java.client.internal.compiler.ast.MethodDeclaration;
import com.codenvy.ide.java.client.internal.compiler.ast.NameReference;
import com.codenvy.ide.java.client.internal.compiler.ast.Statement;
import com.codenvy.ide.java.client.internal.compiler.ast.SuperReference;
import com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration;
...
import com.codenvy.ide.java.client.internal.compiler.parser.RecoveredBlock;
import com.codenvy.ide.java.client.internal.compiler.parser.RecoveredElement;
import com.codenvy.ide.java.client.internal.compiler.parser.RecoveredField;
import com.codenvy.ide.java.client.internal.compiler.parser.RecoveredInitializer;
import com.codenvy.ide.java.client.internal.compiler.parser.RecoveredMethod;
import com.codenvy.ide.java.client.internal.compiler.parser.RecoveredType;
import com.codenvy.ide.java.client.internal.compiler.parser.RecoveredUnit;
...
public abstract class AssistParser extends Parser
{
   ...
   public RecoveredElement buildInitialRecoveryState()
   {
      ...
      for (int j = blockIndex; j <= this.realBlockPtr; j++)
      {
         if (this.blockStarts[j] >= 0)
         {
            if ((this.blockStarts[j] < pos) && (this.blockStarts[j] != lastStart))
            { // avoid multiple block if at same position
               block = new Block(0);
               block.sourceStart = lastStart = this.blockStarts[j];
               element = element.add(block, 1);
   ...
   public abstract TypeReference createParameterizedQualifiedAssistTypeReference(char[][] previousIdentifiers,
      TypeReference[][] typeArguments, char[] asistIdentifier, TypeReference[] assistTypeArguments, long[] positions);

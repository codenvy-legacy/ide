 ...
 *******************************************************************************/
package com.codenvy.ide.java.client.internal.corext.refactoring.sorround;
...
import com.codenvy.ide.java.client.core.dom.UnionType;
...
import com.codenvy.ide.java.client.internal.core.dom.CodeScopeBuilder;
...
import com.codenvy.ide.java.client.internal.corext.refactoring.util.SelectionAwareSourceRangeComputer;
import com.codenvy.ide.java.client.internal.corext.util.Strings;
import com.codenvy.ide.java.client.refactoring.Change;
...
import com.codenvy.ide.java.client.refactoring.TextFileChange;
...
public class SurroundWithTryCatchRefactoring extends Refactoring
{
   ...
   /**
    * @see com.codenvy.ide.java.client.ltk.refactoring.Refactoring#checkFinalConditions(com.codenvy.ide.java.client.runtime.IProgressMonitor)
    */
   @Override

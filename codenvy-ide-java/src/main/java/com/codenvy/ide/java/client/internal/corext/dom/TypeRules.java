...
import com.codenvy.ide.java.client.internal.corext.refactoring.types.TType;
import com.codenvy.ide.java.client.internal.corext.refactoring.types.TypeEnvironment;
...
public class TypeRules
{
   ...
   public static boolean isJavaLangObject(ITypeBinding definedType)
   {
      return definedType.isTopLevel() && definedType.isClass()
         && "Object".equals(definedType.getName()) && "java.lang".equals(definedType.getPackage().getName()); //$NON-NLS-1$//$NON-NLS-2$
   }

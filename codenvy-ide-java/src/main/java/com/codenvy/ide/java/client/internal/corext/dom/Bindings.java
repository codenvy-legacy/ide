...
import com.codenvy.ide.java.client.core.dom.IPackageBinding;
...
public class Bindings
{
    ...
    * @param parameters The parameter types of the method to find. If <code>null</code> is passed, only the name is matched and

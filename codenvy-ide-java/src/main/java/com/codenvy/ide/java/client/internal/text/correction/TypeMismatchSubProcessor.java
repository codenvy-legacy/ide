...
import com.codenvy.ide.java.client.core.dom.MemberValuePair;
import com.codenvy.ide.java.client.core.dom.MethodDeclaration;
import com.codenvy.ide.java.client.core.dom.Name;
import com.codenvy.ide.java.client.core.dom.SingleMemberAnnotation;
...
import com.codenvy.ide.java.client.internal.text.correction.proposals.TypeChangeCorrectionProposal;
...
public class TypeMismatchSubProcessor
{
   ...
   public static void addChangeSenderTypeProposals(InvocationContext context, Expression nodeToCast,
      ITypeBinding castTypeBinding, boolean isAssignedNode, int relevance, Collection<ICommandAccess> proposals)
   {
      ...
      Collection<ICommandAccess> proposals)
   {
      ...
      String label =
         CorrectionMessages.INSTANCE.TypeMismatchSubProcessor_incompatible_for_each_type_description(parameter
            .getName().getIdentifier(), BindingLabelProvider.getBindingLabel(expectedBinding,

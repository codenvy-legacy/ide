      ...
      if (validCount > 0)
      {
         ...
         { // only tolerating non-javadoc comments (non-javadoc comment end positions are negative)
           // is there any line break until the end of the immediate comment ? (thus only tolerating line comment)
            ...
            if (com.codenvy.ide.java.client.internal.compiler.util.Util.getLineNumber(position, this.scanner.lineEnds, 0,
               this.scanner.linePtr) != com.codenvy.ide.java.client.internal.compiler.util.Util.getLineNumber(

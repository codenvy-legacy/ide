...
import com.codenvy.ide.java.client.templates.api.SimpleTemplateVariableResolver;
...
public class JavaDocContextType extends CompilationUnitContextType
{
   ...
   protected static class SurroundWithWordSelection extends SimpleTemplateVariableResolver
   {
      ...
      {
         super(
            com.codenvy.ide.java.client.templates.api.GlobalTemplateVariables.WordSelection.NAME,

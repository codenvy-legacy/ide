...
import com.codenvy.ide.java.client.core.ToolFactory;
import com.codenvy.ide.java.client.core.compiler.IScanner;
import com.codenvy.ide.java.client.core.compiler.ITerminalSymbols;
import com.codenvy.ide.java.client.core.compiler.InvalidInputException;
import com.codenvy.ide.java.client.internal.core.dom.rewrite.TokenScanner;
import com.codenvy.ide.java.client.internal.corext.codemanipulation.StubUtility;
import com.codenvy.ide.java.client.templates.api.GlobalTemplateVariables;
import com.codenvy.ide.java.client.templates.api.TemplateContext;
...
import com.codenvy.ide.java.client.templates.api.TemplateVariable;
import com.codenvy.ide.java.client.templates.api.TemplateVariableResolver;
...
public class CodeTemplateContextType extends TemplateContextType
{
   ...
   public CodeTemplateContextType(String contextName)
   {
      ...
      if (CATCHBLOCK_CONTEXTTYPE.equals(contextName))
      {
         addResolver(new CodeTemplateVariableResolver(ENCLOSING_TYPE,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_enclosingtype()));
         addResolver(new CodeTemplateVariableResolver(ENCLOSING_METHOD,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_enclosingmethod()));

         addResolver(new CodeTemplateVariableResolver(EXCEPTION_TYPE,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_exceptiontype()));
         addResolver(new CodeTemplateVariableResolver(EXCEPTION_VAR,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_exceptionvar()));
      }
      else if (METHODBODY_CONTEXTTYPE.equals(contextName))
      {
         ...
         addResolver(new CodeTemplateVariableResolver(BODY_STATEMENT,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_bodystatement()));
      }
      ...
      else if (GETTERBODY_CONTEXTTYPE.equals(contextName))
      {
         ...
         addResolver(new CodeTemplateVariableResolver(FIELD,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_getterfieldname()));
      }
      else if (SETTERBODY_CONTEXTTYPE.equals(contextName))
      {
         ...
         addResolver(new CodeTemplateVariableResolver(PARAM,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_param()));
      }
      else if (NEWTYPE_CONTEXTTYPE.equals(contextName))
      {
         addResolver(new CodeTemplateVariableResolver(TYPENAME,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_typename()));
         addResolver(new CodeTemplateVariableResolver(PACKAGE_DECLARATION,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_packdeclaration()));
         addResolver(new CodeTemplateVariableResolver(TYPE_DECLARATION,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_typedeclaration()));
         addResolver(new CodeTemplateVariableResolver(TYPE_COMMENT,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_typecomment()));
         addResolver(new CodeTemplateVariableResolver(FILE_COMMENT,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_filecomment()));
      ...
      else if (FIELDCOMMENT_CONTEXTTYPE.equals(contextName))
      {
         addResolver(new CodeTemplateVariableResolver(FIELD_TYPE,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_fieldtype()));
         addResolver(new CodeTemplateVariableResolver(FIELD,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_fieldname()));
         addCompilationUnitVariables();
         fIsComment = true;
      }
      else if (METHODCOMMENT_CONTEXTTYPE.equals(contextName))
      {
         ...
         addResolver(new CodeTemplateVariableResolver(RETURN_TYPE,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_returntype()));
         addResolver(new TagsVariableResolver());
         addCompilationUnitVariables();
         fIsComment = true;
      }
      else if (OVERRIDECOMMENT_CONTEXTTYPE.equals(contextName))
      {
         ...
         addResolver(new CodeTemplateVariableResolver(SEE_TO_OVERRIDDEN_TAG,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_see_overridden_tag()));
         addResolver(new TagsVariableResolver());
         addCompilationUnitVariables();
         fIsComment = true;
      }
      else if (DELEGATECOMMENT_CONTEXTTYPE.equals(contextName))
      {
         ...
         addResolver(new CodeTemplateVariableResolver(SEE_TO_TARGET_TAG,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_see_target_tag()));
         addResolver(new TagsVariableResolver());
         addCompilationUnitVariables();
         fIsComment = true;
      }
      ...
      else if (GETTERCOMMENT_CONTEXTTYPE.equals(contextName))
      {
         addResolver(new CodeTemplateVariableResolver(ENCLOSING_TYPE,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_enclosingtype()));
         addResolver(new CodeTemplateVariableResolver(FIELD_TYPE,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_getterfieldtype()));
         addResolver(new CodeTemplateVariableResolver(FIELD,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_getterfieldname()));
         addResolver(new CodeTemplateVariableResolver(ENCLOSING_METHOD,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_enclosingmethod()));
         addResolver(new CodeTemplateVariableResolver(BARE_FIELD_NAME,
            JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_barefieldname()));
         addCompilationUnitVariables();
         fIsComment = true;
      }
   ...
   private void addCompilationUnitVariables()
   {
      addResolver(new CodeTemplateVariableResolver(FILENAME,
         JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_filename()));
      addResolver(new CodeTemplateVariableResolver(PACKAGENAME,
         JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_packagename()));
      addResolver(new CodeTemplateVariableResolver(PROJECTNAME,
         JavaTemplateMessages.INSTANCE.CodeTemplateContextType_variable_description_projectname()));
   }

...
public abstract class Binding
{
    ...
    * 
    * @see com.codenvy.ide.java.client.internal.compiler.lookup.SourceTypeBinding#getAnnotationTagBits()
    */
    ...
    * 
    * @see com.codenvy.ide.java.client.internal.compiler.lookup.SourceTypeBinding#initializeDeprecatedAnnotationTagBits()
    */

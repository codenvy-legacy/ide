...
import com.codenvy.ide.java.client.internal.compiler.parser.RecoveryScannerData;
...
//      options.remove(JavaCore.COMPILER_TASK_TAGS); // no need to parse task tags
    ...
    * </p>
    * 
    * @param enabled <code>true</code> if incomplete bindings are expected, and <code>false</code> if only complete bindings are
    *           expected.
    * 
    ...
    * @param encodings the encodings of the corresponding sourcepath entries or <code>null</code> if the platform encoding can be
    *           used.
    * @param includeRunningVMBootclasspath <code>true</code> if the bootclasspath of the running VM must be prepended to the given
    ...
    * </p>
    * 
    * @param options the table of options (key type: <code>String</code>; value type: <code>String</code>), or <code>null</code>
...
//      options.remove(JavaCore.COMPILER_TASK_TAGS); // no need to parse task tags
    ...
    * </p>
    * 
    * @param enabled <code>true</code> if bindings are wanted, and <code>false</code> if bindings are not of interest
    */
    ...
    * @param length the number of characters to parse, or -1 if the remainder of the source string is to be parsed
    */
    ...
    * </p>
    * 
    * @param enabled <code>true</code> if statements containing syntax errors are wanted, and <code>false</code> if these
    ...
    * </p>
    * 
    * @param monitor the progress monitor used to report progress and request cancellation, or <code>null</code> if none
    ...
    * @exception IllegalStateException if the settings provided are insufficient, contradictory, or otherwise unsupported
    */
      ...
      switch (this.astKind)
      {
         ...
         case K_COMPILATION_UNIT :
            ...
            try
            {
               ...
               com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit = null;
               if (this.rawSource != null)
               {
               ...
               CompilationUnit result =
                  CompilationUnitResolver.convert(compilationUnitDeclaration, sourceUnit.getContents(), this.apiLevel,
                     this.compilerOptions, needToResolveBindings, needToResolveBindings
                        ? new DefaultBindingResolver.BindingTables() : null, flags, false);
               return result;
            }
            finally
            {
   ...
   private ASTNode internalCreateASTForKind()
   {
      ...
      switch (this.astKind)
      {
         case K_STATEMENTS :
            ...
            com.codenvy.ide.java.client.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
            if (statements != null)
            {
         ...
         case K_CLASS_BODY_DECLARATIONS :
            final com.codenvy.ide.java.client.internal.compiler.ast.ASTNode[] nodes =

 ...
 *******************************************************************************/
package com.codenvy.ide.java.client.internal.compiler.lookup;
...
public class ParameterizedTypeBinding extends ReferenceBinding implements Substitution
{
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#canBeInstantiated() */
    ...
    * 
    * @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#capture(Scope,int)
    */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#collectMissingTypes(java.util.List) */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#computeId() */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#constantPoolName() */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#debugName() */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#enclosingType() */
   public ReferenceBinding enclosingType()
   {
      return this.enclosingType;
   }

   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.Substitution#environment() */
   public LookupEnvironment environment()
   {
      return this.environment;
   }

   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#erasure() */
   public TypeBinding erasure()
   {
      return this.type.erasure(); // erasure
   }

   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#fieldCount() */
   public int fieldCount()
   {
      return this.type.fieldCount(); // same as erasure (lazy)
   }

   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#fields() */
   public FieldBinding[] fields()
   {
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#getAnnotationTagBits() */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#getExactConstructor(TypeBinding[]) */
   ...
   /**
    * @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#getExactMethod(char[],
   ...
   /**
    * @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#getField(char[], boolean)
    */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#getMemberType(char[]) */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#getMethods(char[]) */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#implementsMethod(MethodBinding) */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.Substitution#isRawSubstitution() */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#memberTypes() */
   public ReferenceBinding[] memberTypes()
   {
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#methods() */
   public MethodBinding[] methods()
   {
      if ((this.tagBits & TagBits.AreMethodsComplete) != 0)
         return this.methods;
    ...
    * 
    * @see com.codenvy.ide.java.client.internal.compiler.lookup.Binding#problemId()
    */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#qualifiedPackageName() */
   public char[] qualifiedPackageName()
   {
      return this.type.qualifiedPackageName();
   }

   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#qualifiedSourceName() */
   public char[] qualifiedSourceName()
   {
      return this.type.qualifiedSourceName();
   }

   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.Binding#readableName() */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.Binding#shortReadableName() */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#signature() */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#sourceName() */
   public char[] sourceName()
   {
      return this.type.sourceName();
   }

   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.Substitution#substitute(com.codenvy.ide.java.client.internal.compiler.lookup.TypeVariableBinding) */
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#superclass() */
   public ReferenceBinding superclass()
   {
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#superInterfaces() */
   public ReferenceBinding[] superInterfaces()
   {
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#syntheticEnclosingInstanceTypes() */
   public ReferenceBinding[] syntheticEnclosingInstanceTypes()
   {
      return genericType().syntheticEnclosingInstanceTypes();
   }

   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding#syntheticOuterLocalVariables() */

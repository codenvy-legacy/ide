...
public class CastExpression extends Expression
{
   ...
   /**
    * @see com.codenvy.ide.java.client.internal.compiler.ast.Expression#localVariableBinding()
    */
   @Override
   ...
   /**
    * @see com.codenvy.ide.java.client.internal.compiler.ast.Expression#optimizedBooleanConstant()
    */
   @Override
   ...
   /**
    * @see com.codenvy.ide.java.client.internal.compiler.ast.Expression#tagAsNeedCheckCast()
    */
   @Override
   ...
   /**
    * @see com.codenvy.ide.java.client.internal.compiler.ast.Expression#tagAsUnnecessaryCast(Scope, TypeBinding)
    */
   @Override

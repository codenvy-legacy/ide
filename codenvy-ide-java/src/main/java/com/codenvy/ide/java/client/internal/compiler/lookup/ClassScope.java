...
public class ClassScope extends Scope
{
   ...
   void buildAnonymousTypeBinding(SourceTypeBinding enclosingType, ReferenceBinding supertype)
   {
      ...
      else
      {
         ...
         TypeReference typeReference = this.referenceContext.allocation.type;
         if (typeReference != null)
         { // no check for enum constant body
   ...
   private void checkAndSetModifiers()
   {
      ...
      else
      {
         ...
         { // includes member types defined inside local types
            final int UNEXPECTED_MODIFIERS =
               ~(ClassFileConstants.AccPublic | ClassFileConstants.AccPrivate | ClassFileConstants.AccProtected
                  | ClassFileConstants.AccStatic | ClassFileConstants.AccAbstract | ClassFileConstants.AccFinal | ClassFileConstants.AccStrictfp);
            if ((realModifiers & UNEXPECTED_MODIFIERS) != 0)
         ...
         {
            final int UNEXPECTED_MODIFIERS =
               ~(ClassFileConstants.AccPublic | ClassFileConstants.AccAbstract | ClassFileConstants.AccFinal | ClassFileConstants.AccStrictfp);
            if ((realModifiers & UNEXPECTED_MODIFIERS) != 0)
   ...
   private void checkForInheritedMemberTypes(SourceTypeBinding sourceType)
   {
      ...
      if (interfacesToVisit != null)
      {
         ...
         for (int i = 0; i < nextPosition; i++)
         {
            ...
            if ((anInterface.tagBits & TagBits.HasNoMemberTypes) == 0)
   ...
   private boolean connectSuperInterfaces()
   {
      ...
      {
         if (sourceType.isAnnotationType() && compilerOptions().sourceLevel >= ClassFileConstants.JDK1_5)
      ...
      TypeReference reference)
   {
      ...
      {
         com.codenvy.ide.java.client.internal.compiler.ast.TypeReference ref =

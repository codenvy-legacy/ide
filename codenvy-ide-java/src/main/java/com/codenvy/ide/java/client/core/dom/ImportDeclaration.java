...
public class ImportDeclaration extends ASTNode
{
   ...
   public static final SimplePropertyDescriptor STATIC_PROPERTY = new SimplePropertyDescriptor(ImportDeclaration.class,
      "static", boolean.class, MANDATORY); //$NON-NLS-1$
    ...
    * 
    * @param onDemand <code>true</code> if this is an on-demand import, and <code>false</code> if this is a single type import
    */
    ...
    * 
    * @param isStatic <code>true</code> if this is a static import, and <code>false</code> if this is a regular import
    * @exception UnsupportedOperationException if this operation is used in a JLS2 AST
    * @since 3.1
    */

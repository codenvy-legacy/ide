...
import com.codenvy.ide.java.client.internal.text.correction.proposals.MissingReturnTypeCorrectionProposal;
      ...
      if (decl instanceof MethodDeclaration)
      {
         ...
         String label =
            CorrectionMessages.INSTANCE.ReturnTypeSubProcessor_missingreturntype_description(BindingLabelProvider
               .getBindingLabel(typeBinding, BindingLabelProvider.DEFAULT_TEXTFLAGS));
         Image image = new Image(JavaClientBundle.INSTANCE.correction_change());
         LinkedCorrectionProposal proposal =
            new LinkedCorrectionProposal(label, rewrite, 6, context.getDocument(), image);

...
public class BinaryFieldImpl implements IBinaryField
{
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IGenericField#getModifiers() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryField#getAnnotations() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryField#getTagBits() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryField#getConstant() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryField#getGenericSignature() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryField#getName() */
   @Override
   public char[] getName()
   {
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryField#getTypeName() */
   @Override

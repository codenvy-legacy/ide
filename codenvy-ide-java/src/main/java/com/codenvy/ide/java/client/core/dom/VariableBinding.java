...
import com.codenvy.ide.java.client.core.util.ModifierConstants;
...
class VariableBinding implements IVariableBinding {
    ...
    private com.codenvy.ide.java.client.internal.compiler.lookup.VariableBinding binding;
    ...
    VariableBinding(BindingResolver resolver, com.codenvy.ide.java.client.internal.compiler.lookup.VariableBinding binding) {
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        com.codenvy.ide.java.client.internal.compiler.lookup.VariableBinding otherBinding = ((VariableBinding)other).binding;

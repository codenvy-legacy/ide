...
import com.codenvy.ide.java.client.internal.compiler.ast.StringLiteral;
...
import com.codenvy.ide.java.client.internal.compiler.lookup.BaseTypeBinding;
import com.codenvy.ide.java.client.internal.compiler.lookup.Binding;
import com.codenvy.ide.java.client.internal.compiler.lookup.CaptureBinding;
import com.codenvy.ide.java.client.internal.compiler.lookup.FieldBinding;
import com.codenvy.ide.java.client.internal.compiler.lookup.LocalTypeBinding;
...
import com.codenvy.ide.java.client.internal.compiler.lookup.RawTypeBinding;
...
{
   private static final StringLiteral EXPRESSION = new com.codenvy.ide.java.client.internal.compiler.ast.StringLiteral(0, 0);
   ...
   com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding binding;
   ...
   public TypeBinding(BindingResolver resolver, com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding binding)
   {
   ...
   public IAnnotationBinding[] getAnnotations()
   {
      ...
      com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding refType = null;
      ...
      {
         refType = (com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding)this.binding;
      }
      if (refType != null)
      {
         com.codenvy.ide.java.client.internal.compiler.lookup.AnnotationBinding[] internalAnnotations =
         ...
         if (length != 0)
         {
            ...
            {
               com.codenvy.ide.java.client.internal.compiler.lookup.AnnotationBinding internalAnnotation =
   ...
   public String getBinaryName()
   {
      ...
      else if (this.binding.isTypeVariable())
      {
         ...
         com.codenvy.ide.java.client.internal.compiler.lookup.Binding declaring = typeVariableBinding.declaringElement;
         StringBuffer binaryName = new StringBuffer();
         switch (declaring.kind())
         {
            case com.codenvy.ide.java.client.internal.compiler.lookup.Binding.METHOD :
               ...
               break;
            default :
               com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding =
                  (com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding)declaring;
   ...
   public synchronized IVariableBinding[] getDeclaredFields()
   {
      ...
      catch (RuntimeException e)
      {
          ...
          */
         com.codenvy.ide.java.client.internal.core.util.Util.log(e, "Could not retrieve declared fields"); //$NON-NLS-1$
      }
      return this.fields = NO_VARIABLE_BINDINGS;
   }
   ...
   public synchronized IMethodBinding[] getDeclaredMethods()
   {
      ...
      try
      {
         ...
         {
            ReferenceBinding referenceBinding = (ReferenceBinding)this.binding;
            com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding[] internalMethods =
            ...
            if (length != 0)
            {
               ...
               for (int i = 0; i < length; i++)
               {
                  com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding = internalMethods[i];
      ...
      catch (RuntimeException e)
      {
          ...
          * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
          */
         com.codenvy.ide.java.client.internal.core.util.Util.log(e, "Could not retrieve declared methods"); //$NON-NLS-1$
      }
      return this.methods = NO_METHOD_BINDINGS;
   }
      ...
      if (this.binding instanceof LocalTypeBinding)
      {
         ...
         if (methodBinding != null)
         {
            ...
            catch (RuntimeException e)
            {
                ...
                * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
                */
               com.codenvy.ide.java.client.internal.core.util.Util.log(e, "Could not retrieve declaring method"); //$NON-NLS-1$
            }
         }
      }
      else if (this.binding.isTypeVariable())
      ...
      if (isClass() || isInterface() || isEnum())
      {
         ...
         if (referenceBinding.isNestedType())
         {
            ...
            catch (RuntimeException e)
            {
                ...
                * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
                */
               com.codenvy.ide.java.client.internal.core.util.Util.log(e, "Could not retrieve declaring class"); //$NON-NLS-1$
            }
         }
      }
      else if (this.binding.isTypeVariable())
   ...
   public synchronized ITypeBinding[] getInterfaces()
   {
      ...
      catch (RuntimeException e)
      {
          ...
          * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
          */
         com.codenvy.ide.java.client.internal.core.util.Util.log(e, "Could not retrieve interfaces"); //$NON-NLS-1$
      }
   ...
   /** @see com.codenvy.ide.java.client.core.dom.ITypeBinding#getQualifiedName() */
   ...
   public synchronized ITypeBinding getSuperclass()
   {
      ...
      catch (RuntimeException e)
      {
          ...
          * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
          */
         com.codenvy.ide.java.client.internal.core.util.Util.log(e, "Could not retrieve superclass"); //$NON-NLS-1$
   ...
   public ITypeBinding[] getTypeArguments()
   {
      ...
      {
         ParameterizedTypeBinding parameterizedTypeBinding = (ParameterizedTypeBinding)this.binding;
         final com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding[] arguments =
   ...
   public ITypeBinding[] getTypeBounds()
   {
      ...
      if (this.binding instanceof TypeVariableBinding)
      {
         ...
         com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding firstClassOrArrayBound =
   ...
   public boolean isCastCompatible(ITypeBinding type)
   {
      try
      {
         ...
         if (!(type instanceof TypeBinding))
            return false;
         com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding expressionType = ((TypeBinding)type).binding;
   ...
   public boolean isEqualTo(IBinding other)
   {
      ...
      com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding otherBinding = ((TypeBinding)other).binding;
      // check return type
   ...
   public boolean isFromSource()
   {
      if (isClass() || isInterface() || isEnum())
      {
         ...
         else if (referenceBinding.isParameterizedType())
         {
            ...
            com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding erasure = parameterizedTypeBinding.erasure();
      ...
      else if (isTypeVariable())
      {
         ...
         {
            final com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding =
               (com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding)declaringElement;
            ...
            else if (typeBinding instanceof ArrayBinding)
            {
               ...
               final com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding leafComponentType =
   ...
   {
      return this.binding == com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding.NULL;
   }

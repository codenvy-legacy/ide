...
import com.codenvy.ide.java.client.JavaPreferencesSettings;
...
import com.codenvy.ide.java.client.internal.corext.dom.ASTNodeFactory;
...
import com.codenvy.ide.java.client.internal.corext.dom.BodyDeclarationRewrite;
import com.codenvy.ide.java.client.internal.corext.dom.NecessaryParenthesesChecker;
...
import com.codenvy.ide.java.client.internal.corext.fix.CleanUpConstants;
import com.codenvy.ide.java.client.internal.corext.fix.CleanUpOptions;
import com.codenvy.ide.java.client.internal.corext.fix.CodeStyleCleanUp;
import com.codenvy.ide.java.client.internal.corext.fix.CodeStyleFix;
import com.codenvy.ide.java.client.internal.corext.fix.ICleanUp;
import com.codenvy.ide.java.client.internal.corext.fix.IProposableFix;
import com.codenvy.ide.java.client.internal.corext.fix.UnimplementedCodeCleanUp;
import com.codenvy.ide.java.client.internal.corext.fix.UnimplementedCodeFix;
import com.codenvy.ide.java.client.internal.corext.fix.UnnecessaryCodeCleanUp;
import com.codenvy.ide.java.client.internal.corext.fix.UnusedCodeFix;
import com.codenvy.ide.java.client.internal.corext.refactoring.code.CompilationUnitChange;
import com.codenvy.ide.java.client.internal.corext.refactoring.code.Invocations;
import com.codenvy.ide.java.client.internal.corext.refactoring.sorround.ExceptionAnalyzer;
import com.codenvy.ide.java.client.internal.corext.refactoring.sorround.SurroundWithTryCatchRefactoring;
import com.codenvy.ide.java.client.internal.corext.refactoring.util.NoCommentSourceRangeComputer;
import com.codenvy.ide.java.client.internal.corext.refactoring.util.TightSourceRangeComputer;
...
import com.codenvy.ide.java.client.internal.text.correction.proposals.ChangeCorrectionProposal;
import com.codenvy.ide.java.client.internal.text.correction.proposals.ChangeMethodSignatureProposal;
import com.codenvy.ide.java.client.internal.text.correction.proposals.ConstructorFromSuperclassProposal;
import com.codenvy.ide.java.client.internal.text.correction.proposals.FixCorrectionProposal;
import com.codenvy.ide.java.client.internal.text.correction.proposals.LinkedCorrectionProposal;
import com.codenvy.ide.java.client.internal.text.correction.proposals.MissingAnnotationAttributesProposal;
import com.codenvy.ide.java.client.internal.text.correction.proposals.NewVariableCorrectionProposal;
import com.codenvy.ide.java.client.internal.text.correction.proposals.ReplaceCorrectionProposal;
import com.codenvy.ide.java.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.ChangeDescription;
import com.codenvy.ide.java.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.InsertDescription;
import com.codenvy.ide.java.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.RemoveDescription;
...
public class LocalCorrectionsSubProcessor
{
      ...
      Collection<ICommandAccess> proposals) throws CoreException
   {
      ...
      if (refactoring.checkActivationBasics(context.getDocument(), astRoot).isOK())
      {
         ...
         Image image = new Image(JavaClientBundle.INSTANCE.exceptionProp());
...
//            LinkedNamesAssistProposal proposal = new LinkedNamesAssistProposal(name, context, nameNode, valueSuggestion);
      ...
      if (selectedNode instanceof PrefixExpression)
      {
         ...
         if (expression.getOperator() == PrefixExpression.Operator.NOT)
         {
            ...
            if (label != null)
            {
               ...
               Image image = new Image(JavaClientBundle.INSTANCE.correction_cast());
               ASTRewriteCorrectionProposal proposal =
      ...
      if (binding == fieldBinding && ASTResolving.findParentBodyDeclaration(selectedNode) instanceof MethodDeclaration)
      {
         ...
         String label =
            CorrectionMessages.INSTANCE.UnresolvedElementsSubProcessor_createparameter_description(simpleName
               .getIdentifier());
         Image image = new Image(JavaClientBundle.INSTANCE.local_var());
      ...
      Collection<ICommandAccess> proposals)
   {
         ...
         && selectedNode.getLocationInParent() == SwitchStatement.STATEMENTS_PROPERTY)
      {
         ...
         image = new Image(JavaClientBundle.INSTANCE.correction_change());
      ...
      Collection<ICommandAccess> proposals)
   {
      ...
      Image image = new Image(JavaClientBundle.INSTANCE.publicMethod());

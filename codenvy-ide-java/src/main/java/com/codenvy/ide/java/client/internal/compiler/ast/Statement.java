...
public abstract class Statement extends ASTNode
{
      ...
      Scope scope)
   {
      ...
      return expressionType.isBaseType() // narrowing then boxing ?
         ...
         && scope.compilerOptions().sourceLevel >= com.codenvy.ide.java.client.internal.compiler.ClassFileConstants.JDK1_5 // autoboxing
   ...
   /** 
    * Implementation of {@link com.codenvy.ide.java.client.internal.compiler.lookup.InvocationSite#expectedType}

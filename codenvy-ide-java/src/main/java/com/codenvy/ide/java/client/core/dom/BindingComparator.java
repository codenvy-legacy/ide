...
import com.codenvy.ide.java.client.internal.compiler.lookup.ImportBinding;
...
import com.codenvy.ide.java.client.internal.compiler.lookup.VariableBinding;
...
class BindingComparator
{
   ...
   {
      if (declaringElement instanceof com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding)
      {
         if (!(declaringElement2 instanceof com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding))
         {
            return false;
         }
         return isEqual((com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding)declaringElement,
            (com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding)declaringElement2, visitedTypes);
      }
      else if (declaringElement instanceof com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding)
      {
         if (!(declaringElement2 instanceof com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding))
         {
            return false;
         }
         return isEqual((com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding)declaringElement,
            (com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding)declaringElement2, visitedTypes);
      }
      ...
      else if (declaringElement instanceof com.codenvy.ide.java.client.internal.compiler.lookup.PackageBinding)
      {
         if (!(declaringElement2 instanceof com.codenvy.ide.java.client.internal.compiler.lookup.PackageBinding))
         {
            return false;
         }
         com.codenvy.ide.java.client.internal.compiler.lookup.PackageBinding packageBinding =
            (com.codenvy.ide.java.client.internal.compiler.lookup.PackageBinding)declaringElement;
         com.codenvy.ide.java.client.internal.compiler.lookup.PackageBinding packageBinding2 =
            (com.codenvy.ide.java.client.internal.compiler.lookup.PackageBinding)declaringElement2;
   ...
   static boolean isEqual(com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding,
      com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding2)
   {
      return isEqual(methodBinding, methodBinding2, new HashSet());
   }

   static boolean isEqual(com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding,
      com.codenvy.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding2, HashSet visitedTypes)
   {
    ...
    * @return true if both parameters are equals, false otherwise
    */
   static boolean isEqual(com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding[] bindings,
      com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding[] otherBindings)
   {
    ...
    */
   static boolean isEqual(com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding[] bindings,
      com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes)
   {
      if (bindings == null)
      {
         return otherBindings == null;
   ...
   static boolean isEqual(com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding,
      com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes)
   {
    ...
    */
   static boolean isEqual(com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding,
      com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding2)
   {

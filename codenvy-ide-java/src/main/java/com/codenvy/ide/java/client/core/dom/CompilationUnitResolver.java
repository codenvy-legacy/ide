...
import com.codenvy.ide.java.client.internal.compiler.Compiler;
import com.codenvy.ide.java.client.internal.compiler.DefaultErrorHandlingPolicies;
import com.codenvy.ide.java.client.internal.compiler.ICompilerRequestor;
...
import com.codenvy.ide.java.client.internal.compiler.lookup.AnnotationBinding;
...
import com.codenvy.ide.java.client.internal.core.CancelableProblemFactory;
import com.codenvy.ide.java.client.internal.core.util.BindingKeyResolver;
import com.codenvy.ide.java.client.internal.core.util.CommentRecorderParser;
...
class CompilationUnitResolver extends Compiler
{
   ...
   public void accept(ISourceType[] sourceTypes, PackageBinding packageBinding, AccessRestriction accessRestriction)
   {
      ...
      // accept((com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit)sourceType.getHandle().getCompilationUnit(),
      // accessRestriction);
   }

   @Override
   public synchronized void accept(com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit,
    ...
    * their results.
    */
   protected void beginToCompile(com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit[] sourceUnits,
      String[] bindingKeys)
   {
      ...
      {
         com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit = sourceUnits[i];
...
//            continue;
//         }
//         com.codenvy.ide.java.client.compiler.batch.CompilationUnit compilationUnit =
//            new com.codenvy.ide.java.client.compiler.batch.CompilationUnit(contents, sourceUnits[i], encoding);
//         com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit = compilationUnit;
//         CompilationResult compilationResult =
//            new CompilationResult(sourceUnit, 0, 0, compilerOptions.maxProblemsPerUnit);
//         CompilationUnitDeclaration compilationUnitDeclaration = parser.dietParse(sourceUnit, compilationResult);
//
...
//         // fill the methods bodies in order for the code to be generated
//         // real parse of the method....
//         com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration[] types =
...
//   }
   ...
   public static CompilationUnitDeclaration parse(
      com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit, NodeSearcher nodeSearcher,
      Map<String, String> settings, int flags)
   {
      ...
      if (nodeSearcher != null)
      {
         ...
         com.codenvy.ide.java.client.internal.compiler.ast.ASTNode node = nodeSearcher.found;
         if (node == null)
         {
            return compilationUnitDeclaration;
         }

         com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration enclosingTypeDeclaration =
         ...
         else if (enclosingTypeDeclaration != null)
         {
            ...
            {
               ((com.codenvy.ide.java.client.internal.compiler.ast.Initializer)node).parseStatements(parser,
            ...
            {
               ((com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration)node).parseMethods(parser,
   ...
   public static CompilationUnitDeclaration resolve(
      com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit, List classpaths,
   ...
   {
      final com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration[] types =
         compilationUnitDeclaration.types;
      if (types != null)
      {
   ...
   private void removeUnresolvedBindings(com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration type)
   {
      final com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration[] memberTypes = type.memberTypes;
      if (memberTypes != null)
      {
      ...
      final com.codenvy.ide.java.client.internal.compiler.ast.FieldDeclaration[] fields = type.fields;
      if (fields != null)
      {
      ...
      FileASTRequestor astRequestor, int apiLevel, Map compilerOptions, int flags)
   {
      ...
      try
      {
         ...
         com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit[] sourceUnits =
            new com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit[length];
         int count = 0;
         for (int i = 0; i < length; i++)
         {
            char[] contents = null;
            ...
            sourceUnits[count++] =
               new com.codenvy.ide.java.client.compiler.batch.CompilationUnit(contents, sourceUnitPath, encoding);
         }
         beginToCompile(sourceUnits, bindingKeys);
         // process all units (some more could be injected in the loop by the lookup environment)
         for (int i = 0; i < this.totalUnits; i++)
         {
            ...
            try
            {
               ...
               // requested AST
               char[] fileName = unit.compilationResult.getFileName();
               com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit source =
                  (com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit)this.requestedSources
                     .get(fileName);
               if (source != null)
               {
                  // convert AST
                  CompilationResult compilationResult = unit.compilationResult;
                  com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit =
      ...
      boolean verifyMethods, boolean analyzeCode, boolean generateCode)
   {
      ...
      try
      {
         ...
         if (unit == null)
         {
            ...
            beginToCompile(new com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit[]{sourceUnit});
            ...
            if (searchPosition >= 0 && searchPosition <= length)
            {
               ...
               if (node != null)
               {
                  ...
                  else if (enclosingTypeDeclaration != null)
                  {
                     if (node instanceof com.codenvy.ide.java.client.internal.compiler.ast.Initializer)
                     {
                        ((com.codenvy.ide.java.client.internal.compiler.ast.Initializer)node).parseStatements(
                           this.parser, enclosingTypeDeclaration, unit);
                     }
                     else if (node instanceof com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration)
                     {
                        ((com.codenvy.ide.java.client.internal.compiler.ast.TypeDeclaration)node).parseMethods(
                           this.parser, unit);
                     }
                  }
   ...
   public CompilationUnitDeclaration resolve(
      com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit, boolean verifyMethods,

...
public class UnionTypeReference extends TypeReference
{
   ...
   /* (non-Javadoc)
    * @see com.codenvy.ide.java.client.internal.compiler.ast.TypeReference#getTypeBinding(com.codenvy.ide.java.client.internal.compiler.lookup.Scope)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.codenvy.ide.java.client.internal.compiler.ast.TypeReference#traverse(com.codenvy.ide.java.client.internal.compiler.ASTVisitor, com.codenvy.ide.java.client.internal.compiler.lookup.BlockScope)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see com.codenvy.ide.java.client.internal.compiler.ast.TypeReference#traverse(com.codenvy.ide.java.client.internal.compiler.ASTVisitor, com.codenvy.ide.java.client.internal.compiler.lookup.ClassScope)
    */
   @Override

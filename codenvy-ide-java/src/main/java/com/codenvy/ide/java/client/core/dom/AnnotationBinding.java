...
class AnnotationBinding implements IAnnotationBinding {
    ...
    private com.codenvy.ide.java.client.internal.compiler.lookup.AnnotationBinding binding;

    private BindingResolver bindingResolver;

    private String key;

    AnnotationBinding(com.codenvy.ide.java.client.internal.compiler.lookup.AnnotationBinding annotation,

...
class MemberValuePairBinding implements IMemberValuePairBinding
{
   ...
   static Object buildDOMValue(final Object internalObject, BindingResolver resolver)
   {
      ...
      else if (internalObject instanceof com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding)
      {
         return resolver.getTypeBinding((com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding)internalObject);
      }
      else if (internalObject instanceof com.codenvy.ide.java.client.internal.compiler.lookup.AnnotationBinding)
      {
         return resolver
            .getAnnotationInstance((com.codenvy.ide.java.client.internal.compiler.lookup.AnnotationBinding)internalObject);
      }
      else if (internalObject instanceof com.codenvy.ide.java.client.internal.compiler.lookup.FieldBinding)
      {
         return resolver
            .getVariableBinding((com.codenvy.ide.java.client.internal.compiler.lookup.FieldBinding)internalObject);
      }

...
import com.codenvy.ide.java.client.core.ISourceRange;
import com.codenvy.ide.java.client.core.SourceRange;
...
import com.codenvy.ide.java.client.core.search.SearchEngine;
import com.codenvy.ide.java.client.core.search.TypeNameMatch;
import com.codenvy.ide.java.client.core.search.SearchEngine.SearchCallback;
import com.codenvy.ide.java.client.env.PackageFragment;
         ...
         else
         {
            ...
            for (int i = 0; i < nFound; i++)
            {
               ...
               else if (fOldDemandImports.contains(containerName) || fImplicitImports.contains(containerName))
               {
                  ...
                  { // more than one import-on-demand

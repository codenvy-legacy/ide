...
import com.codenvy.ide.java.client.internal.compiler.util.HashtableOfObjectToIntArray;
...
class ASTRecoveryPropagator extends DefaultASTVisitor
{
   ...
   HashtableOfObjectToIntArray endingTokens = new HashtableOfObjectToIntArray();
   {
      ...
      this.endingTokens.put(PrimitiveType.class, new int[]{TerminalTokens.TokenNamebyte, TerminalTokens.TokenNameshort,
         TerminalTokens.TokenNamechar, TerminalTokens.TokenNameint, TerminalTokens.TokenNamelong,
         TerminalTokens.TokenNamefloat, TerminalTokens.TokenNameboolean, TerminalTokens.TokenNamedouble,

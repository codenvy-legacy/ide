...
//      this.service = service;
     ...
     *         the classesFromProject to set
     */
    public void setClassesFromProject(List<Token> classesFromProject) {
        this.classesFromProject = classesFromProject;
    }
    ...
    private List<CodeLine> validateTokenJavaType(TokenBeenImpl currentToken, List<TokenBeenImpl> importStatementBlock) {
        ...
        if (javaType != null && !javaType.isEmpty() && !currentToken.getName().equals(javaType) // filter constructors
                ) {

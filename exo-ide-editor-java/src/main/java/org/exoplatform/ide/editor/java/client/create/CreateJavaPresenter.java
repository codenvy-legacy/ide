 ...
 *
 */
public class CreateJavaPresenter implements CreateJavaClassHandler, ViewClosedHandler, ItemsSelectedHandler,
   ProjectOpenedHandler, ProjectClosedHandler, EditorActiveFileChangedHandler
{
    ...
    * @param eventBus
    */
   public CreateJavaPresenter(HandlerManager eventBus, VirtualFileSystem vfs, IDE ide)
   {
      super();
      ...
      try
      {
         vfs.createFile(parentFolder, new AsyncRequestCallback<FileModel>(new FileUnmarshaller(newFile))
         {
            ...
            protected void onSuccess(FileModel result)
            {
               ...
               fileOpenedHandler = eventBus.addHandler(EditorActiveFileChangedEvent.TYPE, CreateJavaPresenter.this);

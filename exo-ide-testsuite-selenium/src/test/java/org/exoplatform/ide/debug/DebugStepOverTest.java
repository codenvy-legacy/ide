...
public class DebugStepOverTest extends DebuggerServices
{
   ...
   @Test
   public void bebugStepOverTest() throws Exception
   {
      ...
      IDE.DEBUGER.waitActiveBreackPointIsSet(25);
      IDE.DEBUGER.waitInVariableTabContainerWithSpecidiedValue("Hello, selenium!");
      IDE.DEBUGER.clickStepOverBtnClick();
      IDE.DEBUGER.waitActiveBreackPointIsSet(26);
      IDE.DEBUGER.clickOnDebugerTab();

      IDE.DEBUGER
         .waitInVariableTabContainerWithSpecidiedValue("instance of org.springframework.web.servlet.ModelAndView");
      ...
      new WebDriverWait(debuger_app_instance, 80).until(ExpectedConditions.visibilityOfElementLocated(By
         .xpath("//span[text()='" + "Hello, selenium!" + "']")));

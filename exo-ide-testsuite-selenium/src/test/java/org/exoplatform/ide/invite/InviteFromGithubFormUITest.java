...
public class InviteFromGithubFormUITest extends BaseTest
{
   ...
   public void allInviteUserCounterTest() throws Exception
   {
      ...
      IDE.INVITE_FORM.isInviteButtonDisabled();
      ...
      IDE.INVITE_FORM.isInviteButtonEnabled();

      //step 2 uncheck invite  btn and check states boxes and inv. developers button
      IDE.INVITE_FORM.clickInviteAll();
      IDE.INVITE_FORM.waitChekBoxUnchekedGithubForm("1");
      IDE.INVITE_FORM.waitChekBoxUnchekedGithubForm("2");
      IDE.INVITE_FORM.waitChekBoxUnchekedGithubForm("3");
      IDE.INVITE_FORM.isInviteButtonDisabled();
   }

...
import org.exoplatform.ide.debug.DebugChangeVariableTest;
...
@SuiteClasses({CopyFoldersAndFilesTest.class, CreatingAndSavingAsNewFileTest.class, JavaCodeAssistantTest.class,
   CodeOutLineJavaTest.class, GroovyTypeValidationAndFixingTest.class, RESTServiceDeployUndeployTest.class,
   BuildSuccessedTest.class, UploadingZippedFolderTest.class, DebugChangeVariableTest.class})

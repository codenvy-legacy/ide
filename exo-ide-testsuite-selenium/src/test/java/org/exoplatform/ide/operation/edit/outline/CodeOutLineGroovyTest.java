...
public class CodeOutLineGroovyTest extends BaseTest
{
   ...
   public void testCodeOutLineGroovy() throws Exception
   {
      ...
      outlineTreeHelper.addOutlineItem(1, "TestJSON", 6);
      outlineTreeHelper.addOutlineItem(2, "a1 : java.lang.A", 7);
      outlineTreeHelper.addOutlineItem(3, "a2 : java.lang.A", 7, false);
      outlineTreeHelper.addOutlineItem(4, "a3 : java.lang.A", 7, false);      
      outlineTreeHelper.addOutlineItem(5, "b1 : java.lang.B", 8);
      outlineTreeHelper.addOutlineItem(6, "b2 : java.lang.B", 8, false);
      outlineTreeHelper.addOutlineItem(7, "b3 : String", 8, false);
      outlineTreeHelper.addOutlineItem(8, "getValue1() : java.lang.String", 10); 
      outlineTreeHelper.addOutlineItem(9, "c1 : String", 11);
      outlineTreeHelper.addOutlineItem(10, "identity : Identity", 19);
      outlineTreeHelper.addOutlineItem(11, "c2 : String", 27);
      outlineTreeHelper.addOutlineItem(12, "d : java.lang.String", 31);      

      // TODO update content of node 
      outlineTreeHelper.addOutlineItem(13, "setValue2(@String) : void", 33);
      outlineTreeHelper.addOutlineItem(14, "printClosureInner", 35);
      outlineTreeHelper.addOutlineItem(15, "printClosureOuter", 40);      
      outlineTreeHelper.addOutlineItem(16, "hello()", 42);
      outlineTreeHelper.addOutlineItem(17, "name4 : String", 44);
      outlineTreeHelper.addOutlineItem(18, "g : String", 47);     

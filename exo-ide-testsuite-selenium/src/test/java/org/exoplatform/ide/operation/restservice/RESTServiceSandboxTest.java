...
public class RESTServiceSandboxTest extends BaseTest {
	...
	private static String FILE_NAME = RESTServiceSandboxTest.class
			.getSimpleName() + ".grs";

	private static String PROJECT = RESTServiceSandboxTest.class
			.getSimpleName();
	...
	/**
	 * Test deploy REST service to sandbox and undeploy from sandbox.
	 */
	@Test

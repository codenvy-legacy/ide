...
public class RESTServiceComplexMediaTypeTest extends BaseTest {
	...
	private final static String FOLDER_NAME = RESTServiceComplexMediaTypeTest.class
			.getSimpleName();
	...
	public void testComplexMediaType() throws Exception {
		...
		IDE.REST_SERVICE
				.selectPathSuggestPanelItem("/testMediaTypes/InnerPath");

		Thread.sleep(TestConstants.SLEEP_SHORT);
		assertEquals("POST", IDE.REST_SERVICE.getMethodFieldValue());

		IDE.REST_SERVICE.checkRequestFieldContainsValues("application/json",
				"text/plain");

		IDE.REST_SERVICE.setRequestMediaTypeFieldValue("text/plain");

		assertEquals("text/plain", IDE.REST_SERVICE
				.getResponseMediaTypeFieldValue());

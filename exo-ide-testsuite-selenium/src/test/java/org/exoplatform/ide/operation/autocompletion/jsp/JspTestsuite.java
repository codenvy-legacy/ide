...
/**
 * @author <a href="mailto:tnemov@gmail.com">Musienko Maksim</a>
 * @version $Id: $
 *
 */
@RunWith(Suite.class)
@SuiteClasses({AutoCompleteJspTest.class, JspImplicitObjectsTest.class, JspTagsTest.class})
public class JspTestsuite
{

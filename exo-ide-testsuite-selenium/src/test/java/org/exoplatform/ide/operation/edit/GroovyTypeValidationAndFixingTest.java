...
public class GroovyTypeValidationAndFixingTest extends BaseTest
{
   ...
   public void testServiceFile() throws Exception
   {
      ...
      IDE.ERROR_MARKS.selectIframeWitErrorMarks();
      IDE.ERROR_MARKS.waitLineNumberAppearance(43);
      IDE.ERROR_MARKS.waitErrorMarkerIsAppear(41);
      IDE.selectMainFrame();
      // test error marks after open test file
      firstTestErrorMarks();

      // step 2 click on mark in 16 string-position, fix error and check
      // changes
      IDE.ERROR_MARKS.selectIframeWitErrorMarks();
      ...
      assertTrue(IDE.EDITOR.getTextFromCodeEditor().startsWith(
      ...
      // add test text
      IDE.EDITOR.typeTextIntoEditor("Integer1 d \n" + "@POST \n"
   ...
   // IDE-499: "Recognize error "cannot resolve to a
   // type" within the Groovy Template file in the Code Editor."
   @Test
   public void testTemplateFile() throws Exception
   {
      ...
      assertTrue(IDE.EDITOR.getTextFromCodeEditor().startsWith("<%\n" + "  import java.util.prefs.Base64\n" + "%>\n"));
      IDE.ERROR_MARKS.selectIframeWitErrorMarks();
      IDE.ERROR_MARKS.waitErrorMarkerShow(12);
      IDE.ERROR_MARKS.waitErrorMarkerShow(13);
      IDE.ERROR_MARKS.waitErrorMarkerShow(9);
   }

   // --------------------------------------------------------------
   /**
    * check error-markers after first opening test groovy template file
    */
   private void checkErrorMarkerAfterFirsOpeningInGtmpl()
   {
      ...
      IDE.ERROR_MARKS.waitErrorMarkerShow(7);
      IDE.ERROR_MARKS.waitErrorMarkerShow(8);
      ...
      IDE.ERROR_MARKS.waitErrorMarkerShow(13);
      IDE.ERROR_MARKS.waitErrorMarkerShow(14);
      IDE.ERROR_MARKS.waitErrorMarkerShow(17);
      IDE.ERROR_MARKS.waitErrorMarkerShow(19);
      IDE.ERROR_MARKS.waitErrorMarkerShow(21);
      IDE.selectMainFrame();
   }
   ...
   {
      assertTrue(IDE.EDITOR.getTextFromCodeEditor().startsWith("import java.util.prefs.Base64\n"));
      IDE.ERROR_MARKS.selectIframeWitErrorMarks();
      IDE.ERROR_MARKS.waitErrorMarkerIsAppear(1);
      IDE.ERROR_MARKS.waitErrorMarkerShow(1);
      IDE.ERROR_MARKS.waitErrorMarkerIsAppear(2);
      IDE.ERROR_MARKS.waitErrorMarkerShow(2);
      IDE.ERROR_MARKS.waitErrorMarkerIsAppear(3);
      IDE.ERROR_MARKS.waitErrorMarkerShow(3);
      IDE.selectMainFrame();
   }
   ...
   /**
    * check position error markers after open of the test-file
    * 
   ...
   {
      IDE.ERROR_MARKS.selectIframeWitErrorMarks();
      IDE.ERROR_MARKS.waitErrorMarkerShow(4);
      IDE.ERROR_MARKS.waitErrorMarkerShow(6);
      IDE.ERROR_MARKS.waitErrorMarkerShow(7);
      IDE.ERROR_MARKS.waitErrorMarkerShow(8);
   ...
   private void testAfterFixFirstError() throws InterruptedException
   {
      ...
      IDE.ERROR_MARKS.waitErrorMarkerShow(18);
      IDE.ERROR_MARKS.waitErrorMarkerShow(18);
      IDE.ERROR_MARKS.waitErrorMarkerShow(37);
      IDE.ERROR_MARKS.waitErrorMarkerShow(40);
      IDE.ERROR_MARKS.waitErrorMarkerShow(42);
      IDE.selectMainFrame();
   }

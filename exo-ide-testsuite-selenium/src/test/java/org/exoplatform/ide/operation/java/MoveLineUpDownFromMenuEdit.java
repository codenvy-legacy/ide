...
public class MoveLineUpDownFromMenuEdit extends ServicesJavaTextFuction
{
   private static final String PROJECT = MoveLineUpDownFromMenuEdit.class.getSimpleName();

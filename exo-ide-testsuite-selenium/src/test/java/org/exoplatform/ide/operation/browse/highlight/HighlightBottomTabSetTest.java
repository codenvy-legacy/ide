...
public class HighlightBottomTabSetTest extends BaseTest {
	private static final String PROJECT = HighlightBottomTabSetTest.class
			.getSimpleName();

	private static String FOLDER_NAME = HighlightBottomTabSetTest.class
			.getSimpleName();
	...
	public void testHighlightBottopTabSet() throws Exception {
		...
		IDE.MENU.runCommand(MenuCommands.View.VIEW,
				MenuCommands.View.SHOW_PROPERTIES);

...
public class ShowHideHiddenFilesTest extends BaseTest
{
   ...
   public void showHideHiddenFilesTest() throws Exception
   {
      ...
      IDE.MENU.waitCommandVisible(MenuCommands.View.VIEW, MenuCommands.View.SHOW_HIDDEN_FILES);
      ...
      IDE.PROJECT.EXPLORER.waitItemNotPresent(PROJECT + "/" + HIDDEN_FILE_NAME);
      IDE.LOADER.waitClosed();
      // show hidden files
      ...
      IDE.PROJECT.EXPLORER.waitItemPresent(PROJECT + "/" + HIDDEN_FILE_NAME);

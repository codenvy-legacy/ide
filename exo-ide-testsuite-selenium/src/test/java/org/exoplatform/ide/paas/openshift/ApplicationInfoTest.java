...
public class ApplicationInfoTest extends BaseTest
{
   ...
   public void testCreateApplicationAndGetItInfo() throws Exception
   {
      ...
      assertEquals("http://appinfotest-domain1.rhcloud.com/", IDE.OPENSHIFT.APPLICATION_INFO.getTextFromAppInfoTable(3, 2));
      
      assertEquals("Git URL", IDE.OPENSHIFT.APPLICATION_INFO.getTextFromAppInfoTable(4, 1));
      assertEquals("ssh://04fc0584021b4a9da8d95cd6383b12e4@appinfotest-domain1.rhcloud.com/~/git/appinfotest.git/", IDE.OPENSHIFT.APPLICATION_INFO.getTextFromAppInfoTable(4, 2));

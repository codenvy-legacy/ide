...
public class UpdateInstancesTest extends CloudFoundryTest
{

   private static final String TEST_FOLDER = "cloudfoundry-test-update-instances-" + System.currentTimeMillis();
   ...
   public void testUpdateInstances() throws Exception
   {
      ...
      */
      ...
      IDE.ASK_FOR_VALUE_DIALOG.setValue("5");

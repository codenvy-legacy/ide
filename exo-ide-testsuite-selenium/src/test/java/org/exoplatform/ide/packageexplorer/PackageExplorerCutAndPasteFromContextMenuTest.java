...
public class PackageExplorerCutAndPasteFromContextMenuTest extends BaseTest
{
   ...
   public void cutFileFromContextMenuTest() throws Exception
   {
      ...
      IDE.PROJECT.PACKAGE_EXPLORER.openItemWithDoubleClick(FOLDER_NAME);
   ...
   public void cutPackageFromContextMenuTest() throws Exception
   {
      ...
      cut();
      IDE.PROJECT.PACKAGE_EXPLORER.openItemWithDoubleClick(SOURCE_FOLDER_NAME);
      IDE.PROJECT.PACKAGE_EXPLORER.openContextMenuOnSelectedItemInPackageExplorer("src");
      IDE.PROJECT.PACKAGE_EXPLORER.waitElementInContextMenuEnabled(MenuCommands.Edit.PASTE_MENU);
      IDE.PROJECT.PACKAGE_EXPLORER.clickOnItemInContextMenu(MenuCommands.Edit.PASTE_MENU);
      IDE.LOADER.waitClosed();
   ...
   public void cutReferencedLibrariesFromContextMenuTest() throws Exception
   {
      ...
      IDE.PROJECT.PACKAGE_EXPLORER.waitElementInContextMenuDisabled(MenuCommands.Edit.CUT_MENU);
   ...
   */
   ...
   {
      IDE.PROJECT.PACKAGE_EXPLORER.waitElementInContextMenuEnabled(MenuCommands.Edit.CUT_MENU);
      IDE.PROJECT.PACKAGE_EXPLORER.clickOnItemInContextMenu(MenuCommands.Edit.CUT_MENU);
      IDE.LOADER.waitClosed();

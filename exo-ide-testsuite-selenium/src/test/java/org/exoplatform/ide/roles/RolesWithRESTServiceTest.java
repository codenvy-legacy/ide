...
public class RolesWithRESTServiceTest extends BaseTest
{
   ...
   /**
    * Tests allowed commands for work with REST services if user has
    * "developers" role.
    * 
    * @throws Exception
    */
   ...
   public void testDeveloperRoleWithRESTService() throws Exception
   {
      ...
      IDE.TOOLBAR.waitForButtonEnabled(ToolbarCommands.Run.DEPLOY_GROOVY_SERVICE);
      ...
      IDE.TOOLBAR.waitForButtonEnabled(ToolbarCommands.Run.DEPLOY_GROOVY_SERVICE);
      IDE.TOOLBAR.waitForButtonEnabled(ToolbarCommands.Run.UNDEPLOY_GROOVY_SERVICE);
      ...
      IDE.TOOLBAR.waitForButtonEnabled(ToolbarCommands.Run.SET_AUTOLOAD);

      // Check Sandbox
      IDE.MENU.waitCommandEnabled(MenuCommands.Run.RUN, MenuCommands.Run.DEPLOY_SANDBOX);
      IDE.MENU.waitCommandEnabled(MenuCommands.Run.RUN, MenuCommands.Run.UNDEPLOY_SANDBOX);
      IDE.TOOLBAR.waitForButtonEnabled(ToolbarCommands.Run.DEPLOY_SANDBOX);
      IDE.TOOLBAR.waitForButtonEnabled(ToolbarCommands.Run.UNDEPLOY_SANDBOX);
      ...
      IDE.TOOLBAR.waitButtonPresentAtRight(ToolbarCommands.Run.VALIDATE_GROOVY_SERVICE);
      IDE.MENU.waitCommandEnabled(MenuCommands.Run.RUN, MenuCommands.Run.VALIDATE);
      IDE.TOOLBAR.waitForButtonEnabled(ToolbarCommands.Run.VALIDATE_GROOVY_SERVICE);
      ...
      // assertFalse(IDE.MENU.isCommandVisible(MenuCommands.Run.RUN,
      // MenuCommands.Run.DEPLOY_REST_SERVICE));
      // assertFalse(IDE.MENU.isCommandVisible(MenuCommands.Run.RUN,
      // MenuCommands.Run.UNDEPLOY_REST_SERVICE));
      // // Check run service is allowed for developer
      // assertTrue(IDE.MENU.isCommandEnabled(MenuCommands.Run.RUN,
      // MenuCommands.Run.RUN_GROOVY_SERVICE));
      ...
      // assertFalse(IDE.MENU.isCommandVisible(MenuCommands.Run.RUN,
      // MenuCommands.Run.SET_AUTOLOAD));
      // //Check deploy/undeploy in sandbox is available for developer
      // assertTrue(IDE.MENU.isCommandEnabled(MenuCommands.Run.RUN,
      // MenuCommands.Run.DEPLOY_SANDBOX));
      // assertTrue(IDE.MENU.isCommandEnabled(MenuCommands.Run.RUN,
      // MenuCommands.Run.UNDEPLOY_SANDBOX));
      ...
      // assertFalse(IDE.MENU.isCommandVisible(MenuCommands.Run.RUN,
      // MenuCommands.Run.LAUNCH_REST_SERVICE));

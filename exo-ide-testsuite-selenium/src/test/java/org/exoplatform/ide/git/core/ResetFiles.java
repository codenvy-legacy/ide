...
public class ResetFiles extends AbstractTestModule
{
   ...
   @FindBy(id = Locators.RESET_BUTTON_ID)
   ...
   {
      return (view != null && view.isDisplayed() && filesGrid != null && filesGrid.isDisplayed() && resetButton != null
         && resetButton.isDisplayed() && cancelButton != null && cancelButton.isDisplayed());
   }

 ...
 *
 */
public class CloudHerokuTest_
{
   
   public static final ResourceBundle TEST_SETTINGS = ResourceBundle.getBundle("test");
   
   public static final String SELENIUM_HOST = TEST_SETTINGS.getString("");

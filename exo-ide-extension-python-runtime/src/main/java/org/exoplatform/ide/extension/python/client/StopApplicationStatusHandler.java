...
public class StopApplicationStatusHandler implements RequestStatusHandler {
    ...
    public void requestInProgress(String id) {
        ...
        job.setStartMessage(PythonRuntimeExtension.PYTHON_LOCALIZATION.stoppingProjectMessage(projectName));
    ...
    public void requestFinished(String id) {
        ...
        job.setFinishMessage(PythonRuntimeExtension.PYTHON_LOCALIZATION.projectStoppedMessage(projectName));
        IDE.fireEvent(new JobChangeEvent(job));
    }

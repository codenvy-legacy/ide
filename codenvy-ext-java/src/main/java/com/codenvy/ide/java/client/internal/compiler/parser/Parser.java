...
import com.codenvy.ide.java.client.core.util.JSONUtil;
...
import com.codenvy.ide.java.client.internal.compiler.parser.diagnose.DiagnoseParser;
    ...
    */
    ...
    protected void reportSyntaxErrors(boolean isDietParse, int oldFirstToken) {
        ...
        if (isDietParse) {
            ...
            int[][] intervalToSkip =
                    com.codenvy.ide.java.client.internal.compiler.parser.diagnose.RangeUtil.computeDietRange(types);

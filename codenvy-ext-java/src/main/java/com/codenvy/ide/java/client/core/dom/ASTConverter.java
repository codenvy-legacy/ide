...
import com.codenvy.ide.java.client.internal.compiler.ast.*;
...
class ASTConverter {
            ...
            if (block != null && (statements != null || explicitConstructorCall != null)) {
                if (explicitConstructorCall != null
                    && explicitConstructorCall.accessMode !=
                       com.codenvy.ide.java.client.internal.compiler.ast.ExplicitConstructorCall.ImplicitSuper) {
    ...
    public Expression convert(com.codenvy.ide.java.client.internal.compiler.ast.AND_AND_Expression expression) {
        ...
        final int expressionOperatorID =
                (expression.bits & com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >>
                com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT;
        if (expression.left instanceof com.codenvy.ide.java.client.internal.compiler.ast.BinaryExpression
            ...
            do {
                ...
                if ((((leftOperand.bits & com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >>
                      com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID &&
                     ((leftOperand.bits & com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))
                    || ((rightOperand instanceof com.codenvy.ide.java.client.internal.compiler.ast.BinaryExpression &&
                         ((rightOperand.bits & com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >>
                          com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID) &&
                        ((rightOperand.bits & com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))) {
        ...
        for (int i = 0; i < nodesLength; i++) {
            ...
            if (node instanceof com.codenvy.ide.java.client.internal.compiler.ast.Initializer) {
                ...
                if (i > 0
                    ...
                    && ((com.codenvy.ide.java.client.internal.compiler.ast.FieldDeclaration)nodes[i - 1]).declarationSourceStart ==
    ...
    public Expression convert(com.codenvy.ide.java.client.internal.compiler.ast.EqualExpression expression) {
        ...
        int startPosition = leftExpression.getStartPosition();
        infixExpression.setSourceRange(startPosition, expression.sourceEnd - startPosition + 1);
        switch ((expression.bits & com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >>
                com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT) {
        ...
        if (initializations != null) {
            ...
            if (initializations[0] instanceof com.codenvy.ide.java.client.internal.compiler.ast.LocalDeclaration) {
                ...
                if (initializationsLength != 1) {
                    ...
                    int end =
                            ((com.codenvy.ide.java.client.internal.compiler.ast.LocalDeclaration)initializations[initializationsLength -
    ...
    public ParenthesizedExpression convertToParenthesizedExpression(
        ...
        int numberOfParenthesis =
                ...
                com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
        expression.bits &= ~com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK;
        expression.bits |=

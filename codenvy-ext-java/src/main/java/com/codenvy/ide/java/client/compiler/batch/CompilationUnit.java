 ...
 */
package com.codenvy.ide.java.client.compiler.batch;
...
public class CompilationUnit implements ICompilationUnit {
    ...
    /** @see com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit#getContents() */
    @Override
    public char[] getContents() {
        return contents;
    }

    /** @see com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit#getMainTypeName() */
    @Override
    public char[] getMainTypeName() {
        return mainTypeName;
    }

    /** @see com.codenvy.ide.java.client.internal.compiler.env.ICompilationUnit#getPackageName() */
    @Override

 ...
 *******************************************************************************/
package com.codenvy.ide.ext.java.client.internal.text.correction;

import com.codenvy.ide.ext.java.client.JavaClientBundle;
import com.codenvy.ide.ext.java.client.JavaPreferencesSettings;
...
import com.codenvy.ide.ext.java.client.core.dom.rewrite.ImportRewrite;
import com.codenvy.ide.ext.java.client.core.dom.rewrite.ListRewrite;
import com.codenvy.ide.ext.java.client.core.dom.rewrite.ImportRewrite.ImportRewriteContext;
import com.codenvy.ide.ext.java.client.internal.corext.codemanipulation.*;
import com.codenvy.ide.ext.java.client.internal.corext.dom.*;
import com.codenvy.ide.ext.java.client.internal.corext.fix.*;
import com.codenvy.ide.ext.java.client.internal.corext.refactoring.code.CompilationUnitChange;
import com.codenvy.ide.ext.java.client.internal.corext.refactoring.code.Invocations;
import com.codenvy.ide.ext.java.client.internal.corext.refactoring.sorround.ExceptionAnalyzer;
import com.codenvy.ide.ext.java.client.internal.corext.refactoring.sorround.SurroundWithTryCatchRefactoring;
import com.codenvy.ide.ext.java.client.internal.corext.refactoring.util.NoCommentSourceRangeComputer;
import com.codenvy.ide.ext.java.client.internal.corext.refactoring.util.TightSourceRangeComputer;
import com.codenvy.ide.ext.java.client.internal.text.correction.proposals.*;
import com.codenvy.ide.ext.java.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.ChangeDescription;
import com.codenvy.ide.ext.java.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.InsertDescription;
import com.codenvy.ide.ext.java.client.internal.text.correction.proposals.ChangeMethodSignatureProposal.RemoveDescription;

...
public class DefaultProblem extends CategorizedProblem {
    ...
    /** @see com.codenvy.ide.ext.java.worker.core.compiler.CategorizedProblem#getCategoryID() */
     ...
     *
     * @return int
     * @see com.codenvy.ide.ext.java.worker.core.compiler.IProblem#getID()
     */
    public int getID() {
        return this.id;
    }
     ...
     *
     * @see com.codenvy.ide.ext.java.worker.core.compiler.CategorizedProblem#getMarkerType()
     */

...
public abstract class OperatorExpression extends Expression implements OperatorIds {
    ...
    public static final String generateTableTestCase() {
      ...
      /*
      com.codenvy.ide.java.client.internal.compiler.ast.
      ...
      */
        ...
        s = "\tpublic static void binaryOperationTablesTestCase(){\n" + //$NON-NLS-1$
            ...
            "\t\t//com.codenvy.ide.java.client.internal.compiler.ast.OperatorExpression.generateTableTestCase();\n" + //$NON-NLS-1$
    ...
    public static final int[] get_MINUS() {
        ...
        int[] table = com.codenvy.ide.ext.java.worker.internal.core.util.Util.clone(get_PLUS());

...
package com.codenvy.ide.ext.java.client.internal.corext.dom;

import com.codenvy.ide.ext.java.client.core.dom.ASTNode;
import com.codenvy.ide.ext.java.client.core.dom.ArrayAccess;
import com.codenvy.ide.ext.java.client.core.dom.AssertStatement;
import com.codenvy.ide.ext.java.client.core.dom.ChildListPropertyDescriptor;
import com.codenvy.ide.ext.java.client.core.dom.ConditionalExpression;
import com.codenvy.ide.ext.java.client.core.dom.DoStatement;
import com.codenvy.ide.ext.java.client.core.dom.EnhancedForStatement;
import com.codenvy.ide.ext.java.client.core.dom.Expression;
import com.codenvy.ide.ext.java.client.core.dom.ForStatement;
import com.codenvy.ide.ext.java.client.core.dom.ITypeBinding;
import com.codenvy.ide.ext.java.client.core.dom.IfStatement;
import com.codenvy.ide.ext.java.client.core.dom.InfixExpression;
import com.codenvy.ide.ext.java.client.core.dom.ParenthesizedExpression;
import com.codenvy.ide.ext.java.client.core.dom.ReturnStatement;
import com.codenvy.ide.ext.java.client.core.dom.SingleVariableDeclaration;
import com.codenvy.ide.ext.java.client.core.dom.StructuralPropertyDescriptor;
import com.codenvy.ide.ext.java.client.core.dom.SwitchCase;
import com.codenvy.ide.ext.java.client.core.dom.SwitchStatement;
import com.codenvy.ide.ext.java.client.core.dom.SynchronizedStatement;
import com.codenvy.ide.ext.java.client.core.dom.ThrowStatement;
import com.codenvy.ide.ext.java.client.core.dom.VariableDeclarationFragment;
import com.codenvy.ide.ext.java.client.core.dom.WhileStatement;

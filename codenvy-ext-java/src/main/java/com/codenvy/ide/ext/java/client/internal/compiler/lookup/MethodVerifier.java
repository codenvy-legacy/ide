...
import com.codenvy.ide.ext.java.client.internal.compiler.util.SimpleSet;
...
public class MethodVerifier {
    ...
    boolean couldMethodOverride(MethodBinding method, MethodBinding inheritedMethod) {
        if (!com.codenvy.ide.ext.java.client.core.compiler.CharOperation.equals(method.selector, inheritedMethod.selector))
            return false;
    ...
    public boolean isMethodSubsignature(MethodBinding method, MethodBinding inheritedMethod) {
        return com.codenvy.ide.ext.java.client.core.compiler.CharOperation.equals(method.selector, inheritedMethod.selector)

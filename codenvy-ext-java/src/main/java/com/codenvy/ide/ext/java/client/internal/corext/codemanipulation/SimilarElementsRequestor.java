...
import com.codenvy.ide.ext.java.client.core.dom.Javadoc;
...
import com.codenvy.ide.ext.java.client.internal.text.correction.NameMatcher;
...
public class SimilarElementsRequestor extends CompletionRequestor {
    ...
    public static SimilarElement[] findSimilarElement(Document document,
                                                      com.codenvy.ide.ext.java.client.core.dom.CompilationUnit compilationUnit, Name name,
                                                      int kind) {
    ...
    private SimilarElement[] process(int pos, Document document,
                                     com.codenvy.ide.ext.java.client.core.dom.CompilationUnit compilationUnit) {
        try {

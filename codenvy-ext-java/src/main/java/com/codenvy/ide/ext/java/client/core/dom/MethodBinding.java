...
import com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding;
...
class MethodBinding implements IMethodBinding {
    ...
    private com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding binding;
    ...
    MethodBinding(BindingResolver resolver, com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding binding) {
    ...
    public IAnnotationBinding[] getParameterAnnotations(int index) {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations =
        ...
        for (int i = 0; i < length; i++) {
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations =
    ...
    public ITypeBinding[] getParameterTypes() {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding[] parameters = this.binding.parameters;
    ...
    public ITypeBinding[] getExceptionTypes() {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding[] exceptions = this.binding.thrownExceptions;
    ...
    /**
     * @see com.codenvy.ide.ext.java.client.core.dom.IMethodBinding#isVarargs()
     * @since 3.1
     */
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding otherBinding = ((MethodBinding)other).binding;
        return BindingComparator.isEqual(this.binding, otherBinding);
    }

    /** @see com.codenvy.ide.ext.java.client.core.dom.IMethodBinding#getTypeParameters() */
    ...
    /**
     * @see com.codenvy.ide.ext.java.client.core.dom.IMethodBinding#isGenericMethod()
     * @since 3.1
     */
    ...
    /** @see com.codenvy.ide.ext.java.client.core.dom.IMethodBinding#getTypeArguments() */
    public ITypeBinding[] getTypeArguments() {
        ...
        if (this.binding instanceof ParameterizedGenericMethodBinding) {
            ...
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding[] typeArgumentsBindings =
    ...
    /** @see com.codenvy.ide.ext.java.client.core.dom.IMethodBinding#isParameterizedMethod() */
    public boolean isParameterizedMethod() {
        return (this.binding instanceof ParameterizedGenericMethodBinding)
               && !((ParameterizedGenericMethodBinding)this.binding).isRaw;
    }

    /** @see com.codenvy.ide.ext.java.client.core.dom.IMethodBinding#isRawMethod() */
    ...
    /** @see com.codenvy.ide.ext.java.client.core.dom.IMethodBinding#getMethodDeclaration() */

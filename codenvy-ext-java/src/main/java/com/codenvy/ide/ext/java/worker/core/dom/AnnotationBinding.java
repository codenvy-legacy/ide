...
import com.codenvy.ide.ext.java.worker.internal.compiler.lookup.TagBits;
...
class AnnotationBinding implements IAnnotationBinding {
    ...
    private com.codenvy.ide.ext.java.worker.internal.compiler.lookup.AnnotationBinding binding;

    private BindingResolver bindingResolver;

    private String key;

    AnnotationBinding(com.codenvy.ide.ext.java.worker.internal.compiler.lookup.AnnotationBinding annotation,

        ...
        switch (this.astKind) {
            ...
            case K_COMPILATION_UNIT:
                ...
                try {
                    ...
                    com.codenvy.ide.ext.java.jdt.internal.compiler.env.ICompilationUnit sourceUnit = null;
                    if (this.rawSource != null) {
    ...
    private ASTNode internalCreateASTForKind() {
        ...
        switch (this.astKind) {
            case K_STATEMENTS:
                ...
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
                if (statements != null) {
            ...
            case K_CLASS_BODY_DECLARATIONS:
                final com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode[] nodes =

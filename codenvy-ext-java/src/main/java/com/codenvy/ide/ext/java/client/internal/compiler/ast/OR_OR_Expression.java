...
public class OR_OR_Expression extends BinaryExpression {
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.ast.BinaryExpression#resolveType(com.codenvy.ide.ext.java.client.internal.compiler.lookup.BlockScope) */

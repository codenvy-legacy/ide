...
/**
 * The wizard page for creating a Spring project from a project template.
 *
...
public class CreateAntSpringProjectPage extends AbstractTemplatePage {
    ...
    /** Create page. */
    @Inject
    public CreateAntSpringProjectPage(CreateProjectClientService createProjectClientService,
    ...
    public void commit(final CommitCallback callback) {
        ...
        try {
            createProjectClientService.createProject(projectName, springDescriptor, attributes, new AsyncRequestCallback<Void>() {
                @Override
    ...
    private void unzipTemplate(final String projectName, final CommitCallback callback) {
        try {
            unzipTemplateClientService.unzipAntSpringTemplate(projectName, new AsyncRequestCallback<Void>() {
                @Override
                protected void onSuccess(Void result) {
                    resourceProvider.getProject(projectName, new AsyncCallback<Project>() {
                        @Override

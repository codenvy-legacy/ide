...
public class MethodBinding extends Binding {
            ...
            if (var.boundsCount() <= 1) {
                ...
                arguments[i] =
                        env.createWildcard(null, 0, rawFirstBound, rawOtherBounds,
                                           com.codenvy.ide.ext.java.client.internal.compiler.ast.Wildcard.EXTENDS);
            }
        }
    ...
    */
     ...
     *
     * @see com.codenvy.ide.ext.java.client.internal.compiler.lookup.Binding#getAnnotationTagBits()
     */

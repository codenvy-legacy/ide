...
import com.codenvy.ide.ext.java.client.internal.compiler.lookup.FieldBinding;
...
public class Initializer extends FieldDeclaration {
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.ast.AbstractVariableDeclaration#getKind() */
    @Override
    public int getKind() {
        return INITIALIZER;
    }

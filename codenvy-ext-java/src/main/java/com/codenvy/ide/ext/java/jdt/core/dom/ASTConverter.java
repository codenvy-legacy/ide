...
class ASTConverter {
    ...
    protected void buildBodyDeclarations(
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] members = typeDeclaration.memberTypes;
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration[] fields = typeDeclaration.fields;
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods =
        ...
        while ((fieldsIndex < fieldsLength) || (membersIndex < membersLength) || (methodsIndex < methodsLength)) {
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration nextFieldDeclaration = null;
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration nextMethodDeclaration = null;
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = null;
    ...
    protected void buildBodyDeclarations(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration enumDeclaration2,
            EnumDeclaration enumDeclaration) {
        // add body declaration in the lexical order
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] members = enumDeclaration2.memberTypes;
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration[] fields = enumDeclaration2.fields;
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods =
    ...
    protected void buildBodyDeclarations(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration expression,
            AnonymousClassDeclaration anonymousClassDeclaration) {
        // add body declaration in the lexical order
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] members = expression.memberTypes;
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration[] fields = expression.fields;
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration[] methods = expression.methods;
    ...
    protected void checkAndAddMultipleFieldDeclaration(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration[] fields, int index, List bodyDeclarations) {
        if (fields[index] instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Initializer) {
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Initializer oldInitializer =
                    (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Initializer)fields[index];
    ...
    protected void checkAndAddMultipleLocalDeclaration(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement[] stmts, int index, List blockStatements) {
        if (index > 0
            && stmts[index - 1] instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration) {
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration local1 =
                    (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)stmts[index - 1];
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration local2 =
                    (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)stmts[index];
    ...
    public ASTNode convert(boolean isInterface,
                           com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration methodDeclaration) {
        if (methodDeclaration instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AnnotationMethodDeclaration) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AnnotationMethodDeclaration)methodDeclaration);
        }
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference[] thrownExceptions =
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Argument[] parameters = methodDeclaration.arguments;
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall explicitConstructorCall = null;
        if (isConstructor) {
            if (isInterface) {
                // interface cannot have a constructor
                methodDecl.setFlags(methodDecl.getFlags() | ASTNode.MALFORMED);
            }
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ConstructorDeclaration constructorDeclaration =
                    (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ConstructorDeclaration)methodDeclaration;
        ...
        } else if (methodDeclaration instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MethodDeclaration) {
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MethodDeclaration method =
                    (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MethodDeclaration)methodDeclaration;
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeReference = method.returnType;
        ...
        if (closingPosition != -1) {
            ...
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement[] statements = methodDeclaration.statements;
            ...
            if (block != null && (statements != null || explicitConstructorCall != null)) {
                if (explicitConstructorCall != null
                    && explicitConstructorCall.accessMode !=
                       com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall.ImplicitSuper) {
                    block.statements().add(convert(explicitConstructorCall));
                }
                int statementsLength = statements == null ? 0 : statements.length;
                for (int i = 0; i < statementsLength; i++) {
                    if (statements[i] instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeParameter[] typeParameters =
    ...
    public ClassInstanceCreation convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AllocationExpression expression) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression[] arguments = expression.arguments;
        if (arguments != null) {
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AND_AND_Expression expression) {
        ...
        final int expressionOperatorID =
                (expression.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT;
        if (expression.left instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression
            && ((expression.left.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)) {
            ...
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression leftOperand = expression.left;
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression rightOperand = null;
            do {
                rightOperand = ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression)leftOperand).right;
                if ((((leftOperand.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                      com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID &&
                     ((leftOperand.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))
                    || ((rightOperand instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression &&
                         ((rightOperand.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                          com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID) &&
                        ((rightOperand.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))) {
                ...
                leftOperand = ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression)leftOperand).left;
            }
            while (leftOperand instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression
                   && ((leftOperand.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0));
    ...
    public ASTNode convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AnnotationMethodDeclaration annotationTypeMemberDeclaration) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeReference =
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression memberValue =
    ...
    public SingleVariableDeclaration convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Argument argument) {
    ...
    public Annotation convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation annotation) {
        if (annotation instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SingleMemberAnnotation) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SingleMemberAnnotation)annotation);
        } else if (annotation instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MarkerAnnotation) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MarkerAnnotation)annotation);
        } else {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.NormalAnnotation)annotation);
        }
    }

    public ArrayCreation convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayAllocationExpression expression) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression[] dimensions = expression.dimensions;
    ...
    public ArrayInitializer convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayInitializer expression) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression[] expressions = expression.expressions;
        if (expressions != null) {
    ...
    public ArrayAccess convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayReference reference) {
    ...
    public AssertStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AssertStatement statement) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression exceptionArgument = statement.exceptionArgument;
    ...
    public Assignment convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Assignment expression) {
    ...
    public TypeDeclaration convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode[] nodes) {
        final TypeDeclaration typeDecl = new TypeDeclaration(this.ast);
        typeDecl.setInterface(false);
        int nodesLength = nodes.length;
        for (int i = 0; i < nodesLength; i++) {
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode node = nodes[i];
            if (node instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Initializer) {
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Initializer oldInitializer =
                        (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Initializer)node;
                Initializer initializer = new Initializer(this.ast);
                initializer.setBody(convert(oldInitializer.block));
                setModifiers(initializer, oldInitializer);
                initializer.setSourceRange(oldInitializer.declarationSourceStart, oldInitializer.sourceEnd
                ...
                if (i > 0
                    && (nodes[i - 1] instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration)
                    && ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration)nodes[i - 1]).declarationSourceStart ==
            ...
            } else if (node instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AbstractMethodDeclaration) {
                ...
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration nextMemberDeclaration =
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression expression) {
        InfixExpression infixExpression = new InfixExpression(this.ast);
        if (this.resolveBindings) {
            this.recordNodes(infixExpression, expression);
        }
        ...
        if (expression.left instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression
            ...
            final com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression[] stringLiterals = literal.literals;
    ...
    public Block convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Block statement) {
        Block block = new Block(this.ast);
        if (statement.sourceEnd > 0) {
            block.setSourceRange(statement.sourceStart, statement.sourceEnd - statement.sourceStart + 1);
        }
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement[] statements = statement.statements;
        if (statements != null) {
    ...
    public BreakStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BreakStatement statement) {
    ...
    public SwitchCase convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CaseStatement statement) {
        SwitchCase switchCase = new SwitchCase(this.ast);
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression constantExpression =
    ...
    public CastExpression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CastExpression expression) {
    ...
    public CharacterLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CharLiteral expression) {
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ClassLiteralAccess expression) {
    ...
    public CompilationUnit convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CompilationUnitDeclaration unit, char[] source) {
        try {
            ...
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ImportReference[] imports = unit.imports;
            if (imports != null) {
            ...
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration[] types = unit.types;
            if (types != null) {
                int typesLength = types.length;
                for (int i = 0; i < typesLength; i++) {
                    com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration declaration = types[i];
    ...
    public Assignment convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CompoundAssignment expression) {
        Assignment assignment = new Assignment(this.ast);
        Expression lhs = convert(expression.lhs);
        assignment.setLeftHandSide(lhs);
        int start = lhs.getStartPosition();
        ...
        switch (expression.operator) {
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.PLUS:
                assignment.setOperator(Assignment.Operator.PLUS_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.MINUS:
                assignment.setOperator(Assignment.Operator.MINUS_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.MULTIPLY:
                assignment.setOperator(Assignment.Operator.TIMES_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.DIVIDE:
                assignment.setOperator(Assignment.Operator.DIVIDE_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.AND:
                assignment.setOperator(Assignment.Operator.BIT_AND_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.OR:
                assignment.setOperator(Assignment.Operator.BIT_OR_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.XOR:
                assignment.setOperator(Assignment.Operator.BIT_XOR_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.REMAINDER:
                assignment.setOperator(Assignment.Operator.REMAINDER_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.LEFT_SHIFT:
                assignment.setOperator(Assignment.Operator.LEFT_SHIFT_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.RIGHT_SHIFT:
                assignment.setOperator(Assignment.Operator.RIGHT_SHIFT_SIGNED_ASSIGN);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.UNSIGNED_RIGHT_SHIFT:
    ...
    public ConditionalExpression convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ConditionalExpression expression) {
    ...
    public ContinueStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ContinueStatement statement) {
    ...
    public DoStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.DoStatement statement) {
    ...
    public NumberLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.DoubleLiteral expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
    ...
    public EmptyStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.EmptyStatement statement) {
    ...
    public EnumConstantDeclaration convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration enumConstant) {
        ...
        final com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression initialization =
                enumConstant.initialization;
        if (initialization != null) {
            if (initialization instanceof QualifiedAllocationExpression) {
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration anonymousType =
            ...
            final com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression[] arguments =
                    ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AllocationExpression)initialization).arguments;
            if (arguments != null) {
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.EqualExpression expression) {
        InfixExpression infixExpression = new InfixExpression(this.ast);
        if (this.resolveBindings) {
        ...
        int startPosition = leftExpression.getStartPosition();
        infixExpression.setSourceRange(startPosition, expression.sourceEnd - startPosition + 1);
        switch ((expression.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorSHIFT) {
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.EQUAL_EQUAL:
                infixExpression.setOperator(InfixExpression.Operator.EQUALS);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.NOT_EQUAL:
    ...
    public Statement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall statement) {
        ...
        if (statement.isSuperAccess() || statement.isSuper()) {
            ...
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression[] arguments = statement.arguments;
            if (arguments != null) {
                int length = arguments.length;
                for (int i = 0; i < length; i++) {
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression expression) {
        if ((expression.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0) {
            return convertToParenthesizedExpression(expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CastExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CastExpression)expression);
        }
        // switch between all types of expression
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayAllocationExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayAllocationExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedAllocationExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedAllocationExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AllocationExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AllocationExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayInitializer) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayInitializer)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.PrefixExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.PrefixExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.PostfixExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.PostfixExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CompoundAssignment) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CompoundAssignment)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Assignment) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Assignment)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ClassLiteralAccess) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ClassLiteralAccess)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FalseLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FalseLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TrueLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TrueLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.NullLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.NullLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CharLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CharLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.DoubleLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.DoubleLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FloatLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FloatLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IntLiteralMinValue) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IntLiteralMinValue)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IntLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IntLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LongLiteralMinValue) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LongLiteralMinValue)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LongLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LongLiteral)expression);
        }
        if (expression instanceof StringLiteralConcatenation) {
            return convert((StringLiteralConcatenation)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ExtendedStringLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ExtendedStringLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.StringLiteral) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.StringLiteral)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AND_AND_Expression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AND_AND_Expression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OR_OR_Expression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OR_OR_Expression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.EqualExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.EqualExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BinaryExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.InstanceOfExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.InstanceOfExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.UnaryExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.UnaryExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ConditionalExpression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ConditionalExpression)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MessageSend) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MessageSend)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Reference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Reference)expression);
        }
        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference)expression);
        }
        return null;
    }

    public StringLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ExtendedStringLiteral expression) {
    ...
    public BooleanLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FalseLiteral expression) {
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldReference reference) {
        if (reference.receiver.isSuper()) {
            ...
            if (reference.receiver instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference) {
                Name qualifier =
                        convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference)reference.receiver);
    ...
    public NumberLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FloatLiteral expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
        NumberLiteral literal = new NumberLiteral(this.ast);
        literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
    ...
    public Statement convert(ForeachStatement statement) {
        switch (this.ast.apiLevel) {
            ...
            default:
                ...
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression collection = statement.collection;
                if (collection == null)
                    return null;
    ...
    public ForStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ForStatement statement) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement[] initializations = statement.initializations;
        if (initializations != null) {
            // we know that we have at least one initialization
            if (initializations[0] instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration) {
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration initialization =
                        (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)initializations[0];
                VariableDeclarationExpression variableDeclarationExpression =
                        convertToVariableDeclarationExpression(initialization);
                int initializationsLength = initializations.length;
                for (int i = 1; i < initializationsLength; i++) {
                    initialization =
                            (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)initializations[i];
                ...
                if (initializationsLength != 1) {
                    ...
                    int end =
                            ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)initializations[initializationsLength -
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement[] increments = statement.increments;
        if (increments != null) {
    ...
    public IfStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IfStatement statement) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement statement2 = statement.elseStatement;
        if (statement2 != null) {
    ...
    public InstanceofExpression convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.InstanceOfExpression expression) {
    ...
    public NumberLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IntLiteral expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
    ...
    public NumberLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IntLiteralMinValue expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
        NumberLiteral literal = new NumberLiteral(this.ast);
        literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
    ...
    public void convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Javadoc javadoc,
    ...
    public LabeledStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LabeledStatement statement) {
    ...
    public NumberLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LongLiteral expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
        final NumberLiteral literal = new NumberLiteral(this.ast);
        literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
    ...
    public NumberLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LongLiteralMinValue expression) {
        int length = expression.sourceEnd - expression.sourceStart + 1;
        int sourceStart = expression.sourceStart;
        final NumberLiteral literal = new NumberLiteral(this.ast);
        literal.internalSetToken(new String(this.compilationUnitSource, sourceStart, length));
    ...
    public Expression convert(MessageSend expression) {
        ...
        if (expression.isSuperAccess()) {
            ...
            if (expression.receiver instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference) {
                Name qualifier =
                        convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference)expression.receiver);
            ...
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression receiver = expression.receiver;
            if (receiver instanceof MessageSend) {
                if ((receiver.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0) {
    ...
    public MarkerAnnotation convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MarkerAnnotation annotation) {
    ...
    public MemberValuePair convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MemberValuePair memberValuePair) {
    ...
    public Name convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.NameReference reference) {
        if (reference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedNameReference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedNameReference)reference);
        } else {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SingleNameReference)reference);
        }
    }
    ...
    public InfixExpression convert(StringLiteralConcatenation expression) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression[] stringLiterals = expression.literals;
        infixExpression.setLeftOperand(convert(stringLiterals[0]));
        infixExpression.setRightOperand(convert(stringLiterals[1]));
    ...
    public NormalAnnotation convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.NormalAnnotation annotation) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.MemberValuePair[] memberValuePairs =
    ...
    public NullLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.NullLiteral expression) {
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OR_OR_Expression expression) {
        InfixExpression infixExpression = new InfixExpression(this.ast);
    ...
    public PostfixExpression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.PostfixExpression expression) {
    ...
    public PrefixExpression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.PrefixExpression expression) {
    ...
    public Expression convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedAllocationExpression allocation) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression[] arguments = allocation.arguments;
        if (arguments != null) {
            int length = arguments.length;
            for (int i = 0; i < length; i++) {
    ...
    public Name convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedNameReference nameReference) {
        return setQualifiedNameNameAndSourceRanges(nameReference.tokens, nameReference.sourcePositions, nameReference);
    }

    public Name convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference reference) {
        return convert(reference.qualification);
    }

    public ThisExpression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedThisReference reference) {
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Reference reference) {
        if (reference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.NameReference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.NameReference)reference);
        }
        if (reference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ThisReference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ThisReference)reference);
        }
        if (reference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayReference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ArrayReference)reference);
        }
        if (reference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldReference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldReference)reference);
        }
        return null; // cannot be reached
    }

    public ReturnStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ReturnStatement statement) {
    ...
    public SingleMemberAnnotation convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SingleMemberAnnotation annotation) {
    ...
    public SimpleName convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SingleNameReference nameReference) {
        final SimpleName name = new SimpleName(this.ast);
    ...
    public Statement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement statement) {
        if (statement instanceof ForeachStatement) {
            return convert((ForeachStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration) {
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration localDeclaration =
                    (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LocalDeclaration)statement;
            return convertToVariableDeclarationStatement(localDeclaration);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AssertStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.AssertStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Block) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Block)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BreakStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.BreakStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ContinueStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ContinueStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CaseStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CaseStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.DoStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.DoStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.EmptyStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.EmptyStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ExplicitConstructorCall)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ForStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ForStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IfStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.IfStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LabeledStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.LabeledStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ReturnStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ReturnStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SwitchStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SwitchStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SynchronizedStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SynchronizedStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ThrowStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ThrowStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TryStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TryStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration) {
            ASTNode result = convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration)statement);
            if (result == null) {
                return createFakeEmptyStatement(statement);
            }
        ...
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.WhileStatement) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.WhileStatement)statement);
        }
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression) {
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression statement2 =
                    (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression)statement;
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.StringLiteral expression) {
        if (expression instanceof StringLiteralConcatenation) {
            return convert((StringLiteralConcatenation)expression);
        }
        int length = expression.sourceEnd - expression.sourceStart + 1;
    ...
    public SwitchStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SwitchStatement statement) {
    ...
    public SynchronizedStatement convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SynchronizedStatement statement) {
    ...
    public Expression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ThisReference reference) {
        if (reference.isImplicitThis()) {
            // There is no source associated with an implicit this
            return null;
        } else if (reference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedSuperReference)reference);
        } else if (reference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedThisReference) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedThisReference)reference);
        } else {
    ...
    public ThrowStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ThrowStatement statement) {
    ...
    public BooleanLiteral convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TrueLiteral expression) {
        final BooleanLiteral literal = new BooleanLiteral(this.ast);
    ...
    public TryStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TryStatement statement) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Argument[] catchArguments = statement.catchArguments;
        if (catchArguments != null) {
            int catchArgumentsLength = catchArguments.length;
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Block[] catchBlocks = statement.catchBlocks;
    ...
    public AbstractTypeDeclaration convert(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration) {
        int kind = com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration.kind(typeDeclaration.modifiers);
        switch (kind) {
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration.ENUM_DECL:
                if (this.ast.apiLevel == AST.JLS2_INTERNAL) {
                    return null;
                } else {
                    return convertToEnumDeclaration(typeDeclaration);
                }
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration.ANNOTATION_TYPE_DECL:
                if (this.ast.apiLevel == AST.JLS2_INTERNAL) {
                    return null;
                } else {
        ...
        boolean isInterface =
                kind == com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration.INTERFACE_DECL;
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference[] superInterfaces =
    ...
    public TypeParameter convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeParameter typeParameter) {
    ...
    public Name convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeReference) {
        char[][] typeName = typeReference.getTypeName();
        int length = typeName.length;
        if (length > 1) {
            // QualifiedName
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference qualifiedTypeReference =
                    (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference;
    ...
    public PrefixExpression convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.UnaryExpression expression) {
        final PrefixExpression prefixExpression = new PrefixExpression(this.ast);
        if (this.resolveBindings) {
        ...
        switch ((expression.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OperatorMASK) >>
            ...
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.MINUS:
                ...
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.NOT:
                prefixExpression.setOperator(PrefixExpression.Operator.NOT);
                break;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.TWIDDLE:
                prefixExpression.setOperator(PrefixExpression.Operator.COMPLEMENT);
        }
        return prefixExpression;
    }

    public WhileStatement convert(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.WhileStatement statement) {
    ...
    public ImportDeclaration convertImport(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ImportReference importReference) {
        final ImportDeclaration importDeclaration = new ImportDeclaration(this.ast);
        final boolean onDemand =
                (importReference.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0;
    ...
    public PackageDeclaration convertPackage(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.CompilationUnitDeclaration compilationUnitDeclaration) {
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ImportReference importReference =
        ...
        packageDeclaration.setSourceRange(importReference.declarationSourceStart, importReference.declarationEnd
                                                                                  - importReference.declarationSourceStart + 1);
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation[] annotations = importReference.annotations;
        if (annotations != null) {
            switch (this.ast.apiLevel) {
                case AST.JLS2_INTERNAL:
    ...
    public Expression convertToExpression(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement statement) {
        if (statement instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression) {
            return convert((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression)statement);
        } else {
            return null;
        }
    }
    ...
    protected FieldDeclaration convertToFieldDeclaration(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.FieldDeclaration fieldDecl) {
    ...
    public ParenthesizedExpression convertToParenthesizedExpression(
        ...
        int numberOfParenthesis =
                (expression.bits & com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK) >>
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
        expression.bits &= ~com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedMASK;
        expression.bits |=
                (numberOfParenthesis - 1) << com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
    ...
    protected VariableDeclarationFragment convertToVariableDeclarationFragment(
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression initialization = localDeclaration.initialization;
    ...
    public Type convertType(TypeReference typeReference) {
        ...
        if (typeReference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SingleTypeReference) {
            // this is either an ArrayTypeReference or a SingleTypeReference
            char[] name =
                    ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.SingleTypeReference)typeReference).getTypeName()[0];
            ...
            if (typeReference instanceof ParameterizedQualifiedTypeReference) {
            ...
            } else if (typeReference instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference) {
                char[][] name =
                        ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference)
                                .getTypeName();
                int nameLength = name.length;
                long[] positions =
                        ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.QualifiedTypeReference)typeReference).sourcePositions;
                sourceStart = (int)(positions[0] >>> 32);
                length = (int)(positions[nameLength - 1] & 0xFFFFFFFF) - sourceStart + 1;
                ...
                TypeReference[] typeReferences =
                        ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.UnionTypeReference)typeReference).typeReferences;
                switch (this.ast.apiLevel) {
                    case AST.JLS2_INTERNAL:
                    case AST.JLS3:
                        // recovery
    ...
    protected Statement createFakeEmptyStatement(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Statement statement) {
        if (statement == null)
            return null;
        EmptyStatement emptyStatement = new EmptyStatement(this.ast);
    ...
    protected InfixExpression.Operator getOperatorFor(int operatorID) {
        switch (operatorID) {
            ...
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.LESS_EQUAL:
                return InfixExpression.Operator.LESS_EQUALS;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.GREATER_EQUAL:
            ...
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.OR_OR:
                return InfixExpression.Operator.CONDITIONAL_OR;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.AND_AND:
            ...
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.GREATER:
                return InfixExpression.Operator.GREATER;
            case com.codenvy.ide.ext.java.jdt.internal.compiler.ast.OperatorIds.LESS:
    ...
    private BlockScope lookupScope(ASTNode node) {
        ...
        if (currentNode instanceof Initializer) {
            ...
            if (currentNode instanceof TypeDeclaration || currentNode instanceof EnumDeclaration
                ...
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration typeDecl =
                        (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeDeclaration)this.ast.getBindingResolver()
    ...
    protected void recordName(Name name, com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode compilerNode) {
        if (compilerNode != null) {
            recordNodes(name, compilerNode);
            if (compilerNode instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference) {
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeRef =
                        (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference)compilerNode;
    ...
    protected void recordNodes(ASTNode node, com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode oldASTNode) {
        this.ast.getBindingResolver().store(node, oldASTNode);
    }

    protected void recordNodes(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Javadoc javadoc,
        ...
        while (fragments.hasNext()) {
            ...
            if (node.getNodeType() == ASTNode.MEMBER_REF) {
                ...
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.ASTNode compilerNode =
                ...
                if (memberRef.getQualifier() != null) {
                    com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeRef = null;
                    if (compilerNode instanceof JavadocFieldReference) {
                        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression expression =
                                ((JavadocFieldReference)compilerNode).receiver;
                        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference) {
                            typeRef = (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference)expression;
                        }
                ...
                if (compilerNode != null) {
                    ...
                    // get type ref
                    com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference typeRef = null;
                    if (compilerNode instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.JavadocAllocationExpression) {
                        typeRef =
                                ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.JavadocAllocationExpression)compilerNode).type;
                        if (typeRef != null)
                            recordNodes(name, compilerNode);
                    } else if (compilerNode instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.JavadocMessageSend) {
                        com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression expression =
                                ((com.codenvy.ide.ext.java.jdt.internal.compiler.ast.JavadocMessageSend)compilerNode).receiver;
                        if (expression instanceof com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference) {
                            typeRef = (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.TypeReference)expression;
                        }
                        recordNodes(name, compilerNode);
                ...
                while (parameters.hasNext()) {
                    ...
                    com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression expression =
                            (com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression)javadoc.getNodeStartingAt(param
    ...
    private void trimWhiteSpacesAndComments(com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Expression expression) {
        int start = expression.sourceStart;
        int end = expression.sourceEnd;
        int token;
    ...
    protected void setModifiers(BodyDeclaration bodyDeclaration,
                                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation[] annotations, int modifiersEnd) {
                ...
                switch (token) {
                    ...
                    case TerminalTokens.TokenNameAT:
                        ...
                        if (annotations != null && indexInAnnotations < annotations.length) {
                            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation annotation =
    ...
    protected void setModifiers(SingleVariableDeclaration variableDecl, Argument argument) {
        switch (this.ast.apiLevel) {
            ...
            default:
                ...
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation[] annotations = argument.annotations;
                int indexInAnnotations = 0;
                try {
                    int token;
                    while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF) {
    ...
    protected void setModifiers(SingleVariableDeclaration variableDecl, LocalDeclaration localDeclaration) {
        switch (this.ast.apiLevel) {
            ...
            default:
                ...
                com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation[] annotations =
    ...
    protected void setTypeNameForAnnotation(
            com.codenvy.ide.ext.java.jdt.internal.compiler.ast.Annotation compilerAnnotation, Annotation annotation) {

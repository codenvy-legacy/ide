...
@Singleton
public class JarProjectTemplateExtension implements ProjectTemplateExtension {

    @Inject
    public JarProjectTemplateExtension(ProjectTemplateRegistry registry) {
    ...
    public List<ProjectTemplateDescription> getTemplateDescriptions() {
        ...
        list.add(new ProjectTemplateDescription("maven_jar",
                                                "MAVEN JAR PROJECT",
                                                "Simple JAR project which uses Maven build system.",
                                                "templates/MavenJar.zip"));

        list.add(new ProjectTemplateDescription("ant_jar",
                                                "ANT JAR PROJECT",

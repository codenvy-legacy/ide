...
import com.codenvy.ide.ext.java.worker.core.util.ModifierConstants;
...
class VariableBinding implements IVariableBinding {
    ...
    private com.codenvy.ide.ext.java.worker.internal.compiler.lookup.VariableBinding binding;
    ...
    VariableBinding(BindingResolver resolver, com.codenvy.ide.ext.java.worker.internal.compiler.lookup.VariableBinding binding) {
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        com.codenvy.ide.ext.java.worker.internal.compiler.lookup.VariableBinding otherBinding = ((VariableBinding)other).binding;

...
import com.codenvy.ide.ext.java.worker.internal.compiler.Compiler;
import com.codenvy.ide.ext.java.worker.internal.compiler.DefaultErrorHandlingPolicies;
import com.codenvy.ide.ext.java.worker.internal.compiler.ICompilerRequestor;
import com.codenvy.ide.ext.java.worker.internal.compiler.IErrorHandlingPolicy;
import com.codenvy.ide.ext.java.worker.internal.compiler.IProblemFactory;
import com.codenvy.ide.ext.java.worker.internal.compiler.ast.AbstractMethodDeclaration;
import com.codenvy.ide.ext.java.worker.internal.compiler.ast.CompilationUnitDeclaration;
...
import com.codenvy.ide.ext.java.worker.internal.compiler.lookup.AnnotationBinding;
...
import com.codenvy.ide.ext.java.worker.internal.compiler.parser.Parser;
...
import com.codenvy.ide.ext.java.worker.internal.compiler.util.HashtableOfObject;
import com.codenvy.ide.ext.java.worker.internal.core.CancelableProblemFactory;
import com.codenvy.ide.ext.java.worker.internal.core.util.BindingKeyResolver;
import com.codenvy.ide.ext.java.worker.internal.core.util.CommentRecorderParser;
...
class CompilationUnitResolver extends Compiler {
     ...
     * @see com.codenvy.ide.ext.java.worker.internal.compiler.DefaultErrorHandlingPolicies
     * @see com.codenvy.ide.ext.java.worker.internal.compiler.CompilationResult
     */
    ...
    public void accept(ISourceType[] sourceTypes, PackageBinding packageBinding, AccessRestriction accessRestriction) {
        ...
        // accept((com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit)sourceType.getHandle().getCompilationUnit(),
        // accessRestriction);
    }

    @Override
    public synchronized void accept(com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit sourceUnit,
     ...
     * their results.
     */
    protected void beginToCompile(com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit[] sourceUnits,
                                  String[] bindingKeys) {
        ...
        for (int i = 0; i < sourceLength; i++) {
            com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit sourceUnit = sourceUnits[i];
...
//            continue;
//         }
//         com.codenvy.ide.ext.java.worker.compiler.batch.CompilationUnit compilationUnit =
//            new com.codenvy.ide.ext.java.worker.compiler.batch.CompilationUnit(contents, sourceUnits[i], encoding);
//         com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit sourceUnit = compilationUnit;
//         CompilationResult compilationResult =
//            new CompilationResult(sourceUnit, 0, 0, compilerOptions.maxProblemsPerUnit);
//         CompilationUnitDeclaration compilationUnitDeclaration = parser.dietParse(sourceUnit, compilationResult);
//
...
//         // fill the methods bodies in order for the code to be generated
//         // real parse of the method....
//         com.codenvy.ide.ext.java.worker.internal.compiler.ast.TypeDeclaration[] types =
...
//   }
    ...
    public static CompilationUnitDeclaration parse(
            com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit sourceUnit, NodeSearcher nodeSearcher,
        ...
        if (nodeSearcher != null) {
            ...
            com.codenvy.ide.ext.java.worker.internal.compiler.ast.ASTNode node = nodeSearcher.found;
            if (node == null) {
                return compilationUnitDeclaration;
            }

            com.codenvy.ide.ext.java.worker.internal.compiler.ast.TypeDeclaration enclosingTypeDeclaration =
            ...
            if (node instanceof AbstractMethodDeclaration) {
                ...
                if (node instanceof com.codenvy.ide.ext.java.worker.internal.compiler.ast.Initializer) {
                    ((com.codenvy.ide.ext.java.worker.internal.compiler.ast.Initializer)node).parseStatements(parser,
                    ...
                    ((com.codenvy.ide.ext.java.worker.internal.compiler.ast.TypeDeclaration)node).parseMethods(parser,
                                                                                                           compilationUnitDeclaration);
                }
            }
        } else {
    ...
    public static CompilationUnitDeclaration resolve(
            com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit sourceUnit, List classpaths,
...
//            return null;
    ...
    public void removeUnresolvedBindings(CompilationUnitDeclaration compilationUnitDeclaration) {
        final com.codenvy.ide.ext.java.worker.internal.compiler.ast.TypeDeclaration[] types =
                compilationUnitDeclaration.types;
        if (types != null) {
    ...
    private void removeUnresolvedBindings(com.codenvy.ide.ext.java.worker.internal.compiler.ast.TypeDeclaration type) {
        final com.codenvy.ide.ext.java.worker.internal.compiler.ast.TypeDeclaration[] memberTypes = type.memberTypes;
        if (memberTypes != null) {
        ...
        final com.codenvy.ide.ext.java.worker.internal.compiler.ast.FieldDeclaration[] fields = type.fields;
        if (fields != null) {
    ...
    private void resolve(String[] sourceCompilationUnits, String[] encodings, String[] bindingKeys,
        ...
        try {
            ...
            com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit[] sourceUnits =
                    new com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit[length];
            int count = 0;
            for (int i = 0; i < length; i++) {
                char[] contents = null;
                String encoding = encodings != null ? encodings[i] : null;
                ...
                sourceUnits[count++] =
                        new com.codenvy.ide.ext.java.worker.compiler.batch.CompilationUnit(contents, sourceUnitPath, encoding);
            }
            beginToCompile(sourceUnits, bindingKeys);
            // process all units (some more could be injected in the loop by the lookup environment)
            for (int i = 0; i < this.totalUnits; i++) {
                ...
                try {
                    ...
                    // requested AST
                    char[] fileName = unit.compilationResult.getFileName();
                    com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit source =
                            (com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit)this.requestedSources
                                    .get(fileName);
                    if (source != null) {
                        // convert AST
                        CompilationResult compilationResult = unit.compilationResult;
                        com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit sourceUnit =
    ...
    private CompilationUnitDeclaration resolve(CompilationUnitDeclaration unit,
        ...
        try {
            ...
            if (unit == null) {
                ...
                beginToCompile(new com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit[]{sourceUnit});
                ...
                if (searchPosition >= 0 && searchPosition <= length) {
                    ...
                    if (node != null) {
                        ...
                        if (node instanceof AbstractMethodDeclaration) {
                            ...
                            if (node instanceof com.codenvy.ide.ext.java.worker.internal.compiler.ast.Initializer) {
                                ((com.codenvy.ide.ext.java.worker.internal.compiler.ast.Initializer)node).parseStatements(
                                        this.parser, enclosingTypeDeclaration, unit);
                            } else if (node instanceof com.codenvy.ide.ext.java.worker.internal.compiler.ast.TypeDeclaration) {
                                ((com.codenvy.ide.ext.java.worker.internal.compiler.ast.TypeDeclaration)node).parseMethods(
                                        this.parser, unit);
                            }
                        }
    ...
    public CompilationUnitDeclaration resolve(
            com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit sourceUnit, boolean verifyMethods,

...
import com.codenvy.ide.ext.java.worker.internal.compiler.parser.RecoveryScannerData;
...
import com.codenvy.ide.ext.java.worker.internal.core.util.CodeSnippetParsingUtil;
import com.codenvy.ide.ext.java.worker.internal.core.util.RecordedParsingInformation;
        ...
        switch (this.astKind) {
            ...
            case K_COMPILATION_UNIT:
                ...
                try {
                    ...
                    com.codenvy.ide.ext.java.worker.internal.compiler.env.ICompilationUnit sourceUnit = null;
                    if (this.rawSource != null) {
    ...
    private ASTNode internalCreateASTForKind() {
        ...
        switch (this.astKind) {
            case K_STATEMENTS:
                ...
                com.codenvy.ide.ext.java.worker.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
                if (statements != null) {
            ...
            case K_CLASS_BODY_DECLARATIONS:
                final com.codenvy.ide.ext.java.worker.internal.compiler.ast.ASTNode[] nodes =

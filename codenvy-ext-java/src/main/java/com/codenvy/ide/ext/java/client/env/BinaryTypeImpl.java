...
public class BinaryTypeImpl implements IBinaryType {
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IGenericType#getModifiers() */
    @Override
    public int getModifiers() {
        return (int)jsObj.get("modifiers").isNumber().doubleValue();
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IGenericType#isBinaryType() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getAnnotations() */
    @Override
    public IBinaryAnnotation[] getAnnotations() {
        return null;
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getEnclosingMethod() */
    @Override
    public char[] getEnclosingMethod() {
        return null;
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getEnclosingTypeName() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getFields() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getGenericSignature() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getInterfaceNames() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getMemberTypes() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getMethods() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getMissingTypeNames() */
    @Override
    public char[][][] getMissingTypeNames() {
        return null;
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getName() */
    @Override
    public char[] getName() {
        return jsObj.get("name").isString().stringValue().replaceAll("\\.", "/").toCharArray();
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getSourceName() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getSuperclassName() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#getTagBits() */
    @Override
    public long getTagBits() {
        return 0;
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#isAnonymous() */
    @Override
    public boolean isAnonymous() {
        return false;
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#isLocal() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#isMember() */
    @Override
    public boolean isMember() {
        return CharOperation.contains('$', getName());
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryType#sourceFileName() */
    @Override

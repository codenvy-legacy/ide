...
import com.codenvy.ide.ext.java.worker.internal.compiler.parser.diagnose.DiagnoseParser;
import com.codenvy.ide.ext.java.worker.internal.compiler.problem.AbortCompilation;
import com.codenvy.ide.ext.java.worker.internal.compiler.problem.AbortCompilationUnit;
...
import com.codenvy.ide.ext.java.worker.internal.compiler.util.Messages;
import com.codenvy.ide.ext.java.worker.internal.compiler.util.Util;
    ...
    */
    ...
    protected void reportSyntaxErrors(boolean isDietParse, int oldFirstToken) {
        ...
        if (isDietParse) {
            ...
            int[][] intervalToSkip =
                    com.codenvy.ide.ext.java.worker.internal.compiler.parser.diagnose.RangeUtil.computeDietRange(types);

...
import com.codenvy.ide.ext.java.client.templates.ContextTypeRegistry;
import com.codenvy.ide.ext.java.client.templates.JavaContextType;
import com.codenvy.ide.ext.java.client.templates.JavaDocContextType;
import com.codenvy.ide.ext.java.client.templates.TemplateEngine;
import com.codenvy.ide.ext.java.client.templates.api.TemplateContextType;
...
public class TemplateCompletionProposalComputer extends AbstractTemplateCompletionProposalComputer {
    ...
    public TemplateCompletionProposalComputer() {
        ContextTypeRegistry templateContextRegistry = JavaExtension.get().getTemplateContextRegistry();

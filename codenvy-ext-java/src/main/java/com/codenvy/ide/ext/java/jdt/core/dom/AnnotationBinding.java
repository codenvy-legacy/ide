...
class AnnotationBinding implements IAnnotationBinding {
    ...
    private com.codenvy.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding binding;

    private BindingResolver bindingResolver;

    private String key;

    AnnotationBinding(com.codenvy.ide.ext.java.jdt.internal.compiler.lookup.AnnotationBinding annotation,

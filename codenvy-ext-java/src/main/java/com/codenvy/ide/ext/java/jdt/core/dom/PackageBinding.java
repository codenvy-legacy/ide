...
class PackageBinding implements IPackageBinding {
    ...
    private com.codenvy.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding binding;
    ...
    PackageBinding(com.codenvy.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding binding, BindingResolver resolver) {
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        com.codenvy.ide.ext.java.jdt.internal.compiler.lookup.PackageBinding packageBinding2 = ((PackageBinding)other).binding;

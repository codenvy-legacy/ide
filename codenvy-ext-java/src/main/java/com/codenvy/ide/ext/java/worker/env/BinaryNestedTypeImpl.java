...
public class BinaryNestedTypeImpl implements IBinaryNestedType {
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryNestedType#getEnclosingTypeName() */
    @Override
    public char[] getEnclosingTypeName() {
        return parentType;
    }

    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryNestedType#getModifiers() */
    @Override
    public int getModifiers() {
        return nestedType.getIntField("modifiers");
    }

    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryNestedType#getName() */
    @Override
    public char[] getName() {

...
import com.codenvy.ide.ext.java.client.core.util.ModifierConstants;
...
import com.codenvy.ide.ext.java.client.internal.compiler.ast.Initializer;
...
class VariableBinding implements IVariableBinding {
    ...
    private com.codenvy.ide.ext.java.client.internal.compiler.lookup.VariableBinding binding;
    ...
    VariableBinding(BindingResolver resolver, com.codenvy.ide.ext.java.client.internal.compiler.lookup.VariableBinding binding) {
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.VariableBinding otherBinding = ((VariableBinding)other).binding;

...
public class BinaryNestedTypeImpl implements IBinaryNestedType {
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryNestedType#getEnclosingTypeName() */
    @Override
    public char[] getEnclosingTypeName() {
        return parentType;
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryNestedType#getModifiers() */
    @Override
    public int getModifiers() {
        return (int)nestedType.get("modifiers").isNumber().doubleValue();
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.env.IBinaryNestedType#getName() */
    @Override
    public char[] getName() {

...
public class BinaryMethodImpl implements IBinaryMethod {
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IGenericMethod#getModifiers() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IGenericMethod#isConstructor() */
    @Override
    public boolean isConstructor() {
        return method.getBooleanField("constructor");
    }

    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IGenericMethod#getArgumentNames() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#getAnnotations() */
    @Override
    public IBinaryAnnotation[] getAnnotations() {
        return null;
    }

    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#getDefaultValue() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#getExceptionTypeNames() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#getGenericSignature() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#getMethodDescriptor() */
    @Override
    public char[] getMethodDescriptor() {
        return method.getStringField("descriptor").toCharArray();
    }

    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#getParameterAnnotations(int) */
    @Override
    public IBinaryAnnotation[] getParameterAnnotations(int index) {
        return null;
    }

    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#getSelector() */
    @Override
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#getTagBits() */
    @Override
    public long getTagBits() {
        return 0;
    }

    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryMethod#isClinit() */
    @Override

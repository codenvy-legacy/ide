 ...
 *******************************************************************************/
package com.codenvy.ide.ext.java.client.internal.corext.refactoring.structure;
...
import com.codenvy.ide.ext.java.client.refactoring.CategorizedTextEditGroup;
    ...
    public CompilationUnitChange attachChange(CompilationUnitChange cuChange, boolean generateGroups) throws CoreException {
        ...
        if (needsAstRewrite) {
            ...
            if (fRememberContent != null) {
                rewriteEdit = fRewrite.rewriteAST(fRememberContent, JavaExtension.get().getOptions());
            } else {
                rewriteEdit = fRewrite.rewriteAST(document, JavaExtension.get().getOptions());
            }

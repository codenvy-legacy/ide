...
public abstract class Statement extends ASTNode {
    ...
    protected boolean isBoxingCompatible(TypeBinding expressionType, TypeBinding targetType, Expression expression,
        ...
        return expressionType.isBaseType() // narrowing then boxing ?
               ...
               && scope.compilerOptions().sourceLevel >= com.codenvy.ide.ext.java.jdt.internal.compiler.ClassFileConstants.JDK1_5
               // autoboxing
    ...
    /**
     * Implementation of {@link com.codenvy.ide.ext.java.jdt.internal.compiler.lookup.InvocationSite#expectedType}
     * suitable at this level. Subclasses should override as necessary.
     *
     * @see com.codenvy.ide.ext.java.jdt.internal.compiler.lookup.InvocationSite#expectedType()
     */

 ...
 *******************************************************************************/
package com.codenvy.ide.ext.java.client.codeassistant;
...
import com.codenvy.ide.ext.java.client.codeassistant.ui.StyledString;
import com.codenvy.ide.ext.java.client.core.Flags;
import com.codenvy.ide.ext.java.client.core.Messages;
...
import com.codenvy.ide.ext.java.client.core.formatter.CodeFormatter;
import com.codenvy.ide.ext.java.client.internal.corext.codemanipulation.CodeGenerationSettings;
import com.codenvy.ide.ext.java.client.internal.corext.codemanipulation.GetterSetterUtil;
import com.codenvy.ide.ext.java.client.internal.corext.util.CodeFormatterUtil;
import com.codenvy.ide.ext.java.client.internal.corext.util.JdtFlags;
import com.codenvy.ide.ext.java.client.internal.corext.util.Strings;
...
public class GetterSetterCompletionProposal extends JavaTypeCompletionProposal {
    ...
    public GetterSetterCompletionProposal(IVariableBinding field, int start, int length, boolean isGetter,
        ...
        super(
                "", start, length, new Image(JavaClientBundle.INSTANCE.publicMethod()), getDisplayName(field, isGetter), relevance, null,
                context); //$NON-NLS-1$

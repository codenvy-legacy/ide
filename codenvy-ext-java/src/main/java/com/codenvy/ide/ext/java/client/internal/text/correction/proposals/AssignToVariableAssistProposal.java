...
package com.codenvy.ide.ext.java.client.internal.text.correction.proposals;

import com.codenvy.ide.ext.java.client.JavaClientBundle;
import com.codenvy.ide.ext.java.client.core.NamingConventions;
import com.codenvy.ide.ext.java.client.core.compiler.ITerminalSymbols;
...
import com.codenvy.ide.ext.java.client.internal.corext.dom.TokenScanner;
...
public class AssignToVariableAssistProposal extends LinkedCorrectionProposal {
    ...
    public AssignToVariableAssistProposal(int variableKind, ExpressionStatement node, ITypeBinding typeBinding,
        ...
        if (variableKind == LOCAL) {
            ...
            setImage(new Image(JavaClientBundle.INSTANCE.local_var()));
        } else {
            setDisplayName(CorrectionMessages.INSTANCE.AssignToVariableAssistProposal_assigntofield_description());
            setImage(new Image(JavaClientBundle.INSTANCE.privateField()));
        }

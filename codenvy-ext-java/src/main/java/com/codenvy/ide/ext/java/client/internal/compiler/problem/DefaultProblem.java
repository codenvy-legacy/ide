...
public class DefaultProblem extends CategorizedProblem {
    ...
    /** @see com.codenvy.ide.ext.java.client.core.compiler.CategorizedProblem#getCategoryID() */
     ...
     *
     * @return int
     * @see com.codenvy.ide.ext.java.client.core.compiler.IProblem#getID()
     */
    public int getID() {
        return this.id;
    }
     ...
     *
     * @see com.codenvy.ide.ext.java.client.core.compiler.CategorizedProblem#getMarkerType()
     */

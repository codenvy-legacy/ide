...
import com.codenvy.ide.ext.java.client.templates.api.GlobalTemplateVariables;
import com.codenvy.ide.ext.java.client.templates.api.SimpleTemplateVariableResolver;
import com.codenvy.ide.ext.java.client.templates.api.TemplateContext;
...
public class JavaDocContextType extends CompilationUnitContextType {
    ...
    protected static class SurroundWithWordSelection extends SimpleTemplateVariableResolver {
        ...
        public SurroundWithWordSelection() {
            super(
                    com.codenvy.ide.ext.java.client.templates.api.GlobalTemplateVariables.WordSelection.NAME,
        ...
        protected String resolve(TemplateContext context) {
            String selection = context.getVariable(com.codenvy.ide.ext.java.client.templates.api.GlobalTemplateVariables.SELECTION);
            if (selection == null)
                return ""; //$NON-NLS-1$
            return selection;
        }

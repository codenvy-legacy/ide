 ...
 *******************************************************************************/
package com.codenvy.ide.ext.java.client.internal.compiler.parser;
...
import com.codenvy.ide.ext.java.client.core.util.JSONUtil;
...
import com.codenvy.ide.ext.java.client.internal.compiler.CompilationResult;
...
import com.codenvy.ide.ext.java.client.internal.compiler.impl.ReferenceContext;
import com.codenvy.ide.ext.java.client.internal.compiler.lookup.*;
import com.codenvy.ide.ext.java.client.internal.compiler.parser.diagnose.DiagnoseParser;
import com.codenvy.ide.ext.java.client.internal.compiler.problem.AbortCompilation;
import com.codenvy.ide.ext.java.client.internal.compiler.problem.AbortCompilationUnit;
...
import com.codenvy.ide.ext.java.client.internal.compiler.util.Messages;
...
public class Parser implements ParserBasicInformation, TerminalTokens, OperatorIds, TypeIds {
    ...
    public final static void initTables() {
        ...
        non_terminal_index =
                JSONUtil.parseArrayToCharArray(resources.parser8().getText()); // readTable(prefix + (++i) + ".rsc"); //$NON-NLS-1$
        ...
        scope_state_set =
                JSONUtil.parseArrayToCharArray(resources.parser13().getText()); //readTable(prefix + (++i) + ".rsc"); //$NON-NLS-1$
        ...
        term_check =
                JSONUtil.parseArrayToByteArray(resources.parser18().getText()); // readByteTable(prefix + (++i) + ".rsc"); //$NON-NLS-1$
        ...
        rules_compliance =
                JSONUtil.parseJsonAsLongArray(resources.parser21().getText()); //readLongTable(prefix + (++i) + ".rsc"); //$NON-NLS-1$
        ...
        recovery_templates_index =
                JSONUtil.parseArrayToCharArray(resources.parser22().getText()); //readTable(prefix + (++i) + ".rsc"); //$NON-NLS-1$
        recovery_templates =
                JSONUtil.parseArrayToCharArray(resources.parser23().getText()); //readTable(prefix + (++i) + ".rsc"); //$NON-NLS-1$

        statements_recovery_filter =
                JSONUtil.parseArrayToCharArray(resources.parser24().getText()); //readTable(prefix + (++i) + ".rsc"); //$NON-NLS-1$
    ...
    */
    ...
    protected void reportSyntaxErrors(boolean isDietParse, int oldFirstToken) {
        ...
        if (isDietParse) {
            ...
            int[][] intervalToSkip =
                    com.codenvy.ide.ext.java.client.internal.compiler.parser.diagnose.RangeUtil.computeDietRange(types);

...
import com.codenvy.ide.ext.java.client.internal.text.correction.JavadocTagsSubProcessor;
...
public class TypeChangeCorrectionProposal extends LinkedCorrectionProposal {
    ...
    public TypeChangeCorrectionProposal(IBinding binding, CompilationUnit astRoot, ITypeBinding newType,
        ...
        super("", null, relevance, document, new Image(JavaClientBundle.INSTANCE.correction_change())); //$NON-NLS-1$

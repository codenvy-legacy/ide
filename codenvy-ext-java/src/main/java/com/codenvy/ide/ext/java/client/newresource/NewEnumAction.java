...
/**
 * Action to create new Java enum.
 *
 * @author Artem Zatsarynnyy
 */
@Singleton
public class NewEnumAction extends NewJavaResourceAction {
    @Inject
    public NewEnumAction(JavaResources javaResources,
                         JavaLocalizationConstant localizationConstant,
                         ResourceProvider resourceProvider,
                         SelectionAgent selectionAgent,
                         EditorAgent editorAgent) {
        super(localizationConstant.actionNewEnumTitle(),
              localizationConstant.actionNewEnumDescription(),
              javaResources.enumItem(),
              null,
              resourceProvider,
              selectionAgent,
              editorAgent);
    ...
    public void actionPerformed(ActionEvent e) {
        new AskValueDialog("New " + title, "Name:", new AskValueCallback() {
            ...
            public void onOk(String value) {
                ...
                content.append("public enum ").append(value).append(DEFAULT_CONTENT);

...
public class ParameterizedFieldBinding extends FieldBinding {
    ...
    /** @see com.codenvy.ide.ext.java.client.internal.compiler.lookup.VariableBinding#constant() */
    public Constant constant() {
        return this.originalField.constant();
    }

    /** @see com.codenvy.ide.ext.java.client.internal.compiler.lookup.FieldBinding#original() */

...
public class BinaryElementValuePairImpl implements IBinaryElementValuePair {
    ...
    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryElementValuePair#getName() */
    @Override
    public char[] getName() {
        return val.getStringField("name").toCharArray();
    }

    /** @see com.codenvy.ide.ext.java.worker.internal.compiler.env.IBinaryElementValuePair#getValue() */
    @Override

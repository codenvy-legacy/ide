...
/**
 * Action to create new Java class.
 *
 * @author Artem Zatsarynnyy
 */
@Singleton
public class NewClassAction extends NewJavaResourceAction {
    @Inject
    public NewClassAction(JavaResources javaResources,
                          JavaLocalizationConstant localizationConstant,
                          ResourceProvider resourceProvider,
                          SelectionAgent selectionAgent,
                          EditorAgent editorAgent) {
        super(localizationConstant.actionNewClassTitle(),
              localizationConstant.actionNewClassDescription(),
              javaResources.classItem(),
              null,
              resourceProvider,
              selectionAgent,
              editorAgent);
    ...
    public void actionPerformed(ActionEvent e) {
        new AskValueDialog("New " + title, "Name:", new AskValueCallback() {
            ...
            public void onOk(String value) {
                ...
                content.append("public class ").append(value).append(DEFAULT_CONTENT);

...
public class CompletionProposalLabelProvider {
    ...
    public Image createImageDescriptor(CompletionProposal proposal) {
        ...
        switch (proposal.getKind()) {
            ...
            case CompletionProposal.TYPE_REF:
                switch (Signature.getTypeSignatureKind(proposal.getSignature())) {
                    ...
                    case Signature.TYPE_VARIABLE_SIGNATURE:
                        // TODO
                        descriptor = JavaClientBundle.INSTANCE.classItem();
                        break;
                    default:
                        descriptor = null;
                }
            ...
            case CompletionProposal.LOCAL_VARIABLE_REF:
            case CompletionProposal.VARIABLE_DECLARATION:
                descriptor = JavaClientBundle.INSTANCE.variable();
                break;
            case CompletionProposal.PACKAGE_REF:
                // TODO PACKAGE_REF
                descriptor = JavaClientBundle.INSTANCE.variable();
            ...
            case CompletionProposal.JAVADOC_PARAM_REF:
                // TODO JAVADOCTAG
                descriptor = JavaClientBundle.INSTANCE.jspTagItem();
                break;
            default:
                descriptor = null;
                Assert.isTrue(false);
    ...
    ImageResource createLocalImageDescriptor(CompletionProposal proposal) {

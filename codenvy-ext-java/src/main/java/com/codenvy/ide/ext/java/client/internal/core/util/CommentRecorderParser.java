    ...
    public int flushCommentsDefinedPriorTo(int position) {
        ...
        if (validCount > 0) {
            ...
            while (index < lastCommentIndex && (immediateCommentEnd = -this.scanner.commentStops[index + 1]) >
                ...
                if (com.codenvy.ide.ext.java.client.internal.compiler.util.Util.getLineNumber(position, this.scanner.lineEnds, 0,
                                                                                          this.scanner.linePtr) !=
                    com.codenvy.ide.ext.java.client.internal.compiler.util.Util.getLineNumber(

...
import com.codenvy.ide.ext.java.client.internal.compiler.ast.Argument;
import com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeReference;
import com.codenvy.ide.ext.java.client.internal.compiler.ast.UnionTypeReference;
...
public class Util {
                ...
                */
                    ...
                    if (next == ARGUMENTS_DELIMITER) {
                        ...
                        if (EMPTY_ARGUMENT.equals(currentArgumentContents)) {
                            currentArgumentContents = com.codenvy.ide.ext.java.client.internal.compiler.util.Util.EMPTY_STRING;
                        }
    ...
    public static int scanTypeSignature(char[] string, int start) {
        ...
        return com.codenvy.ide.ext.java.client.internal.compiler.util.Util.scanTypeSignature(string, start);
    }
    ...
    static void appendTypeSignature(char[] string, int start, StringBuffer buffer, boolean compact) {
        ...
        switch (c) {
            ...
            case Signature.C_TYPE_VARIABLE:
                int e =
                        com.codenvy.ide.ext.java.client.internal.compiler.util.Util.scanTypeVariableSignature(string, start);
    ...
    public static String typeSignature(TypeReference type) {
        ...
        if ((type.bits & com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode.IsUnionType) != 0) {

...
public abstract class Statement extends ASTNode {
    ...
    protected boolean isBoxingCompatible(TypeBinding expressionType, TypeBinding targetType, Expression expression,
        ...
        return expressionType.isBaseType() // narrowing then boxing ?
               ...
               && scope.compilerOptions().sourceLevel >= com.codenvy.ide.ext.java.client.internal.compiler.ClassFileConstants.JDK1_5
               // autoboxing
    ...
    /**
     * Implementation of {@link com.codenvy.ide.ext.java.client.internal.compiler.lookup.InvocationSite#expectedType}

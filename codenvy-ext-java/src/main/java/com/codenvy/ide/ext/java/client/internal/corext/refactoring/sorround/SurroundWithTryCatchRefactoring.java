...
import com.codenvy.ide.ext.java.client.internal.core.dom.CodeScopeBuilder;
...
import com.codenvy.ide.ext.java.client.internal.corext.refactoring.util.SelectionAwareSourceRangeComputer;
import com.codenvy.ide.ext.java.client.internal.corext.util.Strings;
import com.codenvy.ide.ext.java.client.refactoring.Change;
...
import com.codenvy.ide.ext.java.client.refactoring.TextFileChange;
...
public class SurroundWithTryCatchRefactoring extends Refactoring {
    ...
    public Change createChange() throws CoreException {
        ...
        TextEdit change = fRewriter.rewriteAST(document, JavaExtension.get().getOptions());
    ...
    /** @see com.codenvy.ide.java.client.ltk.refactoring.Refactoring#checkFinalConditions(com.codenvy.ide.java.client.runtime
     * .IProgressMonitor) */
    @Override

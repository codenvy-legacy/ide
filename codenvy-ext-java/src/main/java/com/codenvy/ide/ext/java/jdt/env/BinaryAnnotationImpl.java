...
public class BinaryAnnotationImpl implements IBinaryAnnotation {
    ...
    /** @see com.codenvy.ide.ext.java.jdt.internal.compiler.env.IBinaryAnnotation#getTypeName() */
    @Override
    public char[] getTypeName() {
        return annotation.getStringField("typeName").toCharArray();
    }

    /** @see com.codenvy.ide.ext.java.jdt.internal.compiler.env.IBinaryAnnotation#getElementValuePairs() */
    @Override

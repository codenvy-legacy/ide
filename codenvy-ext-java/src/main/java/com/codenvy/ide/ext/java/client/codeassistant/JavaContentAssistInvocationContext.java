...
import com.codenvy.ide.ext.java.client.codeassistant.ContentAssistHistory.RHSHistory;
import com.codenvy.ide.ext.java.client.codeassistant.api.ContentAssistInvocationContext;
...
import com.codenvy.ide.ext.java.client.internal.corext.util.SignatureUtil;
        ...
        if (fRHSHistory == null) {
            ...
            if (context != null) {
                ...
                if (expectedTypes != null && expectedTypes.length > 0) {
                    ...
                    fRHSHistory = JavaExtension.get().getContentAssistHistory().getHistory(expected);
                }
            }
            if (fRHSHistory == null)
                fRHSHistory = JavaExtension.get().getContentAssistHistory().getHistory(null);
        }
        return fRHSHistory;
    }

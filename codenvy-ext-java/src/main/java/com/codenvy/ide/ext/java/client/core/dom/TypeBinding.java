...
import com.codenvy.ide.ext.java.client.internal.compiler.ast.StringLiteral;
...
import com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding;
...
class TypeBinding implements ITypeBinding {
    private static final StringLiteral EXPRESSION = new com.codenvy.ide.ext.java.client.internal.compiler.ast.StringLiteral(0, 0);
    ...
    com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding binding;
    ...
    public TypeBinding(BindingResolver resolver, com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding binding) {
    ...
    public IAnnotationBinding[] getAnnotations() {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.ReferenceBinding refType = null;
        if (this.binding instanceof ParameterizedTypeBinding) {
            ...
            refType = (com.codenvy.ide.ext.java.client.internal.compiler.lookup.ReferenceBinding)this.binding;
        }
        if (refType != null) {
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.AnnotationBinding[] internalAnnotations =
            ...
            if (length != 0) {
                ...
                for (int i = 0; i < length; i++) {
                    com.codenvy.ide.ext.java.client.internal.compiler.lookup.AnnotationBinding internalAnnotation =
    ...
    public String getBinaryName() {
        if (this.binding.isCapture()) {
            ...
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.Binding declaring = typeVariableBinding.declaringElement;
            StringBuffer binaryName = new StringBuffer();
            switch (declaring.kind()) {
                case com.codenvy.ide.ext.java.client.internal.compiler.lookup.Binding.METHOD:
                    ...
                    break;
                default:
                    com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding typeBinding =
                            (com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding)declaring;
    ...
    public synchronized IVariableBinding[] getDeclaredFields() {
        ...
        try {
          ...
          */
            com.codenvy.ide.ext.java.client.internal.core.util.Util.log(e, "Could not retrieve declared fields"); //$NON-NLS-1$
        }
        return this.fields = NO_VARIABLE_BINDINGS;
    }
    ...
    public synchronized IMethodBinding[] getDeclaredMethods() {
        ...
        try {
            if (isClass() || isInterface() || isEnum()) {
                ReferenceBinding referenceBinding = (ReferenceBinding)this.binding;
                com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding[] internalMethods =
                ...
                if (length != 0) {
                    ...
                    for (int i = 0; i < length; i++) {
                        com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding methodBinding = internalMethods[i];
          ...
          * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
          */
            com.codenvy.ide.ext.java.client.internal.core.util.Util.log(e, "Could not retrieve declared methods"); //$NON-NLS-1$
        }
        return this.methods = NO_METHOD_BINDINGS;
    }
    ...
    public synchronized IMethodBinding getDeclaringMethod() {
        if (this.binding instanceof LocalTypeBinding) {
            ...
            if (methodBinding != null) {
                ...
                * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
                */
                    com.codenvy.ide.ext.java.client.internal.core.util.Util.log(e, "Could not retrieve declaring method"); //$NON-NLS-1$
                }
            }
        } else if (this.binding.isTypeVariable()) {
            TypeVariableBinding typeVariableBinding = (TypeVariableBinding)this.binding;
    ...
    public synchronized ITypeBinding getDeclaringClass() {
        if (isClass() || isInterface() || isEnum()) {
            ...
            if (referenceBinding.isNestedType()) {
                ...
                * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
                */
                    com.codenvy.ide.ext.java.client.internal.core.util.Util.log(e, "Could not retrieve declaring class"); //$NON-NLS-1$
                }
            }
        } else if (this.binding.isTypeVariable()) {
            TypeVariableBinding typeVariableBinding = (TypeVariableBinding)this.binding;
    ...
    public synchronized ITypeBinding[] getInterfaces() {
        ...
        try {
          ...
          * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
          */
            com.codenvy.ide.ext.java.client.internal.core.util.Util.log(e, "Could not retrieve interfaces"); //$NON-NLS-1$
        }
    ...
    /** @see com.codenvy.ide.ext.java.client.core.dom.ITypeBinding#getQualifiedName() */
    ...
    public synchronized ITypeBinding getSuperclass() {
        ...
        try {
          ...
          * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
          */
            com.codenvy.ide.ext.java.client.internal.core.util.Util.log(e, "Could not retrieve superclass"); //$NON-NLS-1$
    ...
    public ITypeBinding[] getTypeArguments() {
        ...
        if (this.binding.isParameterizedTypeWithActualArguments()) {
            ParameterizedTypeBinding parameterizedTypeBinding = (ParameterizedTypeBinding)this.binding;
            final com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding[] arguments =
    ...
    public ITypeBinding[] getTypeBounds() {
        ...
        if (this.binding instanceof TypeVariableBinding) {
            ...
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding firstClassOrArrayBound =
    ...
    public boolean isCastCompatible(ITypeBinding type) {
        try {
            ...
            if (!(type instanceof TypeBinding))
                return false;
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding expressionType = ((TypeBinding)type).binding;
    ...
    public boolean isEqualTo(IBinding other) {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding otherBinding = ((TypeBinding)other).binding;
        // check return type
    ...
    public boolean isFromSource() {
        if (isClass() || isInterface() || isEnum()) {
            ...
            if (referenceBinding.isRawType()) {
                ...
                com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding erasure = parameterizedTypeBinding.erasure();
            ...
            if (declaringElement instanceof MethodBinding) {
                ...
                final com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding typeBinding =
                        (com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding)declaringElement;
                if (typeBinding instanceof ReferenceBinding) {
                    ...
                    final com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding leafComponentType =
    ...
    public boolean isNullType() {
        return this.binding == com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.NULL;
    }

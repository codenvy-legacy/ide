...
import com.codenvy.ide.ext.java.client.internal.compiler.ast.MemberValuePair;
import com.codenvy.ide.ext.java.client.internal.compiler.impl.Constant;
import com.codenvy.ide.ext.java.client.internal.compiler.lookup.*;
import com.codenvy.ide.ext.java.client.internal.compiler.problem.AbortCompilation;
...
public class DefaultBindingResolver extends BindingResolver {
    ...
    IBinding getBinding(com.codenvy.ide.ext.java.client.internal.compiler.lookup.Binding binding) {
        switch (binding.kind()) {
            case Binding.PACKAGE:
                return getPackageBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.PackageBinding)binding);
            case Binding.TYPE:
            case Binding.BASE_TYPE:
            case Binding.GENERIC_TYPE:
            case Binding.PARAMETERIZED_TYPE:
            case Binding.RAW_TYPE:
                return getTypeBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding)binding);
            case Binding.ARRAY_TYPE:
            case Binding.TYPE_PARAMETER:
                return new TypeBinding(this, (com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding)binding);
            case Binding.METHOD:
                return getMethodBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding)binding);
            case Binding.FIELD:
            case Binding.LOCAL:
                return getVariableBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.VariableBinding)binding);
        }
        return null;
    }

    synchronized com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
        return (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(currentNode);
    }

    /* Method declared on BindingResolver. */
    synchronized IMethodBinding getMethodBinding(
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding methodBinding) {
        if (methodBinding != null && !methodBinding.isValidBinding()) {
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding =
                    (com.codenvy.ide.ext.java.client.internal.compiler.lookup.ProblemMethodBinding)methodBinding;
    ...
    synchronized IPackageBinding getPackageBinding(
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.PackageBinding packageBinding) {
    ...
    /* Method declared on BindingResolver. */
    public ITypeBinding getTypeBinding(com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding referenceBinding) {
            ...
            switch (referenceBinding.problemId()) {
                ...
                case ProblemReasons.NonStaticReferenceInStaticContext:
                    if (referenceBinding instanceof ProblemReferenceBinding) {
                        ...
                        com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding binding2 =
    ...
    synchronized IVariableBinding getVariableBinding(
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.VariableBinding variableBinding,
    ...
    synchronized IVariableBinding getVariableBinding(
        ...
        if (variableBinding != null) {
            if (variableBinding.isValidBinding()) {
                com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding variableType = variableBinding.type;
    ...
    synchronized IAnnotationBinding getAnnotationInstance(
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.AnnotationBinding internalInstance) {
    ...
    boolean isResolvedTypeInferredFromExpectedType(MethodInvocation methodInvocation) {
        ...
        if (oldNode instanceof MessageSend) {
            ...
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding methodBinding = messageSend.binding;
    ...
    /** @see com.codenvy.ide.ext.java.client.core.dom.BindingResolver#recordScope(ASTNode, BlockScope) */
    ...
    boolean resolveBoxing(Expression expression) {
        com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode node =
                (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
        if (node instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.Expression) {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.Expression compilerExpression =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.Expression)node;
    ...
    synchronized IMethodBinding resolveConstructor(ClassInstanceCreation expression) {
        com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode node =
                (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
        if (node != null && (node.bits & com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration =
    ...
    IMethodBinding resolveConstructor(EnumConstantDeclaration enumConstantDeclaration) {
        com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode node =
                (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(enumConstantDeclaration);
        if (node instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.FieldDeclaration) {
            ...
            switch (expression.getNodeType()) {
                case ASTNode.CLASS_INSTANCE_CREATION:
                    com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode astNode =
                            (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
                    if (astNode instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration) {
                        // anonymous type case
                        com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration typeDeclaration =
                                (com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration)astNode;
                ...
                case ASTNode.SINGLE_MEMBER_ANNOTATION:
                    com.codenvy.ide.ext.java.client.internal.compiler.ast.Expression compilerExpression =
                            (com.codenvy.ide.ext.java.client.internal.compiler.ast.Expression)this.newAstToOldAst.get(expression);
    ...
    synchronized IBinding resolveImport(ImportDeclaration importDeclaration) {
        ...
        try {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode node =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(importDeclaration);
            if (node instanceof ImportReference) {
                ImportReference importReference = (ImportReference)node;
                final boolean isStatic = importReference.isStatic();
                if ((importReference.bits & com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode.OnDemand) != 0) {
                    Binding binding =
                            this.scope.getImport(
                                    CharOperation.subarray(importReference.tokens, 0, importReference.tokens.length), true, isStatic);
                    if (binding != null) {
                        if (isStatic) {
                            if (binding instanceof com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding) {
                                ITypeBinding typeBinding =
                                        this.getTypeBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding)binding);
                                return typeBinding == null ? null : typeBinding;
                            }
                        } else {
                            if ((binding.kind() & Binding.PACKAGE) != 0) {
                                IPackageBinding packageBinding =
                                        getPackageBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.PackageBinding)binding);
                                if (packageBinding == null) {
                                    return null;
                                }
                    ...
                    if (binding != null) {
                        if (isStatic) {
                            ...
                            } else if (binding instanceof com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding) {
                                // it is a type
                                return getMethodBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding)binding);
                            }
                        } else {
    ...
    synchronized ITypeBinding resolveTypeBindingForName(Name name) {
        com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode node =
                (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(name);
        ...
        if (node instanceof QualifiedNameReference) {
            ...
            if (index < indexOfFirstFieldBinding) {
                ...
                if (binding instanceof com.codenvy.ide.ext.java.client.internal.compiler.lookup.PackageBinding) {
                    return null;
                } else if (binding instanceof com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding) {
                    // it is a type
                    return this.getTypeBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding)binding);
                }
                ...
                if (qualifiedNameReference.isTypeReference()) {
                    ...
                    if (fieldBinding == null)
                        return null;
                    com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding type = fieldBinding.declaringClass;
                    if (type == null) { // array length scenario
                        ...
                        switch (qualifiedNameReference.bits
                                & com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode.RestrictiveFlagMASK) {
                            case Binding.FIELD:
                        ...
                        binding =
                                this.scope.getImport(CharOperation.subarray(importReference.tokens, 0, index),
                                                     (importReference.bits &
                                                      com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode.OnDemand) != 0,
        ...
        if (node instanceof SingleNameReference) {
            ...
            com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding binding = singleTypeReference.resolvedType;
            if (binding != null) {
        ...
        } else if (node instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeParameter) {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeParameter typeParameter =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeParameter)node;
            return this.getTypeBinding(typeParameter.binding);
        } else if (node instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.MemberValuePair) {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.MemberValuePair memberValuePair =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.MemberValuePair)node;
    ...
    synchronized IBinding resolveName(Name name) {
        ...
        if (node instanceof QualifiedNameReference) {
                ...
                if (qualifiedNameReference.isTypeReference()) {
                    ...
                    if (binding != null) {
                        if (binding.isValidBinding()) {
                            return this
                                    .getVariableBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.VariableBinding)binding);
            ...
            if (index >= 0) {
                ...
                if (binding != null) {
                    if (binding instanceof com.codenvy.ide.ext.java.client.internal.compiler.lookup.PackageBinding) {
                        ...
                        // it is a type
                        return this.getTypeBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding)binding);
                    } else if (binding instanceof com.codenvy.ide.ext.java.client.internal.compiler.lookup.FieldBinding) {
                        // it is a type
                        return this.getVariableBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.FieldBinding)binding);
                    } else if (binding instanceof com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding) {
                        // it is a type
                        return getMethodBinding((com.codenvy.ide.ext.java.client.internal.compiler.lookup.MethodBinding)binding);
                    } else {
            ...
            com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration[] types = compilationUnitDeclaration.types;
            if (types == null || types.length == 0) {
                return null;
            }
            com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration type = types[0];
            if (type != null) {
    ...
    synchronized IPackageBinding resolvePackage(PackageDeclaration pkg) {
        ...
        try {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode node =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(pkg);
            if (node instanceof ImportReference) {
                ImportReference importReference = (ImportReference)node;
                Binding binding =
    ...
    synchronized IBinding resolveReference(MemberRef ref) {
        com.codenvy.ide.ext.java.client.internal.compiler.ast.Expression expression =
                (com.codenvy.ide.ext.java.client.internal.compiler.ast.Expression)this.newAstToOldAst.get(ref);
    ...
    synchronized IMemberValuePairBinding resolveMemberValuePair(
            com.codenvy.ide.ext.java.client.core.dom.MemberValuePair memberValuePair) {
    ...
    ITypeBinding resolveType(AnnotationTypeDeclaration type) {
        ...
        if (node instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration) {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration typeDeclaration =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration)node;
            ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
            if (typeBinding == null) {
    ...
    synchronized ITypeBinding resolveType(AnonymousClassDeclaration type) {
        com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode node =
                (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(type);
        if (node != null && (node.bits & com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeDeclaration)node;
    ...
    synchronized ITypeBinding resolveType(Type type) {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode node =
                (com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(type);
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding binding = null;
        if (node != null) {
            if (node instanceof ParameterizedQualifiedTypeReference) {
                ...
                com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding typeBinding = typeReference.resolvedType;
                if (type.isArrayType()) {
                    if (this.scope == null) {
                        return null;
                    }
          ...
          */
            if (((PrimitiveType)type).getPrimitiveTypeCode() == PrimitiveType.VOID) {
                return this.getTypeBinding(com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.VOID);
            }
        }
        return null;
    }
    ...
    synchronized ITypeBinding resolveTypeParameter(TypeParameter typeParameter) {
        ...
        if (node instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeParameter) {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeParameter typeParameter2 =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.TypeParameter)node;
    ...
    synchronized IVariableBinding resolveVariable(VariableDeclaration variable) {
        ...
        if (node instanceof AbstractVariableDeclaration) {
            ...
            if (abstractVariableDeclaration instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.FieldDeclaration) {
                com.codenvy.ide.ext.java.client.internal.compiler.ast.FieldDeclaration fieldDeclaration =
                        (com.codenvy.ide.ext.java.client.internal.compiler.ast.FieldDeclaration)abstractVariableDeclaration;
    ...
    synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode) {
        ...
        if (oldNode instanceof com.codenvy.ide.ext.java.client.internal.compiler.ast.Annotation) {
            com.codenvy.ide.ext.java.client.internal.compiler.ast.Annotation internalAstNode =
                    (com.codenvy.ide.ext.java.client.internal.compiler.ast.Annotation)oldNode;
    ...
    /* Method declared on BindingResolver. */
    synchronized void store(ASTNode node, com.codenvy.ide.ext.java.client.internal.compiler.ast.ASTNode oldASTNode) {
    ...
    ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions) {
        ...
        com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding leafTypeBinding = null;
        if (leafComponentType.isPrimitive()) {
            String name = leafComponentType.getBinaryName();
            switch (name.charAt(0)) {
                case 'I':
                    leafTypeBinding = com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.INT;
                    break;
                case 'B':
                    leafTypeBinding = com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.BYTE;
                    break;
                case 'Z':
                    leafTypeBinding = com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.BOOLEAN;
                    break;
                case 'C':
                    leafTypeBinding = com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.CHAR;
                    break;
                case 'J':
                    leafTypeBinding = com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.LONG;
                    break;
                case 'S':
                    leafTypeBinding = com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.SHORT;
                    break;
                case 'D':
                    leafTypeBinding = com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.DOUBLE;
                    break;
                case 'F':
                    leafTypeBinding = com.codenvy.ide.ext.java.client.internal.compiler.lookup.TypeBinding.FLOAT;
                    break;
                case 'V':

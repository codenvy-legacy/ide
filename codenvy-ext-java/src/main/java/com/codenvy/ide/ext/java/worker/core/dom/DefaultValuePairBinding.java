...
class DefaultValuePairBinding extends MemberValuePairBinding {
    ...
    private com.codenvy.ide.ext.java.worker.internal.compiler.lookup.MethodBinding method;

    DefaultValuePairBinding(com.codenvy.ide.ext.java.worker.internal.compiler.lookup.MethodBinding binding,

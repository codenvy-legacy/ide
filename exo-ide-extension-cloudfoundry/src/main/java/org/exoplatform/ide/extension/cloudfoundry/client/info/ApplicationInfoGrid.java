...
{
   private final String ID = "ideCloudFoundryApplicationInfoGrid";
   
   private final String NAME = CloudFoundryExtension.LOCALIZATION_CONSTANT.applicationInfoListGridNameField();
   
   private final String VALUE = CloudFoundryExtension.LOCALIZATION_CONSTANT.applicationInfoListGridValueField();

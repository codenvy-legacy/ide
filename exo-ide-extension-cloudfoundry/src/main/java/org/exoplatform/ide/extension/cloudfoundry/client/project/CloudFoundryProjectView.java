...
public class CloudFoundryProjectView extends ViewImpl implements CloudFoundryProjectPresenter.Display {
    ...
    /** @see org.exoplatform.ide.extension.cloudfoundry.client.project.CloudFoundryProjectPresenter.Display#setApplicationURLs(java.util
     * .List) */
    @Override
    ...
    /** @see org.exoplatform.ide.extension.cloudfoundry.client.project.CloudFoundryProjectPresenter.Display#setStartButtonEnabled
     * (boolean) */
    @Override
    ...
    /** @see org.exoplatform.ide.extension.cloudfoundry.client.project.CloudFoundryProjectPresenter.Display#setRestartButtonEnabled
     * (boolean) */
    @Override

...
import static com.codenvy.ide.rest.MimeType.TEXT_CSS;
...
/**
 * Testing {@link NewCSSFileProvider} functionality.
 *
...
public class NewCSSFileProviderTest {
    ...
    @Mock
    private CssExtensionResource    resource;
    private NewCSSFileProvider      newCSSFileProvider;
    private String                  cssFileName;

    @Before
    public void setUp() {
        newCSSFileProvider = new NewCSSFileProvider(resource);

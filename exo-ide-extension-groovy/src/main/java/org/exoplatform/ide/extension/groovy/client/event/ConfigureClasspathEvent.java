...
public class ConfigureClasspathEvent extends GwtEvent<ConfigureClasspathHandler>
{
   ...
   @Override
   public com.google.gwt.event.shared.GwtEvent.Type<ConfigureClasspathHandler> getAssociatedType()
   {
      return TYPE;
   }

   @Override
   protected void dispatch(ConfigureClasspathHandler handler)
   {
      handler.onConfigureClasspath(this);
   }

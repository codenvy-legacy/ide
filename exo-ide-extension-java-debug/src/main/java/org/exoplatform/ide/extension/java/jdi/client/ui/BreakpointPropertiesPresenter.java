...
import org.exoplatform.ide.extension.java.jdi.client.events.ShowBreakpointPropertiesHandler;
                     ...
                     DebuggerClientService.getInstance().addBreakPoint(debuggerInfo.getId(), currentBreakPoint,
                        new AsyncRequestCallback<BreakPoint>()
                        {
                           ...
                           protected void onFailure(Throwable exception)
                           {
                              ...
                              IDE.fireEvent(new OutputEvent("Can't save breakpoint properties", Type.ERROR));
                           }
                        });
                  }

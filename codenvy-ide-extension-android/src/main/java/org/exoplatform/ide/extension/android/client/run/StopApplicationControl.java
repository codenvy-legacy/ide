...
public class StopApplicationControl extends SimpleControl implements IDEControl, ProjectClosedHandler,
    ...
    public static final String ID = "Run/Stop Android Application";

    private static final String TITLE = AndroidExtension.LOCALIZATION.stopApplicationControlTitle();

    private static final String PROMPT = AndroidExtension.LOCALIZATION.stopApplicationControlPrompt();

    public StopApplicationControl() {
        super(ID);
        setTitle(TITLE);
        setPrompt(PROMPT);
        setImages(AndroidExtensionClientBundle.INSTANCE.stopApp(), AndroidExtensionClientBundle.INSTANCE.stopAppDisabled());

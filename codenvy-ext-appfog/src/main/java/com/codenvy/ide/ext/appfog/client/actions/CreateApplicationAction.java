...
public class CreateApplicationAction extends Action {
    ...
    @Inject
    public CreateApplicationAction(CreateApplicationPresenter presenter, AppfogResources resources, ResourceProvider resourceProvider) {
        super("Create Application...", "Create new application on appfog.com", resources.createApp());

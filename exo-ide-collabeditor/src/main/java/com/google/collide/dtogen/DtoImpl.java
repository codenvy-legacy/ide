...
abstract class DtoImpl {
   ...
   *
   * <p>For compact DTO (see {@link com.google.collide.dtogen.shared.CompactJsonDto}) methods are ordered
   * corresponding to {@link com.google.collide.dtogen.shared.SerializationIndex} annotation.
   *

 ...
 * a new {@link com.google.collide.dtogen.shared.ServerToClientDto} on the client. And similarly, you aren't
 * allowed to construct a {@link com.google.collide.dtogen.shared.ClientToServerDto} on the server.
 *
 */
public class DtoTemplate {
   ...
   *         {@link com.google.collide.dtogen.shared.ClientToServerDto}.
   */
  ...
  /**
   * @return whether or not the specified interface implements
   *         {@link com.google.collide.dtogen.shared.ServerToClientDto}.
   */
  ...
  /**
   * @return whether or not the specified interface implements
   *         {@link com.google.collide.dtogen.shared.RoutableDto}.
   */
  ...
  /**
   * Extracts the {@link com.google.collide.dtogen.shared.RoutingType} annotation to derive the stable
   * routing type.
   */

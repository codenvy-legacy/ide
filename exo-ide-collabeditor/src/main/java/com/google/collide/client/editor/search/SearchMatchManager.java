...
public class SearchMatchManager {
     ...
     *
     * @param startIndex
     *         The boundary to find the next match after.
     * @param endIndex
     *         The boundary to find the next match before.
     ...
     *
     * @param startIndex
     *         The boundary to find a previous match after.
     * @param endIndex
     *         The boundary to find a previous match before.

 ...
 * </p>
 */
public class CenterPanel extends UiComponent<View>
{
   ...
   *
   * @param selectAndFocusElement an {@link com.google.gwt.dom.client.InputElement} to select and focus on when the panel is

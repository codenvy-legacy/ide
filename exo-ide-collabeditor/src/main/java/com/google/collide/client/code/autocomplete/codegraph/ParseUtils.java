...
import static com.google.collide.codemirror2.TokenType.*;
...
public class ParseUtils {
     ...
     *
     * @param tokens
     *         source tokens array; destroyed in runtime.
     * @param expectingPeriod
     *         state before parsing:
     *         {@code true} if period token is expected
     * @param contextParts
     *         output collector; only ids are collected
     ...
     *
     * @param <T>
     *         language-specific {@link State} type.
     */

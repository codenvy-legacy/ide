...
public class IncomingDocOpDemultiplexer {
  ...
  private final MessageRecipient<ServerToClientDocOpImpl> messageReceiver =
  ...
  private final MessageRecipient<ServerToClientDocOpsImpl> bulkMessageReceiver =
  ...
  /**
   * Adds a {@link com.google.collide.client.collaboration.IncomingDocOpDemultiplexer.Receiver} that will receive all DocOp messages.
   */

...
public class EditorPopupController {
     ...
     *
     * @param lineInfo
     *         the line to anchor the popup to
     * @param startColumn
     *         start column in the line, inclusive
     * @param endColumn
     *         end column in the line, inclusive
     * @param textCssClassName
     *         class name to highlight the anchor, or {@code null}
     *         if this is not needed
     * @param renderer
     *         the popup renderer
     * @param popupPartnerElements
     *         array of partner element of the popup
     ...
     * @param verticalAlign
     *         vertical align of the popup related to the line
     * @param shouldCaptureOutsideClickOnClose
     *         whether the popup should capture

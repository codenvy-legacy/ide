...
public class GenericOperationChannel<M> implements RevisionProvider {
     ...
     * {@link com.google.collide.client.collaboration.cc.GenericOperationChannel#receive()}
     */
    public interface Listener<M> {
        /**
         * A remote op has been received. Do not use the parameter to apply to local
         * state, instead use {@link com.google.collide.client.collaboration.cc.GenericOperationChannel#receive()}.
         *
         * @param serverHistoryOp
         *         the operation as it appears in the server history

 ...
 * {@link #consume(java.util.List, String, int, com.google.collide.dto.DocumentSelection)}.
 * <p/>
 * <p/>
...
public class VersionedDocument {
    ...
    /** A simple class for the result of the {@link com.google.collide.server.documents.VersionedDocument#consume} method. */
    public static class ConsumeResult {
         ...
         *
         * @see com.google.collide.dto.ClientToServerDocOp#getSelection()
         */
...
//  private final Logger logger;
    ...
    /** Constructs a new {@link com.google.collide.server.documents.VersionedDocument} with the given contents and revision number */
...
//    this.logger = logger;
    ...
    /**
     * Constructs a new {@link com.google.collide.server.documents.VersionedDocument} with the given initial contents. The revision number
     * starts at zero.
     */
    ...
    /**
     * Applies the given list of {@link com.google.collide.dto.DocOp DocOps} to the backing document.
     *
     * @param docOps
     *         the list of {@code DocOp}s being applied
     * @param authorClientId
     *         clientId who sent the doc ops
     * @param intendedCcRevision
     *         the revision of the document that the DocOps are intended to be
     *         applied to
     * @param selection
     ...
     * {@link #consume(java.util.List, String, int, com.google.collide.dto.DocumentSelection)} takes care of acquiring/releasing the
...
//          startingCcRevision, docOpHistory.size()));
    ...
    /**
     * @param column
     *         the column of the anchor, or {@link com.google.collide.shared.document.anchor.AnchorManager#IGNORE_COLUMN} for a line
     *         anchor
     */

...
//    this.logger = logger;
   ...
   *        applied to
   * @param selection see {@link com.google.collide.dto.ClientToServerDocOp#getSelection()}
...
//          startingCcRevision, docOpHistory.size()));
  ...
  /**
   * @param column the column of the anchor, or {@link com.google.collide.shared.document.anchor.AnchorManager#IGNORE_COLUMN} for a line
   *        anchor
   */

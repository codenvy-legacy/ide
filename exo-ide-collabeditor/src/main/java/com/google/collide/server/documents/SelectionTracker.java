...
public class SelectionTracker {
     ...
     *
     * @param clientId
     *         the ID for the user's tab
     * @param resourceId
     *         the key for the file edit session that holds the active selection
     * @param documentSelection
     *         the position of the selection after any mutations currently being
     *         processed
     */
            ...
            if (userSelection.resourceId.equals(resourceId)) {
                ...
                if (cursorAnchor != null && baseAnchor != null) {
                    FilePositionImpl basePosition = FilePositionImpl.make()
                                                                    .setColumn(baseAnchor.getColumn())
                                                                    .setLineNumber(baseAnchor.getLineNumber());

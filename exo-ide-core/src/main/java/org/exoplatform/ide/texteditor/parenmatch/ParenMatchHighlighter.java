...
package org.exoplatform.ide.texteditor.parenmatch;
...
import org.exoplatform.ide.texteditor.renderer.SingleChunkLineRenderer;
import org.exoplatform.ide.texteditor.search.SearchTask;
import org.exoplatform.ide.texteditor.search.SearchTask.SearchDirection;
...
public class ParenMatchHighlighter
{
   ...
   {
      @Source({"ParenMatchHighlighter.css", "org/exoplatform/ide/texteditor/constants.css"})

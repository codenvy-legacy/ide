...
import static org.exoplatform.ide.text.store.util.LineUtils.getLastCursorColumn;
import static org.exoplatform.ide.text.store.util.LineUtils.rubberbandColumn;
...
import org.exoplatform.ide.text.store.anchor.AnchorUtils;
import org.exoplatform.ide.text.store.anchor.InsertionPlacementStrategy;
...
public class SelectionModel implements Buffer.MouseDragListener
{
   ...
   public void setSelection(LineInfo baseLineInfo, int baseColumn, LineInfo cursorLineInfo, int cursorColumn)
   {
      ...
      Assert.isLegal(cursorColumn <= lastCursorColumn, "The cursor column is out-of-bounds. Expected <= "
         + lastCursorColumn + ", got " + cursorColumn + ", line " + cursorLineInfo.number());

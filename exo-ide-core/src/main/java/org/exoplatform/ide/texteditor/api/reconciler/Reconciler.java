 ...
 * of the text display document in the presence of changes applied to this
 * document.
...
public interface Reconciler
{
   ...
   /**
    * Installs the reconciler on the given text display. After this method has been
    ...
    *
    * @param display the display on which the reconciler is installed
    */
   void install(TextEditorPartDisplay display);

   /**
    * Removes the reconciler from the text display it has

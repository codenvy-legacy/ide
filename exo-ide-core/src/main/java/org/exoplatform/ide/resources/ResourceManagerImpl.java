...
public class ResourceManagerImpl implements ResourceManager
{
    ...
    */
   @Inject
   public ResourceManagerImpl(EventBus eventBus, ModelProvider genericModelProvider, Loader loader)
   {
      ...
      AsyncRequestCallback<VirtualFileSystemInfo> internalCallback =
         new AsyncRequestCallback<VirtualFileSystemInfo>(new VFSInfoUnmarshaller(new VirtualFileSystemInfo()))
         {
            ...
            protected void onSuccess(VirtualFileSystemInfo result)
            {
               vfsInfo = result;
               initialized = true;
               eventBus.fireEvent(new ComponentLifecycleEvent(ResourceManagerImpl.this, LifecycleState.STARTED));
   ...
   {
      eventBus.fireEvent(new ComponentLifecycleEvent(ResourceManagerImpl.this, LifecycleState.FAILED));

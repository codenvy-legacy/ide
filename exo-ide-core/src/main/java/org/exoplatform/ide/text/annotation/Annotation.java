 ...
 */
package org.exoplatform.ide.text.annotation;
 ...
 * type are of type <code>"org.exoplatform.ide.text.annotation.unknown"</code>.
 * </p>
 */
public class Annotation
{
    ...
    * Value: <code>"org.exoplatform.ide.text.annotation.unknown"</code>
    */
   public final static String TYPE_UNKNOWN = "org.exoplatform.ide.text.annotation.unknown"; //$NON-NLS-1$

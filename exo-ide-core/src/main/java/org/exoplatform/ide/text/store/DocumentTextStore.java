...
public class DocumentTextStore extends DocumentModel implements TextStore
{
   ...
   /**
    * @see org.exoplatform.ide.text.TextStore#get(int)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.text.TextStore#get(int, int)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.text.TextStore#getLength()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.text.TextStore#replace(int, int, java.lang.String)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.text.TextStore#set(java.lang.String)
    */
   @Override

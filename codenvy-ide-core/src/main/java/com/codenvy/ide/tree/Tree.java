 ...
 * {@link com.codenvy.ide.tree.NodeDataAdapter} and
 * {@link com.codenvy.ide.tree.NodeRenderer}.
 *
...
public class Tree<D> extends UiComponent<Tree.View<D>> implements IsWidget
{
   ...
   @SuppressWarnings({"rawtypes", "unchecked"})
   public static Tree<Resource> create(com.codenvy.ide.Resources resources)
   {
      View view = new View(resources);

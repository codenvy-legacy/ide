...
import com.codenvy.ide.menu.BottomMenuView;
import com.codenvy.ide.menu.BottomMenuViewImpl;
...
//        themeBinder.addBinding().to(LightTheme.class);
        ...
        bind(BottomMenuView.class).to(BottomMenuViewImpl.class).in(Singleton.class);

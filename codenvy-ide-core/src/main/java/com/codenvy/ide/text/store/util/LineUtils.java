...
public final class LineUtils
{
   ...
   */
   ...
   {
      Anchor anchorWithLineNumber = line.getDocument().getAnchorManager().findAnchorWithLineNumber(line);
   ...
   static Position getPositionBackwards(Line line, int lineNumber, int column, int numCharsToTraverse)
   {
         ...
         if (remainingCharsOnThisLine < numCharsToTraverse)
         {
            ...
            if (line == null)
            {
               throw new PositionOutOfBoundsException(
                  "Reached the document beginning, but still wanted to go " + numCharsToTraverse + " characters backwards.");
            }
            lineNumber--;
   ...
   static Position getPositionForward(Line line, int lineNumber, int column, int numCharsToTraverse)
   {
       ...
       */
         if (remainingCharsOnThisLine <= numCharsToTraverse)
         {
           ...
           */
               ...
               {
                  throw new PositionOutOfBoundsException(
                     "Reached the document end, but still wanted to go " + (numCharsToTraverse - remainingCharsOnThisLine) + " characters forward.");
               }
               else
               {
                  column += numCharsToTraverse;

...
public class Anchor implements ReadOnlyAnchor
{
   ...
   private InsertionPlacementStrategy insertionPlacementStrategy = InsertionPlacementStrategy.DEFAULT;
   ...
   void dispatchShifted()
   {
      if (shiftListenerManager != null)
      {
         shiftListenerManager.dispatch(new Dispatcher<Anchor.ShiftListenerImpl<? extends ReadOnlyAnchor>>()
         {
            @SuppressWarnings("unchecked")
            @Override
   ...
   public void dispatchMoved()
   {
      if (moveListenerManager != null)
      {
         moveListenerManager.dispatch(new Dispatcher<Anchor.MoveListenerImpl<? extends ReadOnlyAnchor>>()
         {
            @SuppressWarnings("unchecked")
            @Override
   ...
   void dispatchRemoved()
   {
      if (removeListenerManager != null)
      {
         removeListenerManager.dispatch(new Dispatcher<Anchor.RemoveListenerImpl<? extends ReadOnlyAnchor>>()
         {
            @SuppressWarnings("unchecked")
            @Override

...
public interface InsertionPlacementStrategy
{
    ...
    */
   public static final InsertionPlacementStrategy EARLIER = new InsertionPlacementStrategy()
   {
      @Override
    ...
    */
   public static final InsertionPlacementStrategy LATER = new InsertionPlacementStrategy()
   {
      @Override
      public Placement determineForInsertion(Anchor anchor, Line line, int column)
      {
    ...
    * the insertion.
    */
   public static final InsertionPlacementStrategy DEFAULT = new InsertionPlacementStrategy()
   {
      @Override
      public Placement determineForInsertion(Anchor anchor, Line line, int column)
      {
         InsertionPlacementStrategy currentStrategy = anchor.isLineAnchor() ? EARLIER : LATER;

...
public class FocusManager
{
   ...
   private final ListenerManager<FocusManager.FocusListener> focusListenerManager = ListenerManager.create();
   ...
   private void attachEventHandlers(Buffer buffer)
   {
      ...
      {
         private final Dispatcher<FocusManager.FocusListener> dispatcher = new Dispatcher<FocusManager.FocusListener>()
         {
            @Override

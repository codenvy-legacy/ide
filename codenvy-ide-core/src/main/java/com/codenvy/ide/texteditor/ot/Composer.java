...
public class Composer {
    ...
    private class ProcessingAForBDelete extends ProcessingA {
        ...
        private void cancel(int count) {
            Assert.isLegal(count <= bDeleteText.length(),
    ...
    private class ProcessingAForBRetain extends ProcessingA {
        ...
        private void cancel(int count) {
            Assert.isLegal(count <= bRetainCount,
                           "Cannot cancel if A's component is longer than B's");
    ...
    /**
     * @param startWithSpecificProcessingAState
     *         the allows the caller to begin the
    ...
    /**
     * @param remainingBRetainLineCount
     *         the remaining retain line count of B

 ...
 */
@Provider
public class RemoteFileServiceExceptionMapper implements ExceptionMapper<RemoteFileServiceException>
{

   /**
    * @see javax.ws.rs.ext.ExceptionMapper#toResponse(java.lang.Throwable)
    */
   public Response toResponse(RemoteFileServiceException exception)
   {

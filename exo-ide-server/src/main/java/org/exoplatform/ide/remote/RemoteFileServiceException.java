...
public class RemoteFileServiceException extends Exception
{
    ...
    * @param cause the cause
    */
   public RemoteFileServiceException(int status, String message, Throwable cause)
   {
      super(message, cause);
      this.status = status;
   }
    ...
    * @param message the detail message about exception
    */
   public RemoteFileServiceException(int status, String message)
   {
      super(message);
      this.status = status;
   }

 ...
 *
 */
public final class CodeAssitantImages
{
   ...
   static
   {
      ...
      images.put(TokenExtType.CONSTRUCTOR, GroovyPluginImageBundle.INSTANCE.publicMethod());
      images.put(TokenExtType.METHOD, GroovyPluginImageBundle.INSTANCE.publicMethod());
      images.put(TokenExtType.FIELD, GroovyPluginImageBundle.INSTANCE.publicField());
   }

   ...
   JavaCodeAssistantErrorHandler, EditorActiveFileChangedHandler
{
   ...
   public void initialize()
   {
      ...
      IDE.getInstance().addControl(
         new NewItemControl("File/New/New Data Object", "Data Object", "Create Data Object",
            Images.CHROMATTIC, MimeType.CHROMATTIC_DATA_OBJECT), DockTarget.NONE, false);
   }
   ...
   public void onInitializeServices(InitializeServicesEvent event)
   {
      ...
      IDE.getInstance().      addEditor(new CodeMirrorProducer(MimeType.CHROMATTIC_DATA_OBJECT, "CodeMirror Data Object editor", "groovy", true,

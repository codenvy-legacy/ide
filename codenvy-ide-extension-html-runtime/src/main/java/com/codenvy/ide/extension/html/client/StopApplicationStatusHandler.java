...
public class StopApplicationStatusHandler implements RequestStatusHandler {
    ...
    public void requestInProgress(String id) {
        ...
        job.setStartMessage(HtmlRuntimeExtension.HTML_LOCALIZATION_CONSTANTS.stoppingProjectMessage(projectName));
    ...
    public void requestFinished(String id) {
        ...
        job.setFinishMessage(HtmlRuntimeExtension.HTML_LOCALIZATION_CONSTANTS.projectStoppedMessage(projectName));
        IDE.fireEvent(new JobChangeEvent(job));
    }

...
{
   //
   //   public ConstructorInfoBuilder(int access, String[] exceptions, Type[] parameters, Type declaredClass)
   //   {
   //      super(access, declaredClass.getInternalName(), exceptions, parameters, declaredClass);
   //   }
   //

...
public abstract class RoutineInfoBuilder extends MemberInfoBuilder
{
   ...
   //
   //   protected Type declaredClass;
   //
   //   protected String[] exceptions;
   //
   //   private final String methodName;
   //
   //   public RoutineInfoBuilder(int access, String methodName, String[] exceptions, Type[] parameters, Type declaredClass)
   //   {
   ...
   //      routineInfo.setName(methodName);
   //      routineInfo.setDeclaringClass(declaredClass.getInternalName());
   //      if (exceptions != null)
   //      {

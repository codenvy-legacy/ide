...
public class TypeInfoBuilder extends MemberInfoBuilder
{
   ...
   //
   //   public TypeInfoBuilder(int access, Type typeName, String superName, String[] interfaces)
   //   {
   //      //TODO make it short
   //      super(access, typeName.getInternalName());
   //      this.typeName = typeName;
   //      this.qualifiedName = typeName.getClassName();
   //      if (superName != null)
   //      {

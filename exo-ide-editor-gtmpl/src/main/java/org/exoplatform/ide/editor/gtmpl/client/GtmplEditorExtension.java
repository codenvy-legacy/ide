    ...
    public void initialize() {
        ...
        IDE.getInstance().addControl(
                new NewItemControl("File/New/New Template", "Template", "Create Template", Images.GROOVY_TEMPLATE,
                                   MimeType.GROOVY_TEMPLATE).setGroupName(GroupNames.NEW_SCRIPT));
    }
                ...
                new EditorCreator() {
                    ...
                    public Editor createEditor() {
                        return new CodeMirror(MimeType.GROOVY_TEMPLATE, new CodeMirrorConfiguration()
                                .setGenericParsers(
                                        "['parsegtmpl.js', 'parsecss.js', 'tokenizejavascript.js', 'parsejavascript.js', " +
                                        "'tokenizegroovy.js', 'parsegroovy.js', 'parsegtmplmixed.js']")
                                .setGenericStyles(
...
//            .setGenericParsers("['parsegtmpl.js', 'parsecss.js', 'tokenizejavascript.js', 'parsejavascript.js', 'tokenizegroovy.js',
// 'parsegroovy.js', 'parsegtmplmixed.js']")
      ...
      IDE.getInstance()
         .addEditor(
            new CodeMirrorProducer(
               ...
               new CodeMirrorConfiguration()
                  .setGenericParsers(
                     "['parsegtmpl.js', 'parsecss.js', 'tokenizejavascript.js', 'parsejavascript.js', 'tokenizegroovy.js',
                     'parsegroovy.js', 'parsegtmplmixed.js']")
                  .setGenericStyles(
                     "['" + CodeMirrorConfiguration.PATH + "css/gtmplcolors.css', '" + CodeMirrorConfiguration.PATH
                        + "css/jscolors.css', '" + CodeMirrorConfiguration.PATH + "css/csscolors.css', '"

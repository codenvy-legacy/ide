 ...
 * @version $Id: $
 */
public final class FileTaskLogger implements TaskLogger
{
   private static final Log LOG = ExoLogger.getLogger(FileTaskLogger.class);
    ...
    */
   public FileTaskLogger(File file, InvocationOutputHandler delegate)
   {
      this.file = file;
   ...
   /** @param file the log tile */
   public FileTaskLogger(File file)
   {
      this(file, null);
   }

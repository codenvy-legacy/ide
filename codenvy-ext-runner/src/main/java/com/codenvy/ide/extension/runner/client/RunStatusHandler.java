 ...
 */
public class RunStatusHandler implements RequestStatusHandler {
     ...
     *         project's name
     */
    public RunStatusHandler(String projectName, EventBus eventBus, RunnerLocalizationConstant constant) {
    ...
    public void requestInProgress(String id) {
        ...
        job.setStartMessage(constant.applicationStarting(projectName));
    ...
    public void requestFinished(String id) {
        ...
        job.setFinishMessage(constant.applicationStopped(projectName));
        eventBus.fireEvent(new JobChangeEvent(job));
    }

...
public class VfsCommandTest extends BaseTest
{
   ...
   public void vfsCommands() throws Exception
   {
      ...
      shell.type("cd " + "sr");
      shell.type(Keys.TAB);
      assertThat(shell.getTerm()).contains("cd src/");
      ...
      assertThat(shell.getContent()).contains("/" + MAIN_FOLDER + "/src/org/exoplatform/sample");

      shell.executeCommand("mkdir ../../client");
      shell.executeCommand("cd ../../client");
      shell.executeCommand("pwd");
      assertThat(shell.getContent()).contains("/" + MAIN_FOLDER + "/src/org/client");
      ...
      assertThat(shell.getContent()).doesNotContain("client");
   }
}

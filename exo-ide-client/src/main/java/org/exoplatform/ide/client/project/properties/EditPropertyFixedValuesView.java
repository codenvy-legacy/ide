...
public class EditPropertyFixedValuesView extends ViewImpl implements EditPropertyFixedValuesPresenter.Display {
    ...
    interface EditPropertyFixedValuesViewUiBinder extends UiBinder<Widget, EditPropertyFixedValuesView> {
    }
    ...
    @Override
    public HasValue<String> getValueCombo() {
        return valueField;
    }

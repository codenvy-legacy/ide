...
public class SampleEvent extends GwtEvent<SampleHandler>
{
   ...
   {
      handler.onSampleEvent(this);
   }

   @Override
   public com.google.gwt.event.shared.GwtEvent.Type<SampleHandler> getAssociatedType()
   {
      return TYPE;
   }

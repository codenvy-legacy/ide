 ...
 */
public class CopyTextControl extends SimpleControl implements IDEControl, ShowContextMenuHandler, ViewActivatedHandler,
                                                              EditorActiveFileChangedHandler {
    public static final String ID = "Edit/Copy";

    public static final String TITLE = IDE.IDE_LOCALIZATION_CONSTANT.copyTextControl();

    private boolean isEditorPanelActive = false;

    public CopyTextControl() {
        super(ID);
        setTitle(TITLE);
        setPrompt(TITLE);
        setImages(IDEImageBundle.INSTANCE.copy(), IDEImageBundle.INSTANCE.copyDisabled());
        setEvent(new EditorCopyTextEvent());
    }

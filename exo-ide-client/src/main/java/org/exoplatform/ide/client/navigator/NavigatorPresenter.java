...
public class NavigatorPresenter implements RefreshBrowserHandler, SelectItemHandler, ViewVisibilityChangedHandler,
                                           ...
                                           AddItemTreeIconHandler, RemoveItemTreeIconHandler, ViewActivatedHandler, ShowNavigatorHandler,
                                           VfsChangedHandler,
            ...
            VirtualFileSystem.getInstance().getChildren(folder,
                                                        new AsyncRequestCallback<List<Item>>(
                                                            ...
                                                            protected void onFailure(Throwable exception) {
                                                                ...
                                                                IDE.fireEvent(
                                                                        new ExceptionThrownEvent(exception, RECEIVE_CHILDREN_ERROR_MSG));
                                                            }
                                                            ...
                                                            protected void onSuccess(List<Item> result) {
                                                                ...
                                                                for (Item i : result) {
                                                                    ...
                                                                    } else if (folder instanceof ItemContext &&
                                                                               ((ItemContext)folder).getProject() != null) {
    ...
    /** @see org.exoplatform.ide.client.framework.project.ProjectCreatedHandler#onProjectCreated(org.exoplatform.ide.client.framework

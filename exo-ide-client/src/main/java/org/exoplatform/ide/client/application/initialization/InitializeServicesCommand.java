...
import org.exoplatform.ide.client.application.phases.LoadDefaultEntryPointPhase;
...
public class InitializeServicesCommand implements Command, ConfigurationReceivedSuccessfullyHandler,
   ApplicationSettingsReceivedHandler
{
   ...
   public InitializeServicesCommand(HandlerManager eventBus, ControlsRegistration controls)
   {

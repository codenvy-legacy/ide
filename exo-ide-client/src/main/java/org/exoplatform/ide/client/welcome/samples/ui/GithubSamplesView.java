 ...
 */
package org.exoplatform.ide.client.welcome.samples.ui;
 ...
 *
 */
public class GithubSamplesView extends ViewImpl implements GithubSamplesPresenter.Display
{
    ...
    * 
    */
   interface GithubSamplesViewUiBinder extends UiBinder<Widget, GithubSamplesView>
   {
   }
   ...
   /**
    * @see org.exoplatform.ide.client.welcome.samples.GithubSamplesPresenter.Display#getSamplesListGridAlt()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.welcome.samples.GithubSamplesPresenter.Display#getSelectedItems()
    */
   @Override

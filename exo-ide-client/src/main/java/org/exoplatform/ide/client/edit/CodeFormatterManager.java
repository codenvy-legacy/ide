   ...
   EditorActiveFileChangedHandler
{
   ...
   /**
    * @see org.exoplatform.ide.client.framework.editor.AddCodeFormatterHandler#onAddCodeFormatter(org.exoplatform.ide.client.framework.editor.AddCodeFormatterEvent)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.framework.editor.event.EditorFormatTextHandler#onFormatFile(org.exoplatform.ide.client.framework.editor.event.EditorFormatTextEvent)
    */
   @Override

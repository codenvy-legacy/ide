...
public class CreateProjectView extends ViewImpl implements CreateProjectPresenter.Display
{
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getCancelButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getNextButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getFinishButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getNameField()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#enableNextButton(boolean)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#enableFinishButton(boolean)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#showCreateProjectStep()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#showDeployProjectStep()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#showChooseTemlateStep()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getBackButton()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#setDeployView(com.google.gwt.user.client.ui.Composite)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getTargetGrid()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#setProjectTypes(java.util.List)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getSingleSelectionModel()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#selectTarget(org.exoplatform.ide.client.framework.paas.recent.PaaS)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getTemplatesGrid()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#selectTemplate(org.exoplatform.ide.client.framework.template.ProjectTemplate)
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.client.project.create.recent.CreateProjectPresenter.Display#getErrorLabel()
    */
   @Override

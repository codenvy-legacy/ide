 ...
 * </p>
 * 
 * @see com.codenvy.ide.java.client.core.dom.ASTNode#subtreeMatch(ASTMatcher, Object)
 * @since 2.0
 */
public class ASTMatcher
{
   ...
   public boolean match(AnnotationTypeDeclaration node, Object other)
   {
      ...
      return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc())
         && safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(
   ...
   public boolean match(ArrayCreation node, Object other)
   {
      ...
      return (safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeListMatch(node.dimensions(), o.dimensions()) && safeSubtreeMatch(
   ...
   public boolean match(CompilationUnit node, Object other)
   {
      ...
      return (safeSubtreeMatch(node.getPackage(), o.getPackage()) && safeSubtreeListMatch(node.imports(), o.imports()) && safeSubtreeListMatch(
         node.types(), o.types()));
   }
   ...
   public boolean match(InfixExpression node, Object other)
   {
      ...
      return (node.getOperator().equals(o.getOperator()) && safeSubtreeMatch(node.getLeftOperand(), o.getLeftOperand()) && safeSubtreeMatch(
   ...
   public boolean match(MethodRef node, Object other)
   {
      ...
      return (safeSubtreeMatch(node.getQualifier(), o.getQualifier()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(

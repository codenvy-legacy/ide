...
import com.codenvy.ide.java.client.internal.text.correction.NameMatcher;
...
public class SimilarElementsRequestor extends CompletionRequestor
{
   ...
   public static SimilarElement[] findSimilarElement(Document document,
      com.codenvy.ide.java.client.core.dom.CompilationUnit compilationUnit, Name name, int kind)
   {
   ...
   private SimilarElement[] process(int pos, Document document,
      com.codenvy.ide.java.client.core.dom.CompilationUnit compilationUnit)
   {
      try
      {

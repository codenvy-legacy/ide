...
abstract public class ReferenceBinding extends TypeBinding
{
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#isThrowable() */
    ...
    * 
    * @see com.codenvy.ide.java.client.internal.compiler.lookup.TypeBinding#isUncheckedException(boolean)
    */

...
public abstract class AbstractJavaContextType extends CompilationUnitContextType
{
   ...
   protected static class IterableType extends AbstractIterableType
   {
      ...
      {
         super(
            "iterable_type", "A proposal for the element type of an iterable (array or java.lang.Iterable)", "iterable"); //$NON-NLS-1$ //$NON-NLS-2$
      }
   ...
   protected static class IterableElement extends AbstractIterableElement
   {
      ...
      {
         super(
            "iterable_element", "A proposal for the element name of an iterable (array or java.lang.Iterable)", "iterable"); //$NON-NLS-1$ //$NON-NLS-2$
      }

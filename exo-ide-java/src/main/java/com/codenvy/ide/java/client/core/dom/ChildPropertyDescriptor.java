 ...
 * 
 * @see com.codenvy.ide.java.client.core.dom.ASTNode#getStructuralProperty(StructuralPropertyDescriptor)
 * @see com.codenvy.ide.java.client.core.dom.ASTNode#setStructuralProperty(StructuralPropertyDescriptor, Object)
 * @since 3.0
...
public final class ChildPropertyDescriptor extends StructuralPropertyDescriptor
{
    ...
    * @param cycleRisk <code>true</code> if this property is at risk of cycles, and <code>false</code> if there is no worry about
    *           cycles
    */

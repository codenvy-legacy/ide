...
import com.codenvy.ide.java.client.core.dom.SwitchCase;
...
import com.codenvy.ide.java.client.internal.corext.refactoring.structure.CompilationUnitRewrite;
...
public class CodeStyleFix extends CompilationUnitRewriteOperationsFix
{
   ...
   public static ICleanUpFix createCleanUp(CompilationUnit compilationUnit, Document document,
      boolean addThisQualifier, boolean changeNonStaticAccessToStatic, boolean qualifyStaticFieldAccess,
      boolean changeIndirectStaticAccessToDirect, boolean qualifyMethodAccess, boolean qualifyStaticMethodAccess,
   ...
   {
      return (problem.getProblemId() == IProblem.NonStaticAccessToStaticField || problem.getProblemId() == IProblem.NonStaticAccessToStaticMethod);
   }

   private static ToStaticAccessOperation[] createToStaticAccessOperations(CompilationUnit astRoot,
      HashMap<ASTNode, Block> createdBlocks, IProblemLocation problem, boolean conservative)
   {

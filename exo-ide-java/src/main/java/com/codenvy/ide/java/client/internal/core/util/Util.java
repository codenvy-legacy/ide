...
import com.codenvy.ide.java.client.core.dom.QualifiedType;
import com.codenvy.ide.java.client.core.dom.SimpleType;
import com.codenvy.ide.java.client.core.dom.Type;
import com.codenvy.ide.java.client.core.dom.WildcardType;
...
import com.codenvy.ide.java.client.internal.compiler.ast.UnionTypeReference;
...
public class Util
{
         ...
         switch (current)
         {
            case ARGUMENTS_DELIMITER :
               ...
               else
               {
                  ...
                  {
                     currentArgumentContents = com.codenvy.ide.java.client.internal.compiler.util.Util.EMPTY_STRING;
                  }
   ...
   public static int scanTypeSignature(char[] string, int start)
   {
      ...
      return com.codenvy.ide.java.client.internal.compiler.util.Util.scanTypeSignature(string, start);
   }
   ...
   static void appendTypeSignature(char[] string, int start, StringBuffer buffer, boolean compact)
   {
      ...
      switch (c)
      {
         ...
         case Signature.C_TYPE_VARIABLE :
            int e =
               com.codenvy.ide.java.client.internal.compiler.util.Util.scanTypeVariableSignature(string, start);
   ...
   public static String typeSignature(TypeReference type)
   {
      ...
      if ((type.bits & com.codenvy.ide.java.client.internal.compiler.ast.ASTNode.IsUnionType) != 0)
      {

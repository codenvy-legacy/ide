...
public abstract class CompletionRequestor
{
    ...
    * 
    * @param ignoreAll <code>true</code> to ignore all kinds of completion proposals, and <code>false</code> to propose all kinds
    * 
    * @since 3.4
    */
    ...
    * 
    * @param completionProposalKind one of the kind constants declared on <code>CompletionProposal</code>
    ...
    * 
    * @param completionProposalKind one of the kind constants declared on <code>CompletionProposal</code>
    * @param ignore <code>true</code> if the given kind of completion proposal is ignored by this requestor, and
    ...
    * @param requiredProposalKind one of the kind constants declared on <code>CompletionProposal</code>
    ...
    * @param proposalKind one of the kind constants declared
    * @param requiredProposalKind one of the kind constants declared on <code>CompletionProposal</code>
    * @param allow <code>true</code> if a proposal of a given kind with a required proposal of the given kind is allowed by this
    *           requestor, and <code>false</code> if it isn't of interest

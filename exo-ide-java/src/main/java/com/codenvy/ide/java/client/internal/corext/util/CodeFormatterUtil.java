...
import com.codenvy.ide.java.client.core.formatter.CodeFormatter;
...
public class CodeFormatterUtil
{
    ...
    * @param project the project from which to get the formatter settings, <code>null</code> if the workspace default should be
    *           used
    ...
    * 
    * @param project The project where the source is used, used for project specific options or <code>null</code> if the project
    ...
    * 
    * @param project the project where the source is used or, <code>null</code> if the project is unknown and the workspace
    ...
    * 
    * @param project the project to get the preference from, or <code>null</code> to get the global preference
    ...
    * 
    * @param kind Use to specify the kind of the code snippet to format. It can be any of the kind constants defined in
    *           {@link CodeFormatter}
    * @param source The source to format
    * @param indentationLevel The initial indentation level, used to shift left/right the entire source fragment. An initial
    *           indentation level of zero or below has no effect.
    * @param lineSeparator The line separator to use in formatted source, if set to <code>null</code>, then the platform default
    *           one will be used.
    * @param project The project from which to retrieve the formatter options from If set to <code>null</code>, then use the
    ...
    * @param lineSeparator The line separator to use in formatted source, if set to <code>null</code>, then the platform default
    *           one will be used.
    * @param options The options map to use for formatting with the default code formatter. Recognized options are documented on
    ...
    * </p>
    * 
    * @param kind Use to specify the kind of the code snippet to format. It can be any of K_EXPRESSION, K_STATEMENTS,
    ...
    *           {@link JavaCore#getOptions()}.
    * @return an TextEdit describing the changes required to format source
    * @throws IllegalArgumentException if there is no region, a region overlaps with another region, or the regions are not sorted

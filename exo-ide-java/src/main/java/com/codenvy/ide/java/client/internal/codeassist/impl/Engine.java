...
import com.codenvy.ide.java.client.internal.compiler.impl.ITypeRequestor;
...
import com.codenvy.ide.java.client.internal.compiler.lookup.ImportConflictBinding;
...
import com.codenvy.ide.java.client.internal.compiler.parser.SourceTypeConverter;
         ...
         if (CharOperation.equals(typeName, importName[0]))
         {
            char[] fullyQualifiedTypeName =
               enclosingTypeNames == null || enclosingTypeNames.length == 0 ? CharOperation.concat(packageName,
                  typeName, '.') : CharOperation.concat(CharOperation.concat(packageName, enclosingTypeNames, '.'),
                  typeName, '.');

...
import com.codenvy.ide.java.client.internal.compiler.env.IBinaryNestedType;
...
public class BinaryTypeImpl implements IBinaryType
{
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IGenericType#getModifiers() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IGenericType#isBinaryType() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IDependent#getFileName() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getAnnotations() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getEnclosingMethod() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getEnclosingTypeName() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getFields() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getGenericSignature() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getInterfaceNames() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getMemberTypes() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getMethods() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getMissingTypeNames() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getName() */
   @Override
   public char[] getName()
   {
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getSourceName() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getSuperclassName() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#getTagBits() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#isAnonymous() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#isLocal() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#isMember() */
   @Override
   ...
   /** @see com.codenvy.ide.java.client.internal.compiler.env.IBinaryType#sourceFileName() */
   @Override

...
public abstract class AbstractVariableDeclaration extends Statement implements InvocationSite
{
   ...
   /* (non-Javadoc)
    * @see com.codenvy.ide.java.client.internal.compiler.lookup.InvocationSite#setActualReceiverType(com.codenvy.ide.java.client.internal.compiler.lookup.ReferenceBinding)
    */
   @Override

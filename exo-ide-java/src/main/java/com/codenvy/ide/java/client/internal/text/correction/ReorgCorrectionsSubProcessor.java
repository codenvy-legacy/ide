...
import com.codenvy.ide.java.client.internal.corext.fix.UnusedCodeCleanUp;
...
public class ReorgCorrectionsSubProcessor
{
      ...
      Collection<ICommandAccess> proposals)
   {
      ...
      if (fix != null)
      {
         Image image = new Image(JavaClientBundle.INSTANCE.correction_delete_import());
      ...
      ChangeCorrectionProposal proposal =
         new ChangeCorrectionProposal(name, null, 5, new Image(JavaClientBundle.INSTANCE.correction_change()))
         {
            @Override

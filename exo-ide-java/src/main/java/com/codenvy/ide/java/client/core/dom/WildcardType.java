...
public class WildcardType extends Type
{
   ...
   public static final ChildPropertyDescriptor BOUND_PROPERTY = new ChildPropertyDescriptor(WildcardType.class,
      "bound", Type.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
   ...
   public static final SimplePropertyDescriptor UPPER_BOUND_PROPERTY = new SimplePropertyDescriptor(WildcardType.class,
      "upperBound", boolean.class, MANDATORY); //$NON-NLS-1$
    ...
    * @param isUpperBound <code>true</code> for an upper bound ("? extends B"), and <code>false</code> for a lower bound
    *           ("? super B")
    ...
    * 
    * @param isUpperBound <code>true</code> if an upper bound, and <code>false</code> if a lower bound
    * @see #isUpperBound()
    */

...
import org.exoplatform.ide.java.client.internal.compiler.util.SimpleSetOfCharArray;
...
public class UnresolvedReferenceNameFinder extends ASTVisitor
{
   ...
   private MethodDeclaration findAfter(char[] startWith, Scope s, int from, int to, int maxLineCount,
      boolean outsideEnclosingBlock, char[][] discouragedNames, UnresolvedReferenceNameRequestor nameRequestor)
   {

...
import org.exoplatform.ide.java.client.internal.compiler.impl.ByteConstant;
import org.exoplatform.ide.java.client.internal.compiler.impl.CharConstant;
import org.exoplatform.ide.java.client.internal.compiler.impl.Constant;
import org.exoplatform.ide.java.client.internal.compiler.impl.DoubleConstant;
import org.exoplatform.ide.java.client.internal.compiler.impl.FloatConstant;
import org.exoplatform.ide.java.client.internal.compiler.impl.IntConstant;
import org.exoplatform.ide.java.client.internal.compiler.impl.LongConstant;
...
public class BinaryFieldImpl implements IBinaryField
{
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IGenericField#getModifiers() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryField#getAnnotations() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryField#getTagBits() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryField#getConstant() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryField#getGenericSignature() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryField#getName() */
   @Override
   public char[] getName()
   {
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryField#getTypeName() */
   @Override

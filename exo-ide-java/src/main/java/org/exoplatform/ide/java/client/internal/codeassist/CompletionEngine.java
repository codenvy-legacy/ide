 ...
 *******************************************************************************/
package org.exoplatform.ide.java.client.internal.codeassist;

import org.exoplatform.ide.java.client.core.CompletionContext;
import org.exoplatform.ide.java.client.core.CompletionFlags;
...
import org.exoplatform.ide.java.client.core.search.IJavaSearchConstants;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionNodeDetector;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionNodeFound;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnAnnotationOfType;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnArgumentName;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnBranchStatementLabel;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnClassLiteralAccess;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnExplicitConstructorCall;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnFieldName;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnFieldType;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnImportReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadoc;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadocAllocationExpression;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadocFieldReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadocMessageSend;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadocParamNameReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadocQualifiedTypeReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadocSingleTypeReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadocTag;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnJavadocTypeParamReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnKeyword;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnLocalName;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnMarkerAnnotationName;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnMemberAccess;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnMemberValueName;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnMessageSend;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnMessageSendName;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnMethodName;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnMethodReturnType;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnPackageReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnParameterizedQualifiedTypeReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnQualifiedAllocationExpression;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnQualifiedNameReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnQualifiedTypeReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnSingleNameReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnSingleTypeReference;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionOnStringLiteral;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionParser;
import org.exoplatform.ide.java.client.internal.codeassist.complete.CompletionScanner;
import org.exoplatform.ide.java.client.internal.codeassist.complete.InvalidCursorLocation;
import org.exoplatform.ide.java.client.internal.codeassist.impl.AssistParser;
import org.exoplatform.ide.java.client.internal.codeassist.impl.Engine;
import org.exoplatform.ide.java.client.internal.codeassist.impl.Keywords;
...
import org.exoplatform.ide.java.client.internal.compiler.DefaultErrorHandlingPolicies;
import org.exoplatform.ide.java.client.internal.compiler.ExtraFlags;
import org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.AllocationExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.Annotation;
import org.exoplatform.ide.java.client.internal.compiler.ast.Argument;
import org.exoplatform.ide.java.client.internal.compiler.ast.ArrayInitializer;
import org.exoplatform.ide.java.client.internal.compiler.ast.ArrayReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.AssertStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.Assignment;
import org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.CaseStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.CastExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.CompilationUnitDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.ConditionalExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.ConstructorDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.Expression;
import org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.FieldReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.ForStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.IfStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.ImportReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.Initializer;
import org.exoplatform.ide.java.client.internal.compiler.ast.InstanceOfExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.Javadoc;
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocImplicitTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocQualifiedTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocSingleTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.MemberValuePair;
import org.exoplatform.ide.java.client.internal.compiler.ast.MessageSend;
import org.exoplatform.ide.java.client.internal.compiler.ast.MethodDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.NameReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.NormalAnnotation;
import org.exoplatform.ide.java.client.internal.compiler.ast.OperatorExpression;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedNameReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.ReturnStatement;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.SuperReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.SwitchStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.ThisReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.TryStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter;
import org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.UnaryExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.UnionTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.WhileStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.Wildcard;
import org.exoplatform.ide.java.client.internal.compiler.env.AccessRestriction;
...
import org.exoplatform.ide.java.client.internal.compiler.env.ISourceType;
import org.exoplatform.ide.java.client.internal.compiler.env.NameEnvironmentAnswer;
import org.exoplatform.ide.java.client.internal.compiler.impl.ReferenceContext;
import org.exoplatform.ide.java.client.internal.compiler.lookup.ArrayBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.BaseTypeBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.Binding;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.CompilationUnitScope;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.ImportBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite;
import org.exoplatform.ide.java.client.internal.compiler.lookup.LocalVariableBinding;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.ParameterizedMethodBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.ParameterizedTypeBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.ProblemMethodBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.ProblemReasons;
import org.exoplatform.ide.java.client.internal.compiler.lookup.ProblemReferenceBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.Scope;
import org.exoplatform.ide.java.client.internal.compiler.lookup.SourceTypeBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.TagBits;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding;
import org.exoplatform.ide.java.client.internal.compiler.lookup.WildcardBinding;
import org.exoplatform.ide.java.client.internal.compiler.parser.JavadocTagConstants;
import org.exoplatform.ide.java.client.internal.compiler.parser.ScannerHelper;
...
import org.exoplatform.ide.java.client.internal.compiler.problem.ProblemSeverities;
import org.exoplatform.ide.java.client.internal.compiler.util.HashtableOfObject;
import org.exoplatform.ide.java.client.internal.compiler.util.ObjectVector;
import org.exoplatform.ide.java.client.internal.compiler.util.SuffixConstants;
import org.exoplatform.ide.java.client.internal.core.BasicCompilationUnit;
import org.exoplatform.ide.java.client.internal.core.INamingRequestor;
import org.exoplatform.ide.java.client.internal.core.InternalNamingConventions;
   ...
   RelevanceConstants, SuffixConstants
{
   ...
   public class CompletionProblemFactory extends DefaultProblemFactory
   {
      ...
      public CategorizedProblem createProblem(char[] originatingFileName, int problemId, String[] problemArguments,
         int elaborationId, String[] messageArguments, int severity, int start, int end, int lineNumber,
         int columnNumber)
      {
         return checkProblem(super.createProblem(originatingFileName, problemId, problemArguments, elaborationId,
            messageArguments, severity, start, end, lineNumber, columnNumber), originatingFileName, severity, start);
      }

      public CategorizedProblem createProblem(char[] originatingFileName, int problemId, String[] problemArguments,
         String[] messageArguments, int severity, int start, int end, int lineNumber, int columnNumber)
      {
      ...
      char[] returnPackagename, char[] returnTypeName)
   {
      char[] returnTypeSignature =
         returnTypeName == null || returnTypeName.length == 0 ? Signature.createCharArrayTypeSignature(VOID, true)
            : Signature.createCharArrayTypeSignature(
               CharOperation.concat(returnPackagename, CharOperation.replaceOnCopy(returnTypeName, '.', '$'), '.'),
               true);
   ...
   static final BaseTypeBinding[] BASE_TYPES = {TypeBinding.BOOLEAN, TypeBinding.BYTE, TypeBinding.CHAR,
      TypeBinding.DOUBLE, TypeBinding.FLOAT, TypeBinding.INT, TypeBinding.LONG, TypeBinding.SHORT, TypeBinding.VOID};
    ...
    * results to a UI.
    * 
    * @param nameEnvironment org.eclipse.jdt.internal.codeassist.ISearchableNameEnvironment used to resolve type/package
    *           references and search for types/packages based on partial names.
    * 
    * @param requestor org.eclipse.jdt.internal.codeassist.ICompletionRequestor since the engine might produce answers of various
...
//               checkCancel();
    ...
    * 
    * @param sourceUnit org.eclipse.jdt.internal.compiler.env.ICompilationUnit the source of the current compilation unit.
    * 
    * @param completionPosition int a position in the source where the completion is taking place. This position is relative to
    *           the source provided.
    */
      ...
      if (!this.requestor.isIgnored(CompletionProposal.VARIABLE_DECLARATION))
      {
         ...
         int kind =
            (field.modifiers & ClassFileConstants.AccStatic) == 0 ? InternalNamingConventions.VK_INSTANCE_FIELD
               : (field.modifiers & ClassFileConstants.AccFinal) == 0 ? InternalNamingConventions.VK_STATIC_FIELD
      ...
      if (!this.requestor.isIgnored(CompletionProposal.VARIABLE_DECLARATION))
      {
         ...
         int kind =
            (method.modifiers & ClassFileConstants.AccStatic) == 0 ? InternalNamingConventions.VK_INSTANCE_FIELD
               : (method.modifiers & ClassFileConstants.AccFinal) == 0 ? InternalNamingConventions.VK_STATIC_FIELD
                  : InternalNamingConventions.VK_STATIC_FINAL_FIELD;
      ...
      Scope scope)
   {
      ...
      if (qualifiedBinding == null)
      {
         if (this.completionToken.length == 0
            && (astNodeParent instanceof ParameterizedSingleTypeReference || astNodeParent instanceof ParameterizedQualifiedTypeReference))
         {
   ...
   private void computeExpectedTypes(ASTNode parent, ASTNode node, Scope scope)
   {
      ...
      { // covers both while and do-while loops
         addExpectedType(TypeBinding.BOOLEAN, scope);
      }
      ...
      { // astNodeParent set to ForStatement only for the condition
         addExpectedType(TypeBinding.BOOLEAN, scope);
   ...
   private void computeExpectedTypesForMessageSend(ReferenceBinding binding, char[] selector, Expression[] arguments,
      ReferenceBinding receiverType, Scope scope, InvocationSite invocationSite, boolean isStatic)
   {
   ...
   private void findEnumConstants(char[] enumConstantName, ReferenceBinding enumType, Scope invocationScope,
      ObjectVector fieldsFound, char[][] alreadyUsedConstants, int alreadyUsedConstantCount, boolean needQualification)
   {
   ...
   private void findExceptionFromTryStatement(char[] typeName, ReferenceBinding exceptionType,
      ReferenceBinding receiverType, SourceTypeBinding invocationType, BlockScope scope, ObjectVector typesFound,
   ...
   private void findFields(char[] fieldName, FieldBinding[] fields, Scope scope, ObjectVector fieldsFound,
      ObjectVector localsFound, boolean onlyStaticFields, ReferenceBinding receiverType, InvocationSite invocationSite,
      ...
      char[] castedReceiver, int receiverStart, int receiverEnd)
   {
      ...
      for (int f = fields.length; --f >= 0;)
      {
         ...
         if (fieldDeclaration != null && fieldDeclaration.initialization != null && astNode != null)
         {
            ...
            { // The sourceEnd may not yet be set
   ...
   protected void findFieldsAndMethods(char[] token, TypeBinding receiverType, Scope scope, ObjectVector fieldsFound,
      ObjectVector methodsFound, InvocationSite invocationSite, Scope invocationScope, boolean implicitCall,
      boolean superCall, Binding[] missingElements, int[] missingElementsStarts, int[] missingElementsEnds,
            ...
            if (castedReceiver == null)
            {
               if (!this.isIgnored(CompletionProposal.METHOD_REF, missingElements != null))
               {
                  ...
                  proposal.setSignature(this.compilerOptions.sourceLevel > ClassFileConstants.JDK1_4
                     ...
                     CharOperation.NO_CHAR_CHAR, getSignature(receiverType)) : createMethodSignature(
                     CharOperation.NO_CHAR_CHAR, CharOperation.NO_CHAR_CHAR, CharOperation.concatWith(JAVA_LANG, '.'),
                     OBJECT));
                  // proposal.setOriginalSignature(null);
                  // proposal.setDeclarationPackageName(null);
                  // proposal.setDeclarationTypeName(null);
                     ...
                     if (proposeMethod && !insideAnnotationAttribute)
                     {
                              ...
                              methodBinding.selector)))
                        {
                           findLocalMethodsFromStaticImports(token,
                              methodBinding.declaringClass.getMethods(methodBinding.selector), scope, exactMatch,
   ...
   private void findFieldsFromFavorites(char[] fieldName, FieldBinding[] fields, Scope scope, ObjectVector fieldsFound,
      ObjectVector localsFound, ReferenceBinding receiverType, InvocationSite invocationSite, Scope invocationScope)
   {
   ...
   private void findLocalMethods(char[] methodName, TypeBinding[] typeArgTypes, TypeBinding[] argTypes,
      MethodBinding[] methods, Scope scope, ObjectVector methodsFound, boolean onlyStaticMethods, boolean exactMatch,
    ...
    * @param methods a resultant array of MethodBinding, whose names should match methodName. The calling client must ensure that
    *           this check is handled.
    */
   private void findLocalMethodsFromStaticImports(char[] methodName, MethodBinding[] methods, Scope scope,
      boolean exactMatch, ObjectVector methodsFound, ReferenceBinding receiverType, InvocationSite invocationSite)
   {
   ...
   private void findMemberTypes(char[] typeName, ReferenceBinding receiverType, Scope scope,
      ...
      SourceTypeBinding typeToIgnore, ObjectVector typesFound, Binding[] missingElements, int[] missingElementsStarts,
      int[] missingElementsEnds, boolean missingElementsHaveProblems)
   {
      ...
      { // do not search up the hierarchy
   ...
   protected void findMemberTypes(char[] typeName, ReferenceBinding receiverType, Scope scope,
      SourceTypeBinding typeInvocation, boolean staticOnly, boolean staticFieldsAndMethodOnly, ObjectVector typesFound,
      Binding[] missingElements, int[] missingElementsStarts, int[] missingElementsEnds,
      boolean missingElementsHaveProblems)
   {
   ...
   private void findMethodDeclarations(char[] selector, ReferenceBinding receiverType, Scope scope,
      ObjectVector methodsFound, Binding[] missingElements, int[] missingElementsStarts, int[] missingElementsEnds,
      boolean missingElementsHaveProblems)
   {
      ...
      while (currentType != null)
      {
               ...
               .isEnum()))
         {
            ...
            findInterfacesMethods(selector, typeArgTypes, argTypes, receiverType, superInterfaces, scope, methodsFound,
               onlyStaticMethods, exactMatch, invocationSite, invocationScope, implicitCall, superCall, canBePrefixed,
               missingElements, missingElementsStarts, missingElementsEnds, missingElementsHaveProblems,
               castedReceiver, receiverStart, receiverEnd);
         }
         else
   ...
   private void findVariableName(char[] token, char[] qualifiedPackageName, char[] qualifiedSourceName,
      char[] sourceName, final TypeBinding typeBinding, char[][] discouragedNames, final char[][] forbiddenNames,
      ...
      if (type != null && type.resolvedType != null)
      {
         ...
         if (tb.problemId() == ProblemReasons.NoError && tb != Scope.getBaseType(VOID))
         {
            findVariableName(name, tb.leafComponentType().qualifiedPackageName(), tb.leafComponentType()
               .qualifiedSourceName(), tb.leafComponentType().sourceName(), tb, discouragedNames, forbiddenNames,
                  ...
                  next : for (int i = 0, length = blockScope.locals.length; i < length; i++)
                  {
                     ...
                     if (!this.requestor.isIgnored(CompletionProposal.LOCAL_VARIABLE_REF))
                     {
                        ...
                        proposal.setSignature(local.type == null ? createTypeSignature(CharOperation.NO_CHAR,
                           local.declaration.type.toString().toCharArray()) : getSignature(local.type));
                        if (local.type == null)
                        {
                           // proposal.setPackageName(null);
      ...
      next : for (int i = 0; i < favoriteReferences.length; i++)
      {
         ...
         ImportReference importReference =
            new ImportReference(compoundName, new long[compoundName.length], onDemand, isStatic
               ? ClassFileConstants.AccStatic : ClassFileConstants.AccDefault);
   ...
   private boolean isForbiddenType(char[] givenPkgName, char[] givenTypeName, char[][] enclosingTypeNames)
   {
      ...
      if (this.compilerOptions.sourceLevel >= ClassFileConstants.JDK1_5
         && CharOperation.endsWith(givenPkgName, DOT_ENUM))
      { // note: it should be .enum and not just enum
         return true;
      }

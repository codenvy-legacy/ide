...
public class Javadoc extends ASTNode
{
   ...
   public ASTNode getNodeStartingAt(int start)
   {
      ...
      if (this.seeReferences != null)
      {
         ...
         for (int i = 0; i < length; i++)
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.Expression expression = this.seeReferences[i];
   ...
   /*
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode#print(int, java.lang.StringBuffer)
    */
   ...
   public void resolve(MethodScope methScope)
   {
      ...
      boolean reportMissing =
         methDecl == null
            || !((overriding && this.inheritedPositions != null) || superRef || (methDecl.binding.declaringClass != null && methDecl.binding.declaringClass
               .isLocalType()));

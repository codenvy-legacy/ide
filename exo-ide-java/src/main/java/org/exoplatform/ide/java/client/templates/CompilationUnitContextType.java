...
public abstract class CompilationUnitContextType extends TemplateContextType
{
   ...
   // super(org.exoplatform.ide.java.client.templates.api.GlobalTemplateVariables.LineSelection.NAME,
   // JavaTemplateMessages.CompilationUnitContextType_variable_description_line_selection);
   // }
   // @Override
   // protected String resolve(TemplateContext context) {
   // String selection= context.getVariable(org.exoplatform.ide.java.client.templates.api.GlobalTemplateVariables.SELECTION);
   // if (selection == null)
   //            return ""; //$NON-NLS-1$
   // return selection;
   // }

...
import org.exoplatform.ide.java.client.core.compiler.InvalidInputException;
import org.exoplatform.ide.java.client.core.dom.Modifier.ModifierKeyword;
import org.exoplatform.ide.java.client.internal.compiler.ClassFileConstants;
import org.exoplatform.ide.java.client.internal.compiler.ast.AbstractMethodDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.AbstractVariableDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.Argument;
import org.exoplatform.ide.java.client.internal.compiler.ast.ForeachStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocArgumentExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocFieldReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocMessageSend;
import org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.MessageSend;
import org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds;
import org.exoplatform.ide.java.client.internal.compiler.ast.ParameterizedQualifiedTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.ParameterizedSingleTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedAllocationExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.SingleNameReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.SingleTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.StringLiteralConcatenation;
import org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.Wildcard;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.TypeConstants;
import org.exoplatform.ide.java.client.internal.compiler.parser.RecoveryScanner;
import org.exoplatform.ide.java.client.internal.compiler.parser.Scanner;
import org.exoplatform.ide.java.client.internal.compiler.parser.TerminalTokens;
...
class ASTConverter
{
   ...
   protected void adjustSourcePositionsForParent(
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression expression)
   {
   ...
   protected void buildBodyDeclarations(
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration typeDeclaration,
      AbstractTypeDeclaration typeDecl, boolean isInterface)
   {
      // add body declaration in the lexical order
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration[] members = typeDeclaration.memberTypes;
      org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration[] fields = typeDeclaration.fields;
      org.exoplatform.ide.java.client.internal.compiler.ast.AbstractMethodDeclaration[] methods =
      ...
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration nextFieldDeclaration = null;
         org.exoplatform.ide.java.client.internal.compiler.ast.AbstractMethodDeclaration nextMethodDeclaration = null;
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration nextMemberDeclaration = null;
   ...
   protected void buildBodyDeclarations(
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration enumDeclaration2,
      EnumDeclaration enumDeclaration)
   {
      // add body declaration in the lexical order
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration[] members = enumDeclaration2.memberTypes;
      org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration[] fields = enumDeclaration2.fields;
      org.exoplatform.ide.java.client.internal.compiler.ast.AbstractMethodDeclaration[] methods =
   ...
   protected void buildBodyDeclarations(
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration expression,
      AnonymousClassDeclaration anonymousClassDeclaration)
   {
      // add body declaration in the lexical order
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration[] members = expression.memberTypes;
      org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration[] fields = expression.fields;
      org.exoplatform.ide.java.client.internal.compiler.ast.AbstractMethodDeclaration[] methods = expression.methods;
   ...
   protected void checkAndAddMultipleFieldDeclaration(
      org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration[] fields, int index, List bodyDeclarations)
   {
      if (fields[index] instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Initializer)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.Initializer oldInitializer =
            (org.exoplatform.ide.java.client.internal.compiler.ast.Initializer)fields[index];
   ...
   protected void checkAndAddMultipleLocalDeclaration(
      org.exoplatform.ide.java.client.internal.compiler.ast.Statement[] stmts, int index, List blockStatements)
   {
      if (index > 0
         && stmts[index - 1] instanceof org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration local1 =
            (org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)stmts[index - 1];
         org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration local2 =
            (org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)stmts[index];
         if (local1.declarationSourceStart == local2.declarationSourceStart)
         {
            ...
            variableDeclarationStatement
               .fragments()
               .add(
                  convertToVariableDeclarationFragment((org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)stmts[index]));
         }
         else
         {
            // we can create a new FieldDeclaration
            blockStatements
               .add(convertToVariableDeclarationStatement((org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)stmts[index]));
         }
      }
      else
      {
   ...
   protected void completeRecord(ArrayType arrayType,
      org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode astNode)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.AbstractMethodDeclaration methodDeclaration)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference[] thrownExceptions =
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Argument[] parameters = methodDeclaration.arguments;
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.ExplicitConstructorCall explicitConstructorCall = null;
      if (isConstructor)
      {
         if (isInterface)
         {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.ConstructorDeclaration constructorDeclaration =
            (org.exoplatform.ide.java.client.internal.compiler.ast.ConstructorDeclaration)methodDeclaration;
      ...
      else if (methodDeclaration instanceof org.exoplatform.ide.java.client.internal.compiler.ast.MethodDeclaration)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.MethodDeclaration method =
            (org.exoplatform.ide.java.client.internal.compiler.ast.MethodDeclaration)methodDeclaration;
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference typeReference = method.returnType;
      ...
      if (closingPosition != -1)
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.Statement[] statements = methodDeclaration.statements;
         ...
         if (block != null && (statements != null || explicitConstructorCall != null))
         {
            if (explicitConstructorCall != null
               && explicitConstructorCall.accessMode != org.exoplatform.ide.java.client.internal.compiler.ast.ExplicitConstructorCall.ImplicitSuper)
            {
            ...
            {
               if (statements[i] instanceof org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)
               {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter[] typeParameters =
   ...
   public ClassInstanceCreation convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.AllocationExpression expression)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression[] arguments = expression.arguments;
      if (arguments != null)
      {
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.AND_AND_Expression expression)
   {
      ...
      final int expressionOperatorID =
         (expression.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >> org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT;
      if (expression.left instanceof org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression
         && ((expression.left.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.Expression leftOperand = expression.left;
         org.exoplatform.ide.java.client.internal.compiler.ast.Expression rightOperand = null;
         do
         {
            rightOperand = ((org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression)leftOperand).right;
            if ((((leftOperand.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >> org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID && ((leftOperand.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0))
               || ((rightOperand instanceof org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression && ((rightOperand.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >> org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT) != expressionOperatorID) && ((rightOperand.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0)))
            {
            ...
            leftOperand = ((org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression)leftOperand).left;
         }
         while (leftOperand instanceof org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression
            && ((leftOperand.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) == 0));
   ...
   public ASTNode convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.AnnotationMethodDeclaration annotationTypeMemberDeclaration)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference typeReference =
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression memberValue =
   ...
   public SingleVariableDeclaration convert(org.exoplatform.ide.java.client.internal.compiler.ast.Argument argument)
   {
   ...
   public Annotation convert(org.exoplatform.ide.java.client.internal.compiler.ast.Annotation annotation)
   {
      if (annotation instanceof org.exoplatform.ide.java.client.internal.compiler.ast.SingleMemberAnnotation)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.SingleMemberAnnotation)annotation);
      }
      else if (annotation instanceof org.exoplatform.ide.java.client.internal.compiler.ast.MarkerAnnotation)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.MarkerAnnotation)annotation);
      }
      else
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.NormalAnnotation)annotation);
      }
   }

   public ArrayCreation convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.ArrayAllocationExpression expression)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression[] dimensions = expression.dimensions;
   ...
   public ArrayInitializer convert(org.exoplatform.ide.java.client.internal.compiler.ast.ArrayInitializer expression)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression[] expressions = expression.expressions;
      if (expressions != null)
      {
   ...
   public ArrayAccess convert(org.exoplatform.ide.java.client.internal.compiler.ast.ArrayReference reference)
   {
   ...
   public AssertStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.AssertStatement statement)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression exceptionArgument = statement.exceptionArgument;
   ...
   public Assignment convert(org.exoplatform.ide.java.client.internal.compiler.ast.Assignment expression)
   {
   ...
   public TypeDeclaration convert(org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode[] nodes)
   {
      ...
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node = nodes[i];
         if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Initializer)
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.Initializer oldInitializer =
               (org.exoplatform.ide.java.client.internal.compiler.ast.Initializer)node;
            Initializer initializer = new Initializer(this.ast);
            initializer.setBody(convert(oldInitializer.block));
            setModifiers(initializer, oldInitializer);
            initializer.setSourceRange(oldInitializer.declarationSourceStart, oldInitializer.sourceEnd
         ...
         else if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration)
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration fieldDeclaration =
               (org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration)node;
            if (i > 0
               && (nodes[i - 1] instanceof org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration)
               && ((org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration)nodes[i - 1]).declarationSourceStart == fieldDeclaration.declarationSourceStart)
            {
               // we have a multiple field declaration
               // We retrieve the existing fieldDeclaration to add the new VariableDeclarationFragment
         ...
         else if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.AbstractMethodDeclaration)
         {
         ...
         else if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration nextMemberDeclaration =
               (org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)node;
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression expression)
   {
      InfixExpression infixExpression = new InfixExpression(this.ast);
      if (this.resolveBindings)
      {
         ...
         && (OperatorIds.PLUS == expressionOperatorID))
      {
         ...
         final org.exoplatform.ide.java.client.internal.compiler.ast.Expression[] stringLiterals = literal.literals;
   ...
   public Block convert(org.exoplatform.ide.java.client.internal.compiler.ast.Block statement)
   {
      Block block = new Block(this.ast);
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Statement[] statements = statement.statements;
      if (statements != null)
      {
   ...
   public BreakStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.BreakStatement statement)
   {
   ...
   public SwitchCase convert(org.exoplatform.ide.java.client.internal.compiler.ast.CaseStatement statement)
   {
      SwitchCase switchCase = new SwitchCase(this.ast);
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression constantExpression =
   ...
   public CastExpression convert(org.exoplatform.ide.java.client.internal.compiler.ast.CastExpression expression)
   {
   ...
   public CharacterLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.CharLiteral expression)
   {
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.ClassLiteralAccess expression)
   {
   ...
   public CompilationUnit convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.CompilationUnitDeclaration unit, char[] source)
   {
      try
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.ImportReference[] imports = unit.imports;
         if (imports != null)
         {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration[] types = unit.types;
         if (types != null)
         {
            int typesLength = types.length;
            for (int i = 0; i < typesLength; i++)
            {
               org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration declaration = types[i];
   ...
   public Assignment convert(org.exoplatform.ide.java.client.internal.compiler.ast.CompoundAssignment expression)
   {
      Assignment assignment = new Assignment(this.ast);
      Expression lhs = convert(expression.lhs);
      assignment.setLeftHandSide(lhs);
      ...
      {
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.PLUS :
            assignment.setOperator(Assignment.Operator.PLUS_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.MINUS :
            assignment.setOperator(Assignment.Operator.MINUS_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.MULTIPLY :
            assignment.setOperator(Assignment.Operator.TIMES_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.DIVIDE :
            assignment.setOperator(Assignment.Operator.DIVIDE_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.AND :
            assignment.setOperator(Assignment.Operator.BIT_AND_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.OR :
            assignment.setOperator(Assignment.Operator.BIT_OR_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.XOR :
            assignment.setOperator(Assignment.Operator.BIT_XOR_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.REMAINDER :
            assignment.setOperator(Assignment.Operator.REMAINDER_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.LEFT_SHIFT :
            assignment.setOperator(Assignment.Operator.LEFT_SHIFT_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.RIGHT_SHIFT :
            assignment.setOperator(Assignment.Operator.RIGHT_SHIFT_SIGNED_ASSIGN);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.UNSIGNED_RIGHT_SHIFT :
   ...
   public ConditionalExpression convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.ConditionalExpression expression)
   {
   ...
   public ContinueStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.ContinueStatement statement)
   {
   ...
   public DoStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.DoStatement statement)
   {
   ...
   public NumberLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.DoubleLiteral expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
   ...
   public EmptyStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.EmptyStatement statement)
   {
   ...
   public EnumConstantDeclaration convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration enumConstant)
   {
      ...
      final org.exoplatform.ide.java.client.internal.compiler.ast.Expression initialization =
         enumConstant.initialization;
      if (initialization != null)
      {
         if (initialization instanceof QualifiedAllocationExpression)
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration anonymousType =
         ...
         final org.exoplatform.ide.java.client.internal.compiler.ast.Expression[] arguments =
            ((org.exoplatform.ide.java.client.internal.compiler.ast.AllocationExpression)initialization).arguments;
         if (arguments != null)
         {
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.EqualExpression expression)
   {
      InfixExpression infixExpression = new InfixExpression(this.ast);
      if (this.resolveBindings)
      {
      ...
      int startPosition = leftExpression.getStartPosition();
      infixExpression.setSourceRange(startPosition, expression.sourceEnd - startPosition + 1);
      switch ((expression.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >> org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT)
      {
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.EQUAL_EQUAL :
            infixExpression.setOperator(InfixExpression.Operator.EQUALS);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.NOT_EQUAL :
   ...
   public Statement convert(org.exoplatform.ide.java.client.internal.compiler.ast.ExplicitConstructorCall statement)
   {
      ...
      if (statement.isSuperAccess() || statement.isSuper())
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.Expression[] arguments = statement.arguments;
         if (arguments != null)
         {
            int length = arguments.length;
            for (int i = 0; i < length; i++)
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.Expression expression)
   {
      if ((expression.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0)
      {
         return convertToParenthesizedExpression(expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Annotation)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.Annotation)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.CastExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.CastExpression)expression);
      }
      // switch between all types of expression
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ArrayAllocationExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ArrayAllocationExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedAllocationExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedAllocationExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.AllocationExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.AllocationExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ArrayInitializer)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ArrayInitializer)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.PrefixExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.PrefixExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.PostfixExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.PostfixExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.CompoundAssignment)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.CompoundAssignment)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Assignment)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.Assignment)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ClassLiteralAccess)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ClassLiteralAccess)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.FalseLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.FalseLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TrueLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.TrueLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.NullLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.NullLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.CharLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.CharLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.DoubleLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.DoubleLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.FloatLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.FloatLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.IntLiteralMinValue)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.IntLiteralMinValue)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.IntLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.IntLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.LongLiteralMinValue)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.LongLiteralMinValue)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.LongLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.LongLiteral)expression);
      }
      if (expression instanceof StringLiteralConcatenation)
      {
         return convert((StringLiteralConcatenation)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ExtendedStringLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ExtendedStringLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.StringLiteral)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.StringLiteral)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.AND_AND_Expression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.AND_AND_Expression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.OR_OR_Expression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.OR_OR_Expression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.EqualExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.EqualExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.BinaryExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.InstanceOfExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.InstanceOfExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.UnaryExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.UnaryExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ConditionalExpression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ConditionalExpression)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.MessageSend)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.MessageSend)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Reference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.Reference)expression);
      }
      if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference)expression);
      }
      return null;
   }

   public StringLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.ExtendedStringLiteral expression)
   {
   ...
   public BooleanLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.FalseLiteral expression)
   {
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.FieldReference reference)
   {
      if (reference.receiver.isSuper())
      {
         ...
         if (reference.receiver instanceof org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedSuperReference)
         {
            Name qualifier =
               convert((org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedSuperReference)reference.receiver);
   ...
   public NumberLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.FloatLiteral expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
      NumberLiteral literal = new NumberLiteral(this.ast);
   ...
   public Statement convert(ForeachStatement statement)
   {
      switch (this.ast.apiLevel)
      {
         ...
         default :
            ...
            org.exoplatform.ide.java.client.internal.compiler.ast.Expression collection = statement.collection;
            if (collection == null)
               return null;
   ...
   public ForStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.ForStatement statement)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Statement[] initializations = statement.initializations;
      if (initializations != null)
      {
         // we know that we have at least one initialization
         if (initializations[0] instanceof org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration initialization =
               (org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)initializations[0];
            ...
            {
               initialization =
                  (org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)initializations[i];
            ...
            if (initializationsLength != 1)
            {
               ...
               int end =
                  ((org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)initializations[initializationsLength - 1]).declarationSourceEnd;
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Statement[] increments = statement.increments;
      if (increments != null)
      {
   ...
   public IfStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.IfStatement statement)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Statement statement2 = statement.elseStatement;
      if (statement2 != null)
      {
   ...
   public InstanceofExpression convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.InstanceOfExpression expression)
   {
   ...
   public NumberLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.IntLiteral expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
   ...
   public NumberLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.IntLiteralMinValue expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
      NumberLiteral literal = new NumberLiteral(this.ast);
   ...
   public void convert(org.exoplatform.ide.java.client.internal.compiler.ast.Javadoc javadoc,
   ...
   public LabeledStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.LabeledStatement statement)
   {
   ...
   public NumberLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.LongLiteral expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
      final NumberLiteral literal = new NumberLiteral(this.ast);
   ...
   public NumberLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.LongLiteralMinValue expression)
   {
      int length = expression.sourceEnd - expression.sourceStart + 1;
      int sourceStart = expression.sourceStart;
      final NumberLiteral literal = new NumberLiteral(this.ast);
   ...
   public Expression convert(MessageSend expression)
   {
      ...
      if (expression.isSuperAccess())
      {
         ...
         if (expression.receiver instanceof org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedSuperReference)
         {
            Name qualifier =
               convert((org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedSuperReference)expression.receiver);
      ...
      else
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.Expression receiver = expression.receiver;
         if (receiver instanceof MessageSend)
         {
            if ((receiver.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) != 0)
            {
   ...
   public MarkerAnnotation convert(org.exoplatform.ide.java.client.internal.compiler.ast.MarkerAnnotation annotation)
   {
   ...
   public MemberValuePair convert(org.exoplatform.ide.java.client.internal.compiler.ast.MemberValuePair memberValuePair)
   {
   ...
   public Name convert(org.exoplatform.ide.java.client.internal.compiler.ast.NameReference reference)
   {
      if (reference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedNameReference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedNameReference)reference);
      }
      else
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.SingleNameReference)reference);
      }
   }
   ...
   public InfixExpression convert(StringLiteralConcatenation expression)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression[] stringLiterals = expression.literals;
      infixExpression.setLeftOperand(convert(stringLiterals[0]));
      infixExpression.setRightOperand(convert(stringLiterals[1]));
   ...
   public NormalAnnotation convert(org.exoplatform.ide.java.client.internal.compiler.ast.NormalAnnotation annotation)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.MemberValuePair[] memberValuePairs =
   ...
   public NullLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.NullLiteral expression)
   {
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.OR_OR_Expression expression)
   {
      InfixExpression infixExpression = new InfixExpression(this.ast);
   ...
   public PostfixExpression convert(org.exoplatform.ide.java.client.internal.compiler.ast.PostfixExpression expression)
   {
   ...
   public PrefixExpression convert(org.exoplatform.ide.java.client.internal.compiler.ast.PrefixExpression expression)
   {
   ...
   public Expression convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedAllocationExpression allocation)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression[] arguments = allocation.arguments;
      if (arguments != null)
      {
         int length = arguments.length;
         for (int i = 0; i < length; i++)
   ...
   public Name convert(org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedNameReference nameReference)
   {
      return setQualifiedNameNameAndSourceRanges(nameReference.tokens, nameReference.sourcePositions, nameReference);
   }

   public Name convert(org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedSuperReference reference)
   {
      return convert(reference.qualification);
   }

   public ThisExpression convert(org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedThisReference reference)
   {
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.Reference reference)
   {
      if (reference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.NameReference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.NameReference)reference);
      }
      if (reference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ThisReference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ThisReference)reference);
      }
      if (reference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ArrayReference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ArrayReference)reference);
      }
      if (reference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.FieldReference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.FieldReference)reference);
      }
      return null; // cannot be reached
   }

   public ReturnStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.ReturnStatement statement)
   {
   ...
   public SingleMemberAnnotation convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.SingleMemberAnnotation annotation)
   {
   ...
   public SimpleName convert(org.exoplatform.ide.java.client.internal.compiler.ast.SingleNameReference nameReference)
   {
      final SimpleName name = new SimpleName(this.ast);
   ...
   public Statement convert(org.exoplatform.ide.java.client.internal.compiler.ast.Statement statement)
   {
      if (statement instanceof ForeachStatement)
      {
         return convert((ForeachStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration localDeclaration =
            (org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration)statement;
         return convertToVariableDeclarationStatement(localDeclaration);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.AssertStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.AssertStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Block)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.Block)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.BreakStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.BreakStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ContinueStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ContinueStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.CaseStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.CaseStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.DoStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.DoStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.EmptyStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.EmptyStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ExplicitConstructorCall)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ExplicitConstructorCall)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ForStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ForStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.IfStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.IfStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.LabeledStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.LabeledStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ReturnStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ReturnStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.SwitchStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.SwitchStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.SynchronizedStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.SynchronizedStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.ThrowStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.ThrowStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TryStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.TryStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)
      {
         ASTNode result = convert((org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)statement);
         if (result == null)
         {
            return createFakeEmptyStatement(statement);
         }
      ...
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.WhileStatement)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.WhileStatement)statement);
      }
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Expression)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.Expression statement2 =
            (org.exoplatform.ide.java.client.internal.compiler.ast.Expression)statement;
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.StringLiteral expression)
   {
      if (expression instanceof StringLiteralConcatenation)
      {
         return convert((StringLiteralConcatenation)expression);
   ...
   public SwitchStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.SwitchStatement statement)
   {
   ...
   public SynchronizedStatement convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.SynchronizedStatement statement)
   {
   ...
   public Expression convert(org.exoplatform.ide.java.client.internal.compiler.ast.ThisReference reference)
   {
      ...
      else if (reference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedSuperReference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedSuperReference)reference);
      }
      else if (reference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedThisReference)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedThisReference)reference);
      }
      else
      {
   ...
   public ThrowStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.ThrowStatement statement)
   {
   ...
   public BooleanLiteral convert(org.exoplatform.ide.java.client.internal.compiler.ast.TrueLiteral expression)
   {
      final BooleanLiteral literal = new BooleanLiteral(this.ast);
   ...
   public TryStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.TryStatement statement)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Argument[] catchArguments = statement.catchArguments;
      if (catchArguments != null)
      {
         int catchArgumentsLength = catchArguments.length;
         org.exoplatform.ide.java.client.internal.compiler.ast.Block[] catchBlocks = statement.catchBlocks;
   ...
   public AbstractTypeDeclaration convert(
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration typeDeclaration)
   {
      int kind = org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration.kind(typeDeclaration.modifiers);
      switch (kind)
      {
         case org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration.ENUM_DECL :
            if (this.ast.apiLevel == AST.JLS2_INTERNAL)
            {
               return null;
            }
         ...
         case org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration.ANNOTATION_TYPE_DECL :
            if (this.ast.apiLevel == AST.JLS2_INTERNAL)
            {
               return null;
            }
      ...
      boolean isInterface =
         kind == org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration.INTERFACE_DECL;
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference[] superInterfaces =
   ...
   public TypeParameter convert(org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter typeParameter)
   {
   ...
   public Name convert(org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference typeReference)
   {
      ...
      {
         // QualifiedName
         org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedTypeReference qualifiedTypeReference =
            (org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedTypeReference)typeReference;
   ...
   public PrefixExpression convert(org.exoplatform.ide.java.client.internal.compiler.ast.UnaryExpression expression)
   {
      final PrefixExpression prefixExpression = new PrefixExpression(this.ast);
      if (this.resolveBindings)
      {
      ...
      switch ((expression.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorMASK) >> org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OperatorSHIFT)
      {
         ...
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.MINUS :
            ...
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.NOT :
            prefixExpression.setOperator(PrefixExpression.Operator.NOT);
            break;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.TWIDDLE :
            prefixExpression.setOperator(PrefixExpression.Operator.COMPLEMENT);
      }
      return prefixExpression;
   }

   public WhileStatement convert(org.exoplatform.ide.java.client.internal.compiler.ast.WhileStatement statement)
   {
   ...
   public ImportDeclaration convertImport(
      org.exoplatform.ide.java.client.internal.compiler.ast.ImportReference importReference)
   {
      final ImportDeclaration importDeclaration = new ImportDeclaration(this.ast);
      final boolean onDemand =
         (importReference.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OnDemand) != 0;
   ...
   public PackageDeclaration convertPackage(
      org.exoplatform.ide.java.client.internal.compiler.ast.CompilationUnitDeclaration compilationUnitDeclaration)
   {
      org.exoplatform.ide.java.client.internal.compiler.ast.ImportReference importReference =
      ...
      packageDeclaration.setSourceRange(importReference.declarationSourceStart, importReference.declarationEnd
         - importReference.declarationSourceStart + 1);
      org.exoplatform.ide.java.client.internal.compiler.ast.Annotation[] annotations = importReference.annotations;
      if (annotations != null)
      {
         switch (this.ast.apiLevel)
         {
   ...
   public Expression convertToExpression(org.exoplatform.ide.java.client.internal.compiler.ast.Statement statement)
   {
      if (statement instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Expression)
      {
         return convert((org.exoplatform.ide.java.client.internal.compiler.ast.Expression)statement);
      }
      else
      {
         return null;
   ...
   protected FieldDeclaration convertToFieldDeclaration(
      org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration fieldDecl)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression expression)
   {
      ...
      int numberOfParenthesis =
         (expression.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK) >> org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
      expression.bits &= ~org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedMASK;
      expression.bits |=
         (numberOfParenthesis - 1) << org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.ParenthesizedSHIFT;
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.LocalDeclaration localDeclaration)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression initialization = localDeclaration.initialization;
   ...
   public Type convertType(TypeReference typeReference)
   {
      ...
      if (typeReference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.SingleTypeReference)
      {
         // this is either an ArrayTypeReference or a SingleTypeReference
         char[] name =
            ((org.exoplatform.ide.java.client.internal.compiler.ast.SingleTypeReference)typeReference).getTypeName()[0];
      ...
      else
      {
         ...
         else if (typeReference instanceof org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedTypeReference)
         {
            char[][] name =
               ((org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedTypeReference)typeReference)
                  .getTypeName();
            int nameLength = name.length;
            long[] positions =
               ((org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedTypeReference)typeReference).sourcePositions;
            sourceStart = (int)(positions[0] >>> 32);
            length = (int)(positions[nameLength - 1] & 0xFFFFFFFF) - sourceStart + 1;
         ...
         else
         {
            TypeReference[] typeReferences =
               ((org.exoplatform.ide.java.client.internal.compiler.ast.UnionTypeReference)typeReference).typeReferences;
            switch (this.ast.apiLevel)
            {
               case AST.JLS2_INTERNAL :
               case AST.JLS3 :
   ...
   protected Statement createFakeEmptyStatement(
      org.exoplatform.ide.java.client.internal.compiler.ast.Statement statement)
   {
      if (statement == null)
         return null;
      EmptyStatement emptyStatement = new EmptyStatement(this.ast);
   ...
   protected InfixExpression.Operator getOperatorFor(int operatorID)
   {
      switch (operatorID)
      {
         ...
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.LESS_EQUAL :
            return InfixExpression.Operator.LESS_EQUALS;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.GREATER_EQUAL :
         ...
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.OR_OR :
            return InfixExpression.Operator.CONDITIONAL_OR;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.AND_AND :
         ...
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.GREATER :
            return InfixExpression.Operator.GREATER;
         case org.exoplatform.ide.java.client.internal.compiler.ast.OperatorIds.LESS :
   ...
   private BlockScope lookupScope(ASTNode node)
   {
      ...
      if (currentNode instanceof Initializer)
      {
         ...
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration typeDecl =
               (org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)this.ast.getBindingResolver()
   ...
   protected void recordName(Name name, org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode compilerNode)
   {
      if (compilerNode != null)
      {
         recordNodes(name, compilerNode);
         if (compilerNode instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference)
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference typeRef =
               (org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference)compilerNode;
   ...
   protected void recordNodes(ASTNode node, org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode oldASTNode)
   {
      this.ast.getBindingResolver().store(node, oldASTNode);
   }

   protected void recordNodes(org.exoplatform.ide.java.client.internal.compiler.ast.Javadoc javadoc,
      TagElement tagElement)
   {
      ...
      while (fragments.hasNext())
      {
         ...
         if (node.getNodeType() == ASTNode.MEMBER_REF)
         {
            ...
            org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode compilerNode =
            ...
            {
               org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference typeRef = null;
               if (compilerNode instanceof JavadocFieldReference)
               {
                  ...
                  if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference)
                  {
                     typeRef = (org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference)expression;
                  }
               }
         ...
         else if (node.getNodeType() == ASTNode.METHOD_REF)
         {
            ...
            if (compilerNode != null)
            {
               ...
               // get type ref
               org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference typeRef = null;
               if (compilerNode instanceof org.exoplatform.ide.java.client.internal.compiler.ast.JavadocAllocationExpression)
               {
                  typeRef =
                     ((org.exoplatform.ide.java.client.internal.compiler.ast.JavadocAllocationExpression)compilerNode).type;
                  if (typeRef != null)
                     recordNodes(name, compilerNode);
               }
               else if (compilerNode instanceof org.exoplatform.ide.java.client.internal.compiler.ast.JavadocMessageSend)
               {
                  org.exoplatform.ide.java.client.internal.compiler.ast.Expression expression =
                     ((org.exoplatform.ide.java.client.internal.compiler.ast.JavadocMessageSend)compilerNode).receiver;
                  if (expression instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference)
                  {
                     typeRef = (org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference)expression;
                  }
            ...
            while (parameters.hasNext())
            {
               ...
               org.exoplatform.ide.java.client.internal.compiler.ast.Expression expression =
                  (org.exoplatform.ide.java.client.internal.compiler.ast.Expression)javadoc.getNodeStartingAt(param
                     .getStartPosition());
               if (expression != null)
               {
   ...
   private void trimWhiteSpacesAndComments(org.exoplatform.ide.java.client.internal.compiler.ast.Expression expression)
   {
      int start = expression.sourceStart;
      int end = expression.sourceEnd;
      int token;
   ...
   protected void setModifiers(BodyDeclaration bodyDeclaration,
      org.exoplatform.ide.java.client.internal.compiler.ast.Annotation[] annotations, int modifiersEnd)
   {
         ...
         while ((token = this.scanner.getNextToken()) != TerminalTokens.TokenNameEOF)
         {
            ...
            switch (token)
            {
               ...
               case TerminalTokens.TokenNameAT :
                  ...
                  {
                     org.exoplatform.ide.java.client.internal.compiler.ast.Annotation annotation =
   ...
   protected void setModifiers(SingleVariableDeclaration variableDecl, Argument argument)
   {
      switch (this.ast.apiLevel)
      {
         ...
         default :
            ...
            org.exoplatform.ide.java.client.internal.compiler.ast.Annotation[] annotations = argument.annotations;
            int indexInAnnotations = 0;
            try
            {
               int token;
   ...
   protected void setModifiers(SingleVariableDeclaration variableDecl, LocalDeclaration localDeclaration)
   {
      switch (this.ast.apiLevel)
      {
         ...
         default :
            ...
            org.exoplatform.ide.java.client.internal.compiler.ast.Annotation[] annotations =
   ...
   protected QualifiedName setQualifiedNameNameAndSourceRanges(char[][] typeName, long[] positions,
      org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node)
   {
      int length = typeName.length;
   ...
   protected void setTypeNameForAnnotation(
      org.exoplatform.ide.java.client.internal.compiler.ast.Annotation compilerAnnotation, Annotation annotation)
   {

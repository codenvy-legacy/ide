...
public class UnionTypeReference extends TypeReference
{
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference#copyDims(int)
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference#getLastToken()
    */
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.ArrayQualifiedTypeReference#getTypeBinding(org.exoplatform.ide.java.client.internal.compiler.lookup.Scope)
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference#getTypeBinding(org.exoplatform.ide.java.client.internal.compiler.lookup.Scope)
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference#getTypeName()
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference#traverse(org.exoplatform.ide.java.client.internal.compiler.ASTVisitor, org.exoplatform.ide.java.client.internal.compiler.lookup.BlockScope)
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.TypeReference#traverse(org.exoplatform.ide.java.client.internal.compiler.ASTVisitor, org.exoplatform.ide.java.client.internal.compiler.lookup.ClassScope)
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.Expression#printExpression(int, java.lang.StringBuffer)
    */

 ...
 */
package org.exoplatform.ide.java.client.compiler.batch;
...
public class CompilationUnit implements ICompilationUnit
{
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit#getContents() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit#getMainTypeName() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit#getPackageName() */
   @Override

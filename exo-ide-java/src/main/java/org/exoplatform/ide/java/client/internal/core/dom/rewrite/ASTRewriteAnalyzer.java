 ...
 *******************************************************************************/
package org.exoplatform.ide.java.client.internal.core.dom.rewrite;
...
import org.exoplatform.ide.java.client.core.dom.ChildPropertyDescriptor;
import org.exoplatform.ide.java.client.core.dom.ClassInstanceCreation;
import org.exoplatform.ide.java.client.core.dom.Comment;
...
import org.exoplatform.ide.java.client.core.dom.IExtendedModifier;
...
import org.exoplatform.ide.java.client.core.dom.rewrite.TargetSourceRangeComputer;
import org.exoplatform.ide.java.client.core.dom.rewrite.TargetSourceRangeComputer.SourceRange;
...
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.ASTRewriteFormatter.BlockContext;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.ASTRewriteFormatter.NodeMarker;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.ASTRewriteFormatter.Prefix;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.NodeInfoStore.CopyPlaceholderData;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.NodeInfoStore.StringPlaceholderData;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.RewriteEventStore.CopySourceInfo;
import org.exoplatform.ide.runtime.Assert;
import org.exoplatform.ide.runtime.CoreException;
import org.exoplatform.ide.text.edits.CopySourceEdit;
import org.exoplatform.ide.text.edits.CopyTargetEdit;
import org.exoplatform.ide.text.edits.DeleteEdit;
import org.exoplatform.ide.text.edits.InsertEdit;
import org.exoplatform.ide.text.edits.MoveSourceEdit;
import org.exoplatform.ide.text.edits.MoveTargetEdit;
import org.exoplatform.ide.text.edits.RangeMarker;
import org.exoplatform.ide.text.edits.ReplaceEdit;
import org.exoplatform.ide.text.edits.SourceModifier;
   ...
   public boolean visit(TryStatement node)
   {
      ...
      if (node.getAST().apiLevel() >= AST.JLS4)
      {
         if (isChanged(node, TryStatement.RESOURCES_PROPERTY))
         {
            ...
            pos =
               rewriteNodeList(node, TryStatement.RESOURCES_PROPERTY, getPosAfterTry(pos), newParen, ")", ";" + prefix); //$NON-NLS-1$ //$NON-NLS-2$
         }
         else
         {

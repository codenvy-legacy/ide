...
public class BinaryElementValuePairImpl implements IBinaryElementValuePair
{
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryElementValuePair#getName()
    */
   @Override
   public char[] getName()
   {
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryElementValuePair#getValue()
    */
   @Override

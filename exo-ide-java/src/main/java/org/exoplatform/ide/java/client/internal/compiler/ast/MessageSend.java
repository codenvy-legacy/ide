...
public class MessageSend extends Expression implements InvocationSite
{
      ...
      if (!this.binding.isStatic())
      {
         ...
         else
         {
            ...
            if (this.actualReceiverType != oldReceiverType
               && this.receiver.postConversionType(scope) != this.actualReceiverType)
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.Expression#setExpectedType(org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)
    */

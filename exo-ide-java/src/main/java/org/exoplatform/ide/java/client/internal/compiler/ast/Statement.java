...
public abstract class Statement extends ASTNode
{
      ...
      Scope scope)
   {
      ...
      return expressionType.isBaseType() // narrowing then boxing ?
         ...
         && scope.compilerOptions().sourceLevel >= org.exoplatform.ide.java.client.internal.compiler.ClassFileConstants.JDK1_5 // autoboxing
   ...
   /** 
    * Implementation of {@link org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite#expectedType}

...
public final class NamingConventions
{
    ...
    * @param excludedNames a list of names which cannot be suggested (already used names). Can be <code>null</code> if there is no
    *           excluded names.
    * @return char[] a name.
    * @see Flags
    * @see JavaCore#setOptions(java.util.Hashtable)
    ...
    * @param excluded a list of names which cannot be suggested (already used names). Can be <code>null</code> if there are no
    *           excluded names.
    * @param evaluateDefault if <code>true</code>, the result is guaranteed to contain at least one result. If <code>false</code>,

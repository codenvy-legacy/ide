...
public class PrefixExpression extends CompoundAssignment
{
    ...
    * @param lhs org.exoplatform.ide.java.client.internal.compiler.ast.Expression
    * @param expression org.exoplatform.ide.java.client.internal.compiler.ast.Expression
    * @param operator int
    */

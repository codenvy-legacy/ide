...
import org.exoplatform.ide.java.client.internal.compiler.util.SimpleLookupTable;
...
public class SourceTypeBinding extends ReferenceBinding
{
                  ...
                  nextAbstractMethod : for (int m = superMethods.length; --m >= 0;)
                  {
                     ...
                     MethodBinding defaultAbstract =
                        new MethodBinding(method.modifiers | ExtraCompilerModifiers.AccDefaultAbstract
                           | ClassFileConstants.AccSynthetic, method.selector, method.returnType, method.parameters,
      ...
      if (synthField == null)
      {
         synthField =
            new SyntheticFieldBinding(CharOperation.concat(TypeConstants.SYNTHETIC_OUTER_LOCAL_PREFIX,
               actualOuterLocalVariable.name), actualOuterLocalVariable.type, ClassFileConstants.AccPrivate
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#genericTypeSignature() */
    ...
    * 
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.Binding#getAnnotationTagBits()
    */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.Binding#initializeDeprecatedAnnotationTagBits() */

...
import org.exoplatform.ide.java.client.internal.compiler.Compiler;
import org.exoplatform.ide.java.client.internal.compiler.DefaultErrorHandlingPolicies;
import org.exoplatform.ide.java.client.internal.compiler.ICompilerRequestor;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.AnnotationBinding;
...
import org.exoplatform.ide.java.client.internal.core.CancelableProblemFactory;
import org.exoplatform.ide.java.client.internal.core.util.BindingKeyResolver;
import org.exoplatform.ide.java.client.internal.core.util.CommentRecorderParser;
...
class CompilationUnitResolver extends Compiler
{
    ...
    * @see org.exoplatform.ide.java.client.internal.compiler.DefaultErrorHandlingPolicies
    * 
    ...
    * @see org.exoplatform.ide.java.client.internal.compiler.CompilationResult
    * 
   ...
   public void accept(ISourceType[] sourceTypes, PackageBinding packageBinding, AccessRestriction accessRestriction)
   {
      ...
      // accept((org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit)sourceType.getHandle().getCompilationUnit(),
      // accessRestriction);
   }

   public synchronized void accept(org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit,
    ...
    * their results.
    */
   protected void beginToCompile(org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit[] sourceUnits,
      String[] bindingKeys)
   {
      ...
      {
         org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit = sourceUnits[i];
...
//            continue;
//         }
//         org.exoplatform.ide.java.client.compiler.batch.CompilationUnit compilationUnit =
//            new org.exoplatform.ide.java.client.compiler.batch.CompilationUnit(contents, sourceUnits[i], encoding);
//         org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit = compilationUnit;
//         CompilationResult compilationResult =
//            new CompilationResult(sourceUnit, 0, 0, compilerOptions.maxProblemsPerUnit);
//         CompilationUnitDeclaration compilationUnitDeclaration = parser.dietParse(sourceUnit, compilationResult);
//
...
//         // fill the methods bodies in order for the code to be generated
//         // real parse of the method....
//         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration[] types =
...
//   }
   ...
   public static CompilationUnitDeclaration parse(
      org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit, NodeSearcher nodeSearcher,
      Map<String, String> settings, int flags)
   {
      ...
      if (nodeSearcher != null)
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node = nodeSearcher.found;
         if (node == null)
         {
            return compilationUnitDeclaration;
         }

         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration enclosingTypeDeclaration =
         ...
         else if (enclosingTypeDeclaration != null)
         {
            ...
            {
               ((org.exoplatform.ide.java.client.internal.compiler.ast.Initializer)node).parseStatements(parser,
            ...
            {
               ((org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)node).parseMethods(parser,
   ...
   public static CompilationUnitDeclaration resolve(
      org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit, List classpaths,
   ...
   {
      final org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration[] types =
         compilationUnitDeclaration.types;
      if (types != null)
      {
   ...
   private void removeUnresolvedBindings(org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration type)
   {
      final org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration[] memberTypes = type.memberTypes;
      if (memberTypes != null)
      {
      ...
      final org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration[] fields = type.fields;
      if (fields != null)
      {
      ...
      FileASTRequestor astRequestor, int apiLevel, Map compilerOptions, int flags)
   {
      ...
      try
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit[] sourceUnits =
            new org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit[length];
         int count = 0;
         for (int i = 0; i < length; i++)
         {
            char[] contents = null;
            ...
            sourceUnits[count++] =
               new org.exoplatform.ide.java.client.compiler.batch.CompilationUnit(contents, sourceUnitPath, encoding);
         }
         beginToCompile(sourceUnits, bindingKeys);
         // process all units (some more could be injected in the loop by the lookup environment)
         for (int i = 0; i < this.totalUnits; i++)
         {
            ...
            try
            {
               ...
               // requested AST
               char[] fileName = unit.compilationResult.getFileName();
               org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit source =
                  (org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit)this.requestedSources
                     .get(fileName);
               if (source != null)
               {
                  // convert AST
                  CompilationResult compilationResult = unit.compilationResult;
                  org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit =
      ...
      boolean verifyMethods, boolean analyzeCode, boolean generateCode)
   {
      ...
      try
      {
         ...
         if (unit == null)
         {
            ...
            beginToCompile(new org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit[]{sourceUnit});
            ...
            if (searchPosition >= 0 && searchPosition <= length)
            {
               ...
               if (node != null)
               {
                  ...
                  else if (enclosingTypeDeclaration != null)
                  {
                     if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Initializer)
                     {
                        ((org.exoplatform.ide.java.client.internal.compiler.ast.Initializer)node).parseStatements(
                           this.parser, enclosingTypeDeclaration, unit);
                     }
                     else if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)
                     {
                        ((org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)node).parseMethods(
                           this.parser, unit);
                     }
                  }
   ...
   public CompilationUnitDeclaration resolve(
      org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit, boolean verifyMethods,

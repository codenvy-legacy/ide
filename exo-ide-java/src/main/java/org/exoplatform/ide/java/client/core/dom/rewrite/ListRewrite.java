 ...
 *******************************************************************************/
package org.exoplatform.ide.java.client.core.dom.rewrite;
...
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.ListRewriteEvent;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.NodeInfoStore;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.RewriteEvent;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.RewriteEventStore;
...
public final class ListRewrite
{
    ...
    * this list.
    * 
    * @param node the node being removed. The node can either be an original node in this list or (since 3.4) a new node already
    ...
    * @param editGroup the edit group in which to collect the corresponding text edits, or <code>null</code> if ungrouped
    * @throws IllegalArgumentException if the node or element is null, or if the node is not part of this rewriter's AST, or if
    ...
    * @param node the node to insert
    * @param editGroup the edit group in which to collect the corresponding text edits, or <code>null</code> if ungrouped
    * @throws IllegalArgumentException if the node is null, or if the node is not part of this rewriter's AST, or if the inserted
    ...
    * 
    * @param node the node to insert
    * @param index insertion index in the combined list of original and inserted nodes; <code>-1</code> indicates insertion as the
    *           last element
    * @param editGroup the edit group in which to collect the corresponding text edits, or <code>null</code> if ungrouped
    * @throws IllegalArgumentException if the node is null, or if the node is not part of this rewriter's AST, or if the inserted
    *            node is not a new node (or placeholder), or if the described modification is otherwise invalid (not a member of
    ...
    * @throws IllegalArgumentException An exception is thrown if the first or last node are <code>null</code>, if a node is not a
    ...
    * @param first the node that starts the range
    * @param last the node that ends the range
    * @param replacingNode a node that is set at the location of the moved nodes or <code>null</code> to remove all nodes
    * @param editGroup the edit group in which to collect the corresponding text edits fro a replace, or <code>null</code> if
    *           ungrouped
    * @return the new placeholder node
    * @throws IllegalArgumentException An exception is thrown if the first or last node are <code>null</code>, if a node is not a

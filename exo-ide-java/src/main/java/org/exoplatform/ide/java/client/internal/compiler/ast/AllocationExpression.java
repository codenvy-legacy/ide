...
public class AllocationExpression extends Expression implements InvocationSite
{
         ...
         this.resolvedType =
            this.type.resolvedType =
               scope.environment().createParameterizedType(((ParameterizedTypeBinding)this.resolvedType).genericType(),
                  inferredTypes, ((ParameterizedTypeBinding)this.resolvedType).enclosingType());
      }
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite#expectedType()
    */

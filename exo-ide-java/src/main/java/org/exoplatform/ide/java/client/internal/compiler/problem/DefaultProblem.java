...
public class DefaultProblem extends CategorizedProblem
{
   ...
   /** @see org.exoplatform.ide.java.client.core.compiler.CategorizedProblem#getCategoryID() */
    ...
    * 
    * @see org.exoplatform.ide.java.client.core.compiler.IProblem#getID()
    * @return int
    */
   public int getID()
   {
    ...
    * 
    * @see org.exoplatform.ide.java.client.core.compiler.CategorizedProblem#getMarkerType()
    */

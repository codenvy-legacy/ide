 ...
 *******************************************************************************/
package org.exoplatform.ide.java.client.internal.corext.refactoring.code;
...
import org.exoplatform.ide.java.client.internal.corext.dom.HierarchicalASTVisitor;
import org.exoplatform.ide.java.client.internal.corext.dom.ModifierRewrite;
import org.exoplatform.ide.java.client.internal.corext.refactoring.RefactoringCoreMessages;
import org.exoplatform.ide.java.client.internal.corext.refactoring.rename.TempOccurrenceAnalyzer;
import org.exoplatform.ide.java.client.internal.corext.refactoring.util.TextChangeCompatibility;
...
import org.exoplatform.ide.java.client.refactoring.Change;
...
public class PromoteTempToFieldRefactoring extends Refactoring
{
            ...
            if (names.contains(fFieldName))
            {
               String msg =
                  RefactoringCoreMessages.INSTANCE.PromoteTempToFieldRefactoring_Name_conflict(fFieldName,
                     BindingLabelProvider.getBindingLabel(method.resolveBinding(),
   ...
   public Change createChange() throws CoreException
   {
      ...
      TextEdit resultingEdits = rewrite.rewriteAST(document, JavaExtension.get().getOptions());

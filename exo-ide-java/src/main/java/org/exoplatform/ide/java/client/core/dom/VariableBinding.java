...
import org.exoplatform.ide.java.client.core.util.ModifierConstants;
...
class VariableBinding implements IVariableBinding
{
   ...
   private org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding binding;
   ...
   VariableBinding(BindingResolver resolver, org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding binding)
   {
   ...
   public boolean isEqualTo(IBinding other)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding otherBinding = ((VariableBinding)other).binding;

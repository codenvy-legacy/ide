...
class BindingComparator
{
   ...
   {
      if (declaringElement instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)
      {
         if (!(declaringElement2 instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding))
         {
            return false;
         }
         return isEqual((org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)declaringElement,
            (org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)declaringElement2, visitedTypes);
      }
      else if (declaringElement instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding)
      {
         if (!(declaringElement2 instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding))
         {
            return false;
         }
         return isEqual((org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding)declaringElement,
            (org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding)declaringElement2, visitedTypes);
      }
      ...
      else if (declaringElement instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding)
      {
         if (!(declaringElement2 instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding))
         {
            return false;
         }
         org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding packageBinding =
            (org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding)declaringElement;
         org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding packageBinding2 =
            (org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding)declaringElement2;
   ...
   static boolean isEqual(org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding,
      org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding2)
   {
      return isEqual(methodBinding, methodBinding2, new HashSet());
   }

   static boolean isEqual(org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding,
      org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding2, HashSet visitedTypes)
   {
    ...
    * @return true if both parameters are equals, false otherwise
    */
   static boolean isEqual(org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding[] bindings,
      org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding[] otherBindings)
   {
    ...
    */
   static boolean isEqual(org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding[] bindings,
      org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes)
   {
      if (bindings == null)
      {
         return otherBindings == null;
   ...
   static boolean isEqual(org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding,
      org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes)
   {
         ...
         case Binding.PARAMETERIZED_TYPE :
            ...
            return CharOperation.equals(parameterizedTypeBinding.compoundName, parameterizedTypeBinding2.compoundName)
               && (parameterizedTypeBinding.modifiers & (ExtraCompilerModifiers.AccJustFlag
                  | ClassFileConstants.AccInterface | ClassFileConstants.AccEnum | ClassFileConstants.AccAnnotation)) == (parameterizedTypeBinding2.modifiers & (ExtraCompilerModifiers.AccJustFlag
         ...
         case Binding.GENERIC_TYPE :
            ...
            return CharOperation.equals(referenceBinding.compoundName, referenceBinding2.compoundName)
               && (referenceBinding.modifiers & (ExtraCompilerModifiers.AccJustFlag | ClassFileConstants.AccInterface
                  | ClassFileConstants.AccEnum | ClassFileConstants.AccAnnotation)) == (referenceBinding2.modifiers & (ExtraCompilerModifiers.AccJustFlag
                  | ClassFileConstants.AccInterface | ClassFileConstants.AccEnum | ClassFileConstants.AccAnnotation))
         ...
         default :
            ...
            return CharOperation.equals(referenceBinding.compoundName, referenceBinding2.compoundName)
               ...
               && ((referenceBinding.modifiers & ~ClassFileConstants.AccSuper) & (ExtraCompilerModifiers.AccJustFlag
                  | ClassFileConstants.AccInterface | ClassFileConstants.AccEnum | ClassFileConstants.AccAnnotation)) == ((referenceBinding2.modifiers & ~ClassFileConstants.AccSuper) & (ExtraCompilerModifiers.AccJustFlag
                  | ClassFileConstants.AccInterface | ClassFileConstants.AccEnum | ClassFileConstants.AccAnnotation))
               && isEqual(referenceBinding.enclosingType(), referenceBinding2.enclosingType(), visitedTypes);
      }
   }
    ...
    */
   static boolean isEqual(org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding,
      org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding2)
   {

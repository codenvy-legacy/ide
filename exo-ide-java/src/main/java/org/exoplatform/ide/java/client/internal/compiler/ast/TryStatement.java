...
import org.exoplatform.ide.java.client.internal.compiler.flow.ExceptionHandlingFlowContext;
import org.exoplatform.ide.java.client.internal.compiler.flow.FinallyFlowContext;
...
import org.exoplatform.ide.java.client.internal.compiler.flow.InsideSubRoutineFlowContext;
import org.exoplatform.ide.java.client.internal.compiler.flow.NullInfoRegistry;
      ...
      if (this.subRoutineStartLabel == null)
      {
         ...
         ExceptionHandlingFlowContext handlingContext =
            new ExceptionHandlingFlowContext(flowContext, this, this.caughtExceptionTypes,
               this.caughtExceptionsCatchBlocks, this.catchArguments, null, this.scope, flowInfo.unconditionalInits());

...
import org.exoplatform.ide.java.client.internal.compiler.env.ClassSignature;
import org.exoplatform.ide.java.client.internal.compiler.env.EnumConstantSignature;
import org.exoplatform.ide.java.client.internal.compiler.env.IBinaryAnnotation;
import org.exoplatform.ide.java.client.internal.compiler.env.IBinaryElementValuePair;
...
public class BinaryTypeBinding extends ReferenceBinding
{
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#availableMethods() */
            ...
            for (int i = 0; i < size; i++)
            {
               ...
               TypeBinding type =
                  fieldSignature == null ? this.environment.getTypeFromSignature(binaryField.getTypeName(), 0, -1,
                     false, this, missingTypeNames) : this.environment.getTypeFromTypeSignature(new SignatureWrapper(
               ...
               FieldBinding field =
                  new FieldBinding(binaryField.getName(), type, binaryField.getModifiers()
                     | ExtraCompilerModifiers.AccUnresolved, this, binaryField.getConstant());

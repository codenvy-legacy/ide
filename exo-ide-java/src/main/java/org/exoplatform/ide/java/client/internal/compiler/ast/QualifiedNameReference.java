...
import org.exoplatform.ide.java.client.internal.compiler.lookup.MissingTypeBinding;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.SyntheticMethodBinding;
...
public class QualifiedNameReference extends NameReference
{
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.Expression#computeConversion(org.exoplatform.ide.java.client.internal.compiler.lookup.Scope, org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding, org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)
    */
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite#genericTypeArguments()
    */
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.ast.Expression#postConversionType(Scope)
    */
         ...
         switch (this.bits & ASTNode.RestrictiveFlagMASK)
         {
            ...
            case Binding.TYPE | Binding.VARIABLE :
               ...
               if (this.binding instanceof FieldBinding)
               {
                  ...
                  if ((this.indexOfFirstFieldBinding == 1 || (fieldBinding.modifiers & ClassFileConstants.AccEnum) != 0 || (!fieldBinding

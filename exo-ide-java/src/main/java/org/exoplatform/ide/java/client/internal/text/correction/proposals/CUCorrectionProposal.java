...
import org.exoplatform.ide.java.client.refactoring.DocumentChange;
...
import org.exoplatform.ide.text.edits.TextEditVisitor;
...
public class CUCorrectionProposal extends ChangeCorrectionProposal
{
    ...
    * image is desired.
    */
   public CUCorrectionProposal(String name, TextChange change, int relevance, Document document, Image image)
   {
    ...
    * image is desired.
    */
   protected CUCorrectionProposal(String name, int relevance, Document document, Image image)
   {

...
import org.exoplatform.ide.java.client.internal.compiler.parser.RecoveryScannerData;
      ...
      switch (this.astKind)
      {
         ...
         case K_COMPILATION_UNIT :
            ...
            try
            {
               ...
               org.exoplatform.ide.java.client.internal.compiler.env.ICompilationUnit sourceUnit = null;
               if (this.rawSource != null)
               {
   ...
   private ASTNode internalCreateASTForKind()
   {
      ...
      switch (this.astKind)
      {
         case K_STATEMENTS :
            ...
            org.exoplatform.ide.java.client.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
            if (statements != null)
            {
         ...
         case K_CLASS_BODY_DECLARATIONS :
            final org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode[] nodes =

...
import org.exoplatform.ide.java.client.core.formatter.align.Alignment;
import org.exoplatform.ide.java.client.core.formatter.align.AlignmentException;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.AND_AND_Expression;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.BreakStatement;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.CharLiteral;
import org.exoplatform.ide.java.client.internal.compiler.ast.ClassLiteralAccess;
import org.exoplatform.ide.java.client.internal.compiler.ast.Clinit;
import org.exoplatform.ide.java.client.internal.compiler.ast.CombinedBinaryExpression;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.ContinueStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.DoStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.DoubleLiteral;
import org.exoplatform.ide.java.client.internal.compiler.ast.EmptyStatement;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.FalseLiteral;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.FloatLiteral;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.IntLiteral;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.LongLiteral;
import org.exoplatform.ide.java.client.internal.compiler.ast.MarkerAnnotation;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.NullLiteral;
import org.exoplatform.ide.java.client.internal.compiler.ast.OR_OR_Expression;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.PostfixExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.PrefixExpression;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedThisReference;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.SingleMemberAnnotation;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.StringLiteral;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.SynchronizedStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.ThisReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.ThrowStatement;
import org.exoplatform.ide.java.client.internal.compiler.ast.TrueLiteral;
...
import org.exoplatform.ide.java.client.internal.core.util.CodeSnippetParsingUtil;
...
public class CodeFormatterVisitor extends ASTVisitor
{
   ...
   private static final int[] SINGLETYPEREFERENCE_EXPECTEDTOKENS = new int[]{TerminalTokens.TokenNameIdentifier,
      ...
      TerminalTokens.TokenNamedouble, TerminalTokens.TokenNamefloat, TerminalTokens.TokenNameint,
      TerminalTokens.TokenNamelong, TerminalTokens.TokenNameshort, TerminalTokens.TokenNamevoid};
   ...
   private void formatClassBodyDeclarations(ASTNode[] nodes)
   {
      ...
      Alignment memberAlignment =
         this.scribe.createMemberAlignment(Alignment.TYPE_MEMBERS, this.preferences.align_type_members_on_columns
            ? Alignment.M_MULTICOLUMN : Alignment.M_NO_ALIGNMENT, 4, this.scribe.scanner.currentPosition);
   ...
   private void formatTypeMembers(TypeDeclaration typeDeclaration)
   {
      Alignment memberAlignment =
         this.scribe.createMemberAlignment(Alignment.TYPE_MEMBERS, this.preferences.align_type_members_on_columns
            ? Alignment.M_MULTICOLUMN : Alignment.M_NO_ALIGNMENT, 3, this.scribe.scanner.currentPosition);
      this.scribe.enterMemberAlignment(memberAlignment);

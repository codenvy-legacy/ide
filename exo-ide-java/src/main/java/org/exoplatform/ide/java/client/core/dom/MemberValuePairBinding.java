...
class MemberValuePairBinding implements IMemberValuePairBinding
{
   ...
   static Object buildDOMValue(final Object internalObject, BindingResolver resolver)
   {
      ...
      else if (internalObject instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)
      {
         return resolver.getTypeBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)internalObject);
      }
      else if (internalObject instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.AnnotationBinding)
      {
         return resolver
            .getAnnotationInstance((org.exoplatform.ide.java.client.internal.compiler.lookup.AnnotationBinding)internalObject);
      }
      else if (internalObject instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.FieldBinding)
      {
         return resolver
            .getVariableBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.FieldBinding)internalObject);
      }

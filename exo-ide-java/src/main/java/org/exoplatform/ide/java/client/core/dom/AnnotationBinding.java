...
class AnnotationBinding implements IAnnotationBinding
{
   ...
   private org.exoplatform.ide.java.client.internal.compiler.lookup.AnnotationBinding binding;

   private BindingResolver bindingResolver;

   private String key;

   AnnotationBinding(org.exoplatform.ide.java.client.internal.compiler.lookup.AnnotationBinding annotation,

...
import org.exoplatform.ide.java.client.internal.compiler.ast.ArrayAllocationExpression;
import org.exoplatform.ide.java.client.internal.compiler.ast.CompilationUnitDeclaration;
import org.exoplatform.ide.java.client.internal.compiler.ast.ExplicitConstructorCall;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocAllocationExpression;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocSingleNameReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.JavadocSingleTypeReference;
import org.exoplatform.ide.java.client.internal.compiler.ast.Literal;
...
import org.exoplatform.ide.java.client.internal.compiler.ast.QualifiedSuperReference;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.ElementValuePair;
...
import org.exoplatform.ide.java.client.internal.compiler.lookup.ProblemFieldBinding;
...
public class DefaultBindingResolver extends BindingResolver
{
   ...
   IBinding getBinding(org.exoplatform.ide.java.client.internal.compiler.lookup.Binding binding)
   {
      switch (binding.kind())
      {
         case Binding.PACKAGE :
            return getPackageBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding)binding);
         case Binding.TYPE :
         case Binding.BASE_TYPE :
         case Binding.GENERIC_TYPE :
         case Binding.PARAMETERIZED_TYPE :
         case Binding.RAW_TYPE :
            return getTypeBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)binding);
         case Binding.ARRAY_TYPE :
         case Binding.TYPE_PARAMETER :
            return new TypeBinding(this, (org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)binding);
         case Binding.METHOD :
            return getMethodBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding)binding);
         case Binding.FIELD :
         case Binding.LOCAL :
            return getVariableBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding)binding);
      }
      return null;
   }

   synchronized org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode)
   {
      return (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(currentNode);
   }

   /* Method declared on BindingResolver. */
   synchronized IMethodBinding getMethodBinding(
      org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding)
   {
      if (methodBinding != null && !methodBinding.isValidBinding())
      {
         org.exoplatform.ide.java.client.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding =
            (org.exoplatform.ide.java.client.internal.compiler.lookup.ProblemMethodBinding)methodBinding;
   ...
   synchronized IPackageBinding getPackageBinding(
      org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding packageBinding)
   {
   ...
   /* Method declared on BindingResolver. */
   public ITypeBinding getTypeBinding(org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding referenceBinding)
   {
         ...
         switch (referenceBinding.problemId())
         {
            ...
            case ProblemReasons.NonStaticReferenceInStaticContext :
               if (referenceBinding instanceof ProblemReferenceBinding)
               {
                  ...
                  org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding binding2 =
   ...
   synchronized IVariableBinding getVariableBinding(
      org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding variableBinding,
      ...
      org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding variableBinding)
   {
      if (variableBinding != null)
      {
         if (variableBinding.isValidBinding())
         {
            org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding variableType = variableBinding.type;
   ...
   synchronized IAnnotationBinding getAnnotationInstance(
      org.exoplatform.ide.java.client.internal.compiler.lookup.AnnotationBinding internalInstance)
   {
   ...
   boolean isResolvedTypeInferredFromExpectedType(MethodInvocation methodInvocation)
   {
      ...
      if (oldNode instanceof MessageSend)
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding methodBinding = messageSend.binding;
   ...
   /**
    * @see org.exoplatform.ide.java.client.core.dom.BindingResolver#recordScope(ASTNode, BlockScope)
    */
   ...
   boolean resolveBoxing(Expression expression)
   {
      org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node =
         (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
      if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Expression)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.Expression compilerExpression =
            (org.exoplatform.ide.java.client.internal.compiler.ast.Expression)node;
   ...
   synchronized IMethodBinding resolveConstructor(ClassInstanceCreation expression)
   {
      org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node =
         (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
      if (node != null && (node.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.IsAnonymousType) != 0)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration =
   ...
   {
      org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node =
         (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(enumConstantDeclaration);
      if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration)
      {
         ...
         switch (expression.getNodeType())
         {
            case ASTNode.CLASS_INSTANCE_CREATION :
               org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode astNode =
                  (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(expression);
               if (astNode instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)
               {
                  // anonymous type case
                  org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration typeDeclaration =
                     (org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)astNode;
            ...
            case ASTNode.SINGLE_MEMBER_ANNOTATION :
               org.exoplatform.ide.java.client.internal.compiler.ast.Expression compilerExpression =
                  (org.exoplatform.ide.java.client.internal.compiler.ast.Expression)this.newAstToOldAst.get(expression);
   ...
   synchronized IBinding resolveImport(ImportDeclaration importDeclaration)
   {
      ...
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node =
            (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(importDeclaration);
         if (node instanceof ImportReference)
         {
            ImportReference importReference = (ImportReference)node;
            final boolean isStatic = importReference.isStatic();
            if ((importReference.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.OnDemand) != 0)
            {
               Binding binding =
               ...
               if (binding != null)
               {
                  if (isStatic)
                  {
                     if (binding instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)
                     {
                        ITypeBinding typeBinding =
                           this.getTypeBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)binding);
                  ...
                  else
                  {
                     if ((binding.kind() & Binding.PACKAGE) != 0)
                     {
                        IPackageBinding packageBinding =
                           getPackageBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding)binding);
                        if (packageBinding == null)
                        {
                           return null;
                        }
            ...
            else
            {
               ...
               if (binding != null)
               {
                  if (isStatic)
                  {
                     ...
                     else if (binding instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding)
                     {
                        // it is a type
                        return getMethodBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding)binding);
                     }
   ...
   {
      org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node =
         (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(name);
      ...
      if (node instanceof QualifiedNameReference)
      {
         ...
         if (index < indexOfFirstFieldBinding)
         {
            ...
            if (binding instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding)
            {
               return null;
            }
            else if (binding instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)
            {
               // it is a type
               return this.getTypeBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding)binding);
            }
         }
         else if (index == indexOfFirstFieldBinding)
         {
            ...
            else
            {
               ...
               if (fieldBinding == null)
                  return null;
               org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding type = fieldBinding.declaringClass;
               if (type == null)
               { // array length scenario
                 // use type from first binding (no capture needed for array type)
                  switch (qualifiedNameReference.bits
                     & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.RestrictiveFlagMASK)
                  {
                     case Binding.FIELD :
      ...
      else if (node instanceof SingleTypeReference)
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding binding = singleTypeReference.resolvedType;
         if (binding != null)
         {
      ...
      else if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter typeParameter =
            (org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter)node;
         return this.getTypeBinding(typeParameter.binding);
      }
      else if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.MemberValuePair)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.MemberValuePair memberValuePair =
            (org.exoplatform.ide.java.client.internal.compiler.ast.MemberValuePair)node;
   ...
   synchronized IBinding resolveName(Name name)
   {
         ...
         else if (index == indexOfFirstFieldBinding)
         {
            ...
            else
            {
               ...
               if (binding != null)
               {
                  ...
                  {
                     return this
                        .getVariableBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding)binding);
                  }
      ...
      else if (node instanceof ImportReference)
      {
         ...
         if (index >= 0)
         {
            ...
            if (binding != null)
            {
               ...
               else if (binding instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.FieldBinding)
               {
                  // it is a type
                  return this.getVariableBinding((org.exoplatform.ide.java.client.internal.compiler.lookup.FieldBinding)binding);
               }
               else if (binding instanceof org.exoplatform.ide.java.client.internal.compiler.lookup.MethodBinding)
               {
                  // it is a type
      ...
      else if (node instanceof CompilationUnitDeclaration)
      {
         ...
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration[] types = compilationUnitDeclaration.types;
         if (types == null || types.length == 0)
         {
            return null;
         }
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration type = types[0];
         if (type != null)
         {
   ...
   synchronized IPackageBinding resolvePackage(PackageDeclaration pkg)
   {
      ...
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node =
            (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(pkg);
         if (node instanceof ImportReference)
         {
            ImportReference importReference = (ImportReference)node;
            Binding binding =
   ...
   synchronized IBinding resolveReference(MemberRef ref)
   {
      org.exoplatform.ide.java.client.internal.compiler.ast.Expression expression =
         (org.exoplatform.ide.java.client.internal.compiler.ast.Expression)this.newAstToOldAst.get(ref);
   ...
   synchronized IMemberValuePairBinding resolveMemberValuePair(
      org.exoplatform.ide.java.client.core.dom.MemberValuePair memberValuePair)
   {
   ...
   ITypeBinding resolveType(AnnotationTypeDeclaration type)
   {
      ...
      if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration typeDeclaration =
            (org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)node;
         ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
   ...
   {
      org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node =
         (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(type);
      if (node != null && (node.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.IsAnonymousType) != 0)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration =
            (org.exoplatform.ide.java.client.internal.compiler.ast.TypeDeclaration)node;
   ...
   synchronized ITypeBinding resolveType(Type type)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode node =
         (org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode)this.newAstToOldAst.get(type);
      org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding binding = null;
      if (node != null)
      {
         if (node instanceof ParameterizedQualifiedTypeReference)
         {
            ...
            org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding typeBinding = typeReference.resolvedType;
            if (type.isArrayType())
            {
               if (this.scope == null)
               {
      ...
      else if (type.isPrimitiveType())
      {
         ...
         {
            return this.getTypeBinding(org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.VOID);
         }
      }
      return null;
   }
   ...
   synchronized ITypeBinding resolveTypeParameter(TypeParameter typeParameter)
   {
      ...
      if (node instanceof org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter typeParameter2 =
            (org.exoplatform.ide.java.client.internal.compiler.ast.TypeParameter)node;
   ...
   synchronized IVariableBinding resolveVariable(VariableDeclaration variable)
   {
      ...
      if (node instanceof AbstractVariableDeclaration)
      {
         ...
         if (abstractVariableDeclaration instanceof org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration)
         {
            org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration fieldDeclaration =
               (org.exoplatform.ide.java.client.internal.compiler.ast.FieldDeclaration)abstractVariableDeclaration;
   ...
   synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode)
   {
      ...
      if (oldNode instanceof org.exoplatform.ide.java.client.internal.compiler.ast.Annotation)
      {
         org.exoplatform.ide.java.client.internal.compiler.ast.Annotation internalAstNode =
            (org.exoplatform.ide.java.client.internal.compiler.ast.Annotation)oldNode;
   ...
   /* Method declared on BindingResolver. */
   synchronized void store(ASTNode node, org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode oldASTNode)
   {
   ...
   ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding leafTypeBinding = null;
      if (leafComponentType.isPrimitive())
      {
         ...
         {
            case 'I' :
               leafTypeBinding = org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.INT;
               break;
            case 'B' :
               leafTypeBinding = org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.BYTE;
               break;
            case 'Z' :
               leafTypeBinding = org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.BOOLEAN;
               break;
            case 'C' :
               leafTypeBinding = org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.CHAR;
               break;
            case 'J' :
               leafTypeBinding = org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.LONG;
               break;
            case 'S' :
               leafTypeBinding = org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.SHORT;
               break;
            case 'D' :
               leafTypeBinding = org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.DOUBLE;
               break;
            case 'F' :
               leafTypeBinding = org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding.FLOAT;
               break;
            case 'V' :

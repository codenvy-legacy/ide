...
import org.exoplatform.ide.java.client.templates.CompilationUnitCompletion.Variable;
...
import org.exoplatform.ide.java.client.templates.api.TemplateVariableType;
...
//   }
    ...
    * 
    * @param qualifiedMemberName the fully qualified name of the member to import or a qualified type name plus a '.*' suffix.
    ...
    * 
    * @param master the master variable - <code>slave</code> needs to be updated when <code>master</code> changes

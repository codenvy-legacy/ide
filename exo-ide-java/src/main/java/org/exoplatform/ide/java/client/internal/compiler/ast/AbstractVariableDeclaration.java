...
public abstract class AbstractVariableDeclaration extends Statement implements InvocationSite
{
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite#isSuperAccess()
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite#isTypeAccess()
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite#setActualReceiverType(org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding)
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite#setDepth(int)
    */
   ...
   /* (non-Javadoc)
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.InvocationSite#setFieldIndex(int)
    */

...
class PackageBinding implements IPackageBinding
{
   ...
   private org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding binding;
   ...
   PackageBinding(org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding binding, BindingResolver resolver)
   {
   ...
   public boolean isEqualTo(IBinding other)
   {
      ...
      org.exoplatform.ide.java.client.internal.compiler.lookup.PackageBinding packageBinding2 = ((PackageBinding)other).binding;

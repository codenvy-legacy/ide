...
public class BinaryAnnotationImpl implements IBinaryAnnotation
{
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryAnnotation#getTypeName()
    */
   @Override
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryAnnotation#getElementValuePairs()
    */
   @Override

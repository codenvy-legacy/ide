...
import org.exoplatform.ide.java.client.internal.compiler.env.IBinaryAnnotation;
import org.exoplatform.ide.java.client.internal.compiler.env.IBinaryField;
import org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod;
import org.exoplatform.ide.java.client.internal.compiler.env.IBinaryNestedType;
import org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType;
...
public class BinaryTypeImpl implements IBinaryType
{
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IGenericType#getModifiers() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IGenericType#isBinaryType() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IDependent#getFileName() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getAnnotations() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getEnclosingMethod() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getEnclosingTypeName() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getFields() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getGenericSignature() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getInterfaceNames() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getMemberTypes() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getMethods() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getMissingTypeNames() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getName() */
   @Override
   public char[] getName()
   {
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getSourceName() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getSuperclassName() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#getTagBits() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#isAnonymous() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#isLocal() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#isMember() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryType#sourceFileName() */
   @Override

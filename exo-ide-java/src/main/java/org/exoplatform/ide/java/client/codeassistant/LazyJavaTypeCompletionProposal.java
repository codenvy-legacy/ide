...
import org.exoplatform.ide.java.client.internal.corext.util.ModelUtil;
...
public class LazyJavaTypeCompletionProposal extends LazyJavaCompletionProposal
{
   ...
   protected ProposalInfo computeProposalInfo()
   {
      ...
      // IJavaProject project= fCompilationUnit.getJavaProject();
      // if (project != null)
      return new TypeProposalInfo(fProposal, fInvocationContext.getProjectId(), fInvocationContext.getDocContext(), fInvocationContext.getVfsId());
      // }

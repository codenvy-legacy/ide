...
public class TargetSourceRangeComputer
{
   ...
   public static final class SourceRange
   {
       ...
       * 
       * @param startPosition the 0-based character index, or <code>-1</code> if no source position information is known
       * @param length the (possibly 0) length, or <code>0</code> if no source position information is known
       */

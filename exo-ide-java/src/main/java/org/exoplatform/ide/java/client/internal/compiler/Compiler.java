...
import org.exoplatform.ide.java.client.internal.compiler.impl.CompilerStats;
...
import org.exoplatform.ide.java.client.internal.compiler.problem.DefaultProblem;
...
public class Compiler implements ITypeRequestor, ProblemSeverities
{
   ...
   // if (newUnitSize != 0)
   // {
   // ICompilationUnit[] newProcessedUnits = org.exoplatform.ide.java.client.internal.core.util.Util.clone(newUnits); // remember new units

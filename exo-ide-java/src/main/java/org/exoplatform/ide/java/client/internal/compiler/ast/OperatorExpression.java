...
public abstract class OperatorExpression extends Expression implements OperatorIds
{
   ...
   public static final String generateTableTestCase()
   {
      ...
      /*
      org.exoplatform.ide.java.client.internal.compiler.ast.
      ...
      */
      ...
      s = "\tpublic static void binaryOperationTablesTestCase(){\n" + //$NON-NLS-1$
         ...
         "\t\t//org.exoplatform.ide.java.client.internal.compiler.ast.OperatorExpression.generateTableTestCase();\n" + //$NON-NLS-1$
   ...
   public static final int[] get_MINUS()
   {
      ...
      int[] table = org.exoplatform.ide.java.client.internal.core.util.Util.clone(get_PLUS());

...
import org.exoplatform.ide.java.client.internal.compiler.codegen.ConstantPool;
...
public class BinaryMethodImpl implements IBinaryMethod
{
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IGenericMethod#getModifiers() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IGenericMethod#isConstructor() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IGenericMethod#getArgumentNames() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#getAnnotations() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#getDefaultValue() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#getExceptionTypeNames() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#getGenericSignature() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#getMethodDescriptor() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#getParameterAnnotations(int) */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#getSelector() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#getTagBits() */
   @Override
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.env.IBinaryMethod#isClinit() */
   @Override

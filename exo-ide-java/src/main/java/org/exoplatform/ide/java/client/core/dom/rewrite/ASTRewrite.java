...
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.ASTRewriteAnalyzer;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.LineInformation;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.NodeInfoStore;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.NodeRewriteEvent;
...
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.RewriteEventStore.PropertyLocation;
import org.exoplatform.ide.java.client.internal.core.dom.rewrite.TrackedNodePosition;
...
public class ASTRewrite
{
   ...
   private TextEdit internalRewriteAST(char[] content, LineInformation lineInfo, String lineDelim,
      List<Comment> commentNodes, Map<String, String> options, ASTNode rootNode, RecoveryScannerData recoveryScannerData)
   {
    ...
    * @return the new placeholder node
    * @throws IllegalArgumentException if the node is null, or if the node is not part of this rewriter's AST
    */
    ...
    * 
    * @param computer a target source range computer, or <code>null</code> to restore the default value of
    *           <code>new TargetSourceRangeComputer()</code>
    * @since 3.1

 ...
 *******************************************************************************/
package org.exoplatform.ide.java.client.internal.compiler.lookup;
...
public class ParameterizedTypeBinding extends ReferenceBinding implements Substitution
{
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#canBeInstantiated() */
    ...
    * 
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#capture(Scope,int)
    */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#collectMissingTypes(java.util.List) */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#computeId() */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#constantPoolName() */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#debugName() */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#enclosingType() */
   public ReferenceBinding enclosingType()
   {
      return this.enclosingType;
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.Substitution#environment() */
   public LookupEnvironment environment()
   {
      return this.environment;
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#erasure() */
   public TypeBinding erasure()
   {
      return this.type.erasure(); // erasure
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#fieldCount() */
   public int fieldCount()
   {
      return this.type.fieldCount(); // same as erasure (lazy)
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#fields() */
   public FieldBinding[] fields()
   {
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#getAnnotationTagBits() */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#getExactConstructor(TypeBinding[]) */
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#getExactMethod(char[],
   ...
   /**
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#getField(char[], boolean)
    */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#getMemberType(char[]) */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#getMethods(char[]) */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#implementsMethod(MethodBinding) */
   ...
   void initialize(ReferenceBinding someType, TypeBinding[] someArguments)
   {
      ...
      this.tagBits |=
         someType.tagBits
            & (TagBits.IsLocalType | TagBits.IsMemberType | TagBits.IsNestedType | TagBits.HasMissingType | TagBits.ContainsNestedTypeReferences);
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.Substitution#isRawSubstitution() */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#memberTypes() */
   public ReferenceBinding[] memberTypes()
   {
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#methods() */
   public MethodBinding[] methods()
   {
      if ((this.tagBits & TagBits.AreMethodsComplete) != 0)
         return this.methods;
    ...
    * 
    * @see org.exoplatform.ide.java.client.internal.compiler.lookup.Binding#problemId()
    */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#qualifiedPackageName() */
   public char[] qualifiedPackageName()
   {
      return this.type.qualifiedPackageName();
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#qualifiedSourceName() */
   public char[] qualifiedSourceName()
   {
      return this.type.qualifiedSourceName();
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.Binding#readableName() */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.Binding#shortReadableName() */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#signature() */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.TypeBinding#sourceName() */
   public char[] sourceName()
   {
      return this.type.sourceName();
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.Substitution#substitute(org.exoplatform.ide.java.client.internal.compiler.lookup.TypeVariableBinding) */
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#superclass() */
   public ReferenceBinding superclass()
   {
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#superInterfaces() */
   public ReferenceBinding[] superInterfaces()
   {
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#syntheticEnclosingInstanceTypes() */
   public ReferenceBinding[] syntheticEnclosingInstanceTypes()
   {
      return genericType().syntheticEnclosingInstanceTypes();
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.ReferenceBinding#syntheticOuterLocalVariables() */

...
public class ParameterizedFieldBinding extends FieldBinding
{
   ...
   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.VariableBinding#constant() */
   public Constant constant()
   {
      return this.originalField.constant();
   }

   /** @see org.exoplatform.ide.java.client.internal.compiler.lookup.FieldBinding#original() */

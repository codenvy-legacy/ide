...
public class Util
{
         ...
         switch (current)
         {
            case ARGUMENTS_DELIMITER :
               ...
               else
               {
                  ...
                  {
                     currentArgumentContents = org.exoplatform.ide.java.client.internal.compiler.util.Util.EMPTY_STRING;
                  }
   ...
   public static int scanTypeSignature(char[] string, int start)
   {
      ...
      return org.exoplatform.ide.java.client.internal.compiler.util.Util.scanTypeSignature(string, start);
   }
   ...
   public static String typeSignature(TypeReference type)
   {
      ...
      if ((type.bits & org.exoplatform.ide.java.client.internal.compiler.ast.ASTNode.IsUnionType) != 0)
      {

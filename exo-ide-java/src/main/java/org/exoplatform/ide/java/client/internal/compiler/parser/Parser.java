 ...
 *******************************************************************************/
package org.exoplatform.ide.java.client.internal.compiler.parser;
...
import org.exoplatform.ide.java.client.core.util.JSONUtil;
...
import org.exoplatform.ide.java.client.internal.compiler.parser.diagnose.DiagnoseParser;
import org.exoplatform.ide.java.client.internal.compiler.problem.AbortCompilation;
import org.exoplatform.ide.java.client.internal.compiler.problem.AbortCompilationUnit;
...
import org.exoplatform.ide.java.client.internal.compiler.util.Util;
...
public class Parser implements ParserBasicInformation, TerminalTokens, OperatorIds, TypeIds
{
   ...
   protected void consumeAssignment()
   {
      ...
      this.expressionStack[this.expressionPtr] =
         (op != EQUAL) ? new CompoundAssignment(this.expressionStack[this.expressionPtr], expression, op,
            expression.sourceEnd) : new Assignment(this.expressionStack[this.expressionPtr], expression,
   ...
   protected void consumeEnumConstantHeaderName()
   {
      if (this.currentElement != null)
      {
         if (!(this.currentElement instanceof RecoveredType || (this.currentElement instanceof RecoveredField && ((RecoveredField)this.currentElement).fieldDeclaration.type == null))
   ...
   protected void reportSyntaxErrors(boolean isDietParse, int oldFirstToken)
   {
      ...
      if (isDietParse)
      {
         ...
         int[][] intervalToSkip =
            org.exoplatform.ide.java.client.internal.compiler.parser.diagnose.RangeUtil.computeDietRange(types);

...
//      new JavaCodeAssistantService(null, null);
   ...
   private class MockNameEnv implements INameEnvironment
   {
      ...
      /**
       * @see org.exoplatform.ide.java.client.internal.compiler.env.INameEnvironment#findType(char[][])
       */
      @Override
      ...
      /**
       * @see org.exoplatform.ide.java.client.internal.compiler.env.INameEnvironment#findType(char[], char[][])
       */
      @Override
      ...
      /**
       * @see org.exoplatform.ide.java.client.internal.compiler.env.INameEnvironment#isPackage(char[][], char[])
       */
      @Override
      ...
      /**
       * @see org.exoplatform.ide.java.client.internal.compiler.env.INameEnvironment#cleanup()
       */
      @Override
      public void cleanup()
      {
      ...
      /**
       * @see org.exoplatform.ide.java.client.internal.compiler.env.INameEnvironment#findTypes(char[], boolean, boolean, int, org.exoplatform.ide.java.client.internal.codeassist.ISearchRequestor, org.exoplatform.ide.java.client.runtime.IProgressMonitor)
       */
      ...
      /**
       * @see org.exoplatform.ide.java.client.internal.compiler.env.INameEnvironment#findPackages(char[], org.exoplatform.ide.java.client.internal.codeassist.ISearchRequestor)
       */
      ...
      /**
       * @see org.exoplatform.ide.java.client.internal.compiler.env.INameEnvironment#findConstructorDeclarations(char[], boolean, org.exoplatform.ide.java.client.internal.codeassist.ISearchRequestor, org.exoplatform.ide.java.client.runtime.IProgressMonitor)
       */
      ...
      /**
       * @see org.exoplatform.ide.java.client.internal.compiler.env.INameEnvironment#findExactTypes(char[], boolean, int, org.exoplatform.ide.java.client.internal.codeassist.ISearchRequestor)
       */

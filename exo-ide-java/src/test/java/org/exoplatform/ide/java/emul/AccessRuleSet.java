...
import org.exoplatform.ide.java.client.internal.compiler.env.AccessRule;
...
public class AccessRuleSet
{
   ...
   public boolean equals(Object object)
   {
      ...
      if (this.classpathEntryType != otherRuleSet.classpathEntryType || this.classpathEntryName == null
         && otherRuleSet.classpathEntryName != null || !this.classpathEntryName.equals(otherRuleSet.classpathEntryName))
      {
         return false;
      }

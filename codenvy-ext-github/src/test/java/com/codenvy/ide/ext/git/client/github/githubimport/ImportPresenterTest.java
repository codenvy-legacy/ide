...
public class ImportPresenterTest extends BaseTest {
    ...
    public void disarm() {
        ...
        presenter = new ImportPresenter(view, gitHubService, gitService, eventBus, "restContext", constant, gitConstant, resourceProvider, console,
    ...
    public void testOnFinishClickedWhenProjectNameIsEmpty() throws Exception {
        ...
        verify(gitConstant).noIncorrectProjectNameMessage();
    }
    ...
    public void testOnFinishClickedWhenCloneRepositoryWSIsSuccessful() throws Exception {
        ...
        }).when(gitService).cloneRepositoryWS(anyString(), (Project)anyObject(), anyString(), anyString(),
        ...
        verify(notificationManager).showNotification((Notification)anyObject());
        verify(gitConstant).cloneSuccess(eq(REMOTE_URI));
        verify(view).close();
    }
    ...
    public void testOnFinishClickedWhenCloneRepositoryWSIsFailed() throws Exception {
        ...
        verify(gitService, never())
                .cloneRepository(eq(VFS_ID), eq(project), eq(REMOTE_URI), eq(PROJECT_NAME), (AsyncRequestCallback<String>)anyObject());
        verify(notificationManager).showNotification((Notification)anyObject());
        verify(gitConstant).cloneFailed(anyString());
        verify(notificationManager).showNotification((Notification)anyObject());
        verify(view).close();
    }
    ...
    public void testOnFinishClickedWhenCloneRepositoryIsSuccessful() throws Exception {
        ...
        doThrow(WebSocketException.class).when(gitService).cloneRepositoryWS(anyString(), (Project)anyObject(), anyString(), anyString(),
                                                                          (RequestCallback<String>)anyObject());
        doAnswer(new Answer() {
            @Override
            public Object answer(InvocationOnMock invocation) throws Throwable {
        ...
        }).when(gitService).cloneRepository(anyString(), (Project)anyObject(), anyString(), anyString(),
        ...
        verify(gitService)
                .cloneRepositoryWS(eq(VFS_ID), eq(project), eq(REMOTE_URI), eq(PROJECT_NAME), (RequestCallback<String>)anyObject());
        verify(gitService).cloneRepository(eq(VFS_ID), eq(project), eq(REMOTE_URI), eq(PROJECT_NAME),
                                        (AsyncRequestCallback<String>)anyObject());
        verify(notificationManager).showNotification((Notification)anyObject());
        verify(gitConstant).cloneSuccess(eq(REMOTE_URI));
        verify(view).close();
    ...
    public void testOnFinishClickedWhenCloneRepositoryIsRequestFailed() throws Exception {
        ...
        doThrow(WebSocketException.class).when(gitService).cloneRepositoryWS(anyString(), (Project)anyObject(), anyString(), anyString(),
                                                                          (RequestCallback<String>)anyObject());
        doThrow(RequestException.class).when(gitService).cloneRepository(anyString(), (Project)anyObject(), anyString(), anyString(),
                                                                      (AsyncRequestCallback<String>)anyObject());

...
/**
 * Command for "Run/Run Application" action.
 *
 * @author <a href="mailto:aplotnikov@exoplatform.com">Andrey Plotnikov</a>
 */
@Singleton
public class RunCommand implements ExtendedCommand {
    private final RunnerPresenter         presenter;
     ...
     */
    @Inject
    public RunCommand(RunnerPresenter presenter, JavaRuntimeResources resources, ProjectOpenedExpression expression) {

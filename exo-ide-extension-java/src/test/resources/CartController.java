    ...
    public CartController() {
        ...
        products
                .put(
                        ...
                        new Product(
                                "The MacBook Pro",
                                "The new MacBook Pro. State-of-the-art processors. All-new graphics. Breakthrough high-speed I/O. Three " +
                                "very big leaps forward.",
                                2499.99));
        ...
        products
                .put(
                        ...
                        new Product(
                                "The MacBook Air",
                                "Every millimeter a Mac. Underneath all that thinness is a full-size, " +
                                "fully capable Mac that can do practically everything its larger siblings can do. Minus a pound or two.",
                                999.99));
